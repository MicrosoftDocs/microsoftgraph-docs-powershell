...
function Start-GraphHelp {
    ...
    # Authentication docs live only under graph-powershell-1.0, so (re)generate them
    # only when the v1.0 profile is in scope. When generating beta on its own the auth
