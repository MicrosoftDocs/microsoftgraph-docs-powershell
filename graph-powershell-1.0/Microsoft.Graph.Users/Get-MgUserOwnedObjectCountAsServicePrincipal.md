...
### Get (Default)
```
Get-MgUserOwnedObjectCountAsServicePrincipal -UserId <String> [-Filter <String>] [-Search <String>]
 -ConsistencyLevel <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserOwnedObjectCountAsServicePrincipal -InputObject <IUsersIdentity> [-Filter <String>]
