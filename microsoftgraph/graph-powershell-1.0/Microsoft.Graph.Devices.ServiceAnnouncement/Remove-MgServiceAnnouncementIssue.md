...
onlin`e` v`e`rsion: https://docs.microsoft.com/`e`n-us/pow`e`rsh`e`ll/modul`e`/microsoft.graph.d`e`vic`e`s.s`e`rvic`e`announc`e`m`e`nt/r`e`mov`e`-mgs`e`rvic`e`announc`e`m`e`ntissu`e`
sch`e`ma: 2.0.0
---

# R`e`mov`e`-MgS`e`rvic`e`Announc`e`m`e`ntIssu`e`
...
```
R`e`mov`e`-MgS`e`rvic`e`Announc`e`m`e`ntIssu`e` -S`e`rvic`e`H`e`althIssu`e`Id <String> [-IfMatch <String>] [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParam`e`t`e`rs>]
```

### D`e`l`e`t`e`ViaId`e`ntity1
```
R`e`mov`e`-MgS`e`rvic`e`Announc`e`m`e`ntIssu`e` -InputObj`e`ct <ID`e`vic`e`sS`e`rvic`e`Announc`e`m`e`ntId`e`ntity> [-IfMatch <String>]
