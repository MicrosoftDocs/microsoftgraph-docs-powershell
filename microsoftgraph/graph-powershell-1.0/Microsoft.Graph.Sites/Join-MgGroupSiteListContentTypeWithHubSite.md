...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/join-mggroupsitelistcontenttypewithhubsite
schema: 2.0.0
...
```
Join-MgGroupSiteListContentTypeWithHubSite -InputObject <ISitesIdentity> [-ResponseHeadersVariable <String>]
