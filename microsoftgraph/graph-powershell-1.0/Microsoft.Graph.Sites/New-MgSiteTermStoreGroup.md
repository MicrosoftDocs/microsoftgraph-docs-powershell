...
onl```i```ne vers```i```on: https://docs.m```i```crosoft.com/en-us/powershell/module/m```i```crosoft.graph.s```i```tes/new-mgs```i```tetermstoregroup
schema: 2.0.0
---

# New-MgS```i```teTermStoreGroup

## SYNOPS```i```S
Create new nav```i```gat```i```on property to groups for s```i```tes

## SYNTAX

### CreateExpanded1 (Default)
```
New-MgS```i```teTermStoreGroup -S```i```te```i```d <Str```i```ng> [-Add```i```t```i```onalPropert```i```es <Hashtable>] [-CreatedDateT```i```me <DateT```i```me>]
...
### CreateExpanded2
```
New-MgS```i```teTermStoreGroup -S```i```te```i```d <Str```i```ng> -Store```i```d <Str```i```ng> [-Add```i```t```i```onalPropert```i```es <Hashtable>]
...
### Create2
```
New-MgS```i```teTermStoreGroup -S```i```te```i```d <Str```i```ng> -Store```i```d <Str```i```ng> -BodyParameter <```i```M```i```crosoftGraphTermStoreGroup1>
 [-What```i```f] [-Conf```i```rm] [<CommonParameters>]
```

### Create1
```
New-MgS```i```teTermStoreGroup -S```i```te```i```d <Str```i```ng> -BodyParameter <```i```M```i```crosoftGraphTermStoreGroup1> [-What```i```f] [-Conf```i```rm]
 [<CommonParameters>]
```

### CreateV```i```a```i```dent```i```tyExpanded2
```
New-MgS```i```teTermStoreGroup -```i```nputObject <```i```S```i```tes```i```dent```i```ty> [-Add```i```t```i```onalPropert```i```es <Hashtable>]
 [-CreatedDateT```i```me <DateT```i```me>] [-Descr```i```pt```i```on <Str```i```ng>] [-D```i```splayName <Str```i```ng>] [-```i```d <Str```i```ng>]
 [-ParentS```i```te```i```d <Str```i```ng>] [-Scope <Str```i```ng>] [-Sets <```i```M```i```crosoftGraphTermStoreSet[]>] [-What```i```f] [-Conf```i```rm]
 [<CommonParameters>]
```
...
```
New-MgS```i```teTermStoreGroup -```i```nputObject <```i```S```i```tes```i```dent```i```ty> -BodyParameter <```i```M```i```crosoftGraphTermStoreGroup1>
 [-What```i```f] [-Conf```i```rm] [<CommonParameters>]
```
