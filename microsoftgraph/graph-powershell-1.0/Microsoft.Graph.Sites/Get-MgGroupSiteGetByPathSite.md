...
### List1 (Default)
```
Get-MgGroupSiteGetByPathSite -GroupId <String> -Path <String> -SiteId <String> [-ExpandProperty <String[]>]
...
### List
```
Get-MgGroupSiteGetByPathSite -GroupId <String> -Path <String> -SiteId <String> -Path1 <String>
...
## RELATED LINKS
[Get-MgBetaGroupSiteGetByPathSite](/powershell/module/Microsoft.Graph.Beta.Sites/Get-MgBetaGroupSiteGetByPathSite?view=graph-powershell-beta)
