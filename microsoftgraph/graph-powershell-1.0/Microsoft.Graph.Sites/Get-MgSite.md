...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaBetaSite](/powershell/module/Microsoft.Graph.Beta.Sites/Get-MgBetaSite?view=graph-powershell-beta)

## SYNTAX

### Get2 (Default)
```
Get-MgSite [-Property <String[]>] [-Count] [-Filter <String>] [-Search <String>] [-Skip <Int32>]
...
## RELATED LINKS
[Get-MgBetaBetaSite](/powershell/module/Microsoft.Graph.Beta.Sites/Get-MgBetaSite?view=graph-powershell-beta)
