...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mgsitecontenttype
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Update-MgSiteContentType
---
...
```
Update-MgSiteContentType -ContentTypeId <string> -SiteId <string>
...
```
Update-MgSiteContentType -InputObject <ISitesIdentity> [-ResponseHeadersVariable <string>]
