...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mggroupsiteanalytic
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Get-MgGroupSiteAnalytic
---
...
```
Get-MgGroupSiteAnalytic -InputObject <ISitesIdentity> [-ExpandProperty <string[]>]
 [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
```
...
- [Get-MgGroupSiteAnalytic](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mggroupsiteanalytic)
