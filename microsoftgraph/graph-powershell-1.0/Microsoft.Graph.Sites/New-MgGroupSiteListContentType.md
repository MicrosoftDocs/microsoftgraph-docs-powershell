...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mggroupsitelistcontenttype
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: New-MgGroupSiteListContentType
---
...
```
New-MgGroupSiteListContentType -InputObject <ISitesIdentity> [-ResponseHeadersVariable <string>]
...
```
New-MgGroupSiteListContentType -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphContentType> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgGroupSiteListContentType](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mggroupsitelistcontenttype)
