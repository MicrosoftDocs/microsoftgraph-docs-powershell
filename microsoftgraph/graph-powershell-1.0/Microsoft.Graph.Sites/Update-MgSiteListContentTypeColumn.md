...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaSiteListContentTypeColumn](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaSiteListContentTypeColumn?view=graph-powershell-beta)

## SYNTAX

### UpdateExpanded (Default)
```
Update-MgSiteListContentTypeColumn -ColumnDefinitionId <String> -ContentTypeId <String> -ListId <String>
 -SiteId <String> [-AdditionalProperties <Hashtable>] [-Boolean <Hashtable>]
...
```
Update-MgSiteListContentTypeColumn -ColumnDefinitionId <String> -ContentTypeId <String> -ListId <String>
 -SiteId <String> -BodyParameter <IMicrosoftGraphColumnDefinition> [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgSiteListContentTypeColumn -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]
...
### UpdateViaIdentity
```
Update-MgSiteListContentTypeColumn -InputObject <ISitesIdentity>
...
## RELATED LINKS
[Update-MgBetaSiteListContentTypeColumn](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaSiteListContentTypeColumn?view=graph-powershell-beta)
