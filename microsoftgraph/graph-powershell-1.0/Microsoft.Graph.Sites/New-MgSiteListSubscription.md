...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaSiteListSubscription](/powershell/module/Microsoft.Graph.Beta.Applications/New-MgBetaSiteListSubscription?view=graph-powershell-beta)
...
### CreateViaIdentity
```
New-MgSiteListSubscription -InputObject <ISitesIdentity> -BodyParameter <IMicrosoftGraphSubscription> [-WhatIf]
...
## RELATED LINKS
[New-MgBetaSiteListSubscription](/powershell/module/Microsoft.Graph.Beta.Applications/New-MgBetaSiteListSubscription?view=graph-powershell-beta)
