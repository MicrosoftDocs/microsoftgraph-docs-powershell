...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mggroupsitepageassitepagecanvalayouthorizontalsection
schema: 2.0.0
---
...
```
New-MgGroupSitePageAsSitePageCanvaLayoutHorizontalSection -BaseSitePageId <String> -GroupId <String>
 -SiteId <String> -BodyParameter <IMicrosoftGraphHorizontalSection> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
