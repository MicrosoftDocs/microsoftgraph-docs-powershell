...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mgsitetermstoresetrelation
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: New-MgSiteTermStoreSetRelation
---
...
```
New-MgSiteTermStoreSetRelation -SetId <string> -SiteId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgSiteTermStoreSetRelation -InputObject <ISitesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-FromTerm <IMicrosoftGraphTermStoreTerm>] [-Id <string>]
 [-Relationship <string>] [-Set <IMicrosoftGraphTermStoreSet>]
 [-ToTerm <IMicrosoftGraphTermStoreTerm>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mgsitetermstoresetrelation)
