...
onl`````i`````ne vers`````i`````on: https://docs.m`````i`````crosoft.com/en-us/powershell/module/m`````i`````crosoft.graph.s`````i`````tes/new-mgs`````i`````tetermstoresetparentgroupsettermrelat`````i`````on
schema: 2.0.0
---

# New-MgS`````i`````teTermStoreSetParentGroupSetTermRelat`````i`````on
...
```
New-MgS`````i`````teTermStoreSetParentGroupSetTermRelat`````i`````on -Set`````i`````d <Str`````i`````ng> -Set`````i`````d1 <Str`````i`````ng> -S`````i`````te`````i`````d <Str`````i`````ng>
...
```
New-MgS`````i`````teTermStoreSetParentGroupSetTermRelat`````i`````on -`````i`````nputObject <`````i`````S`````i`````tes`````i`````dent`````i`````ty>
