...
### Delete (Default)
```
Remove-MgSiteTermStoreGroup -GroupId <String> -SiteId <String> [-IfMatch <String>] [-Headers <IDictionary>]
...
### DeleteViaIdentity1
```
Remove-MgSiteTermStoreGroup -InputObject <ISitesIdentity> [-IfMatch <String>] [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
