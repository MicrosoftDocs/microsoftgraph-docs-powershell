...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/invoke-mgreauthorizesitelistsubscription
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Invoke-MgReauthorizeSiteListSubscription
---
...
```
Invoke-MgReauthorizeSiteListSubscription -InputObject <ISitesIdentity>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru]
 [-Proxy <uri>] [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
- [Invoke-MgReauthorizeSiteListSubscription](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/invoke-mgreauthorizesitelistsubscription)
