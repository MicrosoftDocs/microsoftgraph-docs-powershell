...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mgsitelistsubscription
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Update-MgSiteListSubscription
---
...
```
Update-MgSiteListSubscription -InputObject <ISitesIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgSiteListSubscription -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphSubscription> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [Update-MgSiteListSubscription](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mgsitelistsubscription)
