...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/remove-mggroupsitegetbypathonenote
schema: 2.0.0
---
...
### Delete1 (Default)
```
Remove-MgGroupSiteGetByPathOnenote -GroupId <String> -Path <String> -SiteId <String> [-IfMatch <String>]
...
### Delete
```
Remove-MgGroupSiteGetByPathOnenote -GroupId <String> -Path <String> -Path1 <String> -SiteId <String>
...
### DeleteViaIdentity1
```
Remove-MgGroupSiteGetByPathOnenote -InputObject <ISitesIdentity> [-IfMatch <String>] [-Headers <IDictionary>]
