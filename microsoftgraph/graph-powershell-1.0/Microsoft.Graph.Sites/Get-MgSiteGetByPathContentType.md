...
### List (Default)
```
Get-MgSiteGetByPathContentType -Path <String> -SiteId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### List1
```
Get-MgSiteGetByPathContentType -Path <String> -SiteId <String> -Path1 <String> [-ExpandProperty <String[]>]
...
## RELATED LINKS
[Get-MgBetaSiteGetByPathContentType](/powershell/module/Microsoft.Graph.Beta.Sites/Get-MgBetaSiteGetByPathContentType?view=graph-powershell-beta)
