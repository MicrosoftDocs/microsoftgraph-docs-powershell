...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mgsitelistitempermission
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: New-MgSiteListItemPermission
---

# New-MgSiteListItemPermission
...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaSiteListItemPermission](/powershell/module/Microsoft.Graph.Beta.Sites/New-MgBetaSiteListItemPermission?view=graph-powershell-beta)
...
```
New-MgSiteListItemPermission -ListId <string> -ListItemId <string> -SiteId <string>
...
```
New-MgSiteListItemPermission -InputObject <ISitesIdentity> [-ResponseHeadersVariable <string>]
...
```
New-MgSiteListItemPermission -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphPermission> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgSiteListItemPermission](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mgsitelistitempermission)
