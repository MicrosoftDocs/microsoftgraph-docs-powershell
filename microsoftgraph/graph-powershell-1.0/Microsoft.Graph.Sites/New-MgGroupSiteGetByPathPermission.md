...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mggroupsitegetbypathpermission
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: New-MgGroupSiteGetByPathPermission
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaGroupSiteGetByPathPermission](/powershell/module/Microsoft.Graph.Beta.Sites/New-MgBetaGroupSiteGetByPathPermission?view=graph-powershell-beta)
...
```
New-MgGroupSiteGetByPathPermission -GroupId <string> -Path <string> -SiteId <string>
...
```
New-MgGroupSiteGetByPathPermission -InputObject <ISitesIdentity> [-ResponseHeadersVariable <string>]
...
```
New-MgGroupSiteGetByPathPermission -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphPermission> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm] [<CommonParameters>]
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mggroupsitegetbypathpermission)
