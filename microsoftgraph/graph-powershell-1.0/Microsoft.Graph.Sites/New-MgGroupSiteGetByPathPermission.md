...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mggroupsitegetbypathpermission
schema: 2.0.0
---
...
### CreateExpanded
```
New-MgGroupSiteGetByPathPermission -GroupId <String> -Path <String> -Path1 <String> -SiteId <String>
 [-AdditionalProperties <Hashtable>] [-ExpirationDateTime <DateTime>] [-GrantedTo <IMicrosoftGraphIdentitySet>]
 [-GrantedToIdentities <IMicrosoftGraphIdentitySet[]>]
 [-GrantedToIdentitiesV2 <IMicrosoftGraphSharePointIdentitySet[]>]
 [-GrantedToV2 <IMicrosoftGraphSharePointIdentitySet>] [-HasPassword] [-Id <String>]
...
```
New-MgGroupSiteGetByPathPermission -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]
...
### CreateViaIdentity1
```
New-MgGroupSiteGetByPathPermission -InputObject <ISitesIdentity> -BodyParameter <IMicrosoftGraphPermission>
