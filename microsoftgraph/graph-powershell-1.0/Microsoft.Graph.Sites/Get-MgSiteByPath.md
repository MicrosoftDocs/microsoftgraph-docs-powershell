...
### Get (Default)
```
Get-MgSiteByPath -Path <String> -SiteId <String> [-Headers <IDictionary>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSiteByPath -InputObject <ISitesIdentity> [-Headers <IDictionary>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
