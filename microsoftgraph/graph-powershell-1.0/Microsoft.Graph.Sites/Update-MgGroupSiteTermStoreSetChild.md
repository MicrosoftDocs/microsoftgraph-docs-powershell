...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaGroupSiteTermStoreSetChild](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaGroupSiteTermStoreSetChild?view=graph-powershell-beta)
...
```
Update-MgGroupSiteTermStoreSetChild -GroupId <String> -SetId <String> -SiteId <String> -TermId <String>
 -StoreId <String> -TermId1 <String> -BodyParameter <IMicrosoftGraphTermStoreTerm> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgBetaGroupSiteTermStoreSetChild](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaGroupSiteTermStoreSetChild?view=graph-powershell-beta)
