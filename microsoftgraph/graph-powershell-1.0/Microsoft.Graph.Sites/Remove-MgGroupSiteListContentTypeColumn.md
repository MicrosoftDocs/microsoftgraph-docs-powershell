...
Remove-MgGroupSiteListContentTypeColumn -ColumnDefinitionId <String> -ContentTypeId <String> -GroupId <String>
 -ListId <String> -SiteId <String> [-IfMatch <String>] [-Headers <IDictionary>] [-PassThru]
...
## RELATED LINKS
[Remove-MgBetaGroupSiteListContentTypeColumn](/powershell/module/Microsoft.Graph.Beta.Sites/Remove-MgBetaGroupSiteListContentTypeColumn?view=graph-powershell-beta)
