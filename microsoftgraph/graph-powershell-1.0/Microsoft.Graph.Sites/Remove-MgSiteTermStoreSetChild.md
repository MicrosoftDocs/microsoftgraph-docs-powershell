...
Remove-MgSiteTermStoreSetChild -SetId <String> -SiteId <String> -TermId <String> -StoreId <String>
 -TermId1 <String> [-IfMatch <String>] [-Headers <IDictionary>] [-PassThru]
...
### DeleteViaIdentity3
```
Remove-MgSiteTermStoreSetChild -InputObject <ISitesIdentity> [-IfMatch <String>] [-Headers <IDictionary>]
