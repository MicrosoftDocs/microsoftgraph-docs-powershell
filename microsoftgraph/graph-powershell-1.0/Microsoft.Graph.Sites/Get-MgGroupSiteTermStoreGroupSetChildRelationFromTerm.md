...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaGroupSiteTermStoreGroupSetChildRelationFromTerm](/powershell/module/Microsoft.Graph.Beta.Applications/Get-MgBetaGroupSiteTermStoreGroupSetChildRelationFromTerm?view=graph-powershell-beta)

## SYNTAX

### Get1 (Default)
```
Get-MgGroupSiteTermStoreGroupSetChildRelationFromTerm -GroupId <String> -GroupId1 <String> -RelationId <String>
...
## RELATED LINKS
[Get-MgBetaGroupSiteTermStoreGroupSetChildRelationFromTerm](/powershell/module/Microsoft.Graph.Beta.Applications/Get-MgBetaGroupSiteTermStoreGroupSetChildRelationFromTerm?view=graph-powershell-beta)
