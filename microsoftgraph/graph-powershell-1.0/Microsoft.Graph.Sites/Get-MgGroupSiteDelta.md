...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mggroupsitedelta
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Get-MgGroupSiteDelta
---
...
```
Get-MgGroupSiteDelta -GroupId <string> [-ExpandProperty <string[]>] [-Filter <string>]
...
```
Get-MgGroupSiteDelta -InputObject <ISitesIdentity> [-ExpandProperty <string[]>] [-Filter <string>]
 [-Property <string[]>] [-Search <string>] [-Skip <int>] [-Sort <string[]>] [-Top <int>] [-Count]
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
...
- [Get-MgGroupSiteDelta](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mggroupsitedelta)
