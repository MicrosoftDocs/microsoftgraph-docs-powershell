...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mggroupsiteonenotepage
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: Update-MgGroupSiteOnenotePage
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaGroupSiteOnenotePage](/powershell/module/Microsoft.Graph.Beta.Sites/Update-MgBetaGroupSiteOnenotePage?view=graph-powershell-beta)
...
```
Update-MgGroupSiteOnenotePage -InputObject <ISitesIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgGroupSiteOnenotePage -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphOnenotePage> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [Update-MgGroupSiteOnenotePage](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mggroupsiteonenotepage)
