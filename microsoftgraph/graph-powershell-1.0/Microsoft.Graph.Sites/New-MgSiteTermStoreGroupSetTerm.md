...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mgsitetermstoregroupsetterm
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: New-MgSiteTermStoreGroupSetTerm
---
...
```
New-MgSiteTermStoreGroupSetTerm -InputObject <ISitesIdentity> [-ResponseHeadersVariable <string>]
...
```
New-MgSiteTermStoreGroupSetTerm -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphTermStoreTerm> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgSiteTermStoreGroupSetTerm](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mgsitetermstoregroupsetterm)
