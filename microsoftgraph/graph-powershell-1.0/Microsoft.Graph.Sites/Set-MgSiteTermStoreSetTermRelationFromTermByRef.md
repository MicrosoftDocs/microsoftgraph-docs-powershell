...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/set-mgsitetermstoresettermrelationfromtermbyref
schema: 2.0.0
---
...
### SetExpanded (Default)
```
Set-MgSiteTermStoreSetTermRelationFromTermByRef -RelationId <String> -SetId <String> -SiteId <String>
...
```
Set-MgSiteTermStoreSetTermRelationFromTermByRef -InputObject <ISitesIdentity>
...
### SetViaIdentity1
```
Set-MgSiteTermStoreSetTermRelationFromTermByRef -InputObject <ISitesIdentity> -BodyParameter <Hashtable>
