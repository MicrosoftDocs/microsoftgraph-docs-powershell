...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/add-mgsitecontenttypecopy
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Add-MgSiteContentTypeCopy
---
...
```
Add-MgSiteContentTypeCopy -SiteId <string> [-ResponseHeadersVariable <string>]
...
```
Add-MgSiteContentTypeCopy -InputObject <ISitesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-ContentType <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
- [Add-MgSiteContentTypeCopy](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/add-mgsitecontenttypecopy)
