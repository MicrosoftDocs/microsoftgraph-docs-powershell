...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mggroupsitelistpermission
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 09/23/2026
PlatyPS schema version: 2024-05-01
title: Update-MgGroupSiteListPermission
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaGroupSiteListPermission](/powershell/module/Microsoft.Graph.Beta.Sites/Update-MgBetaGroupSiteListPermission?view=graph-powershell-beta)
...
```
Update-MgGroupSiteListPermission -GroupId <string> -ListId <string> -PermissionId <string>
...
```
Update-MgGroupSiteListPermission -GroupId <string> -ListId <string> -PermissionId <string>
 -SiteId <string> -BodyParameter <IMicrosoftGraphPermission> [-ResponseHeadersVariable <string>]
...
```
Update-MgGroupSiteListPermission -InputObject <ISitesIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgGroupSiteListPermission -InputObject <ISitesIdentity>
...
- [Update-MgGroupSiteListPermission](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mggroupsitelistpermission)
