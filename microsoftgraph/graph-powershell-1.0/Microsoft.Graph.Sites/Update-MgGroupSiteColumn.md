...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mggroupsitecolumn
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Update-MgGroupSiteColumn
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaGroupSiteColumn](/powershell/module/Microsoft.Graph.Beta.Sites/Update-MgBetaGroupSiteColumn?view=graph-powershell-beta)
...
```
Update-MgGroupSiteColumn -InputObject <ISitesIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgGroupSiteColumn -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphColumnDefinition> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [Update-MgGroupSiteColumn](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mggroupsitecolumn)
