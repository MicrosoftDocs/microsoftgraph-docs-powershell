...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mgsitetermstore
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: New-MgSiteTermStore
---
...
```
New-MgSiteTermStore -SiteId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgSiteTermStore -SiteId <string> -BodyParameter <IMicrosoftGraphTermStore>
...
```
New-MgSiteTermStore -InputObject <ISitesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-DefaultLanguageTag <string>]
 [-Groups <IMicrosoftGraphTermStoreGroup[]>] [-Id <string>] [-LanguageTags <string[]>]
 [-Sets <IMicrosoftGraphTermStoreSet[]>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
