...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaGroupSiteListItemDocumentSetVersion](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaGroupSiteListItemDocumentSetVersion?view=graph-powershell-beta)
...
Update-MgGroupSiteListItemDocumentSetVersion -DocumentSetVersionId <String> -GroupId <String> -ListId <String>
 -ListItemId <String> -SiteId <String> [-AdditionalProperties <Hashtable>] [-Comment <String>]
...
```
Update-MgGroupSiteListItemDocumentSetVersion -DocumentSetVersionId <String> -GroupId <String> -ListId <String>
 -ListItemId <String> -SiteId <String> -BodyParameter <IMicrosoftGraphDocumentSetVersion> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgGroupSiteListItemDocumentSetVersion -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]
...
## RELATED LINKS
[Update-MgBetaGroupSiteListItemDocumentSetVersion](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaGroupSiteListItemDocumentSetVersion?view=graph-powershell-beta)
