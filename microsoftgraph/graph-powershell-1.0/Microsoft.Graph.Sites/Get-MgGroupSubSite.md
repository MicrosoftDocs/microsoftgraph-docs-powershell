...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mggroupsubsite
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Get-MgGroupSubSite
---
...
```
Get-MgGroupSubSite -GroupId <string> [-SiteId <string>] [-ExpandProperty <string[]>]
...
```
Get-MgGroupSubSite -GroupId <string> -SiteId1 <string> [-SiteId <string>]
...
- [Get-MgGroupSubSite](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mggroupsubsite)
