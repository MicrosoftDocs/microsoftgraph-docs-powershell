...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mggroupsitetermstoresetterm
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: New-MgGroupSiteTermStoreSetTerm
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaGroupSiteTermStoreSetTerm](/powershell/module/Microsoft.Graph.Beta.Sites/New-MgBetaGroupSiteTermStoreSetTerm?view=graph-powershell-beta)
...
```
New-MgGroupSiteTermStoreSetTerm -InputObject <ISitesIdentity> [-ResponseHeadersVariable <string>]
...
```
New-MgGroupSiteTermStoreSetTerm -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphTermStoreTerm> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgGroupSiteTermStoreSetTerm](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mggroupsitetermstoresetterm)
