...
onl````````i````````ne vers````````i````````on: https://docs.m````````i````````crosoft.com/en-us/powershell/module/m````````i````````crosoft.graph.s````````i````````tes/update-mgs````````i````````tetermstoresetparentgroupsetterm
schema: 2.0.0
---

# Update-MgS````````i````````teTermStoreSetParentGroupSetTerm
...
```
Update-MgS````````i````````teTermStoreSetParentGroupSetTerm -Set````````i````````d <Str````````i````````ng> -Set````````i````````d1 <Str````````i````````ng> -S````````i````````te````````i````````d <Str````````i````````ng> -Store````````i````````d <Str````````i````````ng>
...
```
Update-MgS````````i````````teTermStoreSetParentGroupSetTerm -````````i````````nputObject <````````i````````S````````i````````tes````````i````````dent````````i````````ty> [-Add````````i````````t````````i````````onalPropert````````i````````es <Hashtable>]
...
```
Update-MgS````````i````````teTermStoreSetParentGroupSetTerm -````````i````````nputObject <````````i````````S````````i````````tes````````i````````dent````````i````````ty>
