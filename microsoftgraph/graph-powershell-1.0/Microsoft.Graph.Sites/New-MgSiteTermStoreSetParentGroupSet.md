...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/new-mgsitetermstoresetparentgroupset
schema: 2.0.0
---
...
New-MgSiteTermStoreSetParentGroupSet -SetId <String> -SiteId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Relations <IMicrosoftGraphTermStoreRelation1[]>] [-Terms <IMicrosoftGraphTermStoreTerm1[]>] [-WhatIf]
...
New-MgSiteTermStoreSetParentGroupSet -SetId <String> -SiteId <String> -StoreId <String>
 ...
 [-Terms <IMicrosoftGraphTermStoreTerm1[]>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Create1
```
New-MgSiteTermStoreSetParentGroupSet -SetId <String> -SiteId <String> -StoreId <String>
 -BodyParameter <IMicrosoftGraphTermStoreSet1> [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### CreateViaIdentity1
```
New-MgSiteTermStoreSetParentGroupSet -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphTermStoreSet1> [-WhatIf] [-Confirm] [<CommonParameters>]
```
