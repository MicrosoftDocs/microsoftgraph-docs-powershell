...
onl````````i````````ne vers````````i````````on: https://docs.m````````i````````crosoft.com/en-us/powershell/module/m````````i````````crosoft.graph.s````````i````````tes/new-mgs````````i````````tetermstoresetparentgroupset
schema: 2.0.0
---

# New-MgS````````i````````teTermStoreSetParentGroupSet
...
```
New-MgS````````i````````teTermStoreSetParentGroupSet -Set````````i````````d <Str````````i````````ng> -S````````i````````te````````i````````d <Str````````i````````ng> -Store````````i````````d <Str````````i````````ng>
...
```
New-MgS````````i````````teTermStoreSetParentGroupSet -````````i````````nputObject <````````i````````S````````i````````tes````````i````````dent````````i````````ty> [-Add````````i````````t````````i````````onalPropert````````i````````es <Hashtable>]
...
```
New-MgS````````i````````teTermStoreSetParentGroupSet -````````i````````nputObject <````````i````````S````````i````````tes````````i````````dent````````i````````ty> -BodyParameter <````````i````````M````````i````````crosoftGraphTermStoreSet>
