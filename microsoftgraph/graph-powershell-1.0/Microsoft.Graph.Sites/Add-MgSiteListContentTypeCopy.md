...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/add-mgsitelistcontenttypecopy
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Add-MgSiteListContentTypeCopy
---
...
```
Add-MgSiteListContentTypeCopy -ListId <string> -SiteId <string> [-ResponseHeadersVariable <string>]
...
```
Add-MgSiteListContentTypeCopy -InputObject <ISitesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-ContentType <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
- [Add-MgSiteListContentTypeCopy](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/add-mgsitelistcontenttypecopy)
