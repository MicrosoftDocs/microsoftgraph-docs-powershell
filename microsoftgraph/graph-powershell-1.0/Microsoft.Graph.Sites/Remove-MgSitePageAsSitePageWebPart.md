...
### Delete (Default)
```
Remove-MgSitePageAsSitePageWebPart -BaseSitePageId <String> -SiteId <String> -WebPartId <String>
...
### DeleteViaIdentity
```
Remove-MgSitePageAsSitePageWebPart -InputObject <ISitesIdentity> [-IfMatch <String>]
...
## RELATED LINKS
[Remove-MgBetaSitePageAsSitePageWebPart](/powershell/module/Microsoft.Graph.Beta.Sites/Remove-MgBetaSitePageAsSitePageWebPart?view=graph-powershell-beta)
