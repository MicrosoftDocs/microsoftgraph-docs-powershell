...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/remove-mggroupsite
schema: 2.0.0
...
```
Remove-MgGroupSite -GroupId <String> [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>]
...
```
Remove-MgGroupSite -InputObject <ISitesIdentity> [-ResponseHeadersVariable <String>]
...
### RemoveViaIdentity
```
Remove-MgGroupSite -InputObject <ISitesIdentity>
 -BodyParameter <IPaths8J6HbtGroupsGroupIdSitesMicrosoftGraphRemovePostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
