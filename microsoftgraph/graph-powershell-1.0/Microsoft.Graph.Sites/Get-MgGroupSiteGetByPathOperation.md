...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mggroupsitegetbypathoperation
schema: 2.0.0
---
...
### List1 (Default)
```
Get-MgGroupSiteGetByPathOperation -GroupId <String> -Path <String> -SiteId <String>
...
### List
```
Get-MgGroupSiteGetByPathOperation -GroupId <String> -Path <String> -SiteId <String> -Path1 <String>
 [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>] [-Search <String>] [-Skip <Int32>]
 [-Sort <String[]>] [-Top <Int32>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-PageSize <Int32>] [-All] [-CountVariable <String>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
