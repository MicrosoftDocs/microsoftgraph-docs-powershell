...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mggroupsitepageassitepagecanvalayout
schema: 2.0.0
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaGroupSitePageAsSitePageCanvaLayout](/powershell/module/Microsoft.Graph.Beta.Sites/Update-MgBetaGroupSitePageAsSitePageCanvaLayout?view=graph-powershell-beta)

## SYNTAX

### UpdateExpanded (Default)
```
Update-MgGroupSitePageAsSitePageCanvaLayout -BaseSitePageId <String> -GroupId <String> -SiteId <String>
...
```
Update-MgGroupSitePageAsSitePageCanvaLayout -InputObject <ISitesIdentity> [-ResponseHeadersVariable <String>]
...
### UpdateViaIdentity
```
Update-MgGroupSitePageAsSitePageCanvaLayout -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphCanvasLayout> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgBetaGroupSitePageAsSitePageCanvaLayout](/powershell/module/Microsoft.Graph.Beta.Sites/Update-MgBetaGroupSitePageAsSitePageCanvaLayout?view=graph-powershell-beta)

[https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mggroupsitepageassitepagecanvalayout](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mggroupsitepageassitepagecanvalayout)
