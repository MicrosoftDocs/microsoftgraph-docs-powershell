...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/copy-mggroupsitecontenttypetodefaultcontentlocation
schema: 2.0.0
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Copy-MgBetaGroupSiteContentTypeToDefaultContentLocation](/powershell/module/Microsoft.Graph.Beta.Sites/Copy-MgBetaGroupSiteContentTypeToDefaultContentLocation?view=graph-powershell-beta)
...
```
Copy-MgGroupSiteContentTypeToDefaultContentLocation -InputObject <ISitesIdentity>
 [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>] [-DestinationFileName <String>]
 [-SourceFile <IMicrosoftGraphItemReference>] [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.sites/copy-mggroupsitecontenttypetodefaultcontentlocation](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/copy-mggroupsitecontenttypetodefaultcontentlocation)
