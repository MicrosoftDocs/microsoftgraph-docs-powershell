...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mggroupsitecolumn
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Get-MgGroupSiteColumn
---
...
```
Get-MgGroupSiteColumn -GroupId <string> [-SiteId <string>] [-ExpandProperty <string[]>]
...
```
Get-MgGroupSiteColumn -InputObject <ISitesIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgGroupSiteColumn](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mggroupsitecolumn)
