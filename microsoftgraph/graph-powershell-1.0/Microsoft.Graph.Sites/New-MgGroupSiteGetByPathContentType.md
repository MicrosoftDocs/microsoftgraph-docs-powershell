...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mggroupsitegetbypathcontenttype
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: New-MgGroupSiteGetByPathContentType
---
...
```
New-MgGroupSiteGetByPathContentType -InputObject <ISitesIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-AssociatedHubsUrls <string[]>] [-Base <IMicrosoftGraphContentType>]
 [-BaseTypes <IMicrosoftGraphContentType[]>] [-ColumnLinks <IMicrosoftGraphColumnLink[]>]
 [-ColumnPositions <IMicrosoftGraphColumnDefinition[]>]
...
- [New-MgGroupSiteGetByPathContentType](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mggroupsitegetbypathcontenttype)
