...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mggroupsitelistcolumn
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: New-MgGroupSiteListColumn
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaGroupSiteListColumn](/powershell/module/Microsoft.Graph.Beta.Sites/New-MgBetaGroupSiteListColumn?view=graph-powershell-beta)
...
```
New-MgGroupSiteListColumn -InputObject <ISitesIdentity> [-ResponseHeadersVariable <string>]
...
```
New-MgGroupSiteListColumn -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphColumnDefinition> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgGroupSiteListColumn](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mggroupsitelistcolumn)
