...
### List1 (Default)
```
Get-MgSiteGetByPathOperation -Path <String> -SiteId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### List
```
Get-MgSiteGetByPathOperation -Path <String> -SiteId <String> -Path1 <String> [-ExpandProperty <String[]>]
...
## RELATED LINKS
[Get-MgBetaSiteGetByPathOperation](/powershell/module/Microsoft.Graph.Beta.Sites/Get-MgBetaSiteGetByPathOperation?view=graph-powershell-beta)
