...
### Get3
```
Get-MgGroupSiteDrive -GroupId <String> -SiteId <String> -DriveId <String> [-ExpandProperty <String[]>]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/get-mggroupsitedrive](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/get-mggroupsitedrive)
