...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaSitePermission](/powershell/module/Microsoft.Graph.Beta.Sites/New-MgBetaSitePermission?view=graph-powershell-beta)
...
```
New-MgSitePermission -SiteId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgSitePermission -SiteId <string> -BodyParameter <IMicrosoftGraphPermission>
...
```
New-MgSitePermission -InputObject <ISitesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-ExpirationDateTime <datetime>]
 [-GrantedTo <IMicrosoftGraphIdentitySet>] [-GrantedToIdentities <IMicrosoftGraphIdentitySet[]>]
 [-GrantedToIdentitiesV2 <IMicrosoftGraphSharePointIdentitySet[]>]
 [-GrantedToV2 <IMicrosoftGraphSharePointIdentitySet>] [-HasPassword] [-Id <string>]
...
```
New-MgSitePermission -InputObject <ISitesIdentity> -BodyParameter <IMicrosoftGraphPermission>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
- [New-MgSitePermission](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mgsitepermission)
- [Graph API Reference](https://learn.microsoft.com/graph/api/site-post-permissions?view=graph-rest-1.0)
