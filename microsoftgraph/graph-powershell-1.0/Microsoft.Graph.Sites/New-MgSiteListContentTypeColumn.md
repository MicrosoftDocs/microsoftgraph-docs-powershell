...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mgsitelistcontenttypecolumn
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: New-MgSiteListContentTypeColumn
---
...
```
New-MgSiteListContentTypeColumn -InputObject <ISitesIdentity> [-ResponseHeadersVariable <string>]
...
```
New-MgSiteListContentTypeColumn -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphColumnDefinition> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgSiteListContentTypeColumn](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mgsitelistcontenttypecolumn)
