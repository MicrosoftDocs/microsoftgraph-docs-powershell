...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaGroupSiteContentTypeBaseType](/powershell/module/Microsoft.Graph.Beta.Applications/Get-MgBetaGroupSiteContentTypeBaseType?view=graph-powershell-beta)
...
```
Get-MgGroupSiteContentTypeBaseType -ContentTypeId <String> -GroupId <String> [-SiteId <String>]
 -ListId <String> [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>] [-Search <String>]
...
Get-MgGroupSiteContentTypeBaseType -ContentTypeId <String> -ContentTypeId1 <String> -GroupId <String>
 [-SiteId <String>] -ListId <String> [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
...
## RELATED LINKS
[Get-MgBetaGroupSiteContentTypeBaseType](/powershell/module/Microsoft.Graph.Beta.Applications/Get-MgBetaGroupSiteContentTypeBaseType?view=graph-powershell-beta)
