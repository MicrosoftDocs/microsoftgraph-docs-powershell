...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mgsubsite
Locale: en-US
...
```
Get-MgSubSite [-SiteId <string>] [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgSubSite -SiteId1 <string> [-SiteId <string>] [-ExpandProperty <string[]>]
