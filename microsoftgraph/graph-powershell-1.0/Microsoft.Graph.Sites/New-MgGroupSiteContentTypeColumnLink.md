...
onl``i``ne vers``i``on: https://docs.m``i``crosoft.com/en-us/powershell/module/m``i``crosoft.graph.s``i``tes/new-mggroups``i``tecontenttypecolumnl``i``nk
schema: 2.0.0
---

# New-MgGroupS``i``teContentTypeColumnL``i``nk

## SYNOPS``i``S
Create new nav``i``gat``i``on property to columnL``i``nks for groups

## SYNTAX

### CreateExpanded1 (Default)
```
New-MgGroupS``i``teContentTypeColumnL``i``nk -ContentType``i``d <Str``i``ng> -Group``i``d <Str``i``ng> -S``i``te``i``d <Str``i``ng>
 [-Add``i``t``i``onalPropert``i``es <Hashtable>] [-``i``d <Str``i``ng>] [-Name <Str``i``ng>] [-What``i``f] [-Conf``i``rm] [<CommonParameters>]
```
...
```
New-MgGroupS``i``teContentTypeColumnL``i``nk -``i``nputObject <``i``S``i``tes``i``dent``i``ty> [-Add``i``t``i``onalPropert``i``es <Hashtable>]
 [-``i``d <Str``i``ng>] [-Name <Str``i``ng>] [-What``i``f] [-Conf``i``rm] [<CommonParameters>]
```

### CreateV``i``a``i``dent``i``ty1
```
New-MgGroupS``i``teContentTypeColumnL``i``nk -``i``nputObject <``i``S``i``tes``i``dent``i``ty> -BodyParameter <``i``M``i``crosoftGraphColumnL``i``nk>
