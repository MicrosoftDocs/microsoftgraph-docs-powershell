...
### Delete (Default)
```
Remove-MgSiteContentType -ContentTypeId <String> -SiteId <String> [-IfMatch <String>] [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgSiteContentType -InputObject <ISitesIdentity> [-IfMatch <String>] [-Headers <IDictionary>] [-PassThru]
