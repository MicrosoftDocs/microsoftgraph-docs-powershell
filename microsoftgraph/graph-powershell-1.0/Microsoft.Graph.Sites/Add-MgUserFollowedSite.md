...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/add-mguserfollowedsite
schema: 2.0.0
...
### AddExpanded (Default)
```
Add-MgUserFollowedSite -UserId <String> [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>]
...
```yaml
Type: IPaths1L6Rc2GUsersUserIdFollowedsitesMicrosoftGraphAddPostRequestbodyContentApplicationJsonSchema
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.sites/add-mguserfollowedsite](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/add-mguserfollowedsite)
