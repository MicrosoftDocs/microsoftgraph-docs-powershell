...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/add-mguserfollowedsite
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: Add-MgUserFollowedSite
---
...
```
Add-MgUserFollowedSite -UserId <string> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Value <IMicrosoftGraphSite[]>] [-Break]
...
```
Add-MgUserFollowedSite -UserId <string>
 -BodyParameter <IPaths1L6Rc2GUsersUserIdFollowedsitesMicrosoftGraphAddPostRequestbodyContentApplicationJsonSchema>
...
```
Add-MgUserFollowedSite -InputObject <ISitesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Value <IMicrosoftGraphSite[]>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```
Add-MgUserFollowedSite -InputObject <ISitesIdentity>
 -BodyParameter <IPaths1L6Rc2GUsersUserIdFollowedsitesMicrosoftGraphAddPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths1L6Rc2GUsersUserIdFollowedsitesMicrosoftGraphAddPostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.PowerShell.Models.IPaths1L6Rc2GUsersUserIdFollowedsitesMicrosoftGraphAddPostRequestbodyContentApplicationJsonSchema
...
- [Add-MgUserFollowedSite](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/add-mguserfollowedsite)
