...
```
Update-MgGroupSiteListItem -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]
...
### UpdateViaIdentity
```
Update-MgGroupSiteListItem -InputObject <ISitesIdentity> -BodyParameter <IMicrosoftGraphListItem1> [-PassThru]
