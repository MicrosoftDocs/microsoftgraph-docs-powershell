...
onl`````i`````ne vers`````i`````on: https://docs.m`````i`````crosoft.com/en-us/powershell/module/m`````i`````crosoft.graph.s`````i`````tes/update-mggroups`````i`````tetermstoresettermch`````i`````ldrelat`````i`````on
schema: 2.0.0
---

# Update-MgGroupS`````i`````teTermStoreSetTermCh`````i`````ldRelat`````i`````on
...
```
Update-MgGroupS`````i`````teTermStoreSetTermCh`````i`````ldRelat`````i`````on -Group`````i`````d <Str`````i`````ng> -Relat`````i`````on`````i`````d <Str`````i`````ng> -Set`````i`````d <Str`````i`````ng>
...
```
Update-MgGroupS`````i`````teTermStoreSetTermCh`````i`````ldRelat`````i`````on -`````i`````nputObject <`````i`````S`````i`````tes`````i`````dent`````i`````ty>
