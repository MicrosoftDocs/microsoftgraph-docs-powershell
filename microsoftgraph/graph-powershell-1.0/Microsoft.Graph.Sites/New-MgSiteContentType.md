...
### Create
```
New-MgSiteContentType -SiteId <String> -BodyParameter <IMicrosoftGraphContentType> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgSiteContentType -InputObject <ISitesIdentity> -BodyParameter <IMicrosoftGraphContentType> [-Confirm]
