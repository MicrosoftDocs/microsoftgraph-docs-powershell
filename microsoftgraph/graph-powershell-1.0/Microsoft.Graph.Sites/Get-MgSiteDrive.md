...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mgsitedrive
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Get-MgSiteDrive
---
...
```
Get-MgSiteDrive -SiteId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgSiteDrive -DriveId <string> -SiteId <string> [-ExpandProperty <string[]>]
...
- [Get-MgSiteDrive](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mgsitedrive)
