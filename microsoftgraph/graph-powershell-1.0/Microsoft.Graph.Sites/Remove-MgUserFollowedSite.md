...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/remove-mguserfollowedsite
schema: 2.0.0
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Remove-MgBetaUserFollowedSite](/powershell/module/Microsoft.Graph.Beta.Sites/Remove-MgBetaUserFollowedSite?view=graph-powershell-beta)

## SYNTAX

### RemoveExpanded (Default)
```
Remove-MgUserFollowedSite -UserId <String> [-ResponseHeadersVariable <String>]
...
### Remove
```
Remove-MgUserFollowedSite -UserId <String>
 -BodyParameter <IPaths4Vl3HqUsersUserIdFollowedsitesMicrosoftGraphRemovePostRequestbodyContentApplicationJsonSchema>
...
```
Remove-MgUserFollowedSite -InputObject <ISitesIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-Value <IMicrosoftGraphSite[]>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### RemoveViaIdentity
```
Remove-MgUserFollowedSite -InputObject <ISitesIdentity>
 -BodyParameter <IPaths4Vl3HqUsersUserIdFollowedsitesMicrosoftGraphRemovePostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
```yaml
Type: IPaths4Vl3HqUsersUserIdFollowedsitesMicrosoftGraphRemovePostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.PowerShell.Models.IPaths4Vl3HqUsersUserIdFollowedsitesMicrosoftGraphRemovePostRequestbodyContentApplicationJsonSchema
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.sites/remove-mguserfollowedsite](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/remove-mguserfollowedsite)
