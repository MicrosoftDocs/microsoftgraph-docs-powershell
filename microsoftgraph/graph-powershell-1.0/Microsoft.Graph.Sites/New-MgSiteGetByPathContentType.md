...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mgsitegetbypathcontenttype
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: New-MgSiteGetByPathContentType
---

# New-MgSiteGetByPathContentType
...
```
New-MgSiteGetByPathContentType -Path <string> -SiteId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgSiteGetByPathContentType -Path <string> -SiteId <string>
...
```
New-MgSiteGetByPathContentType -InputObject <ISitesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-AssociatedHubsUrls <string[]>]
 [-Base <IMicrosoftGraphContentType>] [-BaseTypes <IMicrosoftGraphContentType[]>]
 [-ColumnLinks <IMicrosoftGraphColumnLink[]>] [-ColumnPositions <IMicrosoftGraphColumnDefinition[]>]
 [-Columns <IMicrosoftGraphColumnDefinition[]>] [-Description <string>]
...
```
New-MgSiteGetByPathContentType -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphContentType> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgSiteGetByPathContentType](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mgsitegetbypathcontenttype)
