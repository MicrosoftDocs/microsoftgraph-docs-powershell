...
> [!NOTE]
> To view the beta release of this cmdlet, view [Remove-MgBetaSiteContentTypeColumn](/powershell/module/Microsoft.Graph.Beta.Applications/Remove-MgBetaSiteContentTypeColumn?view=graph-powershell-beta)
...
### DeleteViaIdentity
```
Remove-MgSiteContentTypeColumn -InputObject <ISitesIdentity> [-IfMatch <String>] [-PassThru] [-WhatIf]
...
## RELATED LINKS
[Remove-MgBetaSiteContentTypeColumn](/powershell/module/Microsoft.Graph.Beta.Applications/Remove-MgBetaSiteContentTypeColumn?view=graph-powershell-beta)
