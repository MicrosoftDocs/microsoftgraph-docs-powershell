...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mggroupsitegetbypathonenote
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Update-MgGroupSiteGetByPathOnenote
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaGroupSiteGetByPathOnenote](/powershell/module/Microsoft.Graph.Beta.Sites/Update-MgBetaGroupSiteGetByPathOnenote?view=graph-powershell-beta)
...
```
Update-MgGroupSiteGetByPathOnenote -InputObject <ISitesIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgGroupSiteGetByPathOnenote -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphOnenote> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [Update-MgGroupSiteGetByPathOnenote](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mggroupsitegetbypathonenote)
