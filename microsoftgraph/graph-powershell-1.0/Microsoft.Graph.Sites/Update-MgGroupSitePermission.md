...
onl`````````i`````````ne vers`````````i`````````on: https://docs.m`````````i`````````crosoft.com/en-us/powershell/module/m`````````i`````````crosoft.graph.s`````````i`````````tes/update-mggroups`````````i`````````teperm`````````i`````````ss`````````i`````````on
schema: 2.0.0
---

# Update-MgGroupS`````````i`````````tePerm`````````i`````````ss`````````i`````````on
...
```
Update-MgGroupS`````````i`````````tePerm`````````i`````````ss`````````i`````````on -Group`````````i`````````d <Str`````````i`````````ng> -Perm`````````i`````````ss`````````i`````````on`````````i`````````d <Str`````````i`````````ng> -S`````````i`````````te`````````i`````````d <Str`````````i`````````ng>
...
```
Update-MgGroupS`````````i`````````tePerm`````````i`````````ss`````````i`````````on -Group`````````i`````````d <Str`````````i`````````ng> -Perm`````````i`````````ss`````````i`````````on`````````i`````````d <Str`````````i`````````ng> -S`````````i`````````te`````````i`````````d <Str`````````i`````````ng>
 -BodyParameter <`````````i`````````M`````````i`````````crosoftGraphPerm`````````i`````````ss`````````i`````````on1> [-PassThru] [-What`````````i`````````f] [-Conf`````````i`````````rm] [<CommonParameters>]
```

### UpdateV`````````i`````````a`````````i`````````dent`````````i`````````tyExpanded1
```
Update-MgGroupS`````````i`````````tePerm`````````i`````````ss`````````i`````````on -`````````i`````````nputObject <`````````i`````````S`````````i`````````tes`````````i`````````dent`````````i`````````ty> [-Add`````````i`````````t`````````i`````````onalPropert`````````i`````````es <Hashtable>]
...
```
Update-MgGroupS`````````i`````````tePerm`````````i`````````ss`````````i`````````on -`````````i`````````nputObject <`````````i`````````S`````````i`````````tes`````````i`````````dent`````````i`````````ty> -BodyParameter <`````````i`````````M`````````i`````````crosoftGraphPerm`````````i`````````ss`````````i`````````on1>
