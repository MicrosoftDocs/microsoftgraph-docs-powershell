...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mgsitelistpermission
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: New-MgSiteListPermission
---

# New-MgSiteListPermission
...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaSiteListPermission](/powershell/module/Microsoft.Graph.Beta.Sites/New-MgBetaSiteListPermission?view=graph-powershell-beta)
...
```
New-MgSiteListPermission -ListId <string> -SiteId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgSiteListPermission -ListId <string> -SiteId <string>
...
```
New-MgSiteListPermission -InputObject <ISitesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-ExpirationDateTime <datetime>]
 [-GrantedTo <IMicrosoftGraphIdentitySet>] [-GrantedToIdentities <IMicrosoftGraphIdentitySet[]>]
 [-GrantedToIdentitiesV2 <IMicrosoftGraphSharePointIdentitySet[]>]
 [-GrantedToV2 <IMicrosoftGraphSharePointIdentitySet>] [-HasPassword] [-Id <string>]
...
```
New-MgSiteListPermission -InputObject <ISitesIdentity> -BodyParameter <IMicrosoftGraphPermission>
