...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/join-mggroupsitecontenttypewithhubsite
schema: 2.0.0
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Join-MgBetaGroupSiteContentTypeWithHubSite](/powershell/module/Microsoft.Graph.Beta.Sites/Join-MgBetaGroupSiteContentTypeWithHubSite?view=graph-powershell-beta)
...
```
Join-MgGroupSiteContentTypeWithHubSite -InputObject <ISitesIdentity> [-ResponseHeadersVariable <String>]
...
```
Join-MgGroupSiteContentTypeWithHubSite -InputObject <ISitesIdentity>
 -BodyParameter <IPaths1Lktc19GroupsGroupIdSitesSiteIdContenttypesContenttypeIdMicrosoftGraphAssociatewithhubsitesPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.sites/join-mggroupsitecontenttypewithhubsite](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/join-mggroupsitecontenttypewithhubsite)
