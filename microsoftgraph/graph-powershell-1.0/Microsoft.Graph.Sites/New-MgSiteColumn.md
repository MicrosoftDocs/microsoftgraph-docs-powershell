...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mgsitecolumn
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: New-MgSiteColumn
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaSiteColumn](/powershell/module/Microsoft.Graph.Beta.Sites/New-MgBetaSiteColumn?view=graph-powershell-beta)
...
```
New-MgSiteColumn -SiteId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgSiteColumn -InputObject <ISitesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Boolean <hashtable>]
 [-Calculated <IMicrosoftGraphCalculatedColumn>] [-Choice <IMicrosoftGraphChoiceColumn>]
 [-ColumnGroup <string>] [-ContentApprovalStatus <hashtable>]
 [-Currency <IMicrosoftGraphCurrencyColumn>] [-DateTime <IMicrosoftGraphDateTimeColumn>]
