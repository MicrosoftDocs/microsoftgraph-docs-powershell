...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mggroupsitegetbypathlist
schema: 2.0.0
---
...
```
Get-MgGroupSiteGetByPathList -GroupId <String> -Path <String> -Path1 <String> -SiteId <String>
