...
### Delete (Default)
```
Remove-MgSiteListContentTypeColumn -ColumnDefinitionId <String> -ContentTypeId <String> -ListId <String>
...
### DeleteViaIdentity
```
Remove-MgSiteListContentTypeColumn -InputObject <ISitesIdentity> [-IfMatch <String>] [-Headers <IDictionary>]
