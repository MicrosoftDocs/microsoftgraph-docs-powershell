...
onl````````i````````ne vers````````i````````on: https://docs.m````````i````````crosoft.com/en-us/powershell/module/m````````i````````crosoft.graph.s````````i````````tes/update-mggroups````````i````````tetermstoresetparentgroupsetterm
schema: 2.0.0
---

# Update-MgGroupS````````i````````teTermStoreSetParentGroupSetTerm
...
```
Update-MgGroupS````````i````````teTermStoreSetParentGroupSetTerm -Group````````i````````d <Str````````i````````ng> -Set````````i````````d <Str````````i````````ng> -Set````````i````````d1 <Str````````i````````ng>
...
```
Update-MgGroupS````````i````````teTermStoreSetParentGroupSetTerm -````````i````````nputObject <````````i````````S````````i````````tes````````i````````dent````````i````````ty>
