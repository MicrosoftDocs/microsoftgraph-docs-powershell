...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/remove-mgsitelistitem
schema: 2.0.0
---
...
### Example 1: Using the Remove-MgSiteListItem Cmdlet
```powershell
