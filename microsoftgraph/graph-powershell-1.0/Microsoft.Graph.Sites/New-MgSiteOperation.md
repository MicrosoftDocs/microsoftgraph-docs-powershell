...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaSiteOperation](/powershell/module/Microsoft.Graph.Beta.Applications/New-MgBetaSiteOperation?view=graph-powershell-beta)
...
### Create
```
New-MgSiteOperation -SiteId <String> -BodyParameter <IMicrosoftGraphRichLongRunningOperation> [-WhatIf]
...
## RELATED LINKS
[New-MgBetaSiteOperation](/powershell/module/Microsoft.Graph.Beta.Applications/New-MgBetaSiteOperation?view=graph-powershell-beta)
