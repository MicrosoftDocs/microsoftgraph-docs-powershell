...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/add-mggroupsitelistcontenttypecopy
schema: 2.0.0
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Add-MgBetaGroupSiteListContentTypeCopy](/powershell/module/Microsoft.Graph.Beta.Sites/Add-MgBetaGroupSiteListContentTypeCopy?view=graph-powershell-beta)
...
```
Add-MgGroupSiteListContentTypeCopy -InputObject <ISitesIdentity> [-ResponseHeadersVariable <String>]
...
### AddViaIdentity
```
Add-MgGroupSiteListContentTypeCopy -InputObject <ISitesIdentity>
 -BodyParameter <IPathsEgdmnfGroupsGroupIdSitesSiteIdListsListIdContenttypesMicrosoftGraphAddcopyPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.sites/add-mggroupsitelistcontenttypecopy](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/add-mggroupsitelistcontenttypecopy)
