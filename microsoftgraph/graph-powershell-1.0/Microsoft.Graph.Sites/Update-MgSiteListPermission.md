...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mgsitelistpermission
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Update-MgSiteListPermission
---

# Update-MgSiteListPermission
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaSiteListPermission](/powershell/module/Microsoft.Graph.Beta.Sites/Update-MgBetaSiteListPermission?view=graph-powershell-beta)
...
```
Update-MgSiteListPermission -ListId <string> -PermissionId <string> -SiteId <string>
...
```
Update-MgSiteListPermission -InputObject <ISitesIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgSiteListPermission -InputObject <ISitesIdentity> -BodyParameter <IMicrosoftGraphPermission>
