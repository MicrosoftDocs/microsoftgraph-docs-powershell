...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mggroupsitegetbypathtermstore
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: Update-MgGroupSiteGetByPathTermStore
---
...
```
Update-MgGroupSiteGetByPathTermStore -InputObject <ISitesIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-DefaultLanguageTag <string>] [-Groups <IMicrosoftGraphTermStoreGroup[]>] [-Id <string>]
 [-LanguageTags <string[]>] [-Sets <IMicrosoftGraphTermStoreSet[]>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mggroupsitegetbypathtermstore)
