...
### Get (Default)
```
Get-MgSiteApplicableContentTypeForList -ListId <String> -SiteId <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgSiteApplicableContentTypeForList -InputObject <ISitesIdentity> [-Count] [-ExpandProperty <String[]>]
 [-Filter <String>] [-Property <String[]>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>] [-Top <Int32>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
