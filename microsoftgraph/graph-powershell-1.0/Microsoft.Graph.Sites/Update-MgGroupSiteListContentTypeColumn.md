...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaGroupSiteListContentTypeColumn](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaGroupSiteListContentTypeColumn?view=graph-powershell-beta)
...
```
Update-MgGroupSiteListContentTypeColumn -ColumnDefinitionId <String> -ContentTypeId <String> -GroupId <String>
 -ListId <String> -SiteId <String> -BodyParameter <IMicrosoftGraphColumnDefinition> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgBetaGroupSiteListContentTypeColumn](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaGroupSiteListContentTypeColumn?view=graph-powershell-beta)
