...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mggroupsitegetbypathcolumn
schema: 2.0.0
---
...
### CreateExpanded1
```
New-MgGroupSiteGetByPathColumn -GroupId <String> -Path <String> -SiteId <String> -Path1 <String>
 [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>] [-Boolean <Hashtable>]
 [-Calculated <IMicrosoftGraphCalculatedColumn>] [-Choice <IMicrosoftGraphChoiceColumn>]
 [-ColumnGroup <String>] [-ContentApprovalStatus <Hashtable>] [-Currency <IMicrosoftGraphCurrencyColumn>]
 [-DateTime <IMicrosoftGraphDateTimeColumn>] [-DefaultValue <IMicrosoftGraphDefaultColumnValue>]
...
### CreateViaIdentity1
```
New-MgGroupSiteGetByPathColumn -InputObject <ISitesIdentity> -BodyParameter <IMicrosoftGraphColumnDefinition>
