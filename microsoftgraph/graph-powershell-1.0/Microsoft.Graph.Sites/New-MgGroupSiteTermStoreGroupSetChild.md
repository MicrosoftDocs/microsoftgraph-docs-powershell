...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaGroupSiteTermStoreGroupSetChild](/powershell/module/Microsoft.Graph.Beta.Applications/New-MgBetaGroupSiteTermStoreGroupSetChild?view=graph-powershell-beta)
...
```
New-MgGroupSiteTermStoreGroupSetChild -GroupId <String> -GroupId1 <String> -SetId <String> -SiteId <String>
 -StoreId <String> -TermId <String> -BodyParameter <IMicrosoftGraphTermStoreTerm> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
## RELATED LINKS
[New-MgBetaGroupSiteTermStoreGroupSetChild](/powershell/module/Microsoft.Graph.Beta.Applications/New-MgBetaGroupSiteTermStoreGroupSetChild?view=graph-powershell-beta)
