...
onl````````i````````ne vers````````i````````on: https://docs.m````````i````````crosoft.com/en-us/powershell/module/m````````i````````crosoft.graph.s````````i````````tes/update-mgs````````i````````tetermstoresetch````````i````````ld
schema: 2.0.0
---

# Update-MgS````````i````````teTermStoreSetCh````````i````````ld
...
```
Update-MgS````````i````````teTermStoreSetCh````````i````````ld -Set````````i````````d <Str````````i````````ng> -S````````i````````te````````i````````d <Str````````i````````ng> -Term````````i````````d <Str````````i````````ng>
...
### UpdateExpanded1
```
Update-MgS````````i````````teTermStoreSetCh````````i````````ld -Set````````i````````d <Str````````i````````ng> -S````````i````````te````````i````````d <Str````````i````````ng> -Store````````i````````d <Str````````i````````ng> -Term````````i````````d <Str````````i````````ng>
...
```
Update-MgS````````i````````teTermStoreSetCh````````i````````ld -````````i````````nputObject <````````i````````S````````i````````tes````````i````````dent````````i````````ty> [-Add````````i````````t````````i````````onalPropert````````i````````es <Hashtable>]
...
```
Update-MgS````````i````````teTermStoreSetCh````````i````````ld -````````i````````nputObject <````````i````````S````````i````````tes````````i````````dent````````i````````ty> -BodyParameter <````````i````````M````````i````````crosoftGraphTermStoreTerm>
...
```yaml
Type: Hashtable
Parameter Sets: UpdateExpanded3, UpdateExpanded1, UpdateExpanded, UpdateV````````i````````a````````i````````dent````````i````````tyExpanded3, UpdateV````````i````````a````````i````````dent````````i````````tyExpanded1, UpdateV````````i````````a````````i````````dent````````i````````tyExpanded
Al````````i````````ases:
...
Parameter Sets: Update3, Update1, Update, UpdateV````````i````````a````````i````````dent````````i````````ty3, UpdateV````````i````````a````````i````````dent````````i````````ty1, UpdateV````````i````````a````````i````````dent````````i````````ty
Al````````i````````ases:
...
Parameter Sets: UpdateV````````i````````a````````i````````dent````````i````````tyExpanded3, UpdateV````````i````````a````````i````````dent````````i````````tyExpanded1, UpdateV````````i````````a````````i````````dent````````i````````tyExpanded, UpdateV````````i````````a````````i````````dent````````i````````ty3, UpdateV````````i````````a````````i````````dent````````i````````ty1, UpdateV````````i````````a````````i````````dent````````i````````ty
Al````````i````````ases:
...
```yaml
Type: Str````````i````````ng
Parameter Sets: UpdateExpanded3, UpdateExpanded1, UpdateExpanded, Update3, Update1, Update
Al````````i````````ases:
