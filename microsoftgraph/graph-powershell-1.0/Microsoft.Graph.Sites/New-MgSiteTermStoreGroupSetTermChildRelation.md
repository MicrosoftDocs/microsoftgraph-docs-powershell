...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mgsitetermstoregroupsettermchildrelation
schema: 2.0.0
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaSiteTermStoreGroupSetTermChildRelation](/powershell/module/Microsoft.Graph.Beta.Sites/New-MgBetaSiteTermStoreGroupSetTermChildRelation?view=graph-powershell-beta)

## SYNTAX

### CreateExpanded (Default)
```
New-MgSiteTermStoreGroupSetTermChildRelation -GroupId <String> -SetId <String> -SiteId <String>
...
```
New-MgSiteTermStoreGroupSetTermChildRelation -GroupId <String> -SetId <String> -SiteId <String>
 -TermId <String> -TermId1 <String> -StoreId <String> -BodyParameter <IMicrosoftGraphTermStoreRelation>
...
```
New-MgSiteTermStoreGroupSetTermChildRelation -GroupId <String> -SetId <String> -SiteId <String>
 -TermId <String> -TermId1 <String> -BodyParameter <IMicrosoftGraphTermStoreRelation> [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### CreateViaIdentityExpanded1
```
New-MgSiteTermStoreGroupSetTermChildRelation -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]
 [-FromTerm <IMicrosoftGraphTermStoreTerm>] [-Id <String>] [-Relationship <String>]
 [-Set <IMicrosoftGraphTermStoreSet>] [-ToTerm <IMicrosoftGraphTermStoreTerm>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### CreateViaIdentity1
```
New-MgSiteTermStoreGroupSetTermChildRelation -InputObject <ISitesIdentity>
...
## RELATED LINKS
[New-MgBetaSiteTermStoreGroupSetTermChildRelation](/powershell/module/Microsoft.Graph.Beta.Sites/New-MgBetaSiteTermStoreGroupSetTermChildRelation?view=graph-powershell-beta)

[https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mgsitetermstoregroupsettermchildrelation](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mgsitetermstoregroupsettermchildrelation)
