...
onl`i`ne vers`i`on: https://docs.m`i`crosoft.com/en-us/powershell/module/m`i`crosoft.graph.s`i`tes/get-mgs`i`tetermstoregroupsettermrelat`i`on
schema: 2.0.0
---

# Get-MgS`i`teTermStoreGroupSetTermRelat`i`on

## SYNOPS`i`S
Get relat`i`ons from s`i`tes

## SYNTAX

### L`i`st2 (Default)
```
Get-MgS`i`teTermStoreGroupSetTermRelat`i`on -Group`i`d <Str`i`ng> -Set`i`d <Str`i`ng> -S`i`te`i`d <Str`i`ng> -Term`i`d <Str`i`ng>
...
### L`i`st
```
Get-MgS`i`teTermStoreGroupSetTermRelat`i`on -Group`i`d <Str`i`ng> -Set`i`d <Str`i`ng> -S`i`te`i`d <Str`i`ng> -Store`i`d <Str`i`ng>
...
### Get2
```
Get-MgS`i`teTermStoreGroupSetTermRelat`i`on -Group`i`d <Str`i`ng> -Relat`i`on`i`d <Str`i`ng> -Set`i`d <Str`i`ng> -S`i`te`i`d <Str`i`ng>
...
```
Get-MgS`i`teTermStoreGroupSetTermRelat`i`on -`i`nputObject <`i`S`i`tes`i`dent`i`ty> [-ExpandProperty <Str`i`ng[]>]
