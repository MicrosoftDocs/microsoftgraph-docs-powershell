...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaGroupSiteTermStoreGroupSetChild](/powershell/module/Microsoft.Graph.Beta.Applications/Get-MgBetaGroupSiteTermStoreGroupSetChild?view=graph-powershell-beta)
...
```
Get-MgGroupSiteTermStoreGroupSetChild -GroupId <String> -GroupId1 <String> -SetId <String> -SiteId <String>
 -TermId <String> -StoreId <String> -TermId1 <String> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
...
## RELATED LINKS
[Get-MgBetaGroupSiteTermStoreGroupSetChild](/powershell/module/Microsoft.Graph.Beta.Applications/Get-MgBetaGroupSiteTermStoreGroupSetChild?view=graph-powershell-beta)
