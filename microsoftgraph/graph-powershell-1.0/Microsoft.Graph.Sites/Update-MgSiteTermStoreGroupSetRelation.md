...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mgsitetermstoregroupsetrelation
schema: 2.0.0
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaSiteTermStoreGroupSetRelation](/powershell/module/Microsoft.Graph.Beta.Sites/Update-MgBetaSiteTermStoreGroupSetRelation?view=graph-powershell-beta)

## SYNTAX

### UpdateExpanded (Default)
```
Update-MgSiteTermStoreGroupSetRelation -GroupId <String> -RelationId <String> -SetId <String> -SiteId <String>
...
```
Update-MgSiteTermStoreGroupSetRelation -InputObject <ISitesIdentity> [-ResponseHeadersVariable <String>]
...
### UpdateViaIdentity1
```
Update-MgSiteTermStoreGroupSetRelation -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphTermStoreRelation> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgBetaSiteTermStoreGroupSetRelation](/powershell/module/Microsoft.Graph.Beta.Sites/Update-MgBetaSiteTermStoreGroupSetRelation?view=graph-powershell-beta)

[https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mgsitetermstoregroupsetrelation](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/update-mgsitetermstoregroupsetrelation)
