...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mgsiteoperation
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Get-MgSiteOperation
---
...
```
Get-MgSiteOperation -SiteId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgSiteOperation -RichLongRunningOperationId <string> -SiteId <string>
...
```
Get-MgSiteOperation -InputObject <ISitesIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgSiteOperation](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mgsiteoperation)
- [Graph API Reference](https://learn.microsoft.com/graph/api/richlongrunningoperation-get?view=graph-rest-1.0)
- [Graph API Reference](https://learn.microsoft.com/graph/api/site-list-operations?view=graph-rest-1.0)
