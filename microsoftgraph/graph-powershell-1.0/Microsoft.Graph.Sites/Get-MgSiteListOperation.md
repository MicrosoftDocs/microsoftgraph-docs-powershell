...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mgsitelistoperation
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Get-MgSiteListOperation
---
...
```
Get-MgSiteListOperation -ListId <string> -SiteId <string> [-ExpandProperty <string[]>]
...
```
Get-MgSiteListOperation -InputObject <ISitesIdentity> [-ExpandProperty <string[]>]
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mgsitelistoperation)
