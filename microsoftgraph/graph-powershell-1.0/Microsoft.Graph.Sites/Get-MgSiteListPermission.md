...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/get-mgsitelistpermission
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Get-MgSiteListPermission
---

# Get-MgSiteListPermission
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaSiteListPermission](/powershell/module/Microsoft.Graph.Beta.Sites/Get-MgBetaSiteListPermission?view=graph-powershell-beta)
...
```
Get-MgSiteListPermission -ListId <string> -SiteId <string> [-ExpandProperty <string[]>]
...
```
Get-MgSiteListPermission -ListId <string> -PermissionId <string> -SiteId <string>
...
```
Get-MgSiteListPermission -InputObject <ISitesIdentity> [-ExpandProperty <string[]>]
