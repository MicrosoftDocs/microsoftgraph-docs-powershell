...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/add-mggroupsitecontenttypecopy
schema: 2.0.0
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Add-MgBetaGroupSiteContentTypeCopy](/powershell/module/Microsoft.Graph.Beta.Sites/Add-MgBetaGroupSiteContentTypeCopy?view=graph-powershell-beta)
...
```
Add-MgGroupSiteContentTypeCopy -InputObject <ISitesIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-ContentType <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### AddViaIdentity
```
Add-MgGroupSiteContentTypeCopy -InputObject <ISitesIdentity>
 -BodyParameter <IPathsVrsotcGroupsGroupIdSitesSiteIdContenttypesMicrosoftGraphAddcopyPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.sites/add-mggroupsitecontenttypecopy](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/add-mggroupsitecontenttypecopy)
