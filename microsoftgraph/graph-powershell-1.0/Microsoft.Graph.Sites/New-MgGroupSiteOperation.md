...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mggroupsiteoperation
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: New-MgGroupSiteOperation
---
...
```
New-MgGroupSiteOperation -GroupId <string> -SiteId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgGroupSiteOperation -InputObject <ISitesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-CreatedDateTime <datetime>]
 [-Error <IMicrosoftGraphPublicError>] [-Id <string>] [-LastActionDateTime <datetime>]
 [-PercentageComplete <int>] [-ResourceId <string>] [-ResourceLocation <string>] [-Status <string>]
 [-StatusDetail <string>] [-Type <string>] [-Break] [-Headers <IDictionary>]
...
- [New-MgGroupSiteOperation](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mggroupsiteoperation)
