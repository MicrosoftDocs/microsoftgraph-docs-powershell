...
### List (Default)
```
Get-MgGroupSiteGetByPathItem -GroupId <String> -Path <String> -SiteId <String> [-ExpandProperty <String[]>]
...
### List1
```
Get-MgGroupSiteGetByPathItem -GroupId <String> -Path <String> -SiteId <String> -Path1 <String>
