...
onl````````i````````ne vers````````i````````on: https://docs.m````````i````````crosoft.com/en-us/powershell/module/m````````i````````crosoft.graph.s````````i````````tes/new-mggroups````````i````````tetermstoresetparentgroupsetch````````i````````ld
schema: 2.0.0
---

# New-MgGroupS````````i````````teTermStoreSetParentGroupSetCh````````i````````ld
...
```
New-MgGroupS````````i````````teTermStoreSetParentGroupSetCh````````i````````ld -Group````````i````````d <Str````````i````````ng> -Set````````i````````d <Str````````i````````ng> -Set````````i````````d1 <Str````````i````````ng>
 -S````````i````````te````````i````````d <Str````````i````````ng> -Store````````i````````d <Str````````i````````ng> [-Add````````i````````t````````i````````onalPropert````````i````````es <Hashtable>]
...
```
New-MgGroupS````````i````````teTermStoreSetParentGroupSetCh````````i````````ld -Group````````i````````d <Str````````i````````ng> -Set````````i````````d <Str````````i````````ng> -Set````````i````````d1 <Str````````i````````ng>
 -S````````i````````te````````i````````d <Str````````i````````ng> -Store````````i````````d <Str````````i````````ng> -BodyParameter <````````i````````M````````i````````crosoftGraphTermStoreTerm> [-What````````i````````f] [-Conf````````i````````rm]
 [<CommonParameters>]
```

### CreateV````````i````````a````````i````````dent````````i````````tyExpanded1
```
New-MgGroupS````````i````````teTermStoreSetParentGroupSetCh````````i````````ld -````````i````````nputObject <````````i````````S````````i````````tes````````i````````dent````````i````````ty>
...
```yaml
Type: Hashtable
Parameter Sets: CreateExpanded, CreateExpanded1, CreateV````````i````````a````````i````````dent````````i````````tyExpanded1, CreateV````````i````````a````````i````````dent````````i````````tyExpanded
Al````````i````````ases:
...
Parameter Sets: Create1, Create, CreateV````````i````````a````````i````````dent````````i````````ty1, CreateV````````i````````a````````i````````dent````````i````````ty
Al````````i````````ases:
...
Parameter Sets: CreateV````````i````````a````````i````````dent````````i````````tyExpanded1, CreateV````````i````````a````````i````````dent````````i````````tyExpanded, CreateV````````i````````a````````i````````dent````````i````````ty1, CreateV````````i````````a````````i````````dent````````i````````ty
Al````````i````````ases:
