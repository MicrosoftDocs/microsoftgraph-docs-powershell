...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaGroupSiteTermStoreSetParentGroupSetChild](/powershell/module/Microsoft.Graph.Beta.Applications/New-MgBetaGroupSiteTermStoreSetParentGroupSetChild?view=graph-powershell-beta)
...
```
New-MgGroupSiteTermStoreSetParentGroupSetChild -GroupId <String> -SetId <String> -SetId1 <String>
 -SiteId <String> -StoreId <String> -TermId <String> -BodyParameter <IMicrosoftGraphTermStoreTerm> [-WhatIf]
...
```
New-MgGroupSiteTermStoreSetParentGroupSetChild -GroupId <String> -SetId <String> -SetId1 <String>
 -SiteId <String> -StoreId <String> -BodyParameter <IMicrosoftGraphTermStoreTerm> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```yaml
Type: String
Parameter Sets: CreateExpanded, CreateExpanded3, CreateExpanded2, CreateExpanded1, Create3, Create2, Create1, Create
Aliases:
...
```yaml
Type: String
Parameter Sets: CreateExpanded3, CreateExpanded1, Create3, Create1
Aliases:
...
## RELATED LINKS
[New-MgBetaGroupSiteTermStoreSetParentGroupSetChild](/powershell/module/Microsoft.Graph.Beta.Applications/New-MgBetaGroupSiteTermStoreSetParentGroupSetChild?view=graph-powershell-beta)
