...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mggroupsitelistpermission
Locale: en-US
Module Name: Microsoft.Graph.Sites
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: New-MgGroupSiteListPermission
---

# New-MgGroupSiteListPermission
...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaGroupSiteListPermission](/powershell/module/Microsoft.Graph.Beta.Sites/New-MgBetaGroupSiteListPermission?view=graph-powershell-beta)
...
```
New-MgGroupSiteListPermission -GroupId <string> -ListId <string> -SiteId <string>
...
```
New-MgGroupSiteListPermission -InputObject <ISitesIdentity> [-ResponseHeadersVariable <string>]
...
```
New-MgGroupSiteListPermission -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphPermission> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
