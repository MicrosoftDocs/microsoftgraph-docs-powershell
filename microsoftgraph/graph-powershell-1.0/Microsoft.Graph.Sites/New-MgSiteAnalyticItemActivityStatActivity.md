...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mgsiteanalyticitemactivitystatactivity
schema: 2.0.0
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaSiteAnalyticItemActivityStatActivity](/powershell/module/Microsoft.Graph.Beta.Sites/New-MgBetaSiteAnalyticItemActivityStatActivity?view=graph-powershell-beta)

## SYNTAX

### CreateExpanded (Default)
```
New-MgSiteAnalyticItemActivityStatActivity -ItemActivityStatId <String> -SiteId <String> [-Access <Hashtable>]
...
### Create
```
New-MgSiteAnalyticItemActivityStatActivity -ItemActivityStatId <String> -SiteId <String>
 -BodyParameter <IMicrosoftGraphItemActivity> [-WhatIf] [-Confirm] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgSiteAnalyticItemActivityStatActivity -InputObject <ISitesIdentity> [-Access <Hashtable>]
 [-ActivityDateTime <DateTime>] [-Actor <IMicrosoftGraphIdentitySet>] [-AdditionalProperties <Hashtable>]
 [-DriveItem <IMicrosoftGraphDriveItem>] [-Id <String>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### CreateViaIdentity
```
New-MgSiteAnalyticItemActivityStatActivity -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphItemActivity> [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mgsiteanalyticitemactivitystatactivity](https://learn.microsoft.com/powershell/module/microsoft.graph.sites/new-mgsiteanalyticitemactivitystatactivity)
