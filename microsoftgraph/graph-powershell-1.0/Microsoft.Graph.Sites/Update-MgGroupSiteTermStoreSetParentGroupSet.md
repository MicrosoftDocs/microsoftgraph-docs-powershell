...
Update-MgGroupSiteTermStoreSetParentGroupSet -GroupId <String> -SetId <String> -SetId1 <String>
 ...
 [-Terms <IMicrosoftGraphTermStoreTerm[]>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```
Update-MgGroupSiteTermStoreSetParentGroupSet -GroupId <String> -SetId <String> -SetId1 <String>
 -SiteId <String> -StoreId <String> -BodyParameter <IMicrosoftGraphTermStoreSet> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```
Update-MgGroupSiteTermStoreSetParentGroupSet -GroupId <String> -SetId <String> -SetId1 <String>
 -SiteId <String> -BodyParameter <IMicrosoftGraphTermStoreSet> [-WhatIf] [-Confirm] [<CommonParameters>]
```
