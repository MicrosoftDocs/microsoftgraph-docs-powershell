...
```
Update-MgSearchBookmark -BookmarkId <string> [-ResponseHeadersVariable <string>]
...
```
Update-MgSearchBookmark -BookmarkId <string> -BodyParameter <IMicrosoftGraphSearchBookmark>
...
```
Update-MgSearchBookmark -InputObject <ISearchIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-AvailabilityEndDateTime <datetime>]
 [-AvailabilityStartDateTime <datetime>] [-Categories <string[]>] [-Description <string>]
 [-DisplayName <string>] [-GroupIds <string[]>] [-Id <string>] [-IsSuggested]
 [-Keywords <IMicrosoftGraphSearchAnswerKeyword>] [-LanguageTags <string[]>]
...
```
Update-MgSearchBookmark -InputObject <ISearchIdentity>
 -BodyParameter <IMicrosoftGraphSearchBookmark> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm] [<CommonParameters>]
```
