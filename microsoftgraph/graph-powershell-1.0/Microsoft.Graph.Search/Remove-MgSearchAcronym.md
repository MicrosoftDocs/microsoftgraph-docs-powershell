...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.search/remove-mgsearchacronym
Locale: en-US
Module Name: Microsoft.Graph.Search
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Remove-MgSearchAcronym
---
...
```
Remove-MgSearchAcronym -InputObject <ISearchIdentity> [-IfMatch <string>]
