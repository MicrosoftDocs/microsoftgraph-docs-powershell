...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.search/remove-mgsearchqna
Locale: en-US
Module Name: Microsoft.Graph.Search
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: Remove-MgSearchQna
---
...
```
Remove-MgSearchQna -QnaId <string> [-IfMatch <string>] [-ResponseHeadersVariable <string>] [-Break]
...
```
Remove-MgSearchQna -InputObject <ISearchIdentity> [-IfMatch <string>]
