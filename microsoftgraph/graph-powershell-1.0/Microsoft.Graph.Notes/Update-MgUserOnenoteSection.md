...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mguseronenotesection
Locale: en-US
Module Name: Microsoft.Graph.Notes
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Update-MgUserOnenoteSection
---
...
```
Update-MgUserOnenoteSection -InputObject <INotesIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgUserOnenoteSection -InputObject <INotesIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm] [<CommonParameters>]
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mguseronenotesection)
