...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mgsiteonenotesectiongroupcontent
schema: 2.0.0
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaSiteOnenoteSectionGroupContent](/powershell/module/Microsoft.Graph.Beta.Notes/Update-MgBetaSiteOnenoteSectionGroupContent?view=graph-powershell-beta)

## SYNTAX

### UpdateExpanded (Default)
```
Update-MgSiteOnenoteSectionGroupContent -SectionGroupId <String> -SiteId <String>
...
```
Update-MgSiteOnenoteSectionGroupContent -InputObject <INotesIdentity> [-ResponseHeadersVariable <String>]
...
### UpdateViaIdentity
```
Update-MgSiteOnenoteSectionGroupContent -InputObject <INotesIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mgsiteonenotesectiongroupcontent](https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mgsiteonenotesectiongroupcontent)
