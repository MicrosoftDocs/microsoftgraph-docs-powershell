...
New-MgGroupOnenoteNotebook -GroupId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Self <String>] [-UserRole <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### Create
```
New-MgGroupOnenoteNotebook -GroupId <String> -BodyParameter <IMicrosoftGraphNotebook> [-Headers <IDictionary>]
