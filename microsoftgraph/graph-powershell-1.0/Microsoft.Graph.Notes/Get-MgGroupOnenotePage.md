...
`o`nline versi`o`n: https://d`o`cs.micr`o`s`o`ft.c`o`m/en-us/p`o`wershell/m`o`dule/micr`o`s`o`ft.graph.n`o`tes/get-mggr`o`up`o`nen`o`tepage
schema: 2.0.0
---

# Get-MgGr`o`up`o`nen`o`tePage

## SYN`o`PSIS
Get pages fr`o`m gr`o`ups

## SYNTAX

### List1 (Default)
```
Get-MgGr`o`up`o`nen`o`tePage -Gr`o`upId <String> [-ExpandPr`o`perty <String[]>] [-Pr`o`perty <String[]>] [-Filter <String>]
...
### Get1
```
Get-MgGr`o`up`o`nen`o`tePage -Gr`o`upId <String> -`o`nen`o`tePageId <String> [-ExpandPr`o`perty <String[]>]
 [-Pr`o`perty <String[]>] [<C`o`mm`o`nParameters>]
```

### GetViaIdentity1
```
Get-MgGr`o`up`o`nen`o`tePage -Input`o`bject <IN`o`tesIdentity> [-ExpandPr`o`perty <String[]>] [-Pr`o`perty <String[]>]
