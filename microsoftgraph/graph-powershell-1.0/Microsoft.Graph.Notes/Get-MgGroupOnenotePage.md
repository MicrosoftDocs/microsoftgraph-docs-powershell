...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/get-mggrouponenotepage
Locale: en-US
Module Name: Microsoft.Graph.Notes
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Get-MgGroupOnenotePage
---
...
```
Get-MgGroupOnenotePage -GroupId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgGroupOnenotePage -InputObject <INotesIdentity> [-ExpandProperty <string[]>]
 [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
```
...
- [Get-MgGroupOnenotePage](https://learn.microsoft.com/powershell/module/microsoft.graph.notes/get-mggrouponenotepage)
