...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mggrouponenotesectiongroupsection
schema: 2.0.0
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaGroupOnenoteSectionGroupSection](/powershell/module/Microsoft.Graph.Beta.Notes/Update-MgBetaGroupOnenoteSectionGroupSection?view=graph-powershell-beta)
...
```
Update-MgGroupOnenoteSectionGroupSection -InputObject <INotesIdentity> [-ResponseHeadersVariable <String>]
...
### UpdateViaIdentity
```
Update-MgGroupOnenoteSectionGroupSection -InputObject <INotesIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mggrouponenotesectiongroupsection](https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mggrouponenotesectiongroupsection)
