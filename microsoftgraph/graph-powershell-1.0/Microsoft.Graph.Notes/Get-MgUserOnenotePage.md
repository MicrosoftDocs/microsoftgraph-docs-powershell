...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/get-mguseronenotepage
Locale: en-US
Module Name: Microsoft.Graph.Notes
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Get-MgUserOnenotePage
---
...
```
Get-MgUserOnenotePage -UserId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgUserOnenotePage -InputObject <INotesIdentity> [-ExpandProperty <string[]>]
 [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
```
...
- [Get-MgUserOnenotePage](https://learn.microsoft.com/powershell/module/microsoft.graph.notes/get-mguseronenotepage)
