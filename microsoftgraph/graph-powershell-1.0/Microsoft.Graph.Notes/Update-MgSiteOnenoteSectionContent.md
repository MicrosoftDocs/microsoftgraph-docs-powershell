...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mgsiteonenotesectioncontent
Locale: en-US
Module Name: Microsoft.Graph.Notes
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Update-MgSiteOnenoteSectionContent
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaSiteOnenoteSectionContent](/powershell/module/Microsoft.Graph.Beta.Notes/Update-MgBetaSiteOnenoteSectionContent?view=graph-powershell-beta)
...
```
Update-MgSiteOnenoteSectionContent -OnenoteSectionId <string> -SiteId <string>
...
```
Update-MgSiteOnenoteSectionContent -InputObject <INotesIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgSiteOnenoteSectionContent -InputObject <INotesIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [Update-MgSiteOnenoteSectionContent](https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mgsiteonenotesectioncontent)
