...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/new-mggrouponenotepage
Locale: en-US
Module Name: Microsoft.Graph.Notes
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: New-MgGroupOnenotePage
---
...
```
New-MgGroupOnenotePage -GroupId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgGroupOnenotePage -GroupId <string> -BodyParameter <IMicrosoftGraphOnenotePage>
...
```
New-MgGroupOnenotePage -InputObject <INotesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-ContentInputFile <string>] [-ContentUrl <string>]
 [-CreatedByAppId <string>] [-CreatedDateTime <datetime>] [-Id <string>]
 [-LastModifiedDateTime <datetime>] [-Level <int>] [-Links <IMicrosoftGraphPageLinks>]
 [-Order <int>] [-ParentNotebook <IMicrosoftGraphNotebook>]
