...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/get-mggrouponenoteoperation
Locale: en-US
Module Name: Microsoft.Graph.Notes
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: Get-MgGroupOnenoteOperation
---
...
```
Get-MgGroupOnenoteOperation -GroupId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgGroupOnenoteOperation -GroupId <string> -OnenoteOperationId <string>
...
```
Get-MgGroupOnenoteOperation -InputObject <INotesIdentity> [-ExpandProperty <string[]>]
