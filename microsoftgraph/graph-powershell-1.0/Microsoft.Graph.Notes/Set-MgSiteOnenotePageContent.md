...
### Set (Default)
```
Set-MgSiteOnenotePageContent -OnenotePageId <String> -SiteId <String> [-Data <Stream>]
...
### SetViaIdentity
```
Set-MgSiteOnenotePageContent -InputObject <INotesIdentity> [-Data <Stream>] [-ResponseHeadersVariable <String>]
