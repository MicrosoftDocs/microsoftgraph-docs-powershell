...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaGroupOnenotePage](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaGroupOnenotePage?view=graph-powershell-beta)
...
### UpdateViaIdentity
```
Update-MgGroupOnenotePage -InputObject <INotesIdentity> -BodyParameter <IMicrosoftGraphOnenotePage> [-WhatIf]
...
## RELATED LINKS
[Update-MgBetaGroupOnenotePage](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaGroupOnenotePage?view=graph-powershell-beta)
