...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/get-mggrouponenoterecentnotebook
Locale: en-US
Module Name: Microsoft.Graph.Notes
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: Get-MgGroupOnenoteRecentNotebook
---
...
```
Get-MgGroupOnenoteRecentNotebook -GroupId <string> -IncludePersonalNotebooks [-Count]
...
```
Get-MgGroupOnenoteRecentNotebook -InputObject <INotesIdentity> [-Count] [-Filter <string>]
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.notes/get-mggrouponenoterecentnotebook)
