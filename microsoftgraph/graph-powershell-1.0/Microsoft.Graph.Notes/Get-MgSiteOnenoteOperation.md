...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/get-mgsiteonenoteoperation
Locale: en-US
Module Name: Microsoft.Graph.Notes
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: Get-MgSiteOnenoteOperation
---
...
```
Get-MgSiteOnenoteOperation -SiteId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgSiteOnenoteOperation -OnenoteOperationId <string> -SiteId <string>
...
```
Get-MgSiteOnenoteOperation -InputObject <INotesIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgSiteOnenoteOperation](https://learn.microsoft.com/powershell/module/microsoft.graph.notes/get-mgsiteonenoteoperation)
