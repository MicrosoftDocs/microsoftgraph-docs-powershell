...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/get-mggrouponenotesection
Locale: en-US
Module Name: Microsoft.Graph.Notes
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: Get-MgGroupOnenoteSection
---
...
```
Get-MgGroupOnenoteSection -InputObject <INotesIdentity> [-ExpandProperty <string[]>]
 [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
```
...
- [Get-MgGroupOnenoteSection](https://learn.microsoft.com/powershell/module/microsoft.graph.notes/get-mggrouponenotesection)
