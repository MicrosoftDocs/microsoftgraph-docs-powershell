...
### Set (Default)
```
Set-MgUserOnenotePageContent -OnenotePageId <String> -UserId <String> [-Data <Stream>]
...
### SetViaIdentity
```
Set-MgUserOnenotePageContent -InputObject <INotesIdentity> [-Data <Stream>] [-ResponseHeadersVariable <String>]
