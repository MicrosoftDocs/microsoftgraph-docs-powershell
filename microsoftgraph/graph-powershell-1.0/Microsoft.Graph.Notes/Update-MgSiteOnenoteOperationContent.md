...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mgsiteonenoteoperationcontent
schema: 2.0.0
---
...
```
Update-MgSiteOnenoteOperationContent -InputObject <INotesIdentity> [-ResponseHeadersVariable <String>]
