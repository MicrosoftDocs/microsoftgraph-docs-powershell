...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaUserOnenotePage](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaUserOnenotePage?view=graph-powershell-beta)
...
### UpdateViaIdentity
```
Update-MgUserOnenotePage -InputObject <INotesIdentity> -BodyParameter <IMicrosoftGraphOnenotePage> [-WhatIf]
...
## RELATED LINKS
[Update-MgBetaUserOnenotePage](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaUserOnenotePage?view=graph-powershell-beta)
