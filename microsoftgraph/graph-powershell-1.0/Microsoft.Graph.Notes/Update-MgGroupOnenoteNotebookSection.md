...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mggrouponenotenotebooksection
schema: 2.0.0
---
...
```
Update-MgGroupOnenoteNotebookSection -GroupId <String> -NotebookId <String> -OnenoteSectionId <String>
...
```
Update-MgGroupOnenoteNotebookSection -InputObject <INotesIdentity> [-ResponseHeadersVariable <String>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mggrouponenotenotebooksection](https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mggrouponenotenotebooksection)
