...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mggrouponenotenotebooksection
Locale: en-US
Module Name: Microsoft.Graph.Notes
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Update-MgGroupOnenoteNotebookSection
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaGroupOnenoteNotebookSection](/powershell/module/Microsoft.Graph.Beta.Notes/Update-MgBetaGroupOnenoteNotebookSection?view=graph-powershell-beta)
...
```
Update-MgGroupOnenoteNotebookSection -GroupId <string> -NotebookId <string>
 ...
 [-Id <string>] [-IsDefault] [-LastModifiedBy <IMicrosoftGraphIdentitySet>]
 [-LastModifiedDateTime <datetime>] [-Links <IMicrosoftGraphSectionLinks>]
 [-Pages <IMicrosoftGraphOnenotePage[]>] [-PagesUrl <string>]
 [-ParentNotebook <IMicrosoftGraphNotebook>] [-ParentSectionGroup <IMicrosoftGraphSectionGroup>]
 [-Self <string>] [-Break] [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
...
```
Update-MgGroupOnenoteNotebookSection -GroupId <string> -NotebookId <string>
 -OnenoteSectionId <string> -BodyParameter <IMicrosoftGraphOnenoteSection>
...
```
Update-MgGroupOnenoteNotebookSection -InputObject <INotesIdentity>
...
```
Update-MgGroupOnenoteNotebookSection -InputObject <INotesIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-ResponseHeadersVariable <string>] [-Break]
...
- [Update-MgGroupOnenoteNotebookSection](https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mggrouponenotenotebooksection)
