...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mgsiteonenotenotebooksectiongroupcontent
schema: 2.0.0
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaSiteOnenoteNotebookSectionGroupContent](/powershell/module/Microsoft.Graph.Beta.Notes/Update-MgBetaSiteOnenoteNotebookSectionGroupContent?view=graph-powershell-beta)

## SYNTAX

### UpdateExpanded (Default)
```
Update-MgSiteOnenoteNotebookSectionGroupContent -NotebookId <String> -SectionGroupId <String> -SiteId <String>
...
```
Update-MgSiteOnenoteNotebookSectionGroupContent -InputObject <INotesIdentity>
 [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>]
 [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <DateTime>] [-DisplayName <String>] [-Id <String>]
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-LastModifiedDateTime <DateTime>]
 [-ParentNotebook <IMicrosoftGraphNotebook>] [-ParentSectionGroup <IMicrosoftGraphSectionGroup>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mgsiteonenotenotebooksectiongroupcontent](https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mgsiteonenotenotebooksectiongroupcontent)
