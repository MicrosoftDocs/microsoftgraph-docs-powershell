...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mggrouponenotepagecontent
schema: 2.0.0
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaGroupOnenotePageContent](/powershell/module/Microsoft.Graph.Beta.Notes/Update-MgBetaGroupOnenotePageContent?view=graph-powershell-beta)
...
```
Update-MgGroupOnenotePageContent -InputObject <INotesIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-Commands <IMicrosoftGraphOnenotePatchContentCommand[]>]
 [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### PatchViaIdentity
```
Update-MgGroupOnenotePageContent -InputObject <INotesIdentity>
 -BodyParameter <IPaths96Tlp1GroupsGroupIdOnenotePagesOnenotepageIdMicrosoftGraphOnenotepatchcontentPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mggrouponenotepagecontent](https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mggrouponenotepagecontent)
