...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/new-mgsiteonenotenotebooksectionpage
schema: 2.0.0
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaSiteOnenoteNotebookSectionPage](/powershell/module/Microsoft.Graph.Beta.Notes/New-MgBetaSiteOnenoteNotebookSectionPage?view=graph-powershell-beta)
...
```
New-MgSiteOnenoteNotebookSectionPage -InputObject <INotesIdentity> [-ResponseHeadersVariable <String>]
...
### CreateViaIdentity
```
New-MgSiteOnenoteNotebookSectionPage -InputObject <INotesIdentity> -BodyParameter <IMicrosoftGraphOnenotePage>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.notes/new-mgsiteonenotenotebooksectionpage](https://learn.microsoft.com/powershell/module/microsoft.graph.notes/new-mgsiteonenotenotebooksectionpage)
