...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/new-mguseronenotenotebooksectionpage
schema: 2.0.0
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaUserOnenoteNotebookSectionPage](/powershell/module/Microsoft.Graph.Beta.Notes/New-MgBetaUserOnenoteNotebookSectionPage?view=graph-powershell-beta)
...
```
New-MgUserOnenoteNotebookSectionPage -InputObject <INotesIdentity> [-ResponseHeadersVariable <String>]
...
### CreateViaIdentity
```
New-MgUserOnenoteNotebookSectionPage -InputObject <INotesIdentity> -BodyParameter <IMicrosoftGraphOnenotePage>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.notes/new-mguseronenotenotebooksectionpage](https://learn.microsoft.com/powershell/module/microsoft.graph.notes/new-mguseronenotenotebooksectionpage)
