...
### Delete (Default)
```
Remove-MgUserOnenoteSection -OnenoteSectionId <String> -UserId <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgUserOnenoteSection -InputObject <INotesIdentity> [-IfMatch <String>] [-Headers <IDictionary>]
...
## RELATED LINKS
[Remove-MgBetaUserOnenoteSection](/powershell/module/Microsoft.Graph.Beta.Notes/Remove-MgBetaUserOnenoteSection?view=graph-powershell-beta)
