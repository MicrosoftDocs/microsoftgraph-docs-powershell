...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/copy-mgsiteonenotenotebook
Locale: en-US
Module Name: Microsoft.Graph.Notes
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: Copy-MgSiteOnenoteNotebook
---
...
Copy-MgSiteOnenoteNotebook -NotebookId <string> -SiteId <string> [-ResponseHeadersVariable <string>]
 ...
 [-RenameAs <string>] [-SiteCollectionId <string>] [-SiteId1 <string>] [-Break]
...
```
Copy-MgSiteOnenoteNotebook -InputObject <INotesIdentity> [-SiteId <string>]
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-GroupId <string>]
 [-NotebookFolder <string>] [-RenameAs <string>] [-SiteCollectionId <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
- [Copy-MgSiteOnenoteNotebook](https://learn.microsoft.com/powershell/module/microsoft.graph.notes/copy-mgsiteonenotenotebook)
