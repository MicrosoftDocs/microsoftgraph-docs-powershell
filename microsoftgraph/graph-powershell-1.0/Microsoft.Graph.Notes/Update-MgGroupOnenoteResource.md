...
```
Update-MgGroupOnenoteResource -GroupId <String> -OnenoteResourceId <String> [-ResponseHeadersVariable <String>]
...
### UpdateViaIdentity
```
Update-MgGroupOnenoteResource -InputObject <INotesIdentity> -BodyParameter <IMicrosoftGraphOnenoteResource>
