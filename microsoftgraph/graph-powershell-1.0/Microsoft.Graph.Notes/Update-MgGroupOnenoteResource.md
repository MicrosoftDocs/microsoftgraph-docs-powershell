...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mggrouponenoteresource
Locale: en-US
Module Name: Microsoft.Graph.Notes
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Update-MgGroupOnenoteResource
---
...
```
Update-MgGroupOnenoteResource -InputObject <INotesIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgGroupOnenoteResource -InputObject <INotesIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteResource> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm] [<CommonParameters>]
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mggrouponenoteresource)
