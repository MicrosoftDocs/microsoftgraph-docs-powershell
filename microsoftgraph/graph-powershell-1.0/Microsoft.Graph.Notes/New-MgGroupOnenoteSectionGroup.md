...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/new-mggrouponenotesectiongroup
Locale: en-US
Module Name: Microsoft.Graph.Notes
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: New-MgGroupOnenoteSectionGroup
---
...
```
New-MgGroupOnenoteSectionGroup -GroupId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgGroupOnenoteSectionGroup -InputObject <INotesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-CreatedBy <IMicrosoftGraphIdentitySet>]
 [-CreatedDateTime <datetime>] [-DisplayName <string>] [-Id <string>]
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-LastModifiedDateTime <datetime>]
 [-ParentNotebook <IMicrosoftGraphNotebook>] [-ParentSectionGroup <IMicrosoftGraphSectionGroup>]
...
```
New-MgGroupOnenoteSectionGroup -InputObject <INotesIdentity>
...
- [New-MgGroupOnenoteSectionGroup](https://learn.microsoft.com/powershell/module/microsoft.graph.notes/new-mggrouponenotesectiongroup)
