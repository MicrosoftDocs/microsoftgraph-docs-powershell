...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/get-mgsiteonenotepage
Locale: en-US
Module Name: Microsoft.Graph.Notes
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Get-MgSiteOnenotePage
---
...
```
Get-MgSiteOnenotePage -SiteId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgSiteOnenotePage -InputObject <INotesIdentity> [-ExpandProperty <string[]>]
 [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
```
...
- [Get-MgSiteOnenotePage](https://learn.microsoft.com/powershell/module/microsoft.graph.notes/get-mgsiteonenotepage)
