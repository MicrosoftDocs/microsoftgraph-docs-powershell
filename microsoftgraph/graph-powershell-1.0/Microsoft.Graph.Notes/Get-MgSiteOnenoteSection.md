...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/get-mgsiteonenotesection
Locale: en-US
Module Name: Microsoft.Graph.Notes
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Get-MgSiteOnenoteSection
---
...
```
Get-MgSiteOnenoteSection -InputObject <INotesIdentity> [-ExpandProperty <string[]>]
 [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
```
...
- [Get-MgSiteOnenoteSection](https://learn.microsoft.com/powershell/module/microsoft.graph.notes/get-mgsiteonenotesection)
