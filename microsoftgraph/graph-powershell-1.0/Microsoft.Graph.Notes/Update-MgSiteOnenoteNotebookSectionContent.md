...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mgsiteonenotenotebooksectioncontent
schema: 2.0.0
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaSiteOnenoteNotebookSectionContent](/powershell/module/Microsoft.Graph.Beta.Notes/Update-MgBetaSiteOnenoteNotebookSectionContent?view=graph-powershell-beta)

## SYNTAX

### UpdateExpanded (Default)
```
Update-MgSiteOnenoteNotebookSectionContent -NotebookId <String> -OnenoteSectionId <String> -SiteId <String>
...
```
Update-MgSiteOnenoteNotebookSectionContent -InputObject <INotesIdentity> [-ResponseHeadersVariable <String>]
...
### UpdateViaIdentity
```
Update-MgSiteOnenoteNotebookSectionContent -InputObject <INotesIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mgsiteonenotenotebooksectioncontent](https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mgsiteonenotenotebooksectioncontent)
