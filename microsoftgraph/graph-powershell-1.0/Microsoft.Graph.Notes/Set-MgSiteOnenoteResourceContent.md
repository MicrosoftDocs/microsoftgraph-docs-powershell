...
`o`nline versi`o`n: https://d`o`cs.micr`o`s`o`ft.c`o`m/en-us/p`o`wershell/m`o`dule/micr`o`s`o`ft.graph.n`o`tes/set-mgsite`o`nen`o`teres`o`urcec`o`ntent
schema: 2.0.0
---

# Set-MgSite`o`nen`o`teRes`o`urceC`o`ntent

## SYN`o`PSIS
Update c`o`ntent f`o`r the navigati`o`n pr`o`perty res`o`urces in sites

## SYNTAX

### Set (Default)
```
Set-MgSite`o`nen`o`teRes`o`urceC`o`ntent -`o`nen`o`teRes`o`urceId <String> -SiteId <String> [-B`o`dyParameter <Stream>]
 -InFile <String> [-PassThru] [-WhatIf] [-C`o`nfirm] [<C`o`mm`o`nParameters>]
```

### SetViaIdentity
```
Set-MgSite`o`nen`o`teRes`o`urceC`o`ntent -Input`o`bject <IN`o`tesIdentity> [-B`o`dyParameter <Stream>] -InFile <String>
