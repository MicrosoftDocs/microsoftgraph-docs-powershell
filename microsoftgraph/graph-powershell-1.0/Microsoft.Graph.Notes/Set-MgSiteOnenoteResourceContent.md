...
### Set (Default)
```
Set-MgSiteOnenoteResourceContent -OnenoteResourceId <String> -SiteId <String> [-BodyParameter <Stream>]
 -InFile <String> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### SetViaIdentity
```
Set-MgSiteOnenoteResourceContent -InputObject <INotesIdentity> [-BodyParameter <Stream>] -InFile <String>
