...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mgsiteonenotenotebookcontent
Locale: en-US
Module Name: Microsoft.Graph.Notes
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Update-MgSiteOnenoteNotebookContent
---
...
```
Update-MgSiteOnenoteNotebookContent -InputObject <INotesIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <datetime>] [-DisplayName <string>]
 [-Id <string>] [-IsDefault] [-IsShared] [-LastModifiedBy <IMicrosoftGraphIdentitySet>]
 [-LastModifiedDateTime <datetime>] [-Links <IMicrosoftGraphNotebookLinks>]
...
- [Update-MgSiteOnenoteNotebookContent](https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mgsiteonenotenotebookcontent)
