...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mgsiteonenotenotebookcontent
schema: 2.0.0
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaSiteOnenoteNotebookContent](/powershell/module/Microsoft.Graph.Beta.Notes/Update-MgBetaSiteOnenoteNotebookContent?view=graph-powershell-beta)

## SYNTAX

### UpdateExpanded (Default)
```
Update-MgSiteOnenoteNotebookContent -NotebookId <String> -SiteId <String> [-ResponseHeadersVariable <String>]
...
### Update
```
Update-MgSiteOnenoteNotebookContent -NotebookId <String> -SiteId <String>
 -BodyParameter <IMicrosoftGraphNotebook> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgSiteOnenoteNotebookContent -InputObject <INotesIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <DateTime>]
 [-DisplayName <String>] [-Id <String>] [-IsDefault] [-IsShared] [-LastModifiedBy <IMicrosoftGraphIdentitySet>]
 [-LastModifiedDateTime <DateTime>] [-Links <IMicrosoftGraphNotebookLinks>]
 [-SectionGroups <IMicrosoftGraphSectionGroup[]>] [-SectionGroupsUrl <String>]
...
### UpdateViaIdentity
```
Update-MgSiteOnenoteNotebookContent -InputObject <INotesIdentity> -BodyParameter <IMicrosoftGraphNotebook>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mgsiteonenotenotebookcontent](https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mgsiteonenotenotebookcontent)
