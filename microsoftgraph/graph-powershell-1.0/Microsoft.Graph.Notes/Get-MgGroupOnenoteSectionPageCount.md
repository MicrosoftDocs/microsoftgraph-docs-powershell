...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/get-mggrouponenotesectionpagecount
Locale: en-US
Module Name: Microsoft.Graph.Notes
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: Get-MgGroupOnenoteSectionPageCount
---
...
```
Get-MgGroupOnenoteSectionPageCount -InputObject <INotesIdentity> [-Filter <string>]
 [-Search <string>] [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
```
...
- [Get-MgGroupOnenoteSectionPageCount](https://learn.microsoft.com/powershell/module/microsoft.graph.notes/get-mggrouponenotesectionpagecount)
