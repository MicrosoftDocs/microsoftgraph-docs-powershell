...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/new-mggrouponenotesectiongroupsectionpage
schema: 2.0.0
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaGroupOnenoteSectionGroupSectionPage](/powershell/module/Microsoft.Graph.Beta.Notes/New-MgBetaGroupOnenoteSectionGroupSectionPage?view=graph-powershell-beta)

## SYNTAX

### CreateExpanded (Default)
```
New-MgGroupOnenoteSectionGroupSectionPage -GroupId <String> -OnenoteSectionId <String> -SectionGroupId <String>
...
```
New-MgGroupOnenoteSectionGroupSectionPage -InputObject <INotesIdentity> [-ResponseHeadersVariable <String>]
...
### CreateViaIdentity
```
New-MgGroupOnenoteSectionGroupSectionPage -InputObject <INotesIdentity>
 -BodyParameter <IMicrosoftGraphOnenotePage> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.notes/new-mggrouponenotesectiongroupsectionpage](https://learn.microsoft.com/powershell/module/microsoft.graph.notes/new-mggrouponenotesectiongroupsectionpage)
