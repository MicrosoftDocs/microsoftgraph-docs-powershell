...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mggrouponenotesectionpagecontent
schema: 2.0.0
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaGroupOnenoteSectionPageContent](/powershell/module/Microsoft.Graph.Beta.Notes/Update-MgBetaGroupOnenoteSectionPageContent?view=graph-powershell-beta)
...
```
Update-MgGroupOnenoteSectionPageContent -InputObject <INotesIdentity> [-ResponseHeadersVariable <String>]
...
### PatchViaIdentity
```
Update-MgGroupOnenoteSectionPageContent -InputObject <INotesIdentity>
 -BodyParameter <IPathsNbnlfzGroupsGroupIdOnenoteSectionsOnenotesectionIdPagesOnenotepageIdMicrosoftGraphOnenotepatchcontentPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mggrouponenotesectionpagecontent](https://learn.microsoft.com/powershell/module/microsoft.graph.notes/update-mggrouponenotesectionpagecontent)
