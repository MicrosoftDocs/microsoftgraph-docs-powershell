...
`````o`````nline versi`````o`````n: https://d`````o`````cs.micr`````o`````s`````o`````ft.c`````o`````m/en-us/p`````o`````wershell/m`````o`````dule/micr`````o`````s`````o`````ft.graph.n`````o`````tes/new-mguser`````o`````nen`````o`````tepage
schema: 2.0.0
---

# New-MgUser`````o`````nen`````o`````tePage
...
```
New-MgUser`````o`````nen`````o`````tePage -UserId <String> [-Additi`````o`````nalPr`````o`````perties <Hashtable>] [-C`````o`````ntentInputFile <String>]
...
### Create
```
New-MgUser`````o`````nen`````o`````tePage -UserId <String> -B`````o`````dyParameter <IMicr`````o`````s`````o`````ftGraph`````o`````nen`````o`````tePage> [-WhatIf] [-C`````o`````nfirm]
 [<C`````o`````mm`````o`````nParameters>]
```

### CreateViaIdentityExpanded
```
New-MgUser`````o`````nen`````o`````tePage -Input`````o`````bject <IN`````o`````tesIdentity> [-Additi`````o`````nalPr`````o`````perties <Hashtable>]
...
### CreateViaIdentity
```
New-MgUser`````o`````nen`````o`````tePage -Input`````o`````bject <IN`````o`````tesIdentity> -B`````o`````dyParameter <IMicr`````o`````s`````o`````ftGraph`````o`````nen`````o`````tePage> [-WhatIf]
