...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaUserOnenotePage](/powershell/module/Microsoft.Graph.Beta.Applications/New-MgBetaUserOnenotePage?view=graph-powershell-beta)

## SYNTAX

### CreateExpanded (Default)
```
New-MgUserOnenotePage -UserId <String> [-AdditionalProperties <Hashtable>] [-ContentInputFile <String>]
...
### Create
```
New-MgUserOnenotePage -UserId <String> -BodyParameter <IMicrosoftGraphOnenotePage> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgUserOnenotePage -InputObject <INotesIdentity> [-AdditionalProperties <Hashtable>]
...
### CreateViaIdentity
```
New-MgUserOnenotePage -InputObject <INotesIdentity> -BodyParameter <IMicrosoftGraphOnenotePage> [-WhatIf]
...
## RELATED LINKS
[New-MgBetaUserOnenotePage](/powershell/module/Microsoft.Graph.Beta.Applications/New-MgBetaUserOnenotePage?view=graph-powershell-beta)
