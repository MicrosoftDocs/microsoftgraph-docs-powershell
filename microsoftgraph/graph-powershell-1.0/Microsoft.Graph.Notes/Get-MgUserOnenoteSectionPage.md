...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/get-mguseronenotesectionpage
Locale: en-US
Module Name: Microsoft.Graph.Notes
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: Get-MgUserOnenoteSectionPage
---
...
```
Get-MgUserOnenoteSectionPage -OnenoteSectionId <string> -UserId <string>
...
```
Get-MgUserOnenoteSectionPage -OnenotePageId <string> -OnenoteSectionId <string> -UserId <string>
...
```
Get-MgUserOnenoteSectionPage -InputObject <INotesIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgUserOnenoteSectionPage](https://learn.microsoft.com/powershell/module/microsoft.graph.notes/get-mguseronenotesectionpage)
