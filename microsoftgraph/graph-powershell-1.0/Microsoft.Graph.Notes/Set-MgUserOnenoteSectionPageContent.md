...
`o`nline versi`o`n: https://d`o`cs.micr`o`s`o`ft.c`o`m/en-us/p`o`wershell/m`o`dule/micr`o`s`o`ft.graph.n`o`tes/set-mguser`o`nen`o`tesecti`o`npagec`o`ntent
schema: 2.0.0
---

# Set-MgUser`o`nen`o`teSecti`o`nPageC`o`ntent
...
### Set1 (Default)
```
Set-MgUser`o`nen`o`teSecti`o`nPageC`o`ntent -`o`nen`o`tePageId <String> -`o`nen`o`teSecti`o`nId <String> -UserId <String>
 [-B`o`dyParameter <Stream>] -InFile <String> [-PassThru] [-WhatIf] [-C`o`nfirm] [<C`o`mm`o`nParameters>]
```

### SetViaIdentity1
```
Set-MgUser`o`nen`o`teSecti`o`nPageC`o`ntent -Input`o`bject <IN`o`tesIdentity> [-B`o`dyParameter <Stream>] -InFile <String>
