...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/copy-mggrouponenotepagetosection
schema: 2.0.0
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Copy-MgBetaGroupOnenotePageToSection](/powershell/module/Microsoft.Graph.Beta.Notes/Copy-MgBetaGroupOnenotePageToSection?view=graph-powershell-beta)
...
```
Copy-MgGroupOnenotePageToSection [-GroupId <String>] -InputObject <INotesIdentity>
...
### CopyViaIdentity
```
Copy-MgGroupOnenotePageToSection -InputObject <INotesIdentity>
 -BodyParameter <IPaths112UvcyGroupsGroupIdOnenotePagesOnenotepageIdMicrosoftGraphCopytosectionPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.notes/copy-mggrouponenotepagetosection](https://learn.microsoft.com/powershell/module/microsoft.graph.notes/copy-mggrouponenotepagetosection)
