...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/copy-mggrouponenotenotebook
schema: 2.0.0
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Copy-MgBetaGroupOnenoteNotebook](/powershell/module/Microsoft.Graph.Beta.Notes/Copy-MgBetaGroupOnenoteNotebook?view=graph-powershell-beta)
...
```
Copy-MgGroupOnenoteNotebook [-GroupId <String>] -InputObject <INotesIdentity>
...
### CopyViaIdentity
```
Copy-MgGroupOnenoteNotebook -InputObject <INotesIdentity>
 -BodyParameter <IPaths1Nalx8HGroupsGroupIdOnenoteNotebooksNotebookIdMicrosoftGraphCopynotebookPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.notes/copy-mggrouponenotenotebook](https://learn.microsoft.com/powershell/module/microsoft.graph.notes/copy-mggrouponenotenotebook)
