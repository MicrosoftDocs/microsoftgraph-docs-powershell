...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.notes/get-mggrouponenotenotebook
Locale: en-US
Module Name: Microsoft.Graph.Notes
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: Get-MgGroupOnenoteNotebook
---
...
```
Get-MgGroupOnenoteNotebook -InputObject <INotesIdentity> [-ExpandProperty <string[]>]
 [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
```
...
- [Get-MgGroupOnenoteNotebook](https://learn.microsoft.com/powershell/module/microsoft.graph.notes/get-mggrouponenotenotebook)
