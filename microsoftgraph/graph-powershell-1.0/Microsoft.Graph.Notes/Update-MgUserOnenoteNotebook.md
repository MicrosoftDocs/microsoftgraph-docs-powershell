...
```````o```````nline versi```````o```````n: https://d```````o```````cs.micr```````o```````s```````o```````ft.c```````o```````m/en-us/p```````o```````wershell/m```````o```````dule/micr```````o```````s```````o```````ft.graph.n```````o```````tes/update-mguser```````o```````nen```````o```````ten```````o```````teb```````o``````````````o```````k
schema: 2.0.0
---

# Update-MgUser```````o```````nen```````o```````teN```````o```````teb```````o``````````````o```````k

## SYN```````o```````PSIS
Update the navigati```````o```````n pr```````o```````perty n```````o```````teb```````o``````````````o```````ks in users

## SYNTAX

### UpdateExpanded (Default)
```
Update-MgUser```````o```````nen```````o```````teN```````o```````teb```````o``````````````o```````k -N```````o```````teb```````o``````````````o```````kId <String> -UserId <String> [-Additi```````o```````nalPr```````o```````perties <Hashtable>]
...
### Update
```
Update-MgUser```````o```````nen```````o```````teN```````o```````teb```````o``````````````o```````k -N```````o```````teb```````o``````````````o```````kId <String> -UserId <String> -B```````o```````dyParameter <IMicr```````o```````s```````o```````ftGraphN```````o```````teb```````o``````````````o```````k>
 [-PassThru] [-WhatIf] [-C```````o```````nfirm] [<C```````o```````mm```````o```````nParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgUser```````o```````nen```````o```````teN```````o```````teb```````o``````````````o```````k -Input```````o```````bject <IN```````o```````tesIdentity> [-Additi```````o```````nalPr```````o```````perties <Hashtable>]
 [-CreatedBy <IMicr```````o```````s```````o```````ftGraphIdentitySet>] [-CreatedDateTime <DateTime>] [-DisplayName <String>] [-Id <String>]
 [-IsDefault] [-IsShared] [-LastM```````o```````difiedBy <IMicr```````o```````s```````o```````ftGraphIdentitySet>] [-LastM```````o```````difiedDateTime <DateTime>]
 [-Links <IMicr```````o```````s```````o```````ftGraphN```````o```````teb```````o``````````````o```````kLinks>] [-Secti```````o```````nGr```````o```````ups <IMicr```````o```````s```````o```````ftGraphSecti```````o```````nGr```````o```````up[]>]
 [-Secti```````o```````nGr```````o```````upsUrl <String>] [-Secti```````o```````ns <IMicr```````o```````s```````o```````ftGraph```````o```````nen```````o```````teSecti```````o```````n[]>] [-Secti```````o```````nsUrl <String>]
...
### UpdateViaIdentity
```
Update-MgUser```````o```````nen```````o```````teN```````o```````teb```````o``````````````o```````k -Input```````o```````bject <IN```````o```````tesIdentity> -B```````o```````dyParameter <IMicr```````o```````s```````o```````ftGraphN```````o```````teb```````o``````````````o```````k> [-PassThru]
