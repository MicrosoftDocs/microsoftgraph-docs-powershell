...
### List (Default)
```
Get-MgUserTrendingInsight -UserId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
[https://learn.microsoft.com/graph/api/insights-list-trending?view=graph-rest-1.0](https://learn.microsoft.com/graph/api/insights-list-trending?view=graph-rest-1.0)
