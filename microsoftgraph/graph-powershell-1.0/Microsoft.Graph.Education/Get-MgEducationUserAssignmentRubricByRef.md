...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.education/get-mgeducationuserassignmentrubricbyref
Locale: en-US
Module Name: Microsoft.Graph.Education
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: Get-MgEducationUserAssignmentRubricByRef
---
...
```
Get-MgEducationUserAssignmentRubricByRef -InputObject <IEducationIdentity>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
```
...
- [Get-MgEducationUserAssignmentRubricByRef](https://learn.microsoft.com/powershell/module/microsoft.graph.education/get-mgeducationuserassignmentrubricbyref)
