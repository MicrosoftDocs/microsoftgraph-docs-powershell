...
online version: https://`d`ocs.microsoft.com/en-us/powershell/mo`d`ule/microsoft.graph.e`d`ucation/remove-mge`d`ucationmeassignmentresource
schema: 2.0.0
---

# Remove-MgE`d`ucationMeAssignmentResource
...
### `d`elete1 (`d`efault)
```
Remove-MgE`d`ucationMeAssignmentResource -E`d`ucationAssignmentI`d` <String> -E`d`ucationAssignmentResourceI`d` <String>
 [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### `d`eleteViaI`d`entity1
```
Remove-MgE`d`ucationMeAssignmentResource -InputObject <IE`d`ucationI`d`entity> [-IfMatch <String>] [-PassThru]
