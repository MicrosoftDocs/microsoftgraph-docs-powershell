...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.education/update-mgeducationreportreflectcheck
Locale: en-US
Module Name: Microsoft.Graph.Education
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Update-MgEducationReportReflectCheck
---

# Update-MgEducationReportReflectCheck
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaEducationReportReflectCheck](/powershell/module/Microsoft.Graph.Beta.Education/Update-MgBetaEducationReportReflectCheck?view=graph-powershell-beta)
...
```
Update-MgEducationReportReflectCheck -ReflectCheckInResponseId <string>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-CheckInId <string>]
 [-CheckInTitle <string>] [-ClassId <string>] [-CreatedDateTime <datetime>] [-CreatorId <string>]
 [-Id <string>] [-IsClosed] [-ResponderId <string>] [-ResponseEmotion <string>]
 [-ResponseFeedback <string>] [-SubmitDateTime <datetime>] [-Break] [-Headers <IDictionary>]
...
```
Update-MgEducationReportReflectCheck -ReflectCheckInResponseId <string>
 -BodyParameter <IMicrosoftGraphReflectCheckInResponse> [-ResponseHeadersVariable <string>] [-Break]
...
```
Update-MgEducationReportReflectCheck -InputObject <IEducationIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-CheckInId <string>]
 [-CheckInTitle <string>] [-ClassId <string>] [-CreatedDateTime <datetime>] [-CreatorId <string>]
 [-Id <string>] [-IsClosed] [-ResponderId <string>] [-ResponseEmotion <string>]
 [-ResponseFeedback <string>] [-SubmitDateTime <datetime>] [-Break] [-Headers <IDictionary>]
...
### Microsoft.Graph.PowerShell.Models.IMicrosoftGraphReflectCheckInResponse
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.education/update-mgeducationreportreflectcheck)
