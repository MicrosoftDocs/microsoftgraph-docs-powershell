...
```
New-MgEducationSchoolClassByRef -EducationSchoolId <String> [-ResponseHeadersVariable <String>]
...
```
New-MgEducationSchoolClassByRef -InputObject <IEducationIdentity> [-ResponseHeadersVariable <String>]
 -OdataId <String> [-AdditionalProperties <Hashtable>] [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
