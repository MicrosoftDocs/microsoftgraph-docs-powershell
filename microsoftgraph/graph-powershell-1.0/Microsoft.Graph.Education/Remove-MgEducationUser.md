...
### Delete (Default)
```
Remove-MgEducationUser -EducationUserId <String> [-IfMatch <String>] [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgEducationUser -InputObject <IEducationIdentity> [-IfMatch <String>] [-Headers <IDictionary>]
