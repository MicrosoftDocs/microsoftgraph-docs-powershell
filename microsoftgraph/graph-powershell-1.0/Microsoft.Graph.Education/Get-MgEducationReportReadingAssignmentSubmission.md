...
```
Get-MgEducationReportReadingAssignmentSubmission [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgEducationReportReadingAssignmentSubmission -ReadingAssignmentSubmissionId <string>
...
```
Get-MgEducationReportReadingAssignmentSubmission -InputObject <IEducationIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [<CommonParameters>]
