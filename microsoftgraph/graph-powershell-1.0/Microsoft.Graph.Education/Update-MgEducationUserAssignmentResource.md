...
online version: https://```d```ocs.microsoft.com/en-us/powershell/mo```d```ule/microsoft.graph.e```d```ucation/up```d```ate-mge```d```ucationuserassignmentresource
schema: 2.0.0
---

# Up```d```ate-MgE```d```ucationUserAssignmentResource
...
```
Up```d```ate-MgE```d```ucationUserAssignmentResource -E```d```ucationAssignmentI```d``` <String>
 -E```d```ucationAssignmentResourceI```d``` <String> -E```d```ucationUserI```d``` <String> [-A```d``````d```itionalProperties <Hashtable>]
...
```
Up```d```ate-MgE```d```ucationUserAssignmentResource -E```d```ucationAssignmentI```d``` <String>
 -E```d```ucationAssignmentResourceI```d``` <String> -E```d```ucationUserI```d``` <String>
...
```
Up```d```ate-MgE```d```ucationUserAssignmentResource -InputObject <IE```d```ucationI```d```entity> [-A```d``````d```itionalProperties <Hashtable>]
 [-```d```istributeForStu```d```entWork] [-I```d``` <String>] [-Resource <IMicrosoftGraphE```d```ucationResource>] [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```
Up```d```ate-MgE```d```ucationUserAssignmentResource -InputObject <IE```d```ucationI```d```entity>
 -Bo```d```yParameter <IMicrosoftGraphE```d```ucationAssignmentResource> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
