...
```
Update-MgEducationClassAssignmentSubmission -EducationAssignmentId <string>
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.education/update-mgeducationclassassignmentsubmission)
