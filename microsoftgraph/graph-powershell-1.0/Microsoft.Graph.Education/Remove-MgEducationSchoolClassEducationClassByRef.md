...
```
Remove-MgEducationSchoolClassEducationClassByRef -EducationClassId <string>
 -EducationSchoolId <string> [-IfMatch <string>] [-ResponseHeadersVariable <string>] [-Break]
...
```
Remove-MgEducationSchoolClassEducationClassByRef -InputObject <IEducationIdentity>
