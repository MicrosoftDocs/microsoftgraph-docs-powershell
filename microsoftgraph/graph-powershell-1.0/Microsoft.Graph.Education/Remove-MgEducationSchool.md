...
### Delete (Default)
```
Remove-MgEducationSchool -EducationSchoolId <String> [-IfMatch <String>] [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgEducationSchool -InputObject <IEducationIdentity> [-IfMatch <String>] [-Headers <IDictionary>]
