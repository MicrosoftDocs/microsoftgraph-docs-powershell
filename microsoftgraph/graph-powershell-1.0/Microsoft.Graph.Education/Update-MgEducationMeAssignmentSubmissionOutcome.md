...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.education/update-mgeducationmeassignmentsubmissionoutcome
Locale: en-US
Module Name: Microsoft.Graph.Education
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: Update-MgEducationMeAssignmentSubmissionOutcome
---
...
```
Update-MgEducationMeAssignmentSubmissionOutcome -EducationAssignmentId <string>
 -EducationOutcomeId <string> -EducationSubmissionId <string> [-ResponseHeadersVariable <string>]
...
```
Update-MgEducationMeAssignmentSubmissionOutcome -EducationAssignmentId <string>
 -EducationOutcomeId <string> -EducationSubmissionId <string>
 -BodyParameter <IMicrosoftGraphEducationOutcome> [-ResponseHeadersVariable <string>] [-Break]
...
```
Update-MgEducationMeAssignmentSubmissionOutcome -InputObject <IEducationIdentity>
...
- [Update-MgEducationMeAssignmentSubmissionOutcome](https://learn.microsoft.com/powershell/module/microsoft.graph.education/update-mgeducationmeassignmentsubmissionoutcome)
