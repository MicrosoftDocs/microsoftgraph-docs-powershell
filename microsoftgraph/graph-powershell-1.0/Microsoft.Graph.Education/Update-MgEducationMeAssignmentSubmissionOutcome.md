...
online version: https://```d```ocs.microsoft.com/en-us/powershell/mo```d```ule/microsoft.graph.e```d```ucation/up```d```ate-mge```d```ucationmeassignmentsubmissionoutcome
schema: 2.0.0
---

# Up```d```ate-MgE```d```ucationMeAssignmentSubmissionOutcome

## SYNOPSIS
Up```d```ate the navigation property outcomes in e```d```ucation

## SYNTAX

### Up```d```ateExpan```d```e```d```1 (```d```efault)
```
Up```d```ate-MgE```d```ucationMeAssignmentSubmissionOutcome -E```d```ucationAssignmentI```d``` <String> -E```d```ucationOutcomeI```d``` <String>
 -E```d```ucationSubmissionI```d``` <String> [-A```d``````d```itionalProperties <Hashtable>] [-I```d``` <String>]
 [-LastMo```d```ifie```d```By <IMicrosoftGraphI```d```entitySet>] [-LastMo```d```ifie```d``````d```ateTime <```d```ateTime>] [-PassThru] [-WhatIf]
...
```
Up```d```ate-MgE```d```ucationMeAssignmentSubmissionOutcome -E```d```ucationAssignmentI```d``` <String> -E```d```ucationOutcomeI```d``` <String>
 -E```d```ucationSubmissionI```d``` <String> -Bo```d```yParameter <IMicrosoftGraphE```d```ucationOutcome> [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### Up```d```ateViaI```d```entityExpan```d```e```d```1
```
Up```d```ate-MgE```d```ucationMeAssignmentSubmissionOutcome -InputObject <IE```d```ucationI```d```entity>
 [-A```d``````d```itionalProperties <Hashtable>] [-I```d``` <String>] [-LastMo```d```ifie```d```By <IMicrosoftGraphI```d```entitySet>]
 [-LastMo```d```ifie```d``````d```ateTime <```d```ateTime>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Up```d```ateViaI```d```entity1
```
Up```d```ate-MgE```d```ucationMeAssignmentSubmissionOutcome -InputObject <IE```d```ucationI```d```entity>
 -Bo```d```yParameter <IMicrosoftGraphE```d```ucationOutcome> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
