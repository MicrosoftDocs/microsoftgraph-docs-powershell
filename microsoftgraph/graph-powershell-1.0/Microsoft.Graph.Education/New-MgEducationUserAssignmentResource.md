...
online version: https://```d```ocs.microsoft.com/en-us/powershell/mo```d```ule/microsoft.graph.e```d```ucation/new-mge```d```ucationuserassignmentresource
schema: 2.0.0
---

# New-MgE```d```ucationUserAssignmentResource
...
```
New-MgE```d```ucationUserAssignmentResource -E```d```ucationAssignmentI```d``` <String> -E```d```ucationUserI```d``` <String>
 [-A```d``````d```itionalProperties <Hashtable>] [-```d```istributeForStu```d```entWork] [-I```d``` <String>]
...
```
New-MgE```d```ucationUserAssignmentResource -E```d```ucationAssignmentI```d``` <String> -E```d```ucationUserI```d``` <String>
 -Bo```d```yParameter <IMicrosoftGraphE```d```ucationAssignmentResource> [-WhatIf] [-Confirm] [<CommonParameters>]
```

### CreateViaI```d```entityExpan```d```e```d```1
```
New-MgE```d```ucationUserAssignmentResource -InputObject <IE```d```ucationI```d```entity> [-A```d``````d```itionalProperties <Hashtable>]
 [-```d```istributeForStu```d```entWork] [-I```d``` <String>] [-Resource <IMicrosoftGraphE```d```ucationResource>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### CreateViaI```d```entity1
```
New-MgE```d```ucationUserAssignmentResource -InputObject <IE```d```ucationI```d```entity>
 -Bo```d```yParameter <IMicrosoftGraphE```d```ucationAssignmentResource> [-WhatIf] [-Confirm] [<CommonParameters>]
```
