...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.education/invoke-mgdeactivateeducationmeassignment
schema: 2.0.0
---
...
### Deactivate (Default)
```
Invoke-MgDeactivateEducationMeAssignment -EducationAssignmentId <String> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeactivateViaIdentity
```
Invoke-MgDeactivateEducationMeAssignment -InputObject <IEducationIdentity> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
## RELATED LINKS
[Invoke-MgBetaDeactivateEducationMeAssignment](/powershell/module/Microsoft.Graph.Beta.Education/Invoke-MgBetaDeactivateEducationMeAssignment?view=graph-powershell-beta)

[https://learn.microsoft.com/powershell/module/microsoft.graph.education/invoke-mgdeactivateeducationmeassignment](https://learn.microsoft.com/powershell/module/microsoft.graph.education/invoke-mgdeactivateeducationmeassignment)
