...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.education/update-mgeducationuserrubric
Locale: en-US
Module Name: Microsoft.Graph.Education
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: Update-MgEducationUserRubric
---
...
```
Update-MgEducationUserRubric -InputObject <IEducationIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgEducationUserRubric -InputObject <IEducationIdentity>
 -BodyParameter <IMicrosoftGraphEducationRubric> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [Update-MgEducationUserRubric](https://learn.microsoft.com/powershell/module/microsoft.graph.education/update-mgeducationuserrubric)
