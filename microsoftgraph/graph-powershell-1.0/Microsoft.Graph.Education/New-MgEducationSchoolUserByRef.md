...
```
New-MgEducationSchoolUserByRef -EducationSchoolId <String> [-ResponseHeadersVariable <String>]
...
```
New-MgEducationSchoolUserByRef -InputObject <IEducationIdentity> [-ResponseHeadersVariable <String>]
 -OdataId <String> [-AdditionalProperties <Hashtable>] [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
