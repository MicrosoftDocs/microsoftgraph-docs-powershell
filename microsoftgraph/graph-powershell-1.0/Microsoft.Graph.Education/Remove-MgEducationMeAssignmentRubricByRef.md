...
online version: https://`d`ocs.microsoft.com/en-us/powershell/mo`d`ule/microsoft.graph.e`d`ucation/remove-mge`d`ucationmeassignmentrubricbyref
schema: 2.0.0
---

# Remove-MgE`d`ucationMeAssignmentRubricByRef
...
### `d`elete1 (`d`efault)
```
Remove-MgE`d`ucationMeAssignmentRubricByRef -E`d`ucationAssignmentI`d` <String> [-IfMatch <String>] [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### `d`eleteViaI`d`entity1
```
Remove-MgE`d`ucationMeAssignmentRubricByRef -InputObject <IE`d`ucationI`d`entity> [-IfMatch <String>] [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
