...
### Delete (Default)
```
Remove-MgEducationMeAssignment -EducationAssignmentId <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgEducationMeAssignment -InputObject <IEducationIdentity> [-IfMatch <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
