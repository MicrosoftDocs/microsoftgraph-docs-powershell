...
online version: https://`````````d`````````ocs.microsoft.com/en-us/powershell/mo`````````d`````````ule/microsoft.graph.e`````````d`````````ucation/new-mge`````````d`````````ucationuserassignmentsubmission
schema: 2.0.0
---

# New-MgE`````````d`````````ucationUserAssignmentSubmission
...
```
New-MgE`````````d`````````ucationUserAssignmentSubmission -E`````````d`````````ucationAssignmentI`````````d````````` <String> -E`````````d`````````ucationUserI`````````d````````` <String>
...
```
New-MgE`````````d`````````ucationUserAssignmentSubmission -InputObject <IE`````````d`````````ucationI`````````d`````````entity> [-A`````````d``````````````````d`````````itionalProperties <Hashtable>]
...
```
New-MgE`````````d`````````ucationUserAssignmentSubmission -InputObject <IE`````````d`````````ucationI`````````d`````````entity>
 -Bo`````````d`````````yParameter <IMicrosoftGraphE`````````d`````````ucationSubmission> [-WhatIf] [-Confirm] [<CommonParameters>]
```
