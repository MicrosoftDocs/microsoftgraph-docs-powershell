...
### Create (Default)
```
New-MgEducationMeAssignmentCategoryByRef -EducationAssignmentId <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgEducationMeAssignmentCategoryByRef -InputObject <IEducationIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
