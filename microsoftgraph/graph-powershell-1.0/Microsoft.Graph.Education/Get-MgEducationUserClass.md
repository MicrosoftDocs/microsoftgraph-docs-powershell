...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.education/get-mgeducationuserclass
Locale: en-US
Module Name: Microsoft.Graph.Education
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: Get-MgEducationUserClass
---
...
```
Get-MgEducationUserClass -EducationUserId <string> [-ExpandProperty <string[]>]
...
```
Get-MgEducationUserClass -EducationClassId <string> -EducationUserId <string>
...
```
Get-MgEducationUserClass -InputObject <IEducationIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgEducationUserClass](https://learn.microsoft.com/powershell/module/microsoft.graph.education/get-mgeducationuserclass)
