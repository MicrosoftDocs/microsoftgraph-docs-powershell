...
```
Get-MgEducationClassMember -EducationClassId <string> [-ExpandProperty <string[]>]
...
- [Get-MgEducationClassMember](https://learn.microsoft.com/powershell/module/microsoft.graph.education/get-mgeducationclassmember)
