...
### Delete (Default)
```
Remove-MgEducationClass -EducationClassId <String> [-IfMatch <String>] [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgEducationClass -InputObject <IEducationIdentity> [-IfMatch <String>] [-Headers <IDictionary>]
