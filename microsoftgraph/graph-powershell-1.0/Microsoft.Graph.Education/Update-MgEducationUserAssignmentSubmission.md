...
```
Update-MgEducationUserAssignmentSubmission -EducationAssignmentId <String> -EducationSubmissionId <String>
 -EducationUserId <String> -BodyParameter <IMicrosoftGraphEducationSubmission1> [-PassThru] [-WhatIf]
...
```
Update-MgEducationUserAssignmentSubmission -InputObject <IEducationIdentity>
 -BodyParameter <IMicrosoftGraphEducationSubmission1> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
