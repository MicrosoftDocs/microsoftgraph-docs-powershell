...
### Set1 (Default)
```
Set-MgEducationMeAssignmentRubricByRef -EducationAssignmentId <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### SetViaIdentity1
```
Set-MgEducationMeAssignmentRubricByRef -InputObject <IEducationIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
