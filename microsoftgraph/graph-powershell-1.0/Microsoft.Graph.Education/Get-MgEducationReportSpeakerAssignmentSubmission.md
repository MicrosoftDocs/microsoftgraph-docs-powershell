...
```
Get-MgEducationReportSpeakerAssignmentSubmission [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgEducationReportSpeakerAssignmentSubmission -SpeakerAssignmentSubmissionId <string>
...
```
Get-MgEducationReportSpeakerAssignmentSubmission -InputObject <IEducationIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
