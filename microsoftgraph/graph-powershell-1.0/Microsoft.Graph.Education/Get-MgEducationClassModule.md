...
### List (Default)
```
Get-MgEducationClassModule -EducationClassId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
### Get
```
Get-MgEducationClassModule -EducationClassId <String> -EducationModuleId <String> [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgEducationClassModule -InputObject <IEducationIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
