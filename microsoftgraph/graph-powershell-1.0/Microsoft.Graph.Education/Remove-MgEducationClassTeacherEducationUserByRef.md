...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.education/remove-mgeducationclassteachereducationuserbyref
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgEducationClassTeacherEducationUserByRef -EducationClassId <String> -EducationUserId <String>
...
### DeleteViaIdentity
```
Remove-MgEducationClassTeacherEducationUserByRef -InputObject <IEducationIdentity> [-IfMatch <String>]
...
## RELATED LINKS
[Remove-MgBetaEducationClassTeacherEducationUserByRef](/powershell/module/Microsoft.Graph.Beta.Education/Remove-MgBetaEducationClassTeacherEducationUserByRef?view=graph-powershell-beta)
