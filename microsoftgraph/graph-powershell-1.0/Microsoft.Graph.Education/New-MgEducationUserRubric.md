...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.education/new-mgeducationuserrubric
Locale: en-US
Module Name: Microsoft.Graph.Education
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: New-MgEducationUserRubric
---
...
```
New-MgEducationUserRubric -EducationUserId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgEducationUserRubric -EducationUserId <string> -BodyParameter <IMicrosoftGraphEducationRubric>
...
```
New-MgEducationUserRubric -InputObject <IEducationIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-CreatedBy <IMicrosoftGraphIdentitySet>]
 [-Description <IMicrosoftGraphEducationItemBody>] [-DisplayName <string>] [-Grading <hashtable>]
 [-Id <string>] [-LastModifiedBy <IMicrosoftGraphIdentitySet>]
 [-Levels <IMicrosoftGraphRubricLevel[]>] [-Qualities <IMicrosoftGraphRubricQuality[]>] [-Break]
...
```
New-MgEducationUserRubric -InputObject <IEducationIdentity>
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.education/new-mgeducationuserrubric)
