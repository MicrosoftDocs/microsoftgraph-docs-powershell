...
```
New-MgEducationClassTeacherByRef -EducationClassId <String> [-ResponseHeadersVariable <String>]
...
```
New-MgEducationClassTeacherByRef -InputObject <IEducationIdentity> [-ResponseHeadersVariable <String>]
 -OdataId <String> [-AdditionalProperties <Hashtable>] [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
