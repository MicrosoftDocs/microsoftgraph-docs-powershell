...
### Delta1
```
Get-MgUserCalendarEventDelta -UserId <String> -CalendarId <String> [-Filter <String>] [-Property <String[]>]
...
### DeltaViaIdentity1
```
Get-MgUserCalendarEventDelta -InputObject <IUsersFunctionsIdentity> [-Filter <String>] [-Property <String[]>]
...
## RELATED LINKS
[Get-MgBetaBetaUserCalendarEventDelta](/powershell/module/Microsoft.Graph.Beta.Users.Functions/Get-MgBetaUserCalendarEventDelta?view=graph-powershell-beta)
