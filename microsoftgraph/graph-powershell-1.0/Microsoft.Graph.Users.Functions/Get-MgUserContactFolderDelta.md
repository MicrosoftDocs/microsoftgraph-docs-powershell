...
### Delta (Default)
```
Get-MgUserContactFolderDelta -UserId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### DeltaViaIdentity
```
Get-MgUserContactFolderDelta -InputObject <IUsersFunctionsIdentity> [-ExpandProperty <String[]>]
