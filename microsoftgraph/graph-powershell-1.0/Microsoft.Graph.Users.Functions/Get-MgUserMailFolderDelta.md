...
### Delta (Default)
```
Get-MgUserMailFolderDelta -UserId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### DeltaViaIdentity
```
Get-MgUserMailFolderDelta -InputObject <IUsersFunctionsIdentity> [-ExpandProperty <String[]>]
