...
```
Get-MgUserManagedAppPolicy -InputObject <IUsersFunctionsIdentity> [-Count]
...
- [Graph API Reference](https://learn.microsoft.com/graph/api/intune-mam-user-getmanagedapppolicies?view=graph-rest-1.0)
