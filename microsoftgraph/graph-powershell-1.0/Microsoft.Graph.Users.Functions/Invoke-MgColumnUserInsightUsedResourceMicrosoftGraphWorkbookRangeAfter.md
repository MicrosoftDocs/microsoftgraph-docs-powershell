...
### Columns (Default)
```
Invoke-MgColumnUserInsightUsedResourceMicrosoftGraphWorkbookRangeAfter -UsedInsightId <String> -UserId <String>
 [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.functions/invoke-mgcolumnuserinsightusedresourcemicrosoftgraphworkbookrangeafter](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.functions/invoke-mgcolumnuserinsightusedresourcemicrosoftgraphworkbookrangeafter)
