...
### Search (Default)
```
Search-MgUserDrive -DriveId <String> -Q <String> -UserId <String> [-Count] [-ExpandProperty <String[]>]
...
### SearchViaIdentity
```
Search-MgUserDrive -InputObject <IUsersFunctionsIdentity> [-Count] [-ExpandProperty <String[]>]
 [-Filter <String>] [-Property <String[]>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>] [-Top <Int32>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
