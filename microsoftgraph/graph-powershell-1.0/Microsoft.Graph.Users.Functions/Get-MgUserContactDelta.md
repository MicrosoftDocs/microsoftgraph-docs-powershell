...
### Delta (Default)
```
Get-MgUserContactDelta -UserId <String> [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>]
...
### DeltaViaIdentity
```
Get-MgUserContactDelta -InputObject <IUsersFunctionsIdentity> [-ExpandProperty <String[]>] [-Filter <String>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.users.functions/get-mgusercontactdelta](https://learn.microsoft.com/powershell/module/microsoft.graph.users.functions/get-mgusercontactdelta)
