...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.users.functions/get-mguserdrivelistitemdelta
schema: 2.0.0
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaUserDriveListItemDelta](/powershell/module/Microsoft.Graph.Beta.Users.Functions/Get-MgBetaUserDriveListItemDelta?view=graph-powershell-beta)

## SYNTAX

### Delta (Default)
```
Get-MgUserDriveListItemDelta -DriveId <String> -UserId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### Delta1
```
Get-MgUserDriveListItemDelta -DriveId <String> -UserId <String> -Token <String> [-ExpandProperty <String[]>]
...
### DeltaViaIdentity1
```
Get-MgUserDriveListItemDelta -InputObject <IUsersFunctionsIdentity> [-ExpandProperty <String[]>]
 [-Filter <String>] [-Property <String[]>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>] [-Top <Int32>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.users.functions/get-mguserdrivelistitemdelta](https://learn.microsoft.com/powershell/module/microsoft.graph.users.functions/get-mguserdrivelistitemdelta)
