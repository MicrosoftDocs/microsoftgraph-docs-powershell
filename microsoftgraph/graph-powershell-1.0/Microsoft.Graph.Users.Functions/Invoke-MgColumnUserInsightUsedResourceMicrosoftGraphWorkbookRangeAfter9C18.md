...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.functions/invoke-mgcolumnuserinsightusedresourcemicrosoftgraphworkbookrangeafter9c18
schema: 2.0.0
---
...
### Columns (Default)
```
Invoke-MgColumnUserInsightUsedResourceMicrosoftGraphWorkbookRangeAfter9C18 -UsedInsightId <String>
