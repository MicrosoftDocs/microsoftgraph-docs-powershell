...
```
Get-MgUserManagedDeviceWithAppFailure -UserId <string> [-Count] [-Filter <string>]
...
```
Get-MgUserManagedDeviceWithAppFailure -InputObject <IUsersFunctionsIdentity> [-Count]
...
- [Graph API Reference](https://learn.microsoft.com/graph/api/intune-troubleshooting-user-getmanageddeviceswithappfailures?view=graph-rest-1.0)
