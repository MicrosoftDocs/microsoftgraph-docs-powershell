...
### Recent (Default)
```
Invoke-MgRecentUserDrive -DriveId <String> -UserId <String> [-Count] [-ExpandProperty <String[]>]
...
### RecentViaIdentity
```
Invoke-MgRecentUserDrive -InputObject <IUsersFunctionsIdentity> [-Count] [-ExpandProperty <String[]>]
 [-Filter <String>] [-Property <String[]>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>] [-Top <Int32>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
