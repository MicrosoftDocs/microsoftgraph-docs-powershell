...
```
Update-MgDeviceManagementRoleDefinitionRoleAssignment -RoleAssignmentId <string>
 -RoleDefinitionId <string> [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
...
```
Update-MgDeviceManagementRoleDefinitionRoleAssignment -RoleAssignmentId <string>
 -RoleDefinitionId <string> -BodyParameter <IMicrosoftGraphRoleAssignment>
