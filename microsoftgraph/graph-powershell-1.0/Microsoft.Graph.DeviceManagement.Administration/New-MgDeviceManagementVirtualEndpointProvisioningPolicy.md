...
New-MgDeviceManagementVirtualEndpointProvisioningPolicy [-ResponseHeadersVariable <String>]
 ...
 [-Autopatch <IMicrosoftGraphCloudPcProvisioningPolicyAutopatch>] [-CloudPcGroupDisplayName <String>]
 ...
 [-ImageType <String>] [-LocalAdminEnabled] [-MicrosoftManagedDesktop <IMicrosoftGraphMicrosoftManagedDesktop>]
 [-ProvisioningType <String>] [-WindowsSetting <IMicrosoftGraphCloudPcWindowsSetting>] [-Headers <IDictionary>]
...
```yaml
Type: IMicrosoftGraphCloudPcProvisioningPolicyAutopatch
Parameter Sets: CreateExpanded
Aliases:
...
```yaml
Type: IMicrosoftGraphCloudPcWindowsSetting
Parameter Sets: CreateExpanded
Aliases:
