...
```
New-MgUserOnlineMeetingRecording -OnlineMeetingId <String> -UserId <String> [-AdditionalProperties <Hashtable>]
...
New-MgUserOnlineMeetingRecording -OnlineMeetingId <String> -UserId <String>
 -BodyParameter <IMicrosoftGraphCallRecording> [-Headers <IDictionary>] [-ProgressAction <ActionPreference>]
