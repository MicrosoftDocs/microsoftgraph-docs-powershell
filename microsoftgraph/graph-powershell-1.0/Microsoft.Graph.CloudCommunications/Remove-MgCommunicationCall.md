...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.cloudcommunications/remove-mgcommunicationcall
Locale: en-US
Module Name: Microsoft.Graph.CloudCommunications
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Remove-MgCommunicationCall
---
...
```
Remove-MgCommunicationCall -CallId <string> [-IfMatch <string>] [-ResponseHeadersVariable <string>]
...
- [Remove-MgCommunicationCall](https://learn.microsoft.com/powershell/module/microsoft.graph.cloudcommunications/remove-mgcommunicationcall)
- [Graph API Reference](https://learn.microsoft.com/graph/api/call-delete?view=graph-rest-1.0)
