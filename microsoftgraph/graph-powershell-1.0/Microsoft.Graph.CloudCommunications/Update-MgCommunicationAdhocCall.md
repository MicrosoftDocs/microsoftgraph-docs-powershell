...
```
Update-MgCommunicationAdhocCall -AdhocCallId <string> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Id <string>] [-Recordings <IMicrosoftGraphCallRecording[]>]
 [-Transcripts <IMicrosoftGraphCallTranscript[]>] [-Break] [-Headers <IDictionary>]
...
```
Update-MgCommunicationAdhocCall -AdhocCallId <string> -BodyParameter <IMicrosoftGraphAdhocCall>
...
```
Update-MgCommunicationAdhocCall -InputObject <ICloudCommunicationsIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-Id <string>]
 [-Recordings <IMicrosoftGraphCallRecording[]>] [-Transcripts <IMicrosoftGraphCallTranscript[]>]
...
```
Update-MgCommunicationAdhocCall -InputObject <ICloudCommunicationsIdentity>
 -BodyParameter <IMicrosoftGraphAdhocCall> [-ResponseHeadersVariable <string>] [-Break]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphAdhocCall
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.PowerShell.Models.IMicrosoftGraphAdhocCall
