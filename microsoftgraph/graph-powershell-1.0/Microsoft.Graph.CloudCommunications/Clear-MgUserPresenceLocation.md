...
```
Clear-MgUserPresenceLocation -UserId <string> [-ResponseHeadersVariable <string>] [-Break]
...
```
Clear-MgUserPresenceLocation -InputObject <ICloudCommunicationsIdentity>
