...
Update-MgCommunicationOnlineMeeting -OnlineMeetingId <string> [-ResponseHeadersVariable <string>]
 ...
 [-MeetingSpokenLanguageTag <string>] [-MeetingTemplateId <string>] [-MeetingType <string>]
...
```
Update-MgCommunicationOnlineMeeting -OnlineMeetingId <string>
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphCloudVideoInteropInfo
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphOnlineMeetingSensitivityLabelAssignment
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
- [Update-MgCommunicationOnlineMeeting](https://learn.microsoft.com/powershell/module/microsoft.graph.cloudcommunications/update-mgcommunicationonlinemeeting)
