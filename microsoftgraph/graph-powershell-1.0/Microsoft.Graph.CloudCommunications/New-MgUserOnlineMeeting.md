...
on`````````l`````````ine version: https://docs.microsoft.com/en-us/powershe`````````l``````````````````l`````````/modu`````````l`````````e/microsoft.graph.c`````````l`````````oudcommunications/new-mguseron`````````l`````````inemeeting
schema: 2.0.0
---

# New-MgUserOn`````````l`````````ineMeeting

## SYNOPSIS
Create new navigation property to on`````````l`````````ineMeetings for users

## SYNTAX

### CreateExpanded (Defau`````````l`````````t)
```
New-MgUserOn`````````l`````````ineMeeting -UserId <String> [-Additiona`````````l`````````Properties <Hashtab`````````l`````````e>] [-A`````````l``````````````````l`````````owAttendeeToEnab`````````l`````````eCamera]
...
### Create
```
New-MgUserOn`````````l`````````ineMeeting -UserId <String> -BodyParameter <IMicrosoftGraphOn`````````l`````````ineMeeting> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgUserOn`````````l`````````ineMeeting -InputObject <IC`````````l`````````oudCommunicationsIdentity> [-Additiona`````````l`````````Properties <Hashtab`````````l`````````e>]
...
### CreateViaIdentity
```
New-MgUserOn`````````l`````````ineMeeting -InputObject <IC`````````l`````````oudCommunicationsIdentity>
 -BodyParameter <IMicrosoftGraphOn`````````l`````````ineMeeting> [-WhatIf] [-Confirm] [<CommonParameters>]
```
