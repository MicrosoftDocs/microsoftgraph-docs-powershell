...
### Set (Default)
```
Set-MgTeamPrimaryChannelFileFolderContent -TeamId <String> [-Data <Stream>] [-ResponseHeadersVariable <String>]
...
### SetViaIdentity
```
Set-MgTeamPrimaryChannelFileFolderContent -InputObject <ITeamsIdentity> [-Data <Stream>]
