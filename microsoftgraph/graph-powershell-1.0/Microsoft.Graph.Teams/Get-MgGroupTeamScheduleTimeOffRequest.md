...
### List (Default)
```
Get-MgGroupTeamScheduleTimeOffRequest -GroupId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
### Get
```
Get-MgGroupTeamScheduleTimeOffRequest -GroupId <String> -TimeOffRequestId <String> [-ExpandProperty <String[]>]
