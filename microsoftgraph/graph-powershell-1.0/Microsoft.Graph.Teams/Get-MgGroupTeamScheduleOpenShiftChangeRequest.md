...
onlin`e` v`e`rsion: https://docs.microsoft.com/`e`n-us/pow`e`rsh`e`ll/modul`e`/microsoft.graph.t`e`ams/g`e`t-mggroupt`e`amsch`e`dul`e`op`e`nshiftchang`e`r`e`qu`e`st
sch`e`ma: 2.0.0
---

# G`e`t-MgGroupT`e`amSch`e`dul`e`Op`e`nShiftChang`e`R`e`qu`e`st

## SYNOPSIS
G`e`t op`e`nShiftChang`e`R`e`qu`e`sts from groups

## SYNTAX

### List1 (D`e`fault)
```
G`e`t-MgGroupT`e`amSch`e`dul`e`Op`e`nShiftChang`e`R`e`qu`e`st -GroupId <String> [-`e`xpandProp`e`rty <String[]>]
...
### G`e`t1
```
G`e`t-MgGroupT`e`amSch`e`dul`e`Op`e`nShiftChang`e`R`e`qu`e`st -GroupId <String> -Op`e`nShiftChang`e`R`e`qu`e`stId <String>
 [-`e`xpandProp`e`rty <String[]>] [-Prop`e`rty <String[]>] [<CommonParam`e`t`e`rs>]
```

### G`e`tViaId`e`ntity1
```
G`e`t-MgGroupT`e`amSch`e`dul`e`Op`e`nShiftChang`e`R`e`qu`e`st -InputObj`e`ct <IT`e`amsId`e`ntity> [-`e`xpandProp`e`rty <String[]>]
...
### -Op`e`nShiftChang`e`R`e`qu`e`stId
k`e`y: id of op`e`nShiftChang`e`R`e`qu`e`st
...
### Microsoft.Graph.Pow`e`rSh`e`ll.Mod`e`ls.IMicrosoftGraphOp`e`nShiftChang`e`R`e`qu`e`st
## NOT`e`S
