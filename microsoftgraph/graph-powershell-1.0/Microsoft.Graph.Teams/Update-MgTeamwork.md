...
Update-MgTeamwork [-AdditionalProperties <Hashtable>] [-DeletedTeams <IMicrosoftGraphDeletedTeam[]>]
 ...
 [-WorkforceIntegrations <IMicrosoftGraphWorkforceIntegration[]>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Update
```
Update-MgTeamwork -BodyParameter <IMicrosoftGraphTeamwork> [-WhatIf] [-Confirm] [<CommonParameters>]
```
