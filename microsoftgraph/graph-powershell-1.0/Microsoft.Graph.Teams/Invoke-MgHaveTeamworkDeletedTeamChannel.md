...
```
Invoke-MgHaveTeamworkDeletedTeamChannel -ChannelId <string> -DeletedTeamId <string>
...
```
Invoke-MgHaveTeamworkDeletedTeamChannel -InputObject <ITeamsIdentity> [-TenantId <string>]
