...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/remove-mgteamchannelallmember
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Remove-MgTeamChannelAllMember
---

# Remove-MgTeamChannelAllMember
...
```
Remove-MgTeamChannelAllMember -ChannelId <string> -TeamId <string>
...
```
Remove-MgTeamChannelAllMember -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
...
```
Remove-MgTeamChannelAllMember -InputObject <ITeamsIdentity>
 -BodyParameter <IPaths1Dhtpq3TeamsTeamIdChannelsChannelIdAllmembersMicrosoftGraphRemovePostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths1Dhtpq3TeamsTeamIdChannelsChannelIdAllmembersMicrosoftGraphRemovePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.PowerShell.Models.IPaths1Dhtpq3TeamsTeamIdChannelsChannelIdAllmembersMicrosoftGraphRemovePostRequestbodyContentApplicationJsonSchema
...
- [Remove-MgTeamChannelAllMember](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/remove-mgteamchannelallmember)
