...
```
Update-MgTeamPhoto -TeamId <String> [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>]
...
### Update
```
Update-MgTeamPhoto -TeamId <String> -BodyParameter <IMicrosoftGraphProfilePhoto>
...
```
Update-MgTeamPhoto -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
