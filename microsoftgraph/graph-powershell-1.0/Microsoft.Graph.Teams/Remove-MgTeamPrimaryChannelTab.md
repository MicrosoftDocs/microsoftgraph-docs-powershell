...
onlin`e` v`e`rsion: https://docs.microsoft.com/`e`n-us/pow`e`rsh`e`ll/modul`e`/microsoft.graph.t`e`ams/r`e`mov`e`-mgt`e`amprimarychann`e`ltab
sch`e`ma: 2.0.0
---

# R`e`mov`e`-MgT`e`amPrimaryChann`e`lTab
...
```
R`e`mov`e`-MgT`e`amPrimaryChann`e`lTab -T`e`amId <String> -T`e`amsTabId <String> [-IfMatch <String>] [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParam`e`t`e`rs>]
```

### D`e`l`e`t`e`ViaId`e`ntity
```
R`e`mov`e`-MgT`e`amPrimaryChann`e`lTab -InputObj`e`ct <IT`e`amsId`e`ntity> [-IfMatch <String>] [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParam`e`t`e`rs>]
```
