...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mgallteamchannel
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: Get-MgAllTeamChannel
---
...
```
Get-MgAllTeamChannel -TeamId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgAllTeamChannel -ChannelId <string> -TeamId <string> [-ExpandProperty <string[]>]
...
```
Get-MgAllTeamChannel -InputObject <ITeamsIdentity> [-ExpandProperty <string[]>]
 [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [<CommonParameters>]
```
