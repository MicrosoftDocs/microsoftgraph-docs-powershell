...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/update-mguserteamwork
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: Update-MgUserTeamwork
---
...
```
Update-MgUserTeamwork -UserId <string> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-AssociatedTeams <IMicrosoftGraphAssociatedTeamInfo[]>]
 [-Id <string>] [-InstalledApps <IMicrosoftGraphUserScopeTeamsAppInstallation[]>] [-Locale <string>]
 [-Region <string>] [-Break] [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
...
Represents the location that a user selected in Microsoft Teams and doesn't follow the Office's locale setting.
...
Represents the region of the organization or the user.
