...
Update-MgUserTeamwork -UserId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-InstalledApps <IMicrosoftGraphUserScopeTeamsAppInstallation[]>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Update
```
Update-MgUserTeamwork -UserId <String> -BodyParameter <IMicrosoftGraphUserTeamwork> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### UpdateViaIdentity
```
Update-MgUserTeamwork -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphUserTeamwork> [-WhatIf]
...
```yaml
Type: IMicrosoftGraphAssociatedTeamInfo[]
Parameter Sets: UpdateExpanded, UpdateViaIdentityExpanded
Aliases:
...
```yaml
Type: IMicrosoftGraphUserTeamwork
