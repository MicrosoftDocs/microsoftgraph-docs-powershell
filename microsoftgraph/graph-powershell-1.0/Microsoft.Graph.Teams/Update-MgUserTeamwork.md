...
Update-MgUserTeamwork -UserId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-InstalledApps <IMicrosoftGraphUserScopeTeamsAppInstallation[]>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Update-MgUserTeamwork -UserId <String> -BodyParameter <IMicrosoftGraphUserTeamwork> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgUserTeamwork -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphUserTeamwork> [-Confirm]
