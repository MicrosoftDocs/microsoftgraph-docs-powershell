...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mgteampermissiongrant
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: New-MgTeamPermissionGrant
---
...
```
New-MgTeamPermissionGrant -TeamId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgTeamPermissionGrant -TeamId <string>
...
```
New-MgTeamPermissionGrant -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-ClientAppId <string>] [-ClientId <string>]
 [-DeletedDateTime <datetime>] [-Id <string>] [-Permission <string>] [-PermissionType <string>]
 [-ResourceAppId <string>] [-Break] [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
...
- [New-MgTeamPermissionGrant](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mgteampermissiongrant)
