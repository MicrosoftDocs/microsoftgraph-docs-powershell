...
onlin```e``` v```e```rsion: https://docs.microsoft.com/```e```n-us/pow```e```rsh```e```ll/modul```e```/microsoft.graph.t```e```ams/updat```e```-mggroupt```e```amsch```e```dul```e```sch```e```dulinggroup
sch```e```ma: 2.0.0
---

# Updat```e```-MgGroupT```e```amSch```e```dul```e```Sch```e```dulingGroup

## SYNOPSIS
Updat```e``` th```e``` navigation prop```e```rty sch```e```dulingGroups in groups

## SYNTAX

### Updat```e``````e```xpand```e```d1 (D```e```fault)
```
Updat```e```-MgGroupT```e```amSch```e```dul```e```Sch```e```dulingGroup -GroupId <String> -Sch```e```dulingGroupId <String>
...
```
Updat```e```-MgGroupT```e```amSch```e```dul```e```Sch```e```dulingGroup -InputObj```e```ct <IT```e```amsId```e```ntity> [-AdditionalProp```e```rti```e```s <Hashtabl```e```>]
...
```
Updat```e```-MgGroupT```e```amSch```e```dul```e```Sch```e```dulingGroup -InputObj```e```ct <IT```e```amsId```e```ntity>
 -BodyParam```e```t```e```r <IMicrosoftGraphSch```e```dulingGroup> [-PassThru] [-WhatIf] [-Confirm] [<CommonParam```e```t```e```rs>]
```
