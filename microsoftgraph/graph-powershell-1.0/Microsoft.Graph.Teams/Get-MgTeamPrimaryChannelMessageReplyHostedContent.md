...
Get-MgTeamPrimaryChannelMessageReplyHostedContent -ChatMessageHostedContentId <String> -ChatMessageId <String>
 -ChatMessageId1 <String> -TeamId <String> [-Format <String>] -OutFile <String> [-Headers <IDictionary>]
...
### GetViaIdentity1
```
Get-MgTeamPrimaryChannelMessageReplyHostedContent -InputObject <ITeamsIdentity> [-Format <String>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mgteamprimarychannelmessagereplyhostedcontent](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mgteamprimarychannelmessagereplyhostedcontent)
