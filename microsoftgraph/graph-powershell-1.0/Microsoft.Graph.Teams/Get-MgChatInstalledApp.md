...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaBetaChatInstalledApp](/powershell/module/Microsoft.Graph.Beta.Teams/Get-MgBetaChatInstalledApp?view=graph-powershell-beta)

## SYNTAX

### List (Default)
```
Get-MgChatInstalledApp -ChatId <String> [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
## RELATED LINKS
[Get-MgBetaBetaChatInstalledApp](/powershell/module/Microsoft.Graph.Beta.Teams/Get-MgBetaChatInstalledApp?view=graph-powershell-beta)
