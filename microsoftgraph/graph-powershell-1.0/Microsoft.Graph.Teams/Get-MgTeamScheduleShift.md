...
### Get
```
Get-MgTeamScheduleShift -ShiftId <String> -TeamId <String> [-Property <String[]>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgTeamScheduleShift -InputObject <ITeamsIdentity> [-Property <String[]>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
