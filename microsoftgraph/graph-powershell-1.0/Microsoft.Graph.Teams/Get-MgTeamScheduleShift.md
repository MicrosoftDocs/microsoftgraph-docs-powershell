...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaTeamScheduleShift](/powershell/module/Microsoft.Graph.Beta.Applications/Get-MgBetaTeamScheduleShift?view=graph-powershell-beta)

## SYNTAX

### List (Default)
```
Get-MgTeamScheduleShift -TeamId <String> [-Property <String[]>] [-Filter <String>] [-Search <String>]
...
## RELATED LINKS
[Get-MgBetaTeamScheduleShift](/powershell/module/Microsoft.Graph.Beta.Applications/Get-MgBetaTeamScheduleShift?view=graph-powershell-beta)
