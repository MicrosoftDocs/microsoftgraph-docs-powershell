...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mggroupteamprimarychannelsharedwithteam
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: Get-MgGroupTeamPrimaryChannelSharedWithTeam
---
...
```
Get-MgGroupTeamPrimaryChannelSharedWithTeam -InputObject <ITeamsIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [<CommonParameters>]
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mggroupteamprimarychannelsharedwithteam)
