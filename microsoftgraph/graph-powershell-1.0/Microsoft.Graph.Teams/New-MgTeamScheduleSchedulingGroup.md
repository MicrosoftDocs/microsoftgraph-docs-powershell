...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mgteamscheduleschedulinggroup
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: New-MgTeamScheduleSchedulingGroup
---
...
```
New-MgTeamScheduleSchedulingGroup -TeamId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgTeamScheduleSchedulingGroup -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Code <string>] [-CreatedBy <IMicrosoftGraphIdentitySet>]
 [-DisplayName <string>] [-Id <string>] [-LastModifiedBy <IMicrosoftGraphIdentitySet>]
 [-UserIds <string[]>] [-Break] [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
...
- [New-MgTeamScheduleSchedulingGroup](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mgteamscheduleschedulinggroup)
- [Graph API Reference](https://learn.microsoft.com/graph/api/schedule-post-schedulinggroups?view=graph-rest-1.0)
