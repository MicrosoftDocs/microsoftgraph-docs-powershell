...
# Get-MgUserTeamworkTargetedMessage
...
```
Get-MgUserTeamworkTargetedMessage -UserId <string> [-Count] [-ExpandProperty <string[]>]
...
```
Get-MgUserTeamworkTargetedMessage -InputObject <ITeamsIdentity> [-Count]
...
- [](https://learn.microsoft.com/graph/api/userteamwork-getalltargetedmessages?view=graph-rest-1.0)
