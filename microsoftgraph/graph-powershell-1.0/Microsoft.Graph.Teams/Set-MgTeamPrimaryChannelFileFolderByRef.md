...
### Set1
```
Set-MgTeamPrimaryChannelFileFolderByRef -TeamId <String> -BodyParameter <Hashtable> [-PassThru] [-WhatIf]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams/set-mgteamprimarychannelfilefolderbyref](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams/set-mgteamprimarychannelfilefolderbyref)
