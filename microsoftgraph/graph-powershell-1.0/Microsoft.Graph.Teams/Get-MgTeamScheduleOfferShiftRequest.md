...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mgteamscheduleoffershiftrequest
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Get-MgTeamScheduleOfferShiftRequest
---
...
```
Get-MgTeamScheduleOfferShiftRequest -TeamId <string> [-ExpandProperty <string[]>]
...
- [Get-MgTeamScheduleOfferShiftRequest](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mgteamscheduleoffershiftrequest)
- [Graph API Reference](https://learn.microsoft.com/graph/api/offershiftrequest-get?view=graph-rest-1.0)
- [Graph API Reference](https://learn.microsoft.com/graph/api/offershiftrequest-list?view=graph-rest-1.0)
