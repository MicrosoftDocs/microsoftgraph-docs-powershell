...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mggraphgroupteamprimarychannelmessage
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: Invoke-MgGraphGroupTeamPrimaryChannelMessage
---

# Invoke-MgGraphGroupTeamPrimaryChannelMessage
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Invoke-MgBetaGraphGroupTeamPrimaryChannelMessage](/powershell/module/Microsoft.Graph.Beta.Teams/Invoke-MgBetaGraphGroupTeamPrimaryChannelMessage?view=graph-powershell-beta)
...
```
Invoke-MgGraphGroupTeamPrimaryChannelMessage -GroupId <string> [-ResponseHeadersVariable <string>]
...
```
Invoke-MgGraphGroupTeamPrimaryChannelMessage -GroupId <string>
...
```
Invoke-MgGraphGroupTeamPrimaryChannelMessage -InputObject <ITeamsIdentity>
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths1MzqmmGroupsGroupIdTeamPrimarychannelMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.PowerShell.Models.IPaths1MzqmmGroupsGroupIdTeamPrimarychannelMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
