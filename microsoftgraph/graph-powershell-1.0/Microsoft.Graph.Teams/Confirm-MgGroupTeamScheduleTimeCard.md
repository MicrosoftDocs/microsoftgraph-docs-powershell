...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/confirm-mggroupteamscheduletimecard
schema: 2.0.0
ms.subservice: teams
---
...
### Confirm (Default)
```
Confirm-MgGroupTeamScheduleTimeCard -GroupId <String> -TimeCardId <String> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### ConfirmViaIdentity
```
Confirm-MgGroupTeamScheduleTimeCard -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.teams/confirm-mggroupteamscheduletimecard](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/confirm-mggroupteamscheduletimecard)
