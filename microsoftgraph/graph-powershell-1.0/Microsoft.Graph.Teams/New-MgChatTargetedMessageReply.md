...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mgchattargetedmessagereply
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: New-MgChatTargetedMessageReply
---

# New-MgChatTargetedMessageReply
...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaChatTargetedMessageReply](/powershell/module/Microsoft.Graph.Beta.Teams/New-MgBetaChatTargetedMessageReply?view=graph-powershell-beta)
...
```
New-MgChatTargetedMessageReply -ChatId <string> -TargetedChatMessageId <string>
...
```
New-MgChatTargetedMessageReply -InputObject <ITeamsIdentity> [-ChatId <string>]
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-Attachments <IMicrosoftGraphChatMessageAttachment[]>] [-Body <IMicrosoftGraphItemBody>]
...
```
New-MgChatTargetedMessageReply -InputObject <ITeamsIdentity>
 -BodyParameter <IMicrosoftGraphChatMessage> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgChatTargetedMessageReply](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mgchattargetedmessagereply)
