...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaTeamScheduleShift](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaTeamScheduleShift?view=graph-powershell-beta)
...
### Update
```
Update-MgTeamScheduleShift -ShiftId <String> -TeamId <String> -BodyParameter <IMicrosoftGraphShift> [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
### UpdateViaIdentity
```
Update-MgTeamScheduleShift -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphShift> [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgBetaTeamScheduleShift](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaTeamScheduleShift?view=graph-powershell-beta)
