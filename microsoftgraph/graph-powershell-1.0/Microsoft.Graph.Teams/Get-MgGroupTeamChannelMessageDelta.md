...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mggroupteamchannelmessagedelta
schema: 2.0.0
ms.subservice: teams
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaGroupTeamChannelMessageDelta](/powershell/module/Microsoft.Graph.Beta.Teams/Get-MgBetaGroupTeamChannelMessageDelta?view=graph-powershell-beta)

## SYNTAX

### Delta (Default)
```
Get-MgGroupTeamChannelMessageDelta -ChannelId <String> -GroupId <String> [-ExpandProperty <String[]>]
...
### DeltaViaIdentity
```
Get-MgGroupTeamChannelMessageDelta -InputObject <ITeamsIdentity> [-ExpandProperty <String[]>]
 [-Filter <String>] [-Property <String[]>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>] [-Top <Int32>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mggroupteamchannelmessagedelta](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mggroupteamchannelmessagedelta)
