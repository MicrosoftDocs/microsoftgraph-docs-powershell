...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/update-mggroupteamprimarychanneltab
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Update-MgGroupTeamPrimaryChannelTab
---
...
```
Update-MgGroupTeamPrimaryChannelTab -InputObject <ITeamsIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-Configuration <IMicrosoftGraphTeamsTabConfiguration>] [-DisplayName <string>] [-Id <string>]
 [-TeamsApp <IMicrosoftGraphTeamsApp>] [-WebUrl <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
...
- [Update-MgGroupTeamPrimaryChannelTab](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/update-mggroupteamprimarychanneltab)
