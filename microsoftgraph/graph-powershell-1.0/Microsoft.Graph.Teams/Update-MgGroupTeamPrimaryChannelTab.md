...
onlin````e```` v````e````rsion: https://docs.microsoft.com/````e````n-us/pow````e````rsh````e````ll/modul````e````/microsoft.graph.t````e````ams/updat````e````-mggroupt````e````amprimarychann````e````ltab
sch````e````ma: 2.0.0
---

# Updat````e````-MgGroupT````e````amPrimaryChann````e````lTab
...
```
Updat````e````-MgGroupT````e````amPrimaryChann````e````lTab -GroupId <String> -T````e````amsTabId <String> [-AdditionalProp````e````rti````e````s <Hashtabl````e````>]
...
### Updat````e````1
```
Updat````e````-MgGroupT````e````amPrimaryChann````e````lTab -GroupId <String> -T````e````amsTabId <String>
...
```
Updat````e````-MgGroupT````e````amPrimaryChann````e````lTab -InputObj````e````ct <IT````e````amsId````e````ntity> [-AdditionalProp````e````rti````e````s <Hashtabl````e````>]
 [-Configuration <IMicrosoftGraphT````e````amsTabConfiguration>] [-DisplayNam````e```` <String>] [-Id <String>]
 [-T````e````amsApp <IMicrosoftGraphT````e````amsApp1>] [-W````e````bUrl <String>] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParam````e````t````e````rs>]
```
...
```
Updat````e````-MgGroupT````e````amPrimaryChann````e````lTab -InputObj````e````ct <IT````e````amsId````e````ntity> -BodyParam````e````t````e````r <IMicrosoftGraphT````e````amsTab>
