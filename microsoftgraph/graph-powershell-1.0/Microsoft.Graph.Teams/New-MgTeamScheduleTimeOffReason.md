...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mgteamscheduletimeoffreason
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: New-MgTeamScheduleTimeOffReason
---
...
```
New-MgTeamScheduleTimeOffReason -TeamId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgTeamScheduleTimeOffReason -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Code <string>] [-CreatedBy <IMicrosoftGraphIdentitySet>]
 [-DisplayName <string>] [-IconType <string>] [-Id <string>] [-IsActive]
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
...
```
New-MgTeamScheduleTimeOffReason -InputObject <ITeamsIdentity>
...
- [New-MgTeamScheduleTimeOffReason](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mgteamscheduletimeoffreason)
- [Graph API Reference](https://learn.microsoft.com/graph/api/schedule-post-timeoffreasons?view=graph-rest-1.0)
