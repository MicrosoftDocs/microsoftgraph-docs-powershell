...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mgchatpinnedmessage
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: Get-MgChatPinnedMessage
---
...
```
Get-MgChatPinnedMessage -ChatId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgChatPinnedMessage -ChatId <string> -PinnedChatMessageInfoId <string>
...
```
Get-MgChatPinnedMessage -InputObject <ITeamsIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgChatPinnedMessage](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mgchatpinnedmessage)
- [Graph API Reference](https://learn.microsoft.com/graph/api/chat-list-pinnedmessages?view=graph-rest-1.0)
