...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mggraphteamchannelmessagereply
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: Invoke-MgGraphTeamChannelMessageReply
---

# Invoke-MgGraphTeamChannelMessageReply
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Invoke-MgBetaGraphTeamChannelMessageReply](/powershell/module/Microsoft.Graph.Beta.Teams/Invoke-MgBetaGraphTeamChannelMessageReply?view=graph-powershell-beta)
...
```
Invoke-MgGraphTeamChannelMessageReply -ChannelId <string> -ChatMessageId <string> -TeamId <string>
...
```
Invoke-MgGraphTeamChannelMessageReply -InputObject <ITeamsIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-MessageIds <string[]>]
 [-ReplyMessage <IMicrosoftGraphChatMessage>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths1Y1G21JTeamsTeamIdChannelsChannelIdMessagesChatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.PowerShell.Models.IPaths1Y1G21JTeamsTeamIdChannelsChannelIdMessagesChatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
...
- [Invoke-MgGraphTeamChannelMessageReply](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mggraphteamchannelmessagereply)
