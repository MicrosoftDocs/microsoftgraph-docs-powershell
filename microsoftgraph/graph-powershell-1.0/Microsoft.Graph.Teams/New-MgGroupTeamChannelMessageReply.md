...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mggroupteamchannelmessagereply
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: New-MgGroupTeamChannelMessageReply
---
...
```
New-MgGroupTeamChannelMessageReply -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
...
```
New-MgGroupTeamChannelMessageReply -InputObject <ITeamsIdentity>
 -BodyParameter <IMicrosoftGraphChatMessage> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgGroupTeamChannelMessageReply](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mggroupteamchannelmessagereply)
