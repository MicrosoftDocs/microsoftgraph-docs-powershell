...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mguserchatmessagedelta
schema: 2.0.0
ms.subservice: teams
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaUserChatMessageDelta](/powershell/module/Microsoft.Graph.Beta.Teams/Get-MgBetaUserChatMessageDelta?view=graph-powershell-beta)

## SYNTAX

### Delta (Default)
```
Get-MgUserChatMessageDelta -ChatId <String> -UserId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### DeltaViaIdentity
```
Get-MgUserChatMessageDelta -InputObject <ITeamsIdentity> [-ExpandProperty <String[]>] [-Filter <String>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mguserchatmessagedelta](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mguserchatmessagedelta)
