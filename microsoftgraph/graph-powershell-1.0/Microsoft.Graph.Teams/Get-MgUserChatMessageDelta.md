...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mguserchatmessagedelta
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: Get-MgUserChatMessageDelta
---
...
```
Get-MgUserChatMessageDelta -ChatId <string> -UserId <string> [-ExpandProperty <string[]>]
...
```
Get-MgUserChatMessageDelta -InputObject <ITeamsIdentity> [-ExpandProperty <string[]>]
 [-Filter <string>] [-Property <string[]>] [-Search <string>] [-Skip <int>] [-Sort <string[]>]
...
- [Get-MgUserChatMessageDelta](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mguserchatmessagedelta)
