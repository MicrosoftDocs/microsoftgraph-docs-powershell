...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/clear-mguserchatmessagereaction
schema: 2.0.0
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Clear-MgBetaUserChatMessageReaction](/powershell/module/Microsoft.Graph.Beta.Teams/Clear-MgBetaUserChatMessageReaction?view=graph-powershell-beta)
...
```
Clear-MgUserChatMessageReaction -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
...
### UnsetViaIdentity
```
Clear-MgUserChatMessageReaction -InputObject <ITeamsIdentity>
 -BodyParameter <IPaths1By85LjUsersUserIdChatsChatIdMessagesChatmessageIdMicrosoftGraphUnsetreactionPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```yaml
Type: IPaths1By85LjUsersUserIdChatsChatIdMessagesChatmessageIdMicrosoftGraphUnsetreactionPostRequestbodyContentApplicationJsonSchema
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.teams/clear-mguserchatmessagereaction](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/clear-mguserchatmessagereaction)
