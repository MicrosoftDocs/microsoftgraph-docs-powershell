...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mggroupteamtag
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: New-MgGroupTeamTag
---
...
```
New-MgGroupTeamTag -GroupId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgGroupTeamTag -GroupId <string> -BodyParameter <IMicrosoftGraphTeamworkTag>
...
```
New-MgGroupTeamTag -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Description <string>] [-DisplayName <string>] [-Id <string>]
 [-MemberCount <int>] [-Members <IMicrosoftGraphTeamworkTagMember[]>] [-TagType <string>]
 [-TeamId <string>] [-Break] [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mggroupteamtag)
