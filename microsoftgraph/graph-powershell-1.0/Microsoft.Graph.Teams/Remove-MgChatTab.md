...
### Delete (Default)
```
Remove-MgChatTab -ChatId <String> -TeamsTabId <String> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
...
### DeleteViaIdentity
```
Remove-MgChatTab -InputObject <ITeamsIdentity> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.teams/remove-mgchattab](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/remove-mgchattab)
