...
> [!NOTE]
> To view the beta release of this cmdlet, view [Remove-MgBetaTeamScheduleTimeOffReason](/powershell/module/Microsoft.Graph.Beta.Applications/Remove-MgBetaTeamScheduleTimeOffReason?view=graph-powershell-beta)

## SYNTAX

### Delete (Default)
```
Remove-MgTeamScheduleTimeOffReason -TeamId <String> -TimeOffReasonId <String> [-IfMatch <String>] [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgTeamScheduleTimeOffReason -InputObject <ITeamsIdentity> [-IfMatch <String>] [-PassThru] [-WhatIf]
...
## RELATED LINKS
[Remove-MgBetaTeamScheduleTimeOffReason](/powershell/module/Microsoft.Graph.Beta.Applications/Remove-MgBetaTeamScheduleTimeOffReason?view=graph-powershell-beta)
