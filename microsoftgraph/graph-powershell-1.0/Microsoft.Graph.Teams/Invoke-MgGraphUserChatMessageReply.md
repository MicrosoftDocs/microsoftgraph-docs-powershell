...
# Invoke-MgGraphUserChatMessageReply
...
```
Invoke-MgGraphUserChatMessageReply -ChatId <string> -ChatMessageId <string> -UserId <string>
...
```
Invoke-MgGraphUserChatMessageReply -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
...
```
Invoke-MgGraphUserChatMessageReply -InputObject <ITeamsIdentity>
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths1Y1Ve8UUsersUserIdChatsChatIdMessagesChatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.PowerShell.Models.IPaths1Y1Ve8UUsersUserIdChatsChatIdMessagesChatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
