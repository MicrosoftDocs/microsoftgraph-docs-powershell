...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaTeamTag](/powershell/module/Microsoft.Graph.Beta.Applications/Get-MgBetaTeamTag?view=graph-powershell-beta)

## SYNTAX

### List (Default)
```
Get-MgTeamTag -TeamId <String> [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
## RELATED LINKS
[Get-MgBetaTeamTag](/powershell/module/Microsoft.Graph.Beta.Applications/Get-MgBetaTeamTag?view=graph-powershell-beta)
