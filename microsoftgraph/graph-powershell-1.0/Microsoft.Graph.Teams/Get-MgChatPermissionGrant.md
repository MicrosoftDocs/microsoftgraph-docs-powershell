...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mgchatpermissiongrant
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Get-MgChatPermissionGrant
---
...
```
Get-MgChatPermissionGrant -InputObject <ITeamsIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgChatPermissionGrant](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mgchatpermissiongrant)
- [Graph API Reference](https://learn.microsoft.com/graph/api/chat-list-permissiongrants?view=graph-rest-1.0)
