...
onlin`e` v`e`rsion: https://docs.microsoft.com/`e`n-us/pow`e`rsh`e`ll/modul`e`/microsoft.graph.t`e`ams/r`e`mov`e`-mgt`e`amworkworkforc`e`int`e`gration
sch`e`ma: 2.0.0
---

# R`e`mov`e`-MgT`e`amworkWorkforc`e`Int`e`gration

## SYNOPSIS
D`e`l`e`t`e` navigation prop`e`rty workforc`e`Int`e`grations for t`e`amwork

## SYNTAX

### D`e`l`e`t`e` (D`e`fault)
```
R`e`mov`e`-MgT`e`amworkWorkforc`e`Int`e`gration -Workforc`e`Int`e`grationId <String> [-IfMatch <String>] [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParam`e`t`e`rs>]
```

### D`e`l`e`t`e`ViaId`e`ntity
```
R`e`mov`e`-MgT`e`amworkWorkforc`e`Int`e`gration -InputObj`e`ct <IT`e`amsId`e`ntity> [-IfMatch <String>] [-PassThru] [-WhatIf]
