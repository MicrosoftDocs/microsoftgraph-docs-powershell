...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mggroupteamchannelmember
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: New-MgGroupTeamChannelMember
---
...
```
New-MgGroupTeamChannelMember -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
...
```
New-MgGroupTeamChannelMember -InputObject <ITeamsIdentity>
 -BodyParameter <IMicrosoftGraphConversationMember> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgGroupTeamChannelMember](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mggroupteamchannelmember)
