...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/update-mgteamscheduletimeoff
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Update-MgTeamScheduleTimeOff
---
...
```
Update-MgTeamScheduleTimeOff -TeamId <string> -TimeOffId <string>
 ...
 [-SharedTimeOff <IMicrosoftGraphTimeOffItem>] [-UserId <string>] [-Break] [-Headers <IDictionary>]
...
```
Update-MgTeamScheduleTimeOff -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/update-mgteamscheduletimeoff)
