...
### Delete (Default)
```
Remove-MgAppCatalogTeamApp -TeamsAppId <String> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
...
### DeleteViaIdentity
```
Remove-MgAppCatalogTeamApp -InputObject <ITeamsIdentity> [-IfMatch <String>]
