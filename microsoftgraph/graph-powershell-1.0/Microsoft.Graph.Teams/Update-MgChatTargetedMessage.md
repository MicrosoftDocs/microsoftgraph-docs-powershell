...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/update-mgchattargetedmessage
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Update-MgChatTargetedMessage
---

# Update-MgChatTargetedMessage
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaChatTargetedMessage](/powershell/module/Microsoft.Graph.Beta.Teams/Update-MgBetaChatTargetedMessage?view=graph-powershell-beta)
...
```
Update-MgChatTargetedMessage -ChatId <string> -TargetedChatMessageId <string>
 ...
 [-Reactions <IMicrosoftGraphChatMessageReaction[]>] [-Recipient <IMicrosoftGraphIdentity>]
 [-Replies <IMicrosoftGraphChatMessage[]>] [-ReplyToId <string>] [-Subject <string>]
 [-Summary <string>] [-WebUrl <string>] [-Break] [-Headers <IDictionary>]
...
```
Update-MgChatTargetedMessage -InputObject <ITeamsIdentity> [-ChatId <string>]
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-Attachments <IMicrosoftGraphChatMessageAttachment[]>] [-Body <IMicrosoftGraphItemBody>]
...
```
Update-MgChatTargetedMessage -ChatId <string> -TargetedChatMessageId <string>
 -BodyParameter <IMicrosoftGraphTargetedChatMessage> [-ResponseHeadersVariable <string>] [-Break]
...
```
Update-MgChatTargetedMessage -InputObject <ITeamsIdentity>
 -BodyParameter <IMicrosoftGraphTargetedChatMessage> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
### Microsoft.Graph.PowerShell.Models.IMicrosoftGraphTargetedChatMessage
...
BODYPARAMETER `<IMicrosoftGraphTargetedChatMessage>`: targetedChatMessage
  [(Any) <Object>]: This indicates any property can be added to this object.
  [Attachments <IMicrosoftGraphChatMessageAttachment[]>]: References to attached objects like files, tabs, meetings etc.
    [Content <String>]: The content of the attachment.
If the attachment is a rich card, set the property to the rich card object.
...
- [Update-MgChatTargetedMessage](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/update-mgchattargetedmessage)
