...
### Get (Default)
```
Get-MgGroupTeamPrimaryChannelFileFolderContent -GroupId <String> [-Format <String>] -OutFile <String>
...
### GetViaIdentity
```
Get-MgGroupTeamPrimaryChannelFileFolderContent -InputObject <ITeamsIdentity> [-Format <String>]
