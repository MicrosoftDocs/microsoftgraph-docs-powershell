...
Get-MgUserChatMessageHostedContent -ChatId <String> -ChatMessageHostedContentId <String>
 -ChatMessageId <String> -UserId <String> [-Format <String>] -OutFile <String> [-Headers <IDictionary>]
...
### GetViaIdentity1
```
Get-MgUserChatMessageHostedContent -InputObject <ITeamsIdentity> [-Format <String>] -OutFile <String>
