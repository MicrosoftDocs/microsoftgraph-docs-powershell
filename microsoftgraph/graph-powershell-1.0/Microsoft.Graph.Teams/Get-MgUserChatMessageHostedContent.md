...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mguserchatmessagehostedcontent
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: Get-MgUserChatMessageHostedContent
---
...
```
Get-MgUserChatMessageHostedContent -InputObject <ITeamsIdentity> -OutFile <string>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mguserchatmessagehostedcontent)
