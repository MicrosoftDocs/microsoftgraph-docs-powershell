...
Get-MgUserChatMessageHostedContent -ChatId <String> -ChatMessageHostedContentId <String>
 -ChatMessageId <String> -UserId <String> [-Format <String>] [-ResponseHeadersVariable <String>]
...
### GetViaIdentity1
```
Get-MgUserChatMessageHostedContent -InputObject <ITeamsIdentity> [-Format <String>]
