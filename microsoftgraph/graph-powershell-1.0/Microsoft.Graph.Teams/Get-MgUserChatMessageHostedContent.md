...
Get-MgUserChatMessageHostedContent -ChatId <String> -ChatMessageHostedContentId <String>
 -ChatMessageId <String> -UserId <String> [-ResponseHeadersVariable <String>] -OutFile <String>
...
### GetViaIdentity1
```
Get-MgUserChatMessageHostedContent -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
