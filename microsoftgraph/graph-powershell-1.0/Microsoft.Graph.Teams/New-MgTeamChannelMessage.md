...
### Example 6: <span class="no-loc" dir="ltr" lang="en-us">@mention</span> a channel in a channel message
...
### Example 7: <span class="no-loc" dir="ltr" lang="en-us">@mention</span> a team in a channel message
...
### Example 8: Send message that contains cards that are attributed to a Teams app
...
### Example 9: Send a message that contains an announcement
