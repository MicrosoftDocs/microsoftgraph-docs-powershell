...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mggroupteamscheduleopenshift
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: New-MgGroupTeamScheduleOpenShift
---
...
```
New-MgGroupTeamScheduleOpenShift -GroupId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgGroupTeamScheduleOpenShift -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-CreatedBy <IMicrosoftGraphIdentitySet>]
 [-DraftOpenShift <IMicrosoftGraphOpenShiftItem>] [-Id <string>] [-IsStagedForDeletion]
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-SchedulingGroupId <string>]
 [-SharedOpenShift <IMicrosoftGraphOpenShiftItem>] [-Break] [-Headers <IDictionary>]
...
```
New-MgGroupTeamScheduleOpenShift -InputObject <ITeamsIdentity>
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mggroupteamscheduleopenshift)
