...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mguserchatinstalledapp
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Get-MgUserChatInstalledApp
---
...
```
Get-MgUserChatInstalledApp -ChatId <string> -UserId <string> [-ExpandProperty <string[]>]
...
```
Get-MgUserChatInstalledApp -InputObject <ITeamsIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgUserChatInstalledApp](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mguserchatinstalledapp)
