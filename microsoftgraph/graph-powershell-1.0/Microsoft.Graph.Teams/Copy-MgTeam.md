...
```
Copy-MgTeam -TeamId <string> [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-Classification <string>] [-Description <string>] [-DisplayName <string>] [-MailNickname <string>]
 [-PartsToClone <string>] [-Visibility <string>] [-Break] [-Headers <IDictionary>]
...
```
Copy-MgTeam -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Classification <string>] [-Description <string>]
 [-DisplayName <string>] [-MailNickname <string>] [-PartsToClone <string>] [-Visibility <string>]
...
| --------------- | ------------------------------------------  |
| Delegated (work or school account) | Directory.ReadWrite.All, Group.ReadWrite.All, Team.Create,  |
...
- [Copy-MgTeam](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/copy-mgteam)
