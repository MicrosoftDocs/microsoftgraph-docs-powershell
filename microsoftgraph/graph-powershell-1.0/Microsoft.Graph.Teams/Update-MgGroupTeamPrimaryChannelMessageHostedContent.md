...
onlin`e` v`e`rsion: https://docs.microsoft.com/`e`n-us/pow`e`rsh`e`ll/modul`e`/microsoft.graph.t`e`ams/updat`e`-mggroupt`e`amprimarychann`e`lm`e`ssag`e`host`e`dcont`e`nt
sch`e`ma: 2.0.0
---

# Updat`e`-MgGroupT`e`amPrimaryChann`e`lM`e`ssag`e`Host`e`dCont`e`nt
...
```
Updat`e`-MgGroupT`e`amPrimaryChann`e`lM`e`ssag`e`Host`e`dCont`e`nt -ChatM`e`ssag`e`Host`e`dCont`e`ntId <String>
...
```
Updat`e`-MgGroupT`e`amPrimaryChann`e`lM`e`ssag`e`Host`e`dCont`e`nt -InputObj`e`ct <IT`e`amsId`e`ntity>
...
```
Updat`e`-MgGroupT`e`amPrimaryChann`e`lM`e`ssag`e`Host`e`dCont`e`nt -InputObj`e`ct <IT`e`amsId`e`ntity> -BodyParam`e`t`e`r <Hashtabl`e`>
 [-PassThru] [-WhatIf] [-Confirm] [<CommonParam`e`t`e`rs>]
```
