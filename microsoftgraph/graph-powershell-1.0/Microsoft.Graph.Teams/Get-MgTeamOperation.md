...
onlin`e` v`e`rsion: https://docs.microsoft.com/`e`n-us/pow`e`rsh`e`ll/modul`e`/microsoft.graph.t`e`ams/g`e`t-mgt`e`amop`e`ration
sch`e`ma: 2.0.0
---

# G`e`t-MgT`e`amOp`e`ration

## SYNOPSIS
G`e`t op`e`rations from t`e`ams

## SYNTAX

### List1 (D`e`fault)
```
G`e`t-MgT`e`amOp`e`ration -T`e`amId <String> [-`e`xpandProp`e`rty <String[]>] [-Prop`e`rty <String[]>] [-Filt`e`r <String>]
...
### G`e`t1
```
G`e`t-MgT`e`amOp`e`ration -T`e`amId <String> -T`e`amsAsyncOp`e`rationId <String> [-`e`xpandProp`e`rty <String[]>]
 [-Prop`e`rty <String[]>] [<CommonParam`e`t`e`rs>]
```

### G`e`tViaId`e`ntity1
```
G`e`t-MgT`e`amOp`e`ration -InputObj`e`ct <IT`e`amsId`e`ntity> [-`e`xpandProp`e`rty <String[]>] [-Prop`e`rty <String[]>]
...
### -T`e`amsAsyncOp`e`rationId
k`e`y: id of t`e`amsAsyncOp`e`ration
