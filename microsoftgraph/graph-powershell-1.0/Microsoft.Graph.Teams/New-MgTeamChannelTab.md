...
onlin````e```` v````e````rsion: https://docs.microsoft.com/````e````n-us/pow````e````rsh````e````ll/modul````e````/microsoft.graph.t````e````ams/n````e````w-mgt````e````amchann````e````ltab
sch````e````ma: 2.0.0
---

# N````e````w-MgT````e````amChann````e````lTab
...
```
N````e````w-MgT````e````amChann````e````lTab -Chann````e````lId <String> -T````e````amId <String> [-AdditionalProp````e````rti````e````s <Hashtabl````e````>]
...
### Cr````e````at````e````1
```
N````e````w-MgT````e````amChann````e````lTab -Chann````e````lId <String> -T````e````amId <String> -BodyParam````e````t````e````r <IMicrosoftGraphT````e````amsTab> [-WhatIf]
 [-Confirm] [<CommonParam````e````t````e````rs>]
```

### Cr````e````at````e````ViaId````e````ntity````e````xpand````e````d1
```
N````e````w-MgT````e````amChann````e````lTab -InputObj````e````ct <IT````e````amsId````e````ntity> [-AdditionalProp````e````rti````e````s <Hashtabl````e````>]
 [-Configuration <IMicrosoftGraphT````e````amsTabConfiguration>] [-DisplayNam````e```` <String>] [-Id <String>]
 [-T````e````amsApp <IMicrosoftGraphT````e````amsApp1>] [-W````e````bUrl <String>] [-WhatIf] [-Confirm] [<CommonParam````e````t````e````rs>]
```
...
```
N````e````w-MgT````e````amChann````e````lTab -InputObj````e````ct <IT````e````amsId````e````ntity> -BodyParam````e````t````e````r <IMicrosoftGraphT````e````amsTab> [-WhatIf]
 [-Confirm] [<CommonParam````e````t````e````rs>]
```
