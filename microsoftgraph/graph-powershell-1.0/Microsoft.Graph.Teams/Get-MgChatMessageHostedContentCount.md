...
```
Get-MgChatMessageHostedContentCount -InputObject <ITeamsIdentity> [-Filter <string>]
 [-Search <string>] [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
```
...
- [Get-MgChatMessageHostedContentCount](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mgchatmessagehostedcontentcount)
