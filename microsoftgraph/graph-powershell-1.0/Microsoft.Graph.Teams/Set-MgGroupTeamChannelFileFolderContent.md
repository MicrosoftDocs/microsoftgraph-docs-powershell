...
### Set (Default)
```
Set-MgGroupTeamChannelFileFolderContent -ChannelId <String> -GroupId <String> [-Data <Stream>]
...
### SetViaIdentity
```
Set-MgGroupTeamChannelFileFolderContent -InputObject <ITeamsIdentity> [-Data <Stream>]
 [-ResponseHeadersVariable <String>] -InFile <String> [-ContentType <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
