...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mggraphgroupteamprimarychannelmessagereply
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: Invoke-MgGraphGroupTeamPrimaryChannelMessageReply
---

# Invoke-MgGraphGroupTeamPrimaryChannelMessageReply
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Invoke-MgBetaGraphGroupTeamPrimaryChannelMessageReply](/powershell/module/Microsoft.Graph.Beta.Teams/Invoke-MgBetaGraphGroupTeamPrimaryChannelMessageReply?view=graph-powershell-beta)
...
```
Invoke-MgGraphGroupTeamPrimaryChannelMessageReply -ChatMessageId <string> -GroupId <string>
...
```
Invoke-MgGraphGroupTeamPrimaryChannelMessageReply -InputObject <ITeamsIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-MessageIds <string[]>]
 [-ReplyMessage <IMicrosoftGraphChatMessage>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPathsRrvo7RGroupsGroupIdTeamPrimarychannelMessagesChatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.PowerShell.Models.IPathsRrvo7RGroupsGroupIdTeamPrimarychannelMessagesChatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
...
- [Invoke-MgGraphGroupTeamPrimaryChannelMessageReply](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mggraphgroupteamprimarychannelmessagereply)
