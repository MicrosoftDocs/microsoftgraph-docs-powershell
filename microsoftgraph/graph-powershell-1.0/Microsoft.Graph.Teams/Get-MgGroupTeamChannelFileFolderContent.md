...
### Get (Default)
```
Get-MgGroupTeamChannelFileFolderContent -ChannelId <String> -GroupId <String> [-Format <String>]
...
### GetViaIdentity
```
Get-MgGroupTeamChannelFileFolderContent -InputObject <ITeamsIdentity> [-Format <String>] -OutFile <String>
...
## RELATED LINKS
[Get-MgBetaGroupTeamChannelFileFolderContent](/powershell/module/Microsoft.Graph.Beta.Teams/Get-MgBetaGroupTeamChannelFileFolderContent?view=graph-powershell-beta)
