...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mgchatpermissiongrantcount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgChatPermissionGrantCount -ChatId <String> [-Filter <String>] [-Search <String>] [-Headers <IDictionary>]
