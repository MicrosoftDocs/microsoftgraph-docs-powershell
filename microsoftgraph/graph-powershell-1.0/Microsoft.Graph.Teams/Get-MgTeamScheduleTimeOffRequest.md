...
onlin`e` v`e`rsion: https://docs.microsoft.com/`e`n-us/pow`e`rsh`e`ll/modul`e`/microsoft.graph.t`e`ams/g`e`t-mgt`e`amsch`e`dul`e`tim`e`offr`e`qu`e`st
sch`e`ma: 2.0.0
---

# G`e`t-MgT`e`amSch`e`dul`e`Tim`e`OffR`e`qu`e`st

## SYNOPSIS
G`e`t tim`e`OffR`e`qu`e`sts from t`e`ams

## SYNTAX

### List (D`e`fault)
```
G`e`t-MgT`e`amSch`e`dul`e`Tim`e`OffR`e`qu`e`st -T`e`amId <String> [-Prop`e`rty <String[]>] [-Filt`e`r <String>] [-S`e`arch <String>]
...
### G`e`t
```
G`e`t-MgT`e`amSch`e`dul`e`Tim`e`OffR`e`qu`e`st -T`e`amId <String> -Tim`e`OffR`e`qu`e`stId <String> [-Prop`e`rty <String[]>]
 [<CommonParam`e`t`e`rs>]
```

### G`e`tViaId`e`ntity
```
G`e`t-MgT`e`amSch`e`dul`e`Tim`e`OffR`e`qu`e`st -InputObj`e`ct <IT`e`amsId`e`ntity> [-Prop`e`rty <String[]>] [<CommonParam`e`t`e`rs>]
```
