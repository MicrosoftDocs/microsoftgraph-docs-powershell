...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaTeamChannelMessage](/powershell/module/Microsoft.Graph.Beta.Applications/Get-MgBetaTeamChannelMessage?view=graph-powershell-beta)

## SYNTAX

### Get1 (Default)
```
Get-MgTeamChannelMessage -TeamId <String> [-Property <String[]>] [-Count] [-Filter <String>] [-Model <String>]
...
## RELATED LINKS
[Get-MgBetaTeamChannelMessage](/powershell/module/Microsoft.Graph.Beta.Applications/Get-MgBetaTeamChannelMessage?view=graph-powershell-beta)
