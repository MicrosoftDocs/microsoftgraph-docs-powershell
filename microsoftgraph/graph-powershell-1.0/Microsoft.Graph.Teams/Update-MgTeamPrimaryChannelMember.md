...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/update-mgteamprimarychannelmember
schema: 2.0.0
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaTeamPrimaryChannelMember](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaTeamPrimaryChannelMember?view=graph-powershell-beta)

## SYNTAX

### UpdateExpanded (Default)
```
Update-MgTeamPrimaryChannelMember -ConversationMemberId <String> -TeamId <String>
...
```
Update-MgTeamPrimaryChannelMember -InputObject <ITeamsIdentity> [-AdditionalProperties <Hashtable>]
...
### UpdateViaIdentity
```
Update-MgTeamPrimaryChannelMember -InputObject <ITeamsIdentity>
 -BodyParameter <IMicrosoftGraphConversationMember> [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgBetaTeamPrimaryChannelMember](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaTeamPrimaryChannelMember?view=graph-powershell-beta)
