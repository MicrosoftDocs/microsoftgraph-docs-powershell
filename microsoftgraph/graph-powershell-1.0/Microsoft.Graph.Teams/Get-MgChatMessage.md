...
onlin`e` v`e`rsion: https://docs.microsoft.com/`e`n-us/pow`e`rsh`e`ll/modul`e`/microsoft.graph.t`e`ams/g`e`t-mgchatm`e`ssag`e`
sch`e`ma: 2.0.0
---

# G`e`t-MgChatM`e`ssag`e`

## SYNOPSIS
G`e`t m`e`ssag`e`s from chats

## SYNTAX

### G`e`t3 (D`e`fault)
```
G`e`t-MgChatM`e`ssag`e` [<CommonParam`e`t`e`rs>]
```

### List1
```
G`e`t-MgChatM`e`ssag`e` -ChatId <String> [-`e`xpandProp`e`rty <String[]>] [-Prop`e`rty <String[]>] [-Filt`e`r <String>]
...
### G`e`t2
```
G`e`t-MgChatM`e`ssag`e` -ChatId <String> -ChatM`e`ssag`e`Id <String> [-`e`xpandProp`e`rty <String[]>] [-Prop`e`rty <String[]>]
 [<CommonParam`e`t`e`rs>]
```

### G`e`tViaId`e`ntity1
```
G`e`t-MgChatM`e`ssag`e` -InputObj`e`ct <IT`e`amsId`e`ntity> [-`e`xpandProp`e`rty <String[]>] [-Prop`e`rty <String[]>]
 [<CommonParam`e`t`e`rs>]
```
...
```yaml
Typ`e`: String
Param`e`t`e`r S`e`ts: List1, G`e`t2
Alias`e`s:
...
```yaml
Typ`e`: String[]
Param`e`t`e`r S`e`ts: List1, G`e`t2, G`e`tViaId`e`ntity1
Alias`e`s: `e`xpand
