...
```
Get-MgChatMessage -ChatId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
| Application | Chat.Read.All, ChatMessage.Read.Chat, Group.Read.All, Group.ReadWrite.All,  |
