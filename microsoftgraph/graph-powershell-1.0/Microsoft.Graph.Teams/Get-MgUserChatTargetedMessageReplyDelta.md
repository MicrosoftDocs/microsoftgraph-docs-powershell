...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mguserchattargetedmessagereplydelta
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Get-MgUserChatTargetedMessageReplyDelta
---

# Get-MgUserChatTargetedMessageReplyDelta
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaUserChatTargetedMessageReplyDelta](/powershell/module/Microsoft.Graph.Beta.Teams/Get-MgBetaUserChatTargetedMessageReplyDelta?view=graph-powershell-beta)
...
```
Get-MgUserChatTargetedMessageReplyDelta -ChatId <string> -TargetedChatMessageId <string>
 -UserId <string> [-ExpandProperty <string[]>] [-Filter <string>] [-Property <string[]>]
...
```
Get-MgUserChatTargetedMessageReplyDelta -InputObject <ITeamsIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgUserChatTargetedMessageReplyDelta](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mguserchattargetedmessagereplydelta)
