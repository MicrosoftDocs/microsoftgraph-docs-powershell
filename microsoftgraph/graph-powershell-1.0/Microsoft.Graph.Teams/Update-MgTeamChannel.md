...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaBetaTeamChannel](/powershell/module/Microsoft.Graph.Beta.Teams/Update-MgBetaTeamChannel?view=graph-powershell-beta)
...
### Update
```
Update-MgTeamChannel -ChannelId <String> -TeamId <String> -BodyParameter <IMicrosoftGraphChannel> [-WhatIf]
...
### UpdateViaIdentity
```
Update-MgTeamChannel -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphChannel> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgBetaBetaTeamChannel](/powershell/module/Microsoft.Graph.Beta.Teams/Update-MgBetaTeamChannel?view=graph-powershell-beta)
