...
```
Get-MgChatTargetedMessageReplyDelta -ChatId <string> -TargetedChatMessageId <string>
...
```
Get-MgChatTargetedMessageReplyDelta -InputObject <ITeamsIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgChatTargetedMessageReplyDelta](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mgchattargetedmessagereplydelta)
