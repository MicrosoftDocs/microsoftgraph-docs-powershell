...
Update-MgGroupTeamChannel -ChannelId <String> -GroupId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Messages <IMicrosoftGraphChatMessage1[]>] [-Tabs <IMicrosoftGraphTeamsTab[]>] [-WebUrl <String>] [-PassThru]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams/update-mggroupteamchannel](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams/update-mggroupteamchannel)
