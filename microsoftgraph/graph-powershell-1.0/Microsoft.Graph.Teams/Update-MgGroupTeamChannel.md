...
Update-MgGroupTeamChannel -ChannelId <String> -GroupId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-Tabs <IMicrosoftGraphTeamsTab[]>] [-TenantId <String>] [-WebUrl <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### UpdateViaIdentity
```
Update-MgGroupTeamChannel -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphChannel> [-Confirm]
