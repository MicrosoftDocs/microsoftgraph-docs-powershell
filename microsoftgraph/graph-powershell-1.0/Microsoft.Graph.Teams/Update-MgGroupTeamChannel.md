...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/update-mggroupteamchannel
schema: 2.0.0
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaBetaGroupTeamChannel](/powershell/module/Microsoft.Graph.Beta.Teams/Update-MgBetaGroupTeamChannel?view=graph-powershell-beta)
...
### Update
```
Update-MgGroupTeamChannel -ChannelId <String> -GroupId <String> -BodyParameter <IMicrosoftGraphChannel>
...
### UpdateViaIdentity
```
Update-MgGroupTeamChannel -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphChannel> [-WhatIf]
...
To construct, see NOTES section for SHAREDWITHTEAMS properties and create a hash table.
...
## RELATED LINKS
[Update-MgBetaBetaGroupTeamChannel](/powershell/module/Microsoft.Graph.Beta.Teams/Update-MgBetaGroupTeamChannel?view=graph-powershell-beta)
