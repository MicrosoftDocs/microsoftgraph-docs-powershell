...
```
Get-MgTeamChannelEnabledApp -ChannelId <string> -TeamId <string> [-ExpandProperty <string[]>]
...
```
Get-MgTeamChannelEnabledApp -ChannelId <string> -TeamId <string> -TeamsAppId <string>
...
```
Get-MgTeamChannelEnabledApp -InputObject <ITeamsIdentity> [-ExpandProperty <string[]>]
