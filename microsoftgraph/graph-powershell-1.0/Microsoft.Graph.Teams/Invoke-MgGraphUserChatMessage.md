...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mggraphuserchatmessage
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: Invoke-MgGraphUserChatMessage
---

# Invoke-MgGraphUserChatMessage
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Invoke-MgBetaGraphUserChatMessage](/powershell/module/Microsoft.Graph.Beta.Teams/Invoke-MgBetaGraphUserChatMessage?view=graph-powershell-beta)
...
```
Invoke-MgGraphUserChatMessage -ChatId <string> -UserId <string> [-ResponseHeadersVariable <string>]
...
```
Invoke-MgGraphUserChatMessage -ChatId <string> -UserId <string>
...
```
Invoke-MgGraphUserChatMessage -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-MessageIds <string[]>]
 [-ReplyMessage <IMicrosoftGraphChatMessage>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```
Invoke-MgGraphUserChatMessage -InputObject <ITeamsIdentity>
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPathsDfn6EyUsersUserIdChatsChatIdMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.PowerShell.Models.IPathsDfn6EyUsersUserIdChatsChatIdMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
...
- [Invoke-MgGraphUserChatMessage](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mggraphuserchatmessage)
