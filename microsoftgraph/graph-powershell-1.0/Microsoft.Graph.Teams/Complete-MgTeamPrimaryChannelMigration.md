...
```
Complete-MgTeamPrimaryChannelMigration -TeamId <string> [-ResponseHeadersVariable <string>] [-Break]
...
```
Complete-MgTeamPrimaryChannelMigration -InputObject <ITeamsIdentity>
