...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mgclockgroupteamscheduletimecardout
schema: 2.0.0
---
...
```
Invoke-MgClockGroupTeamScheduleTimeCardOut -GroupId <String> -TimeCardId <String>
...
```
Invoke-MgClockGroupTeamScheduleTimeCardOut -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
...
### ClockViaIdentity
```
Invoke-MgClockGroupTeamScheduleTimeCardOut -InputObject <ITeamsIdentity>
 -BodyParameter <IPaths5Qay4XGroupsGroupIdTeamScheduleTimecardsTimecardIdMicrosoftGraphClockoutPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
### Microsoft.Graph.PowerShell.Models.IPaths5Qay4XGroupsGroupIdTeamScheduleTimecardsTimecardIdMicrosoftGraphClockoutPostRequestbodyContentApplicationJsonSchema
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mgclockgroupteamscheduletimecardout](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mgclockgroupteamscheduletimecardout)
