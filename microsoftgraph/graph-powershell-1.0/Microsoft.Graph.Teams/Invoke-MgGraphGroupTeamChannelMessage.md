...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mggraphgroupteamchannelmessage
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Invoke-MgGraphGroupTeamChannelMessage
---

# Invoke-MgGraphGroupTeamChannelMessage
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Invoke-MgBetaGraphGroupTeamChannelMessage](/powershell/module/Microsoft.Graph.Beta.Teams/Invoke-MgBetaGraphGroupTeamChannelMessage?view=graph-powershell-beta)
...
```
Invoke-MgGraphGroupTeamChannelMessage -ChannelId <string> -GroupId <string>
...
```
Invoke-MgGraphGroupTeamChannelMessage -ChannelId <string> -GroupId <string>
 -Body <IPaths1CiexhuGroupsGroupIdTeamChannelsChannelIdMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema>
...
```
Invoke-MgGraphGroupTeamChannelMessage -InputObject <ITeamsIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-MessageIds <string[]>]
 [-ReplyMessage <IMicrosoftGraphChatMessage>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```
Invoke-MgGraphGroupTeamChannelMessage -InputObject <ITeamsIdentity>
 -BodyParameter <IPaths1CiexhuGroupsGroupIdTeamChannelsChannelIdMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths1CiexhuGroupsGroupIdTeamChannelsChannelIdMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.PowerShell.Models.IPaths1CiexhuGroupsGroupIdTeamChannelsChannelIdMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
...
- [Invoke-MgGraphGroupTeamChannelMessage](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mggraphgroupteamchannelmessage)
