...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mggroupteamchannelretainedmessage
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Get-MgGroupTeamChannelRetainedMessage
---
...
```
Get-MgGroupTeamChannelRetainedMessage -GroupId <string> [-Count] [-ExpandProperty <string[]>]
...
```
Get-MgGroupTeamChannelRetainedMessage -InputObject <ITeamsIdentity> [-Count]
