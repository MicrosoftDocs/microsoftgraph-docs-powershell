...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/confirm-mgteamscheduletimecard
schema: 2.0.0
ms.subservice: teams
---
...
### Confirm (Default)
```
Confirm-MgTeamScheduleTimeCard -TeamId <String> -TimeCardId <String> [-ResponseHeadersVariable <String>]
