...
onlin```e``` v```e```rsion: https://docs.microsoft.com/```e```n-us/pow```e```rsh```e```ll/modul```e```/microsoft.graph.t```e```ams/updat```e```-mggroupt```e```amsch```e```dul```e```tim```e```offr```e```qu```e```st
sch```e```ma: 2.0.0
---

# Updat```e```-MgGroupT```e```amSch```e```dul```e```Tim```e```OffR```e```qu```e```st

## SYNOPSIS
Updat```e``` th```e``` navigation prop```e```rty tim```e```OffR```e```qu```e```sts in groups

## SYNTAX

### Updat```e``````e```xpand```e```d1 (D```e```fault)
```
Updat```e```-MgGroupT```e```amSch```e```dul```e```Tim```e```OffR```e```qu```e```st -GroupId <String> -Tim```e```OffR```e```qu```e```stId <String>
...
```
Updat```e```-MgGroupT```e```amSch```e```dul```e```Tim```e```OffR```e```qu```e```st -InputObj```e```ct <IT```e```amsId```e```ntity> [-AdditionalProp```e```rti```e```s <Hashtabl```e```>]
...
```
Updat```e```-MgGroupT```e```amSch```e```dul```e```Tim```e```OffR```e```qu```e```st -InputObj```e```ct <IT```e```amsId```e```ntity>
 -BodyParam```e```t```e```r <IMicrosoftGraphTim```e```OffR```e```qu```e```st> [-PassThru] [-WhatIf] [-Confirm] [<CommonParam```e```t```e```rs>]
```
