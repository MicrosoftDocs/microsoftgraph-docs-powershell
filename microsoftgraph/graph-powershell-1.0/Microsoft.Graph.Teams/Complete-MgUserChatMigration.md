...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/complete-mguserchatmigration
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Complete-MgUserChatMigration
---

# Complete-MgUserChatMigration
...
```
Complete-MgUserChatMigration -ChatId <string> -UserId <string> [-ResponseHeadersVariable <string>]
...
```
Complete-MgUserChatMigration -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
 [-Break] [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
- [Complete-MgUserChatMigration](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/complete-mguserchatmigration)
