...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mgchattargetedmessage
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: New-MgChatTargetedMessage
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaChatTargetedMessage](/powershell/module/Microsoft.Graph.Beta.Teams/New-MgBetaChatTargetedMessage?view=graph-powershell-beta)
...
```
New-MgChatTargetedMessage -ChatId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgChatTargetedMessage -InputObject <ITeamsIdentity> [-ChatId <string>]
...
```
New-MgChatTargetedMessage -ChatId <string> -BodyParameter <IMicrosoftGraphTargetedChatMessage>
...
```
New-MgChatTargetedMessage -InputObject <ITeamsIdentity>
...
- [New-MgChatTargetedMessage](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mgchattargetedmessage)
