...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/clear-mguserchatmessagereplyreaction
schema: 2.0.0
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Clear-MgBetaUserChatMessageReplyReaction](/powershell/module/Microsoft.Graph.Beta.Teams/Clear-MgBetaUserChatMessageReplyReaction?view=graph-powershell-beta)
...
```
Clear-MgUserChatMessageReplyReaction -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
...
### UnsetViaIdentity
```
Clear-MgUserChatMessageReplyReaction -InputObject <ITeamsIdentity>
 -BodyParameter <IPathsH9Jox8UsersUserIdChatsChatIdMessagesChatmessageIdRepliesChatmessageId1MicrosoftGraphUnsetreactionPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.teams/clear-mguserchatmessagereplyreaction](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/clear-mguserchatmessagereplyreaction)
