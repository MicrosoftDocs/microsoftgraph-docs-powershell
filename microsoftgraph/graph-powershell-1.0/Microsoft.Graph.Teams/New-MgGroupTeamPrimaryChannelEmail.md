...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mggroupteamprimarychannelemail
schema: 2.0.0
ms.subservice: teams
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaGroupTeamPrimaryChannelEmail](/powershell/module/Microsoft.Graph.Beta.Teams/New-MgBetaGroupTeamPrimaryChannelEmail?view=graph-powershell-beta)

## SYNTAX

### Provision (Default)
```
New-MgGroupTeamPrimaryChannelEmail -GroupId <String> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### ProvisionViaIdentity
```
New-MgGroupTeamPrimaryChannelEmail -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mggroupteamprimarychannelemail](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mggroupteamprimarychannelemail)
