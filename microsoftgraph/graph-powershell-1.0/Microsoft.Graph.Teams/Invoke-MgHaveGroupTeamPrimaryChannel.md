...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mghavegroupteamprimarychannel
schema: 2.0.0
ms.subservice: teams
---
...
### HaveViaIdentity
```
Invoke-MgHaveGroupTeamPrimaryChannel -InputObject <ITeamsIdentity> [-TenantId <String>] [-UserId <String>]
 [-UserPrincipalName <String>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
