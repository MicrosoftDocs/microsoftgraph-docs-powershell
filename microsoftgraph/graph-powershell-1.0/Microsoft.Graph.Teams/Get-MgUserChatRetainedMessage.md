...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mguserchatretainedmessage
schema: 2.0.0
ms.subservice: teams
---
...
### Get (Default)
```
Get-MgUserChatRetainedMessage -UserId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgUserChatRetainedMessage -InputObject <ITeamsIdentity> [-Count] [-ExpandProperty <String[]>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mguserchatretainedmessage](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mguserchatretainedmessage)
