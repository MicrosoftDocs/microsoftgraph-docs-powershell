...
### Delete (Default)
```
Remove-MgTeamIncomingChannel -ChannelId <String> -TeamId <String> [-IfMatch <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgTeamIncomingChannel -InputObject <ITeamsIdentity> [-IfMatch <String>] [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```
