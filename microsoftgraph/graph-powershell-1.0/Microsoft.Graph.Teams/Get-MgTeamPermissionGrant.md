...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mgteampermissiongrant
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Get-MgTeamPermissionGrant
---
...
```
Get-MgTeamPermissionGrant -TeamId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgTeamPermissionGrant -InputObject <ITeamsIdentity> [-ExpandProperty <string[]>]
