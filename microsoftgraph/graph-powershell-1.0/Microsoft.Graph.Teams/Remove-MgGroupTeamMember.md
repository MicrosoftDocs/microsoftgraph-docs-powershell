...
### DeleteViaIdentity
```
Remove-MgGroupTeamMember -InputObject <ITeamsIdentity> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
...
```yaml
Type: IPathsWfpmg5GroupsGroupIdTeamMembersMicrosoftGraphRemovePostRequestbodyContentApplicationJsonSchema
