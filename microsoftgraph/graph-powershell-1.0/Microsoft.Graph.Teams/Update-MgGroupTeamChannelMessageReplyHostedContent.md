...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/update-mggroupteamchannelmessagereplyhostedcontent
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: Update-MgGroupTeamChannelMessageReplyHostedContent
---
...
```
Update-MgGroupTeamChannelMessageReplyHostedContent -ChannelId <string>
...
Update-MgGroupTeamChannelMessageReplyHostedContent -ChannelId <string>
 -ChatMessageHostedContentId <string> -ChatMessageId <string> -ChatMessageId1 <string>
 -GroupId <string> -BodyParameter <hashtable> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
- [Update-MgGroupTeamChannelMessageReplyHostedContent](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/update-mggroupteamchannelmessagereplyhostedcontent)
