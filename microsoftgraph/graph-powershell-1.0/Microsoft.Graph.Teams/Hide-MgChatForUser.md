...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/hide-mgchatforuser
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Hide-MgChatForUser
---
...
```
Hide-MgChatForUser -ChatId <string> [-ResponseHeadersVariable <string>]
...
```
Hide-MgChatForUser -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-User <IMicrosoftGraphTeamworkUserIdentity>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [Hide-MgChatForUser](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/hide-mgchatforuser)
