...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/update-mggroupteammember
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: Update-MgGroupTeamMember
---
...
```
Update-MgGroupTeamMember -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgGroupTeamMember -InputObject <ITeamsIdentity>
 -BodyParameter <IMicrosoftGraphConversationMember> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [Update-MgGroupTeamMember](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/update-mggroupteammember)
