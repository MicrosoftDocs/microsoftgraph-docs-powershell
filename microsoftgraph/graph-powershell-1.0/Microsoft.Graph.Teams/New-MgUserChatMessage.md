...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mguserchatmessage
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: New-MgUserChatMessage
---
...
```
New-MgUserChatMessage -ChatId <string> -UserId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgUserChatMessage -InputObject <ITeamsIdentity> [-ChatId <string>]
