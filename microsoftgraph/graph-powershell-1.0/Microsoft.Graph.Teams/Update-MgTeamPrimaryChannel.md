...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/update-mgteamprimarychannel
schema: 2.0.0
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaBetaTeamPrimaryChannel](/powershell/module/Microsoft.Graph.Beta.Teams/Update-MgBetaTeamPrimaryChannel?view=graph-powershell-beta)
...
### Update
```
Update-MgTeamPrimaryChannel -TeamId <String> -BodyParameter <IMicrosoftGraphChannel> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### UpdateViaIdentity
```
Update-MgTeamPrimaryChannel -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphChannel> [-WhatIf]
...
## RELATED LINKS
[Update-MgBetaBetaTeamPrimaryChannel](/powershell/module/Microsoft.Graph.Beta.Teams/Update-MgBetaTeamPrimaryChannel?view=graph-powershell-beta)
