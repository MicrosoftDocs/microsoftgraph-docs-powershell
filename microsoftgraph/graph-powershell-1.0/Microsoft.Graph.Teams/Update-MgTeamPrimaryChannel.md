...
### Update
```
Update-MgTeamPrimaryChannel -TeamId <String> -BodyParameter <IMicrosoftGraphChannel> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgTeamPrimaryChannel -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphChannel> [-Confirm]
