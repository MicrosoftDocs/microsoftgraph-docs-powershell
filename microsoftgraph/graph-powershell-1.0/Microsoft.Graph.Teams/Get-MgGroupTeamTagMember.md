...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mggroupteamtagmember
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Get-MgGroupTeamTagMember
---
...
```
Get-MgGroupTeamTagMember -InputObject <ITeamsIdentity> [-ExpandProperty <string[]>]
