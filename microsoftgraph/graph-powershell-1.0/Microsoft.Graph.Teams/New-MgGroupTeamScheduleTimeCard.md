...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mggroupteamscheduletimecard
schema: 2.0.0
---
...
```
New-MgGroupTeamScheduleTimeCard -GroupId <String> [-ResponseHeadersVariable <String>]
...
### Create
```
New-MgGroupTeamScheduleTimeCard -GroupId <String> -BodyParameter <IMicrosoftGraphTimeCard>
...
```
New-MgGroupTeamScheduleTimeCard -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-Breaks <IMicrosoftGraphTimeCardBreak[]>]
 [-ClockInEvent <IMicrosoftGraphTimeCardEvent>] [-ClockOutEvent <IMicrosoftGraphTimeCardEvent>]
 [-ConfirmedBy <String>] [-CreatedBy <IMicrosoftGraphIdentitySet>] [-Id <String>]
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-Notes <IMicrosoftGraphItemBody>]
