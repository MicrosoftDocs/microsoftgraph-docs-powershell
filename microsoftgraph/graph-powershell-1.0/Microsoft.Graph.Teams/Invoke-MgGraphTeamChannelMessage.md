...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mggraphteamchannelmessage
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: Invoke-MgGraphTeamChannelMessage
---

# Invoke-MgGraphTeamChannelMessage
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Invoke-MgBetaGraphTeamChannelMessage](/powershell/module/Microsoft.Graph.Beta.Teams/Invoke-MgBetaGraphTeamChannelMessage?view=graph-powershell-beta)
...
```
Invoke-MgGraphTeamChannelMessage -ChannelId <string> -TeamId <string>
...
```
Invoke-MgGraphTeamChannelMessage -ChannelId <string> -TeamId <string>
 -Body <IPaths1Am35GsTeamsTeamIdChannelsChannelIdMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema>
...
```
Invoke-MgGraphTeamChannelMessage -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-MessageIds <string[]>]
 [-ReplyMessage <IMicrosoftGraphChatMessage>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
```
Invoke-MgGraphTeamChannelMessage -InputObject <ITeamsIdentity>
 -BodyParameter <IPaths1Am35GsTeamsTeamIdChannelsChannelIdMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths1Am35GsTeamsTeamIdChannelsChannelIdMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.PowerShell.Models.IPaths1Am35GsTeamsTeamIdChannelsChannelIdMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
...
- [Invoke-MgGraphTeamChannelMessage](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mggraphteamchannelmessage)
