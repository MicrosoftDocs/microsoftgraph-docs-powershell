...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaTeamScheduleTimeOffRequest](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaTeamScheduleTimeOffRequest?view=graph-powershell-beta)
...
Update-MgTeamScheduleTimeOffRequest -TeamId <String> -TimeOffRequestId <String>
 [-AdditionalProperties <Hashtable>] [-AssignedTo <String>] [-EndDateTime <DateTime>] [-Id <String>]
...
Update-MgTeamScheduleTimeOffRequest -InputObject <ITeamsIdentity> [-AdditionalProperties <Hashtable>]
 [-AssignedTo <String>] [-EndDateTime <DateTime>] [-Id <String>] [-LastModifiedBy <IMicrosoftGraphIdentitySet>]
...
## RELATED LINKS
[Update-MgBetaTeamScheduleTimeOffRequest](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaTeamScheduleTimeOffRequest?view=graph-powershell-beta)
