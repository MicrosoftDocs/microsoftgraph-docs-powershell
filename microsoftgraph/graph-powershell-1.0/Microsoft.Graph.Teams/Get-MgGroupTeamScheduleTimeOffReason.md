...
### List (Default)
```
Get-MgGroupTeamScheduleTimeOffReason -GroupId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
### Get
```
Get-MgGroupTeamScheduleTimeOffReason -GroupId <String> -TimeOffReasonId <String> [-ExpandProperty <String[]>]
