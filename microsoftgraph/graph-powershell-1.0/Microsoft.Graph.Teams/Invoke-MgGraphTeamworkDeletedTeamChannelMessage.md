...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mggraphteamworkdeletedteamchannelmessage
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: Invoke-MgGraphTeamworkDeletedTeamChannelMessage
---

# Invoke-MgGraphTeamworkDeletedTeamChannelMessage
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Invoke-MgBetaGraphTeamworkDeletedTeamChannelMessage](/powershell/module/Microsoft.Graph.Beta.Teams/Invoke-MgBetaGraphTeamworkDeletedTeamChannelMessage?view=graph-powershell-beta)
...
```
Invoke-MgGraphTeamworkDeletedTeamChannelMessage -ChannelId <string> -DeletedTeamId <string>
...
```
Invoke-MgGraphTeamworkDeletedTeamChannelMessage -InputObject <ITeamsIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-MessageIds <string[]>]
 [-ReplyMessage <IMicrosoftGraphChatMessage>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths6Mb5SaTeamworkDeletedteamsDeletedteamIdChannelsChannelIdMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.PowerShell.Models.IPaths6Mb5SaTeamworkDeletedteamsDeletedteamIdChannelsChannelIdMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
...
- [Invoke-MgGraphTeamworkDeletedTeamChannelMessage](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mggraphteamworkdeletedteamchannelmessage)
