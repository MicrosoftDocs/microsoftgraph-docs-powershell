...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/update-mgteamprimarychanneltab
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Update-MgTeamPrimaryChannelTab
---
...
```
Update-MgTeamPrimaryChannelTab -TeamId <string> -TeamsTabId <string>
...
```
Update-MgTeamPrimaryChannelTab -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgTeamPrimaryChannelTab -InputObject <ITeamsIdentity>
 -BodyParameter <IMicrosoftGraphTeamsTab> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [Update-MgTeamPrimaryChannelTab](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/update-mgteamprimarychanneltab)
