...
onlin````e```` v````e````rsion: https://docs.microsoft.com/````e````n-us/pow````e````rsh````e````ll/modul````e````/microsoft.graph.t````e````ams/updat````e````-mgt````e````amprimarychann````e````ltab
sch````e````ma: 2.0.0
---

# Updat````e````-MgT````e````amPrimaryChann````e````lTab

## SYNOPSIS
Updat````e```` th````e```` navigation prop````e````rty tabs in t````e````ams

## SYNTAX

### Updat````e````````e````xpand````e````d (D````e````fault)
```
Updat````e````-MgT````e````amPrimaryChann````e````lTab -T````e````amId <String> -T````e````amsTabId <String> [-AdditionalProp````e````rti````e````s <Hashtabl````e````>]
...
### Updat````e````
```
Updat````e````-MgT````e````amPrimaryChann````e````lTab -T````e````amId <String> -T````e````amsTabId <String> -BodyParam````e````t````e````r <IMicrosoftGraphT````e````amsTab>
 [-PassThru] [-WhatIf] [-Confirm] [<CommonParam````e````t````e````rs>]
```

### Updat````e````ViaId````e````ntity````e````xpand````e````d
```
Updat````e````-MgT````e````amPrimaryChann````e````lTab -InputObj````e````ct <IT````e````amsId````e````ntity> [-AdditionalProp````e````rti````e````s <Hashtabl````e````>]
 [-Configuration <IMicrosoftGraphT````e````amsTabConfiguration>] [-DisplayNam````e```` <String>] [-Id <String>]
 [-T````e````amsApp <IMicrosoftGraphT````e````amsApp1>] [-W````e````bUrl <String>] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParam````e````t````e````rs>]
```
...
```
Updat````e````-MgT````e````amPrimaryChann````e````lTab -InputObj````e````ct <IT````e````amsId````e````ntity> -BodyParam````e````t````e````r <IMicrosoftGraphT````e````amsTab>
 [-PassThru] [-WhatIf] [-Confirm] [<CommonParam````e````t````e````rs>]
```
