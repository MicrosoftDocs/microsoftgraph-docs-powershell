...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mgteamprimarychannel
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Get-MgTeamPrimaryChannel
---
...
```
Get-MgTeamPrimaryChannel -InputObject <ITeamsIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgTeamPrimaryChannel](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mgteamprimarychannel)
- [Graph API Reference](https://learn.microsoft.com/graph/api/team-get-primarychannel?view=graph-rest-1.0)
