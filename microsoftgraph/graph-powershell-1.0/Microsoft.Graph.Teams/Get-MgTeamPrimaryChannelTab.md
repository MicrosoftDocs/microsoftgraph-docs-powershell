...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mgteamprimarychanneltab
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Get-MgTeamPrimaryChannelTab
---
...
```
Get-MgTeamPrimaryChannelTab -InputObject <ITeamsIdentity> [-ExpandProperty <string[]>]
 [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
```
...
- [Get-MgTeamPrimaryChannelTab](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mgteamprimarychanneltab)
