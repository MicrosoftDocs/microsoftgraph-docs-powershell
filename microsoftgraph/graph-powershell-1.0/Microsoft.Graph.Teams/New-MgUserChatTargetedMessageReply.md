...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mguserchattargetedmessagereply
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: New-MgUserChatTargetedMessageReply
---

# New-MgUserChatTargetedMessageReply
...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaUserChatTargetedMessageReply](/powershell/module/Microsoft.Graph.Beta.Teams/New-MgBetaUserChatTargetedMessageReply?view=graph-powershell-beta)
...
```
New-MgUserChatTargetedMessageReply -ChatId <string> -TargetedChatMessageId <string> -UserId <string>
...
```
New-MgUserChatTargetedMessageReply -InputObject <ITeamsIdentity> [-ChatId <string>]
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-Attachments <IMicrosoftGraphChatMessageAttachment[]>] [-Body <IMicrosoftGraphItemBody>]
...
```
New-MgUserChatTargetedMessageReply -InputObject <ITeamsIdentity>
 -BodyParameter <IMicrosoftGraphChatMessage> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
