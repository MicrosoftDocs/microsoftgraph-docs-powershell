...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mggraphchattargetedmessagereply
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Invoke-MgGraphChatTargetedMessageReply
---

# Invoke-MgGraphChatTargetedMessageReply
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Invoke-MgBetaGraphChatTargetedMessageReply](/powershell/module/Microsoft.Graph.Beta.Teams/Invoke-MgBetaGraphChatTargetedMessageReply?view=graph-powershell-beta)
...
```
Invoke-MgGraphChatTargetedMessageReply -ChatId <string> -TargetedChatMessageId <string>
...
```
Invoke-MgGraphChatTargetedMessageReply -ChatId <string> -TargetedChatMessageId <string>
 -Body <IPaths2Me7UzChatsChatIdTargetedmessagesTargetedchatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema>
...
```
Invoke-MgGraphChatTargetedMessageReply -InputObject <ITeamsIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-MessageIds <string[]>]
 [-ReplyMessage <IMicrosoftGraphChatMessage>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```
Invoke-MgGraphChatTargetedMessageReply -InputObject <ITeamsIdentity>
 -BodyParameter <IPaths2Me7UzChatsChatIdTargetedmessagesTargetedchatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths2Me7UzChatsChatIdTargetedmessagesTargetedchatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.PowerShell.Models.IPaths2Me7UzChatsChatIdTargetedmessagesTargetedchatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
...
- [Invoke-MgGraphChatTargetedMessageReply](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mggraphchattargetedmessagereply)
