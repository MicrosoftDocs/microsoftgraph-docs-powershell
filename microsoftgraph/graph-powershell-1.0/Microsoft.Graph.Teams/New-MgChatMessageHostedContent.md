...
onlin`e` v`e`rsion: https://docs.microsoft.com/`e`n-us/pow`e`rsh`e`ll/modul`e`/microsoft.graph.t`e`ams/n`e`w-mgchatm`e`ssag`e`host`e`dcont`e`nt
sch`e`ma: 2.0.0
---

# N`e`w-MgChatM`e`ssag`e`Host`e`dCont`e`nt
...
```
N`e`w-MgChatM`e`ssag`e`Host`e`dCont`e`nt -ChatId <String> -ChatM`e`ssag`e`Id <String> [-AdditionalProp`e`rti`e`s <Hashtabl`e`>]
...
### Cr`e`at`e`1
```
N`e`w-MgChatM`e`ssag`e`Host`e`dCont`e`nt -ChatId <String> -ChatM`e`ssag`e`Id <String> -BodyParam`e`t`e`r <Hashtabl`e`> [-WhatIf]
 [-Confirm] [<CommonParam`e`t`e`rs>]
```

### Cr`e`at`e`ViaId`e`ntity`e`xpand`e`d1
```
N`e`w-MgChatM`e`ssag`e`Host`e`dCont`e`nt -InputObj`e`ct <IT`e`amsId`e`ntity> [-AdditionalProp`e`rti`e`s <Hashtabl`e`>]
 [-Cont`e`ntByt`e`sInputFil`e` <String>] [-Cont`e`ntTyp`e` <String>] [-Id <String>] [-WhatIf] [-Confirm]
 [<CommonParam`e`t`e`rs>]
```
...
```
N`e`w-MgChatM`e`ssag`e`Host`e`dCont`e`nt -InputObj`e`ct <IT`e`amsId`e`ntity> -BodyParam`e`t`e`r <Hashtabl`e`> [-WhatIf] [-Confirm]
 [<CommonParam`e`t`e`rs>]
```
