...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mgteamtag
Locale: en-US
...
```
New-MgTeamTag -TeamId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgTeamTag -InputObject <ITeamsIdentity> [-TeamId <string>] [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Description <string>] [-DisplayName <string>] [-Id <string>]
 [-MemberCount <int>] [-Members <IMicrosoftGraphTeamworkTagMember[]>] [-TagType <string>] [-Break]
...
```
New-MgTeamTag -TeamId <string> -BodyParameter <IMicrosoftGraphTeamworkTag>
