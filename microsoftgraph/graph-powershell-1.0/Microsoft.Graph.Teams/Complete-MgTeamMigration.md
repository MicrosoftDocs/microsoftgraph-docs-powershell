...
### Complete (Default)
```
Complete-MgTeamMigration -TeamId <String> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### CompleteViaIdentity
```
Complete-MgTeamMigration -InputObject <ITeamsIdentity> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.teams/complete-mgteammigration](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/complete-mgteammigration)
