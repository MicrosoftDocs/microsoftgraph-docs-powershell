...
onlin```e``` v```e```rsion: https://docs.microsoft.com/```e```n-us/pow```e```rsh```e```ll/modul```e```/microsoft.graph.t```e```ams/updat```e```-mgt```e```amsch```e```dul```e```op```e```nshiftchang```e```r```e```qu```e```st
sch```e```ma: 2.0.0
---

# Updat```e```-MgT```e```amSch```e```dul```e```Op```e```nShiftChang```e```R```e```qu```e```st

## SYNOPSIS
Updat```e``` th```e``` navigation prop```e```rty op```e```nShiftChang```e```R```e```qu```e```sts in t```e```ams

## SYNTAX

### Updat```e``````e```xpand```e```d (D```e```fault)
```
Updat```e```-MgT```e```amSch```e```dul```e```Op```e```nShiftChang```e```R```e```qu```e```st -Op```e```nShiftChang```e```R```e```qu```e```stId <String> -T```e```amId <String>
 ...
 [-Op```e```nShiftId <String>] [-S```e```nd```e```rDat```e```Tim```e``` <Dat```e```Tim```e```>] [-S```e```nd```e```rM```e```ssag```e``` <String>] [-S```e```nd```e```rUs```e```rId <String>]
...
```
Updat```e```-MgT```e```amSch```e```dul```e```Op```e```nShiftChang```e```R```e```qu```e```st -Op```e```nShiftChang```e```R```e```qu```e```stId <String> -T```e```amId <String>
 -BodyParam```e```t```e```r <IMicrosoftGraphOp```e```nShiftChang```e```R```e```qu```e```st> [-PassThru] [-WhatIf] [-Confirm] [<CommonParam```e```t```e```rs>]
```

### Updat```e```ViaId```e```ntity```e```xpand```e```d
```
Updat```e```-MgT```e```amSch```e```dul```e```Op```e```nShiftChang```e```R```e```qu```e```st -InputObj```e```ct <IT```e```amsId```e```ntity> [-AdditionalProp```e```rti```e```s <Hashtabl```e```>]
...
```
Updat```e```-MgT```e```amSch```e```dul```e```Op```e```nShiftChang```e```R```e```qu```e```st -InputObj```e```ct <IT```e```amsId```e```ntity>
 -BodyParam```e```t```e```r <IMicrosoftGraphOp```e```nShiftChang```e```R```e```qu```e```st> [-PassThru] [-WhatIf] [-Confirm] [<CommonParam```e```t```e```rs>]
```
...
### -BodyParam```e```t```e```r
op```e```nShiftChang```e```R```e```qu```e```st
...
BODYPARAM```e```T```e```R <IMicrosoftGraphOp```e```nShiftChang```e```R```e```qu```e```st>: op```e```nShiftChang```e```R```e```qu```e```st
