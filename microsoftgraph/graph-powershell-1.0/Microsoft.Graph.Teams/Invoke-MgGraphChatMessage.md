...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mggraphchatmessage
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: Invoke-MgGraphChatMessage
---

# Invoke-MgGraphChatMessage
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Invoke-MgBetaGraphChatMessage](/powershell/module/Microsoft.Graph.Beta.Teams/Invoke-MgBetaGraphChatMessage?view=graph-powershell-beta)
...
```
Invoke-MgGraphChatMessage -ChatId <string> [-ResponseHeadersVariable <string>]
...
```
Invoke-MgGraphChatMessage -ChatId <string>
 -Body <IPaths1Cmn95OChatsChatIdMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema>
...
```
Invoke-MgGraphChatMessage -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-MessageIds <string[]>]
 [-ReplyMessage <IMicrosoftGraphChatMessage>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```
Invoke-MgGraphChatMessage -InputObject <ITeamsIdentity>
 -BodyParameter <IPaths1Cmn95OChatsChatIdMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths1Cmn95OChatsChatIdMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.PowerShell.Models.IPaths1Cmn95OChatsChatIdMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
...
- [Invoke-MgGraphChatMessage](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mggraphchatmessage)
