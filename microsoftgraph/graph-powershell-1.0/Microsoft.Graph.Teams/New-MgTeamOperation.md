...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mgteamoperation
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: New-MgTeamOperation
---
...
```
New-MgTeamOperation -TeamId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgTeamOperation -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-AttemptsCount <int>] [-CreatedDateTime <datetime>]
 [-Error <IMicrosoftGraphOperationError>] [-Id <string>] [-LastActionDateTime <datetime>]
 [-OperationType <string>] [-Status <string>] [-TargetResourceId <string>]
 [-TargetResourceLocation <string>] [-Break] [-Headers <IDictionary>]
...
```
New-MgTeamOperation -InputObject <ITeamsIdentity>
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mgteamoperation)
