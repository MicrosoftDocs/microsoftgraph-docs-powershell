...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaBetaChatTab](/powershell/module/Microsoft.Graph.Beta.Teams/Get-MgBetaChatTab?view=graph-powershell-beta)

## SYNTAX

### List (Default)
```
Get-MgChatTab -ChatId <String> [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
## RELATED LINKS
[Get-MgBetaBetaChatTab](/powershell/module/Microsoft.Graph.Beta.Teams/Get-MgBetaChatTab?view=graph-powershell-beta)
