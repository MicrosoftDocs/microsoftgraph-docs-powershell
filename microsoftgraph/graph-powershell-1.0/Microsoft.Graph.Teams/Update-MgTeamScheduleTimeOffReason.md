...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/update-mgteamscheduletimeoffreason
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Update-MgTeamScheduleTimeOffReason
---
...
```
Update-MgTeamScheduleTimeOffReason -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
...
- [Update-MgTeamScheduleTimeOffReason](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/update-mgteamscheduletimeoffreason)
- [Graph API Reference](https://learn.microsoft.com/graph/api/timeoffreason-put?view=graph-rest-1.0)
