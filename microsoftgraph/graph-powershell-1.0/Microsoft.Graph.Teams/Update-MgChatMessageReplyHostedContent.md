...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaChatMessageReplyHostedContent](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaChatMessageReplyHostedContent?view=graph-powershell-beta)
...
### UpdateViaIdentity
```
Update-MgChatMessageReplyHostedContent -InputObject <ITeamsIdentity> -BodyParameter <Hashtable> [-WhatIf]
...
## RELATED LINKS
[Update-MgBetaChatMessageReplyHostedContent](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaChatMessageReplyHostedContent?view=graph-powershell-beta)
