...
```
Invoke-MgHaveGroupTeamChannel -ChannelId <string> -GroupId <string> [-TenantId <string>]
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mghavegroupteamchannel)
