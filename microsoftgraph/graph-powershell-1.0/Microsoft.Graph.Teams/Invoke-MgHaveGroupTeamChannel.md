...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mghavegroupteamchannel
schema: 2.0.0
ms.subservice: teams
---
...
### Have (Default)
```
Invoke-MgHaveGroupTeamChannel -ChannelId <String> -GroupId <String> [-TenantId <String>] [-UserId <String>]
...
### HaveViaIdentity
```
Invoke-MgHaveGroupTeamChannel -InputObject <ITeamsIdentity> [-TenantId <String>] [-UserId <String>]
 [-UserPrincipalName <String>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mghavegroupteamchannel](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mghavegroupteamchannel)
