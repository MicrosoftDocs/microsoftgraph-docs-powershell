...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mgclockteamscheduletimecardin
schema: 2.0.0
ms.subservice: teams
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Invoke-MgBetaClockTeamScheduleTimeCardIn](/powershell/module/Microsoft.Graph.Beta.Teams/Invoke-MgBetaClockTeamScheduleTimeCardIn?view=graph-powershell-beta)

## SYNTAX

### ClockExpanded (Default)
```
Invoke-MgClockTeamScheduleTimeCardIn -TeamId <String> [-ResponseHeadersVariable <String>]
...
```
Invoke-MgClockTeamScheduleTimeCardIn -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-IsAtApprovedLocation] [-Notes <IMicrosoftGraphItemBody>]
 [-OnBehalfOfUserId <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
