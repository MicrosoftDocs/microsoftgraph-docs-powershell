...
Set-MgTeamPrimaryChannelMessageHostedContent -ChatMessageHostedContentId <String> -ChatMessageId <String>
 -TeamId <String> [-Data <Stream>] [-ResponseHeadersVariable <String>] -InFile <String> [-ContentType <String>]
...
### SetViaIdentity
```
Set-MgTeamPrimaryChannelMessageHostedContent -InputObject <ITeamsIdentity> [-Data <Stream>]
