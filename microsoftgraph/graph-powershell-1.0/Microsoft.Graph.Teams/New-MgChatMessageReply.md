...
```
New-MgChatMessageReply -ChatId <String> -ChatMessageId <String> [-ResponseHeadersVariable <String>]
...
```
New-MgChatMessageReply [-ChatId <String>] -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-Attachments <IMicrosoftGraphChatMessageAttachment[]>]
