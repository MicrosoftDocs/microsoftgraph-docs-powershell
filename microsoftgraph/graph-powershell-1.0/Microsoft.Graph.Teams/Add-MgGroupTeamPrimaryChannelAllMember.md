...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/add-mggroupteamprimarychannelallmember
schema: 2.0.0
ms.subservice: teams
---
...
### AddExpanded (Default)
```
Add-MgGroupTeamPrimaryChannelAllMember -GroupId <String> [-ResponseHeadersVariable <String>]
...
### Add
```
Add-MgGroupTeamPrimaryChannelAllMember -GroupId <String>
...
```
Add-MgGroupTeamPrimaryChannelAllMember -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-Values <IMicrosoftGraphConversationMember[]>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### AddViaIdentity
```
Add-MgGroupTeamPrimaryChannelAllMember -InputObject <ITeamsIdentity>
 -BodyParameter <IPathsHvdtq4GroupsGroupIdTeamPrimarychannelAllmembersMicrosoftGraphAddPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
### Microsoft.Graph.PowerShell.Models.IPathsHvdtq4GroupsGroupIdTeamPrimarychannelAllmembersMicrosoftGraphAddPostRequestbodyContentApplicationJsonSchema
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.teams/add-mggroupteamprimarychannelallmember](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/add-mggroupteamprimarychannelallmember)
