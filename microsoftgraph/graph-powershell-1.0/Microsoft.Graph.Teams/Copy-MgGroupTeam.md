...
```
Copy-MgGroupTeam -GroupId <string> [-ResponseHeadersVariable <string>]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths1Umefn4GroupsGroupIdTeamMicrosoftGraphClonePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
