...
onlin`e` v`e`rsion: https://docs.microsoft.com/`e`n-us/pow`e`rsh`e`ll/modul`e`/microsoft.graph.t`e`ams/updat`e`-mgappcatalogt`e`amappd`e`finitionbot
sch`e`ma: 2.0.0
---

# Updat`e`-MgAppCatalogT`e`amAppD`e`finitionBot

## SYNOPSIS
Updat`e` th`e` navigation prop`e`rty bot in appCatalogs

## SYNTAX

### Updat`e``e`xpand`e`d1 (D`e`fault)
```
Updat`e`-MgAppCatalogT`e`amAppD`e`finitionBot -T`e`amsAppD`e`finitionId <String> -T`e`amsAppId <String>
 [-AdditionalProp`e`rti`e`s <Hashtabl`e`>] [-Id <String>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParam`e`t`e`rs>]
```
...
```
Updat`e`-MgAppCatalogT`e`amAppD`e`finitionBot -InputObj`e`ct <IT`e`amsId`e`ntity> [-AdditionalProp`e`rti`e`s <Hashtabl`e`>]
 [-Id <String>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParam`e`t`e`rs>]
```

### Updat`e`ViaId`e`ntity1
```
Updat`e`-MgAppCatalogT`e`amAppD`e`finitionBot -InputObj`e`ct <IT`e`amsId`e`ntity> -BodyParam`e`t`e`r <Hashtabl`e`> [-PassThru]
