...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mggraphgroupteamchannelmessagereply
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Invoke-MgGraphGroupTeamChannelMessageReply
---

# Invoke-MgGraphGroupTeamChannelMessageReply
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Invoke-MgBetaGraphGroupTeamChannelMessageReply](/powershell/module/Microsoft.Graph.Beta.Teams/Invoke-MgBetaGraphGroupTeamChannelMessageReply?view=graph-powershell-beta)
...
```
Invoke-MgGraphGroupTeamChannelMessageReply -ChannelId <string> -ChatMessageId <string>
...
Invoke-MgGraphGroupTeamChannelMessageReply -ChannelId <string> -ChatMessageId <string>
 -GroupId <string>
 -Body <IPathsFmgo51GroupsGroupIdTeamChannelsChannelIdMessagesChatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema>
...
```
Invoke-MgGraphGroupTeamChannelMessageReply -InputObject <ITeamsIdentity>
...
```
Invoke-MgGraphGroupTeamChannelMessageReply -InputObject <ITeamsIdentity>
 -BodyParameter <IPathsFmgo51GroupsGroupIdTeamChannelsChannelIdMessagesChatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPathsFmgo51GroupsGroupIdTeamChannelsChannelIdMessagesChatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.PowerShell.Models.IPathsFmgo51GroupsGroupIdTeamChannelsChannelIdMessagesChatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
...
- [Invoke-MgGraphGroupTeamChannelMessageReply](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mggraphgroupteamchannelmessagereply)
