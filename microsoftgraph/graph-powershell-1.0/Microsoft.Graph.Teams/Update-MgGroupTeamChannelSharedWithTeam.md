...
Update-MgGroupTeamChannelSharedWithTeam -ChannelId <String> -GroupId <String>
 -SharedWithChannelTeamInfoId <String> [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>]
...
```
Update-MgGroupTeamChannelSharedWithTeam -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
