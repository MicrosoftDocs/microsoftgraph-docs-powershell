...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mguserchattargetedmessage
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: New-MgUserChatTargetedMessage
---

# New-MgUserChatTargetedMessage
...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaUserChatTargetedMessage](/powershell/module/Microsoft.Graph.Beta.Teams/New-MgBetaUserChatTargetedMessage?view=graph-powershell-beta)
...
```
New-MgUserChatTargetedMessage -ChatId <string> -UserId <string> [-ResponseHeadersVariable <string>]
 ...
 [-ChatId1 <string>] [-CreatedDateTime <datetime>] [-DeletedDateTime <datetime>] [-Etag <string>]
...
```
New-MgUserChatTargetedMessage -InputObject <ITeamsIdentity> [-ChatId <string>]
...
```
New-MgUserChatTargetedMessage -ChatId <string> -UserId <string>
...
```
New-MgUserChatTargetedMessage -InputObject <ITeamsIdentity>
 -BodyParameter <IMicrosoftGraphTargetedChatMessage> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgUserChatTargetedMessage](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mguserchattargetedmessage)
