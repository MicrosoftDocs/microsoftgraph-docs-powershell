...
```
New-MgTeamPrimaryChannelTab -TeamId <String> [-ResponseHeadersVariable <String>]
...
```
New-MgTeamPrimaryChannelTab -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-Configuration <IMicrosoftGraphTeamsTabConfiguration>]
 [-DisplayName <String>] [-Id <String>] [-TeamsApp <IMicrosoftGraphTeamsApp>] [-WebUrl <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
## RELATED LINKS
[New-MgBetaTeamPrimaryChannelTab](/powershell/module/Microsoft.Graph.Beta.Teams/New-MgBetaTeamPrimaryChannelTab?view=graph-powershell-beta)

[https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mgteamprimarychanneltab](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mgteamprimarychanneltab)
