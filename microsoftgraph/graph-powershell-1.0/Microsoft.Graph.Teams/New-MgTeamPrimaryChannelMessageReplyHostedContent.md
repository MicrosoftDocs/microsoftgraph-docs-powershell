...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mgteamprimarychannelmessagereplyhostedcontent
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: New-MgTeamPrimaryChannelMessageReplyHostedContent
---
...
```
New-MgTeamPrimaryChannelMessageReplyHostedContent -ChatMessageId <string> -ChatMessageId1 <string>
 -TeamId <string> -BodyParameter <hashtable> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
- [New-MgTeamPrimaryChannelMessageReplyHostedContent](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mgteamprimarychannelmessagereplyhostedcontent)
