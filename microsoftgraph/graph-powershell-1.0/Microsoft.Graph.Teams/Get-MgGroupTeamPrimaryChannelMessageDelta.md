...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mggroupteamprimarychannelmessagedelta
schema: 2.0.0
ms.subservice: teams
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaGroupTeamPrimaryChannelMessageDelta](/powershell/module/Microsoft.Graph.Beta.Teams/Get-MgBetaGroupTeamPrimaryChannelMessageDelta?view=graph-powershell-beta)

## SYNTAX

### Delta (Default)
```
Get-MgGroupTeamPrimaryChannelMessageDelta -GroupId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### DeltaViaIdentity
```
Get-MgGroupTeamPrimaryChannelMessageDelta -InputObject <ITeamsIdentity> [-ExpandProperty <String[]>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mggroupteamprimarychannelmessagedelta](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mggroupteamprimarychannelmessagedelta)
