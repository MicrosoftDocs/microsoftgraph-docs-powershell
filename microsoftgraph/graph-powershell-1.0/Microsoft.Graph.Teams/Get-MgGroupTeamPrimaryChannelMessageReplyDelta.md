...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mggroupteamprimarychannelmessagereplydelta
schema: 2.0.0
ms.subservice: teams
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaGroupTeamPrimaryChannelMessageReplyDelta](/powershell/module/Microsoft.Graph.Beta.Teams/Get-MgBetaGroupTeamPrimaryChannelMessageReplyDelta?view=graph-powershell-beta)

## SYNTAX

### Delta (Default)
```
Get-MgGroupTeamPrimaryChannelMessageReplyDelta -ChatMessageId <String> -GroupId <String>
...
### DeltaViaIdentity
```
Get-MgGroupTeamPrimaryChannelMessageReplyDelta -InputObject <ITeamsIdentity> [-ExpandProperty <String[]>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mggroupteamprimarychannelmessagereplydelta](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/get-mggroupteamprimarychannelmessagereplydelta)
