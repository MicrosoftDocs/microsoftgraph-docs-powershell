...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/update-mguserchattargetedmessage
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Update-MgUserChatTargetedMessage
---

# Update-MgUserChatTargetedMessage
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaUserChatTargetedMessage](/powershell/module/Microsoft.Graph.Beta.Teams/Update-MgBetaUserChatTargetedMessage?view=graph-powershell-beta)
...
```
Update-MgUserChatTargetedMessage -ChatId <string> -TargetedChatMessageId <string> -UserId <string>
...
```
Update-MgUserChatTargetedMessage -InputObject <ITeamsIdentity> [-ChatId <string>]
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-Attachments <IMicrosoftGraphChatMessageAttachment[]>] [-Body <IMicrosoftGraphItemBody>]
...
```
Update-MgUserChatTargetedMessage -InputObject <ITeamsIdentity>
 -BodyParameter <IMicrosoftGraphTargetedChatMessage> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
