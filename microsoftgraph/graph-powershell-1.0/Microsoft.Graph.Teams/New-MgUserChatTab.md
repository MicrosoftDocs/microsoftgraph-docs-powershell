...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mguserchattab
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: New-MgUserChatTab
---
...
```
New-MgUserChatTab -ChatId <string> -UserId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgUserChatTab -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Configuration <IMicrosoftGraphTeamsTabConfiguration>]
 [-DisplayName <string>] [-Id <string>] [-TeamsApp <IMicrosoftGraphTeamsApp>] [-WebUrl <string>]
 [-Break] [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
...
- [New-MgUserChatTab](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mguserchattab)
