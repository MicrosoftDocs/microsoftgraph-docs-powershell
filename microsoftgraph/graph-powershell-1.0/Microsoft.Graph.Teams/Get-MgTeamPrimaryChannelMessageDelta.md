...
onlin`e` v`e`rsion: https://docs.microsoft.com/`e`n-us/pow`e`rsh`e`ll/modul`e`/microsoft.graph.t`e`ams/g`e`t-mgt`e`amprimarychann`e`lm`e`ssag`e`d`e`lta
sch`e`ma: 2.0.0
---

# G`e`t-MgT`e`amPrimaryChann`e`lM`e`ssag`e`D`e`lta
...
### D`e`lta (D`e`fault)
```
G`e`t-MgT`e`amPrimaryChann`e`lM`e`ssag`e`D`e`lta -T`e`amId <String> [<CommonParam`e`t`e`rs>]
```

### D`e`ltaViaId`e`ntity
```
G`e`t-MgT`e`amPrimaryChann`e`lM`e`ssag`e`D`e`lta -InputObj`e`ct <IT`e`amsId`e`ntity> [<CommonParam`e`t`e`rs>]
```
...
Param`e`t`e`r S`e`ts: D`e`ltaViaId`e`ntity
Alias`e`s:
