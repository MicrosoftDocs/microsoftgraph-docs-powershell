...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/remove-mgteamchanneltab
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Remove-MgTeamChannelTab
---
...
```
Remove-MgTeamChannelTab -ChannelId <string> -TeamId <string> -TeamsTabId <string>
...
```
Remove-MgTeamChannelTab -InputObject <ITeamsIdentity> [-IfMatch <string>]
