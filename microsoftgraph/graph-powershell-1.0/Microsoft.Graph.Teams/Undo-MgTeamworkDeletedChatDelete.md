...
### Undo (Default)
```
Undo-MgTeamworkDeletedChatDelete -DeletedChatId <String> [-ResponseHeadersVariable <String>]
...
### UndoViaIdentity
```
Undo-MgTeamworkDeletedChatDelete -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
