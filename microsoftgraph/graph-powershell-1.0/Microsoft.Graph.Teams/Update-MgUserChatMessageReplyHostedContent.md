...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaUserChatMessageReplyHostedContent](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaUserChatMessageReplyHostedContent?view=graph-powershell-beta)
...
### UpdateViaIdentity
```
Update-MgUserChatMessageReplyHostedContent -InputObject <ITeamsIdentity> -BodyParameter <Hashtable> [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgBetaUserChatMessageReplyHostedContent](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaUserChatMessageReplyHostedContent?view=graph-powershell-beta)
