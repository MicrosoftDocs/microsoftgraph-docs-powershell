...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mggroupteaminstalledapp
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: New-MgGroupTeamInstalledApp
---
...
```
New-MgGroupTeamInstalledApp -GroupId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgGroupTeamInstalledApp -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>]
 [-ConsentedPermissionSet <IMicrosoftGraphTeamsAppPermissionSet>] [-Id <string>]
 [-TeamsApp <IMicrosoftGraphTeamsApp>] [-TeamsAppDefinition <IMicrosoftGraphTeamsAppDefinition>]
 [-Break] [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
...
```
New-MgGroupTeamInstalledApp -InputObject <ITeamsIdentity>
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mggroupteaminstalledapp)
