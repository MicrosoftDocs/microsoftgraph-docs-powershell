...
onlin```e``` v```e```rsion: https://docs.microsoft.com/```e```n-us/pow```e```rsh```e```ll/modul```e```/microsoft.graph.t```e```ams/n```e```w-mggroupt```e```amsch```e```dul```e```op```e```nshiftchang```e```r```e```qu```e```st
sch```e```ma: 2.0.0
---

# N```e```w-MgGroupT```e```amSch```e```dul```e```Op```e```nShiftChang```e```R```e```qu```e```st

## SYNOPSIS
Cr```e```at```e``` n```e```w navigation prop```e```rty to op```e```nShiftChang```e```R```e```qu```e```sts for groups

## SYNTAX

### Cr```e```at```e``````e```xpand```e```d1 (D```e```fault)
```
N```e```w-MgGroupT```e```amSch```e```dul```e```Op```e```nShiftChang```e```R```e```qu```e```st -GroupId <String> [-AdditionalProp```e```rti```e```s <Hashtabl```e```>]
...
### Cr```e```at```e```1
```
N```e```w-MgGroupT```e```amSch```e```dul```e```Op```e```nShiftChang```e```R```e```qu```e```st -GroupId <String>
...
```
N```e```w-MgGroupT```e```amSch```e```dul```e```Op```e```nShiftChang```e```R```e```qu```e```st -InputObj```e```ct <IT```e```amsId```e```ntity> [-AdditionalProp```e```rti```e```s <Hashtabl```e```>]
 [-Assign```e```dTo <String>] [-Cr```e```at```e```dDat```e```Tim```e``` <Dat```e```Tim```e```>] [-Id <String>]
 [-LastModifi```e```dBy <IMicrosoftGraphId```e```ntityS```e```t>] [-LastModifi```e```dDat```e```Tim```e``` <Dat```e```Tim```e```>]
 [-Manag```e```rActionDat```e```Tim```e``` <Dat```e```Tim```e```>] [-Manag```e```rActionM```e```ssag```e``` <String>] [-Manag```e```rUs```e```rId <String>]
 [-Op```e```nShiftId <String>] [-S```e```nd```e```rDat```e```Tim```e``` <Dat```e```Tim```e```>] [-S```e```nd```e```rM```e```ssag```e``` <String>] [-S```e```nd```e```rUs```e```rId <String>]
...
```
N```e```w-MgGroupT```e```amSch```e```dul```e```Op```e```nShiftChang```e```R```e```qu```e```st -InputObj```e```ct <IT```e```amsId```e```ntity>
 -BodyParam```e```t```e```r <IMicrosoftGraphOp```e```nShiftChang```e```R```e```qu```e```st> [-WhatIf] [-Confirm] [<CommonParam```e```t```e```rs>]
```
