...
onlin`e` v`e`rsion: https://docs.microsoft.com/`e`n-us/pow`e`rsh`e`ll/modul`e`/microsoft.graph.t`e`ams/g`e`t-mgt`e`aminstall`e`dapp
sch`e`ma: 2.0.0
---

# G`e`t-MgT`e`amInstall`e`dApp

## SYNOPSIS
G`e`t install`e`dApps from t`e`ams

## SYNTAX

### List1 (D`e`fault)
```
G`e`t-MgT`e`amInstall`e`dApp -T`e`amId <String> [-`e`xpandProp`e`rty <String[]>] [-Prop`e`rty <String[]>] [-Filt`e`r <String>]
...
### G`e`t1
```
G`e`t-MgT`e`amInstall`e`dApp -T`e`amId <String> -T`e`amsAppInstallationId <String> [-`e`xpandProp`e`rty <String[]>]
 [-Prop`e`rty <String[]>] [<CommonParam`e`t`e`rs>]
```

### G`e`tViaId`e`ntity1
```
G`e`t-MgT`e`amInstall`e`dApp -InputObj`e`ct <IT`e`amsId`e`ntity> [-`e`xpandProp`e`rty <String[]>] [-Prop`e`rty <String[]>]
