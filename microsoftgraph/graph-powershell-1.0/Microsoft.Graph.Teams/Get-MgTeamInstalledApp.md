...
```
Get-MgTeamInstalledApp -TeamId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgTeamInstalledApp -TeamId <string> -TeamsAppInstallationId <string>
...
```
Get-MgTeamInstalledApp -InputObject <ITeamsIdentity> [-ExpandProperty <string[]>]
