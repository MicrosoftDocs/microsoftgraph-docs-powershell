...
### DeleteViaIdentity
```
Remove-MgUserChatMember -InputObject <ITeamsIdentity> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
...
```yaml
Type: IPathsWr2QdoUsersUserIdChatsChatIdMembersMicrosoftGraphRemovePostRequestbodyContentApplicationJsonSchema
