...
```
New-MgChatMessage -ChatId <String> [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>]
...
```
New-MgChatMessage [-ChatId <String>] -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
