...
### Set
```
Set-MgTeamSchedule -TeamId <String> -BodyParameter <IMicrosoftGraphSchedule> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### SetViaIdentity
```
Set-MgTeamSchedule -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphSchedule> [-PassThru] [-WhatIf]
