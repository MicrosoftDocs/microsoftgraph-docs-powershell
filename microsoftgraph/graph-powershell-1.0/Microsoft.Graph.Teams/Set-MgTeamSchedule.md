...
### Set
```
Set-MgTeamSchedule -TeamId <String> -BodyParameter <IMicrosoftGraphSchedule> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SetViaIdentity
```
Set-MgTeamSchedule -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphSchedule> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
