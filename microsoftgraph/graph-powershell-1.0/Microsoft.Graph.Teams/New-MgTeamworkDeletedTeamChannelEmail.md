...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mgteamworkdeletedteamchannelemail
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: New-MgTeamworkDeletedTeamChannelEmail
---
...
```
New-MgTeamworkDeletedTeamChannelEmail -ChannelId <string> -DeletedTeamId <string>
...
```
New-MgTeamworkDeletedTeamChannelEmail -InputObject <ITeamsIdentity>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
- [New-MgTeamworkDeletedTeamChannelEmail](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mgteamworkdeletedteamchannelemail)
