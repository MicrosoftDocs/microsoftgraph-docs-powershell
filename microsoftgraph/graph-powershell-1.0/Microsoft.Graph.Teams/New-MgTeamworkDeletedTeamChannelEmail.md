...
### Provision (Default)
```
New-MgTeamworkDeletedTeamChannelEmail -ChannelId <String> -DeletedTeamId <String> [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### ProvisionViaIdentity
```
New-MgTeamworkDeletedTeamChannelEmail -InputObject <ITeamsIdentity> [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
## RELATED LINKS
[New-MgBetaTeamworkDeletedTeamChannelEmail](/powershell/module/Microsoft.Graph.Beta.Teams/New-MgBetaTeamworkDeletedTeamChannelEmail?view=graph-powershell-beta)
