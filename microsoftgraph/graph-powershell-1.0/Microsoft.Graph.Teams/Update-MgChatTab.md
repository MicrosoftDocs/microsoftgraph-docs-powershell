...
\rThis can be used to configure the content of the tab.
...
- [Update-MgChatTab](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/update-mgchattab)
- [Graph API Reference](https://learn.microsoft.com/graph/api/chat-patch-tabs?view=graph-rest-1.0)
