...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaChatTab](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaChatTab?view=graph-powershell-beta)
...
### Update
```
Update-MgChatTab -ChatId <String> -TeamsTabId <String> -BodyParameter <IMicrosoftGraphTeamsTab> [-WhatIf]
...
### UpdateViaIdentity
```
Update-MgChatTab -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphTeamsTab> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgBetaChatTab](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaChatTab?view=graph-powershell-beta)
