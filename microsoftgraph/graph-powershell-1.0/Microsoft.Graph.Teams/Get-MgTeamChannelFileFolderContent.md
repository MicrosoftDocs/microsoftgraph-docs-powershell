...
### Get (Default)
```
Get-MgTeamChannelFileFolderContent -ChannelId <String> -TeamId <String> [-Format <String>] -OutFile <String>
...
### GetViaIdentity
```
Get-MgTeamChannelFileFolderContent -InputObject <ITeamsIdentity> [-Format <String>] -OutFile <String>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
