...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mgarchiveteam
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Invoke-MgArchiveTeam
---
...
```
Invoke-MgArchiveTeam -TeamId <string> [-ResponseHeadersVariable <string>]
...
```
Invoke-MgArchiveTeam -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-ShouldSetSpoSiteReadOnlyForMembers] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [Invoke-MgArchiveTeam](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mgarchiveteam)
