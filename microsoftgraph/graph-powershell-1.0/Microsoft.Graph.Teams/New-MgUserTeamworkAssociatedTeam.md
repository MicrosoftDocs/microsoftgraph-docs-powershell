...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaUserTeamworkAssociatedTeam](/powershell/module/Microsoft.Graph.Beta.Applications/New-MgBetaUserTeamworkAssociatedTeam?view=graph-powershell-beta)
...
### Create
```
New-MgUserChatTab -ChatId <String> -UserId <String> -BodyParameter <IMicrosoftGraphTeamsTab> [-WhatIf]
...
### CreateViaIdentity
```
New-MgUserChatTab -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphTeamsTab> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
## RELATED LINKS
[New-MgBetaUserTeamworkAssociatedTeam](/powershell/module/Microsoft.Graph.Beta.Applications/New-MgBetaUserTeamworkAssociatedTeam?view=graph-powershell-beta)
