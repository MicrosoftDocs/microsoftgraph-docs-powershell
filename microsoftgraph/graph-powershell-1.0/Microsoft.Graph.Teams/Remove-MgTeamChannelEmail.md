...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/remove-mgteamchannelemail
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: Remove-MgTeamChannelEmail
---
...
```
Remove-MgTeamChannelEmail -ChannelId <string> -TeamId <string> [-ResponseHeadersVariable <string>]
...
```
Remove-MgTeamChannelEmail -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>] [-Break]
...
- [Remove-MgTeamChannelEmail](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/remove-mgteamchannelemail)
