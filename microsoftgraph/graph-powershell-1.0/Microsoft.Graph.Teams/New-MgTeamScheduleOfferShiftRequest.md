...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mgteamscheduleoffershiftrequest
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: New-MgTeamScheduleOfferShiftRequest
---
...
```
New-MgTeamScheduleOfferShiftRequest -TeamId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgTeamScheduleOfferShiftRequest -TeamId <string>
...
- [New-MgTeamScheduleOfferShiftRequest](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/new-mgteamscheduleoffershiftrequest)
- [Graph API Reference](https://learn.microsoft.com/graph/api/offershiftrequest-post?view=graph-rest-1.0)
