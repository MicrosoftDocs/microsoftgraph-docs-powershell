...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mgmarkuserchatreadforuser
schema: 2.0.0
ms.subservice: teams
---
...
```
Invoke-MgMarkUserChatReadForUser -ChatId <String> -UserId <String> [-ResponseHeadersVariable <String>]
