...
### Delete (Default)
```
Remove-MgTeamTag -TeamId <String> -TeamworkTagId <String> [-IfMatch <String>] [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgTeamTag -InputObject <ITeamsIdentity> [-IfMatch <String>] [-Headers <IDictionary>] [-PassThru]
