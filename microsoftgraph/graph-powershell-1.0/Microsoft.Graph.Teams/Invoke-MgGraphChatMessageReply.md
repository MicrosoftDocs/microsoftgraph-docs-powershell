...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mggraphchatmessagereply
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: Invoke-MgGraphChatMessageReply
---

# Invoke-MgGraphChatMessageReply
...
```
Invoke-MgGraphChatMessageReply -ChatId <string> -ChatMessageId <string>
...
```
Invoke-MgGraphChatMessageReply -ChatId <string> -ChatMessageId <string>
 -Body <IPaths4A0Tl8ChatsChatIdMessagesChatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema>
...
```
Invoke-MgGraphChatMessageReply -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
...
```
Invoke-MgGraphChatMessageReply -InputObject <ITeamsIdentity>
 -BodyParameter <IPaths4A0Tl8ChatsChatIdMessagesChatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths4A0Tl8ChatsChatIdMessagesChatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.PowerShell.Models.IPaths4A0Tl8ChatsChatIdMessagesChatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
...
- [Invoke-MgGraphChatMessageReply](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mggraphchatmessagereply)
