...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaChatMessage](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaChatMessage?view=graph-powershell-beta)
...
### UpdateViaIdentity
```
Update-MgChatMessage -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphChatMessage> [-WhatIf]
...
## RELATED LINKS
[Update-MgBetaChatMessage](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaChatMessage?view=graph-powershell-beta)
