...
```
Update-MgChatMessage [-ChatId <String>] -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-Attachments <IMicrosoftGraphChatMessageAttachment[]>]
...
## RELATED LINKS
[Update-MgBetaChatMessage](/powershell/module/Microsoft.Graph.Beta.Teams/Update-MgBetaChatMessage?view=graph-powershell-beta)
