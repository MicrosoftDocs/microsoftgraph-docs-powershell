...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mgarchiveteamprimarychannel
Locale: en-US
Module Name: Microsoft.Graph.Teams
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Invoke-MgArchiveTeamPrimaryChannel
---
...
```
Invoke-MgArchiveTeamPrimaryChannel -TeamId <string> [-ResponseHeadersVariable <string>]
...
```
Invoke-MgArchiveTeamPrimaryChannel -TeamId <string>
...
```
Invoke-MgArchiveTeamPrimaryChannel -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-ShouldSetSpoSiteReadOnlyForMembers] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```
Invoke-MgArchiveTeamPrimaryChannel -InputObject <ITeamsIdentity>
 -BodyParameter <IPaths136Ckd2TeamsTeamIdPrimarychannelMicrosoftGraphArchivePostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru]
 [-Proxy <uri>] [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths136Ckd2TeamsTeamIdPrimarychannelMicrosoftGraphArchivePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.PowerShell.Models.IPaths136Ckd2TeamsTeamIdPrimarychannelMicrosoftGraphArchivePostRequestbodyContentApplicationJsonSchema
...
- [Invoke-MgArchiveTeamPrimaryChannel](https://learn.microsoft.com/powershell/module/microsoft.graph.teams/invoke-mgarchiveteamprimarychannel)
