...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.applications/remove-mgapplicationpassword
Locale: en-US
Module Name: Microsoft.Graph.Applications
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: Remove-MgApplicationPassword
---
...
Remove-MgApplicationPassword -ApplicationId <string> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-KeyId <string>] [-Break] [-Headers <IDictionary>]
...
Remove-MgApplicationPassword -InputObject <IApplicationsIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-KeyId <string>] [-Break]
...
- [Remove-MgApplicationPassword](https://learn.microsoft.com/powershell/module/microsoft.graph.applications/remove-mgapplicationpassword)
- [Graph API Reference](https://learn.microsoft.com/graph/api/application-removepassword?view=graph-rest-1.0)
