...
```
New-MgApplicationOwnerByRef -ApplicationId <String> [-ResponseHeadersVariable <String>] -OdataId <String>
...
```
New-MgApplicationOwnerByRef -InputObject <IApplicationsIdentity> [-ResponseHeadersVariable <String>]
