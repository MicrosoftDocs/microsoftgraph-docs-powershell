...
### Create
```
New-MgApplicationOwnerByRef -ApplicationId <String> -BodyParameter <IReferenceCreate> [-Break]
...
### CreateViaIdentity
```
New-MgApplicationOwnerByRef -InputObject <IApplicationsIdentity> -BodyParameter <IReferenceCreate> [-Break]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru] [-Proxy <Uri>]
 [-ProxyCredential <PSCredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm] [<CommonParameters>]
```
