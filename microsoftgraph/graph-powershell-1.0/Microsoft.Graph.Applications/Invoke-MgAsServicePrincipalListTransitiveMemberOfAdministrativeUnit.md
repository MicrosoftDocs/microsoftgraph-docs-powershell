...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.applications/invoke-mgasserviceprincipallisttransitivememberofadministrativeunit
schema: 2.0.0
---
...
### As1 (Default)
```
Invoke-MgAsServicePrincipalListTransitiveMemberOfAdministrativeUnit -ServicePrincipalId <String> [-Count]
...
### AsViaIdentity1
```
Invoke-MgAsServicePrincipalListTransitiveMemberOfAdministrativeUnit -InputObject <IApplicationsIdentity>
