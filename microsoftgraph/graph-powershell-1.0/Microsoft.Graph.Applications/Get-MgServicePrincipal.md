...
```powershell
Connect-MgGraph -Scopes 'Application.Read.All'
Get-MgServicePrincipal -Filter "DisplayName eq 'Power BI Service'" ### Example 2: Get the service principal by display name### Example 3: Get a count of the service principals
