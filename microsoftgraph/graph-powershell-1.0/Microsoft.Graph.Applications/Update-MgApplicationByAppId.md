...
```
Update-MgApplicationByAppId -AppId <string> [-ResponseHeadersVariable <string>]
...
```
Update-MgApplicationByAppId -InputObject <IApplicationsIdentity>
...
- [Update-MgApplicationByAppId](https://learn.microsoft.com/powershell/module/microsoft.graph.applications/update-mgapplicationbyappid)
