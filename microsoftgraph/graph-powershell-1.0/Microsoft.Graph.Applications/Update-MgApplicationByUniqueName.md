...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.applications/update-mgapplicationbyuniquename
Locale: en-US
Module Name: Microsoft.Graph.Applications
ms.date: 02/20/2026
PlatyPS schema version: 2024-05-01
title: Update-MgApplicationByUniqueName
---
...
```
Update-MgApplicationByUniqueName -UniqueName <string> [-ResponseHeadersVariable <string>]
 [-AddIns <IMicrosoftGraphAddIn[]>] [-AdditionalProperties <hashtable>]
...
```
Update-MgApplicationByUniqueName -InputObject <IApplicationsIdentity> [-UniqueName <string>]
 [-ResponseHeadersVariable <string>] [-AddIns <IMicrosoftGraphAddIn[]>]
...
The possible values are: null (default value), NotDisabled, and DisabledDueToViolationOfServicesAgreement (reasons include suspicious, abusive, or malicious activity, or a violation of the Microsoft Services Agreement).
...
Allowed characters are : ! # $ % & ' ( ) * + , - . / : ;  =  ? @ \[ \] ^ + _  {  } ~, and characters in the ranges   @ - `[ ]` ^ + _  {  } ~, and characters in the ranges 
