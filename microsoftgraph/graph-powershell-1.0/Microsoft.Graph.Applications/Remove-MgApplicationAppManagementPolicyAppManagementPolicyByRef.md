...
### Delete (Default)
```
Remove-MgApplicationAppManagementPolicyAppManagementPolicyByRef -AppManagementPolicyId <String>
...
### DeleteViaIdentity
```
Remove-MgApplicationAppManagementPolicyAppManagementPolicyByRef -InputObject <IApplicationsIdentity>
...
## RELATED LINKS
[Remove-MgBetaApplicationAppManagementPolicyAppManagementPolicyByRef](/powershell/module/Microsoft.Graph.Beta.Applications/Remove-MgBetaApplicationAppManagementPolicyAppManagementPolicyByRef?view=graph-powershell-beta)
