...
### Delete (Default)
```
Remove-MgApplicationOwnerDirectoryObjectByRef -ApplicationId <String> -DirectoryObjectId <String>
...
### DeleteViaIdentity
```
Remove-MgApplicationOwnerDirectoryObjectByRef -InputObject <IApplicationsIdentity> [-IfMatch <String>]
...
## RELATED LINKS
[Remove-MgBetaApplicationOwnerDirectoryObjectByRef](/powershell/module/Microsoft.Graph.Beta.Applications/Remove-MgBetaApplicationOwnerDirectoryObjectByRef?view=graph-powershell-beta)
