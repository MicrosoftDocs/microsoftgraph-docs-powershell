...
### Create1 (Default)
```
New-MgServicePrincipalClaimMappingPolicyByRef -ServicePrincipalId <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### CreateViaIdentity1
```
New-MgServicePrincipalClaimMappingPolicyByRef -InputObject <IApplicationsIdentity> [-PassThru] [-WhatIf]
