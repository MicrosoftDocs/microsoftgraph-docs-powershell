...
### Delete (Default)
```
Remove-MgApplication -ApplicationId <String> [-IfMatch <String>] [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgApplication -InputObject <IApplicationsIdentity> [-IfMatch <String>] [-Headers <IDictionary>]
