...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.applications/remove-mgapplication
Locale: en-US
Module Name: Microsoft.Graph.Applications
ms.date: 06/17/2026
PlatyPS schema version: 2024-05-01
title: Remove-MgApplication
---
...
```
Remove-MgApplication -ApplicationId <string> [-IfMatch <string>] [-ResponseHeadersVariable <string>]
...
```
Remove-MgApplication -InputObject <IApplicationsIdentity> [-IfMatch <string>]
...
| --------------- | ------------------------------------------  |
| Delegated (work or school account) | AgentIdentityBlueprint.DeleteRestore.All, Application.ReadWrite.All,  |
| Delegated (personal Microsoft account) | Application.ReadWrite.All,  |
| Application | AgentIdentityBlueprint.DeleteRestore.All, Application.ReadWrite.All, Application.ReadWrite.OwnedBy,  |
