...
Update-MgApplicationFederatedIdentityCredential -ApplicationId <String> -FederatedIdentityCredentialId <String>
 ...
 [-Issuer <String>] [-Name <String>] [-Subject <String>] [-Break] [-HttpPipelineAppend <SendAsyncStep[]>]
...
```
Update-MgApplicationFederatedIdentityCredential -ApplicationId <String> -FederatedIdentityCredentialId <String>
 -BodyParameter <IMicrosoftGraphFederatedIdentityCredential> [-Break] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <Uri>] [-ProxyCredential <PSCredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm] [<CommonParameters>]
```
