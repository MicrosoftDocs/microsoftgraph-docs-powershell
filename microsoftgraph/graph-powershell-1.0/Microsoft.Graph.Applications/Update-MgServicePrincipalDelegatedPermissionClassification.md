...
Update-MgServicePrincipalDelegatedPermissionClassification -DelegatedPermissionClassificationId <String>
 ...
 [-PermissionId <String>] [-PermissionName <String>] [-Break] [-HttpPipelineAppend <SendAsyncStep[]>]
...
```
Update-MgServicePrincipalDelegatedPermissionClassification -DelegatedPermissionClassificationId <String>
 -ServicePrincipalId <String> -BodyParameter <IMicrosoftGraphDelegatedPermissionClassification> [-Break]
