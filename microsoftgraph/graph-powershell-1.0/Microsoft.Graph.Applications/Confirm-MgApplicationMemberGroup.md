...
### Unset (Default)
```
Clear-MgApplicationVerifiedPublisher -ApplicationId <String> [-Break] [-HttpPipelineAppend <SendAsyncStep[]>]
...
### UnsetViaIdentity
```
Clear-MgApplicationVerifiedPublisher -InputObject <IApplicationsIdentity> [-Break]
