...
```
Set-MgApplicationSynchronizationJobBulkUploadContent -ApplicationId <string>
 -SynchronizationJobId <string> -InFile <string> [-Data <Stream>]
...
```
Set-MgApplicationSynchronizationJobBulkUploadContent -InputObject <IApplicationsIdentity>
