...
Remove-MgServicePrincipalAppRoleAssignedTo -AppRoleAssignmentId <String> -ServicePrincipalId <String>
 [-IfMatch <String>] [-Break] [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>]
...
### DeleteViaIdentity
```
Remove-MgServicePrincipalAppRoleAssignedTo -InputObject <IApplicationsIdentity> [-IfMatch <String>] [-Break]
