...
$secret ### Example 1: Add a password credential to an application with a six month expiry### Example 2: Add a password credential to an application with a start date
...
$secret = Add-MgApplicationPassword -applicationId $appObjectId -PasswordCredential $passwordCred
$secret ### Example 2: Add a password credential to an application with a start date
## PARAMETERS
