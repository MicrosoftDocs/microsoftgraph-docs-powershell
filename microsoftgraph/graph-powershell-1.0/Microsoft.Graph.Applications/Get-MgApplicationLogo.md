...
### Get (Default)
```
Get-MgApplicationLogo -ApplicationId <String> -OutFile <String> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgApplicationLogo -InputObject <IApplicationsIdentity> -OutFile <String> [-Headers <IDictionary>]
