...
| --------------- | ------------------------------------------  |
| Delegated (work or school account) | AgentIdentityBlueprint.Read.All, Application.Read.All, Application.ReadWrite.All, Directory.Read.All, Directory.ReadWrite.All,  |
| Delegated (personal Microsoft account) | Application.Read.All, Application.ReadWrite.All,  |
| Application | AgentIdentityBlueprint.Read.All, Application.Read.All, Application.ReadWrite.All, Application.ReadWrite.OwnedBy, Directory.Read.All, Directory.ReadWrite.All,  |
...
- [Graph API Reference](https://learn.microsoft.com/graph/api/application-list?view=graph-rest-1.0)
