...
Get-MgApplication ### Example 1: Get a list of applications### Example 2: Get an application by Id

```powershell
Connect-MgGraph -Scopes 'Application.Read.All'
Get-MgApplication -Filter "AppId eq '39b09640-ec3e-44c9-b3de-f52db4e1cf66'" ### Example 2: Get an application by Id### Example 3: Get a count of all applications
