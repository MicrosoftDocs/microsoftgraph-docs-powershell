...
```
Remove-MgServicePrincipalOwnerDirectoryObjectByRef -DirectoryObjectId <string>
...
```
Remove-MgServicePrincipalOwnerDirectoryObjectByRef -InputObject <IApplicationsIdentity>
