...
```
Update-MgServicePrincipalByAppId [-AppId <String>] -InputObject <IApplicationsIdentity> [-AccountEnabled]
...
### Update
```
Update-MgServicePrincipalByAppId -AppId <String> -BodyParameter <IMicrosoftGraphServicePrincipal> [-WhatIf]
