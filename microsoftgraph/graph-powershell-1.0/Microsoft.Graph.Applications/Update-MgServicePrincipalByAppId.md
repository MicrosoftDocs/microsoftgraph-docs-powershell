...
```
Update-MgServicePrincipalByAppId -AppId <string> [-ResponseHeadersVariable <string>]
...
```
Update-MgServicePrincipalByAppId -InputObject <IApplicationsIdentity> [-AppId <string>]
