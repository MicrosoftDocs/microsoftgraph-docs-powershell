...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaBetaServicePrincipalById](/powershell/module/Microsoft.Graph.Beta.Applications/Get-MgBetaServicePrincipalById?view=graph-powershell-beta)

## SYNTAX

### GetExpanded (Default)
```
Get-MgServicePrincipalById [-AdditionalProperties <Hashtable>] [-Ids <String[]>] [-Types <String[]>] [-WhatIf]
...
## RELATED LINKS
[Get-MgBetaBetaServicePrincipalById](/powershell/module/Microsoft.Graph.Beta.Applications/Get-MgBetaServicePrincipalById?view=graph-powershell-beta)
