...
```
Update-MgUserActivity -UserActivityId <string> -UserId <string> [-ResponseHeadersVariable <string>]
...
```
Update-MgUserActivity -UserActivityId <string> -UserId <string>
...
- [Update-MgUserActivity](https://learn.microsoft.com/powershell/module/microsoft.graph.crossdeviceexperiences/update-mguseractivity)
