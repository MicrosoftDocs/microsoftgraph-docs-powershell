...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.compliance/get-mgprivacysubjectrightsrequestapprover
schema: 2.0.0
---
...
### List (Default)
```
Get-MgPrivacySubjectRightsRequestApprover -SubjectRightsRequestId <String> [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgPrivacySubjectRightsRequestApprover -InputObject <IComplianceIdentity> [-ExpandProperty <String[]>]
