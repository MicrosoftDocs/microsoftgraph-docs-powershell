...
Update-MgPrivacySubjectRightsRequest -SubjectRightsRequestId <String>
 -BodyParameter <IMicrosoftGraphSubjectRightsRequest> [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgBetaPrivacySubjectRightsRequest](/powershell/module/Microsoft.Graph.Beta.Compliance/Update-MgBetaPrivacySubjectRightsRequest?view=graph-powershell-beta)
