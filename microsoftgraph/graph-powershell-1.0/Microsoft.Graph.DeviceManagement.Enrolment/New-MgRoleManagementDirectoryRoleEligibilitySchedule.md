...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaRoleManagementDirectoryRoleEligibilitySchedule](/powershell/module/Microsoft.Graph.Beta.DeviceManagement.Enrolment/New-MgRoleManagementDirectoryRoleEligibilitySchedule?view=graph-powershell-beta)
...
```
New-MgRoleManagementDirectoryRoleEligibilitySchedule
 -BodyParameter <IMicrosoftGraphUnifiedRoleEligibilitySchedule1> [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
## RELATED LINKS
[New-MgBetaRoleManagementDirectoryRoleEligibilitySchedule](/powershell/module/Microsoft.Graph.Beta.DeviceManagement.Enrolment/New-MgRoleManagementDirectoryRoleEligibilitySchedule?view=graph-powershell-beta)
