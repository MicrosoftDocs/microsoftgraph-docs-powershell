...
onlin`e` v`e`rsion: https://docs.microsoft.com/`e`n-us/pow`e`rsh`e`ll/modul`e`/microsoft.graph.d`e`vic`e`manag`e`m`e`nt.`e`nrolm`e`nt/r`e`mov`e`-mgrol`e`manag`e`m`e`nt`e`ntitl`e`m`e`ntmanag`e`m`e`ntrol`e`d`e`finitioninh`e`ritp`e`rmissionfrom
sch`e`ma: 2.0.0
---

# R`e`mov`e`-MgRol`e`Manag`e`m`e`nt`e`ntitl`e`m`e`ntManag`e`m`e`ntRol`e`D`e`finitionInh`e`ritP`e`rmissionFrom
...
```
R`e`mov`e`-MgRol`e`Manag`e`m`e`nt`e`ntitl`e`m`e`ntManag`e`m`e`ntRol`e`D`e`finitionInh`e`ritP`e`rmissionFrom
 -Unifi`e`dRol`e`D`e`finitionId <String> -Unifi`e`dRol`e`D`e`finitionId1 <String> [-IfMatch <String>] [-PassThru] [-WhatIf]
