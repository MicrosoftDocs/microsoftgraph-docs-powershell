...
onlin````e```` v````e````rsion: https://docs.microsoft.com/````e````n-us/pow````e````rsh````e````ll/modul````e````/microsoft.graph.d````e````vic````e````manag````e````m````e````nt.````e````nrolm````e````nt/updat````e````-mgrol````e````manag````e````m````e````ntdir````e````ctoryrol````e````d````e````finitioninh````e````ritp````e````rmissionfrom
sch````e````ma: 2.0.0
---

# Updat````e````-MgRol````e````Manag````e````m````e````ntDir````e````ctoryRol````e````D````e````finitionInh````e````ritP````e````rmissionFrom
...
```
Updat````e````-MgRol````e````Manag````e````m````e````ntDir````e````ctoryRol````e````D````e````finitionInh````e````ritP````e````rmissionFrom -Unifi````e````dRol````e````D````e````finitionId <String>
 -Unifi````e````dRol````e````D````e````finitionId1 <String> [-AdditionalProp````e````rti````e````s <Hashtabl````e````>] [-D````e````scription <String>]
...
```
Updat````e````-MgRol````e````Manag````e````m````e````ntDir````e````ctoryRol````e````D````e````finitionInh````e````ritP````e````rmissionFrom -Unifi````e````dRol````e````D````e````finitionId <String>
 -Unifi````e````dRol````e````D````e````finitionId1 <String> -BodyParam````e````t````e````r <IMicrosoftGraphUnifi````e````dRol````e````D````e````finition1> [-PassThru]
