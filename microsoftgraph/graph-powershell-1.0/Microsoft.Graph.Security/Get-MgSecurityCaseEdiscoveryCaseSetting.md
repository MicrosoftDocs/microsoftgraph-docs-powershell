...
```
Get-MgSecurityCaseEdiscoveryCaseSetting -InputObject <ISecurityIdentity>
...
- [Get-MgSecurityCaseEdiscoveryCaseSetting](https://learn.microsoft.com/powershell/module/microsoft.graph.security/get-mgsecuritycaseediscoverycasesetting)
- [Graph API Reference](https://learn.microsoft.com/graph/api/security-ediscoverycasesettings-get?view=graph-rest-1.0)
