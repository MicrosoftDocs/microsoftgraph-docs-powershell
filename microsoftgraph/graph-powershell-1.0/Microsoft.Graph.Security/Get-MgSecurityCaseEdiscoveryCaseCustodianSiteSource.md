...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.security/get-mgsecuritycaseediscoverycasecustodiansitesource
schema: 2.0.0
---
...
### Example 1: Using the Get-MgSecurityCaseEdiscoveryCaseCustodianSiteSource Cmdlet
```powershell
