...
title: Update-MgSecurityIdentityAccount
---

# Update-MgSecurityIdentityAccount
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaSecurityIdentityAccount](/powershell/module/Microsoft.Graph.Beta.Security/Update-MgBetaSecurityIdentityAccount?view=graph-powershell-beta)
...
```
Update-MgSecurityIdentityAccount -IdentityAccountsId <string> [-ResponseHeadersVariable <string>]
 [-Accounts <IMicrosoftGraphSecurityAccount[]>] [-AdditionalProperties <hashtable>]
 [-CloudSecurityIdentifier <string>] [-DisplayName <string>] [-Domain <string>] [-Id <string>]
 [-IsEnabled] [-OnPremisesSecurityIdentifier <string>] [-Break] [-Headers <IDictionary>]
...
```
Update-MgSecurityIdentityAccount -IdentityAccountsId <string>
 -BodyParameter <IMicrosoftGraphSecurityIdentityAccounts> [-ResponseHeadersVariable <string>]
...
```
Update-MgSecurityIdentityAccount -InputObject <ISecurityIdentity>
 [-ResponseHeadersVariable <string>] [-Accounts <IMicrosoftGraphSecurityAccount[]>]
 [-AdditionalProperties <hashtable>] [-CloudSecurityIdentifier <string>] [-DisplayName <string>]
 [-Domain <string>] [-Id <string>] [-IsEnabled] [-OnPremisesSecurityIdentifier <string>] [-Break]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphSecurityAccount[]
DefaultValue: ''
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphSecurityIdentityAccounts
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.PowerShell.Models.IMicrosoftGraphSecurityIdentityAccounts
...
The possible values are: disable, enable, forcePasswordReset, revokeAllSessions, requireUserToSignInAgain, markUserAsCompromised, unknownFutureValue.
