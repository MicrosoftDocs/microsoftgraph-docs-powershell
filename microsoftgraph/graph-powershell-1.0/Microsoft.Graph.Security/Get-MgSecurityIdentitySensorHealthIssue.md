...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.security/get-mgsecurityidentitysensorhealthissue
Locale: en-US
Module Name: Microsoft.Graph.Security
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: Get-MgSecurityIdentitySensorHealthIssue
---
...
```
Get-MgSecurityIdentitySensorHealthIssue -SensorId <string> [-ExpandProperty <string[]>]
...
```
Get-MgSecurityIdentitySensorHealthIssue -HealthIssueId <string> -SensorId <string>
...
```
Get-MgSecurityIdentitySensorHealthIssue -InputObject <ISecurityIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [<CommonParameters>]
