...
```
Get-MgSecurityIdentitySettingAutoAuditingConfiguration [-ExpandProperty <string[]>]
...
### Microsoft.Graph.PowerShell.Models.IMicrosoftGraphSecurityAutoAuditingConfiguration
