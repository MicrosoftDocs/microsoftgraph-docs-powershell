...
### List (Default)
```
Get-MgSecurityAttackSimulationTraining [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
### Get
```
Get-MgSecurityAttackSimulationTraining -TrainingId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.security/get-mgsecurityattacksimulationtraining](https://learn.microsoft.com/powershell/module/microsoft.graph.security/get-mgsecurityattacksimulationtraining)

[https://learn.microsoft.com/graph/api/training-get?view=graph-rest-1.0](https://learn.microsoft.com/graph/api/training-get?view=graph-rest-1.0)
