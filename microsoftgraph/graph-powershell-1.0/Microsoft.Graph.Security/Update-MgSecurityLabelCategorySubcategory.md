...
```
Update-MgSecurityLabelCategorySubcategory -CategoryTemplateId <string>
 -SubcategoryTemplateId <string> [-ResponseHeadersVariable <string>]
...
```
Update-MgSecurityLabelCategorySubcategory -InputObject <ISecurityIdentity>
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.security/update-mgsecuritylabelcategorysubcategory)
