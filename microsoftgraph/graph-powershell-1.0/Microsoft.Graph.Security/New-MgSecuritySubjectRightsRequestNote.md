...
```
New-MgSecuritySubjectRightsRequestNote -SubjectRightsRequestId <String> [-ResponseHeadersVariable <String>]
...
```
New-MgSecuritySubjectRightsRequestNote -InputObject <ISecurityIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-Author <IMicrosoftGraphIdentity>] [-Content <IMicrosoftGraphItemBody>]
 [-CreatedDateTime <DateTime>] [-Id <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
