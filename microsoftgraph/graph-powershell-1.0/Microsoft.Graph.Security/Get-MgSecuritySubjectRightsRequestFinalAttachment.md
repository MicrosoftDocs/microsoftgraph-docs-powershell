...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.security/get-mgsecuritysubjectrightsrequestfinalattachment
Locale: en-US
Module Name: Microsoft.Graph.Security
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: Get-MgSecuritySubjectRightsRequestFinalAttachment
---
...
```
Get-MgSecuritySubjectRightsRequestFinalAttachment -SubjectRightsRequestId <string> -OutFile <string>
...
```
Get-MgSecuritySubjectRightsRequestFinalAttachment -InputObject <ISecurityIdentity> -OutFile <string>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru]
 [-Proxy <uri>] [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
```
...
- [Get-MgSecuritySubjectRightsRequestFinalAttachment](https://learn.microsoft.com/powershell/module/microsoft.graph.security/get-mgsecuritysubjectrightsrequestfinalattachment)
- [Graph API Reference](https://learn.microsoft.com/graph/api/subjectrightsrequest-getfinalattachment?view=graph-rest-1.0)
