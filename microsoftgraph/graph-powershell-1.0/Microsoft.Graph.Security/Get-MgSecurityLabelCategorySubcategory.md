...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.security/get-mgsecuritylabelcategorysubcategory
schema: 2.0.0
...
### List (Default)
```
Get-MgSecurityLabelCategorySubcategory -CategoryTemplateId <String> [-ExpandProperty <String[]>]
...
### Get
```
Get-MgSecurityLabelCategorySubcategory -CategoryTemplateId <String> -SubcategoryTemplateId <String>
...
### Microsoft.Graph.PowerShell.Models.IMicrosoftGraphSecuritySubcategoryTemplate
## NOTES
