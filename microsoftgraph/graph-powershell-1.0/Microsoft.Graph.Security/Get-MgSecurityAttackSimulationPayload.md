...
```
Get-MgSecurityAttackSimulationPayload [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgSecurityAttackSimulationPayload -PayloadId <string> [-ExpandProperty <string[]>]
