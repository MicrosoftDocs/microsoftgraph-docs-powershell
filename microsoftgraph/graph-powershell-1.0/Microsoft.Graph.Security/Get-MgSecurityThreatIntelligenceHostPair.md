...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.security/get-mgsecuritythreatintelligencehostpair
Locale: en-US
Module Name: Microsoft.Graph.Security
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Get-MgSecurityThreatIntelligenceHostPair
---
...
```
Get-MgSecurityThreatIntelligenceHostPair [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgSecurityThreatIntelligenceHostPair -HostPairId <string> -HostId <string>
...
```
Get-MgSecurityThreatIntelligenceHostPair -HostId <string> [-ExpandProperty <string[]>]
...
```
Get-MgSecurityThreatIntelligenceHostPair -InputObject <ISecurityIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
...
- [Get-MgSecurityThreatIntelligenceHostPair](https://learn.microsoft.com/powershell/module/microsoft.graph.security/get-mgsecuritythreatintelligencehostpair)
- [Graph API Reference](https://learn.microsoft.com/graph/api/security-hostpair-get?view=graph-rest-1.0)
- [Graph API Reference](https://learn.microsoft.com/graph/api/security-host-list-hostpairs?view=graph-rest-1.0)
