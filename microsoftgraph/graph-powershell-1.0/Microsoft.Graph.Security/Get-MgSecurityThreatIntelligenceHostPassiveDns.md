...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.security/get-mgsecuritythreatintelligencehostpassivedns
Locale: en-US
Module Name: Microsoft.Graph.Security
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Get-MgSecurityThreatIntelligenceHostPassiveDns
---
...
```
Get-MgSecurityThreatIntelligenceHostPassiveDns -InputObject <ISecurityIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
...
- [Get-MgSecurityThreatIntelligenceHostPassiveDns](https://learn.microsoft.com/powershell/module/microsoft.graph.security/get-mgsecuritythreatintelligencehostpassivedns)
- [Graph API Reference](https://learn.microsoft.com/graph/api/security-host-list-passivedns?view=graph-rest-1.0)
