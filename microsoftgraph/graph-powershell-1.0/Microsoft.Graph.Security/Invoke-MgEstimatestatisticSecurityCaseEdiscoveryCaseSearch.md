...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.security/invoke-mgestimatestatisticsecuritycaseediscoverycasesearch
schema: 2.0.0
---

# Invoke-MgEstimatestatisticSecurityCaseEdiscoveryCaseSearch
...
```
Invoke-MgEstimatestatisticSecurityCaseEdiscoveryCaseSearch -EdiscoveryCaseId <String>
 -EdiscoverySearchId <String> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### EstimatestatisticsViaIdentity
```
Invoke-MgEstimatestatisticSecurityCaseEdiscoveryCaseSearch -InputObject <ISecurityIdentity> [-PassThru]
