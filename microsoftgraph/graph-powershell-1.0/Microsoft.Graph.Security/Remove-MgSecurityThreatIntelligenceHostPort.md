...
### Delete (Default)
```
Remove-MgSecurityThreatIntelligenceHostPort -HostPortId <String> [-IfMatch <String>] [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgSecurityThreatIntelligenceHostPort -InputObject <ISecurityIdentity> [-IfMatch <String>] [-PassThru]
