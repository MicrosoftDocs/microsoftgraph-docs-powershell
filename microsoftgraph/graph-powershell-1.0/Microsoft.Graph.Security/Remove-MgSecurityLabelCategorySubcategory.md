...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.security/remove-mgsecuritylabelcategorysubcategory
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgSecurityLabelCategorySubcategory -CategoryTemplateId <String> -SubcategoryTemplateId <String>
