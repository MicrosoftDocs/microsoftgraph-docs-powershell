...
> [!NOTE]
> To view the beta release of this cmdlet, view [Invoke-MgBetaAndSecurityDataSecurityAndGovernanceSensitivityLabel](/powershell/module/Microsoft.Graph.Beta.Security/Invoke-MgBetaAndSecurityDataSecurityAndGovernanceSensitivityLabel?view=graph-powershell-beta)
...
```
Invoke-MgAndSecurityDataSecurityAndGovernanceSensitivityLabel [-ResponseHeadersVariable <string>]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths1Bfgf7OSecurityDatasecurityandgovernanceSensitivitylabelsMicrosoftGraphComputerightsandinheritancePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.PowerShell.Models.IPaths1Bfgf7OSecurityDatasecurityandgovernanceSensitivitylabelsMicrosoftGraphComputerightsandinheritancePostRequestbodyContentApplicationJsonSchema
