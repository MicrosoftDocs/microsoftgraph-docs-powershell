...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.security/get-mgsecuritythreatintelligenceprofileindicator
Locale: en-US
Module Name: Microsoft.Graph.Security
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Get-MgSecurityThreatIntelligenceProfileIndicator
---
...
```
Get-MgSecurityThreatIntelligenceProfileIndicator [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgSecurityThreatIntelligenceProfileIndicator -IntelligenceProfileIndicatorId <string>
...
```
Get-MgSecurityThreatIntelligenceProfileIndicator -InputObject <ISecurityIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
...
- [Get-MgSecurityThreatIntelligenceProfileIndicator](https://learn.microsoft.com/powershell/module/microsoft.graph.security/get-mgsecuritythreatintelligenceprofileindicator)
- [Graph API Reference](https://learn.microsoft.com/graph/api/security-intelligenceprofileindicator-get?view=graph-rest-1.0)
