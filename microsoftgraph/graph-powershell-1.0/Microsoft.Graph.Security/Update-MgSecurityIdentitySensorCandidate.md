...
# Update-MgSecurityIdentitySensorCandidate
...
```
Update-MgSecurityIdentitySensorCandidate -SensorCandidateId <string>
...
```
Update-MgSecurityIdentitySensorCandidate -InputObject <ISecurityIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-ComputerDnsName <string>]
 [-DomainName <string>] [-Id <string>] [-LastSeenDateTime <datetime>] [-SenseClientVersion <string>]
 [-Break] [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.security/update-mgsecurityidentitysensorcandidate)
