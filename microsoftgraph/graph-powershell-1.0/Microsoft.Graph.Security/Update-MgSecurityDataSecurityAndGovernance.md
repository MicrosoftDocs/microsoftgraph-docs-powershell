...
```
Update-MgSecurityDataSecurityAndGovernance [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Id <string>] [-ProtectionScopes <hashtable>]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphTenantDataSecurityAndGovernance
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.PowerShell.Models.IMicrosoftGraphTenantDataSecurityAndGovernance
...
- [Update-MgSecurityDataSecurityAndGovernance](https://learn.microsoft.com/powershell/module/microsoft.graph.security/update-mgsecuritydatasecurityandgovernance)
