...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.security/get-mgsecurityattacksimulation
Locale: en-US
Module Name: Microsoft.Graph.Security
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Get-MgSecurityAttackSimulation
---
...
```
Get-MgSecurityAttackSimulation [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgSecurityAttackSimulation -SimulationId <string> [-ExpandProperty <string[]>]
...
- [Get-MgSecurityAttackSimulation](https://learn.microsoft.com/powershell/module/microsoft.graph.security/get-mgsecurityattacksimulation)
- [Graph API Reference](https://learn.microsoft.com/graph/api/simulation-get?view=graph-rest-1.0)
- [Graph API Reference](https://learn.microsoft.com/graph/api/attacksimulationroot-list-simulations?view=graph-rest-1.0)
