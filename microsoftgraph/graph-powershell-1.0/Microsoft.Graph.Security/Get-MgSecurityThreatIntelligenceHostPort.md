...
### List (Default)
```
Get-MgSecurityThreatIntelligenceHostPort [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
### Get1
```
Get-MgSecurityThreatIntelligenceHostPort -HostPortId <String> -HostId <String> [-ExpandProperty <String[]>]
...
### List1
```
Get-MgSecurityThreatIntelligenceHostPort -HostId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
