...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.security/get-mgsecuritythreatintelligencesslcertificate
Locale: en-US
Module Name: Microsoft.Graph.Security
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Get-MgSecurityThreatIntelligenceSslCertificate
---
...
```
Get-MgSecurityThreatIntelligenceSslCertificate [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgSecurityThreatIntelligenceSslCertificate -SslCertificateId <string>
...
```
Get-MgSecurityThreatIntelligenceSslCertificate -InputObject <ISecurityIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
...
- [Get-MgSecurityThreatIntelligenceSslCertificate](https://learn.microsoft.com/powershell/module/microsoft.graph.security/get-mgsecuritythreatintelligencesslcertificate)
- [Graph API Reference](https://learn.microsoft.com/graph/api/security-sslcertificate-get?view=graph-rest-1.0)
- [Graph API Reference](https://learn.microsoft.com/graph/api/security-threatintelligence-list-sslcertificates?view=graph-rest-1.0)
