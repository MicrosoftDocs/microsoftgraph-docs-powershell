...
```
Remove-MgSecurityIdentitySensorCandidate -SensorCandidateId <string> [-IfMatch <string>]
...
```
Remove-MgSecurityIdentitySensorCandidate -InputObject <ISecurityIdentity> [-IfMatch <string>]
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru]
 [-Proxy <uri>] [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.security/remove-mgsecurityidentitysensorcandidate)
