...
### Get (Default)
```
Get-MgSecurityThreatIntelligenceHostWhoi -HostId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSecurityThreatIntelligenceHostWhoi -InputObject <ISecurityIdentity> [-ExpandProperty <String[]>]
...
## RELATED LINKS
[Get-MgBetaSecurityThreatIntelligenceHostWhoi](/powershell/module/Microsoft.Graph.Beta.Security/Get-MgBetaSecurityThreatIntelligenceHostWhoi?view=graph-powershell-beta)
