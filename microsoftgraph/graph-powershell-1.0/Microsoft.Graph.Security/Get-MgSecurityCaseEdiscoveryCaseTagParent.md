...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.security/get-mgsecuritycaseediscoverycasetagparent
Locale: en-US
Module Name: Microsoft.Graph.Security
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Get-MgSecurityCaseEdiscoveryCaseTagParent
---
...
```
Get-MgSecurityCaseEdiscoveryCaseTagParent -InputObject <ISecurityIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
...
- [Get-MgSecurityCaseEdiscoveryCaseTagParent](https://learn.microsoft.com/powershell/module/microsoft.graph.security/get-mgsecuritycaseediscoverycasetagparent)
