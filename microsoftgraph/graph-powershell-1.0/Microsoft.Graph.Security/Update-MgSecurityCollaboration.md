...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.security/update-mgsecuritycollaboration
Locale: en-US
Module Name: Microsoft.Graph.Security
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Update-MgSecurityCollaboration
---

# Update-MgSecurityCollaboration
...
```
Update-MgSecurityCollaboration [-ResponseHeadersVariable <string>]
...
```
Update-MgSecurityCollaboration -BodyParameter <IMicrosoftGraphSecurityCollaborationRoot>
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphSecurityCollaborationRoot
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
