...
```
New-MgSecurityCaseEdiscoveryCaseCustodianSiteSource -EdiscoveryCaseId <string>
 ...
 [-Site <IMicrosoftGraphSite>] [-Break] [-Headers <IDictionary>]
...
```
New-MgSecurityCaseEdiscoveryCaseCustodianSiteSource -EdiscoveryCaseId <string>
 -EdiscoveryCustodianId <string> -BodyParameter <IMicrosoftGraphSecuritySiteSource>
...
New-MgSecurityCaseEdiscoveryCaseCustodianSiteSource -InputObject <ISecurityIdentity>
 ...
 [-HoldStatus <string>] [-Id <string>] [-Site <IMicrosoftGraphSite>] [-Break]
...
```
New-MgSecurityCaseEdiscoveryCaseCustodianSiteSource -InputObject <ISecurityIdentity>
 -BodyParameter <IMicrosoftGraphSecuritySiteSource> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm] [<CommonParameters>]
```
