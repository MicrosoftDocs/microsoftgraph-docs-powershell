...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.security/update-mgsecuritylabelcitation
schema: 2.0.0
---
...
```
Update-MgSecurityLabelCitation -CitationTemplateId <String> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-CitationJurisdiction <String>] [-CitationUrl <String>]
...
### Update
```
Update-MgSecurityLabelCitation -CitationTemplateId <String>
...
```
Update-MgSecurityLabelCitation -InputObject <ISecurityIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-CitationJurisdiction <String>] [-CitationUrl <String>]
 [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <DateTime>] [-DisplayName <String>] [-Id <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### UpdateViaIdentity
```
Update-MgSecurityLabelCitation -InputObject <ISecurityIdentity>
 -BodyParameter <IMicrosoftGraphSecurityCitationTemplate> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
