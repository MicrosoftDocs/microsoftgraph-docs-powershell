...
### List (Default)
```
Get-MgSecurityIdentityHealthIssue [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
### Get
```
Get-MgSecurityIdentityHealthIssue -HealthIssueId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
