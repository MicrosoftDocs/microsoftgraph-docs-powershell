...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.security/get-mgsecurityidentityhealthissue
Locale: en-US
Module Name: Microsoft.Graph.Security
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: Get-MgSecurityIdentityHealthIssue
---
...
```
Get-MgSecurityIdentityHealthIssue [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgSecurityIdentityHealthIssue -HealthIssueId <string> [-ExpandProperty <string[]>]
...
```
Get-MgSecurityIdentityHealthIssue -InputObject <ISecurityIdentity> [-ExpandProperty <string[]>]
 [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [<CommonParameters>]
```
