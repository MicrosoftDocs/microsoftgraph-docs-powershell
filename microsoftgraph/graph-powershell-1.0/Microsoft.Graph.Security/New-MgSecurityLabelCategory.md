...
New-MgSecurityLabelCategory [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 ...
 [-Id <string>] [-Subcategories <IMicrosoftGraphSecuritySubcategoryTemplate[]>] [-Break]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphSecuritySubcategoryTemplate[]
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
