...
# Remove-MgSecurityCaseEdiscoveryCaseMember
...
```
Remove-MgSecurityCaseEdiscoveryCaseMember -EdiscoveryCaseId <string>
...
```
Remove-MgSecurityCaseEdiscoveryCaseMember -InputObject <ISecurityIdentity> [-IfMatch <string>]
