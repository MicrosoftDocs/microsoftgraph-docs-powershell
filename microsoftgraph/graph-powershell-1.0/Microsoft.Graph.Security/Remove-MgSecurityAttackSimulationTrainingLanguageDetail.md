...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.security/remove-mgsecurityattacksimulationtraininglanguagedetail
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgSecurityAttackSimulationTrainingLanguageDetail -TrainingId <String> -TrainingLanguageDetailId <String>
...
### DeleteViaIdentity
```
Remove-MgSecurityAttackSimulationTrainingLanguageDetail -InputObject <ISecurityIdentity> [-IfMatch <String>]
