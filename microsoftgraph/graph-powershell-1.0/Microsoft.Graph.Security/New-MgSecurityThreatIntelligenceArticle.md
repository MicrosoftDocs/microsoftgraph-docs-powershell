...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaSecurityThreatIntelligenceArticle](/powershell/module/Microsoft.Graph.Beta.Applications/New-MgBetaSecurityThreatIntelligenceArticle?view=graph-powershell-beta)
...
### Create
```
New-MgSecurityThreatIntelligenceArticle -BodyParameter <IMicrosoftGraphSecurityArticle> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
## RELATED LINKS
[New-MgBetaSecurityThreatIntelligenceArticle](/powershell/module/Microsoft.Graph.Beta.Applications/New-MgBetaSecurityThreatIntelligenceArticle?view=graph-powershell-beta)
