...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.security/update-mgsecuritycase
Locale: en-US
Module Name: Microsoft.Graph.Security
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: Update-MgSecurityCase
---
...
Update-MgSecurityCase [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-EdiscoveryCases <IMicrosoftGraphSecurityEdiscoveryCase[]>] [-Id <string>] [-Break]
...
```
Update-MgSecurityCase -BodyParameter <IMicrosoftGraphSecurityCasesRoot>
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.security/update-mgsecuritycase)
