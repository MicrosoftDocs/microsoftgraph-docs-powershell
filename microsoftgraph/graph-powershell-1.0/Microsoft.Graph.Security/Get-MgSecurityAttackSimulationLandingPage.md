...
### List (Default)
```
Get-MgSecurityAttackSimulationLandingPage [-ExpandProperty <String[]>] [-Property <String[]>]
...
[https://learn.microsoft.com/graph/api/landingpage-get?view=graph-rest-1.0](https://learn.microsoft.com/graph/api/landingpage-get?view=graph-rest-1.0)
