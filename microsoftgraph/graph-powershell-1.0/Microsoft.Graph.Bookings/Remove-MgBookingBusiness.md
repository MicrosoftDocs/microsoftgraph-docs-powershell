...
### Delete (Default)
```
Remove-MgBookingBusiness -BookingBusinessId <String> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
...
### DeleteViaIdentity
```
Remove-MgBookingBusiness -InputObject <IBookingsIdentity> [-IfMatch <String>]
