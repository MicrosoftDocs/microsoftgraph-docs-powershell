...
```
Stop-MgVirtualEventWebinarRegistration -VirtualEventRegistrationId <string>
 -VirtualEventWebinarId <string> [-ResponseHeadersVariable <string>] [-Break]
...
```
Stop-MgVirtualEventWebinarRegistration -InputObject <IBookingsIdentity>
...
- [Stop-MgVirtualEventWebinarRegistration](https://learn.microsoft.com/powershell/module/microsoft.graph.bookings/stop-mgvirtualeventwebinarregistration)
