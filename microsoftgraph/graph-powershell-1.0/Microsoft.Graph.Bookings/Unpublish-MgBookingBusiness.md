...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.bookings/unpublish-mgbookingbusiness
Locale: en-US
Module Name: Microsoft.Graph.Bookings
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Unpublish-MgBookingBusiness
---
...
```
Unpublish-MgBookingBusiness -BookingBusinessId <string> [-ResponseHeadersVariable <string>] [-Break]
...
- [Unpublish-MgBookingBusiness](https://learn.microsoft.com/powershell/module/microsoft.graph.bookings/unpublish-mgbookingbusiness)
- [Graph API Reference](https://learn.microsoft.com/graph/api/bookingbusiness-unpublish?view=graph-rest-1.0)
