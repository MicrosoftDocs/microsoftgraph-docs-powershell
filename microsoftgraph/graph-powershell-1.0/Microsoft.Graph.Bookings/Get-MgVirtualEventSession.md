...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.bookings/get-mgvirtualeventsession
Locale: en-US
Module Name: Microsoft.Graph.Bookings
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Get-MgVirtualEventSession
---
...
```
Get-MgVirtualEventSession -VirtualEventId <string> [-ExpandProperty <string[]>]
...
```
Get-MgVirtualEventSession -InputObject <IBookingsIdentity> [-ExpandProperty <string[]>]
