...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.bookings/update-mgvirtualeventpresenter
schema: 2.0.0
---
...
```
Update-MgVirtualEventPresenter -VirtualEventId <String> -VirtualEventPresenterId <String>
...
```
Update-MgVirtualEventPresenter -InputObject <IBookingsIdentity> [-ResponseHeadersVariable <String>]
...
### UpdateViaIdentity
```
Update-MgVirtualEventPresenter -InputObject <IBookingsIdentity>
 -BodyParameter <IMicrosoftGraphVirtualEventPresenter> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.bookings/update-mgvirtualeventpresenter](https://learn.microsoft.com/powershell/module/microsoft.graph.bookings/update-mgvirtualeventpresenter)
