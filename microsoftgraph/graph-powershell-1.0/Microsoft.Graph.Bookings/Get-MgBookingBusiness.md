...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaBetaBookingBusiness](/powershell/module/Microsoft.Graph.Beta.Bookings/Get-MgBetaBookingBusiness?view=graph-powershell-beta)

## SYNTAX

### List (Default)
```
Get-MgBookingBusiness [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>] [-Search <String>]
...
## RELATED LINKS
[Get-MgBetaBetaBookingBusiness](/powershell/module/Microsoft.Graph.Beta.Bookings/Get-MgBetaBookingBusiness?view=graph-powershell-beta)
