...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.bookings/publish-mgvirtualevent
schema: 2.0.0
---
...
### Publish (Default)
```
Publish-MgVirtualEvent -VirtualEventId <String> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### PublishViaIdentity
```
Publish-MgVirtualEvent -InputObject <IBookingsIdentity> [-ResponseHeadersVariable <String>]
