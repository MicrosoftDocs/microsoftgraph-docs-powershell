...
### Delete (Default)
```
Remove-MgVirtualEventTownhallPresenter -VirtualEventPresenterId <String> -VirtualEventTownhallId <String>
...
### DeleteViaIdentity
```
Remove-MgVirtualEventTownhallPresenter -InputObject <IBookingsIdentity> [-IfMatch <String>]
