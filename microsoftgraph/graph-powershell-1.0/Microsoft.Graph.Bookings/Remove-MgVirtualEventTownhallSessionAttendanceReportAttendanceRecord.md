...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.bookings/remove-mgvirtualeventtownhallsessionattendancereportattendancerecord
Locale: en-US
Module Name: Microsoft.Graph.Bookings
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Remove-MgVirtualEventTownhallSessionAttendanceReportAttendanceRecord
---
...
Remove-MgVirtualEventTownhallSessionAttendanceReportAttendanceRecord -AttendanceRecordId <string>
 ...
 -VirtualEventTownhallId <string> [-IfMatch <string>] [-ResponseHeadersVariable <string>] [-Break]
...
```
Remove-MgVirtualEventTownhallSessionAttendanceReportAttendanceRecord
 -InputObject <IBookingsIdentity> [-IfMatch <string>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
- [Remove-MgVirtualEventTownhallSessionAttendanceReportAttendanceRecord](https://learn.microsoft.com/powershell/module/microsoft.graph.bookings/remove-mgvirtualeventtownhallsessionattendancereportattendancerecord)
