...
### Publish (Default)
```
Publish-MgBookingBusiness -BookingBusinessId <String> [-ResponseHeadersVariable <String>]
...
### PublishViaIdentity
```
Publish-MgBookingBusiness -InputObject <IBookingsIdentity> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
[https://learn.microsoft.com/graph/api/bookingbusiness-publish?view=graph-rest-1.0](https://learn.microsoft.com/graph/api/bookingbusiness-publish?view=graph-rest-1.0)
