...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.bookings/new-mgvirtualeventsession
Locale: en-US
Module Name: Microsoft.Graph.Bookings
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: New-MgVirtualEventSession
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaVirtualEventSession](/powershell/module/Microsoft.Graph.Beta.Bookings/New-MgBetaVirtualEventSession?view=graph-powershell-beta)
...
```
New-MgVirtualEventSession -VirtualEventId <string>
...
```
New-MgVirtualEventSession -InputObject <IBookingsIdentity>
 -BodyParameter <IMicrosoftGraphVirtualEventSession> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm] [<CommonParameters>]
