...
# Invoke-MgFilterIdentityGovernanceAccessReviewUnifiedDecisionByCurrentUser
...
```
Invoke-MgFilterIdentityGovernanceAccessReviewUnifiedDecisionByCurrentUser -On <string> [-Count]
...
- [Invoke-MgFilterIdentityGovernanceAccessReviewUnifiedDecisionByCurrentUser](https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/invoke-mgfilteridentitygovernanceaccessreviewunifieddecisionbycurrentuser)
- [Graph API Reference](https://learn.microsoft.com/graph/api/accessreviewinstancedecisionitem-filterbycurrentuser?view=graph-rest-1.0)
