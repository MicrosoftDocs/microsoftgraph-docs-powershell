...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/get-mgidentitygovernancecatalogresourcescoperesource
Locale: en-US
Module Name: Microsoft.Graph.Identity.Governance
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Get-MgIdentityGovernanceCatalogResourceScopeResource
---

# Get-MgIdentityGovernanceCatalogResourceScopeResource
...
```
Get-MgIdentityGovernanceCatalogResourceScopeResource -AccessPackageCatalogId <string>
...
```
Get-MgIdentityGovernanceCatalogResourceScopeResource -InputObject <IIdentityGovernanceIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
