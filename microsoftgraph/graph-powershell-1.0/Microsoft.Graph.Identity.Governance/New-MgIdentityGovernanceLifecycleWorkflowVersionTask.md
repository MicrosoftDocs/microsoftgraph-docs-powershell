...
New-MgIdentityGovernanceLifecycleWorkflowVersionTask -WorkflowId <String> -WorkflowVersionNumber <Int32>
 ...
 [-TaskProcessingResults <IMicrosoftGraphIdentityGovernanceTaskProcessingResult[]>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```
New-MgIdentityGovernanceLifecycleWorkflowVersionTask -WorkflowId <String> -WorkflowVersionNumber <Int32>
 -BodyParameter <IMicrosoftGraphIdentityGovernanceTask> [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
Required.
  ...
  \[ContinueOnError \<Boolean?\>\]: A boolean value that specifies whether, if this task fails, the workflow will stop, and subsequent tasks will not run.
Optional.
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/new-mgidentitygovernancelifecycleworkflowversiontask](https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/new-mgidentitygovernancelifecycleworkflowversiontask)
