...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/new-mgentitlementmanagementresourceuploadsession
Locale: en-US
Module Name: Microsoft.Graph.Identity.Governance
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: New-MgEntitlementManagementResourceUploadSession
---

# New-MgEntitlementManagementResourceUploadSession
...
```
New-MgEntitlementManagementResourceUploadSession -AccessPackageResourceId <string>
...
```
New-MgEntitlementManagementResourceUploadSession -InputObject <IIdentityGovernanceIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-CreatedDateTime <datetime>] [-Data <hashtable>]
 [-Files <IMicrosoftGraphCustomDataProvidedResourceFile[]>] [-Id <string>] [-IsUploadDone]
 [-ReferenceId <string>] [-Stats <IMicrosoftGraphCustomDataProvidedResourceUploadStats>]
...
- [New-MgEntitlementManagementResourceUploadSession](https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/new-mgentitlementmanagementresourceuploadsession)
