...
# Stop-MgIdentityGovernanceLifecycleWorkflowProcessing
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Stop-MgBetaIdentityGovernanceLifecycleWorkflowProcessing](/powershell/module/Microsoft.Graph.Beta.Identity.Governance/Stop-MgBetaIdentityGovernanceLifecycleWorkflowProcessing?view=graph-powershell-beta)
...
```
Stop-MgIdentityGovernanceLifecycleWorkflowProcessing -WorkflowId <string>
...
```
Stop-MgIdentityGovernanceLifecycleWorkflowProcessing -InputObject <IIdentityGovernanceIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-Scope <hashtable>]
 [-Break] [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths1Ye3F10IdentitygovernanceLifecycleworkflowsWorkflowsWorkflowIdMicrosoftGraphIdentitygovernanceCancelprocessingPostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.PowerShell.Models.IPaths1Ye3F10IdentitygovernanceLifecycleworkflowsWorkflowsWorkflowIdMicrosoftGraphIdentitygovernanceCancelprocessingPostRequestbodyContentApplicationJsonSchema
