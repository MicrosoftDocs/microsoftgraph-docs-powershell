...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgidentitygovernanceaccessreviewunifiedinstance
Locale: en-US
Module Name: Microsoft.Graph.Identity.Governance
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Update-MgIdentityGovernanceAccessReviewUnifiedInstance
---

# Update-MgIdentityGovernanceAccessReviewUnifiedInstance
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaIdentityGovernanceAccessReviewUnifiedInstance](/powershell/module/Microsoft.Graph.Beta.Identity.Governance/Update-MgBetaIdentityGovernanceAccessReviewUnifiedInstance?view=graph-powershell-beta)
...
```
Update-MgIdentityGovernanceAccessReviewUnifiedInstance -AccessReviewInstanceId <string>
...
```
Update-MgIdentityGovernanceAccessReviewUnifiedInstance -InputObject <IIdentityGovernanceIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-ContactedReviewers <IMicrosoftGraphAccessReviewReviewer[]>]
 [-Decisions <IMicrosoftGraphAccessReviewInstanceDecisionItem[]>] [-EndDateTime <datetime>]
 [-Errors <IMicrosoftGraphAccessReviewError[]>]
