...
New-MgIdentityGovernanceLifecycleWorkflowDeletedItemWorkflowNewVersion -WorkflowId <String>
 [-AdditionalProperties <Hashtable>] [-Workflow <IMicrosoftGraphIdentityGovernanceWorkflow>] [-WhatIf]
...
New-MgIdentityGovernanceLifecycleWorkflowDeletedItemWorkflowNewVersion
 ...
 [-Workflow <IMicrosoftGraphIdentityGovernanceWorkflow>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
