...
Supports $filter(lt,gt) and $orderby.
    [PreviewScope <IMicrosoftGraphDirectoryObject[]>]: The preview scope for the workflow.
    [QuarantineDetails <IMicrosoftGraphIdentityGovernanceQuarantineDetails>]: quarantineDetails
      ...
      [QuarantinedDateTime <DateTime?>]: The date and time when the workflow was quarantined.
