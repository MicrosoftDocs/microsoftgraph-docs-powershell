...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/get-mgidentitygovernancecatalogresourceroleresource
Locale: en-US
Module Name: Microsoft.Graph.Identity.Governance
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Get-MgIdentityGovernanceCatalogResourceRoleResource
---

# Get-MgIdentityGovernanceCatalogResourceRoleResource
...
```
Get-MgIdentityGovernanceCatalogResourceRoleResource -AccessPackageCatalogId <string>
...
```
Get-MgIdentityGovernanceCatalogResourceRoleResource -InputObject <IIdentityGovernanceIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
...
- [Get-MgIdentityGovernanceCatalogResourceRoleResource](https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/get-mgidentitygovernancecatalogresourceroleresource)
