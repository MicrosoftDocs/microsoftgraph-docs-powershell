...
```
Get-MgIdentityGovernancePrivilegedAccessGroupAssignmentApprovalStage -ApprovalId <String>
 -ApprovalStageId <String> [-ExpandProperty <String[]>] [-Property <String[]>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgIdentityGovernancePrivilegedAccessGroupAssignmentApprovalStage -InputObject <IIdentityGovernanceIdentity>
