...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/get-mgentitlementmanagementresourcerolescoperoleresourcescoperesourcerole
schema: 2.0.0
---
...
```
Get-MgEntitlementManagementResourceRoleScopeRoleResourceScopeResourceRole
 -AccessPackageResourceRoleScopeId <String> -AccessPackageResourceScopeId <String> [-ExpandProperty <String[]>]
...
### Get
```
Get-MgEntitlementManagementResourceRoleScopeRoleResourceScopeResourceRole -AccessPackageResourceRoleId <String>
 -AccessPackageResourceRoleScopeId <String> -AccessPackageResourceScopeId <String> [-ExpandProperty <String[]>]
