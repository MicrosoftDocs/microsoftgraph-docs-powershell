...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/new-mgentitlementmanagementaccesspackagesuggestion
Locale: en-US
Module Name: Microsoft.Graph.Identity.Governance
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: New-MgEntitlementManagementAccessPackageSuggestion
---

# New-MgEntitlementManagementAccessPackageSuggestion
...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaEntitlementManagementAccessPackageSuggestion](/powershell/module/Microsoft.Graph.Beta.Identity.Governance/New-MgBetaEntitlementManagementAccessPackageSuggestion?view=graph-powershell-beta)
...
```
New-MgEntitlementManagementAccessPackageSuggestion [-ResponseHeadersVariable <string>]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphAvailableAccessPackage
DefaultValue: ''
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphAccessPackageSuggestion
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphAccessPackageSuggestionReason[]
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.PowerShell.Models.IMicrosoftGraphAccessPackageSuggestion
...
- [New-MgEntitlementManagementAccessPackageSuggestion](https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/new-mgentitlementmanagementaccesspackagesuggestion)
