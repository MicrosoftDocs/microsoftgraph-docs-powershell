...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaBetaAgreement](/powershell/module/Microsoft.Graph.Beta.Identity.Governance/Update-MgBetaAgreement?view=graph-powershell-beta)
...
### Update
```
Update-MgAgreement -AgreementId <String> -BodyParameter <IMicrosoftGraphAgreement> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgBetaBetaAgreement](/powershell/module/Microsoft.Graph.Beta.Identity.Governance/Update-MgBetaAgreement?view=graph-powershell-beta)
