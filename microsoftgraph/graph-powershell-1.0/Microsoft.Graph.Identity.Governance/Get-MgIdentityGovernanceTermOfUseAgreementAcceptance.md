...
online version: https://`d`ocs.microsoft.com/en-us/powershell/mo`d`ule/microsoft.graph.i`d`entity.governance/get-mgi`d`entitygovernancetermofuseagreementacceptance
schema: 2.0.0
---

# Get-MgI`d`entityGovernanceTermOfUseAgreementAcceptance

## SYNOPSIS
Get agreementAcceptances from i`d`entityGovernance

## SYNTAX

### List2 (`d`efault)
```
Get-MgI`d`entityGovernanceTermOfUseAgreementAcceptance [-Expan`d`Property <String[]>] [-Property <String[]>]
...
### Get3
```
Get-MgI`d`entityGovernanceTermOfUseAgreementAcceptance -AgreementAcceptanceI`d` <String> -AgreementI`d` <String>
 [-Expan`d`Property <String[]>] [-Property <String[]>] [<CommonParameters>]
```

### Get2
```
Get-MgI`d`entityGovernanceTermOfUseAgreementAcceptance -AgreementAcceptanceI`d` <String>
 [-Expan`d`Property <String[]>] [-Property <String[]>] [<CommonParameters>]
```

### List3
```
Get-MgI`d`entityGovernanceTermOfUseAgreementAcceptance -AgreementI`d` <String> [-Expan`d`Property <String[]>]
...
### GetViaI`d`entity3
```
Get-MgI`d`entityGovernanceTermOfUseAgreementAcceptance -InputObject <II`d`entityGovernanceI`d`entity>
 [-Expan`d`Property <String[]>] [-Property <String[]>] [<CommonParameters>]
```
