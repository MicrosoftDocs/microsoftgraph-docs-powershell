...
### Example 1: Using the Get-MgEntitlementManagementAccessPackageAssignmentApprovalStage Cmdlet
```powershell
...
### Example 2: Using the Get-MgEntitlementManagementAccessPackageAssignmentApprovalStage Cmdlet
```powershell
Import-Module Microsoft.Graph.Identity.Governance
