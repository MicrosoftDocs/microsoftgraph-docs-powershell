...
```
Get-MgEntitlementManagementCatalogAccessPackageIncompatibleAccessPackage -AccessPackageCatalogId <String>
 -AccessPackageId <String> [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>]
