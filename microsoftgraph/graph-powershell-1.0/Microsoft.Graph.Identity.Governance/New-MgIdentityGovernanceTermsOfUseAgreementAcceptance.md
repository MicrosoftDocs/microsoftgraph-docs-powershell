...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaBetaIdentityGovernanceTermsOfUseAgreementAcceptance](/powershell/module/Microsoft.Graph.Beta.Identity.Governance/New-MgBetaIdentityGovernanceTermsOfUseAgreementAcceptance?view=graph-powershell-beta)
...
### CreateExpanded1
```
New-MgIdentityGovernanceTermsOfUseAgreementAcceptance -AgreementId <String> [-AdditionalProperties <Hashtable>]
...
## RELATED LINKS
[New-MgBetaBetaIdentityGovernanceTermsOfUseAgreementAcceptance](/powershell/module/Microsoft.Graph.Beta.Identity.Governance/New-MgBetaIdentityGovernanceTermsOfUseAgreementAcceptance?view=graph-powershell-beta)
