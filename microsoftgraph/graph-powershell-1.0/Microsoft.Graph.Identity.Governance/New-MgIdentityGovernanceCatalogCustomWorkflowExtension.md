...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/new-mgidentitygovernancecatalogcustomworkflowextension
Locale: en-US
Module Name: Microsoft.Graph.Identity.Governance
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: New-MgIdentityGovernanceCatalogCustomWorkflowExtension
---

# New-MgIdentityGovernanceCatalogCustomWorkflowExtension
...
```
New-MgIdentityGovernanceCatalogCustomWorkflowExtension -AccessPackageCatalogId <string>
...
```
New-MgIdentityGovernanceCatalogCustomWorkflowExtension -InputObject <IIdentityGovernanceIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-AuthenticationConfiguration <hashtable>]
 [-ClientConfiguration <IMicrosoftGraphCustomExtensionClientConfiguration>] [-Description <string>]
 [-DisplayName <string>] [-EndpointConfiguration <hashtable>] [-Id <string>] [-Break]
...
- [New-MgIdentityGovernanceCatalogCustomWorkflowExtension](https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/new-mgidentitygovernancecatalogcustomworkflowextension)
