...
# Update-MgIdentityGovernanceAccessReviewUnified
...
```
Update-MgIdentityGovernanceAccessReviewUnified [-ResponseHeadersVariable <string>]
...
```
Update-MgIdentityGovernanceAccessReviewUnified -BodyParameter <IMicrosoftGraphUnifiedRoot>
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphUnifiedRoot
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
