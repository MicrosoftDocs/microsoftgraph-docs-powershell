...
Update-MgEntitlementManagementResourceRequestCatalogResourceRoleResource
 -AccessPackageResourceRequestId <string> -AccessPackageResourceRoleId <string>
 -AccessPackageResourceId <string> -BodyParameter <IMicrosoftGraphAccessPackageResource>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
Update-MgEntitlementManagementResourceRequestCatalogResourceRoleResource
 -AccessPackageResourceRequestId <string> -AccessPackageResourceRoleId <string>
 -AccessPackageResourceId <string> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
...
- [Update-MgEntitlementManagementResourceRequestCatalogResourceRoleResource](https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgentitlementmanagementresourcerequestcatalogresourceroleresource)
