...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/get-mgrolemanagementdirectoryroleassignmentscheduleinstance
Locale: en-US
Module Name: Microsoft.Graph.Identity.Governance
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: Get-MgRoleManagementDirectoryRoleAssignmentScheduleInstance
---
...
```
Get-MgRoleManagementDirectoryRoleAssignmentScheduleInstance [-ExpandProperty <string[]>]
...
- [Get-MgRoleManagementDirectoryRoleAssignmentScheduleInstance](https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/get-mgrolemanagementdirectoryroleassignmentscheduleinstance)
- [Graph API Reference](https://learn.microsoft.com/graph/api/unifiedroleassignmentscheduleinstance-get?view=graph-rest-1.0)
- [Graph API Reference](https://learn.microsoft.com/graph/api/rbacapplication-list-roleassignmentscheduleinstances?view=graph-rest-1.0)
