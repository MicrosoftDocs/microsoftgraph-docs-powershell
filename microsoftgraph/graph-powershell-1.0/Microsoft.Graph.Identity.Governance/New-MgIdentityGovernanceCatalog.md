...
# New-MgIdentityGovernanceCatalog
...
```
New-MgIdentityGovernanceCatalog [-ResponseHeadersVariable <string>]
...
```
New-MgIdentityGovernanceCatalog -BodyParameter <IMicrosoftGraphAccessPackageCatalog>
