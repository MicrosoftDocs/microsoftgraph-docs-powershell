...
### Example 1: Using the Get-MgEntitlementManagementAssignmentRequest Cmdlet
```powershell
...
### Example 2: Using the Get-MgEntitlementManagementAssignmentRequest Cmdlet
```powershell
Import-Module Microsoft.Graph.Identity.Governance
Get-MgEntitlementManagementAssignmentRequest -AccessPackageAssignmentRequestId $accessPackageAssignmentRequestId
```
...
### Example 3: Using the Get-MgEntitlementManagementAssignmentRequest Cmdlet
```powershell
Import-Module Microsoft.Graph.Identity.Governance
Get-MgEntitlementManagementAssignmentRequest
```
