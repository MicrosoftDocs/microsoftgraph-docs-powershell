...
```
Update-MgRoleManagementDirectory [-ResponseHeadersVariable <string>]
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgrolemanagementdirectory)
