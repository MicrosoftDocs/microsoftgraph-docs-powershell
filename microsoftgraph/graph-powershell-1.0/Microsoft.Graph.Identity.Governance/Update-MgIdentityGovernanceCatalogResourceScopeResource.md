...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgidentitygovernancecatalogresourcescoperesource
Locale: en-US
Module Name: Microsoft.Graph.Identity.Governance
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Update-MgIdentityGovernanceCatalogResourceScopeResource
---

# Update-MgIdentityGovernanceCatalogResourceScopeResource
...
```
Update-MgIdentityGovernanceCatalogResourceScopeResource -AccessPackageCatalogId <string>
...
```
Update-MgIdentityGovernanceCatalogResourceScopeResource -InputObject <IIdentityGovernanceIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-Attributes <IMicrosoftGraphAccessPackageResourceAttribute[]>] [-CreatedDateTime <datetime>]
 [-Description <string>] [-DisplayName <string>]
 [-Environment <IMicrosoftGraphAccessPackageResourceEnvironment>]
...
- [Update-MgIdentityGovernanceCatalogResourceScopeResource](https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgidentitygovernancecatalogresourcescoperesource)
