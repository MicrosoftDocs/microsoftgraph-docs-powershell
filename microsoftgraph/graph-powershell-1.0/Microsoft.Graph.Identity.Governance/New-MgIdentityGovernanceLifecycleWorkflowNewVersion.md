...
```
New-MgIdentityGovernanceLifecycleWorkflowNewVersion -WorkflowId <String> [-ResponseHeadersVariable <String>]
...
```yaml
Type: IPaths1Fqilt9IdentitygovernanceLifecycleworkflowsWorkflowsWorkflowIdMicrosoftGraphIdentitygovernanceCreatenewversionPostRequestbodyContentApplicationJsonSchema
