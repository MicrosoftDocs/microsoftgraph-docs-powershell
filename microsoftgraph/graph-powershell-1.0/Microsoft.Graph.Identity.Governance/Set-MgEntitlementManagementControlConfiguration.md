...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/set-mgentitlementmanagementcontrolconfiguration
Locale: en-US
Module Name: Microsoft.Graph.Identity.Governance
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Set-MgEntitlementManagementControlConfiguration
---

# Set-MgEntitlementManagementControlConfiguration
...
```
Set-MgEntitlementManagementControlConfiguration -ControlConfigurationId <string>
...
```
Set-MgEntitlementManagementControlConfiguration -InputObject <IIdentityGovernanceIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-CreatedBy <string>]
 [-CreatedDateTime <datetime>] [-Id <string>] [-IsEnabled] [-ModifiedBy <string>]
 [-ModifiedDateTime <datetime>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
...
- [Set-MgEntitlementManagementControlConfiguration](https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/set-mgentitlementmanagementcontrolconfiguration)
