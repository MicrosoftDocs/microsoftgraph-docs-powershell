...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgidentitygovernancecatalogresourceuploadsession
Locale: en-US
Module Name: Microsoft.Graph.Identity.Governance
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Update-MgIdentityGovernanceCatalogResourceUploadSession
---

# Update-MgIdentityGovernanceCatalogResourceUploadSession
...
```
Update-MgIdentityGovernanceCatalogResourceUploadSession -AccessPackageCatalogId <string>
...
```
Update-MgIdentityGovernanceCatalogResourceUploadSession -InputObject <IIdentityGovernanceIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-CreatedDateTime <datetime>] [-Data <hashtable>]
 [-Files <IMicrosoftGraphCustomDataProvidedResourceFile[]>] [-Id <string>] [-IsUploadDone]
 [-ReferenceId <string>] [-Stats <IMicrosoftGraphCustomDataProvidedResourceUploadStats>]
