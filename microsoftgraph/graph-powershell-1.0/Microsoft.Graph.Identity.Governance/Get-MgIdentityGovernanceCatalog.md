...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/get-mgidentitygovernancecatalog
Locale: en-US
Module Name: Microsoft.Graph.Identity.Governance
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Get-MgIdentityGovernanceCatalog
---

# Get-MgIdentityGovernanceCatalog
...
```
Get-MgIdentityGovernanceCatalog [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgIdentityGovernanceCatalog -AccessPackageCatalogId <string> [-ExpandProperty <string[]>]
...
```
Get-MgIdentityGovernanceCatalog -InputObject <IIdentityGovernanceIdentity>
...
- [Get-MgIdentityGovernanceCatalog](https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/get-mgidentitygovernancecatalog)
