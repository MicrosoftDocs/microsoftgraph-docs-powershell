...
# Clear-MgIdentityGovernanceLifecycleWorkflowQuarantine
...
```
Clear-MgIdentityGovernanceLifecycleWorkflowQuarantine -WorkflowId <string>
...
```
Clear-MgIdentityGovernanceLifecycleWorkflowQuarantine -InputObject <IIdentityGovernanceIdentity>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
