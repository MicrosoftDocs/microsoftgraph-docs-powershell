...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/new-mgentitlementmanagementcatalogresourceuploadsession
Locale: en-US
Module Name: Microsoft.Graph.Identity.Governance
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: New-MgEntitlementManagementCatalogResourceUploadSession
---

# New-MgEntitlementManagementCatalogResourceUploadSession

## SYNOPSIS

Create a customDataProvidedResourceUploadSession object.
Only one upload session is allowed per reference instance (for example, access review instance) and accessPackageResource pair.
...
```
New-MgEntitlementManagementCatalogResourceUploadSession -AccessPackageCatalogId <string>
...
```
New-MgEntitlementManagementCatalogResourceUploadSession -InputObject <IIdentityGovernanceIdentity>
...
- [New-MgEntitlementManagementCatalogResourceUploadSession](https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/new-mgentitlementmanagementcatalogresourceuploadsession)
- [Graph API Reference](https://learn.microsoft.com/graph/api/accesspackageresource-post-uploadsessions?view=graph-rest-1.0)
