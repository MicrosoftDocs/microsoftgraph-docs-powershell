...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgentitlementmanagementaccesspackagesuggestion
Locale: en-US
Module Name: Microsoft.Graph.Identity.Governance
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Update-MgEntitlementManagementAccessPackageSuggestion
---

# Update-MgEntitlementManagementAccessPackageSuggestion
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaEntitlementManagementAccessPackageSuggestion](/powershell/module/Microsoft.Graph.Beta.Identity.Governance/Update-MgBetaEntitlementManagementAccessPackageSuggestion?view=graph-powershell-beta)
...
```
Update-MgEntitlementManagementAccessPackageSuggestion -AccessPackageSuggestionId <string>
...
```
Update-MgEntitlementManagementAccessPackageSuggestion -InputObject <IIdentityGovernanceIdentity>
 [-ResponseHeadersVariable <string>] [-AccessPackage <IMicrosoftGraphAvailableAccessPackage>]
 [-AdditionalProperties <hashtable>] [-Id <string>]
 [-Reasons <IMicrosoftGraphAccessPackageSuggestionReason[]>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
...
- [Update-MgEntitlementManagementAccessPackageSuggestion](https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgentitlementmanagementaccesspackagesuggestion)
