...
Update-MgIdentityGovernanceAppConsentRequestUserConsentRequestApproval -AppConsentRequestId <String>
 ...
 [-Stages <IMicrosoftGraphApprovalStage[]>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>]
...
```
Update-MgIdentityGovernanceAppConsentRequestUserConsentRequestApproval -AppConsentRequestId <String>
 -UserConsentRequestId <String> -BodyParameter <IMicrosoftGraphApproval> [-Headers <IDictionary>]
