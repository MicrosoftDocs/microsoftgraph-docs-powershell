...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgidentitygovernancecatalogresourceroleresource
Locale: en-US
Module Name: Microsoft.Graph.Identity.Governance
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Update-MgIdentityGovernanceCatalogResourceRoleResource
---

# Update-MgIdentityGovernanceCatalogResourceRoleResource
...
```
Update-MgIdentityGovernanceCatalogResourceRoleResource -AccessPackageCatalogId <string>
 -AccessPackageResourceRoleId <string> [-ResponseHeadersVariable <string>] [-Break]
...
```
Update-MgIdentityGovernanceCatalogResourceRoleResource -InputObject <IIdentityGovernanceIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-Attributes <IMicrosoftGraphAccessPackageResourceAttribute[]>] [-CreatedDateTime <datetime>]
 [-Description <string>] [-DisplayName <string>]
 [-Environment <IMicrosoftGraphAccessPackageResourceEnvironment>]
...
- [Update-MgIdentityGovernanceCatalogResourceRoleResource](https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgidentitygovernancecatalogresourceroleresource)
