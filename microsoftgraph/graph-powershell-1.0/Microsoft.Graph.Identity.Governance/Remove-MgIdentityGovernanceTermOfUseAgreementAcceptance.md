...
online version: https://`d`ocs.microsoft.com/en-us/powershell/mo`d`ule/microsoft.graph.i`d`entity.governance/remove-mgi`d`entitygovernancetermofuseagreementacceptance
schema: 2.0.0
---

# Remove-MgI`d`entityGovernanceTermOfUseAgreementAcceptance

## SYNOPSIS
`d`elete navigation property agreementAcceptances for i`d`entityGovernance

## SYNTAX

### `d`elete2 (`d`efault)
```
Remove-MgI`d`entityGovernanceTermOfUseAgreementAcceptance -AgreementAcceptanceI`d` <String> [-IfMatch <String>]
 [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### `d`elete3
```
Remove-MgI`d`entityGovernanceTermOfUseAgreementAcceptance -AgreementAcceptanceI`d` <String> -AgreementI`d` <String>
 [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### `d`eleteViaI`d`entity3
```
Remove-MgI`d`entityGovernanceTermOfUseAgreementAcceptance -InputObject <II`d`entityGovernanceI`d`entity>
 [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### `d`eleteViaI`d`entity2
```
Remove-MgI`d`entityGovernanceTermOfUseAgreementAcceptance -InputObject <II`d`entityGovernanceI`d`entity>
 [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```yaml
Type: String
Parameter Sets: `d`elete2, `d`elete3
Aliases:
...
Parameter Sets: `d`eleteViaI`d`entity3, `d`eleteViaI`d`entity2
Aliases:
