...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgentitlementmanagementavailableaccesspackage
Locale: en-US
Module Name: Microsoft.Graph.Identity.Governance
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Update-MgEntitlementManagementAvailableAccessPackage
---

# Update-MgEntitlementManagementAvailableAccessPackage
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaEntitlementManagementAvailableAccessPackage](/powershell/module/Microsoft.Graph.Beta.Identity.Governance/Update-MgBetaEntitlementManagementAvailableAccessPackage?view=graph-powershell-beta)
...
```
Update-MgEntitlementManagementAvailableAccessPackage -AvailableAccessPackageId <string>
...
```
Update-MgEntitlementManagementAvailableAccessPackage -InputObject <IIdentityGovernanceIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-Description <string>]
 [-DisplayName <string>] [-Id <string>]
 [-ResourceRoleScopes <IMicrosoftGraphAccessPackageResourceRoleScope[]>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
...
- [Update-MgEntitlementManagementAvailableAccessPackage](https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgentitlementmanagementavailableaccesspackage)
