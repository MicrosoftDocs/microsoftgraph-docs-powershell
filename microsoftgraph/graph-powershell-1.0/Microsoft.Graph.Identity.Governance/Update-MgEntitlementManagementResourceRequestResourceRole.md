...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgentitlementmanagementresourcerequestresourcerole
schema: 2.0.0
---
...
```
Update-MgEntitlementManagementResourceRequestResourceRole -AccessPackageResourceRequestId <String>
 -AccessPackageResourceRoleId <String> [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>]
...
```
Update-MgEntitlementManagementResourceRequestResourceRole -AccessPackageResourceRequestId <String>
 -AccessPackageResourceRoleId <String> -BodyParameter <IMicrosoftGraphAccessPackageResourceRole>
...
```
Update-MgEntitlementManagementResourceRequestResourceRole -InputObject <IIdentityGovernanceIdentity>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgentitlementmanagementresourcerequestresourcerole](https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgentitlementmanagementresourcerequestresourcerole)
