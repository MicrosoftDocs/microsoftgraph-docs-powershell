...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaEntitlementManagementCatalogCustomWorkflowExtension](/powershell/module/Microsoft.Graph.Beta.Identity.Governance/Update-MgBetaEntitlementManagementCatalogCustomWorkflowExtension?view=graph-powershell-beta)
...
```
Update-MgEntitlementManagementCatalogCustomWorkflowExtension -AccessPackageCatalogId <String>
 -CustomCalloutExtensionId <String> -BodyParameter <IMicrosoftGraphCustomCalloutExtension> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgBetaEntitlementManagementCatalogCustomWorkflowExtension](/powershell/module/Microsoft.Graph.Beta.Identity.Governance/Update-MgBetaEntitlementManagementCatalogCustomWorkflowExtension?view=graph-powershell-beta)
