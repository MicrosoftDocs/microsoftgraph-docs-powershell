...
# Update-MgIdentityGovernanceAccessReviewUnifiedDecision
...
```
Update-MgIdentityGovernanceAccessReviewUnifiedDecision -AccessReviewInstanceDecisionItemId <string>
...
```
Update-MgIdentityGovernanceAccessReviewUnifiedDecision -InputObject <IIdentityGovernanceIdentity>
 [-ResponseHeadersVariable <string>] [-AccessReviewId <string>] [-AdditionalProperties <hashtable>]
 [-AppliedBy <IMicrosoftGraphUserIdentity>] [-AppliedDateTime <datetime>]
 [-ApplyDescription <string>] [-ApplyResult <string>] [-Decision <string>] [-Id <string>]
 [-Insights <IMicrosoftGraphGovernanceInsight[]>] [-Justification <string>]
...
- [Update-MgIdentityGovernanceAccessReviewUnifiedDecision](https://learn.microsoft.com/powershell/module/microsoft.graph.identity.governance/update-mgidentitygovernanceaccessreviewunifieddecision)
