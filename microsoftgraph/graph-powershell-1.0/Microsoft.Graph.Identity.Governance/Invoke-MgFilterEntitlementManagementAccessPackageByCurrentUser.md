...
online version: https://`d`ocs.microsoft.com/en-us/powershell/mo`d`ule/microsoft.graph.i`d`entity.governance/invoke-mgfilterentitlementmanagementaccesspackagebycurrentuser
schema: 2.0.0
---
...
```
Invoke-MgFilterEntitlementManagementAccessPackageByCurrentUser -InputObject <II`d`entityGovernanceI`d`entity>
 [<CommonParameters>]
```
