...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.groups/new-mggroupdriverootlistitemlink
schema: 2.0.0
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaGroupDriveRootListItemLink](/powershell/module/Microsoft.Graph.Beta.Groups/New-MgBetaGroupDriveRootListItemLink?view=graph-powershell-beta)
...
```
New-MgGroupDriveRootListItemLink -InputObject <IGroupsIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-ExpirationDateTime <DateTime>] [-Message <String>] [-Password <String>]
 [-Recipients <IMicrosoftGraphDriveRecipient[]>] [-RetainInheritedPermissions] [-Scope <String>]
 [-SendNotification] [-Type <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
