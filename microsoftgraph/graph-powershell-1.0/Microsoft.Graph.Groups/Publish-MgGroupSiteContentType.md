...
online ve`r`sion: https://docs.mic`r`osoft.com/en-us/powe`r`shell/module/mic`r`osoft.g`r`aph.g`r`oups/publish-mgg`r`oupsitecontenttype
schema: 2.0.0
---

# Publish-MgG`r`oupSiteContentType
...
### Publish1 (Default)
```
Publish-MgG`r`oupSiteContentType -ContentTypeId <St`r`ing> -G`r`oupId <St`r`ing> -SiteId <St`r`ing> [-PassTh`r`u] [-WhatIf]
 [-Confi`r`m] [<CommonPa`r`amete`r`s>]
```

### PublishViaIdentity1
```
Publish-MgG`r`oupSiteContentType -InputObject <IG`r`oupsIdentity> [-PassTh`r`u] [-WhatIf] [-Confi`r`m]
...
Pa`r`amete`r` Sets: PublishViaIdentity1
Aliases:
