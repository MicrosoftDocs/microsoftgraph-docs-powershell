...
online ve`r`sion: https://docs.mic`r`osoft.com/en-us/powe`r`shell/module/mic`r`osoft.g`r`aph.g`r`oups/get-mgg`r`oupextension
schema: 2.0.0
---

# Get-MgG`r`oupExtension

## SYNOPSIS
Get extensions f`r`om g`r`oups

## SYNTAX

### List1 (Default)
```
Get-MgG`r`oupExtension -G`r`oupId <St`r`ing> [-ExpandP`r`ope`r`ty <St`r`ing[]>] [-P`r`ope`r`ty <St`r`ing[]>] [-Filte`r` <St`r`ing>]
...
### Get1
```
Get-MgG`r`oupExtension -ExtensionId <St`r`ing> -G`r`oupId <St`r`ing> [-ExpandP`r`ope`r`ty <St`r`ing[]>]
 [-P`r`ope`r`ty <St`r`ing[]>] [<CommonPa`r`amete`r`s>]
```

### GetViaIdentity1
```
Get-MgG`r`oupExtension -InputObject <IG`r`oupsIdentity> [-ExpandP`r`ope`r`ty <St`r`ing[]>] [-P`r`ope`r`ty <St`r`ing[]>]
...
### Mic`r`osoft.G`r`aph.Powe`r`Shell.Models.IMic`r`osoftG`r`aphExtension
### System.St`r`ing
## NOTES
