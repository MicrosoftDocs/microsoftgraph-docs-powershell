...
online ve`r`sion: https://docs.mic`r`osoft.com/en-us/powe`r`shell/module/mic`r`osoft.g`r`aph.g`r`oups/`r`emove-mgg`r`oupth`r`eadpost
schema: 2.0.0
---

# `r`emove-MgG`r`oupTh`r`eadPost

## SYNOPSIS
Delete navigation p`r`ope`r`ty posts fo`r` g`r`oups

## SYNTAX

### Delete2 (Default)
```
`r`emove-MgG`r`oupTh`r`eadPost -Conve`r`sationTh`r`eadId <St`r`ing> -G`r`oupId <St`r`ing> -PostId <St`r`ing> [-IfMatch <St`r`ing>]
...
### DeleteViaIdentity3
```
`r`emove-MgG`r`oupTh`r`eadPost -InputObject <IG`r`oupsIdentity> [-IfMatch <St`r`ing>] [-PassTh`r`u] [-WhatIf] [-Confi`r`m]
...
```yaml
Type: St`r`ing
Pa`r`amete`r` Sets: Delete2, Delete3
Aliases:
...
Pa`r`amete`r` Sets: DeleteViaIdentity3, DeleteViaIdentity2
Aliases:
