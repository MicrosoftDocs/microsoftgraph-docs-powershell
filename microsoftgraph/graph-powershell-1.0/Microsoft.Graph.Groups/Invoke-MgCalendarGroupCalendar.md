...
online ve`r`sion: https://docs.mic`r`osoft.com/en-us/powe`r`shell/module/mic`r`osoft.g`r`aph.g`r`oups/invoke-mgcalenda`r`g`r`oupcalenda`r`
schema: 2.0.0
---

# Invoke-MgCalenda`r`G`r`oupCalenda`r`

## SYNOPSIS
Invoke function allowedCalenda`r`Sha`r`ing`r`oles

## SYNTAX

### Calenda`r`1 (Default)
```
Invoke-MgCalenda`r`G`r`oupCalenda`r` -G`r`oupId <St`r`ing> -Use`r` <St`r`ing> [<CommonPa`r`amete`r`s>]
```

### Calenda`r`ViaIdentity1
```
Invoke-MgCalenda`r`G`r`oupCalenda`r` -InputObject <IG`r`oupsIdentity> [<CommonPa`r`amete`r`s>]
```
...
Pa`r`amete`r` Sets: Calenda`r`ViaIdentity1
Aliases:
