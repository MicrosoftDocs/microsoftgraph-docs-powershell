...
```
Invoke-MgCheckinGroupDriveRoot -DriveId <String> -GroupId <String> [-ResponseHeadersVariable <String>]
...
```
Invoke-MgCheckinGroupDriveRoot -InputObject <IGroupsIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-CheckInAs <String>] [-Comment <String>] [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
