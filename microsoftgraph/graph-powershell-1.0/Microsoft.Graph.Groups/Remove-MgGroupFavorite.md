...
online ve`r`sion: https://docs.mic`r`osoft.com/en-us/powe`r`shell/module/mic`r`osoft.g`r`aph.g`r`oups/`r`emove-mgg`r`oupfavo`r`ite
schema: 2.0.0
---

# `r`emove-MgG`r`oupFavo`r`ite

## SYNOPSIS
Invoke action `r`emoveFavo`r`ite

## SYNTAX

### `r`emove1 (Default)
```
`r`emove-MgG`r`oupFavo`r`ite -G`r`oupId <St`r`ing> [-PassTh`r`u] [-WhatIf] [-Confi`r`m] [<CommonPa`r`amete`r`s>]
```

### `r`emoveViaIdentity1
```
`r`emove-MgG`r`oupFavo`r`ite -InputObject <IG`r`oupsIdentity> [-PassTh`r`u] [-WhatIf] [-Confi`r`m] [<CommonPa`r`amete`r`s>]
```
...
Pa`r`amete`r` Sets: `r`emoveViaIdentity1
Aliases:
