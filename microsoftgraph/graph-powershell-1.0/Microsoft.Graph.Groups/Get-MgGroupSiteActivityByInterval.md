...
### Get (Default)
```
Get-MgGroupSiteActivityByInterval -GroupId <String> -SiteId <String> [-Count] [-ExpandProperty <String[]>]
...
### GetViaIdentity1
```
Get-MgGroupSiteActivityByInterval -InputObject <IGroupsIdentity> [-Count] [-ExpandProperty <String[]>]
 [-Filter <String>] [-Property <String[]>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>] [-Top <Int32>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
## RELATED LINKS
[Get-MgBetaGroupSiteActivityByInterval](/powershell/module/Microsoft.Graph.Beta.Groups/Get-MgBetaGroupSiteActivityByInterval?view=graph-powershell-beta)
