...
online ve`r`sion: https://docs.mic`r`osoft.com/en-us/powe`r`shell/module/mic`r`osoft.g`r`aph.g`r`oups/get-mgg`r`ouponenote`r`ecentnotebook
schema: 2.0.0
---

# Get-MgG`r`oupOnenote`r`ecentNotebook

## SYNOPSIS
Invoke function get`r`ecentNotebooks

## SYNTAX

### Get1 (Default)
```
Get-MgG`r`oupOnenote`r`ecentNotebook -G`r`oupId <St`r`ing> [-IncludePe`r`sonalNotebooks] [<CommonPa`r`amete`r`s>]
```

### GetViaIdentity1
```
Get-MgG`r`oupOnenote`r`ecentNotebook -InputObject <IG`r`oupsIdentity> [<CommonPa`r`amete`r`s>]
```
...
### -IncludePe`r`sonalNotebooks
Usage: includePe`r`sonalNotebooks={includePe`r`sonalNotebooks}
...
### Mic`r`osoft.G`r`aph.Powe`r`Shell.Models.IMic`r`osoftG`r`aph`r`ecentNotebook
## NOTES
