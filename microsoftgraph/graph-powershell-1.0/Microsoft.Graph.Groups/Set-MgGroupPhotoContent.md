...
### Set (Default)
```
Set-MgGroupPhotoContent -GroupId <String> [-Data <Stream>] [-ResponseHeadersVariable <String>] -InFile <String>
...
### Set1
```
Set-MgGroupPhotoContent -GroupId <String> -ProfilePhotoId <String> [-Data <Stream>]
...
### SetViaIdentity1
```
Set-MgGroupPhotoContent -InputObject <IGroupsIdentity> [-Data <Stream>] [-ResponseHeadersVariable <String>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.groups/set-mggroupphotocontent](https://learn.microsoft.com/powershell/module/microsoft.graph.groups/set-mggroupphotocontent)
