...
### Set (Default)
```
Set-MgGroupPhotoContent -GroupId <String> [-Data <Stream>] -InFile <String> [-ContentType <String>]
...
### SetViaIdentity1
```
Set-MgGroupPhotoContent -InputObject <IGroupsIdentity> [-Data <Stream>] -InFile <String>
 [-ContentType <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
