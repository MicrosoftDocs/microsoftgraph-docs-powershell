...
online ve`r`sion: https://docs.mic`r`osoft.com/en-us/powe`r`shell/module/mic`r`osoft.g`r`aph.g`r`oups/get-mgg`r`oupc`r`eatedonbehalfof
schema: 2.0.0
---

# Get-MgG`r`oupC`r`eatedOnBehalfOf

## SYNOPSIS
Get c`r`eatedOnBehalfOf f`r`om g`r`oups

## SYNTAX

### Get1 (Default)
```
Get-MgG`r`oupC`r`eatedOnBehalfOf -G`r`oupId <St`r`ing> [-ExpandP`r`ope`r`ty <St`r`ing[]>] [-P`r`ope`r`ty <St`r`ing[]>]
 [<CommonPa`r`amete`r`s>]
```

### GetViaIdentity1
```
Get-MgG`r`oupC`r`eatedOnBehalfOf -InputObject <IG`r`oupsIdentity> [-ExpandP`r`ope`r`ty <St`r`ing[]>] [-P`r`ope`r`ty <St`r`ing[]>]
 [<CommonPa`r`amete`r`s>]
```
