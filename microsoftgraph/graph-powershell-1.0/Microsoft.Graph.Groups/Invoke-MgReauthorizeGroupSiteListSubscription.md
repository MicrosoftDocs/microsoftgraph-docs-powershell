...
Invoke-MgReauthorizeGroupSiteListSubscription -GroupId <String> -ListId <String> -SiteId <String>
 -SubscriptionId <String> [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### ReauthorizeViaIdentity
```
Invoke-MgReauthorizeGroupSiteListSubscription -InputObject <IGroupsIdentity> [-Headers <IDictionary>]
