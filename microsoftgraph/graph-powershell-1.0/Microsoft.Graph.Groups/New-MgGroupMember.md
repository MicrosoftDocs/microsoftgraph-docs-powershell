...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaGroupMember](/powershell/module/Microsoft.Graph.Beta.Applications/New-MgBetaGroupMember?view=graph-powershell-beta)
...
### Create1
```
New-MgGroupMember -GroupId <String> -BodyParameter <Hashtable> [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### CreateViaIdentity
```
New-MgGroupMember -InputObject <IGroupsIdentity> -BodyParameter <Hashtable> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
## RELATED LINKS
[New-MgBetaGroupMember](/powershell/module/Microsoft.Graph.Beta.Applications/New-MgBetaGroupMember?view=graph-powershell-beta)
