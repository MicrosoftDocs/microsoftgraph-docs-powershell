...
online ve`r`sion: https://docs.mic`r`osoft.com/en-us/powe`r`shell/module/mic`r`osoft.g`r`aph.g`r`oups/get-mgg`r`oupth`r`eadpost
schema: 2.0.0
---

# Get-MgG`r`oupTh`r`eadPost

## SYNOPSIS
Get posts f`r`om g`r`oups

## SYNTAX

### List1 (Default)
```
Get-MgG`r`oupTh`r`eadPost -Conve`r`sationTh`r`eadId <St`r`ing> -G`r`oupId <St`r`ing> [-ExpandP`r`ope`r`ty <St`r`ing[]>]
...
### Get3
```
Get-MgG`r`oupTh`r`eadPost -Conve`r`sationTh`r`eadId <St`r`ing> -G`r`oupId <St`r`ing> -PostId <St`r`ing>
...
### GetViaIdentity3
```
Get-MgG`r`oupTh`r`eadPost -InputObject <IG`r`oupsIdentity> [-ExpandP`r`ope`r`ty <St`r`ing[]>] [-P`r`ope`r`ty <St`r`ing[]>]
...
```yaml
Type: St`r`ing
Pa`r`amete`r` Sets: List1, Get3, Get2
Aliases:
