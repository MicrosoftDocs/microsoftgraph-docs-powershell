...
```
Get-MgGroupThreadPost -InputObject <IGroupsIdentity> [-ExpandProperty <string[]>]
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.groups/get-mggroupthreadpost)
