...
online ve`r`sion: https://docs.mic`r`osoft.com/en-us/powe`r`shell/module/mic`r`osoft.g`r`aph.g`r`oups/get-mgg`r`oupcalenda`r`eventdelta
schema: 2.0.0
---

# Get-MgG`r`oupCalenda`r`EventDelta
...
### Delta1 (Default)
```
Get-MgG`r`oupCalenda`r`EventDelta -G`r`oupId <St`r`ing> [<CommonPa`r`amete`r`s>]
```

### DeltaViaIdentity1
```
Get-MgG`r`oupCalenda`r`EventDelta -InputObject <IG`r`oupsIdentity> [<CommonPa`r`amete`r`s>]
```
...
Pa`r`amete`r` Sets: DeltaViaIdentity1
Aliases:
...
### Mic`r`osoft.G`r`aph.Powe`r`Shell.Models.IMic`r`osoftG`r`aphEvent1
## NOTES
