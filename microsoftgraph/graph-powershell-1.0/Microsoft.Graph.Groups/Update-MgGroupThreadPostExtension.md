...
```
Update-MgGroupThreadPostExtension -InputObject <IGroupsIdentity> [-ResponseHeadersVariable <String>]
...
### UpdateViaIdentity
```
Update-MgGroupThreadPostExtension -InputObject <IGroupsIdentity> -BodyParameter <Hashtable>
