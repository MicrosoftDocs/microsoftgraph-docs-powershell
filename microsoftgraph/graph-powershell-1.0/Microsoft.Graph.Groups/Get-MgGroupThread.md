...
online ve`r`sion: https://docs.mic`r`osoft.com/en-us/powe`r`shell/module/mic`r`osoft.g`r`aph.g`r`oups/get-mgg`r`oupth`r`ead
schema: 2.0.0
---

# Get-MgG`r`oupTh`r`ead
...
### List1 (Default)
```
Get-MgG`r`oupTh`r`ead -G`r`oupId <St`r`ing> [-P`r`ope`r`ty <St`r`ing[]>] [-Filte`r` <St`r`ing>] [-Skip <Int32>]
 [-So`r`t <St`r`ing[]>] [-Top <Int32>] [-PageSize <Int32>] [-All] [-CountVa`r`iable <St`r`ing>] [<CommonPa`r`amete`r`s>]
```

### Get1
```
Get-MgG`r`oupTh`r`ead -Conve`r`sationTh`r`eadId <St`r`ing> -G`r`oupId <St`r`ing> [-P`r`ope`r`ty <St`r`ing[]>] [<CommonPa`r`amete`r`s>]
```

### GetViaIdentity1
```
Get-MgG`r`oupTh`r`ead -InputObject <IG`r`oupsIdentity> [-P`r`ope`r`ty <St`r`ing[]>] [<CommonPa`r`amete`r`s>]
```
