...
online ve`r`sion: https://docs.mic`r`osoft.com/en-us/powe`r`shell/module/mic`r`osoft.g`r`aph.g`r`oups/get-mgg`r`oupsitecontenttypecompatiblehubcontenttype
schema: 2.0.0
---

# Get-MgG`r`oupSiteContentTypeCompatibleHubContentType
...
### Get1 (Default)
```
Get-MgG`r`oupSiteContentTypeCompatibleHubContentType -G`r`oupId <St`r`ing> -SiteId <St`r`ing> [<CommonPa`r`amete`r`s>]
```

### GetViaIdentity1
```
Get-MgG`r`oupSiteContentTypeCompatibleHubContentType -InputObject <IG`r`oupsIdentity> [<CommonPa`r`amete`r`s>]
```
