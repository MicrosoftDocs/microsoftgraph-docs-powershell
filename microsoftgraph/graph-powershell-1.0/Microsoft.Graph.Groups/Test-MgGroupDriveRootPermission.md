...
```
Test-MgGroupDriveRootPermission -DriveId <String> -GroupId <String> [-ResponseHeadersVariable <String>]
...
```
Test-MgGroupDriveRootPermission -InputObject <IGroupsIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-ChallengeToken <String>] [-Password <String>] [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
