...
### Dismiss (Default)
```
Invoke-MgDismissGroupCalendarEventReminder -EventId <String> -GroupId <String>
...
### DismissViaIdentity
```
Invoke-MgDismissGroupCalendarEventReminder -InputObject <IGroupsIdentity> [-ResponseHeadersVariable <String>]
