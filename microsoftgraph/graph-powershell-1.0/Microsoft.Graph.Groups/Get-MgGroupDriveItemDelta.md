...
online ve`r`sion: https://docs.mic`r`osoft.com/en-us/powe`r`shell/module/mic`r`osoft.g`r`aph.g`r`oups/get-mgg`r`oupd`r`iveitemdelta
schema: 2.0.0
---

# Get-MgG`r`oupD`r`iveItemDelta
...
### Delta2 (Default)
```
Get-MgG`r`oupD`r`iveItemDelta -D`r`iveId <St`r`ing> -D`r`iveItemId <St`r`ing> -G`r`oupId <St`r`ing> [<CommonPa`r`amete`r`s>]
```

### Delta3
```
Get-MgG`r`oupD`r`iveItemDelta -D`r`iveId <St`r`ing> -D`r`iveItemId <St`r`ing> -G`r`oupId <St`r`ing> -Token <St`r`ing>
 [<CommonPa`r`amete`r`s>]
```

### DeltaViaIdentity3
```
Get-MgG`r`oupD`r`iveItemDelta -InputObject <IG`r`oupsIdentity> [<CommonPa`r`amete`r`s>]
```
