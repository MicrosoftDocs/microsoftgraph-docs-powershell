...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.groups/get-mggroupdrivelistitemdelta
schema: 2.0.0
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaGroupDriveListItemDelta](/powershell/module/Microsoft.Graph.Beta.Groups/Get-MgBetaGroupDriveListItemDelta?view=graph-powershell-beta)
...
### DeltaViaIdentity1
```
Get-MgGroupDriveListItemDelta -InputObject <IGroupsIdentity> [-ExpandProperty <String[]>] [-Filter <String>]
