...
online ve`r`sion: https://docs.mic`r`osoft.com/en-us/powe`r`shell/module/mic`r`osoft.g`r`aph.g`r`oups/invoke-mgg`r`aphg`r`oup
schema: 2.0.0
---

# Invoke-MgG`r`aphG`r`oup

## SYNOPSIS
Invoke action unsubsc`r`ibeByMail

## SYNTAX

### G`r`aph1 (Default)
```
Invoke-MgG`r`aphG`r`oup -G`r`oupId <St`r`ing> [-PassTh`r`u] [-WhatIf] [-Confi`r`m] [<CommonPa`r`amete`r`s>]
```

### G`r`aphViaIdentity1
```
Invoke-MgG`r`aphG`r`oup -InputObject <IG`r`oupsIdentity> [-PassTh`r`u] [-WhatIf] [-Confi`r`m] [<CommonPa`r`amete`r`s>]
```
...
Pa`r`amete`r` Sets: G`r`aphViaIdentity1
Aliases:
