...
### Graph (Default)
```
Invoke-MgGraphGroup -GroupId <String> [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### GraphViaIdentity
```
Invoke-MgGraphGroup -InputObject <IGroupsIdentity> [-Headers <IDictionary>] [-PassThru]
