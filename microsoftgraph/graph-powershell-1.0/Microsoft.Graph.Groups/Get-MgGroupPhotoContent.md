...
```
Get-MgGroupPhotoContent -GroupId <string> -OutFile <string> [-ResponseHeadersVariable <string>]
...
```
Get-MgGroupPhotoContent -GroupId <string> -ProfilePhotoId <string> -OutFile <string>
...
```
Get-MgGroupPhotoContent -InputObject <IGroupsIdentity> -OutFile <string>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru]
 [-Proxy <uri>] [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [<CommonParameters>]
```
...
| --------------- | ------------------------------------------  |
| Delegated (work or school account) | Group.Read.All, ProfilePhoto.Read.All, ProfilePhoto.ReadWrite.All,  |
| Delegated (personal Microsoft account) | Not supported |
| Application | Group.Read.All, ProfilePhoto.Read.All, ProfilePhoto.ReadWrite.All,  |
