...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.groups/grant-mggroupsdrivesrootpermission
schema: 2.0.0
---

# Grant-MgGroupsDrivesRootPermission
...
```
Grant-MgGroupsDrivesRootPermission -DriveId <String> -GroupId <String> -PermissionId <String>
...
```
Grant-MgGroupsDrivesRootPermission -InputObject <IGroupsIdentity> [-AdditionalProperties <Hashtable>]
 [-Recipients <IMicrosoftGraphDriveRecipient[]>] [-Roles <String[]>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### GrantViaIdentity
```
Grant-MgGroupsDrivesRootPermission -InputObject <IGroupsIdentity>
 -BodyParameter <IPathsG3D749GroupsGroupIdDrivesDriveIdRootPermissionsPermissionIdMicrosoftGraphGrantPostRequestbodyContentApplicationJsonSchema>
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.groups/grant-mggroupsdrivesrootpermission](https://learn.microsoft.com/powershell/module/microsoft.graph.groups/grant-mggroupsdrivesrootpermission)
