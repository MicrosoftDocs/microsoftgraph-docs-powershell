...
online ve`r`sion: https://docs.mic`r`osoft.com/en-us/powe`r`shell/module/mic`r`osoft.g`r`aph.g`r`oups/get-mgg`r`oupd`r`iveitemactivitybyinte`r`val
schema: 2.0.0
---

# Get-MgG`r`oupD`r`iveItemActivityByInte`r`val
...
### Get1 (Default)
```
Get-MgG`r`oupD`r`iveItemActivityByInte`r`val -D`r`iveId <St`r`ing> -D`r`iveItemId <St`r`ing> -G`r`oupId <St`r`ing>
...
### GetViaIdentity2
```
Get-MgG`r`oupD`r`iveItemActivityByInte`r`val -InputObject <IG`r`oupsIdentity> [<CommonPa`r`amete`r`s>]
```
