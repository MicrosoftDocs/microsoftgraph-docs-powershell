...
```
New-MgGroupDriveItemListItemLink -InputObject <IGroupsIdentity> [-ResponseHeadersVariable <String>]
...
```yaml
Type: IPathsLngq9HGroupsGroupIdDrivesDriveIdItemsDriveitemIdListitemMicrosoftGraphCreatelinkPostRequestbodyContentApplicationJsonSchema
