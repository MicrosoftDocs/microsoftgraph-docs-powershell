...
online ve``r``sion: https://docs.mic``r``osoft.com/en-us/powe``r``shell/module/mic``r``osoft.g``r``aph.g``r``oups/new-mgg``r``oupd``r``iveitemlink
schema: 2.0.0
---

# New-MgG``r``oupD``r``iveItemLink
...
```
New-MgG``r``oupD``r``iveItemLink -D``r``iveId <St``r``ing> -D``r``iveItemId <St``r``ing> -G``r``oupId <St``r``ing>
 [-AdditionalP``r``ope``r``ties <Hashtable>] [-Expi``r``ationDateTime <DateTime>] [-Message <St``r``ing>] [-Passwo``r``d <St``r``ing>]
 [-``r``etainInhe``r``itedPe``r``missions] [-Scope <St``r``ing>] [-Type <St``r``ing>] [-WhatIf] [-Confi``r``m] [<CommonPa``r``amete``r``s>]
```

### C``r``eate1
```
New-MgG``r``oupD``r``iveItemLink -D``r``iveId <St``r``ing> -D``r``iveItemId <St``r``ing> -G``r``oupId <St``r``ing>
 -BodyPa``r``amete``r`` <IPaths13X0452G``r``oupsG``r``oupIdD``r``ivesD``r``iveIdItemsD``r``iveitemIdMic``r``osoftG``r``aphC``r``eatelinkPost``r``equestbodyContentApplicationJsonSchema>
 [-WhatIf] [-Confi``r``m] [<CommonPa``r``amete``r``s>]
```

### C``r``eateViaIdentityExpanded1
```
New-MgG``r``oupD``r``iveItemLink -InputObject <IG``r``oupsIdentity> [-AdditionalP``r``ope``r``ties <Hashtable>]
...
```
New-MgG``r``oupD``r``iveItemLink -InputObject <IG``r``oupsIdentity>
 -BodyPa``r``amete``r`` <IPaths13X0452G``r``oupsG``r``oupIdD``r``ivesD``r``iveIdItemsD``r``iveitemIdMic``r``osoftG``r``aphC``r``eatelinkPost``r``equestbodyContentApplicationJsonSchema>
 [-WhatIf] [-Confi``r``m] [<CommonPa``r``amete``r``s>]
```
...
```yaml
Type: IPaths13X0452G``r``oupsG``r``oupIdD``r``ivesD``r``iveIdItemsD``r``iveitemIdMic``r``osoftG``r``aphC``r``eatelinkPost``r``equestbodyContentApplicationJsonSchema
...
### Mic``r``osoft.G``r``aph.Powe``r``Shell.Models.IPaths13X0452G``r``oupsG``r``oupIdD``r``ivesD``r``iveIdItemsD``r``iveitemIdMic``r``osoftG``r``aphC``r``eatelinkPost``r``equestbodyContentApplicationJsonSchema
## OUTPUTS
