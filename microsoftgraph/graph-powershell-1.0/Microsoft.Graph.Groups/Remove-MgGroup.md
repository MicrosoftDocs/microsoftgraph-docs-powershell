...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.groups/remove-mggroup
Locale: en-US
Module Name: Microsoft.Graph.Groups
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: Remove-MgGroup
---
...
```
Remove-MgGroup -GroupId <string> [-IfMatch <string>] [-ResponseHeadersVariable <string>] [-Break]
...
```
Remove-MgGroup -InputObject <IGroupsIdentity> [-IfMatch <string>]
...
- [Remove-MgGroup](https://learn.microsoft.com/powershell/module/microsoft.graph.groups/remove-mggroup)
