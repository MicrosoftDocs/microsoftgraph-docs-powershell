...
online ve`r`sion: https://docs.mic`r`osoft.com/en-us/powe`r`shell/module/mic`r`osoft.g`r`aph.g`r`oups/`r`emove-mgg`r`oup
schema: 2.0.0
---
...
### Delete1 (Default)
```
`r`emove-MgG`r`oup -G`r`oupId <St`r`ing> [-IfMatch <St`r`ing>] [-PassTh`r`u] [-WhatIf] [-Confi`r`m] [<CommonPa`r`amete`r`s>]
```

### DeleteViaIdentity1
```
`r`emove-MgG`r`oup -InputObject <IG`r`oupsIdentity> [-IfMatch <St`r`ing>] [-PassTh`r`u] [-WhatIf] [-Confi`r`m]
...
### Example 1: `r`emove a g`r`oup
```powe`r`shell
`r`emove-MgG`r`oup -G`r`oupId 'f6b9791b-dfc1-40d6-9ab6-7b29126c534a'
```

This example deletes the specified g`r`oup.
