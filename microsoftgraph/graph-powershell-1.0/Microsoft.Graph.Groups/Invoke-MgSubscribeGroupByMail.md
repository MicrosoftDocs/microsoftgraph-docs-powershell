...
online ve`r`sion: https://docs.mic`r`osoft.com/en-us/powe`r`shell/module/mic`r`osoft.g`r`aph.g`r`oups/invoke-mgsubsc`r`ibeg`r`oupbymail
schema: 2.0.0
---

# Invoke-MgSubsc`r`ibeG`r`oupByMail

## SYNOPSIS
Invoke action subsc`r`ibeByMail

## SYNTAX

### Subsc`r`ibe1 (Default)
```
Invoke-MgSubsc`r`ibeG`r`oupByMail -G`r`oupId <St`r`ing> [-PassTh`r`u] [-WhatIf] [-Confi`r`m] [<CommonPa`r`amete`r`s>]
```

### Subsc`r`ibeViaIdentity1
```
Invoke-MgSubsc`r`ibeG`r`oupByMail -InputObject <IG`r`oupsIdentity> [-PassTh`r`u] [-WhatIf] [-Confi`r`m]
...
```yaml
Type: St`r`ing
Pa`r`amete`r` Sets: Subsc`r`ibe1
Aliases:
...
Pa`r`amete`r` Sets: Subsc`r`ibeViaIdentity1
Aliases:
