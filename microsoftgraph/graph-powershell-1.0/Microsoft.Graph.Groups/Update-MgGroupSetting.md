...
Update-MgGroupSetting -GroupSettingId <String> [-AdditionalProperties <Hashtable>] [-DisplayName <String>]
 [-Id <String>] [-TemplateId <String>] [-Values <IMicrosoftGraphSettingValue[]>] [-PassThru] [-WhatIf]
...
Parameter Sets: Update1, Update2, UpdateViaIdentity2, UpdateViaIdentity1
Aliases:
...
```yaml
Type: String
Parameter Sets: UpdateExpanded2, UpdateExpanded1, Update1, Update2
Aliases:
