...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaGroupSettingTemplateMemberObject](/powershell/module/Microsoft.Graph.Beta.Applications/Get-MgBetaGroupSettingTemplateMemberObject?view=graph-powershell-beta)

## SYNTAX

### GetExpanded (Default)
```
Get-MgGroupSettingTemplateMemberObject -GroupSettingTemplateId <String> [-AdditionalProperties <Hashtable>]
...
```
Get-MgGroupSettingTemplateMemberObject -InputObject <IGroupsIdentity> [-AdditionalProperties <Hashtable>]
 [-SecurityEnabledOnly] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
## RELATED LINKS
[Get-MgBetaGroupSettingTemplateMemberObject](/powershell/module/Microsoft.Graph.Beta.Applications/Get-MgBetaGroupSettingTemplateMemberObject?view=graph-powershell-beta)
