...
online ve`r`sion: https://docs.mic`r`osoft.com/en-us/powe`r`shell/module/mic`r`osoft.g`r`aph.g`r`oups/get-mgg`r`oupth`r`eadpostin`r`eplytomultivalueextendedp`r`ope`r`ty
schema: 2.0.0
---

# Get-MgG`r`oupTh`r`eadPostIn`r`eplyToMultiValueExtendedP`r`ope`r`ty
...
### List1 (Default)
```
Get-MgG`r`oupTh`r`eadPostIn`r`eplyToMultiValueExtendedP`r`ope`r`ty -Conve`r`sationTh`r`eadId <St`r`ing> -G`r`oupId <St`r`ing>
...
### GetViaIdentity1
```
Get-MgG`r`oupTh`r`eadPostIn`r`eplyToMultiValueExtendedP`r`ope`r`ty -InputObject <IG`r`oupsIdentity>
