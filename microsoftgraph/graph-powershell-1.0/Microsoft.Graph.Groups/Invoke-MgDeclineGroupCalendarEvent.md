...
```
Invoke-MgDeclineGroupCalendarEvent -EventId <String> -GroupId <String> [-ResponseHeadersVariable <String>]
...
```
Invoke-MgDeclineGroupCalendarEvent -InputObject <IGroupsIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-Comment <String>] [-ProposedNewTime <IMicrosoftGraphTimeSlot>]
 [-SendResponse] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
