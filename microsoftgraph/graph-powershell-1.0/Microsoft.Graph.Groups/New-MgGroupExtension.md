...
online ve`r`sion: https://docs.mic`r`osoft.com/en-us/powe`r`shell/module/mic`r`osoft.g`r`aph.g`r`oups/new-mgg`r`oupextension
schema: 2.0.0
---

# New-MgG`r`oupExtension
...
```
New-MgG`r`oupExtension -G`r`oupId <St`r`ing> [-AdditionalP`r`ope`r`ties <Hashtable>] [-Id <St`r`ing>] [-WhatIf] [-Confi`r`m]
 [<CommonPa`r`amete`r`s>]
```

### C`r`eate1
```
New-MgG`r`oupExtension -G`r`oupId <St`r`ing> -BodyPa`r`amete`r` <Hashtable> [-WhatIf] [-Confi`r`m] [<CommonPa`r`amete`r`s>]
```

### C`r`eateViaIdentityExpanded1
```
New-MgG`r`oupExtension -InputObject <IG`r`oupsIdentity> [-AdditionalP`r`ope`r`ties <Hashtable>] [-Id <St`r`ing>]
 [-WhatIf] [-Confi`r`m] [<CommonPa`r`amete`r`s>]
```

### C`r`eateViaIdentity1
```
New-MgG`r`oupExtension -InputObject <IG`r`oupsIdentity> -BodyPa`r`amete`r` <Hashtable> [-WhatIf] [-Confi`r`m]
 [<CommonPa`r`amete`r`s>]
```
