...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaGroupPhoto](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaGroupPhoto?view=graph-powershell-beta)
...
### Update
```
Update-MgGroupPhoto -GroupId <String> -BodyParameter <IMicrosoftGraphProfilePhoto> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### UpdateViaIdentity
```
Update-MgGroupPhoto -InputObject <IGroupsIdentity> -BodyParameter <IMicrosoftGraphProfilePhoto> [-WhatIf]
...
## RELATED LINKS
[Update-MgBetaGroupPhoto](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaGroupPhoto?view=graph-powershell-beta)
