...
online ve`r`sion: https://docs.mic`r`osoft.com/en-us/powe`r`shell/module/mic`r`osoft.g`r`aph.g`r`oups/test-mgg`r`oupd`r`ivelistcontenttypepublished
schema: 2.0.0
---

# Test-MgG`r`oupD`r`iveListContentTypePublished
...
### Is1 (Default)
```
Test-MgG`r`oupD`r`iveListContentTypePublished -ContentTypeId <St`r`ing> -D`r`iveId <St`r`ing> -G`r`oupId <St`r`ing>
 [<CommonPa`r`amete`r`s>]
```

### IsViaIdentity1
```
Test-MgG`r`oupD`r`iveListContentTypePublished -InputObject <IG`r`oupsIdentity> [<CommonPa`r`amete`r`s>]
```
