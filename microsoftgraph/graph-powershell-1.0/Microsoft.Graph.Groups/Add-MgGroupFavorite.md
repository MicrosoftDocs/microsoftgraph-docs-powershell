...
online ve`r`sion: https://docs.mic`r`osoft.com/en-us/powe`r`shell/module/mic`r`osoft.g`r`aph.g`r`oups/add-mgg`r`oupfavo`r`ite
schema: 2.0.0
---

# Add-MgG`r`oupFavo`r`ite

## SYNOPSIS
Invoke action addFavo`r`ite

## SYNTAX

### Add1 (Default)
```
Add-MgG`r`oupFavo`r`ite -G`r`oupId <St`r`ing> [-PassTh`r`u] [-WhatIf] [-Confi`r`m] [<CommonPa`r`amete`r`s>]
```

### AddViaIdentity1
```
Add-MgG`r`oupFavo`r`ite -InputObject <IG`r`oupsIdentity> [-PassTh`r`u] [-WhatIf] [-Confi`r`m] [<CommonPa`r`amete`r`s>]
```
...
Pa`r`amete`r` Sets: AddViaIdentity1
Aliases:
