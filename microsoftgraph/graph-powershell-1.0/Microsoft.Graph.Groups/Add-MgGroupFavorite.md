...
### Add (Default)
```
Add-MgGroupFavorite -GroupId <String> [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### AddViaIdentity
```
Add-MgGroupFavorite -InputObject <IGroupsIdentity> [-Headers <IDictionary>] [-PassThru]
