...
### Delete1
```
Remove-MgGroupOwnerByRef -GroupId <String> -Id <String> [-IfMatch <String>] [-Headers <IDictionary>]
...
### DeleteViaIdentity
```
Remove-MgGroupOwnerByRef -InputObject <IGroupsIdentity> [-IfMatch <String>] [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
