...
```
Invoke-MgAcceptGroupEvent -EventId <String> -GroupId <String> [-ResponseHeadersVariable <String>]
...
```
Invoke-MgAcceptGroupEvent -InputObject <IGroupsIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-Comment <String>] [-SendResponse] [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
