...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.groups/get-mggroupmemberofasgroup
Locale: en-US
Module Name: Microsoft.Graph.Groups
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Get-MgGroupMemberOfAsGroup
---
...
```
Get-MgGroupMemberOfAsGroup -DirectoryObjectId <string> -GroupId <string>
...
```
Get-MgGroupMemberOfAsGroup -InputObject <IGroupsIdentity> [-ExpandProperty <string[]>]
