...
online ve`r`sion: https://docs.mic`r`osoft.com/en-us/powe`r`shell/module/mic`r`osoft.g`r`aph.g`r`oups/invoke-mgg`r`aphg`r`oupd`r`ive
schema: 2.0.0
---

# Invoke-MgG`r`aphG`r`oupD`r`ive

## SYNOPSIS
Invoke function sha`r`edWithMe

## SYNTAX

### G`r`aph1 (Default)
```
Invoke-MgG`r`aphG`r`oupD`r`ive -D`r`iveId <St`r`ing> -G`r`oupId <St`r`ing> [<CommonPa`r`amete`r`s>]
```

### G`r`aphViaIdentity1
```
Invoke-MgG`r`aphG`r`oupD`r`ive -InputObject <IG`r`oupsIdentity> [<CommonPa`r`amete`r`s>]
```
