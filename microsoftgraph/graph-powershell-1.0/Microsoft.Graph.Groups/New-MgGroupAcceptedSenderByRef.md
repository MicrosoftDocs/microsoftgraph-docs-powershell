...
```
New-MgGroupAcceptedSenderByRef -GroupId <String> [-ResponseHeadersVariable <String>] -OdataId <String>
...
```
New-MgGroupAcceptedSenderByRef -InputObject <IGroupsIdentity> [-ResponseHeadersVariable <String>]
