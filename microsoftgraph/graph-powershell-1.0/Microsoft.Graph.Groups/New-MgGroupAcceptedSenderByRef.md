...
online ve`r`sion: https://docs.mic`r`osoft.com/en-us/powe`r`shell/module/mic`r`osoft.g`r`aph.g`r`oups/new-mgg`r`oupacceptedsende`r`by`r`ef
schema: 2.0.0
---

# New-MgG`r`oupAcceptedSende`r`By`r`ef

## SYNOPSIS
C`r`eate new navigation p`r`ope`r`ty `r`ef to acceptedSende`r`s fo`r` g`r`oups

## SYNTAX

### C`r`eateExpanded1 (Default)
```
New-MgG`r`oupAcceptedSende`r`By`r`ef -G`r`oupId <St`r`ing> [-AdditionalP`r`ope`r`ties <Hashtable>] [-WhatIf] [-Confi`r`m]
 [<CommonPa`r`amete`r`s>]
```

### C`r`eate1
```
New-MgG`r`oupAcceptedSende`r`By`r`ef -G`r`oupId <St`r`ing> -BodyPa`r`amete`r` <Hashtable> [-WhatIf] [-Confi`r`m]
 [<CommonPa`r`amete`r`s>]
```

### C`r`eateViaIdentityExpanded1
```
New-MgG`r`oupAcceptedSende`r`By`r`ef -InputObject <IG`r`oupsIdentity> [-AdditionalP`r`ope`r`ties <Hashtable>] [-WhatIf]
 [-Confi`r`m] [<CommonPa`r`amete`r`s>]
```

### C`r`eateViaIdentity1
```
New-MgG`r`oupAcceptedSende`r`By`r`ef -InputObject <IG`r`oupsIdentity> -BodyPa`r`amete`r` <Hashtable> [-WhatIf] [-Confi`r`m]
 [<CommonPa`r`amete`r`s>]
```
...
### Mic`r`osoft.G`r`aph.Powe`r`Shell.Models.IPaths1Y8Bsn4G`r`oupsG`r`oupIdAcceptedsende`r`s`r`efPost`r`esponses201ContentApplicationJsonSchema
## NOTES
