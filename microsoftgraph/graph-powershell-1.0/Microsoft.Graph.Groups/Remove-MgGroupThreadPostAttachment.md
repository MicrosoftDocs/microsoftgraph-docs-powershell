...
online ve`r`sion: https://docs.mic`r`osoft.com/en-us/powe`r`shell/module/mic`r`osoft.g`r`aph.g`r`oups/`r`emove-mgg`r`oupth`r`eadpostattachment
schema: 2.0.0
---

# `r`emove-MgG`r`oupTh`r`eadPostAttachment
...
### Delete1 (Default)
```
`r`emove-MgG`r`oupTh`r`eadPostAttachment -AttachmentId <St`r`ing> -Conve`r`sationTh`r`eadId <St`r`ing> -G`r`oupId <St`r`ing>
 -PostId <St`r`ing> [-IfMatch <St`r`ing>] [-PassTh`r`u] [-WhatIf] [-Confi`r`m] [<CommonPa`r`amete`r`s>]
```

### DeleteViaIdentity1
```
`r`emove-MgG`r`oupTh`r`eadPostAttachment -InputObject <IG`r`oupsIdentity> [-IfMatch <St`r`ing>] [-PassTh`r`u] [-WhatIf]
