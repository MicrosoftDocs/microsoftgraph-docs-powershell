...
### Unfollow (Default)
```
Invoke-MgUnfollowGroupDriveRoot -DriveId <String> -GroupId <String> [-ResponseHeadersVariable <String>]
...
### UnfollowViaIdentity
```
Invoke-MgUnfollowGroupDriveRoot -InputObject <IGroupsIdentity> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.groups/invoke-mgunfollowgroupdriveroot](https://learn.microsoft.com/powershell/module/microsoft.graph.groups/invoke-mgunfollowgroupdriveroot)
