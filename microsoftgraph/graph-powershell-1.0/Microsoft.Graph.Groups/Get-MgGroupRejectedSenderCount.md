...
### Get (Default)
```
Get-MgGroupRejectedSenderCount -GroupId <String> [-Filter <String>] [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupRejectedSenderCount -InputObject <IGroupsIdentity> [-Filter <String>]
