...
```
New-MgGroupMemberByRef -GroupId <String> -OdataId <String> [-AdditionalProperties <Hashtable>]
...
### Create
```
New-MgGroupMemberByRef -GroupId <String> -BodyParameter <IReferenceCreate> [-Headers <IDictionary>] [-PassThru]
