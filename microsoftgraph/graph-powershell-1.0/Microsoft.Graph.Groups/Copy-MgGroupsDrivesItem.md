...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.groups/copy-mggroupsdrivesitem
schema: 2.0.0
---

# Copy-MgGroupsDrivesItem
...
```
Copy-MgGroupsDrivesItem -DriveId <String> -DriveItemId <String> -GroupId <String>
...
```
Copy-MgGroupsDrivesItem -InputObject <IGroupsIdentity> [-AdditionalProperties <Hashtable>] [-Name <String>]
 [-ParentReference <IMicrosoftGraphItemReference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### CopyViaIdentity
```
Copy-MgGroupsDrivesItem -InputObject <IGroupsIdentity>
 -BodyParameter <IPathsZsqog0GroupsGroupIdDrivesDriveIdItemsDriveitemIdMicrosoftGraphCopyPostRequestbodyContentApplicationJsonSchema>
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.groups/copy-mggroupsdrivesitem](https://learn.microsoft.com/powershell/module/microsoft.graph.groups/copy-mggroupsdrivesitem)
