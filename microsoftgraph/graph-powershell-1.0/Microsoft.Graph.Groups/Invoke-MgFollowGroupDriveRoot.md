...
online ve`r`sion: https://docs.mic`r`osoft.com/en-us/powe`r`shell/module/mic`r`osoft.g`r`aph.g`r`oups/invoke-mgfollowg`r`oupd`r`ive`r`oot
schema: 2.0.0
---

# Invoke-MgFollowG`r`oupD`r`ive`r`oot
...
### Follow1 (Default)
```
Invoke-MgFollowG`r`oupD`r`ive`r`oot -D`r`iveId <St`r`ing> -G`r`oupId <St`r`ing> [-WhatIf] [-Confi`r`m] [<CommonPa`r`amete`r`s>]
```

### FollowViaIdentity1
```
Invoke-MgFollowG`r`oupD`r`ive`r`oot -InputObject <IG`r`oupsIdentity> [-WhatIf] [-Confi`r`m] [<CommonPa`r`amete`r`s>]
```
