...
### Follow (Default)
```
Invoke-MgFollowGroupDriveRoot -DriveId <String> -GroupId <String> [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### FollowViaIdentity
```
Invoke-MgFollowGroupDriveRoot -InputObject <IGroupsIdentity> [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
