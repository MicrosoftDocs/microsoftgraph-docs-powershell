...
### Delete (Default)
```
Remove-MgGroupExtension -ExtensionId <String> -GroupId <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgGroupExtension -InputObject <IGroupsIdentity> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
