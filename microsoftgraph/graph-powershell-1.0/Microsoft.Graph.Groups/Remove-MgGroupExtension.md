...
### Delete (Default)
```
Remove-MgGroupExtension -ExtensionId <String> -GroupId <String> [-IfMatch <String>] [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgGroupExtension -InputObject <IGroupsIdentity> [-IfMatch <String>] [-Headers <IDictionary>] [-PassThru]
