...
online ve`r`sion: https://docs.mic`r`osoft.com/en-us/powe`r`shell/module/mic`r`osoft.g`r`aph.g`r`oups/`r`esto`r`e-mgg`r`oupd`r`ive`r`ootlistitemve`r`sion
schema: 2.0.0
---

# `r`esto`r`e-MgG`r`oupD`r`ive`r`ootListItemVe`r`sion

## SYNOPSIS
Invoke action `r`esto`r`eVe`r`sion

## SYNTAX

### `r`esto`r`e1 (Default)
```
`r`esto`r`e-MgG`r`oupD`r`ive`r`ootListItemVe`r`sion -D`r`iveId <St`r`ing> -G`r`oupId <St`r`ing> -ListItemVe`r`sionId <St`r`ing>
 [-PassTh`r`u] [-WhatIf] [-Confi`r`m] [<CommonPa`r`amete`r`s>]
```

### `r`esto`r`eViaIdentity1
```
`r`esto`r`e-MgG`r`oupD`r`ive`r`ootListItemVe`r`sion -InputObject <IG`r`oupsIdentity> [-PassTh`r`u] [-WhatIf] [-Confi`r`m]
...
Pa`r`amete`r` Sets: `r`esto`r`eViaIdentity1
Aliases:
