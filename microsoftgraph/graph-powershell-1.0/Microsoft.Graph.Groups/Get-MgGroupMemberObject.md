...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaGroupMemberObject](/powershell/module/Microsoft.Graph.Beta.Applications/Get-MgBetaGroupMemberObject?view=graph-powershell-beta)

## SYNTAX

### GetExpanded (Default)
```
Get-MgGroupMemberObject -GroupId <String> [-AdditionalProperties <Hashtable>] [-SecurityEnabledOnly] [-WhatIf]
...
## RELATED LINKS
[Get-MgBetaGroupMemberObject](/powershell/module/Microsoft.Graph.Beta.Applications/Get-MgBetaGroupMemberObject?view=graph-powershell-beta)
