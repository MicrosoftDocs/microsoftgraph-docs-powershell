...
### Create1 (Default)
```
New-MgGroupRejectedSenderByRef -GroupId <String> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### CreateViaIdentity1
```
New-MgGroupRejectedSenderByRef -InputObject <IGroupsIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
