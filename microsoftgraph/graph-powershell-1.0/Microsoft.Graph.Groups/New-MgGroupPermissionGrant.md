...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.groups/new-mggrouppermissiongrant
Locale: en-US
Module Name: Microsoft.Graph.Groups
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: New-MgGroupPermissionGrant
---
...
```
New-MgGroupPermissionGrant -GroupId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgGroupPermissionGrant -GroupId <string>
...
```
New-MgGroupPermissionGrant -InputObject <IGroupsIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-ClientAppId <string>] [-ClientId <string>]
 [-DeletedDateTime <datetime>] [-Id <string>] [-Permission <string>] [-PermissionType <string>]
 [-ResourceAppId <string>] [-Break] [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.groups/new-mggrouppermissiongrant)
