...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.groups/new-mggroupownerbyref
Locale: en-US
Module Name: Microsoft.Graph.Groups
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: New-MgGroupOwnerByRef
---
...
```
New-MgGroupOwnerByRef -GroupId <string> -OdataId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgGroupOwnerByRef -InputObject <IGroupsIdentity> -OdataId <string>
