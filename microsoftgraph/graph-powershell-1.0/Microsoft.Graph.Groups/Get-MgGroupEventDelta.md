...
online ve`r`sion: https://docs.mic`r`osoft.com/en-us/powe`r`shell/module/mic`r`osoft.g`r`aph.g`r`oups/get-mgg`r`oupeventdelta
schema: 2.0.0
---

# Get-MgG`r`oupEventDelta
...
### Delta1 (Default)
```
Get-MgG`r`oupEventDelta -G`r`oupId <St`r`ing> [<CommonPa`r`amete`r`s>]
```

### DeltaViaIdentity1
```
Get-MgG`r`oupEventDelta -InputObject <IG`r`oupsIdentity> [<CommonPa`r`amete`r`s>]
```
