...
### Search (Default)
```
Search-MgGroupDriveRoot -DriveId <String> -GroupId <String> -Q <String> [-Count] [-ExpandProperty <String[]>]
...
### SearchViaIdentity
```
Search-MgGroupDriveRoot -InputObject <IGroupsIdentity> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
