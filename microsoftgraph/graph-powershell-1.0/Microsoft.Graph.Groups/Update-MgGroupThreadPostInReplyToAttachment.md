...
Update-MgGroupThreadPostInReplyToAttachment -AttachmentId <String> -ConversationThreadId <String>
 ...
 [-IsInline] [-LastModifiedDateTime <DateTime>] [-Name <String>] [-Size <Int32>] [-PassThru] [-WhatIf]
...
```
Update-MgGroupThreadPostInReplyToAttachment -AttachmentId <String> -ConversationThreadId <String>
 -GroupId <String> -PostId <String> -BodyParameter <IMicrosoftGraphAttachment> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups/update-mggroupthreadpostinreplytoattachment](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups/update-mggroupthreadpostinreplytoattachment)
