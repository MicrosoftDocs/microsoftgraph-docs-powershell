...
Restore-MgGroupSiteListItemDocumentSetVersion -DocumentSetVersionId <String> -GroupId <String> -ListId <String>
 -ListItemId <String> -SiteId <String> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### RestoreViaIdentity
```
Restore-MgGroupSiteListItemDocumentSetVersion -InputObject <IGroupsIdentity> [-Headers <IDictionary>]
