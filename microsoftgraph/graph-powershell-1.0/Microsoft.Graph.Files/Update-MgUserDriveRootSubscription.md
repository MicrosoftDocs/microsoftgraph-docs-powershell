...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/update-mguserdriverootsubscription
schema: 2.0.0
---
...
Update-MgUserDriveRootSubscription -DriveId <String> -SubscriptionId <String> -UserId <String>
 ...
 [-NotificationUrlAppId <String>] [-Resource <String>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/update-mguserdriverootsubscription](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/update-mguserdriverootsubscription)
