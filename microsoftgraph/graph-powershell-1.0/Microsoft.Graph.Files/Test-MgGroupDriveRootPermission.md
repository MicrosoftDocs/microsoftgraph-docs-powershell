...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/test-mggroupdriverootpermission
schema: 2.0.0
---
...
```
Test-MgGroupDriveRootPermission -InputObject <IFilesIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-ChallengeToken <String>] [-Password <String>] [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### ValidateViaIdentity
```
Test-MgGroupDriveRootPermission -InputObject <IFilesIdentity>
 -BodyParameter <IPaths1Hi1AeeGroupsGroupIdDrivesDriveIdRootMicrosoftGraphValidatepermissionPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.files/test-mggroupdriverootpermission](https://learn.microsoft.com/powershell/module/microsoft.graph.files/test-mggroupdriverootpermission)
