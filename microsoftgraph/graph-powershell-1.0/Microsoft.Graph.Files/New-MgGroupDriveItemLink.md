...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/new-mggroupdriveitemlink
schema: 2.0.0
...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaGroupDriveItemLink](/powershell/module/Microsoft.Graph.Beta.Files/New-MgBetaGroupDriveItemLink?view=graph-powershell-beta)
...
```
New-MgGroupDriveItemLink -InputObject <IFilesIdentity> [-ResponseHeadersVariable <String>]
...
### CreateViaIdentity
```
New-MgGroupDriveItemLink -InputObject <IFilesIdentity>
 -BodyParameter <IPaths13X0452GroupsGroupIdDrivesDriveIdItemsDriveitemIdMicrosoftGraphCreatelinkPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.files/new-mggroupdriveitemlink](https://learn.microsoft.com/powershell/module/microsoft.graph.files/new-mggroupdriveitemlink)
