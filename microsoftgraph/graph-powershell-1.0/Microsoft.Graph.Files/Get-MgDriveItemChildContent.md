...
### Get (Default)
```
Get-MgDriveItemChildContent -DriveId <String> -DriveItemId <String> -DriveItemId1 <String> [-Format <String>]
...
### GetViaIdentity
```
Get-MgDriveItemChildContent -InputObject <IFilesIdentity> [-Format <String>] -OutFile <String>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.files/get-mgdriveitemchildcontent](https://learn.microsoft.com/powershell/module/microsoft.graph.files/get-mgdriveitemchildcontent)
