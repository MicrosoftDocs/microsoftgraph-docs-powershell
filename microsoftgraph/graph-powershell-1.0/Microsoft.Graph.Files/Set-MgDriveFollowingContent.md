...
### Set (Default)
```
Set-MgDriveFollowingContent -DriveId <String> -DriveItemId <String> [-Data <Stream>]
...
### SetViaIdentity
```
Set-MgDriveFollowingContent -InputObject <IFilesIdentity> [-Data <Stream>] [-ResponseHeadersVariable <String>]
