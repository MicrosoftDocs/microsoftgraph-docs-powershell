...
### Set (Default)
```
Set-MgDriveFollowingContent -DriveId <String> -DriveItemId <String> [-Data <Stream>] -InFile <String>
...
### SetViaIdentity
```
Set-MgDriveFollowingContent -InputObject <IFilesIdentity> [-Data <Stream>] -InFile <String>
 [-ContentType <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
