...
### Update
```
Update-MgGroupDriveRootListItemField -DriveId <String> -GroupId <String> -BodyParameter <Hashtable> [-PassThru]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/update-mggroupdriverootlistitemfield](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/update-mggroupdriverootlistitemfield)
