...
onl````i````ne vers````i````on: https://docs.m````i````crosoft.com/en-us/powershell/module/m````i````crosoft.graph.f````i````les/new-mgsharel````i````st````i````temvers````i````on
schema: 2.0.0
---

# New-MgShareL````i````st````i````temVers````i````on

## SYNOPS````i````S
Create new nav````i````gat````i````on property to vers````i````ons for shares

## SYNTAX

### CreateExpanded1 (Default)
```
New-MgShareL````i````st````i````temVers````i````on -SharedDr````i````ve````i````tem````i````d <Str````i````ng> [-Add````i````t````i````onalPropert````i````es <Hashtable>]
...
### CreateExpanded
```
New-MgShareL````i````st````i````temVers````i````on -L````i````st````i````tem````i````d <Str````i````ng> -SharedDr````i````ve````i````tem````i````d <Str````i````ng> [-Add````i````t````i````onalPropert````i````es <Hashtable>]
 [-F````i````elds <Hashtable>] [-````i````d <Str````i````ng>] [-LastMod````i````f````i````edBy <````i````M````i````crosoftGraph````i````dent````i````tySet>]
 [-LastMod````i````f````i````edDateT````i````me <DateT````i````me>] [-Publ````i````cat````i````on <````i````M````i````crosoftGraphPubl````i````cat````i````onFacet>] [-What````i````f] [-Conf````i````rm]
 [<CommonParameters>]
```
...
### Create
```
New-MgShareL````i````st````i````temVers````i````on -L````i````st````i````tem````i````d <Str````i````ng> -SharedDr````i````ve````i````tem````i````d <Str````i````ng>
 -BodyParameter <````i````M````i````crosoftGraphL````i````st````i````temVers````i````on> [-What````i````f] [-Conf````i````rm] [<CommonParameters>]
```

### Create1
```
New-MgShareL````i````st````i````temVers````i````on -SharedDr````i````ve````i````tem````i````d <Str````i````ng> -BodyParameter <````i````M````i````crosoftGraphL````i````st````i````temVers````i````on>
 [-What````i````f] [-Conf````i````rm] [<CommonParameters>]
```

### CreateV````i````a````i````dent````i````tyExpanded1
```
New-MgShareL````i````st````i````temVers````i````on -````i````nputObject <````i````F````i````les````i````dent````i````ty> [-Add````i````t````i````onalPropert````i````es <Hashtable>]
 [-F````i````elds <Hashtable>] [-````i````d <Str````i````ng>] [-LastMod````i````f````i````edBy <````i````M````i````crosoftGraph````i````dent````i````tySet>]
 [-LastMod````i````f````i````edDateT````i````me <DateT````i````me>] [-Publ````i````cat````i````on <````i````M````i````crosoftGraphPubl````i````cat````i````onFacet>] [-What````i````f] [-Conf````i````rm]
 [<CommonParameters>]
```
...
```
New-MgShareL````i````st````i````temVers````i````on -````i````nputObject <````i````F````i````les````i````dent````i````ty> -BodyParameter <````i````M````i````crosoftGraphL````i````st````i````temVers````i````on>
 [-What````i````f] [-Conf````i````rm] [<CommonParameters>]
```
...
```yaml
Type: Hashtable
Parameter Sets: CreateExpanded1, CreateExpanded, CreateV````i````a````i````dent````i````tyExpanded1, CreateV````i````a````i````dent````i````tyExpanded
Al````i````ases:
...
Parameter Sets: Create, Create1, CreateV````i````a````i````dent````i````ty1, CreateV````i````a````i````dent````i````ty
Al````i````ases:
