...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaDriveItemListItemVersion](/powershell/module/Microsoft.Graph.Beta.Applications/New-MgBetaDriveItemListItemVersion?view=graph-powershell-beta)

## SYNTAX

### CreateExpanded (Default)
```
New-MgDriveItemListItemVersion -DriveId <String> -DriveItemId <String> [-AdditionalProperties <Hashtable>]
...
```
New-MgDriveItemListItemVersion -InputObject <IFilesIdentity> [-AdditionalProperties <Hashtable>]
 [-Fields <Hashtable>] [-Id <String>] [-LastModifiedBy <IMicrosoftGraphIdentitySet>]
 [-LastModifiedDateTime <DateTime>] [-Publication <IMicrosoftGraphPublicationFacet>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### CreateViaIdentity
```
New-MgDriveItemListItemVersion -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphListItemVersion>
...
## RELATED LINKS
[New-MgBetaDriveItemListItemVersion](/powershell/module/Microsoft.Graph.Beta.Applications/New-MgBetaDriveItemListItemVersion?view=graph-powershell-beta)
