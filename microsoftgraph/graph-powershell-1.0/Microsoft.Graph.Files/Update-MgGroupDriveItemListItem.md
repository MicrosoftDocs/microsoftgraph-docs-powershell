...
```
Update-MgGroupDriveItemListItem -InputObject <IFilesIdentity> [-AdditionalProperties <Hashtable>]
...
### UpdateViaIdentity
```
Update-MgGroupDriveItemListItem -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphListItem>
