...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/new-mguserdriverootlistitempermission
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: New-MgUserDriveRootListItemPermission
---

# New-MgUserDriveRootListItemPermission
...
```
New-MgUserDriveRootListItemPermission -DriveId <string> -UserId <string>
...
```
New-MgUserDriveRootListItemPermission -InputObject <IFilesIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-ExpirationDateTime <datetime>] [-GrantedTo <IMicrosoftGraphIdentitySet>]
 [-GrantedToIdentities <IMicrosoftGraphIdentitySet[]>]
 [-GrantedToIdentitiesV2 <IMicrosoftGraphSharePointIdentitySet[]>]
