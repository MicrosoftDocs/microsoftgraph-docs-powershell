...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mgdrivelistitemversion
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Update-MgDriveListItemVersion
---
...
```
Update-MgDriveListItemVersion -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgDriveListItemVersion -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphListItemVersion> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [Update-MgDriveListItemVersion](https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mgdrivelistitemversion)
