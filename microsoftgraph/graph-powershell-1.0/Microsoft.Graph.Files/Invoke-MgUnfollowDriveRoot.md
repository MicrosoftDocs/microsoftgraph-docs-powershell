...
### Unfollow (Default)
```
Invoke-MgUnfollowDriveRoot -DriveId <String> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UnfollowViaIdentity
```
Invoke-MgUnfollowDriveRoot -InputObject <IFilesIdentity> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
