...
```
Get-MgGroupDriveRootDelta -DriveId <string> -GroupId <string> [-ExpandProperty <string[]>]
...
```
Get-MgGroupDriveRootDelta -DriveId <string> -GroupId <string> -Token <string>
...
```
Get-MgGroupDriveRootDelta -InputObject <IFilesIdentity> [-ExpandProperty <string[]>]
 [-Filter <string>] [-Property <string[]>] [-Search <string>] [-Skip <int>] [-Sort <string[]>]
...
- [Get-MgGroupDriveRootDelta](https://learn.microsoft.com/powershell/module/microsoft.graph.files/get-mggroupdriverootdelta)
