...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/new-mggroupdrivelistpermission
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: New-MgGroupDriveListPermission
---

# New-MgGroupDriveListPermission
...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaGroupDriveListPermission](/powershell/module/Microsoft.Graph.Beta.Files/New-MgBetaGroupDriveListPermission?view=graph-powershell-beta)
...
```
New-MgGroupDriveListPermission -DriveId <string> -GroupId <string>
...
```
New-MgGroupDriveListPermission -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
...
```
New-MgGroupDriveListPermission -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphPermission> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgGroupDriveListPermission](https://learn.microsoft.com/powershell/module/microsoft.graph.files/new-mggroupdrivelistpermission)
