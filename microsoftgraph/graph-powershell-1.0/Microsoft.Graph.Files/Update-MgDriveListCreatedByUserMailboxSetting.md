...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaDriveListCreatedByUserMailboxSetting](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaDriveListCreatedByUserMailboxSetting?view=graph-powershell-beta)
...
```
Update-MgDriveListCreatedByUserMailboxSetting -InputObject <IFilesIdentity> [-AdditionalProperties <Hashtable>]
 [-ArchiveFolder <String>] [-AutomaticRepliesSetting <IMicrosoftGraphAutomaticRepliesSetting>]
 [-DateFormat <String>] [-DelegateMeetingMessageDeliveryOptions <String>]
 [-Language <IMicrosoftGraphLocaleInfo>] [-TimeFormat <String>] [-TimeZone <String>] [-UserPurpose <String>]
 [-WorkingHours <IMicrosoftGraphWorkingHours>] [-WhatIf] [-Confirm] [<CommonParameters>]
...
## RELATED LINKS
[Update-MgBetaDriveListCreatedByUserMailboxSetting](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaDriveListCreatedByUserMailboxSetting?view=graph-powershell-beta)
