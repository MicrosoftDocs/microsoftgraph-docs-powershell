...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/new-mgsharelistcolumn
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: New-MgShareListColumn
---
...
```
New-MgShareListColumn -SharedDriveItemId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgShareListColumn -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Boolean <hashtable>]
 [-Calculated <IMicrosoftGraphCalculatedColumn>] [-Choice <IMicrosoftGraphChoiceColumn>]
 [-ColumnGroup <string>] [-ContentApprovalStatus <hashtable>]
 [-Currency <IMicrosoftGraphCurrencyColumn>] [-DateTime <IMicrosoftGraphDateTimeColumn>]
