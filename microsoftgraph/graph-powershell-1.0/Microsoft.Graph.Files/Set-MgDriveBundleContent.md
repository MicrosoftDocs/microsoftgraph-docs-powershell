...
### Set (Default)
```
Set-MgDriveBundleContent -DriveId <String> -DriveItemId <String> [-Data <Stream>]
...
### SetViaIdentity
```
Set-MgDriveBundleContent -InputObject <IFilesIdentity> [-Data <Stream>] [-ResponseHeadersVariable <String>]
