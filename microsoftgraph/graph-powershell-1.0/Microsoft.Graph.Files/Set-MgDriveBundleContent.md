...
### Set (Default)
```
Set-MgDriveBundleContent -DriveId <String> -DriveItemId <String> [-Data <Stream>] -InFile <String>
...
### SetViaIdentity
```
Set-MgDriveBundleContent -InputObject <IFilesIdentity> [-Data <Stream>] -InFile <String>
 [-ContentType <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
