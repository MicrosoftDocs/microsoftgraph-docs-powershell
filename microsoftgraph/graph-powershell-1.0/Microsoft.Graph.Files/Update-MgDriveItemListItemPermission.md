...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mgdriveitemlistitempermission
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Update-MgDriveItemListItemPermission
---

# Update-MgDriveItemListItemPermission
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaDriveItemListItemPermission](/powershell/module/Microsoft.Graph.Beta.Files/Update-MgBetaDriveItemListItemPermission?view=graph-powershell-beta)
...
```
Update-MgDriveItemListItemPermission -DriveId <string> -DriveItemId <string> -PermissionId <string>
...
```
Update-MgDriveItemListItemPermission -InputObject <IFilesIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-ExpirationDateTime <datetime>] [-GrantedTo <IMicrosoftGraphIdentitySet>]
 [-GrantedToIdentities <IMicrosoftGraphIdentitySet[]>]
 [-GrantedToIdentitiesV2 <IMicrosoftGraphSharePointIdentitySet[]>]
...
- [Update-MgDriveItemListItemPermission](https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mgdriveitemlistitempermission)
