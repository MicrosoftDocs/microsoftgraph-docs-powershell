...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/new-mgsharelistoperation
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: New-MgShareListOperation
---
...
```
New-MgShareListOperation -SharedDriveItemId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgShareListOperation -SharedDriveItemId <string>
...
```
New-MgShareListOperation -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-CreatedDateTime <datetime>]
 [-Error <IMicrosoftGraphPublicError>] [-Id <string>] [-LastActionDateTime <datetime>]
 [-PercentageComplete <int>] [-ResourceId <string>] [-ResourceLocation <string>] [-Status <string>]
 [-StatusDetail <string>] [-Type <string>] [-Break] [-Headers <IDictionary>]
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.files/new-mgsharelistoperation)
