...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/remove-mguserdriveitemcheckout
schema: 2.0.0
...
### Discard (Default)
```
Remove-MgUserDriveItemCheckout -DriveId <String> -DriveItemId <String> -UserId <String>
...
### DiscardViaIdentity
```
Remove-MgUserDriveItemCheckout -InputObject <IFilesIdentity> [-ResponseHeadersVariable <String>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.files/remove-mguserdriveitemcheckout](https://learn.microsoft.com/powershell/module/microsoft.graph.files/remove-mguserdriveitemcheckout)
