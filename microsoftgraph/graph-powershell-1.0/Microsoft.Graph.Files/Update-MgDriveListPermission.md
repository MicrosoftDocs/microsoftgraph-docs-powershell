...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mgdrivelistpermission
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Update-MgDriveListPermission
---

# Update-MgDriveListPermission
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaDriveListPermission](/powershell/module/Microsoft.Graph.Beta.Files/Update-MgBetaDriveListPermission?view=graph-powershell-beta)
...
```
Update-MgDriveListPermission -DriveId <string> -PermissionId <string>
...
```
Update-MgDriveListPermission -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgDriveListPermission -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphPermission> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [Update-MgDriveListPermission](https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mgdrivelistpermission)
