...
### Set (Default)
```
Set-MgShareItemContent -DriveItemId <String> -SharedDriveItemId <String> [-Data <Stream>]
...
### SetViaIdentity
```
Set-MgShareItemContent -InputObject <IFilesIdentity> [-Data <Stream>] [-ResponseHeadersVariable <String>]
