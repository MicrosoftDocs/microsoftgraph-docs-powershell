...
### Delete (Default)
```
Remove-MgDriveRootListItemField -DriveId <String> [-IfMatch <String>] [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgDriveRootListItemField -InputObject <IFilesIdentity> [-IfMatch <String>] [-Headers <IDictionary>]
