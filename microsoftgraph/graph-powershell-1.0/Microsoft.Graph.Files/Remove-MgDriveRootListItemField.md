...
### Delete (Default)
```
Remove-MgDriveRootListItemField -DriveId <String> [-IfMatch <String>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgDriveRootListItemField -InputObject <IFilesIdentity> [-IfMatch <String>] [-PassThru] [-Confirm]
