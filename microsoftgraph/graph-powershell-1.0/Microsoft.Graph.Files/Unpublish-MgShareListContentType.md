...
### Unpublish (Default)
```
Unpublish-MgShareListContentType -ContentTypeId <String> -SharedDriveItemId <String>
...
```
Unpublish-MgShareListContentType -InputObject <IFilesIdentity> [-ResponseHeadersVariable <String>]
