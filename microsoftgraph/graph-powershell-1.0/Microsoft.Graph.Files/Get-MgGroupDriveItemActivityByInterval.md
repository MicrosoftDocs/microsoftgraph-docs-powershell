...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/get-mggroupdriveitemactivitybyinterval
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Get-MgGroupDriveItemActivityByInterval
---
...
```
Get-MgGroupDriveItemActivityByInterval -InputObject <IFilesIdentity> [-Count]
 [-ExpandProperty <string[]>] [-Filter <string>] [-Property <string[]>] [-Search <string>]
 [-Skip <int>] [-Sort <string[]>] [-Top <int>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
...
- [Get-MgGroupDriveItemActivityByInterval](https://learn.microsoft.com/powershell/module/microsoft.graph.files/get-mggroupdriveitemactivitybyinterval)
