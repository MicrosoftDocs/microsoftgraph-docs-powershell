...
### Delete (Default)
```
Remove-MgDriveItemRetentionLabel -DriveId <String> -DriveItemId <String> [-IfMatch <String>] [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgDriveItemRetentionLabel -InputObject <IFilesIdentity> [-IfMatch <String>] [-PassThru] [-WhatIf]
