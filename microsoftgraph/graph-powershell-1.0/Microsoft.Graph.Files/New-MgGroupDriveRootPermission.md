...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/new-mggroupdriverootpermission
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: New-MgGroupDriveRootPermission
---
...
```
New-MgGroupDriveRootPermission -DriveId <string> -GroupId <string>
...
```
New-MgGroupDriveRootPermission -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
...
```
New-MgGroupDriveRootPermission -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphPermission> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgGroupDriveRootPermission](https://learn.microsoft.com/powershell/module/microsoft.graph.files/new-mggroupdriverootpermission)
