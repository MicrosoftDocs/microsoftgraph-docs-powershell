...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/search-mgdriveroot
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Search-MgDriveRoot
---
...
```
Search-MgDriveRoot -DriveId <string> -Q <string> [-Count] [-ExpandProperty <string[]>]
...
```
Search-MgDriveRoot -InputObject <IFilesIdentity> [-Count] [-ExpandProperty <string[]>]
 [-Filter <string>] [-Property <string[]>] [-Search <string>] [-Skip <int>] [-Sort <string[]>]
 [-Top <int>] [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
...
- [Search-MgDriveRoot](https://learn.microsoft.com/powershell/module/microsoft.graph.files/search-mgdriveroot)
