...
### Search (Default)
```
Search-MgDriveRoot -DriveId <String> -Q <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### SearchViaIdentity
```
Search-MgDriveRoot -InputObject <IFilesIdentity> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
 [-Property <String[]>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>] [-Top <Int32>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.files/search-mgdriveroot](https://learn.microsoft.com/powershell/module/microsoft.graph.files/search-mgdriveroot)
