...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/remove-mgdriveitemcheckout
schema: 2.0.0
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Remove-MgBetaDriveItemCheckout](/powershell/module/Microsoft.Graph.Beta.Files/Remove-MgBetaDriveItemCheckout?view=graph-powershell-beta)

## SYNTAX

### Discard (Default)
```
Remove-MgDriveItemCheckout -DriveId <String> -DriveItemId <String> [-ResponseHeadersVariable <String>]
...
### DiscardViaIdentity
```
Remove-MgDriveItemCheckout -InputObject <IFilesIdentity> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.files/remove-mgdriveitemcheckout](https://learn.microsoft.com/powershell/module/microsoft.graph.files/remove-mgdriveitemcheckout)
