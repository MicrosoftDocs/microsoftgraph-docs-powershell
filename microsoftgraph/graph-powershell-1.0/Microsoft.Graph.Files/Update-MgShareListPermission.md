...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mgsharelistpermission
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Update-MgShareListPermission
---

# Update-MgShareListPermission
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaShareListPermission](/powershell/module/Microsoft.Graph.Beta.Files/Update-MgBetaShareListPermission?view=graph-powershell-beta)
...
```
Update-MgShareListPermission -PermissionId <string> -SharedDriveItemId <string>
...
```
Update-MgShareListPermission -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgShareListPermission -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphPermission> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [Update-MgShareListPermission](https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mgsharelistpermission)
