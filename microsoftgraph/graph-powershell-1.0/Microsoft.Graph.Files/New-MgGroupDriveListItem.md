...
```
New-MgGroupDriveListItem -DriveId <String> -GroupId <String> [-AdditionalProperties <Hashtable>]
...
### Create
```
New-MgGroupDriveListItem -DriveId <String> -GroupId <String> -BodyParameter <IMicrosoftGraphListItem> [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgGroupDriveListItem -InputObject <IFilesIdentity> [-AdditionalProperties <Hashtable>]
 [-Analytics <IMicrosoftGraphItemAnalytics>] [-ContentType <IMicrosoftGraphContentTypeInfo>]
 [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedByUser <IMicrosoftGraphUser>] [-CreatedDateTime <DateTime>]
 [-Description <String>] [-DriveItem <IMicrosoftGraphDriveItem>] [-ETag <String>] [-Fields <Hashtable>]
 [-Id <String>] [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-LastModifiedByUser <IMicrosoftGraphUser>]
...
### CreateViaIdentity
```
New-MgGroupDriveListItem -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphListItem> [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
