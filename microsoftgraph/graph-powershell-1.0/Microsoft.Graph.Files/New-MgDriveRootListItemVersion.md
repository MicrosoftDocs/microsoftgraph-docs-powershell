...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/new-mgdriverootlistitemversion
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: New-MgDriveRootListItemVersion
---
...
```
New-MgDriveRootListItemVersion -DriveId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgDriveRootListItemVersion -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Fields <hashtable>] [-Id <string>]
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-LastModifiedDateTime <datetime>]
 [-Publication <IMicrosoftGraphPublicationFacet>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
...
```
New-MgDriveRootListItemVersion -InputObject <IFilesIdentity>
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.files/new-mgdriverootlistitemversion)
