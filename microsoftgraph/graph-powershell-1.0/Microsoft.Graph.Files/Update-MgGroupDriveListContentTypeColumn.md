...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaGroupDriveListContentTypeColumn](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaGroupDriveListContentTypeColumn?view=graph-powershell-beta)
...
```
Update-MgGroupDriveListContentTypeColumn -ColumnDefinitionId <String> -ContentTypeId <String> -DriveId <String>
 -GroupId <String> -BodyParameter <IMicrosoftGraphColumnDefinition> [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgBetaGroupDriveListContentTypeColumn](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaGroupDriveListContentTypeColumn?view=graph-powershell-beta)
