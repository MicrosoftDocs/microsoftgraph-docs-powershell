...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/get-mggroupdrivelistitemdelta
schema: 2.0.0
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaGroupDriveListItemDelta](/powershell/module/Microsoft.Graph.Beta.Files/Get-MgBetaGroupDriveListItemDelta?view=graph-powershell-beta)

## SYNTAX

### Delta (Default)
```
Get-MgGroupDriveListItemDelta -DriveId <String> -GroupId <String> [-ExpandProperty <String[]>]
...
### Delta1
```
Get-MgGroupDriveListItemDelta -DriveId <String> -GroupId <String> -Token <String> [-ExpandProperty <String[]>]
 [-Filter <String>] [-Property <String[]>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>] [-Top <Int32>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PageSize <Int32>] [-All]
 [-CountVariable <String>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
### DeltaViaIdentity1
```
Get-MgGroupDriveListItemDelta -InputObject <IFilesIdentity> [-ExpandProperty <String[]>] [-Filter <String>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.files/get-mggroupdrivelistitemdelta](https://learn.microsoft.com/powershell/module/microsoft.graph.files/get-mggroupdrivelistitemdelta)
