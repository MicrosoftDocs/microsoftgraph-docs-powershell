...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/get-mggroupdrivelistitemdelta
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: Get-MgGroupDriveListItemDelta
---
...
```
Get-MgGroupDriveListItemDelta -DriveId <string> -GroupId <string> -Token <string>
...
```
Get-MgGroupDriveListItemDelta -InputObject <IFilesIdentity> [-ExpandProperty <string[]>]
 [-Filter <string>] [-Property <string[]>] [-Search <string>] [-Skip <int>] [-Sort <string[]>]
