...
### Delete (Default)
```
Remove-MgDriveRootPermanent -DriveId <String> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgDriveRootPermanent -InputObject <IFilesIdentity> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
