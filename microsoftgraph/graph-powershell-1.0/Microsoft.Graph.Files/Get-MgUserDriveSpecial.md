...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/get-mguserdrivespecial
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: Get-MgUserDriveSpecial
---
...
```
Get-MgUserDriveSpecial -DriveId <string> -UserId <string> [-ExpandProperty <string[]>]
...
```
Get-MgUserDriveSpecial -DriveId <string> -DriveItemId <string> -UserId <string>
...
```
Get-MgUserDriveSpecial -InputObject <IFilesIdentity> [-ExpandProperty <string[]>]
