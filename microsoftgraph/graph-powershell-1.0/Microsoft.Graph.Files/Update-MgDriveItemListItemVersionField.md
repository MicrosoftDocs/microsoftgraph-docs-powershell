...
onl`i`ne vers`i`on: https://docs.m`i`crosoft.com/en-us/powershell/module/m`i`crosoft.graph.f`i`les/update-mgdr`i`ve`i`teml`i`st`i`temvers`i`onf`i`eld
schema: 2.0.0
---

# Update-MgDr`i`ve`i`temL`i`st`i`temVers`i`onF`i`eld
...
```
Update-MgDr`i`ve`i`temL`i`st`i`temVers`i`onF`i`eld -Dr`i`ve`i`d <Str`i`ng> -Dr`i`ve`i`tem`i`d <Str`i`ng> -L`i`st`i`temVers`i`on`i`d <Str`i`ng>
...
```
Update-MgDr`i`ve`i`temL`i`st`i`temVers`i`onF`i`eld -`i`nputObject <`i`F`i`les`i`dent`i`ty> [-Add`i`t`i`onalPropert`i`es <Hashtable>]
 [-`i`d <Str`i`ng>] [-PassThru] [-What`i`f] [-Conf`i`rm] [<CommonParameters>]
```

### UpdateV`i`a`i`dent`i`ty1
```
Update-MgDr`i`ve`i`temL`i`st`i`temVers`i`onF`i`eld -`i`nputObject <`i`F`i`les`i`dent`i`ty> -BodyParameter <Hashtable> [-PassThru]
