...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/test-mgdriverootpermission
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: Test-MgDriveRootPermission
---
...
```
Test-MgDriveRootPermission -DriveId <string> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-ChallengeToken <string>] [-Password <string>] [-Break]
...
```
Test-MgDriveRootPermission -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-ChallengeToken <string>] [-Password <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
