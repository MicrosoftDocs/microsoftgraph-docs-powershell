...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/get-mgdrivelistitemdelta
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Get-MgDriveListItemDelta
---
...
```
Get-MgDriveListItemDelta -DriveId <string> -Token <string> [-ExpandProperty <string[]>]
...
```
Get-MgDriveListItemDelta -InputObject <IFilesIdentity> [-ExpandProperty <string[]>]
 [-Filter <string>] [-Property <string[]>] [-Search <string>] [-Skip <int>] [-Sort <string[]>]
...
- [Get-MgDriveListItemDelta](https://learn.microsoft.com/powershell/module/microsoft.graph.files/get-mgdrivelistitemdelta)
