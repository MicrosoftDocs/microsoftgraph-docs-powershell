...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/new-mguserdrivelistitemversion
schema: 2.0.0
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaUserDriveListItemVersion](/powershell/module/Microsoft.Graph.Beta.Applications/New-MgBetaUserDriveListItemVersion?view=graph-powershell-beta)

## SYNTAX

### CreateExpanded (Default)
```
New-MgUserDriveListItemVersion -DriveId <String> -ListItemId <String> -UserId <String>
...
```
New-MgUserDriveListItemVersion -InputObject <IFilesIdentity> [-AdditionalProperties <Hashtable>]
...
### CreateViaIdentity
```
New-MgUserDriveListItemVersion -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphListItemVersion>
...
## RELATED LINKS
[New-MgBetaUserDriveListItemVersion](/powershell/module/Microsoft.Graph.Beta.Applications/New-MgBetaUserDriveListItemVersion?view=graph-powershell-beta)
