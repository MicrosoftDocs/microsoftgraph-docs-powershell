...
onl````i````ne vers````i````on: https://docs.m````i````crosoft.com/en-us/powershell/module/m````i````crosoft.graph.f````i````les/new-mguserdr````i````vel````i````st````i````temvers````i````on
schema: 2.0.0
---

# New-MgUserDr````i````veL````i````st````i````temVers````i````on
...
```
New-MgUserDr````i````veL````i````st````i````temVers````i````on -Dr````i````ve````i````d <Str````i````ng> -L````i````st````i````tem````i````d <Str````i````ng> -User````i````d <Str````i````ng>
...
```
New-MgUserDr````i````veL````i````st````i````temVers````i````on -````i````nputObject <````i````F````i````les````i````dent````i````ty> [-Add````i````t````i````onalPropert````i````es <Hashtable>]
...
```
New-MgUserDr````i````veL````i````st````i````temVers````i````on -````i````nputObject <````i````F````i````les````i````dent````i````ty> -BodyParameter <````i````M````i````crosoftGraphL````i````st````i````temVers````i````on>
