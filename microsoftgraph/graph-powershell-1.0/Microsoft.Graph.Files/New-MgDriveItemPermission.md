...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaDriveItemPermission](/powershell/module/Microsoft.Graph.Beta.Applications/New-MgBetaDriveItemPermission?view=graph-powershell-beta)
...
### CreateViaIdentity
```
New-MgDriveItemPermission -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphPermission> [-WhatIf]
...
## RELATED LINKS
[New-MgBetaDriveItemPermission](/powershell/module/Microsoft.Graph.Beta.Applications/New-MgBetaDriveItemPermission?view=graph-powershell-beta)
