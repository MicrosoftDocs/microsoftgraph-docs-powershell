...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mguserdriveitempermission
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Update-MgUserDriveItemPermission
---
...
```
Update-MgUserDriveItemPermission -DriveId <string> -DriveItemId <string> -PermissionId <string>
 -UserId <string> -BodyParameter <IMicrosoftGraphPermission> [-ResponseHeadersVariable <string>]
...
```
Update-MgUserDriveItemPermission -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgUserDriveItemPermission -InputObject <IFilesIdentity>
...
- [Update-MgUserDriveItemPermission](https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mguserdriveitempermission)
