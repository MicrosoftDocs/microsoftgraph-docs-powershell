...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/new-mgsharelistitempermission
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: New-MgShareListItemPermission
---

# New-MgShareListItemPermission
...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaShareListItemPermission](/powershell/module/Microsoft.Graph.Beta.Files/New-MgBetaShareListItemPermission?view=graph-powershell-beta)
...
```
New-MgShareListItemPermission -SharedDriveItemId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgShareListItemPermission -ListItemId <string> -SharedDriveItemId <string>
...
```
New-MgShareListItemPermission -SharedDriveItemId <string> -BodyParameter <IMicrosoftGraphPermission>
...
```
New-MgShareListItemPermission -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-ExpirationDateTime <datetime>]
 [-GrantedTo <IMicrosoftGraphIdentitySet>] [-GrantedToIdentities <IMicrosoftGraphIdentitySet[]>]
 [-GrantedToIdentitiesV2 <IMicrosoftGraphSharePointIdentitySet[]>]
 [-GrantedToV2 <IMicrosoftGraphSharePointIdentitySet>] [-HasPassword] [-Id <string>]
...
```
New-MgShareListItemPermission -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphPermission> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgShareListItemPermission](https://learn.microsoft.com/powershell/module/microsoft.graph.files/new-mgsharelistitempermission)
