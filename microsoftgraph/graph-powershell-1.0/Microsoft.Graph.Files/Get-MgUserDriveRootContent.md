...
### Get (Default)
```
Get-MgUserDriveRootContent -DriveId <String> -UserId <String> [-Format <String>] -OutFile <String>
...
### GetViaIdentity
```
Get-MgUserDriveRootContent -InputObject <IFilesIdentity> [-Format <String>] -OutFile <String>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
