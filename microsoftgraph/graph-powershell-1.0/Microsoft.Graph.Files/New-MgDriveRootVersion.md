...
# New-MgDriveRootVersion

## SYNOPSIS
Create new navigation property to versions for drives

> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaDriveRootVersion](/powershell/module/Microsoft.Graph.Beta.Applications/New-MgBetaDriveRootVersion?view=graph-powershell-beta)

## SYNTAX

### CreateExpanded (Default)
```
New-MgDriveRootVersion -DriveId <String> [-AdditionalProperties <Hashtable>] [-ContentInputFile <String>]
...
### Create
```
New-MgDriveRootVersion -DriveId <String> -BodyParameter <IMicrosoftGraphDriveItemVersion> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgDriveRootVersion -InputObject <IFilesIdentity> [-AdditionalProperties <Hashtable>]
...
### CreateViaIdentity
```
New-MgDriveRootVersion -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphDriveItemVersion> [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
## RELATED LINKS
[New-MgBetaDriveRootVersion](/powershell/module/Microsoft.Graph.Beta.Applications/New-MgBetaDriveRootVersion?view=graph-powershell-beta)
