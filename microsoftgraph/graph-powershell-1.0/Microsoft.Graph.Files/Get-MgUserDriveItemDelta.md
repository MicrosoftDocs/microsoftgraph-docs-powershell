...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/get-mguserdriveitemdelta
schema: 2.0.0
...
### Delta (Default)
```
Get-MgUserDriveItemDelta -DriveId <String> -DriveItemId <String> -UserId <String> [-ExpandProperty <String[]>]
...
### DeltaViaIdentity1
```
Get-MgUserDriveItemDelta -InputObject <IFilesIdentity> [-ExpandProperty <String[]>] [-Filter <String>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.files/get-mguserdriveitemdelta](https://learn.microsoft.com/powershell/module/microsoft.graph.files/get-mguserdriveitemdelta)
