...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/get-mguserdriveitemdelta
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: Get-MgUserDriveItemDelta
---
...
```
Get-MgUserDriveItemDelta -DriveId <string> -DriveItemId <string> -UserId <string>
...
```
Get-MgUserDriveItemDelta -InputObject <IFilesIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgUserDriveItemDelta](https://learn.microsoft.com/powershell/module/microsoft.graph.files/get-mguserdriveitemdelta)
