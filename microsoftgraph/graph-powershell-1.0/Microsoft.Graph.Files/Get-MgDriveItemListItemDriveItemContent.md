...
### Get (Default)
```
Get-MgDriveItemListItemDriveItemContent -DriveId <String> -DriveItemId <String> [-Format <String>]
...
### GetViaIdentity
```
Get-MgDriveItemListItemDriveItemContent -InputObject <IFilesIdentity> [-Format <String>] -OutFile <String>
...
## RELATED LINKS
[Get-MgBetaDriveItemListItemDriveItemContent](/powershell/module/Microsoft.Graph.Beta.Files/Get-MgBetaDriveItemListItemDriveItemContent?view=graph-powershell-beta)
