...
### Get (Default)
```
Get-MgUserDriveRootChildContent -DriveId <String> -DriveItemId <String> -UserId <String> [-Format <String>]
...
### GetViaIdentity
```
Get-MgUserDriveRootChildContent -InputObject <IFilesIdentity> [-Format <String>] -OutFile <String>
