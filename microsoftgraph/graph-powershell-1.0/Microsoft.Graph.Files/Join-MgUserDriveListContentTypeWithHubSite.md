...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/join-mguserdrivelistcontenttypewithhubsite
schema: 2.0.0
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Join-MgBetaUserDriveListContentTypeWithHubSite](/powershell/module/Microsoft.Graph.Beta.Files/Join-MgBetaUserDriveListContentTypeWithHubSite?view=graph-powershell-beta)
...
```
Join-MgUserDriveListContentTypeWithHubSite -InputObject <IFilesIdentity> [-ResponseHeadersVariable <String>]
...
```
Join-MgUserDriveListContentTypeWithHubSite -InputObject <IFilesIdentity>
 -BodyParameter <IPaths7Q2KgfUsersUserIdDrivesDriveIdListContenttypesContenttypeIdMicrosoftGraphAssociatewithhubsitesPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.files/join-mguserdrivelistcontenttypewithhubsite](https://learn.microsoft.com/powershell/module/microsoft.graph.files/join-mguserdrivelistcontenttypewithhubsite)
