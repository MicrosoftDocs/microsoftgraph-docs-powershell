...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mgsharelistitemversion
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: Update-MgShareListItemVersion
---
...
```
Update-MgShareListItemVersion -ListItemId <string> -ListItemVersionId <string>
...
```
Update-MgShareListItemVersion -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgShareListItemVersion -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphListItemVersion> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm] [<CommonParameters>]
