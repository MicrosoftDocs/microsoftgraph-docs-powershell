...
### Search (Default)
```
Search-MgDrive -DriveId <String> -Q <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### SearchViaIdentity
```
Search-MgDrive -InputObject <IFilesIdentity> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
 [-Property <String[]>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>] [-Top <Int32>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.files/search-mgdrive](https://learn.microsoft.com/powershell/module/microsoft.graph.files/search-mgdrive)
