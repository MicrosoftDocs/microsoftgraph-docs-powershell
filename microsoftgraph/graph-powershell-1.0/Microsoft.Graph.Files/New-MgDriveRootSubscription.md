...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaDriveRootSubscription](/powershell/module/Microsoft.Graph.Beta.Applications/New-MgBetaDriveRootSubscription?view=graph-powershell-beta)
...
### Create
```
New-MgDriveRootSubscription -DriveId <String> -BodyParameter <IMicrosoftGraphSubscription> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
## RELATED LINKS
[New-MgBetaDriveRootSubscription](/powershell/module/Microsoft.Graph.Beta.Applications/New-MgBetaDriveRootSubscription?view=graph-powershell-beta)
