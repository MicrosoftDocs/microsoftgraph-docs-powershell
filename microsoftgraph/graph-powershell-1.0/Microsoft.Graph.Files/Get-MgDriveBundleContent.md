...
### Get (Default)
```
Get-MgDriveBundleContent -DriveId <String> -DriveItemId <String> [-Format <String>] -OutFile <String>
...
### GetViaIdentity
```
Get-MgDriveBundleContent -InputObject <IFilesIdentity> [-Format <String>] -OutFile <String>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
