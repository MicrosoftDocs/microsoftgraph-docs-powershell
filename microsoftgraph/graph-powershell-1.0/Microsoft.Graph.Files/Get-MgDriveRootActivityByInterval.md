...
### Get (Default)
```
Get-MgDriveRootActivityByInterval -DriveId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity1
```
Get-MgDriveRootActivityByInterval -InputObject <IFilesIdentity> [-Count] [-ExpandProperty <String[]>]
