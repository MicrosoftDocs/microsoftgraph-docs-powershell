...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/get-mgdriverootactivitybyinterval
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Get-MgDriveRootActivityByInterval
---
...
```
Get-MgDriveRootActivityByInterval -DriveId <string> [-Count] [-ExpandProperty <string[]>]
...
```
Get-MgDriveRootActivityByInterval -InputObject <IFilesIdentity> [-Count]
