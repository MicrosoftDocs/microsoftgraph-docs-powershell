...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaUserDriveListSubscription](/powershell/module/Microsoft.Graph.Beta.Applications/New-MgBetaUserDriveListSubscription?view=graph-powershell-beta)
...
### Create
```
New-MgUserDriveListSubscription -DriveId <String> -UserId <String> -BodyParameter <IMicrosoftGraphSubscription>
...
## RELATED LINKS
[New-MgBetaUserDriveListSubscription](/powershell/module/Microsoft.Graph.Beta.Applications/New-MgBetaUserDriveListSubscription?view=graph-powershell-beta)
