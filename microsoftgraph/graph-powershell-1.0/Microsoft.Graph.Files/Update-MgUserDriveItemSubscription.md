...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mguserdriveitemsubscription
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Update-MgUserDriveItemSubscription
---
...
```
Update-MgUserDriveItemSubscription -DriveId <string> -DriveItemId <string> -SubscriptionId <string>
 -UserId <string> -BodyParameter <IMicrosoftGraphSubscription> [-ResponseHeadersVariable <string>]
...
```
Update-MgUserDriveItemSubscription -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgUserDriveItemSubscription -InputObject <IFilesIdentity>
...
- [Update-MgUserDriveItemSubscription](https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mguserdriveitemsubscription)
