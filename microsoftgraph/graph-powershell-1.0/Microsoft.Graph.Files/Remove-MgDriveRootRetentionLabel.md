...
### Delete (Default)
```
Remove-MgDriveRootRetentionLabel -DriveId <String> [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgDriveRootRetentionLabel -InputObject <IFilesIdentity> [-IfMatch <String>] [-PassThru] [-WhatIf]
