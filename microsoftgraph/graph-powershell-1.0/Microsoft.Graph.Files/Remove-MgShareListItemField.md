...
### Delete1 (Default)
```
Remove-MgShareListItemField -SharedDriveItemId <String> [-IfMatch <String>] [-Headers <IDictionary>]
...
### DeleteViaIdentity1
```
Remove-MgShareListItemField -InputObject <IFilesIdentity> [-IfMatch <String>] [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
