...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/get-mguserdriveitemactivitybyinterval
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: Get-MgUserDriveItemActivityByInterval
---
...
```
Get-MgUserDriveItemActivityByInterval -InputObject <IFilesIdentity> [-Count]
 [-ExpandProperty <string[]>] [-Filter <string>] [-Property <string[]>] [-Search <string>]
 [-Skip <int>] [-Sort <string[]>] [-Top <int>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
...
- [Get-MgUserDriveItemActivityByInterval](https://learn.microsoft.com/powershell/module/microsoft.graph.files/get-mguserdriveitemactivitybyinterval)
