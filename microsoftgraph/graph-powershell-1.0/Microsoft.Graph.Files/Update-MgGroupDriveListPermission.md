...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mggroupdrivelistpermission
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Update-MgGroupDriveListPermission
---

# Update-MgGroupDriveListPermission
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaGroupDriveListPermission](/powershell/module/Microsoft.Graph.Beta.Files/Update-MgBetaGroupDriveListPermission?view=graph-powershell-beta)
...
```
Update-MgGroupDriveListPermission -DriveId <string> -GroupId <string> -PermissionId <string>
...
```
Update-MgGroupDriveListPermission -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgGroupDriveListPermission -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphPermission> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [Update-MgGroupDriveListPermission](https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mggroupdrivelistpermission)
