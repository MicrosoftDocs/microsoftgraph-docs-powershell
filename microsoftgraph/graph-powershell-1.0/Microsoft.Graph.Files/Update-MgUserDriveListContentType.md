...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mguserdrivelistcontenttype
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: Update-MgUserDriveListContentType
---
...
```
Update-MgUserDriveListContentType -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgUserDriveListContentType -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphContentType> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [Update-MgUserDriveListContentType](https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mguserdrivelistcontenttype)
