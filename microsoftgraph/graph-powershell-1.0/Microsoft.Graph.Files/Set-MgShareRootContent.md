...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/set-mgsharerootcontent
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Set-MgShareRootContent
---
...
```
Set-MgShareRootContent -SharedDriveItemId <string> -InFile <string> [-Data <Stream>]
...
```
Set-MgShareRootContent -InputObject <IFilesIdentity> -InFile <string> [-Data <Stream>]
 [-ResponseHeadersVariable <string>] [-Break] [-ContentType <string>] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
 [<CommonParameters>]
