...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/new-mgdriveitemsubscription
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: New-MgDriveItemSubscription
---
...
```
New-MgDriveItemSubscription -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
...
```
New-MgDriveItemSubscription -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphSubscription> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgDriveItemSubscription](https://learn.microsoft.com/powershell/module/microsoft.graph.files/new-mgdriveitemsubscription)
