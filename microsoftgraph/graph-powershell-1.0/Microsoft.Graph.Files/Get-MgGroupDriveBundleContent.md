...
### Get (Default)
```
Get-MgGroupDriveBundleContent -DriveId <String> -DriveItemId <String> -GroupId <String> [-Format <String>]
...
### GetViaIdentity
```
Get-MgGroupDriveBundleContent -InputObject <IFilesIdentity> [-Format <String>] -OutFile <String>
