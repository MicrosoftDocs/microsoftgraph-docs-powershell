...
```
Get-MgDriveItemDelta -DriveId <string> -DriveItemId <string> [-ExpandProperty <string[]>]
...
```
Get-MgDriveItemDelta -DriveId <string> -DriveItemId <string> -Token <string>
...
```
Get-MgDriveItemDelta -InputObject <IFilesIdentity> [-ExpandProperty <string[]>] [-Filter <string>]
