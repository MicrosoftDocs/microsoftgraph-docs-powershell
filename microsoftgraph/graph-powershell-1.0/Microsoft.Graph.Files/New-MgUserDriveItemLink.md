...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/new-mguserdriveitemlink
schema: 2.0.0
...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaUserDriveItemLink](/powershell/module/Microsoft.Graph.Beta.Files/New-MgBetaUserDriveItemLink?view=graph-powershell-beta)
...
```
New-MgUserDriveItemLink -InputObject <IFilesIdentity> [-ResponseHeadersVariable <String>]
...
### CreateViaIdentity
```
New-MgUserDriveItemLink -InputObject <IFilesIdentity>
 -BodyParameter <IPathsQt4Ae8UsersUserIdDrivesDriveIdItemsDriveitemIdMicrosoftGraphCreatelinkPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.files/new-mguserdriveitemlink](https://learn.microsoft.com/powershell/module/microsoft.graph.files/new-mguserdriveitemlink)
