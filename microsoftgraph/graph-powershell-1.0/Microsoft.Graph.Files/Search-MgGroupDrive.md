...
```
Search-MgGroupDrive -DriveId <string> -GroupId <string> -Q <string> [-Count]
...
```
Search-MgGroupDrive -InputObject <IFilesIdentity> [-Count] [-ExpandProperty <string[]>]
