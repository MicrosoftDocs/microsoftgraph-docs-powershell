...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/search-mggroupdrive
schema: 2.0.0
...
### Search (Default)
```
Search-MgGroupDrive -DriveId <String> -GroupId <String> -Q <String> [-Count] [-ExpandProperty <String[]>]
...
### SearchViaIdentity
```
Search-MgGroupDrive -InputObject <IFilesIdentity> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.files/search-mggroupdrive](https://learn.microsoft.com/powershell/module/microsoft.graph.files/search-mggroupdrive)
