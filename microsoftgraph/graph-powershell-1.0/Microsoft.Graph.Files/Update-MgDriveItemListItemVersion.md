...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mgdriveitemlistitemversion
schema: 2.0.0
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaDriveItemListItemVersion](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaDriveItemListItemVersion?view=graph-powershell-beta)

## SYNTAX

### UpdateExpanded (Default)
```
Update-MgDriveItemListItemVersion -DriveId <String> -DriveItemId <String> -ListItemVersionId <String>
...
```
Update-MgDriveItemListItemVersion -InputObject <IFilesIdentity> [-AdditionalProperties <Hashtable>]
...
### UpdateViaIdentity
```
Update-MgDriveItemListItemVersion -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphListItemVersion>
...
## RELATED LINKS
[Update-MgBetaDriveItemListItemVersion](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaDriveItemListItemVersion?view=graph-powershell-beta)
