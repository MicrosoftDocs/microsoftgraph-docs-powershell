...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaShareListContentTypeColumn](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaShareListContentTypeColumn?view=graph-powershell-beta)
...
```
Update-MgShareListContentTypeColumn -ColumnDefinitionId <String> -ContentTypeId <String>
 -SharedDriveItemId <String> -BodyParameter <IMicrosoftGraphColumnDefinition> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgBetaShareListContentTypeColumn](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaShareListContentTypeColumn?view=graph-powershell-beta)
