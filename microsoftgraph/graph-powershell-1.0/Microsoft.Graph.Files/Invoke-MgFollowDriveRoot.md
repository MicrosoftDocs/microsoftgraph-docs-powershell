...
### Follow (Default)
```
Invoke-MgFollowDriveRoot -DriveId <String> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### FollowViaIdentity
```
Invoke-MgFollowDriveRoot -InputObject <IFilesIdentity> [-ResponseHeadersVariable <String>]
