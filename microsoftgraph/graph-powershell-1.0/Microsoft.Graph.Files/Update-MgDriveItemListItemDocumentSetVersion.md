...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaDriveItemListItemDocumentSetVersion](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaDriveItemListItemDocumentSetVersion?view=graph-powershell-beta)
...
```
Update-MgDriveItemListItemDocumentSetVersion -DocumentSetVersionId <String> -DriveId <String>
 -DriveItemId <String> -BodyParameter <IMicrosoftGraphDocumentSetVersion> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgBetaDriveItemListItemDocumentSetVersion](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaDriveItemListItemDocumentSetVersion?view=graph-powershell-beta)
