...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mggroupdriverootlistitempermission
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Update-MgGroupDriveRootListItemPermission
---

# Update-MgGroupDriveRootListItemPermission
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaGroupDriveRootListItemPermission](/powershell/module/Microsoft.Graph.Beta.Files/Update-MgBetaGroupDriveRootListItemPermission?view=graph-powershell-beta)
...
```
Update-MgGroupDriveRootListItemPermission -DriveId <string> -GroupId <string> -PermissionId <string>
...
```
Update-MgGroupDriveRootListItemPermission -InputObject <IFilesIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-ExpirationDateTime <datetime>] [-GrantedTo <IMicrosoftGraphIdentitySet>]
 [-GrantedToIdentities <IMicrosoftGraphIdentitySet[]>]
 [-GrantedToIdentitiesV2 <IMicrosoftGraphSharePointIdentitySet[]>]
...
- [Update-MgGroupDriveRootListItemPermission](https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mggroupdriverootlistitempermission)
