...
### Get1 (Default)
```
Get-MgDriveListItemActivityByInterval -DriveId <String> -ListItemId <String> [<CommonParameters>]
```
...
### GetViaIdentity2
```
Get-MgDriveListItemActivityByInterval -InputObject <IFilesIdentity> [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/get-mgdrivelistitemactivitybyinterval](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/get-mgdrivelistitemactivitybyinterval)
