...
```
Update-MgUserDriveRootListItemField -DriveId <String> -UserId <String> [-ResponseHeadersVariable <String>]
...
```
Update-MgUserDriveRootListItemField -InputObject <IFilesIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-Id <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
