...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaDriveListSubscription](/powershell/module/Microsoft.Graph.Beta.Applications/New-MgBetaDriveListSubscription?view=graph-powershell-beta)
...
### Create
```
New-MgDriveListSubscription -DriveId <String> -BodyParameter <IMicrosoftGraphSubscription> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
## RELATED LINKS
[New-MgBetaDriveListSubscription](/powershell/module/Microsoft.Graph.Beta.Applications/New-MgBetaDriveListSubscription?view=graph-powershell-beta)
