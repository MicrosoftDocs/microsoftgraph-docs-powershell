...
```
Update-MgDriveItemListItem -DriveId <String> -DriveItemId <String> [-AdditionalProperties <Hashtable>]
...
### Update1
```
Update-MgDriveItemListItem -DriveId <String> -DriveItemId <String> -BodyParameter <IMicrosoftGraphListItem>
 [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UpdateViaIdentityExpanded1
```
Update-MgDriveItemListItem -InputObject <IFilesIdentity> [-AdditionalProperties <Hashtable>]
 [-Analytics <IMicrosoftGraphItemAnalytics>] [-ContentType <IMicrosoftGraphContentTypeInfo>]
 [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedByUser <IMicrosoftGraphUser>] [-CreatedDateTime <DateTime>]
 [-Description <String>] [-DriveItem <IMicrosoftGraphDriveItem>] [-ETag <String>] [-Fields <Hashtable>]
 [-Id <String>] [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-LastModifiedByUser <IMicrosoftGraphUser>]
...
### UpdateViaIdentity1
```
Update-MgDriveItemListItem -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphListItem> [-PassThru]
