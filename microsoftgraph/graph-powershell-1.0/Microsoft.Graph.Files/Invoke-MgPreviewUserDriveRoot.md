...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/invoke-mgpreviewuserdriveroot
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Invoke-MgPreviewUserDriveRoot
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Invoke-MgBetaPreviewUserDriveRoot](/powershell/module/Microsoft.Graph.Beta.Files/Invoke-MgBetaPreviewUserDriveRoot?view=graph-powershell-beta)
...
```
Invoke-MgPreviewUserDriveRoot -DriveId <string> -UserId <string> [-ResponseHeadersVariable <string>]
...
```
Invoke-MgPreviewUserDriveRoot -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Page <string>] [-Zoom <double>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm] [<CommonParameters>]
...
```
Invoke-MgPreviewUserDriveRoot -InputObject <IFilesIdentity>
 -BodyParameter <IPaths1H3Ys40UsersUserIdDrivesDriveIdRootMicrosoftGraphPreviewPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.files/invoke-mgpreviewuserdriveroot)
