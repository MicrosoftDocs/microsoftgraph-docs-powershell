...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/invoke-mgpreviewgroupdriveitem
schema: 2.0.0
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Invoke-MgBetaPreviewGroupDriveItem](/powershell/module/Microsoft.Graph.Beta.Files/Invoke-MgBetaPreviewGroupDriveItem?view=graph-powershell-beta)
...
```
Invoke-MgPreviewGroupDriveItem -InputObject <IFilesIdentity> [-ResponseHeadersVariable <String>]
...
### PreviewViaIdentity
```
Invoke-MgPreviewGroupDriveItem -InputObject <IFilesIdentity>
 -BodyParameter <IPaths1Rxt39KGroupsGroupIdDrivesDriveIdItemsDriveitemIdMicrosoftGraphPreviewPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.files/invoke-mgpreviewgroupdriveitem](https://learn.microsoft.com/powershell/module/microsoft.graph.files/invoke-mgpreviewgroupdriveitem)
