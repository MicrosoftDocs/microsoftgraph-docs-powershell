...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mgdriverootlistitempermission
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Update-MgDriveRootListItemPermission
---

# Update-MgDriveRootListItemPermission
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaDriveRootListItemPermission](/powershell/module/Microsoft.Graph.Beta.Files/Update-MgBetaDriveRootListItemPermission?view=graph-powershell-beta)
...
```
Update-MgDriveRootListItemPermission -DriveId <string> -PermissionId <string>
...
```
Update-MgDriveRootListItemPermission -InputObject <IFilesIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-ExpirationDateTime <datetime>] [-GrantedTo <IMicrosoftGraphIdentitySet>]
 [-GrantedToIdentities <IMicrosoftGraphIdentitySet[]>]
 [-GrantedToIdentitiesV2 <IMicrosoftGraphSharePointIdentitySet[]>]
...
- [Update-MgDriveRootListItemPermission](https://learn.microsoft.com/powershell/module/microsoft.graph.files/update-mgdriverootlistitempermission)
