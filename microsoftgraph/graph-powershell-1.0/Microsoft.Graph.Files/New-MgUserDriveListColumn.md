...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/new-mguserdrivelistcolumn
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: New-MgUserDriveListColumn
---
...
```
New-MgUserDriveListColumn -DriveId <string> -UserId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgUserDriveListColumn -DriveId <string> -UserId <string>
...
```
New-MgUserDriveListColumn -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Boolean <hashtable>]
 [-Calculated <IMicrosoftGraphCalculatedColumn>] [-Choice <IMicrosoftGraphChoiceColumn>]
 [-ColumnGroup <string>] [-ContentApprovalStatus <hashtable>]
 [-Currency <IMicrosoftGraphCurrencyColumn>] [-DateTime <IMicrosoftGraphDateTimeColumn>]
...
```
New-MgUserDriveListColumn -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphColumnDefinition> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgUserDriveListColumn](https://learn.microsoft.com/powershell/module/microsoft.graph.files/new-mguserdrivelistcolumn)
