...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/new-mguserdrivelistitempermission
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: New-MgUserDriveListItemPermission
---

# New-MgUserDriveListItemPermission
...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaUserDriveListItemPermission](/powershell/module/Microsoft.Graph.Beta.Files/New-MgBetaUserDriveListItemPermission?view=graph-powershell-beta)
...
```
New-MgUserDriveListItemPermission -DriveId <string> -ListItemId <string> -UserId <string>
...
```
New-MgUserDriveListItemPermission -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
...
```
New-MgUserDriveListItemPermission -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphPermission> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgUserDriveListItemPermission](https://learn.microsoft.com/powershell/module/microsoft.graph.files/new-mguserdrivelistitempermission)
