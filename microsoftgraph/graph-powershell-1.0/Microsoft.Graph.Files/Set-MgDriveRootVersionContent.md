...
### Set (Default)
```
Set-MgDriveRootVersionContent -DriveId <String> -DriveItemVersionId <String> [-Data <Stream>]
...
### SetViaIdentity
```
Set-MgDriveRootVersionContent -InputObject <IFilesIdentity> [-Data <Stream>]
 [-ResponseHeadersVariable <String>] -InFile <String> [-ContentType <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
