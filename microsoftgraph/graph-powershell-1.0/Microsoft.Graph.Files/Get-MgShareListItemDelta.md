...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/get-mgsharelistitemdelta
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Get-MgShareListItemDelta
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaShareListItemDelta](/powershell/module/Microsoft.Graph.Beta.Files/Get-MgBetaShareListItemDelta?view=graph-powershell-beta)
...
```
Get-MgShareListItemDelta -InputObject <IFilesIdentity> [-ExpandProperty <string[]>]
 [-Filter <string>] [-Property <string[]>] [-Search <string>] [-Skip <int>] [-Sort <string[]>]
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.files/get-mgsharelistitemdelta)
