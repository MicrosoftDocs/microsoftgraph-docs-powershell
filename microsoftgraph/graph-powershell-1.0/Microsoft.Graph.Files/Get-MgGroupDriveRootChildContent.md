...
### Get (Default)
```
Get-MgGroupDriveRootChildContent -DriveId <String> -DriveItemId <String> -GroupId <String> [-Format <String>]
...
### GetViaIdentity
```
Get-MgGroupDriveRootChildContent -InputObject <IFilesIdentity> [-Format <String>] -OutFile <String>
