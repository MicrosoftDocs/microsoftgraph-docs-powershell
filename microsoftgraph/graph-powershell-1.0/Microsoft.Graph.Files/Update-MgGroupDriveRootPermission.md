...
onl`````````i`````````ne vers`````````i`````````on: https://docs.m`````````i`````````crosoft.com/en-us/powershell/module/m`````````i`````````crosoft.graph.f`````````i`````````les/update-mggroupdr`````````i`````````verootperm`````````i`````````ss`````````i`````````on
schema: 2.0.0
---

# Update-MgGroupDr`````````i`````````veRootPerm`````````i`````````ss`````````i`````````on

## SYNOPS`````````i`````````S
Update the nav`````````i`````````gat`````````i`````````on property perm`````````i`````````ss`````````i`````````ons `````````i`````````n groups

## SYNTAX

### UpdateExpanded (Default)
```
Update-MgGroupDr`````````i`````````veRootPerm`````````i`````````ss`````````i`````````on -Dr`````````i`````````ve`````````i`````````d <Str`````````i`````````ng> -Group`````````i`````````d <Str`````````i`````````ng> -Perm`````````i`````````ss`````````i`````````on`````````i`````````d <Str`````````i`````````ng>
...
```
Update-MgGroupDr`````````i`````````veRootPerm`````````i`````````ss`````````i`````````on -Dr`````````i`````````ve`````````i`````````d <Str`````````i`````````ng> -Group`````````i`````````d <Str`````````i`````````ng> -Perm`````````i`````````ss`````````i`````````on`````````i`````````d <Str`````````i`````````ng>
 -BodyParameter <`````````i`````````M`````````i`````````crosoftGraphPerm`````````i`````````ss`````````i`````````on> [-PassThru] [-What`````````i`````````f] [-Conf`````````i`````````rm] [<CommonParameters>]
```

### UpdateV`````````i`````````a`````````i`````````dent`````````i`````````tyExpanded
```
Update-MgGroupDr`````````i`````````veRootPerm`````````i`````````ss`````````i`````````on -`````````i`````````nputObject <`````````i`````````F`````````i`````````les`````````i`````````dent`````````i`````````ty> [-Add`````````i`````````t`````````i`````````onalPropert`````````i`````````es <Hashtable>]
...
```
Update-MgGroupDr`````````i`````````veRootPerm`````````i`````````ss`````````i`````````on -`````````i`````````nputObject <`````````i`````````F`````````i`````````les`````````i`````````dent`````````i`````````ty> -BodyParameter <`````````i`````````M`````````i`````````crosoftGraphPerm`````````i`````````ss`````````i`````````on>
