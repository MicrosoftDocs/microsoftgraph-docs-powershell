...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/copy-mguserdriveitem
schema: 2.0.0
...
```
Copy-MgUserDriveItem -InputObject <IFilesIdentity> [-ResponseHeadersVariable <String>]
...
### CopyViaIdentity
```
Copy-MgUserDriveItem -InputObject <IFilesIdentity>
 -BodyParameter <IPaths8Bxd2FUsersUserIdDrivesDriveIdItemsDriveitemIdMicrosoftGraphCopyPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
