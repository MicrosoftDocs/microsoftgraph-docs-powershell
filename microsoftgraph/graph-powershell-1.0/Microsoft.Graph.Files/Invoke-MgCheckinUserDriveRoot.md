...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/invoke-mgcheckinuserdriveroot
schema: 2.0.0
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Invoke-MgBetaCheckinUserDriveRoot](/powershell/module/Microsoft.Graph.Beta.Files/Invoke-MgBetaCheckinUserDriveRoot?view=graph-powershell-beta)

## SYNTAX

### CheckinExpanded (Default)
```
Invoke-MgCheckinUserDriveRoot -DriveId <String> -UserId <String> [-ResponseHeadersVariable <String>]
...
```
Invoke-MgCheckinUserDriveRoot -InputObject <IFilesIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-CheckInAs <String>] [-Comment <String>] [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.files/invoke-mgcheckinuserdriveroot](https://learn.microsoft.com/powershell/module/microsoft.graph.files/invoke-mgcheckinuserdriveroot)
