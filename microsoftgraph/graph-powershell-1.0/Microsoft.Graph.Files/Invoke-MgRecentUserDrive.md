...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.files/invoke-mgrecentuserdrive
schema: 2.0.0
...
### RecentViaIdentity
```
Invoke-MgRecentUserDrive -InputObject <IFilesIdentity> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.files/invoke-mgrecentuserdrive](https://learn.microsoft.com/powershell/module/microsoft.graph.files/invoke-mgrecentuserdrive)
