...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/new-mgdriveitemthumbnail
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: New-MgDriveItemThumbnail
---
...
```
New-MgDriveItemThumbnail -DriveId <string> -DriveItemId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgDriveItemThumbnail -DriveId <string> -DriveItemId <string>
...
```
New-MgDriveItemThumbnail -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Id <string>] [-Large <IMicrosoftGraphThumbnail>]
 [-Medium <IMicrosoftGraphThumbnail>] [-Small <IMicrosoftGraphThumbnail>]
 [-Source <IMicrosoftGraphThumbnail>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
