...
onl`````````i`````````ne vers`````````i`````````on: https://docs.m`````````i`````````crosoft.com/en-us/powershell/module/m`````````i`````````crosoft.graph.f`````````i`````````les/update-mgdr`````````i`````````ve`````````i`````````temperm`````````i`````````ss`````````i`````````on
schema: 2.0.0
---

# Update-MgDr`````````i`````````ve`````````i`````````temPerm`````````i`````````ss`````````i`````````on

## SYNOPS`````````i`````````S
Update the nav`````````i`````````gat`````````i`````````on property perm`````````i`````````ss`````````i`````````ons `````````i`````````n dr`````````i`````````ves

## SYNTAX

### UpdateExpanded1 (Default)
```
Update-MgDr`````````i`````````ve`````````i`````````temPerm`````````i`````````ss`````````i`````````on -Dr`````````i`````````ve`````````i`````````d <Str`````````i`````````ng> -Dr`````````i`````````ve`````````i`````````tem`````````i`````````d <Str`````````i`````````ng> -Perm`````````i`````````ss`````````i`````````on`````````i`````````d <Str`````````i`````````ng>
...
```
Update-MgDr`````````i`````````ve`````````i`````````temPerm`````````i`````````ss`````````i`````````on -`````````i`````````nputObject <`````````i`````````F`````````i`````````les`````````i`````````dent`````````i`````````ty> [-Add`````````i`````````t`````````i`````````onalPropert`````````i`````````es <Hashtable>]
...
```
Update-MgDr`````````i`````````ve`````````i`````````temPerm`````````i`````````ss`````````i`````````on -`````````i`````````nputObject <`````````i`````````F`````````i`````````les`````````i`````````dent`````````i`````````ty> -BodyParameter <`````````i`````````M`````````i`````````crosoftGraphPerm`````````i`````````ss`````````i`````````on>
