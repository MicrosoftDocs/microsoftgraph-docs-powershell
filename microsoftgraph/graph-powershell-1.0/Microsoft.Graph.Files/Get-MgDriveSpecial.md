...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.files/get-mgdrivespecial
Locale: en-US
Module Name: Microsoft.Graph.Files
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: Get-MgDriveSpecial
---
...
```
Get-MgDriveSpecial -DriveId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgDriveSpecial -DriveId <string> -DriveItemId <string> [-ExpandProperty <string[]>]
...
- [Get-MgDriveSpecial](https://learn.microsoft.com/powershell/module/microsoft.graph.files/get-mgdrivespecial)
