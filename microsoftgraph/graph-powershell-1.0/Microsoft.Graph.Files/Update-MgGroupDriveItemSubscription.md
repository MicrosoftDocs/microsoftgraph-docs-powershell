...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaGroupDriveItemSubscription](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaGroupDriveItemSubscription?view=graph-powershell-beta)
...
```
Update-MgGroupDriveItemSubscription -DriveId <String> -DriveItemId <String> -GroupId <String>
 -SubscriptionId <String> -BodyParameter <IMicrosoftGraphSubscription> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgBetaGroupDriveItemSubscription](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaGroupDriveItemSubscription?view=graph-powershell-beta)
