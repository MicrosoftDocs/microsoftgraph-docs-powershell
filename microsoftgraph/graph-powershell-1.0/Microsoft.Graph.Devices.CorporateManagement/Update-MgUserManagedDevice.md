...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgusermanageddevice
Locale: en-US
Module Name: Microsoft.Graph.Devices.CorporateManagement
ms.date: 10/10/2025
PlatyPS schema version: 2024-05-01
title: Update-MgUserManagedDevice
---
...
Update-MgUserManagedDevice -ManagedDeviceId <string> -UserId <string>
 ...
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
Update-MgUserManagedDevice -ManagedDeviceId <string> -UserId <string>
 ...
 [-LogCollectionRequests <IMicrosoftGraphDeviceLogCollectionResponse[]>]
...
```
Update-MgUserManagedDevice -ManagedDeviceId <string> -UserId <string>
 -BodyParameter <IMicrosoftGraphManagedDevice> [-ResponseHeadersVariable <string>] [-Break]
...
- [Graph API Reference](https://learn.microsoft.com/graph/api/intune-devices-manageddevice-windowsdefenderupdatesignatures?view=graph-rest-1.0)
