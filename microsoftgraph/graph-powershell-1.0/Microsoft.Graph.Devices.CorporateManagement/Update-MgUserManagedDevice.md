...
Update-MgUserManagedDevice -ManagedDeviceId <String> -UserId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-WindowsProtectionState <IMicrosoftGraphWindowsProtectionState>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Update
```
Update-MgUserManagedDevice -ManagedDeviceId <String> -UserId <String>
 -BodyParameter <IMicrosoftGraphManagedDevice> [-WhatIf] [-Confirm] [<CommonParameters>]
```
