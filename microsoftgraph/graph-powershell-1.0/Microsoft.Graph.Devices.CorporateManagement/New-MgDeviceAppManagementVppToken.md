...
```
New-MgDeviceAppManagementVppToken [-ResponseHeadersVariable <string>]
 ...
 [-Token <string>] [-VppTokenAccountType <VppTokenAccountType>] [-Break] [-Headers <IDictionary>]
...
```
New-MgDeviceAppManagementVppToken -BodyParameter <IMicrosoftGraphVppToken>
