...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/remove-mgdeviceappmanagementmobileappaswindowsuniversalappxassignment
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgDeviceAppManagementMobileAppAsWindowsUniversalAppXAssignment -MobileAppAssignmentId <String>
