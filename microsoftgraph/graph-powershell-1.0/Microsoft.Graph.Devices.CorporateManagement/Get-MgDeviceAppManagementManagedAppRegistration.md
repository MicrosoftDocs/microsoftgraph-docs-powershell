...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgdeviceappmanagementmanagedappregistration
Locale: en-US
Module Name: Microsoft.Graph.Devices.CorporateManagement
ms.date: 10/03/2025
PlatyPS schema version: 2024-05-01
title: Get-MgDeviceAppManagementManagedAppRegistration
---
...
```
Get-MgDeviceAppManagementManagedAppRegistration [-ExpandProperty <string[]>] [-Property <string[]>]
...
- [Get-MgDeviceAppManagementManagedAppRegistration](https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgdeviceappmanagementmanagedappregistration)
- [Graph API Reference](https://learn.microsoft.com/graph/api/intune-mam-iosmanagedappregistration-get?view=graph-rest-1.0)
- [Graph API Reference](https://learn.microsoft.com/graph/api/intune-mam-androidmanagedappregistration-list?view=graph-rest-1.0)
