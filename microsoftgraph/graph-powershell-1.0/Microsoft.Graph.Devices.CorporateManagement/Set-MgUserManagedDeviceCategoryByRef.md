...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/set-mgusermanageddevicecategorybyref
schema: 2.0.0
---
...
### SetExpanded (Default)
```
Set-MgUserManagedDeviceCategoryByRef -ManagedDeviceId <String> -UserId <String>
...
```
Set-MgUserManagedDeviceCategoryByRef -InputObject <IDevicesCorporateManagementIdentity>
 [-ResponseHeadersVariable <String>] -OdataId <String> [-AdditionalProperties <Hashtable>]
 [-OdataType <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/set-mgusermanageddevicecategorybyref](https://learn.microsoft.com/powershell/module/microsoft.graph.devices.corporatemanagement/set-mgusermanageddevicecategorybyref)
