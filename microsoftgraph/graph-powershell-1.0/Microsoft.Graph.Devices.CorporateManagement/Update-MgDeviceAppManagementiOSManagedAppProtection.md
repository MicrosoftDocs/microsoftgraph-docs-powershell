...
Update-MgDeviceAppManagementiOSManagedAppProtection -IosManagedAppProtectionId <string>
 ...
 [-Description <string>] [-DeviceComplianceRequired] [-DisableAppPinIfDevicePinIsSet]
 [-DisplayName <string>] [-FaceIdBlocked] [-FingerprintBlocked] [-Id <string>] [-IsAssigned]
 [-LastModifiedDateTime <datetime>] [-ManagedBrowser <ManagedBrowserType>]
 [-ManagedBrowserToOpenLinksRequired] [-MaximumPinRetries <int>] [-MinimumPinLength <int>]
 ...
 [-MinimumWarningOSVersion <string>] [-OrganizationalCredentialsRequired]
 ...
 [-SimplePinBlocked] [-Version <string>] [-Break] [-Headers <IDictionary>]
