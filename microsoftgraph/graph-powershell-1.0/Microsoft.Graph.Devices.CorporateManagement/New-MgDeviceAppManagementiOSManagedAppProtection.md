...
```
New-MgDeviceAppManagementiOSManagedAppProtection [-ResponseHeadersVariable <string>]
...
- [Graph API Reference](https://learn.microsoft.com/graph/api/intune-mam-iosmanagedappprotection-create?view=graph-rest-1.0)
