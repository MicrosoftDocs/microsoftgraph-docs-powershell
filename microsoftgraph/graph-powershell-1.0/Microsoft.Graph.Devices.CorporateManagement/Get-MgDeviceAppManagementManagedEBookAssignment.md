...
```
Get-MgDeviceAppManagementManagedEBookAssignment -ManagedEBookId <string>
...
```
Get-MgDeviceAppManagementManagedEBookAssignment -ManagedEBookAssignmentId <string>
...
- [Graph API Reference](https://learn.microsoft.com/graph/api/intune-books-iosvppebookassignment-get?view=graph-rest-1.0)
