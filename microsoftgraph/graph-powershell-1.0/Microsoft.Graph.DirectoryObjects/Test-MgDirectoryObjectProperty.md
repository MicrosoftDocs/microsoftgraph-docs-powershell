...
```
Test-MgDirectoryObjectProperty [-ResponseHeadersVariable <string>]
...
- [Test-MgDirectoryObjectProperty](https://learn.microsoft.com/powershell/module/microsoft.graph.directoryobjects/test-mgdirectoryobjectproperty)
