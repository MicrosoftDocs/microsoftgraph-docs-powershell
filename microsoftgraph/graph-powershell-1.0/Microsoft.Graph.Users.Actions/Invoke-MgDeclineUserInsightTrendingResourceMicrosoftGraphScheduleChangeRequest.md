...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/invoke-mgdeclineuserinsighttrendingresourcemicrosoftgraphschedulechangerequest
schema: 2.0.0
---
...
```
Invoke-MgDeclineUserInsightTrendingResourceMicrosoftGraphScheduleChangeRequest -TrendingId <String>
...
```yaml
Type: IPaths3F0K5HUsersUserIdInsightsTrendingIdResourceMicrosoftGraphSchedulechangerequestMicrosoftGraphDeclinePostRequestbodyContentApplicationJsonSchema
