...
### Extract (Default)
```
Invoke-MgExtractUserDriveRootSensitivityLabel -DriveId <String> -UserId <String>
...
### ExtractViaIdentity
```
Invoke-MgExtractUserDriveRootSensitivityLabel -InputObject <IUsersActionsIdentity>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
