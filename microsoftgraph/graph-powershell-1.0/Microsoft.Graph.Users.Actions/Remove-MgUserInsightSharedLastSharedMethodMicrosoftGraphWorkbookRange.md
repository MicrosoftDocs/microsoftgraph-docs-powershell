...
Remove-MgUserInsightSharedLastSharedMethodMicrosoftGraphWorkbookRange -SharedInsightId <String>
 -UserId <String> [-AdditionalProperties <Hashtable>] [-Shift <String>] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```yaml
Type: IPaths1Rv2CynUsersUserIdInsightsSharedSharedinsightIdLastsharedmethodMicrosoftGraphWorkbookrangeMicrosoftGraphDeletePostRequestbodyContentApplicationJsonSchema
