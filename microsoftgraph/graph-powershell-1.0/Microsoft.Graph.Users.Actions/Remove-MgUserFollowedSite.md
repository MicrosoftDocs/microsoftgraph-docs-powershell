...
> [!NOTE]
> To view the beta release of this cmdlet, view [Remove-MgBetaUserFollowedSite](/powershell/module/Microsoft.Graph.Beta.Users.Actions/Remove-MgBetaUserFollowedSite?view=graph-powershell-beta)
...
```
Remove-MgUserFollowedSite -InputObject <IUsersActionsIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-Value <IMicrosoftGraphSite[]>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
## RELATED LINKS
[Remove-MgBetaUserFollowedSite](/powershell/module/Microsoft.Graph.Beta.Users.Actions/Remove-MgBetaUserFollowedSite?view=graph-powershell-beta)
