...
### Publish (Default)
```
Publish-MgUserDriveListContentType -ContentTypeId <String> -DriveId <String> -UserId <String>
...
### PublishViaIdentity
```
Publish-MgUserDriveListContentType -InputObject <IUsersActionsIdentity> [-ResponseHeadersVariable <String>]
