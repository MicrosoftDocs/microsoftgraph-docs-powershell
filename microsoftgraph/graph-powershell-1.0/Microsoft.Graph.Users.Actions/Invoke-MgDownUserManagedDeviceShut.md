...
### Down (Default)
```
Invoke-MgDownUserManagedDeviceShut -ManagedDeviceId <String> -UserId <String> [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DownViaIdentity
```
Invoke-MgDownUserManagedDeviceShut -InputObject <IUsersActionsIdentity> [-Headers <IDictionary>] [-PassThru]
