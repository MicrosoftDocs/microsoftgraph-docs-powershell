...
### Down (Default)
```
Invoke-MgDownUserManagedDeviceShut -ManagedDeviceId <String> -UserId <String>
...
### DownViaIdentity
```
Invoke-MgDownUserManagedDeviceShut -InputObject <IUsersActionsIdentity> [-ResponseHeadersVariable <String>]
