...
online ver``s``ion: http``s``://doc``s``.micro``s``oft.com/en-u``s``/power``s``hell/module/micro``s``oft.graph.u``s``er``s``.action``s``/clear-mgu``s``ermanagedappregi``s``trationbydevicetag
``s``chema: 2.0.0
---

# Clear-MgU``s``erManagedAppRegi``s``trationByDeviceTag

## ``s``YNOP``s``I``s``
Invoke action wipeManagedAppRegi``s``tration``s``ByDeviceTag

## ``s``YNTAX

### WipeExpanded2 (Default)
```
Clear-MgU``s``erManagedAppRegi``s``trationByDeviceTag -U``s``erId <``s``tring> [-AdditionalPropertie``s`` <Ha``s``htable>]
 [-DeviceTag <``s``tring>] [-Pa``s````s``Thru] [-WhatIf] [-Confirm] [<CommonParameter``s``>]
```

### Wipe2
```
Clear-MgU``s``erManagedAppRegi``s``trationByDeviceTag -U``s``erId <``s``tring>
 -BodyParameter <IPath``s``Vloam1U``s``er``s``U``s``erIdMicro``s``oftGraphWipemanagedappregi``s``tration``s``bydevicetagPo``s``tReque``s``tbodyContentApplicationJ``s``on``s``chema1>
 [-Pa``s````s``Thru] [-WhatIf] [-Confirm] [<CommonParameter``s``>]
```

### WipeViaIdentityExpanded2
```
Clear-MgU``s``erManagedAppRegi``s``trationByDeviceTag -InputObject <IU``s``er``s``Action``s``Identity>
 [-AdditionalPropertie``s`` <Ha``s``htable>] [-DeviceTag <``s``tring>] [-Pa``s````s``Thru] [-WhatIf] [-Confirm]
 [<CommonParameter``s``>]
```
...
```yaml
Type: Ha``s``htable
Parameter ``s``et``s``: WipeExpanded2, WipeViaIdentityExpanded2
Alia``s``e``s``:
...
```yaml
Type: IPath``s``Vloam1U``s``er``s``U``s``erIdMicro``s``oftGraphWipemanagedappregi``s``tration``s``bydevicetagPo``s``tReque``s``tbodyContentApplicationJ``s``on``s``chema1
Parameter ``s``et``s``: Wipe2, WipeViaIdentity2
Alia``s``e``s``:
...
Parameter ``s``et``s``: WipeViaIdentityExpanded2, WipeViaIdentity2
Alia``s``e``s``:
...
```yaml
Type: ``s``tring
Parameter ``s``et``s``: WipeExpanded2, Wipe2
Alia``s``e``s``:
...
### Micro``s``oft.Graph.Power``s``hell.Model``s``.IPath``s``Vloam1U``s``er``s``U``s``erIdMicro``s``oftGraphWipemanagedappregi``s``tration``s``bydevicetagPo``s``tReque``s``tbodyContentApplicationJ``s``on``s``chema1
