...
```yaml
Type: IPaths1Jn10S6UsersUserIdInsightsSharedSharedinsightIdLastsharedmethodMicrosoftGraphTargetedmanagedappprotectionMicrosoftGraphTargetappsPostRequestbodyContentApplicationJsonSchema
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/invoke-mgtargetuserinsightsharedlastsharedmethodmicrosoftgraphtargetedmanagedappprotectionapp](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/invoke-mgtargetuserinsightsharedlastsharedmethodmicrosoftgraphtargetedmanagedappprotectionapp)
