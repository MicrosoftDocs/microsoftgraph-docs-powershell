...
```yaml
Type: IPaths67HcvyUsersUserIdInsightsUsedUsedinsightIdResourceMicrosoftGraphManagedappprotectionMicrosoftGraphTargetappsPostRequestbodyContentApplicationJsonSchema
