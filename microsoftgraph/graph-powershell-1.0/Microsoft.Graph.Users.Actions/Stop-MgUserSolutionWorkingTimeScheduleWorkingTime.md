...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.users.actions/stop-mgusersolutionworkingtimescheduleworkingtime
schema: 2.0.0
ms.subservice: teams
---
...
### End (Default)
```
Stop-MgUserSolutionWorkingTimeScheduleWorkingTime -UserId <String> [-ResponseHeadersVariable <String>]
...
### EndViaIdentity
```
Stop-MgUserSolutionWorkingTimeScheduleWorkingTime -InputObject <IUsersActionsIdentity>
...
[https://learn.microsoft.com/graph/api/workingtimeschedule-endworkingtime?view=graph-rest-1.0](https://learn.microsoft.com/graph/api/workingtimeschedule-endworkingtime?view=graph-rest-1.0)
