...
### Recover (Default)
```
Restore-MgUserManagedDevicePasscode -ManagedDeviceId <String> -UserId <String>
...
### RecoverViaIdentity
```
Restore-MgUserManagedDevicePasscode -InputObject <IUsersActionsIdentity> [-ResponseHeadersVariable <String>]
