...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/invoke-mgautofituserinsightusedresourcemicrosoftgraphworkbookrangeformatrow
schema: 2.0.0
---
...
### Autofit (Default)
```
Invoke-MgAutofitUserInsightUsedResourceMicrosoftGraphWorkbookRangeFormatRow -UsedInsightId <String>
