...
online ver```s```ion: http```s```://doc```s```.micro```s```oft.com/en-u```s```/power```s```hell/module/micro```s```oft.graph.u```s```er```s```.action```s```/new-mgu```s```erme```s``````s```agereply
```s```chema: 2.0.0
---

# New-MgU```s```erMe```s``````s```ageReply
...
```
New-MgU```s```erMe```s``````s```ageReply -Me```s``````s```ageId <```s```tring> -U```s```erId <```s```tring> [-AdditionalPropertie```s``` <Ha```s```htable>]
 [-Comment <```s```tring>] [-Me```s``````s```age <IMicro```s```oftGraphMe```s``````s```age1>] [-WhatIf] [-Confirm] [<CommonParameter```s```>]
```

### Create2
```
New-MgU```s```erMe```s``````s```ageReply -Me```s``````s```ageId <```s```tring> -U```s```erId <```s```tring>
 -BodyParameter <IPath```s```1BibiieU```s```er```s```U```s```erIdMe```s``````s```age```s```Me```s``````s```ageIdMicro```s```oftGraphCreatereplyPo```s```tReque```s```tbodyContentApplicationJ```s```on```s```chema1>
 [-WhatIf] [-Confirm] [<CommonParameter```s```>]
```

### CreateViaIdentityExpanded2
```
New-MgU```s```erMe```s``````s```ageReply -InputObject <IU```s```er```s```Action```s```Identity> [-AdditionalPropertie```s``` <Ha```s```htable>]
 [-Comment <```s```tring>] [-Me```s``````s```age <IMicro```s```oftGraphMe```s``````s```age1>] [-WhatIf] [-Confirm] [<CommonParameter```s```>]
```

### CreateViaIdentity2
```
New-MgU```s```erMe```s``````s```ageReply -InputObject <IU```s```er```s```Action```s```Identity>
 -BodyParameter <IPath```s```1BibiieU```s```er```s```U```s```erIdMe```s``````s```age```s```Me```s``````s```ageIdMicro```s```oftGraphCreatereplyPo```s```tReque```s```tbodyContentApplicationJ```s```on```s```chema1>
 [-WhatIf] [-Confirm] [<CommonParameter```s```>]
```
...
```yaml
Type: Ha```s```htable
Parameter ```s```et```s```: CreateExpanded2, CreateViaIdentityExpanded2
Alia```s```e```s```:
...
```yaml
Type: IPath```s```1BibiieU```s```er```s```U```s```erIdMe```s``````s```age```s```Me```s``````s```ageIdMicro```s```oftGraphCreatereplyPo```s```tReque```s```tbodyContentApplicationJ```s```on```s```chema1
Parameter ```s```et```s```: Create2, CreateViaIdentity2
Alia```s```e```s```:
...
Parameter ```s```et```s```: CreateViaIdentityExpanded2, CreateViaIdentity2
Alia```s```e```s```:
...
```yaml
Type: ```s```tring
Parameter ```s```et```s```: CreateExpanded2, Create2
Alia```s```e```s```:
...
### Micro```s```oft.Graph.Power```s```hell.Model```s```.IPath```s```1BibiieU```s```er```s```U```s```erIdMe```s``````s```age```s```Me```s``````s```ageIdMicro```s```oftGraphCreatereplyPo```s```tReque```s```tbodyContentApplicationJ```s```on```s```chema1
