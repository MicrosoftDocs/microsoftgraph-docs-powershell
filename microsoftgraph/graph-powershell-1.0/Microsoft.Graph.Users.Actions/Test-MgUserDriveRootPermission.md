...
```
Test-MgUserDriveRootPermission -DriveId <String> -UserId <String> [-ResponseHeadersVariable <String>]
...
```
Test-MgUserDriveRootPermission -InputObject <IUsersActionsIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-ChallengeToken <String>] [-Password <String>] [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.users.actions/test-mguserdriverootpermission](https://learn.microsoft.com/powershell/module/microsoft.graph.users.actions/test-mguserdriverootpermission)
