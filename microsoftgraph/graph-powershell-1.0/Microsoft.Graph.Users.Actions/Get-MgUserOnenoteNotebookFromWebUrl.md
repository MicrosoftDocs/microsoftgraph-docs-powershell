...
online ver``s``ion: http``s``://doc``s``.micro``s``oft.com/en-u``s``/power``s``hell/module/micro``s``oft.graph.u``s``er``s``.action``s``/get-mgu``s``eronenotenotebookfromweburl
``s``chema: 2.0.0
---

# Get-MgU``s``erOnenoteNotebookFromWebUrl
...
```
Get-MgU``s``erOnenoteNotebookFromWebUrl -U``s``erId <``s``tring> [-AdditionalPropertie``s`` <Ha``s``htable>] [-WebUrl <``s``tring>]
 [-WhatIf] [-Confirm] [<CommonParameter``s``>]
```

### Get1
```
Get-MgU``s``erOnenoteNotebookFromWebUrl -U``s``erId <``s``tring>
 -BodyParameter <IPath``s``1Fukv4U``s``er``s``U``s``erIdOnenoteNotebook``s``Micro``s``oftGraphGetnotebookfromweburlPo``s``tReque``s``tbodyContentApplicationJ``s``on``s``chema>
 [-WhatIf] [-Confirm] [<CommonParameter``s``>]
```

### GetViaIdentityExpanded1
```
Get-MgU``s``erOnenoteNotebookFromWebUrl -InputObject <IU``s``er``s``Action``s``Identity> [-AdditionalPropertie``s`` <Ha``s``htable>]
 [-WebUrl <``s``tring>] [-WhatIf] [-Confirm] [<CommonParameter``s``>]
```

### GetViaIdentity1
```
Get-MgU``s``erOnenoteNotebookFromWebUrl -InputObject <IU``s``er``s``Action``s``Identity>
 -BodyParameter <IPath``s``1Fukv4U``s``er``s``U``s``erIdOnenoteNotebook``s``Micro``s``oftGraphGetnotebookfromweburlPo``s``tReque``s``tbodyContentApplicationJ``s``on``s``chema>
 [-WhatIf] [-Confirm] [<CommonParameter``s``>]
```
...
```yaml
Type: Ha``s``htable
Parameter ``s``et``s``: GetExpanded1, GetViaIdentityExpanded1
Alia``s``e``s``:
...
```yaml
Type: IPath``s``1Fukv4U``s``er``s``U``s``erIdOnenoteNotebook``s``Micro``s``oftGraphGetnotebookfromweburlPo``s``tReque``s``tbodyContentApplicationJ``s``on``s``chema
Parameter ``s``et``s``: Get1, GetViaIdentity1
Alia``s``e``s``:
...
Parameter ``s``et``s``: GetViaIdentityExpanded1, GetViaIdentity1
Alia``s``e``s``:
...
```yaml
Type: ``s``tring
Parameter ``s``et``s``: GetExpanded1, Get1
Alia``s``e``s``:
...
### Micro``s``oft.Graph.Power``s``hell.Model``s``.IPath``s``1Fukv4U``s``er``s``U``s``erIdOnenoteNotebook``s``Micro``s``oftGraphGetnotebookfromweburlPo``s``tReque``s``tbodyContentApplicationJ``s``on``s``chema
### Micro``s``oft.Graph.Power``s``hell.Model``s``.IU``s``er``s``Action``s``Identity
## OUTPUT``s``

### Micro``s``oft.Graph.Power``s``hell.Model``s``.IMicro``s``oftGraphCopyNotebookModel
## NOTE``s``
