...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/invoke-mgrenewuserinsighttrendingresourcemicrosoftgraphmobileappcontentfileupload
schema: 2.0.0
---
...
### Renew (Default)
```
Invoke-MgRenewUserInsightTrendingResourceMicrosoftGraphMobileAppContentFileUpload -TrendingId <String>
