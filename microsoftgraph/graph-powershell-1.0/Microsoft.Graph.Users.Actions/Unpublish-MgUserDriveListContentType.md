...
### Unpublish (Default)
```
Unpublish-MgUserDriveListContentType -ContentTypeId <String> -DriveId <String> -UserId <String>
...
```
Unpublish-MgUserDriveListContentType -InputObject <IUsersActionsIdentity> [-ResponseHeadersVariable <String>]
