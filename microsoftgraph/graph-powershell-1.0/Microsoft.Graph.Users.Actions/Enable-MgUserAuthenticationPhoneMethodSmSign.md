...
### Enable (Default)
```
Enable-MgUserAuthenticationPhoneMethodSmSign -PhoneAuthenticationMethodId <String> -UserId <String> [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### EnableViaIdentity
```
Enable-MgUserAuthenticationPhoneMethodSmSign -InputObject <IUsersActionsIdentity> [-PassThru] [-WhatIf]
