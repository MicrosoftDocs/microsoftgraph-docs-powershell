...
```
Get-MgUserById [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
...
- [Get-MgUserById](https://learn.microsoft.com/powershell/module/microsoft.graph.users.actions/get-mguserbyid)
