...
### Create (Default)
```
New-MgPrintShareAllowedGroupByRef -PrinterShareId <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgPrintShareAllowedGroupByRef -InputObject <IDevicesCloudPrintIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
