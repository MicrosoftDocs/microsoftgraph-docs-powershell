...
### Delete (Default)
```
Remove-MgPrintOperation -PrintOperationId <String> [-IfMatch <String>] [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgPrintOperation -InputObject <IDevicesCloudPrintIdentity> [-IfMatch <String>] [-Headers <IDictionary>]
