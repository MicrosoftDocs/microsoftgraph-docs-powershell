...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaBetaPrintPrinterJob](/powershell/module/Microsoft.Graph.Beta.Devices.CloudPrint/Update-MgBetaPrintPrinterJob?view=graph-powershell-beta)

## SYNTAX

### UpdateExpanded (Default)
```
Update-MgPrintPrinterJob -PrintJobId <String> -PrinterId <String> [-AdditionalProperties <Hashtable>]
...
## RELATED LINKS
[Update-MgBetaBetaPrintPrinterJob](/powershell/module/Microsoft.Graph.Beta.Devices.CloudPrint/Update-MgBetaPrintPrinterJob?view=graph-powershell-beta)
