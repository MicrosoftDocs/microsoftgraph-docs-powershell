...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.cloudprint/get-mgprintsharejob
Locale: en-US
Module Name: Microsoft.Graph.Devices.CloudPrint
ms.date: 07/31/2026
PlatyPS schema version: 2024-05-01
title: Get-MgPrintShareJob
---
...
```
Get-MgPrintShareJob -PrinterShareId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgPrintShareJob -PrintJobId <string> -PrinterShareId <string> [-ExpandProperty <string[]>]
...
- [Get-MgPrintShareJob](https://learn.microsoft.com/powershell/module/microsoft.graph.devices.cloudprint/get-mgprintsharejob)
- [Graph API Reference](https://learn.microsoft.com/graph/api/printershare-list-jobs?view=graph-rest-1.0)
