...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaBetaPrintShareJob](/powershell/module/Microsoft.Graph.Beta.Devices.CloudPrint/New-MgBetaPrintShareJob?view=graph-powershell-beta)
...
### Create
```
New-MgPrintShareJob -PrinterShareId <String> -BodyParameter <IMicrosoftGraphPrintJob> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
## RELATED LINKS
[New-MgBetaBetaPrintShareJob](/powershell/module/Microsoft.Graph.Beta.Devices.CloudPrint/New-MgBetaPrintShareJob?view=graph-powershell-beta)
