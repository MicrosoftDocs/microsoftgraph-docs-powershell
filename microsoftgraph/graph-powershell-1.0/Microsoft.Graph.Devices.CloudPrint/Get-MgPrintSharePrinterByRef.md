...
### Get (Default)
```
Get-MgPrintSharePrinterByRef -PrinterShareId <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgPrintSharePrinterByRef -InputObject <IDevicesCloudPrintIdentity> [<CommonParameters>]
```
