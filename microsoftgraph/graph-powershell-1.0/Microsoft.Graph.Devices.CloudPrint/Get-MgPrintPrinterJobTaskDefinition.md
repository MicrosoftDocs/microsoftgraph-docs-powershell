...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.cloudprint/get-mgprintprinterjobtaskdefinition
Locale: en-US
Module Name: Microsoft.Graph.Devices.CloudPrint
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: Get-MgPrintPrinterJobTaskDefinition
---
...
```
Get-MgPrintPrinterJobTaskDefinition -InputObject <IDevicesCloudPrintIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
...
- [Get-MgPrintPrinterJobTaskDefinition](https://learn.microsoft.com/powershell/module/microsoft.graph.devices.cloudprint/get-mgprintprinterjobtaskdefinition)
