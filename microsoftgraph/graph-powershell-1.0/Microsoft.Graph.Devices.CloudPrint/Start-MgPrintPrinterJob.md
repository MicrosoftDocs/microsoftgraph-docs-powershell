...
### Start (Default)
```
Start-MgPrintPrinterJob -PrintJobId <String> -PrinterId <String> [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### StartViaIdentity
```
Start-MgPrintPrinterJob -InputObject <IDevicesCloudPrintIdentity> [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
