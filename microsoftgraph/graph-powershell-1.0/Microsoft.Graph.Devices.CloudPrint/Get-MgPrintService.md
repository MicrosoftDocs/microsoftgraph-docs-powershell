...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.devices.cloudprint/get-mgprintservice
Locale: en-US
Module Name: Microsoft.Graph.Devices.CloudPrint
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Get-MgPrintService
---
...
```
Get-MgPrintService [-ExpandProperty <string[]>] [-Property <string[]>] [-Filter <string>]
...
- [Get-MgPrintService](https://learn.microsoft.com/powershell/module/microsoft.graph.devices.cloudprint/get-mgprintservice)
- [Graph API Reference](https://learn.microsoft.com/graph/api/printservice-get?view=graph-rest-1.0)
- [Graph API Reference](https://learn.microsoft.com/graph/api/print-list-services?view=graph-rest-1.0)
