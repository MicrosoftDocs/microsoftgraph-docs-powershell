...
> [!NOTE]
> To view the beta release of this cmdlet, view [Invoke-MgBetaBetaAbortPrintPrinterJob](/powershell/module/Microsoft.Graph.Beta.Devices.CloudPrint/Invoke-MgBetaAbortPrintPrinterJob?view=graph-powershell-beta)

## SYNTAX

### AbortExpanded (Default)
```
Invoke-MgAbortPrintPrinterJob -PrintJobId <String> -PrinterId <String> [-AdditionalProperties <Hashtable>]
...
## RELATED LINKS
[Invoke-MgBetaBetaAbortPrintPrinterJob](/powershell/module/Microsoft.Graph.Beta.Devices.CloudPrint/Invoke-MgBetaAbortPrintPrinterJob?view=graph-powershell-beta)
