...
```
Get-MgAdminConfigurationManagementConfigurationSnapshotJob [-ExpandProperty <string[]>]
...
```
Get-MgAdminConfigurationManagementConfigurationSnapshotJob -ConfigurationSnapshotJobId <string>
