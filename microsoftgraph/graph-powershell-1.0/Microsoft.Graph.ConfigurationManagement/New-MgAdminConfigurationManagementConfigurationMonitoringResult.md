...
# New-MgAdminConfigurationManagementConfigurationMonitoringResult
...
```
New-MgAdminConfigurationManagementConfigurationMonitoringResult [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Id <string>] [-RunStatus <MonitorRunStatus>] [-Break]
...
```
New-MgAdminConfigurationManagementConfigurationMonitoringResult
 -BodyParameter <IMicrosoftGraphConfigurationMonitoringResult> [-ResponseHeadersVariable <string>]
...
```yaml
Type: Microsoft.Graph.PowerShell.Support.MonitorRunStatus
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
