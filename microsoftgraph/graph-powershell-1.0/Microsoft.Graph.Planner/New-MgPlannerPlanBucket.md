...
### Create
```
New-MgPlannerPlanBucket -PlannerPlanId <String> -BodyParameter <IMicrosoftGraphPlannerBucket> [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
### CreateViaIdentity
```
New-MgPlannerPlanBucket -InputObject <IPlannerIdentity> -BodyParameter <IMicrosoftGraphPlannerBucket> [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
