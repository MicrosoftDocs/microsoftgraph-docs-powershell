...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.planner/new-mguserplannertask
schema: 2.0.0
---
...
```
New-MgUserPlannerTask -UserId <String> [-ActiveChecklistItemCount <Int32>] [-AdditionalProperties <Hashtable>]
...
### Create1
```
New-MgUserPlannerTask -UserId <String> -BodyParameter <IMicrosoftGraphPlannerTask> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### CreateViaIdentityExpanded1
```
New-MgUserPlannerTask -InputObject <IPlannerIdentity> [-ActiveChecklistItemCount <Int32>]
...
### CreateViaIdentity1
```
New-MgUserPlannerTask -InputObject <IPlannerIdentity> -BodyParameter <IMicrosoftGraphPlannerTask> [-WhatIf]
