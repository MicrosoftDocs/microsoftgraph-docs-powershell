...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.planner/get-mguserplanner
Locale: en-US
Module Name: Microsoft.Graph.Planner
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: Get-MgUserPlanner
---
...
```
Get-MgUserPlanner -UserId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgUserPlanner -InputObject <IPlannerIdentity> [-ExpandProperty <string[]>]
