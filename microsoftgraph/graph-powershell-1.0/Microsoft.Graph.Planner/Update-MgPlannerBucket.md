...
- [Update-MgPlannerBucket](https://learn.microsoft.com/powershell/module/microsoft.graph.planner/update-mgplannerbucket)
- [Graph API Reference](https://learn.microsoft.com/graph/api/plannerbucket-update?view=graph-rest-1.0)
