...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/update-mgplaceasfloorcheck
Locale: en-US
Module Name: Microsoft.Graph.Calendar
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Update-MgPlaceAsFloorCheck
---
...
```
Update-MgPlaceAsFloorCheck -CheckInClaimCalendarEventId <string> -PlaceId <string>
...
```
Update-MgPlaceAsFloorCheck -InputObject <ICalendarIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgPlaceAsFloorCheck -InputObject <ICalendarIdentity>
 -BodyParameter <IMicrosoftGraphCheckInClaim> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/update-mgplaceasfloorcheck)
