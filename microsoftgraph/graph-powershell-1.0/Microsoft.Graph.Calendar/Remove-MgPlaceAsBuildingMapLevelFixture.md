...
```
Remove-MgPlaceAsBuildingMapLevelFixture -FixtureMapId <string> -LevelMapId <string>
...
```
Remove-MgPlaceAsBuildingMapLevelFixture -InputObject <ICalendarIdentity> [-IfMatch <string>]
