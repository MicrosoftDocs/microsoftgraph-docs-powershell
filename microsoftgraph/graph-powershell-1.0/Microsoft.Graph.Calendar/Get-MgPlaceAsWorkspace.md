...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/get-mgplaceasworkspace
Locale: en-US
Module Name: Microsoft.Graph.Calendar
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Get-MgPlaceAsWorkspace
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaPlaceAsWorkspace](/powershell/module/Microsoft.Graph.Beta.Calendar/Get-MgBetaPlaceAsWorkspace?view=graph-powershell-beta)
...
```
Get-MgPlaceAsWorkspace [-ExpandProperty <string[]>] [-Property <string[]>] [-Filter <string>]
...
```
Get-MgPlaceAsWorkspace -PlaceId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
...
```
Get-MgPlaceAsWorkspace -InputObject <ICalendarIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgPlaceAsWorkspace](https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/get-mgplaceasworkspace)
