...
```
New-MgPlaceAsSectionCheck -PlaceId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgPlaceAsSectionCheck -PlaceId <string> -BodyParameter <IMicrosoftGraphCheckInClaim>
...
```
New-MgPlaceAsSectionCheck -InputObject <ICalendarIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-CalendarEventId <string>] [-CheckInMethod <string>]
 [-CreatedDateTime <datetime>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```
New-MgPlaceAsSectionCheck -InputObject <ICalendarIdentity>
...
### Microsoft.Graph.PowerShell.Models.IMicrosoftGraphCheckInClaim
