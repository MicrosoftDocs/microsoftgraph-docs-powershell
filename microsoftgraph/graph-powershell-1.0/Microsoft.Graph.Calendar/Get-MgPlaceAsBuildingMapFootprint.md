...
```
Get-MgPlaceAsBuildingMapFootprint -PlaceId <string> [-ExpandProperty <string[]>]
...
```
Get-MgPlaceAsBuildingMapFootprint -FootprintMapId <string> -PlaceId <string>
...
```
Get-MgPlaceAsBuildingMapFootprint -InputObject <ICalendarIdentity> [-ExpandProperty <string[]>]
