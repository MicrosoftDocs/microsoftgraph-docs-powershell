...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/get-mgplaceasbuildingmaplevelunitcount
Locale: en-US
Module Name: Microsoft.Graph.Calendar
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: Get-MgPlaceAsBuildingMapLevelUnitCount
---
...
```
Get-MgPlaceAsBuildingMapLevelUnitCount -LevelMapId <string> -PlaceId <string> [-Filter <string>]
...
```
Get-MgPlaceAsBuildingMapLevelUnitCount -InputObject <ICalendarIdentity> [-Filter <string>]
 [-Search <string>] [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
```
...
- [Get-MgPlaceAsBuildingMapLevelUnitCount](https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/get-mgplaceasbuildingmaplevelunitcount)
