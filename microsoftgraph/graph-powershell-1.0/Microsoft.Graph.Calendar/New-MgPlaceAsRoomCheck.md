...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/new-mgplaceasroomcheck
Locale: en-US
Module Name: Microsoft.Graph.Calendar
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: New-MgPlaceAsRoomCheck
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaPlaceAsRoomCheck](/powershell/module/Microsoft.Graph.Beta.Calendar/New-MgBetaPlaceAsRoomCheck?view=graph-powershell-beta)
...
```
New-MgPlaceAsRoomCheck -PlaceId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgPlaceAsRoomCheck -PlaceId <string> -BodyParameter <IMicrosoftGraphCheckInClaim>
...
```
New-MgPlaceAsRoomCheck -InputObject <ICalendarIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-CalendarEventId <string>] [-CheckInMethod <string>]
 [-CreatedDateTime <datetime>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```
New-MgPlaceAsRoomCheck -InputObject <ICalendarIdentity> -BodyParameter <IMicrosoftGraphCheckInClaim>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
- [New-MgPlaceAsRoomCheck](https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/new-mgplaceasroomcheck)
