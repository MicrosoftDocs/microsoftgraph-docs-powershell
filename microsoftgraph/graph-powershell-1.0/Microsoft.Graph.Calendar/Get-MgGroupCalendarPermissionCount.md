...
### Get (Default)
```
Get-MgGroupCalendarPermissionCount -GroupId <String> [-Filter <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupCalendarPermissionCount -InputObject <ICalendarIdentity> [-Filter <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
