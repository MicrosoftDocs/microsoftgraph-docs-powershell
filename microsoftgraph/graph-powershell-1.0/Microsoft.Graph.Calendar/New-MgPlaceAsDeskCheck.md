...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/new-mgplaceasdeskcheck
Locale: en-US
Module Name: Microsoft.Graph.Calendar
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: New-MgPlaceAsDeskCheck
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaPlaceAsDeskCheck](/powershell/module/Microsoft.Graph.Beta.Calendar/New-MgBetaPlaceAsDeskCheck?view=graph-powershell-beta)
...
```
New-MgPlaceAsDeskCheck -PlaceId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgPlaceAsDeskCheck -PlaceId <string> -BodyParameter <IMicrosoftGraphCheckInClaim>
...
```
New-MgPlaceAsDeskCheck -InputObject <ICalendarIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-CalendarEventId <string>] [-CheckInMethod <string>]
 [-CreatedDateTime <datetime>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```
New-MgPlaceAsDeskCheck -InputObject <ICalendarIdentity> -BodyParameter <IMicrosoftGraphCheckInClaim>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
- [New-MgPlaceAsDeskCheck](https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/new-mgplaceasdeskcheck)
