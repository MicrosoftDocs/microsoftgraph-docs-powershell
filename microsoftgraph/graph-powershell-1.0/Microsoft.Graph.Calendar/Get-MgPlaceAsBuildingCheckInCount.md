...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/get-mgplaceasbuildingcheckincount
Locale: en-US
Module Name: Microsoft.Graph.Calendar
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Get-MgPlaceAsBuildingCheckInCount
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaPlaceAsBuildingCheckInCount](/powershell/module/Microsoft.Graph.Beta.Calendar/Get-MgBetaPlaceAsBuildingCheckInCount?view=graph-powershell-beta)
...
```
Get-MgPlaceAsBuildingCheckInCount -PlaceId <string> [-Filter <string>] [-Search <string>]
...
```
Get-MgPlaceAsBuildingCheckInCount -InputObject <ICalendarIdentity> [-Filter <string>]
