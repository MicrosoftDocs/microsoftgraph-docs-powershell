...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/new-mgplaceasbuildingmaplevelunit
Locale: en-US
Module Name: Microsoft.Graph.Calendar
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: New-MgPlaceAsBuildingMapLevelUnit
---
...
```
New-MgPlaceAsBuildingMapLevelUnit -LevelMapId <string> -PlaceId <string>
...
```
New-MgPlaceAsBuildingMapLevelUnit -InputObject <ICalendarIdentity> [-PlaceId <string>]
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-Id <string>]
...
```
New-MgPlaceAsBuildingMapLevelUnit -InputObject <ICalendarIdentity>
 -BodyParameter <IMicrosoftGraphUnitMap> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/new-mgplaceasbuildingmaplevelunit)
