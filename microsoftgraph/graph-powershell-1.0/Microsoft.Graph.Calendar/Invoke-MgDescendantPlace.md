...
```
Invoke-MgDescendantPlace -PlaceId <string> [-Count] [-ExpandProperty <string[]>] [-Filter <string>]
...
### DescendantViaIdentity

```
Invoke-MgDescendantPlace -InputObject <ICalendarIdentity> [-Count] [-ExpandProperty <string[]>]
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/invoke-mgdescendantplace)
