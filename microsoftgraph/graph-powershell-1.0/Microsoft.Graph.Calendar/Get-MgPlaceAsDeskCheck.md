...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/get-mgplaceasdeskcheck
Locale: en-US
Module Name: Microsoft.Graph.Calendar
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: Get-MgPlaceAsDeskCheck
---
...
```
Get-MgPlaceAsDeskCheck -PlaceId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgPlaceAsDeskCheck -CheckInClaimCalendarEventId <string> -PlaceId <string>
...
```
Get-MgPlaceAsDeskCheck -InputObject <ICalendarIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgPlaceAsDeskCheck](https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/get-mgplaceasdeskcheck)
