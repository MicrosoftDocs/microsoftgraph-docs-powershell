...
### Get (Default)
```
Get-MgUserEventInstanceCalendar -EventId <String> -EventId1 <String> -UserId <String>
...
### GetViaIdentity
```
Get-MgUserEventInstanceCalendar -InputObject <ICalendarIdentity> [-ExpandProperty <String[]>]
