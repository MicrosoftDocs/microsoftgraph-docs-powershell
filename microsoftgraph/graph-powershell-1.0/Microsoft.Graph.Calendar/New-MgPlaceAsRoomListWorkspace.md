...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaPlaceAsRoomListWorkspace](/powershell/module/Microsoft.Graph.Beta.Calendar/New-MgBetaPlaceAsRoomListWorkspace?view=graph-powershell-beta)
...
```
New-MgPlaceAsRoomListWorkspace -PlaceId <string> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Address <IMicrosoftGraphPhysicalAddress>] [-Capacity <int>]
...
```
New-MgPlaceAsRoomListWorkspace -InputObject <ICalendarIdentity> [-PlaceId <string>]
...
```
New-MgPlaceAsRoomListWorkspace -PlaceId <string> -BodyParameter <IMicrosoftGraphWorkspace>
...
```
New-MgPlaceAsRoomListWorkspace -InputObject <ICalendarIdentity>
...
- [New-MgPlaceAsRoomListWorkspace](https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/new-mgplaceasroomlistworkspace)
