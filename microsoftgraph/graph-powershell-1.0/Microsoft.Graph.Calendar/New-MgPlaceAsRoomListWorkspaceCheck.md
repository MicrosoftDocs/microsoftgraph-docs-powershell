...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/new-mgplaceasroomlistworkspacecheck
Locale: en-US
Module Name: Microsoft.Graph.Calendar
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: New-MgPlaceAsRoomListWorkspaceCheck
---
...
```
New-MgPlaceAsRoomListWorkspaceCheck -PlaceId <string> -WorkspaceId <string>
...
```
New-MgPlaceAsRoomListWorkspaceCheck -InputObject <ICalendarIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-CalendarEventId <string>]
 [-CheckInMethod <string>] [-CreatedDateTime <datetime>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/new-mgplaceasroomlistworkspacecheck)
