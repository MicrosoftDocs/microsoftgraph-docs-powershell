...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/get-mgusereventextension
Locale: en-US
Module Name: Microsoft.Graph.Calendar
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Get-MgUserEventExtension
---
...
```
Get-MgUserEventExtension -EventId <string> -UserId <string> [-ExpandProperty <string[]>]
...
```
Get-MgUserEventExtension -EventId <string> -ExtensionId <string> -UserId <string>
...
```
Get-MgUserEventExtension -InputObject <ICalendarIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgUserEventExtension](https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/get-mgusereventextension)
