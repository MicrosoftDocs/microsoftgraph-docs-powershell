...
### Get (Default)
```
Get-MgGroupEventAttachmentCount -EventId <String> -GroupId <String> [-Filter <String>] [-Search <String>]
...
### GetViaIdentity
```
Get-MgGroupEventAttachmentCount -InputObject <ICalendarIdentity> [-Filter <String>] [-Search <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
