...
### Get (Default)
```
Get-MgGroupEventAttachmentCount -EventId <String> -GroupId <String> [-Filter <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgGroupEventAttachmentCount -InputObject <ICalendarIdentity> [-Filter <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
