...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/new-mgplaceasroomlistcheck
Locale: en-US
Module Name: Microsoft.Graph.Calendar
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: New-MgPlaceAsRoomListCheck
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaPlaceAsRoomListCheck](/powershell/module/Microsoft.Graph.Beta.Calendar/New-MgBetaPlaceAsRoomListCheck?view=graph-powershell-beta)
...
```
New-MgPlaceAsRoomListCheck -PlaceId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgPlaceAsRoomListCheck -PlaceId <string> -BodyParameter <IMicrosoftGraphCheckInClaim>
...
```
New-MgPlaceAsRoomListCheck -InputObject <ICalendarIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-CalendarEventId <string>] [-CheckInMethod <string>]
 [-CreatedDateTime <datetime>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```
New-MgPlaceAsRoomListCheck -InputObject <ICalendarIdentity>
...
- [New-MgPlaceAsRoomListCheck](https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/new-mgplaceasroomlistcheck)
