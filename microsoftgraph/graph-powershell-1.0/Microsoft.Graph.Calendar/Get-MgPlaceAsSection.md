...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaPlaceAsSection](/powershell/module/Microsoft.Graph.Beta.Calendar/Get-MgBetaPlaceAsSection?view=graph-powershell-beta)
...
```
Get-MgPlaceAsSection [-ExpandProperty <string[]>] [-Property <string[]>] [-Filter <string>]
...
### Microsoft.Graph.PowerShell.Models.IMicrosoftGraphSection
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/get-mgplaceassection)
