...
```
Update-MgPlaceAsBuildingMapLevelFixture -FixtureMapId <string> -LevelMapId <string>
 -PlaceId <string> [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
...
```
Update-MgPlaceAsBuildingMapLevelFixture -InputObject <ICalendarIdentity> [-PlaceId <string>]
...
```
Update-MgPlaceAsBuildingMapLevelFixture -InputObject <ICalendarIdentity>
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphFixtureMap
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.PowerShell.Models.IMicrosoftGraphFixtureMap
