...
### Delete (Default)
```
Remove-MgPlaceAsRoomListRoom -PlaceId <String> -RoomId <String> [-IfMatch <String>] [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgPlaceAsRoomListRoom -InputObject <ICalendarIdentity> [-IfMatch <String>] [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
