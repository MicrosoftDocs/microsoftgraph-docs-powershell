...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/update-mgplaceassectioncheck
Locale: en-US
Module Name: Microsoft.Graph.Calendar
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: Update-MgPlaceAsSectionCheck
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaPlaceAsSectionCheck](/powershell/module/Microsoft.Graph.Beta.Calendar/Update-MgBetaPlaceAsSectionCheck?view=graph-powershell-beta)
...
```
Update-MgPlaceAsSectionCheck -CheckInClaimCalendarEventId <string> -PlaceId <string>
...
```
Update-MgPlaceAsSectionCheck -InputObject <ICalendarIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgPlaceAsSectionCheck -InputObject <ICalendarIdentity>
 -BodyParameter <IMicrosoftGraphCheckInClaim> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [Update-MgPlaceAsSectionCheck](https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/update-mgplaceassectioncheck)
