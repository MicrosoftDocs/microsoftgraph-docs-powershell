...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/invoke-mgacceptusereventinstance
schema: 2.0.0
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Invoke-MgBetaAcceptUserEventInstance](/powershell/module/Microsoft.Graph.Beta.Calendar/Invoke-MgBetaAcceptUserEventInstance?view=graph-powershell-beta)
...
```
Invoke-MgAcceptUserEventInstance -InputObject <ICalendarIdentity> [-ResponseHeadersVariable <String>]
...
### AcceptViaIdentity
```
Invoke-MgAcceptUserEventInstance -InputObject <ICalendarIdentity>
 -BodyParameter <IPaths1Qs6J67UsersUserIdEventsEventIdInstancesEventId1MicrosoftGraphAcceptPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
