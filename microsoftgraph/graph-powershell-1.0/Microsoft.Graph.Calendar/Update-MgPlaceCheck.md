...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/update-mgplacecheck
Locale: en-US
Module Name: Microsoft.Graph.Calendar
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Update-MgPlaceCheck
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaPlaceCheck](/powershell/module/Microsoft.Graph.Beta.Calendar/Update-MgBetaPlaceCheck?view=graph-powershell-beta)
...
```
Update-MgPlaceCheck -CheckInClaimCalendarEventId <string> -PlaceId <string>
...
```
Update-MgPlaceCheck -InputObject <ICalendarIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgPlaceCheck -InputObject <ICalendarIdentity> -BodyParameter <IMicrosoftGraphCheckInClaim>
...
- [Update-MgPlaceCheck](https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/update-mgplacecheck)
