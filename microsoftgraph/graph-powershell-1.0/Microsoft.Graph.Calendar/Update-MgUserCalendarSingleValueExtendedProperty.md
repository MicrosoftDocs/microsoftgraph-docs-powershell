...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaBetaUserCalendarSingleValueExtendedProperty](/powershell/module/Microsoft.Graph.Beta.Calendar/Update-MgBetaUserCalendarSingleValueExtendedProperty?view=graph-powershell-beta)
...
```
Update-MgUserCalendarSingleValueExtendedProperty -SingleValueLegacyExtendedPropertyId <String> -UserId <String>
 -CalendarId <String> [-AdditionalProperties <Hashtable>] [-Id <String>] [-Value <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```
Update-MgUserCalendarSingleValueExtendedProperty -SingleValueLegacyExtendedPropertyId <String> -UserId <String>
 -CalendarId <String> -BodyParameter <IMicrosoftGraphSingleValueLegacyExtendedProperty> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgBetaBetaUserCalendarSingleValueExtendedProperty](/powershell/module/Microsoft.Graph.Beta.Calendar/Update-MgBetaUserCalendarSingleValueExtendedProperty?view=graph-powershell-beta)
