...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaGroupEvent](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaGroupEvent?view=graph-powershell-beta)
...
### Update
```
Update-MgGroupEvent -EventId <String> -GroupId <String> -BodyParameter <IMicrosoftGraphEvent> [-WhatIf]
...
### UpdateViaIdentity
```
Update-MgGroupEvent -InputObject <ICalendarIdentity> -BodyParameter <IMicrosoftGraphEvent> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgBetaGroupEvent](/powershell/module/Microsoft.Graph.Beta.Applications/Update-MgBetaGroupEvent?view=graph-powershell-beta)
