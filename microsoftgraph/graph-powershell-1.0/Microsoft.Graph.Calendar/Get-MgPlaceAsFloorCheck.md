...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/get-mgplaceasfloorcheck
Locale: en-US
Module Name: Microsoft.Graph.Calendar
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Get-MgPlaceAsFloorCheck
---
...
```
Get-MgPlaceAsFloorCheck -PlaceId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgPlaceAsFloorCheck -CheckInClaimCalendarEventId <string> -PlaceId <string>
...
```
Get-MgPlaceAsFloorCheck -InputObject <ICalendarIdentity> [-ExpandProperty <string[]>]
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/get-mgplaceasfloorcheck)
