...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/update-mguserevent
Locale: en-US
Module Name: Microsoft.Graph.Calendar
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Update-MgUserEvent
---
...
```
Update-MgUserEvent -EventId <string> -UserId <string> [-ResponseHeadersVariable <string>]
...
```
Update-MgUserEvent -InputObject <ICalendarIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-AllowNewTimeProposals]
 [-Attachments <IMicrosoftGraphAttachment[]>] [-Attendees <IMicrosoftGraphAttendee[]>]
 [-Body <IMicrosoftGraphItemBody>] [-BodyPreview <string>] [-Calendar <IMicrosoftGraphCalendar>]
 [-CancelledOccurrences <string[]>] [-Categories <string[]>] [-ChangeKey <string>]
