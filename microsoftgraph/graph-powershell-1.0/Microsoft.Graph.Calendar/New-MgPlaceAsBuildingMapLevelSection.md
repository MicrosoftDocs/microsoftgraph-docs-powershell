...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/new-mgplaceasbuildingmaplevelsection
Locale: en-US
Module Name: Microsoft.Graph.Calendar
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: New-MgPlaceAsBuildingMapLevelSection
---
...
```
New-MgPlaceAsBuildingMapLevelSection -LevelMapId <string> -PlaceId <string>
...
```
New-MgPlaceAsBuildingMapLevelSection -InputObject <ICalendarIdentity> [-PlaceId <string>]
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-Id <string>]
...
```
New-MgPlaceAsBuildingMapLevelSection -InputObject <ICalendarIdentity>
 -BodyParameter <IMicrosoftGraphSectionMap> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
