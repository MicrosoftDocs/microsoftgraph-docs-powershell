...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/get-mgplaceasroomlistcheck
Locale: en-US
Module Name: Microsoft.Graph.Calendar
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Get-MgPlaceAsRoomListCheck
---
...
```
Get-MgPlaceAsRoomListCheck -PlaceId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgPlaceAsRoomListCheck -CheckInClaimCalendarEventId <string> -PlaceId <string>
...
```
Get-MgPlaceAsRoomListCheck -InputObject <ICalendarIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgPlaceAsRoomListCheck](https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/get-mgplaceasroomlistcheck)
