...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/new-mguserevent
Locale: en-US
Module Name: Microsoft.Graph.Calendar
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: New-MgUserEvent
---
...
```
New-MgUserEvent -UserId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgUserEvent -UserId <string> -BodyParameter <IMicrosoftGraphEvent>
