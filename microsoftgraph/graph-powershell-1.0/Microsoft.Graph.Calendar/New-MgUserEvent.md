...
```
New-MgUserEvent -UserId <String> [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>]
...
```
New-MgUserEvent -InputObject <ICalendarIdentity> [-ResponseHeadersVariable <String>]
