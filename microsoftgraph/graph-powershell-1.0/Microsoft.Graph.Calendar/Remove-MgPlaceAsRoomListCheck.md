...
```
Remove-MgPlaceAsRoomListCheck -CheckInClaimCalendarEventId <string> -PlaceId <string>
...
```
Remove-MgPlaceAsRoomListCheck -InputObject <ICalendarIdentity> [-IfMatch <string>]
