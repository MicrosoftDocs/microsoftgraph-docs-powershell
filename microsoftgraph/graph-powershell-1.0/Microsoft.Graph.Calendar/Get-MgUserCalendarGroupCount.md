...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/get-mgusercalendargroupcount
Locale: en-US
Module Name: Microsoft.Graph.Calendar
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: Get-MgUserCalendarGroupCount
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaUserCalendarGroupCount](/powershell/module/Microsoft.Graph.Beta.Calendar/Get-MgBetaUserCalendarGroupCount?view=graph-powershell-beta)
...
```
Get-MgUserCalendarGroupCount -UserId <string> [-Filter <string>] [-Search <string>]
...
```
Get-MgUserCalendarGroupCount -InputObject <ICalendarIdentity> [-Filter <string>] [-Search <string>]
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
```
...
- [Get-MgUserCalendarGroupCount](https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/get-mgusercalendargroupcount)
