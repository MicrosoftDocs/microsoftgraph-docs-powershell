...
```
Get-MgPlaceAsRoom [-ExpandProperty <string[]>] [-Property <string[]>] [-Filter <string>]
...
```
Get-MgPlaceAsRoom -InputObject <ICalendarIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgPlaceAsRoom](https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/get-mgplaceasroom)
