...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/get-mggroupeventinstancedelta
schema: 2.0.0
...
### Delta (Default)
```
Get-MgGroupEventInstanceDelta -EventId <String> -GroupId <String> -EndDateTime <String> -StartDateTime <String>
...
### DeltaViaIdentity
```
Get-MgGroupEventInstanceDelta -InputObject <ICalendarIdentity> -EndDateTime <String> -StartDateTime <String>
 [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>] [-Search <String>] [-Skip <Int32>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/get-mggroupeventinstancedelta](https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/get-mggroupeventinstancedelta)
