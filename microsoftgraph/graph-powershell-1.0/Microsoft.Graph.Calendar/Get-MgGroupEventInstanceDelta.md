...
```
Get-MgGroupEventInstanceDelta -EventId <string> -GroupId <string> -EndDateTime <string>
...
```
Get-MgGroupEventInstanceDelta -InputObject <ICalendarIdentity> -EndDateTime <string>
 -StartDateTime <string> [-ExpandProperty <string[]>] [-Filter <string>] [-Property <string[]>]
