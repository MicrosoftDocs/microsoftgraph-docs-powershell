...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/new-mgplaceasworkspacecheck
Locale: en-US
Module Name: Microsoft.Graph.Calendar
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: New-MgPlaceAsWorkspaceCheck
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaPlaceAsWorkspaceCheck](/powershell/module/Microsoft.Graph.Beta.Calendar/New-MgBetaPlaceAsWorkspaceCheck?view=graph-powershell-beta)
...
```
New-MgPlaceAsWorkspaceCheck -PlaceId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgPlaceAsWorkspaceCheck -PlaceId <string> -BodyParameter <IMicrosoftGraphCheckInClaim>
...
```
New-MgPlaceAsWorkspaceCheck -InputObject <ICalendarIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-CalendarEventId <string>] [-CheckInMethod <string>]
 [-CreatedDateTime <datetime>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```
New-MgPlaceAsWorkspaceCheck -InputObject <ICalendarIdentity>
...
- [New-MgPlaceAsWorkspaceCheck](https://learn.microsoft.com/powershell/module/microsoft.graph.calendar/new-mgplaceasworkspacecheck)
