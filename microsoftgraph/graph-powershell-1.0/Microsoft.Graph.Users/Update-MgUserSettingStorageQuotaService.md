...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.users/update-mgusersettingstoragequotaservice
schema: 2.0.0
---
...
```
Update-MgUserSettingStorageQuotaService -ServiceStorageQuotaBreakdownId <String> -UserId <String>
...
```
Update-MgUserSettingStorageQuotaService -InputObject <IUsersIdentity> [-ResponseHeadersVariable <String>]
...
### UpdateViaIdentity
```
Update-MgUserSettingStorageQuotaService -InputObject <IUsersIdentity> -BodyParameter <Hashtable>
...
### Microsoft.Graph.PowerShell.Models.IMicrosoftGraphServiceStorageQuotaBreakdown
## NOTES
