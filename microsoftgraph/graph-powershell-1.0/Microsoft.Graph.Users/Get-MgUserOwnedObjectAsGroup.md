...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.users/get-mguserownedobjectasgroup
Locale: en-US
Module Name: Microsoft.Graph.Users
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Get-MgUserOwnedObjectAsGroup
---
...
```
Get-MgUserOwnedObjectAsGroup -UserId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgUserOwnedObjectAsGroup -DirectoryObjectId <string> -UserId <string>
...
```
Get-MgUserOwnedObjectAsGroup -InputObject <IUsersIdentity> [-ExpandProperty <string[]>]
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.users/get-mguserownedobjectasgroup)
