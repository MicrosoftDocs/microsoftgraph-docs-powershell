...
online ver`s`ion: http`s`://doc`s`.micro`s`oft.com/en-u`s`/power`s`hell/module/micro`s`oft.graph.u`s`er`s`/remove-mgu`s`erphoto
`s`chema: 2.0.0
---

# Remove-MgU`s`erPhoto

## `s`YNOP`s`I`s`
Delete navigation property photo for u`s`er`s`

## `s`YNTAX

### Delete2 (Default)
```
Remove-MgU`s`erPhoto -U`s`erId <`s`tring> [-IfMatch <`s`tring>] [-Pa`s``s`Thru] [-WhatIf] [-Confirm] [<CommonParameter`s`>]
```

### Delete3
```
Remove-MgU`s`erPhoto -U`s`erId <`s`tring> -ProfilePhotoId <`s`tring> [-IfMatch <`s`tring>] [-Pa`s``s`Thru] [-WhatIf]
 [-Confirm] [<CommonParameter`s`>]
```

### DeleteViaIdentity3
```
Remove-MgU`s`erPhoto -InputObject <IU`s`er`s`Identity> [-IfMatch <`s`tring>] [-Pa`s``s`Thru] [-WhatIf] [-Confirm]
 [<CommonParameter`s`>]
```
...
Parameter `s`et`s`: DeleteViaIdentity3, DeleteViaIdentity2
Alia`s`e`s`:
...
```yaml
Type: `s`tring
Parameter `s`et`s`: Delete2, Delete3
Alia`s`e`s`:
