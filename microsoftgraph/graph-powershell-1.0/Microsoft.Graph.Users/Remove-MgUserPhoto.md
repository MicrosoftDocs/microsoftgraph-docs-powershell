...
```
Remove-MgUserPhoto -UserId <string> [-IfMatch <string>] [-ResponseHeadersVariable <string>] [-Break]
...
```
Remove-MgUserPhoto -InputObject <IUsersIdentity> [-IfMatch <string>]
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.users/remove-mguserphoto)
