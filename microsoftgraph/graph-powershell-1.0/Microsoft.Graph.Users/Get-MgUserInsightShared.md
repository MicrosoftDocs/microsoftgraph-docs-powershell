...
### List (Default)
```
Get-MgUserInsightShared -UserId <String> [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgUserInsightShared -InputObject <IUsersIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
