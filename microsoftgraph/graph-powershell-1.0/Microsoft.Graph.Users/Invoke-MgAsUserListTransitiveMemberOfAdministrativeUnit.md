...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users/invoke-mgasuserlisttransitivememberofadministrativeunit
schema: 2.0.0
---
...
### As1 (Default)
```
Invoke-MgAsUserListTransitiveMemberOfAdministrativeUnit -UserId <String> [-Count] [-ExpandProperty <String[]>]
...
### AsViaIdentity1
```
Invoke-MgAsUserListTransitiveMemberOfAdministrativeUnit -InputObject <IUsersIdentity> [-Count]
