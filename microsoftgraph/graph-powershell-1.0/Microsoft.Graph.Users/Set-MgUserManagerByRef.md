...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.users/set-mgusermanagerbyref
Locale: en-US
Module Name: Microsoft.Graph.Users
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: Set-MgUserManagerByRef
---
...
```
Set-MgUserManagerByRef -UserId <string> -OdataId <string> [-ResponseHeadersVariable <string>]
...
```
Set-MgUserManagerByRef -UserId <string> -BodyParameter <IReferenceUpdate>
...
```
Set-MgUserManagerByRef -InputObject <IUsersIdentity> -OdataId <string>
