...
```
New-MgUserSettingWorkHourAndLocationOccurrence -UserId <string> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-End <IMicrosoftGraphDateTimeZone>] [-Id <string>]
 [-PlaceId <string>] [-RecurrenceId <string>] [-Start <IMicrosoftGraphDateTimeZone>]
 [-TimeOffDetails <IMicrosoftGraphTimeOffDetails>] [-WorkLocationType <string>] [-Break]
...
```
New-MgUserSettingWorkHourAndLocationOccurrence -UserId <string>
...
```
New-MgUserSettingWorkHourAndLocationOccurrence -InputObject <IUsersIdentity>
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphWorkPlanOccurrence
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphTimeOffDetails
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
