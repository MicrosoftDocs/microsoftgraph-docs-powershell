...
### List (Default)
```
Get-MgUserInsightUsed -UserId <String> [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
### Get
```
Get-MgUserInsightUsed -UsedInsightId <String> -UserId <String> [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgUserInsightUsed -InputObject <IUsersIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.users/get-mguserinsightused](https://learn.microsoft.com/powershell/module/microsoft.graph.users/get-mguserinsightused)
