...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.users/get-mgusersettingstoragequotaservice
Locale: en-US
Module Name: Microsoft.Graph.Users
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Get-MgUserSettingStorageQuotaService
---
...
```
Get-MgUserSettingStorageQuotaService -UserId <string> [-ExpandProperty <string[]>]
...
```
Get-MgUserSettingStorageQuotaService -ServiceStorageQuotaBreakdownId <string> -UserId <string>
...
```
Get-MgUserSettingStorageQuotaService -InputObject <IUsersIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgUserSettingStorageQuotaService](https://learn.microsoft.com/powershell/module/microsoft.graph.users/get-mgusersettingstoragequotaservice)
