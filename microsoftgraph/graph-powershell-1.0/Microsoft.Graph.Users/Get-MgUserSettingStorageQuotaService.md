...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.users/get-mgusersettingstoragequotaservice
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserSettingStorageQuotaService -UserId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
