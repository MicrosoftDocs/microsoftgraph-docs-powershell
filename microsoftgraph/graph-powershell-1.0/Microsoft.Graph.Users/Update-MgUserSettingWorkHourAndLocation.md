...
# Update-MgUserSettingWorkHourAndLocation
...
```
Update-MgUserSettingWorkHourAndLocation -UserId <string> [-ResponseHeadersVariable <string>]
...
```
Update-MgUserSettingWorkHourAndLocation -UserId <string>
...
```
Update-MgUserSettingWorkHourAndLocation -InputObject <IUsersIdentity>
