...
```
Set-MgUserSettingWorkHourAndLocationRecurrence -UserId <string> -WorkPlanRecurrenceId <string>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-End <IMicrosoftGraphDateTimeZone>] [-Id <string>] [-PlaceId <string>]
 [-Recurrence <IMicrosoftGraphPatternedRecurrence>] [-Start <IMicrosoftGraphDateTimeZone>]
...
```
Set-MgUserSettingWorkHourAndLocationRecurrence -UserId <string> -WorkPlanRecurrenceId <string>
 -BodyParameter <IMicrosoftGraphWorkPlanRecurrence> [-ResponseHeadersVariable <string>] [-Break]
...
```
Set-MgUserSettingWorkHourAndLocationRecurrence -InputObject <IUsersIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-End <IMicrosoftGraphDateTimeZone>] [-Id <string>] [-PlaceId <string>]
 [-Recurrence <IMicrosoftGraphPatternedRecurrence>] [-Start <IMicrosoftGraphDateTimeZone>]
 [-WorkLocationType <string>] [-Break] [-Headers <IDictionary>]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphWorkPlanRecurrence
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.PowerShell.Models.IMicrosoftGraphWorkPlanRecurrence
