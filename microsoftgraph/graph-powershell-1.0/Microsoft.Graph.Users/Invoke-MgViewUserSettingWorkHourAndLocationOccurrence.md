...
```
Invoke-MgViewUserSettingWorkHourAndLocationOccurrence -EndDateTime <string> -StartDateTime <string>
...
```
Invoke-MgViewUserSettingWorkHourAndLocationOccurrence -InputObject <IUsersIdentity> [-Count]
