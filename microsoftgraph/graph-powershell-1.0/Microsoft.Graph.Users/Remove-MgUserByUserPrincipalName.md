...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.users/remove-mguserbyuserprincipalname
schema: 2.0.0
...
### Delete (Default)
```
Remove-MgUserByUserPrincipalName -UserPrincipalName <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgUserByUserPrincipalName -InputObject <IUsersIdentity> [-IfMatch <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
