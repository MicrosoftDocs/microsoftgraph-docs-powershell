...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.users/get-mguseronpremisesyncbehavior
Locale: en-US
Module Name: Microsoft.Graph.Users
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Get-MgUserOnPremiseSyncBehavior
---
...
```
Get-MgUserOnPremiseSyncBehavior -UserId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgUserOnPremiseSyncBehavior -InputObject <IUsersIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgUserOnPremiseSyncBehavior](https://learn.microsoft.com/powershell/module/microsoft.graph.users/get-mguseronpremisesyncbehavior)
