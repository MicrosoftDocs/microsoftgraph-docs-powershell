...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.users/update-mguseronpremisesyncbehavior
Locale: en-US
Module Name: Microsoft.Graph.Users
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: Update-MgUserOnPremiseSyncBehavior
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaUserOnPremiseSyncBehavior](/powershell/module/Microsoft.Graph.Beta.Users/Update-MgBetaUserOnPremiseSyncBehavior?view=graph-powershell-beta)
...
```
Update-MgUserOnPremiseSyncBehavior -UserId <string> [-ResponseHeadersVariable <string>]
...
```
Update-MgUserOnPremiseSyncBehavior -UserId <string>
...
```
Update-MgUserOnPremiseSyncBehavior -InputObject <IUsersIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Id <string>] [-IsCloudManaged] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```
Update-MgUserOnPremiseSyncBehavior -InputObject <IUsersIdentity>
 -BodyParameter <IMicrosoftGraphOnPremisesSyncBehavior> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
