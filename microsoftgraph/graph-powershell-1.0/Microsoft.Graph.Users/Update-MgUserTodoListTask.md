...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.users/update-mgusertodolisttask
Locale: en-US
Module Name: Microsoft.Graph.Users
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Update-MgUserTodoListTask
---
...
Update-MgUserTodoListTask -TodoTaskId <string> -TodoTaskListId <string> -UserId <string>
 ...
 [-Status <string>] [-Title <string>] [-Break] [-Headers <IDictionary>]
...
```
Update-MgUserTodoListTask -InputObject <IUsersIdentity> [-ResponseHeadersVariable <string>]
