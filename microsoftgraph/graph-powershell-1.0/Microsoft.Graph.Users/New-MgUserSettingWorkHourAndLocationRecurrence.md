...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.users/new-mgusersettingworkhourandlocationrecurrence
Locale: en-US
Module Name: Microsoft.Graph.Users
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: New-MgUserSettingWorkHourAndLocationRecurrence
---
...
```
New-MgUserSettingWorkHourAndLocationRecurrence -UserId <string> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-End <IMicrosoftGraphDateTimeZone>] [-Id <string>]
 [-PlaceId <string>] [-Recurrence <IMicrosoftGraphPatternedRecurrence>]
 [-Start <IMicrosoftGraphDateTimeZone>] [-WorkLocationType <string>] [-Break]
...
```
New-MgUserSettingWorkHourAndLocationRecurrence -UserId <string>
...
```
New-MgUserSettingWorkHourAndLocationRecurrence -InputObject <IUsersIdentity>
