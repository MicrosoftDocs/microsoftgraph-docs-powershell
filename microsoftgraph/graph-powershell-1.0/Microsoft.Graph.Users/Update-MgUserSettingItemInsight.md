...
```
Update-MgUserSettingItemInsight -UserId <string> [-ResponseHeadersVariable <string>]
...
```
Update-MgUserSettingItemInsight -UserId <string>
...
```
Update-MgUserSettingItemInsight -InputObject <IUsersIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Id <string>] [-IsEnabled] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
 [<CommonParameters>]
