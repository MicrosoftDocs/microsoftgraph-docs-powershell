...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.users/get-mgusersettingwindowsinstance
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserSettingWindowsInstance -UserId <String> -WindowsSettingId <String> [-ExpandProperty <String[]>]
...
### Get
```
Get-MgUserSettingWindowsInstance -UserId <String> -WindowsSettingId <String> -WindowsSettingInstanceId <String>
...
### GetViaIdentity
```
Get-MgUserSettingWindowsInstance -InputObject <IUsersIdentity> [-ExpandProperty <String[]>]
...
## RELATED LINKS
[Get-MgBetaUserSettingWindowsInstance](/powershell/module/Microsoft.Graph.Beta.Users/Get-MgBetaUserSettingWindowsInstance?view=graph-powershell-beta)
