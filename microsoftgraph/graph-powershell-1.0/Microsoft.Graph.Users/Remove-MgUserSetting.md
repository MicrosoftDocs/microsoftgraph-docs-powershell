...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.users/remove-mgusersetting
Locale: en-US
Module Name: Microsoft.Graph.Users
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: Remove-MgUserSetting
---
...
```
Remove-MgUserSetting -UserId <string> [-IfMatch <string>] [-ResponseHeadersVariable <string>]
...
```
Remove-MgUserSetting -InputObject <IUsersIdentity> [-IfMatch <string>]
