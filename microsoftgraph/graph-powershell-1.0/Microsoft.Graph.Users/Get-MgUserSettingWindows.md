...
```
Get-MgUserSettingWindows -UserId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgUserSettingWindows -InputObject <IUsersIdentity> [-ExpandProperty <string[]>]
 [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
```
...
- [Get-MgUserSettingWindows](https://learn.microsoft.com/powershell/module/microsoft.graph.users/get-mgusersettingwindows)
