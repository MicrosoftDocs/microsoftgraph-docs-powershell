...
## Permissions
One of the following permissions is required to call this cmdlet. To learn more, including how to choose permissions, see [Permissions](/graph/permissions-reference).
