...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.users/get-mgusersettingwindowsinstancecount
Locale: en-US
Module Name: Microsoft.Graph.Users
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: Get-MgUserSettingWindowsInstanceCount
---
...
```
Get-MgUserSettingWindowsInstanceCount -UserId <string> -WindowsSettingId <string> [-Filter <string>]
...
```
Get-MgUserSettingWindowsInstanceCount -InputObject <IUsersIdentity> [-Filter <string>]
 [-Search <string>] [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [<CommonParameters>]
```
