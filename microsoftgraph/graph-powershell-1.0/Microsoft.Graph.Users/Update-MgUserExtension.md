...
### Update1
```
Update-MgUserExtension -ExtensionId <String> -UserId <String> -BodyParameter <Hashtable> [-PassThru] [-WhatIf]
...
### UpdateViaIdentity1
```
Update-MgUserExtension -InputObject <IUsersIdentity> -BodyParameter <Hashtable> [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
