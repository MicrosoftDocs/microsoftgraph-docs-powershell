...
```
Remove-MgUser -UserId <string> [-IfMatch <string>] [-ResponseHeadersVariable <string>] [-Break]
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.users/remove-mguser)
