...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.users/invoke-mgtimeuseroutlook
schema: 2.0.0
---
...
### TimeViaIdentity1
```
Invoke-MgTimeUserOutlook -InputObject <IUsersIdentity> [-Count] [-Filter <String>] [-Search <String>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.users/invoke-mgtimeuseroutlook](https://learn.microsoft.com/powershell/module/microsoft.graph.users/invoke-mgtimeuseroutlook)
