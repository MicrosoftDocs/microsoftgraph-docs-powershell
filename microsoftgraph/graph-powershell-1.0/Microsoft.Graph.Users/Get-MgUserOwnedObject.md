...
[https://learn.microsoft.com/graph/api/user-list-ownedobjects?view=graph-rest-1.0](https://learn.microsoft.com/graph/api/user-list-ownedobjects?view=graph-rest-1.0)
