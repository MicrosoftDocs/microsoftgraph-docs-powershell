...
Update-MgRoleManagement [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-Directory <IMicrosoftGraphRbacApplication>]
 [-EntitlementManagement <IMicrosoftGraphRbacApplication>] [-Break] [-Headers <IDictionary>]
...
```
Update-MgRoleManagement -BodyParameter <IMicrosoftGraphRoleManagement>
