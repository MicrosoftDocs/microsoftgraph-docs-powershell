...
New-MgDeviceManagementWindowsAutopilotDeviceIdentity [-ResponseHeadersVariable <string>]
 ...
 [-AzureActiveDirectoryDeviceId <string>] [-DisplayName <string>]
 [-EnrollmentState <EnrollmentState>] [-GroupTag <string>] [-Id <string>]
 ...
 [-ResourceName <string>] [-SerialNumber <string>] [-SkuNumber <string>] [-SystemFamily <string>]
