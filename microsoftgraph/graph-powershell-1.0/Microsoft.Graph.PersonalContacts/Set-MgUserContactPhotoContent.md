...
### Set (Default)
```
Set-MgUserContactPhotoContent -ContactId <String> -UserId <String> [-Data <Stream>]
...
### SetViaIdentity
```
Set-MgUserContactPhotoContent -InputObject <IPersonalContactsIdentity> [-Data <Stream>]
 [-ResponseHeadersVariable <String>] -InFile <String> [-ContentType <String>] [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
