...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.personalcontacts/new-mgusercontact
Locale: en-US
Module Name: Microsoft.Graph.PersonalContacts
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: New-MgUserContact
---
...
```
New-MgUserContact -UserId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgUserContact -UserId <string> -BodyParameter <IMicrosoftGraphContact>
...
```
New-MgUserContact -InputObject <IPersonalContactsIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-AssistantName <string>] [-Birthday <datetime>]
 [-BusinessAddress <IMicrosoftGraphPhysicalAddress>] [-BusinessHomePage <string>]
 [-BusinessPhones <string[]>] [-Categories <string[]>] [-ChangeKey <string>] [-Children <string[]>]
 [-CompanyName <string>] [-CreatedDateTime <datetime>] [-Department <string>]
