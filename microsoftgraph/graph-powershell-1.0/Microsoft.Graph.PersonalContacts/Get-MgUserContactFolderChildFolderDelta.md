...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.personalcontacts/get-mgusercontactfolderchildfolderdelta
schema: 2.0.0
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaUserContactFolderChildFolderDelta](/powershell/module/Microsoft.Graph.Beta.PersonalContacts/Get-MgBetaUserContactFolderChildFolderDelta?view=graph-powershell-beta)

## SYNTAX

### Delta (Default)
```
Get-MgUserContactFolderChildFolderDelta -ContactFolderId <String> -UserId <String> [-ExpandProperty <String[]>]
...
### DeltaViaIdentity
```
Get-MgUserContactFolderChildFolderDelta -InputObject <IPersonalContactsIdentity> [-ExpandProperty <String[]>]
 [-Filter <String>] [-Property <String[]>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>] [-Top <Int32>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.personalcontacts/get-mgusercontactfolderchildfolderdelta](https://learn.microsoft.com/powershell/module/microsoft.graph.personalcontacts/get-mgusercontactfolderchildfolderdelta)
