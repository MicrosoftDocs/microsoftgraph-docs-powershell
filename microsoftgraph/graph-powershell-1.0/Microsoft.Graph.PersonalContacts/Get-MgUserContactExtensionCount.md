...
### Get (Default)
```
Get-MgUserContactExtensionCount -ContactId <String> -UserId <String> [-Filter <String>] [-Search <String>]
...
### GetViaIdentity
```
Get-MgUserContactExtensionCount -InputObject <IPersonalContactsIdentity> [-Filter <String>] [-Search <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
