...
```
Get-MgUserContactFolderChildFolder -ContactFolderId <string> -UserId <string>
...
```
Get-MgUserContactFolderChildFolder -ContactFolderId <string> -ContactFolderId1 <string>
...
```
Get-MgUserContactFolderChildFolder -InputObject <IPersonalContactsIdentity>
...
- [Get-MgUserContactFolderChildFolder](https://learn.microsoft.com/powershell/module/microsoft.graph.personalcontacts/get-mgusercontactfolderchildfolder)
