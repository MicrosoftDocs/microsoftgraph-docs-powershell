...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.personalcontacts/remove-mgusercontactfoldercontactextension
Locale: en-US
Module Name: Microsoft.Graph.PersonalContacts
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: Remove-MgUserContactFolderContactExtension
---
...
```
Remove-MgUserContactFolderContactExtension -ContactFolderId <string> -ContactId <string>
 -ExtensionId <string> -UserId <string> [-IfMatch <string>] [-ResponseHeadersVariable <string>]
...
```
Remove-MgUserContactFolderContactExtension -InputObject <IPersonalContactsIdentity>
