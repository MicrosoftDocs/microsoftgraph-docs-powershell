...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.personalcontacts/get-mgusercontact
Locale: en-US
Module Name: Microsoft.Graph.PersonalContacts
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Get-MgUserContact
---
...
```
Get-MgUserContact -UserId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgUserContact -ContactId <string> -UserId <string> [-ExpandProperty <string[]>]
...
```
Get-MgUserContact -InputObject <IPersonalContactsIdentity> [-ExpandProperty <string[]>]
 [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [<CommonParameters>]
```
