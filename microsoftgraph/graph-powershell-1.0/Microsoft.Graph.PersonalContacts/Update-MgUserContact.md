...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaBetaUserContact](/powershell/module/Microsoft.Graph.Beta.PersonalContacts/Update-MgBetaUserContact?view=graph-powershell-beta)
...
### Update
```
Update-MgUserContact -ContactId <String> -UserId <String> -BodyParameter <IMicrosoftGraphContact> [-WhatIf]
...
### UpdateViaIdentity
```
Update-MgUserContact -InputObject <IPersonalContactsIdentity> -BodyParameter <IMicrosoftGraphContact> [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgBetaBetaUserContact](/powershell/module/Microsoft.Graph.Beta.PersonalContacts/Update-MgBetaUserContact?view=graph-powershell-beta)
