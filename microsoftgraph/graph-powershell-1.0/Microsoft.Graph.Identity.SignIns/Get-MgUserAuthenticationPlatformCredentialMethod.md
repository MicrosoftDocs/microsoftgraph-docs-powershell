...
```
Get-MgUserAuthenticationPlatformCredentialMethod -UserId <string> [-ExpandProperty <string[]>]
...
```
Get-MgUserAuthenticationPlatformCredentialMethod -PlatformCredentialAuthenticationMethodId <string>
...
```
Get-MgUserAuthenticationPlatformCredentialMethod -InputObject <IIdentitySignInsIdentity>
...
### Microsoft.Graph.PowerShell.Models.IMicrosoftGraphPlatformCredentialAuthenticationMethod
...
- [Get-MgUserAuthenticationPlatformCredentialMethod](https://learn.microsoft.com/powershell/module/microsoft.graph.identity.signins/get-mguserauthenticationplatformcredentialmethod)
