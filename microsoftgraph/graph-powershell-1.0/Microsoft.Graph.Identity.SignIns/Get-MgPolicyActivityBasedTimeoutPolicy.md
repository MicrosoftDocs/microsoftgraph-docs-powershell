...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.signins/get-mgpolicyactivitybasedtimeoutpolicy
Locale: en-US
Module Name: Microsoft.Graph.Identity.SignIns
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: Get-MgPolicyActivityBasedTimeoutPolicy
---
...
```
Get-MgPolicyActivityBasedTimeoutPolicy [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgPolicyActivityBasedTimeoutPolicy -ActivityBasedTimeoutPolicyId <string>
...
```
Get-MgPolicyActivityBasedTimeoutPolicy -InputObject <IIdentitySignInsIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
...
- [Get-MgPolicyActivityBasedTimeoutPolicy](https://learn.microsoft.com/powershell/module/microsoft.graph.identity.signins/get-mgpolicyactivitybasedtimeoutpolicy)
- [Graph API Reference](https://learn.microsoft.com/graph/api/activitybasedtimeoutpolicy-get?view=graph-rest-1.0)
- [Graph API Reference](https://learn.microsoft.com/graph/api/activitybasedtimeoutpolicy-list?view=graph-rest-1.0)
