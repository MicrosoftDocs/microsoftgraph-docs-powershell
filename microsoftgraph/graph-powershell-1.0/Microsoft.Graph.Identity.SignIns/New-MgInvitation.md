...
### Create1
```
New-MgInvitation -BodyParameter <IMicrosoftGraphInvitation1> [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```yaml
Type: IMicrosoftGraphInvitation1
...
### -InvitedUser
user
To construct, please use Get-Help -Online and see NOTES section for INVITEDUSER properties and create a hash table.
...
invitedUserMessageInfo
To construct, please use Get-Help -Online and see NOTES section for INVITEDUSERMESSAGEINFO properties and create a hash table.
...
BODYPARAMETER `<IMicrosoftGraphInvitation1>`: invitation
  ...
  - `[InvitedUser <IMicrosoftGraphUser1>]`: user
    - `[(Any) <Object>]`: This indicates any property can be added to this object.
