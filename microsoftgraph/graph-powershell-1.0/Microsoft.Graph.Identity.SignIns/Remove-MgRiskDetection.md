...
### Delete (Default)
```
Remove-MgRiskDetection -RiskDetectionId <String> [-IfMatch <String>] [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgRiskDetection -InputObject <IIdentitySignInsIdentity> [-IfMatch <String>] [-Headers <IDictionary>]
