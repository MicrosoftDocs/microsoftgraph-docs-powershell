...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaUserAuthenticationOperation](/powershell/module/Microsoft.Graph.Beta.Identity.SignIns/Get-MgUserAuthenticationOperation?view=graph-powershell-beta)

## SYNTAX

### List (Default)
```
Get-MgUserAuthenticationOperation -UserId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
## RELATED LINKS
[Get-MgBetaUserAuthenticationOperation](/powershell/module/Microsoft.Graph.Beta.Identity.SignIns/Get-MgUserAuthenticationOperation?view=graph-powershell-beta)
