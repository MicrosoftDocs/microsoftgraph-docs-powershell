...
# Update-MgPolicyOwnerlessGroupPolicy
...
```
Update-MgPolicyOwnerlessGroupPolicy [-ResponseHeadersVariable <string>]
...
```
Update-MgPolicyOwnerlessGroupPolicy -BodyParameter <IMicrosoftGraphOwnerlessGroupPolicy>
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphOwnerlessGroupPolicy
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphEmailDetails
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphTargetOwners
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.PowerShell.Models.IMicrosoftGraphOwnerlessGroupPolicy
