...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.signins/get-mgpolicyhomerealmdiscoverypolicy
Locale: en-US
Module Name: Microsoft.Graph.Identity.SignIns
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Get-MgPolicyHomeRealmDiscoveryPolicy
---
...
```
Get-MgPolicyHomeRealmDiscoveryPolicy [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgPolicyHomeRealmDiscoveryPolicy -HomeRealmDiscoveryPolicyId <string>
...
```
Get-MgPolicyHomeRealmDiscoveryPolicy -InputObject <IIdentitySignInsIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [<CommonParameters>]
