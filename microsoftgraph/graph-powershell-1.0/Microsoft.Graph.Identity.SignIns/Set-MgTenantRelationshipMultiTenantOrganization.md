...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.signins/set-mgtenantrelationshipmultitenantorganization
schema: 2.0.0
---

# Set-MgTenantRelationshipMultiTenantOrganization

## SYNOPSIS
Update the navigation property multiTenantOrganization in tenantRelationships

> [!NOTE]
> To view the beta release of this cmdlet, view [Set-MgBetaTenantRelationshipMultiTenantOrganization](/powershell/module/Microsoft.Graph.Beta.Identity.SignIns/Set-MgBetaTenantRelationshipMultiTenantOrganization?view=graph-powershell-beta)

## SYNTAX

### SetExpanded (Default)
```
Set-MgTenantRelationshipMultiTenantOrganization [-ResponseHeadersVariable <String>]
...
### Set
```
Set-MgTenantRelationshipMultiTenantOrganization -BodyParameter <IMicrosoftGraphMultiTenantOrganization>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.identity.signins/set-mgtenantrelationshipmultitenantorganization](https://learn.microsoft.com/powershell/module/microsoft.graph.identity.signins/set-mgtenantrelationshipmultitenantorganization)
