...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.signins/enable-mguserauthenticationphonemethodsmssignin
schema: 2.0.0
...
### EnableViaIdentity
```
Enable-MgUserAuthenticationPhoneMethodSmsSignIn -InputObject <IIdentitySignInsIdentity>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.identity.signins/enable-mguserauthenticationphonemethodsmssignin](https://learn.microsoft.com/powershell/module/microsoft.graph.identity.signins/enable-mguserauthenticationphonemethodsmssignin)
