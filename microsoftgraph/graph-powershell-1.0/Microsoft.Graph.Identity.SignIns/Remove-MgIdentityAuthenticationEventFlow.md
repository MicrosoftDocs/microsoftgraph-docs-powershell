...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.signins/remove-mgidentityauthenticationeventflow
schema: 2.0.0
...
### Delete (Default)
```
Remove-MgIdentityAuthenticationEventFlow -AuthenticationEventsFlowId <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgIdentityAuthenticationEventFlow -InputObject <IIdentitySignInsIdentity> [-IfMatch <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
