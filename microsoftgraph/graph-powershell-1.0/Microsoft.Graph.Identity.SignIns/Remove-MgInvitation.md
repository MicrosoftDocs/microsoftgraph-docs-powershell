...
### Delete (Default)
```
Remove-MgInvitation -InvitationId <String> [-IfMatch <String>] [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgInvitation -InputObject <IIdentitySignInsIdentity> [-IfMatch <String>] [-Headers <IDictionary>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.identity.signins/remove-mginvitation](https://learn.microsoft.com/powershell/module/microsoft.graph.identity.signins/remove-mginvitation)
