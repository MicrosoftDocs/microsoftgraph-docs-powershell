...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.signins/get-mgmeauthenticationoperation
schema: 2.0.0
---
...
### List (Default)
```
Get-MgMeAuthenticationOperation [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
### Get
```
Get-MgMeAuthenticationOperation -LongRunningOperationId <String> [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgMeAuthenticationOperation -InputObject <IIdentitySignInsIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
