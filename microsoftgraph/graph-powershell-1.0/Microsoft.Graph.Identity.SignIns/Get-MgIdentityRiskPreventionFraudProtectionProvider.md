...
```
Get-MgIdentityRiskPreventionFraudProtectionProvider [-ExpandProperty <string[]>]
...
```
Get-MgIdentityRiskPreventionFraudProtectionProvider -FraudProtectionProviderId <string>
...
```
Get-MgIdentityRiskPreventionFraudProtectionProvider -InputObject <IIdentitySignInsIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
...
```
This example shows how to use the Get-MgIdentityRiskPreventionFraudProtectionProvider Cmdlet.
...
The unique identifier of fraudProtectionProvider
