...
Get-MgRiskyServicePrincipalHistory -RiskyServicePrincipalHistoryItemId <String>
 -RiskyServicePrincipalId <String> [-ExpandProperty <String[]>] [-Property <String[]>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
## RELATED LINKS
[Get-MgBetaRiskyServicePrincipalHistory](/powershell/module/Microsoft.Graph.Beta.Identity.SignIns/Get-MgBetaRiskyServicePrincipalHistory?view=graph-powershell-beta)
