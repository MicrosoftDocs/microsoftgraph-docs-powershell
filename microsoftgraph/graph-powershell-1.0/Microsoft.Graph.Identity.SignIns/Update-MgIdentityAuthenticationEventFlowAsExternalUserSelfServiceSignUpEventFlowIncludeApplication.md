...
Update-MgIdentityAuthenticationEventFlowAsExternalUserSelfServiceSignUpEventFlowIncludeApplication
 ...
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-AppId <string>] [-Break]
...
Update-MgIdentityAuthenticationEventFlowAsExternalUserSelfServiceSignUpEventFlowIncludeApplication
 -AuthenticationConditionApplicationAppId <string> -AuthenticationEventsFlowId <string>
 -BodyParameter <IMicrosoftGraphAuthenticationConditionApplication>
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphAuthenticationConditionApplication
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
