...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.signins/remove-mgpolicyfeaturerolloutpolicyapplytodirectoryobjectbyref
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgPolicyFeatureRolloutPolicyApplyToDirectoryObjectByRef -DirectoryObjectId <String>
...
### DeleteViaIdentity
```
Remove-MgPolicyFeatureRolloutPolicyApplyToDirectoryObjectByRef -InputObject <IIdentitySignInsIdentity>
...
## RELATED LINKS
[Remove-MgBetaPolicyFeatureRolloutPolicyApplyToDirectoryObjectByRef](/powershell/module/Microsoft.Graph.Beta.Identity.SignIns/Remove-MgBetaPolicyFeatureRolloutPolicyApplyToDirectoryObjectByRef?view=graph-powershell-beta)
