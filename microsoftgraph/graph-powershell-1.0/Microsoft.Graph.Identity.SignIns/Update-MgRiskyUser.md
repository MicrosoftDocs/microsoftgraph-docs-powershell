...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaBetaRiskyUser](/powershell/module/Microsoft.Graph.Beta.Identity.SignIns/Update-MgBetaRiskyUser?view=graph-powershell-beta)
...
### Update
```
Update-MgRiskyUser -RiskyUserId <String> -BodyParameter <IMicrosoftGraphRiskyUser> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### UpdateViaIdentity
```
Update-MgRiskyUser -InputObject <IIdentitySignInsIdentity> -BodyParameter <IMicrosoftGraphRiskyUser> [-WhatIf]
...
## RELATED LINKS
[Update-MgBetaBetaRiskyUser](/powershell/module/Microsoft.Graph.Beta.Identity.SignIns/Update-MgBetaRiskyUser?view=graph-powershell-beta)
