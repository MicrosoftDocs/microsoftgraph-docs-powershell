...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.signins/remove-mgidentityapiconnector
Locale: en-US
Module Name: Microsoft.Graph.Identity.SignIns
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Remove-MgIdentityApiConnector
---
...
```
Remove-MgIdentityApiConnector -IdentityApiConnectorId <string> [-IfMatch <string>]
...
- [Remove-MgIdentityApiConnector](https://learn.microsoft.com/powershell/module/microsoft.graph.identity.signins/remove-mgidentityapiconnector)
- [Graph API Reference](https://learn.microsoft.com/graph/api/identityapiconnector-delete?view=graph-rest-1.0)
