...
### Delete (Default)
```
Remove-MgPolicyTokenIssuancePolicy -TokenIssuancePolicyId <String> [-IfMatch <String>] [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgPolicyTokenIssuancePolicy -InputObject <IIdentitySignInsIdentity> [-IfMatch <String>]
