...
# Get-MgPolicyCrossTenantAccessPolicyDefaultM365Capability
...
```
Get-MgPolicyCrossTenantAccessPolicyDefaultM365Capability [-ExpandProperty <string[]>]
...
```
Get-MgPolicyCrossTenantAccessPolicyDefaultM365Capability -M365CapabilityBaseName <string>
...
```
Get-MgPolicyCrossTenantAccessPolicyDefaultM365Capability -InputObject <IIdentitySignInsIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
