...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.signins/get-mgmeauthenticationmethod
schema: 2.0.0
...
### List (Default)
```
Get-MgMeAuthenticationMethod [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
### Get
```
Get-MgMeAuthenticationMethod -AuthenticationMethodId <String> [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgMeAuthenticationMethod -InputObject <IIdentitySignInsIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.identity.signins/get-mgmeauthenticationmethod](https://learn.microsoft.com/powershell/module/microsoft.graph.identity.signins/get-mgmeauthenticationmethod)
