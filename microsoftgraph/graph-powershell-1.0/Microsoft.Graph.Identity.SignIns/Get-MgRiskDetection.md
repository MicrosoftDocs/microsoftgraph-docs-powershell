...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.signins/get-mgriskdetection
Locale: en-US
Module Name: Microsoft.Graph.Identity.SignIns
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Get-MgRiskDetection
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaRiskDetection](/powershell/module/Microsoft.Graph.Beta.Identity.SignIns/Get-MgBetaRiskDetection?view=graph-powershell-beta)
...
```
Get-MgRiskDetection [-ExpandProperty <string[]>] [-Property <string[]>] [-Filter <string>]
...
- [Get-MgRiskDetection](https://learn.microsoft.com/powershell/module/microsoft.graph.identity.signins/get-mgriskdetection)
- [Graph API Reference](https://learn.microsoft.com/graph/api/riskdetection-get?view=graph-rest-1.0)
- [Graph API Reference](https://learn.microsoft.com/graph/api/riskdetection-list?view=graph-rest-1.0)
