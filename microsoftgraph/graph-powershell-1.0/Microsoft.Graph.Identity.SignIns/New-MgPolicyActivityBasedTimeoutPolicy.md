...
```
New-MgPolicyActivityBasedTimeoutPolicy [-ResponseHeadersVariable <string>]
...
```
New-MgPolicyActivityBasedTimeoutPolicy -BodyParameter <hashtable>
...
- [New-MgPolicyActivityBasedTimeoutPolicy](https://learn.microsoft.com/powershell/module/microsoft.graph.identity.signins/new-mgpolicyactivitybasedtimeoutpolicy)
- [Graph API Reference](https://learn.microsoft.com/graph/api/activitybasedtimeoutpolicy-post-activitybasedtimeoutpolicies?view=graph-rest-1.0)
