...
```
New-MgPolicyActivityBasedTimeoutPolicy [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>]
...
### Create
```
New-MgPolicyActivityBasedTimeoutPolicy -BodyParameter <Hashtable> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
