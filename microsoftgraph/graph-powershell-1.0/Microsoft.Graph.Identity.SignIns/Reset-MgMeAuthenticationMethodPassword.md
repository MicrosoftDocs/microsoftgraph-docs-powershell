...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.signins/reset-mgmeauthenticationmethodpassword
schema: 2.0.0
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Reset-MgBetaMeAuthenticationMethodPassword](/powershell/module/Microsoft.Graph.Beta.Identity.SignIns/Reset-MgBetaMeAuthenticationMethodPassword?view=graph-powershell-beta)

## SYNTAX

### ResetExpanded (Default)
```
Reset-MgMeAuthenticationMethodPassword -AuthenticationMethodId <String> [-ResponseHeadersVariable <String>]
...
### Reset
```
Reset-MgMeAuthenticationMethodPassword -AuthenticationMethodId <String>
...
```
Reset-MgMeAuthenticationMethodPassword -InputObject <IIdentitySignInsIdentity>
...
### Microsoft.Graph.PowerShell.Models.IPathsR0PzawMeAuthenticationMethodsAuthenticationmethodIdMicrosoftGraphResetpasswordPostRequestbodyContentApplicationJsonSchema
