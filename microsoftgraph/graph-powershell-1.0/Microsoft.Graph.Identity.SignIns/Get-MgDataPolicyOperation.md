...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.signins/get-mgdatapolicyoperation
Locale: en-US
Module Name: Microsoft.Graph.Identity.SignIns
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Get-MgDataPolicyOperation
---
...
```
Get-MgDataPolicyOperation -DataPolicyOperationId <string> [-ExpandProperty <string[]>]
...
- [Get-MgDataPolicyOperation](https://learn.microsoft.com/powershell/module/microsoft.graph.identity.signins/get-mgdatapolicyoperation)
- [Graph API Reference](https://learn.microsoft.com/graph/api/datapolicyoperation-get?view=graph-rest-1.0)
