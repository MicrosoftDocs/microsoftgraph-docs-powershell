...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.directorymanagement/update-mgdirectoryrecovery
Locale: en-US
Module Name: Microsoft.Graph.Identity.DirectoryManagement
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Update-MgDirectoryRecovery
---

# Update-MgDirectoryRecovery
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaDirectoryRecovery](/powershell/module/Microsoft.Graph.Beta.Identity.DirectoryManagement/Update-MgBetaDirectoryRecovery?view=graph-powershell-beta)
...
```
Update-MgDirectoryRecovery [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-Id <string>] [-Jobs <IMicrosoftGraphEntraRecoveryServicesRecoveryJobBase[]>]
...
```
Update-MgDirectoryRecovery -BodyParameter <IMicrosoftGraphEntraRecoveryServicesRecovery>
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphEntraRecoveryServicesRecoveryJobBase[]
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphEntraRecoveryServicesSnapshot[]
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.PowerShell.Models.IMicrosoftGraphEntraRecoveryServicesRecovery
...
- [Update-MgDirectoryRecovery](https://learn.microsoft.com/powershell/module/microsoft.graph.identity.directorymanagement/update-mgdirectoryrecovery)
