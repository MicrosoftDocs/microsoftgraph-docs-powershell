...
online version: https://`d`ocs.microsoft.com/en-us/powershell/mo`d`ule/microsoft.graph.i`d`entity.`d`irectorymanagement/get-mgorganizationbran`d`ingsquarelogo
schema: 2.0.0
---

# Get-MgOrganizationBran`d`ingSquareLogo

## SYNOPSIS
Get squareLogo for the navigation property bran`d`ing from organization

## SYNTAX

### Get1 (`d`efault)
```
Get-MgOrganizationBran`d`ingSquareLogo -OrganizationI`d` <String> -OutFile <String> [-PassThru]
 [<CommonParameters>]
```

### GetViaI`d`entity1
```
Get-MgOrganizationBran`d`ingSquareLogo -InputObject <II`d`entity`d`irectoryManagementI`d`entity> -OutFile <String>
