...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.directorymanagement/new-mgdirectoryrecoveryjob
Locale: en-US
Module Name: Microsoft.Graph.Identity.DirectoryManagement
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: New-MgDirectoryRecoveryJob
---

# New-MgDirectoryRecoveryJob
...
```
New-MgDirectoryRecoveryJob [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-FilteringCriteria <hashtable>] [-Id <string>] [-JobCompletionDateTime <datetime>]
 [-JobStartDateTime <datetime>] [-Status <RecoveryStatus>] [-TargetStateDateTime <datetime>]
 [-TotalChangedLinksCalculated <int>] [-TotalChangedObjectsCalculated <int>] [-Break]
...
```
New-MgDirectoryRecoveryJob -BodyParameter <IMicrosoftGraphEntraRecoveryServicesRecoveryJobBase>
...
```yaml
Type: Microsoft.Graph.PowerShell.Support.RecoveryStatus
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
