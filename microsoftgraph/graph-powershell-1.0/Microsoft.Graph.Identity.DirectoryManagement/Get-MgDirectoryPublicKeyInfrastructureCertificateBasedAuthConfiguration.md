...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaDirectoryPublicKeyInfrastructureCertificateBasedAuthConfiguration](/powershell/module/Microsoft.Graph.Beta.Identity.DirectoryManagement/Get-MgBetaDirectoryPublicKeyInfrastructureCertificateBasedAuthConfiguration?view=graph-powershell-beta)
...
```
Get-MgDirectoryPublicKeyInfrastructureCertificateBasedAuthConfiguration [-ExpandProperty <string[]>]
