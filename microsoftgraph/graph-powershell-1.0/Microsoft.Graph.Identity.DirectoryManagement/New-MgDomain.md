...
```
New-MgDomain [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
...
```
New-MgDomain -BodyParameter <IMicrosoftGraphDomain> [-ResponseHeadersVariable <string>] [-Break]
