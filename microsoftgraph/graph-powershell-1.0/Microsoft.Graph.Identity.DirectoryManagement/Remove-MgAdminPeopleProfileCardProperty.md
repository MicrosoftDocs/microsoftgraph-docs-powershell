...
### Delete (Default)
```
Remove-MgAdminPeopleProfileCardProperty -ProfileCardPropertyId <String> [-IfMatch <String>] [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgAdminPeopleProfileCardProperty -InputObject <IIdentityDirectoryManagementIdentity> [-IfMatch <String>]
