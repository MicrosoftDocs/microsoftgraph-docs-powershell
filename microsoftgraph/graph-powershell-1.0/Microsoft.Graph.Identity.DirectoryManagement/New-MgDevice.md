...
```
New-MgDevice [-ResponseHeadersVariable <String>] [-AccountEnabled] [-AdditionalProperties <Hashtable>]
...
### Create
```
New-MgDevice -BodyParameter <IMicrosoftGraphDevice> [-ResponseHeadersVariable <String>]
