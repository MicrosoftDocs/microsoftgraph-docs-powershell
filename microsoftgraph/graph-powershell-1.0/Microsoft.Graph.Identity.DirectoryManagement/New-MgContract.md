...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.directorymanagement/new-mgcontract
Locale: en-US
Module Name: Microsoft.Graph.Identity.DirectoryManagement
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: New-MgContract
---
...
```
New-MgContract [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-ContractType <string>] [-CustomerId <string>] [-DefaultDomainName <string>]
 [-DeletedDateTime <datetime>] [-DisplayName <string>] [-Id <string>] [-Break]
...
```
New-MgContract -BodyParameter <IMicrosoftGraphContract> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm] [<CommonParameters>]
```
