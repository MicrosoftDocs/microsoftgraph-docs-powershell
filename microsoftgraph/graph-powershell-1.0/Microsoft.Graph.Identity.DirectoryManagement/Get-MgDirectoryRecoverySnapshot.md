...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.directorymanagement/get-mgdirectoryrecoverysnapshot
Locale: en-US
Module Name: Microsoft.Graph.Identity.DirectoryManagement
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Get-MgDirectoryRecoverySnapshot
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaDirectoryRecoverySnapshot](/powershell/module/Microsoft.Graph.Beta.Identity.DirectoryManagement/Get-MgBetaDirectoryRecoverySnapshot?view=graph-powershell-beta)
...
```
Get-MgDirectoryRecoverySnapshot [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgDirectoryRecoverySnapshot -SnapshotId <string> [-ExpandProperty <string[]>]
...
```
Get-MgDirectoryRecoverySnapshot -InputObject <IIdentityDirectoryManagementIdentity>
