...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.directorymanagement/remove-mgcontract
Locale: en-US
Module Name: Microsoft.Graph.Identity.DirectoryManagement
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Remove-MgContract
---
...
```
Remove-MgContract -ContractId <string> [-IfMatch <string>] [-ResponseHeadersVariable <string>]
...
```
Remove-MgContract -InputObject <IIdentityDirectoryManagementIdentity> [-IfMatch <string>]
...
- [Remove-MgContract](https://learn.microsoft.com/powershell/module/microsoft.graph.identity.directorymanagement/remove-mgcontract)
