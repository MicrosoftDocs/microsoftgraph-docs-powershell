...
online version: https://``d``ocs.microsoft.com/en-us/powershell/mo``d``ule/microsoft.graph.i``d``entity.``d``irectorymanagement/get-mgorganizationmembergroup
schema: 2.0.0
---
...
```
Get-MgOrganizationMemberGroup -OrganizationI``d`` <String> [-A``d````d``itionalProperties <Hashtable>]
 [-SecurityEnable``d``Only] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Get1
```
Get-MgOrganizationMemberGroup -OrganizationI``d`` <String>
 -Bo``d``yParameter <IPathsPlvqruOrganizationI``d``MicrosoftGraphGetmembergroupsPostRequestbo``d``yContentApplicationJsonSchema>
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### GetViaI``d``entityExpan``d``e``d``1
```
Get-MgOrganizationMemberGroup -InputObject <II``d``entity``d``irectoryManagementI``d``entity>
...
```yaml
Type: IPathsPlvqruOrganizationI``d``MicrosoftGraphGetmembergroupsPostRequestbo``d``yContentApplicationJsonSchema
...
### Microsoft.Graph.PowerShell.Mo``d``els.IPathsPlvqruOrganizationI``d``MicrosoftGraphGetmembergroupsPostRequestbo``d``yContentApplicationJsonSchema
## OUTPUTS
