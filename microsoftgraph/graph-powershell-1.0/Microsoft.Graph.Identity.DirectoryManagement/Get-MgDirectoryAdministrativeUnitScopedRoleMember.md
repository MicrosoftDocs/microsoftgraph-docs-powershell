...
### Example 1: Using the Get-MgDirectoryAdministrativeUnitScopedRoleMember Cmdlet
```powershell
...
### Example 2: Using the Get-MgDirectoryAdministrativeUnitScopedRoleMember Cmdlet
```powershell
Import-Module Microsoft.Graph.Identity.DirectoryManagement
