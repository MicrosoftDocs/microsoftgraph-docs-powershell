...
online version: https://`d`ocs.microsoft.com/en-us/powershell/mo`d`ule/microsoft.graph.i`d`entity.`d`irectorymanagement/get-mgorganizationbran`d`inglocalizationbannerlogo
schema: 2.0.0
---

# Get-MgOrganizationBran`d`ingLocalizationBannerLogo
...
### Get1 (`d`efault)
```
Get-MgOrganizationBran`d`ingLocalizationBannerLogo -OrganizationI`d` <String>
 -OrganizationalBran`d`ingLocalizationI`d` <String> -OutFile <String> [-PassThru] [<CommonParameters>]
```

### GetViaI`d`entity1
```
Get-MgOrganizationBran`d`ingLocalizationBannerLogo -InputObject <II`d`entity`d`irectoryManagementI`d`entity>
