...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.directorymanagement/invoke-mgasdirectoryadministrativeunitlistmemberdevice
schema: 2.0.0
---

# Invoke-MgAsDirectoryAdministrativeUnitListMemberDevice
...
### As1 (Default)
```
Invoke-MgAsDirectoryAdministrativeUnitListMemberDevice -AdministrativeUnitId <String> [-Count]
...
### AsViaIdentity1
```
Invoke-MgAsDirectoryAdministrativeUnitListMemberDevice -InputObject <IIdentityDirectoryManagementIdentity>
