...
### Delete (Default)
```
Remove-MgDeviceRegisteredUserDirectoryObjectByRef -DeviceId <String> -DirectoryObjectId <String>
...
### DeleteViaIdentity
```
Remove-MgDeviceRegisteredUserDirectoryObjectByRef -InputObject <IIdentityDirectoryManagementIdentity>
 [-IfMatch <String>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
