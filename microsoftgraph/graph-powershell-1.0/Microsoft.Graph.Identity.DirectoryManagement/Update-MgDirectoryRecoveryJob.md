...
```
Update-MgDirectoryRecoveryJob -RecoveryJobBaseId <string> [-ResponseHeadersVariable <string>]
...
```
Update-MgDirectoryRecoveryJob -RecoveryJobBaseId <string>
 -BodyParameter <IMicrosoftGraphEntraRecoveryServicesRecoveryJobBase>
...
```
Update-MgDirectoryRecoveryJob -InputObject <IIdentityDirectoryManagementIdentity>
