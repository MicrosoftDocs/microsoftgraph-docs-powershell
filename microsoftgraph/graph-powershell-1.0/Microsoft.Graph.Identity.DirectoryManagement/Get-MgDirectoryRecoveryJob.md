...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.directorymanagement/get-mgdirectoryrecoveryjob
Locale: en-US
Module Name: Microsoft.Graph.Identity.DirectoryManagement
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Get-MgDirectoryRecoveryJob
---

# Get-MgDirectoryRecoveryJob
...
```
Get-MgDirectoryRecoveryJob [-ExpandProperty <string[]>] [-Property <string[]>] [-Filter <string>]
...
```
Get-MgDirectoryRecoveryJob -RecoveryJobBaseId <string> [-ExpandProperty <string[]>]
...
```
Get-MgDirectoryRecoveryJob -InputObject <IIdentityDirectoryManagementIdentity>
...
### Microsoft.Graph.PowerShell.Models.IMicrosoftGraphEntraRecoveryServicesRecoveryJobBase
