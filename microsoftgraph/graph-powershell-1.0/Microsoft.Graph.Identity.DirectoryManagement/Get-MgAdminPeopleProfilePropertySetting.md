...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.directorymanagement/get-mgadminpeopleprofilepropertysetting
Locale: en-US
Module Name: Microsoft.Graph.Identity.DirectoryManagement
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Get-MgAdminPeopleProfilePropertySetting
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaAdminPeopleProfilePropertySetting](/powershell/module/Microsoft.Graph.Beta.Identity.DirectoryManagement/Get-MgBetaAdminPeopleProfilePropertySetting?view=graph-powershell-beta)
...
```
Get-MgAdminPeopleProfilePropertySetting [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgAdminPeopleProfilePropertySetting -ProfilePropertySettingId <string>
...
```
Get-MgAdminPeopleProfilePropertySetting -InputObject <IIdentityDirectoryManagementIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
...
```
This example shows how to use the Get-MgAdminPeopleProfilePropertySetting Cmdlet.
