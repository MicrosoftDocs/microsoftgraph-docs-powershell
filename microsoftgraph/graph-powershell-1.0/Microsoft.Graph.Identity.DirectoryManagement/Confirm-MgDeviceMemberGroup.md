...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.directorymanagement/confirm-mgdevicemembergroup
Locale: en-US
Module Name: Microsoft.Graph.Identity.DirectoryManagement
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: Confirm-MgDeviceMemberGroup
---
...
```
Confirm-MgDeviceMemberGroup -DeviceId <string> [-ResponseHeadersVariable <string>]
