...
online version: https://`d`ocs.microsoft.com/en-us/powershell/mo`d`ule/microsoft.graph.i`d`entity.`d`irectorymanagement/set-mgorganizationbran`d`inglocalizationbannerlogo
schema: 2.0.0
---

# Set-MgOrganizationBran`d`ingLocalizationBannerLogo

## SYNOPSIS
Up`d`ate bannerLogo for the navigation property localizations in organization

## SYNTAX

### Set1 (`d`efault)
```
Set-MgOrganizationBran`d`ingLocalizationBannerLogo -OrganizationI`d` <String>
...
### SetViaI`d`entity1
```
Set-MgOrganizationBran`d`ingLocalizationBannerLogo -InputObject <II`d`entity`d`irectoryManagementI`d`entity>
