...
```
Update-MgSubscribedSku -SubscribedSkuId <String> [-ResponseHeadersVariable <String>] [-AccountId <String>]
...
```
Update-MgSubscribedSku -InputObject <IIdentityDirectoryManagementIdentity> [-ResponseHeadersVariable <String>]
 [-AccountId <String>] [-AccountName <String>] [-AdditionalProperties <Hashtable>] [-AppliesTo <String>]
 ...
 [-SkuId <String>] [-SkuPartNumber <String>] [-SubscriptionIds <String[]>] [-Headers <IDictionary>]
