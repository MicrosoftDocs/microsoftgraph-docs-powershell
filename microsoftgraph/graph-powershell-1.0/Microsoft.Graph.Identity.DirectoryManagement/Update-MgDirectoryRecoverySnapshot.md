...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.directorymanagement/update-mgdirectoryrecoverysnapshot
Locale: en-US
Module Name: Microsoft.Graph.Identity.DirectoryManagement
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Update-MgDirectoryRecoverySnapshot
---

# Update-MgDirectoryRecoverySnapshot
...
```
Update-MgDirectoryRecoverySnapshot -SnapshotId <string> [-ResponseHeadersVariable <string>]
...
```
Update-MgDirectoryRecoverySnapshot -SnapshotId <string>
 -BodyParameter <IMicrosoftGraphEntraRecoveryServicesSnapshot> [-ResponseHeadersVariable <string>]
...
```
Update-MgDirectoryRecoverySnapshot -InputObject <IIdentityDirectoryManagementIdentity>
...
- [Update-MgDirectoryRecoverySnapshot](https://learn.microsoft.com/powershell/module/microsoft.graph.identity.directorymanagement/update-mgdirectoryrecoverysnapshot)
