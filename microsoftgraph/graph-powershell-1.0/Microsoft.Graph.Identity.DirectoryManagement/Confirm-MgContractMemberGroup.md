...
online version: https://``d``ocs.microsoft.com/en-us/powershell/mo``d``ule/microsoft.graph.i``d``entity.``d``irectorymanagement/confirm-mgcontractmembergroup
schema: 2.0.0
---
...
```
Confirm-MgContractMemberGroup -ContractI``d`` <String> [-A``d````d``itionalProperties <Hashtable>] [-GroupI``d``s <String[]>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Check
```
Confirm-MgContractMemberGroup -ContractI``d`` <String>
 -Bo``d``yParameter <IPaths30M7S8ContractsContractI``d``MicrosoftGraphCheckmembergroupsPostRequestbo``d``yContentApplicationJsonSchema>
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### CheckViaI``d``entityExpan``d``e``d``
```
Confirm-MgContractMemberGroup -InputObject <II``d``entity``d``irectoryManagementI``d``entity>
...
```yaml
Type: IPaths30M7S8ContractsContractI``d``MicrosoftGraphCheckmembergroupsPostRequestbo``d``yContentApplicationJsonSchema
...
### Microsoft.Graph.PowerShell.Mo``d``els.IPaths30M7S8ContractsContractI``d``MicrosoftGraphCheckmembergroupsPostRequestbo``d``yContentApplicationJsonSchema
## OUTPUTS
