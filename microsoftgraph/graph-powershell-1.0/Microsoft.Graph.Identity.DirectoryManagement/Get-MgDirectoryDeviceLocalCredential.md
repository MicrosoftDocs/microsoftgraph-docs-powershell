...
### List (Default)
```
Get-MgDirectoryDeviceLocalCredential [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
### Get
```
Get-MgDirectoryDeviceLocalCredential -DeviceLocalCredentialInfoId <String> [-ExpandProperty <String[]>]
