...
# Update-MgDirectoryRemoteTenantGroup
...
```
Update-MgDirectoryRemoteTenantGroup -RemoteTenantGroupId <string>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-DeletedDateTime <datetime>] [-Id <string>] [-RemoteGroupDisplayName <string>]
 [-RemoteGroupId <string>] [-RemoteTenantDisplayName <string>] [-RemoteTenantId <string>]
 [-RemoteTenantPrimaryDomain <string>] [-Break] [-Headers <IDictionary>]
...
```
Update-MgDirectoryRemoteTenantGroup -RemoteTenantGroupId <string>
 -BodyParameter <IMicrosoftGraphRemoteTenantGroup> [-ResponseHeadersVariable <string>] [-Break]
...
```
Update-MgDirectoryRemoteTenantGroup -InputObject <IIdentityDirectoryManagementIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-DeletedDateTime <datetime>] [-Id <string>] [-RemoteGroupDisplayName <string>]
 [-RemoteGroupId <string>] [-RemoteTenantDisplayName <string>] [-RemoteTenantId <string>]
 [-RemoteTenantPrimaryDomain <string>] [-Break] [-Headers <IDictionary>]
