...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.directorymanagement/new-mgdirectoryrecoverysnapshot
Locale: en-US
Module Name: Microsoft.Graph.Identity.DirectoryManagement
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: New-MgDirectoryRecoverySnapshot
---

# New-MgDirectoryRecoverySnapshot
...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaDirectoryRecoverySnapshot](/powershell/module/Microsoft.Graph.Beta.Identity.DirectoryManagement/New-MgBetaDirectoryRecoverySnapshot?view=graph-powershell-beta)
...
```
New-MgDirectoryRecoverySnapshot [-ResponseHeadersVariable <string>]
...
```
New-MgDirectoryRecoverySnapshot -BodyParameter <IMicrosoftGraphEntraRecoveryServicesSnapshot>
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphEntraRecoveryServicesRecoveryJob[]
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphEntraRecoveryServicesRecoveryPreviewJob[]
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.PowerShell.Models.IMicrosoftGraphEntraRecoveryServicesSnapshot
