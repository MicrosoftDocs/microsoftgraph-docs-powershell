...
online version: https://`d`ocs.microsoft.com/en-us/powershell/mo`d`ule/microsoft.graph.i`d`entity.`d`irectorymanagement/up`d`ate-mgorganizationextension
schema: 2.0.0
---

# Up`d`ate-MgOrganizationExtension

## SYNOPSIS
Up`d`ate the navigation property extensions in organization

## SYNTAX

### Up`d`ateExpan`d`e`d`1 (`d`efault)
```
Up`d`ate-MgOrganizationExtension -ExtensionI`d` <String> -OrganizationI`d` <String>
 [-A`d``d`itionalProperties <Hashtable>] [-I`d` <String>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Up`d`ate1
```
Up`d`ate-MgOrganizationExtension -ExtensionI`d` <String> -OrganizationI`d` <String> -Bo`d`yParameter <Hashtable>
 [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Up`d`ateViaI`d`entityExpan`d`e`d`1
```
Up`d`ate-MgOrganizationExtension -InputObject <II`d`entity`d`irectoryManagementI`d`entity>
 [-A`d``d`itionalProperties <Hashtable>] [-I`d` <String>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Up`d`ateViaI`d`entity1
```
Up`d`ate-MgOrganizationExtension -InputObject <II`d`entity`d`irectoryManagementI`d`entity> -Bo`d`yParameter <Hashtable>
 [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
