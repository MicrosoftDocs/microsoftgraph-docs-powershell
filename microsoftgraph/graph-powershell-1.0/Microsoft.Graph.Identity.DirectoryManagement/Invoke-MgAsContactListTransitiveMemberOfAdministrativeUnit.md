...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.directorymanagement/invoke-mgascontactlisttransitivememberofadministrativeunit
schema: 2.0.0
---

# Invoke-MgAsContactListTransitiveMemberOfAdministrativeUnit
...
### As (Default)
```
Invoke-MgAsContactListTransitiveMemberOfAdministrativeUnit -OrgContactId <String> [-Count]
...
### AsViaIdentity
```
Invoke-MgAsContactListTransitiveMemberOfAdministrativeUnit -InputObject <IIdentityDirectoryManagementIdentity>
