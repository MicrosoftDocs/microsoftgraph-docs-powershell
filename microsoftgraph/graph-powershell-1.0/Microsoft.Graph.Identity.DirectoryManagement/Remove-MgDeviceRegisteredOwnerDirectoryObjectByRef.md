...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.directorymanagement/remove-mgdeviceregisteredownerdirectoryobjectbyref
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgDeviceRegisteredOwnerDirectoryObjectByRef -DeviceId <String> -DirectoryObjectId <String>
...
### DeleteViaIdentity
```
Remove-MgDeviceRegisteredOwnerDirectoryObjectByRef -InputObject <IIdentityDirectoryManagementIdentity>
 [-IfMatch <String>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
## RELATED LINKS
[Remove-MgBetaDeviceRegisteredOwnerDirectoryObjectByRef](/powershell/module/Microsoft.Graph.Beta.Identity.DirectoryManagement/Remove-MgBetaDeviceRegisteredOwnerDirectoryObjectByRef?view=graph-powershell-beta)
