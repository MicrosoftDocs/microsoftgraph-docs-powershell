...
### Create1 (Default)
```
New-MgDirectoryRoleMemberByRef -DirectoryRoleId <String> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### CreateViaIdentity1
```
New-MgDirectoryRoleMemberByRef -InputObject <IIdentityDirectoryManagementIdentity> [-PassThru] [-WhatIf]
