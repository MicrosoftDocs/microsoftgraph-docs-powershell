...
```
New-MgAdminPeopleProfilePropertySetting [-ResponseHeadersVariable <string>]
...
```
New-MgAdminPeopleProfilePropertySetting -BodyParameter <IMicrosoftGraphProfilePropertySetting>
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphProfilePropertySetting
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.PowerShell.Models.IMicrosoftGraphProfilePropertySetting
