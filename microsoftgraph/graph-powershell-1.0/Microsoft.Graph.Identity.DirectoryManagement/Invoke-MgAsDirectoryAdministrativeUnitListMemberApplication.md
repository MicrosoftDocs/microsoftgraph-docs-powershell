...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.directorymanagement/invoke-mgasdirectoryadministrativeunitlistmemberapplication
schema: 2.0.0
---

# Invoke-MgAsDirectoryAdministrativeUnitListMemberApplication
...
### As1 (Default)
```
Invoke-MgAsDirectoryAdministrativeUnitListMemberApplication -AdministrativeUnitId <String> [-Count]
...
### AsViaIdentity1
```
Invoke-MgAsDirectoryAdministrativeUnitListMemberApplication -InputObject <IIdentityDirectoryManagementIdentity>
