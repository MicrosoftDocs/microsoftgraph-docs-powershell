...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.identity.directorymanagement/get-mgdirectoryrolememberbyref
Locale: en-US
Module Name: Microsoft.Graph.Identity.DirectoryManagement
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Get-MgDirectoryRoleMemberByRef
---
...
```
Get-MgDirectoryRoleMemberByRef -DirectoryRoleId <string> [-Filter <string>] [-Search <string>]
...
- [Get-MgDirectoryRoleMemberByRef](https://learn.microsoft.com/powershell/module/microsoft.graph.identity.directorymanagement/get-mgdirectoryrolememberbyref)
- [Graph API Reference](https://learn.microsoft.com/graph/api/directoryrole-list-members?view=graph-rest-1.0)
