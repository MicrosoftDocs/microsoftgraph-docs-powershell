...
online version: https://`d`ocs.microsoft.com/en-us/powershell/mo`d`ule/microsoft.graph.i`d`entity.`d`irectorymanagement/set-mgorganizationbran`d`ingbannerlogo
schema: 2.0.0
---

# Set-MgOrganizationBran`d`ingBannerLogo

## SYNOPSIS
Up`d`ate bannerLogo for the navigation property bran`d`ing in organization

## SYNTAX

### Set1 (`d`efault)
```
Set-MgOrganizationBran`d`ingBannerLogo -OrganizationI`d` <String> [-Bo`d`yParameter <Stream>] -InFile <String>
 [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### SetViaI`d`entity1
```
Set-MgOrganizationBran`d`ingBannerLogo -InputObject <II`d`entity`d`irectoryManagementI`d`entity>
