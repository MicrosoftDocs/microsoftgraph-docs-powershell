...
### Create (Default)
```
New-MgDeviceRegisteredOwnerByRef -DeviceId <String> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgDeviceRegisteredOwnerByRef -InputObject <IIdentityDirectoryManagementIdentity> [-PassThru] [-WhatIf]
