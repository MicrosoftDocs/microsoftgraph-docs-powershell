...
```
Update-MgDevice -DeviceId <string> [-ResponseHeadersVariable <string>] [-AccountEnabled]
...
```
Update-MgDevice -InputObject <IIdentityDirectoryManagementIdentity> [-DeviceId <string>]
...
```
Update-MgDevice -DeviceId <string> -BodyParameter <IMicrosoftGraphDevice>
...
```
Update-MgDevice -InputObject <IIdentityDirectoryManagementIdentity>
