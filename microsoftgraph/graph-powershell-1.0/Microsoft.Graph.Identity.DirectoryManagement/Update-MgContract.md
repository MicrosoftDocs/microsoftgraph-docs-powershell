...
```
Update-MgContract -ContractId <string> [-ResponseHeadersVariable <string>]
...
```
Update-MgContract -InputObject <IIdentityDirectoryManagementIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-ContractType <string>]
 [-CustomerId <string>] [-DefaultDomainName <string>] [-DeletedDateTime <datetime>]
...
```
Update-MgContract -InputObject <IIdentityDirectoryManagementIdentity>
 -BodyParameter <IMicrosoftGraphContract> [-ResponseHeadersVariable <string>] [-Break]
