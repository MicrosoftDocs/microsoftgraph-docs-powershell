...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaBetaContract](/powershell/module/Microsoft.Graph.Beta.Identity.DirectoryManagement/Update-MgBetaContract?view=graph-powershell-beta)
...
### Update
```
Update-MgContract -ContractId <String> -BodyParameter <IMicrosoftGraphContract> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgBetaBetaContract](/powershell/module/Microsoft.Graph.Beta.Identity.DirectoryManagement/Update-MgBetaContract?view=graph-powershell-beta)
