...
Update-MgDeviceManagementUserExperienceAnalyticBatteryHealthAppImpact
 ...
 [-BatteryUsagePercentage <Double>] [-Id <String>] [-IsForegroundApp] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
Update-MgDeviceManagementUserExperienceAnalyticBatteryHealthAppImpact
 ...
 -BodyParameter <IMicrosoftGraphUserExperienceAnalyticsBatteryHealthAppImpact> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement/update-mgdevicemanagementuserexperienceanalyticbatteryhealthappimpact](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement/update-mgdevicemanagementuserexperienceanalyticbatteryhealthappimpact)
