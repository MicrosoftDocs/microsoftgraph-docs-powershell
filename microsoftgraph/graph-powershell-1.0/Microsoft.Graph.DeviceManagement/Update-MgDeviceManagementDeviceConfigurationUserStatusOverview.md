...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaBetaDeviceManagementDeviceConfigurationUserStatusOverview](/powershell/module/Microsoft.Graph.Beta.DeviceManagement/Update-MgBetaDeviceManagementDeviceConfigurationUserStatusOverview?view=graph-powershell-beta)
...
Update-MgDeviceManagementDeviceConfigurationUserStatusOverview -DeviceConfigurationId <String>
 ...
 [-PendingCount <Int32>] [-SuccessCount <Int32>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Update
```
Update-MgDeviceManagementDeviceConfigurationUserStatusOverview -DeviceConfigurationId <String>
 -BodyParameter <IMicrosoftGraphDeviceConfigurationUserOverview> [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgBetaBetaDeviceManagementDeviceConfigurationUserStatusOverview](/powershell/module/Microsoft.Graph.Beta.DeviceManagement/Update-MgBetaDeviceManagementDeviceConfigurationUserStatusOverview?view=graph-powershell-beta)
