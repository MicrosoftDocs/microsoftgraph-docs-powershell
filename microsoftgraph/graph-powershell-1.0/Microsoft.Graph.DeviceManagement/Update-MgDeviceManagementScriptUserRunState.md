...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement/update-mgdevicemanagementscriptuserrunstate
schema: 2.0.0
---
...
```
Update-MgDeviceManagementScriptUserRunState -DeviceManagementScriptId <String>
 -DeviceManagementScriptUserStateId <String> [-AdditionalProperties <Hashtable>]
...
```
Update-MgDeviceManagementScriptUserRunState -DeviceManagementScriptId <String>
 -DeviceManagementScriptUserStateId <String> -BodyParameter <IMicrosoftGraphDeviceManagementScriptUserState>
 [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgDeviceManagementScriptUserRunState -InputObject <IDeviceManagementIdentity>
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement/update-mgdevicemanagementscriptuserrunstate](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement/update-mgdevicemanagementscriptuserrunstate)
