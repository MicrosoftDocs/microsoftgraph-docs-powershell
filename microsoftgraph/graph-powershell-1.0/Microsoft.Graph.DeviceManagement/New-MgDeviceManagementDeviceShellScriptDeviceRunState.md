...
New-MgDeviceManagementDeviceShellScriptDeviceRunState -DeviceShellScriptId <String>
 ...
 [-ResultMessage <String>] [-RunState <RunState>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Create
```
New-MgDeviceManagementDeviceShellScriptDeviceRunState -DeviceShellScriptId <String>
 -BodyParameter <IMicrosoftGraphDeviceManagementScriptDeviceState> [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement/new-mgdevicemanagementdeviceshellscriptdevicerunstate](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement/new-mgdevicemanagementdeviceshellscriptdevicerunstate)
