...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devicemanagement/request-mgdevicemanagementmanageddeviceremoteassistance
schema: 2.0.0
...
### Request (Default)
```
Request-MgDeviceManagementManagedDeviceRemoteAssistance -ManagedDeviceId <String>
...
### RequestViaIdentity
```
Request-MgDeviceManagementManagedDeviceRemoteAssistance -InputObject <IDeviceManagementIdentity>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.devicemanagement/request-mgdevicemanagementmanageddeviceremoteassistance](https://learn.microsoft.com/powershell/module/microsoft.graph.devicemanagement/request-mgdevicemanagementmanageddeviceremoteassistance)
