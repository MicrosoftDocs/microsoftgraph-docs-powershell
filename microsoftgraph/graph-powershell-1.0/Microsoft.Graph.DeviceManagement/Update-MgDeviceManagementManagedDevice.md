...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.devicemanagement/update-mgdevicemanagementmanageddevice
Locale: en-US
Module Name: Microsoft.Graph.DeviceManagement
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Update-MgDeviceManagementManagedDevice
---
...
Update-MgDeviceManagementManagedDevice -ManagedDeviceId <string> [-ResponseHeadersVariable <string>]
 ...
 [-ProxyUseDefaultCredentials] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
