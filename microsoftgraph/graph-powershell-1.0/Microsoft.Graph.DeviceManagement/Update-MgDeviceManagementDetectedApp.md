...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.devicemanagement/update-mgdevicemanagementdetectedapp
Locale: en-US
Module Name: Microsoft.Graph.DeviceManagement
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Update-MgDeviceManagementDetectedApp
---
...
```
Update-MgDeviceManagementDetectedApp -DetectedAppId <string> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-DeviceCount <int>] [-DisplayName <string>] [-Id <string>]
 [-ManagedDevices <IMicrosoftGraphManagedDevice[]>] [-Platform <DetectedAppPlatformType>]
 [-Publisher <string>] [-SizeInByte <long>] [-Version <string>] [-Break] [-Headers <IDictionary>]
...
```
Update-MgDeviceManagementDetectedApp -DetectedAppId <string>
 -BodyParameter <IMicrosoftGraphDetectedApp> [-ResponseHeadersVariable <string>] [-Break]
...
Update-MgDeviceManagementDetectedApp -InputObject <IDeviceManagementIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-DeviceCount <int>]
 [-DisplayName <string>] [-Id <string>] [-ManagedDevices <IMicrosoftGraphManagedDevice[]>]
 [-Platform <DetectedAppPlatformType>] [-Publisher <string>] [-SizeInByte <long>]
...
BODYPARAMETER `<IMicrosoftGraphDetectedApp>`: A managed or unmanaged app that is installed on a managed device.
Unmanaged apps will only appear for devices marked as corporate owned.
