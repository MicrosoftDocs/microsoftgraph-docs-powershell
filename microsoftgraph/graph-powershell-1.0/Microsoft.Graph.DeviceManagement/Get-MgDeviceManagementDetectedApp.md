...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.devicemanagement/get-mgdevicemanagementdetectedapp
Locale: en-US
Module Name: Microsoft.Graph.DeviceManagement
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: Get-MgDeviceManagementDetectedApp
---
...
```
Get-MgDeviceManagementDetectedApp [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgDeviceManagementDetectedApp -DetectedAppId <string> [-ExpandProperty <string[]>]
...
```
Get-MgDeviceManagementDetectedApp -InputObject <IDeviceManagementIdentity>
