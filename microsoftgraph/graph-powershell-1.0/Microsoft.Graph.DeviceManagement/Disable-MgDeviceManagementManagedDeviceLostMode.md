...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.devicemanagement/disable-mgdevicemanagementmanageddevicelostmode
Locale: en-US
Module Name: Microsoft.Graph.DeviceManagement
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: Disable-MgDeviceManagementManagedDeviceLostMode
---
...
```
Disable-MgDeviceManagementManagedDeviceLostMode -ManagedDeviceId <string>
...
```
Disable-MgDeviceManagementManagedDeviceLostMode -InputObject <IDeviceManagementIdentity>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru]
 [-Proxy <uri>] [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
 [<CommonParameters>]
...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.devicemanagement/disable-mgdevicemanagementmanageddevicelostmode)
