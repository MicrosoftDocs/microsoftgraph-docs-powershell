...
Update-MgDeviceManagementDeviceCompliancePolicyDeviceSettingStateSummary -DeviceCompliancePolicyId <String>
 ...
 [-SettingName <String>] [-UnknownDeviceCount <Int32>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```
Update-MgDeviceManagementDeviceCompliancePolicyDeviceSettingStateSummary
 -InputObject <IDeviceManagementIdentity> -BodyParameter <IMicrosoftGraphSettingStateDeviceSummary> [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
