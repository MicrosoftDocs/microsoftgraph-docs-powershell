...
### List (Default)
```
Get-MgDeviceManagementConfigurationPolicySettingDefinition -DeviceManagementConfigurationPolicyId <String>
...
### GetViaIdentity
```
Get-MgDeviceManagementConfigurationPolicySettingDefinition -InputObject <IDeviceManagementIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement/get-mgdevicemanagementconfigurationpolicysettingdefinition](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement/get-mgdevicemanagementconfigurationpolicysettingdefinition)
