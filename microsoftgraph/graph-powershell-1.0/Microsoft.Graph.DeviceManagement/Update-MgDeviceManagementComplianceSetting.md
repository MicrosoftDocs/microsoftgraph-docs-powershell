...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement/update-mgdevicemanagementcompliancesetting
schema: 2.0.0
---
...
```
Update-MgDeviceManagementComplianceSetting -DeviceManagementConfigurationSettingDefinitionId <String>
...
```
Update-MgDeviceManagementComplianceSetting -InputObject <IDeviceManagementIdentity> [-AccessTypes <String>]
...
### UpdateViaIdentity
```
Update-MgDeviceManagementComplianceSetting -InputObject <IDeviceManagementIdentity>
 -BodyParameter <IMicrosoftGraphDeviceManagementConfigurationSettingDefinition> [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement/update-mgdevicemanagementcompliancesetting](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement/update-mgdevicemanagementcompliancesetting)
