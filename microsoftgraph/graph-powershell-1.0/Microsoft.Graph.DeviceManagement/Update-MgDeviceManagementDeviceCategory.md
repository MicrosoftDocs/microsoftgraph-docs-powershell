...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaBetaDeviceManagementDeviceCategory](/powershell/module/Microsoft.Graph.Beta.DeviceManagement/Update-MgBetaDeviceManagementDeviceCategory?view=graph-powershell-beta)
...
Update-MgDeviceManagementDeviceCategory -InputObject <IDeviceManagementIdentity>
 [-AdditionalProperties <Hashtable>] [-Description <String>] [-DisplayName <String>] [-Id <String>] [-WhatIf]
...
## RELATED LINKS
[Update-MgBetaBetaDeviceManagementDeviceCategory](/powershell/module/Microsoft.Graph.Beta.DeviceManagement/Update-MgBetaDeviceManagementDeviceCategory?view=graph-powershell-beta)
