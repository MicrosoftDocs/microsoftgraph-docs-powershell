...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.devicemanagement/set-mgdevicemanagementmanageddevicecategorybyref
schema: 2.0.0
---
...
### SetExpanded (Default)
```
Set-MgDeviceManagementManagedDeviceCategoryByRef -ManagedDeviceId <String> [-ResponseHeadersVariable <String>]
...
### Set
```
Set-MgDeviceManagementManagedDeviceCategoryByRef -ManagedDeviceId <String> -BodyParameter <IReferenceUpdate>
