...
```
Get-MgSolutionBackupRestoreOneDriveForBusinessBrowseSession [-ExpandProperty <string[]>]
...
```
Get-MgSolutionBackupRestoreOneDriveForBusinessBrowseSession -InputObject <IBackupRestoreIdentity>
