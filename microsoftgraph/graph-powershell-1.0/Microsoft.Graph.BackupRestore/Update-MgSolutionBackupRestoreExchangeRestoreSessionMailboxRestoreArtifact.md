...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.backuprestore/update-mgsolutionbackuprestoreexchangerestoresessionmailboxrestoreartifact
Locale: en-US
Module Name: Microsoft.Graph.BackupRestore
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Update-MgSolutionBackupRestoreExchangeRestoreSessionMailboxRestoreArtifact
---
...
```
Update-MgSolutionBackupRestoreExchangeRestoreSessionMailboxRestoreArtifact
 -ExchangeRestoreSessionId <string> -MailboxRestoreArtifactId <string>
 ...
 [-RestoredItemCount <int>] [-StartDateTime <datetime>] [-Status <string>] [-Break]
...
Update-MgSolutionBackupRestoreExchangeRestoreSessionMailboxRestoreArtifact
 -ExchangeRestoreSessionId <string> -MailboxRestoreArtifactId <string>
 -BodyParameter <IMicrosoftGraphMailboxRestoreArtifact> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
- [Update-MgSolutionBackupRestoreExchangeRestoreSessionMailboxRestoreArtifact](https://learn.microsoft.com/powershell/module/microsoft.graph.backuprestore/update-mgsolutionbackuprestoreexchangerestoresessionmailboxrestoreartifact)
