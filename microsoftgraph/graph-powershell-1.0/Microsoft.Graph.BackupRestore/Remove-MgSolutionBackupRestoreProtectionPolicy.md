...
### Delete (Default)
```
Remove-MgSolutionBackupRestoreProtectionPolicy -ProtectionPolicyBaseId <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgSolutionBackupRestoreProtectionPolicy -InputObject <IBackupRestoreIdentity> [-IfMatch <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
