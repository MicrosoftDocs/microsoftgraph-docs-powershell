...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.backuprestore/new-mgsolutionbackuprestoresiteinclusionrule
Locale: en-US
Module Name: Microsoft.Graph.BackupRestore
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: New-MgSolutionBackupRestoreSiteInclusionRule
---
...
```
New-MgSolutionBackupRestoreSiteInclusionRule [-ResponseHeadersVariable <string>]
 ...
 [-IsAutoApplyEnabled] [-LastModifiedBy <IMicrosoftGraphIdentitySet>]
 [-LastModifiedDateTime <datetime>] [-SiteExpression <string>] [-Status <string>] [-Break]
...
```
New-MgSolutionBackupRestoreSiteInclusionRule -BodyParameter <IMicrosoftGraphSiteProtectionRule>
...
- [New-MgSolutionBackupRestoreSiteInclusionRule](https://learn.microsoft.com/powershell/module/microsoft.graph.backuprestore/new-mgsolutionbackuprestoresiteinclusionrule)
