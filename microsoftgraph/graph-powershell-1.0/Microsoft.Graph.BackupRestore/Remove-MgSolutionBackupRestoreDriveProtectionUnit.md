...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.backuprestore/remove-mgsolutionbackuprestoredriveprotectionunit
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgSolutionBackupRestoreDriveProtectionUnit -DriveProtectionUnitId <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgSolutionBackupRestoreDriveProtectionUnit -InputObject <IBackupRestoreIdentity> [-IfMatch <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
