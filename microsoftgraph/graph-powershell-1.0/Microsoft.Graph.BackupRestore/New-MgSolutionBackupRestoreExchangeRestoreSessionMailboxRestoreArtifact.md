...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.backuprestore/new-mgsolutionbackuprestoreexchangerestoresessionmailboxrestoreartifact
schema: 2.0.0
---
...
```
New-MgSolutionBackupRestoreExchangeRestoreSessionMailboxRestoreArtifact -ExchangeRestoreSessionId <String>
...
```
New-MgSolutionBackupRestoreExchangeRestoreSessionMailboxRestoreArtifact -InputObject <IBackupRestoreIdentity>
 [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>] [-CompletionDateTime <DateTime>]
 [-DestinationType <String>] [-Error <IMicrosoftGraphPublicError>] [-Id <String>]
 [-RestorePoint <IMicrosoftGraphRestorePoint>] [-RestoredFolderId <String>] [-StartDateTime <DateTime>]
 [-Status <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
