...
# Update-MgSolutionBackupRestoreEmailNotificationSetting
...
```
Update-MgSolutionBackupRestoreEmailNotificationSetting [-ResponseHeadersVariable <string>]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IMicrosoftGraphNotificationRecipients
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
