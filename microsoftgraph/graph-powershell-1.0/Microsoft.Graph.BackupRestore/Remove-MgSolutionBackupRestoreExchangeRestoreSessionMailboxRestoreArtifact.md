...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.backuprestore/remove-mgsolutionbackuprestoreexchangerestoresessionmailboxrestoreartifact
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgSolutionBackupRestoreExchangeRestoreSessionMailboxRestoreArtifact -ExchangeRestoreSessionId <String>
 -MailboxRestoreArtifactId <String> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
