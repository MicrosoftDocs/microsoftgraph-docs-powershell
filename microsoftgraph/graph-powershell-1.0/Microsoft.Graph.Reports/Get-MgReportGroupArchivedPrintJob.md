...
### Get (Default)
```
Get-MgReportGroupArchivedPrintJob -EndDateTime <DateTime> -GroupId <String> -StartDateTime <DateTime>
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportGroupArchivedPrintJob -InputObject <IReportsIdentity> [<CommonParameters>]
```
