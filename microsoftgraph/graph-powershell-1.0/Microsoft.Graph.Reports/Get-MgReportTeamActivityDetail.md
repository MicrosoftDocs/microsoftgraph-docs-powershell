...
### Get (Default)
```
Get-MgReportTeamActivityDetail -Date <DateTime> -OutFile <String> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Get1
```
Get-MgReportTeamActivityDetail -Period <String> -OutFile <String> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgReportTeamActivityDetail -InputObject <IReportsIdentity> -OutFile <String> [-Headers <IDictionary>]
