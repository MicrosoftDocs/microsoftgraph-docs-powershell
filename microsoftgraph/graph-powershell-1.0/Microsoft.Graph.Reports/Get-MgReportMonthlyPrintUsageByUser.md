...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaBetaReportMonthlyPrintUsageByUser](/powershell/module/Microsoft.Graph.Beta.Reports/Get-MgBetaReportMonthlyPrintUsageByUser?view=graph-powershell-beta)

## SYNTAX

### List (Default)
```
Get-MgReportMonthlyPrintUsageByUser [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
## RELATED LINKS
[Get-MgBetaBetaReportMonthlyPrintUsageByUser](/powershell/module/Microsoft.Graph.Beta.Reports/Get-MgBetaReportMonthlyPrintUsageByUser?view=graph-powershell-beta)
