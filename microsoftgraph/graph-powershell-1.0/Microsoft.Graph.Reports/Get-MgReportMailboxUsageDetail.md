...
### Get (Default)
```
Get-MgReportMailboxUsageDetail -Period <String> -OutFile <String> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportMailboxUsageDetail -InputObject <IReportsIdentity> -OutFile <String> [-Headers <IDictionary>]
...
## RELATED LINKS
[Get-MgBetaReportMailboxUsageDetail](/powershell/module/Microsoft.Graph.Beta.Reports/Get-MgBetaReportMailboxUsageDetail?view=graph-powershell-beta)
