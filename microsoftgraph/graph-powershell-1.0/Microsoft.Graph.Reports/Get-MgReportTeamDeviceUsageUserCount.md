...
### Get (Default)
```
Get-MgReportTeamDeviceUsageUserCount -Period <String> -OutFile <String> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportTeamDeviceUsageUserCount -InputObject <IReportsIdentity> -OutFile <String> [-Headers <IDictionary>]
