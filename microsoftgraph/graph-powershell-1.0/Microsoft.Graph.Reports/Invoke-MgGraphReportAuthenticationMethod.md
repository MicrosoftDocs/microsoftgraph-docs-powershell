...
### Graph (Default)
```
Invoke-MgGraphReportAuthenticationMethod [-Headers <IDictionary>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
### GraphViaIdentity1
```
Invoke-MgGraphReportAuthenticationMethod -InputObject <IReportsIdentity> [-Headers <IDictionary>]
