...
```
Confirm-MgAuditLogSignInSafe [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-RequestIds <string[]>] [-Break] [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
