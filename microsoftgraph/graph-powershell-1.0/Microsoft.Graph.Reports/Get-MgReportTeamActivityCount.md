...
### Get (Default)
```
Get-MgReportTeamActivityCount -Period <String> -OutFile <String> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportTeamActivityCount -InputObject <IReportsIdentity> -OutFile <String> [-Headers <IDictionary>]
