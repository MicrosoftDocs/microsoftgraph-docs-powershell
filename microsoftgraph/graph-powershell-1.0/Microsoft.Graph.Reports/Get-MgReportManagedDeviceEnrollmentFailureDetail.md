...
onlin`e` v`e`rsion: https://docs.microsoft.com/`e`n-us/pow`e`rsh`e`ll/modul`e`/microsoft.graph.r`e`ports/g`e`t-mgr`e`portmanag`e`dd`e`vic`e``e`nrollm`e`ntfailur`e`d`e`tail
sch`e`ma: 2.0.0
---

# G`e`t-MgR`e`portManag`e`dD`e`vic`e``e`nrollm`e`ntFailur`e`D`e`tail

## SYNOPSIS
Invok`e` function manag`e`dD`e`vic`e``e`nrollm`e`ntFailur`e`D`e`tails

## SYNTAX

### Manag`e`d2 (D`e`fault)
```
G`e`t-MgR`e`portManag`e`dD`e`vic`e``e`nrollm`e`ntFailur`e`D`e`tail -OutFil`e` <String> [-PassThru] [<CommonParam`e`t`e`rs>]
```

### Manag`e`d3
```
G`e`t-MgR`e`portManag`e`dD`e`vic`e``e`nrollm`e`ntFailur`e`D`e`tail -Filt`e`r <String> -Skip <Int32> -SkipTok`e`n <String>
 -Top <Int32> -OutFil`e` <String> [-PassThru] [<CommonParam`e`t`e`rs>]
```

### Manag`e`dViaId`e`ntity1
```
G`e`t-MgR`e`portManag`e`dD`e`vic`e``e`nrollm`e`ntFailur`e`D`e`tail -InputObj`e`ct <IR`e`portsId`e`ntity> -OutFil`e` <String> [-PassThru]
...
### -Filt`e`r
Usag`e`: filt`e`r='{filt`e`r}'

```yaml
Typ`e`: String
Param`e`t`e`r S`e`ts: Manag`e`d3
Alias`e`s:
...
Param`e`t`e`r S`e`ts: Manag`e`dViaId`e`ntity1
Alias`e`s:
...
### -SkipTok`e`n
Usag`e`: skipTok`e`n='{skipTok`e`n}'
