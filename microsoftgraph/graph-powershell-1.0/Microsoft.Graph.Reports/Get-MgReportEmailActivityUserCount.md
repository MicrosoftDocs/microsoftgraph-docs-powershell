...
### Get (Default)
```
Get-MgReportEmailActivityUserCount -Period <String> -OutFile <String> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportEmailActivityUserCount -InputObject <IReportsIdentity> -OutFile <String> [-Headers <IDictionary>]
