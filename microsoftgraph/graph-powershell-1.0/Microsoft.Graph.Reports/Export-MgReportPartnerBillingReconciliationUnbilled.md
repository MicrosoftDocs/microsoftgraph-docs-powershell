...
# Export-MgReportPartnerBillingReconciliationUnbilled
...
```
Export-MgReportPartnerBillingReconciliationUnbilled [-ResponseHeadersVariable <string>]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPathsFucohkReportsPartnersBillingReconciliationUnbilledMicrosoftGraphPartnersBillingExportPostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.PowerShell.Models.IPathsFucohkReportsPartnersBillingReconciliationUnbilledMicrosoftGraphPartnersBillingExportPostRequestbodyContentApplicationJsonSchema
