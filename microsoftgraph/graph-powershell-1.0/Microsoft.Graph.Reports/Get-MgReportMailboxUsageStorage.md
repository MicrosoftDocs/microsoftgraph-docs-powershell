...
### Get (Default)
```
Get-MgReportMailboxUsageStorage -Period <String> -OutFile <String> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportMailboxUsageStorage -InputObject <IReportsIdentity> -OutFile <String> [-Headers <IDictionary>]
