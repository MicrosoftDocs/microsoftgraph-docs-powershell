...
### List (Default)
```
Get-MgReportPartnerBillingOperation [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
### Get
```
Get-MgReportPartnerBillingOperation -OperationId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgReportPartnerBillingOperation -InputObject <IReportsIdentity> [-ExpandProperty <String[]>]
