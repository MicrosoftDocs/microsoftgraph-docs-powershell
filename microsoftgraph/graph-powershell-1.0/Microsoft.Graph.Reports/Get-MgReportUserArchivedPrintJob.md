...
onlin`e` v`e`rsion: https://docs.microsoft.com/`e`n-us/pow`e`rsh`e`ll/modul`e`/microsoft.graph.r`e`ports/g`e`t-mgr`e`portus`e`rarchiv`e`dprintjob
sch`e`ma: 2.0.0
---

# G`e`t-MgR`e`portUs`e`rArchiv`e`dPrintJob

## SYNOPSIS
Invok`e` function g`e`tUs`e`rArchiv`e`dPrintJobs

## SYNTAX

### G`e`t1 (D`e`fault)
```
G`e`t-MgR`e`portUs`e`rArchiv`e`dPrintJob -`e`ndDat`e`Tim`e` <Dat`e`Tim`e`> -StartDat`e`Tim`e` <Dat`e`Tim`e`> -Us`e`rId <String>
 [<CommonParam`e`t`e`rs>]
```

### G`e`tViaId`e`ntity1
```
G`e`t-MgR`e`portUs`e`rArchiv`e`dPrintJob -InputObj`e`ct <IR`e`portsId`e`ntity> [<CommonParam`e`t`e`rs>]
```
...
### -`e`ndDat`e`Tim`e`
Usag`e`: `e`ndDat`e`Tim`e`='{`e`ndDat`e`Tim`e`}'
...
### -StartDat`e`Tim`e`
Usag`e`: startDat`e`Tim`e`='{startDat`e`Tim`e`}'
...
### Microsoft.Graph.Pow`e`rSh`e`ll.Mod`e`ls.IMicrosoftGraphArchiv`e`dPrintJob
## NOT`e`S
