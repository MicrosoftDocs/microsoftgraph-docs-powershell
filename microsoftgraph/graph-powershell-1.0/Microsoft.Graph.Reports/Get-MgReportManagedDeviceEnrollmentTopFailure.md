...
### Top (Default)
```
Get-MgReportManagedDeviceEnrollmentTopFailure -OutFile <String> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Top1
```
Get-MgReportManagedDeviceEnrollmentTopFailure -Period <String> -OutFile <String> [-Headers <IDictionary>]
