...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.mail/update-mgusermessage
Locale: en-US
Module Name: Microsoft.Graph.Mail
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: Update-MgUserMessage
---
...
```
Update-MgUserMessage -MessageId <string> -UserId <string> [-ResponseHeadersVariable <string>]
...
```
Update-MgUserMessage -InputObject <IMailIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Attachments <IMicrosoftGraphAttachment[]>]
 [-BccRecipients <IMicrosoftGraphRecipient[]>] [-Body <IMicrosoftGraphItemBody>]
 [-BodyPreview <string>] [-Categories <string[]>] [-CcRecipients <IMicrosoftGraphRecipient[]>]
 [-ChangeKey <string>] [-ConversationId <string>] [-ConversationIndexInputFile <string>]
