...
### Delta (Default)
```
Get-MgUserMailFolderChildFolderDelta -MailFolderId <String> -UserId <String> [-ExpandProperty <String[]>]
...
### DeltaViaIdentity
```
Get-MgUserMailFolderChildFolderDelta -InputObject <IMailIdentity> [-ExpandProperty <String[]>]
 [-Filter <String>] [-Property <String[]>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>] [-Top <Int32>]
