...
When using JSON format, you can:n- Include an attachment to the **message**.n- Update the draft later to add content to the **body** or change other message properties.
