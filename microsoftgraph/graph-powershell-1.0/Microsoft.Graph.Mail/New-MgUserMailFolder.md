...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.mail/new-mgusermailfolder
Locale: en-US
Module Name: Microsoft.Graph.Mail
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: New-MgUserMailFolder
---
...
```
New-MgUserMailFolder -UserId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgUserMailFolder -UserId <string> -BodyParameter <IMicrosoftGraphMailFolder>
...
```
New-MgUserMailFolder -InputObject <IMailIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-ChildFolderCount <int>]
 [-ChildFolders <IMicrosoftGraphMailFolder[]>] [-DisplayName <string>] [-Id <string>] [-IsHidden]
 [-MessageRules <IMicrosoftGraphMessageRule[]>] [-Messages <IMicrosoftGraphMessage[]>]
 [-MultiValueExtendedProperties <IMicrosoftGraphMultiValueLegacyExtendedProperty[]>]
