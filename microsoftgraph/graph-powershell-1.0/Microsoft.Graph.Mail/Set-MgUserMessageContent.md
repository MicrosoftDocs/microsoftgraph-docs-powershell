...
### Set (Default)
```
Set-MgUserMessageContent -MessageId <String> -UserId <String> [-Data <Stream>]
...
### SetViaIdentity
```
Set-MgUserMessageContent -InputObject <IMailIdentity> [-Data <Stream>] [-ResponseHeadersVariable <String>]
