...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaUserMailFolderChildFolderMessageAttachmentCount](/powershell/module/Microsoft.Graph.Beta.Mail/Get-MgBetaUserMailFolderChildFolderMessageAttachmentCount?view=graph-powershell-beta)

### [Get-MgUserMailFolderChildFolderMessageContent](Get-MgUserMailFolderChildFolderMessageContent.md)
Get media content for the navigation property messages from users

> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaUserMailFolderChildFolderMessageContent](/powershell/module/Microsoft.Graph.Beta.Mail/Get-MgBetaUserMailFolderChildFolderMessageContent?view=graph-powershell-beta)
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaUserMailFolderMessageRule](/powershell/module/Microsoft.Graph.Beta.Mail/Get-MgBetaUserMailFolderMessageRule?view=graph-powershell-beta)

### [Get-MgUserMailFolderMessageRuleCount](Get-MgUserMailFolderMessageRuleCount.md)
Get the number of the resource

> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaUserMailFolderMessageRuleCount](/powershell/module/Microsoft.Graph.Beta.Mail/Get-MgBetaUserMailFolderMessageRuleCount?view=graph-powershell-beta)
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaUserMessageCount](/powershell/module/Microsoft.Graph.Beta.Mail/Get-MgBetaUserMessageCount?view=graph-powershell-beta)
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaUserMessageExtensionCount](/powershell/module/Microsoft.Graph.Beta.Mail/Get-MgBetaUserMessageExtensionCount?view=graph-powershell-beta)
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Remove-MgBetaUserMailFolderMessage](/powershell/module/Microsoft.Graph.Beta.Mail/Remove-MgBetaUserMailFolderMessage?view=graph-powershell-beta)

### [Remove-MgUserMailFolderMessageAttachment](Remove-MgUserMailFolderMessageAttachment.md)
Delete navigation property attachments for users

> [!NOTE]
> To view the beta release of this cmdlet, view [Remove-MgBetaUserMailFolderMessageAttachment](/powershell/module/Microsoft.Graph.Beta.Mail/Remove-MgBetaUserMailFolderMessageAttachment?view=graph-powershell-beta)
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Set-MgBetaUserMailFolderMessageContent](/powershell/module/Microsoft.Graph.Beta.Mail/Set-MgBetaUserMailFolderMessageContent?view=graph-powershell-beta)
...
> [!NOTE]
> To view the beta release of this cmdlet, view [Update-MgBetaUserMessageExtension](/powershell/module/Microsoft.Graph.Beta.Mail/Update-MgBetaUserMessageExtension?view=graph-powershell-beta)
