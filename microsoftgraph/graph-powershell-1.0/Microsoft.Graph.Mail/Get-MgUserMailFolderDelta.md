...
```
Get-MgUserMailFolderDelta -InputObject <IMailIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgUserMailFolderDelta](https://learn.microsoft.com/powershell/module/microsoft.graph.mail/get-mgusermailfolderdelta)
