...
> [!NOTE]
> To view the beta release of this cmdlet, view [Get-MgBetaBetaUserMailFolderMessageMultiValueExtendedProperty](/powershell/module/Microsoft.Graph.Beta.Mail/Get-MgBetaUserMailFolderMessageMultiValueExtendedProperty?view=graph-powershell-beta)
...
### GetViaIdentity
```
Get-MgUserMailFolderMessageMultiValueExtendedProperty -InputObject <IMailIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
...
## RELATED LINKS
[Get-MgBetaBetaUserMailFolderMessageMultiValueExtendedProperty](/powershell/module/Microsoft.Graph.Beta.Mail/Get-MgBetaUserMailFolderMessageMultiValueExtendedProperty?view=graph-powershell-beta)
