...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.mail/new-mgusermailfoldermessagereplyall
schema: 2.0.0
...
```
New-MgUserMailFolderMessageReplyAll -InputObject <IMailIdentity> [-ResponseHeadersVariable <String>]
...
### CreateViaIdentity1
```
New-MgUserMailFolderMessageReplyAll -InputObject <IMailIdentity>
 -BodyParameter <IPaths3M6QbmUsersUserIdMailfoldersMailfolderIdMessagesMessageIdMicrosoftGraphCreatereplyallPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.mail/new-mgusermailfoldermessagereplyall](https://learn.microsoft.com/powershell/module/microsoft.graph.mail/new-mgusermailfoldermessagereplyall)
