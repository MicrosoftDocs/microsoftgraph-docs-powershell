...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.mail/invoke-mgforwardusermailfoldermessage
Locale: en-US
Module Name: Microsoft.Graph.Mail
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Invoke-MgForwardUserMailFolderMessage
---
...
```
Invoke-MgForwardUserMailFolderMessage -InputObject <IMailIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-Comment <string>]
 [-Message <IMicrosoftGraphMessage>] [-ToRecipients <IMicrosoftGraphRecipient[]>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru] [-Proxy <uri>]
...
```yaml
Type: Microsoft.Graph.PowerShell.Models.IPaths1X7Dum0UsersUserIdMailfoldersMailfolderIdMessagesMessageIdMicrosoftGraphForwardPostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
- [Invoke-MgForwardUserMailFolderMessage](https://learn.microsoft.com/powershell/module/microsoft.graph.mail/invoke-mgforwardusermailfoldermessage)
