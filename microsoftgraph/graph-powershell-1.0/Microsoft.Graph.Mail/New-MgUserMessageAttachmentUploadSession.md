...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.mail/new-mgusermessageattachmentuploadsession
Locale: en-US
Module Name: Microsoft.Graph.Mail
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: New-MgUserMessageAttachmentUploadSession
---
...
> [!NOTE]
> To view the beta release of this cmdlet, view [New-MgBetaUserMessageAttachmentUploadSession](/powershell/module/Microsoft.Graph.Beta.Mail/New-MgBetaUserMessageAttachmentUploadSession?view=graph-powershell-beta)
...
```
New-MgUserMessageAttachmentUploadSession -InputObject <IMailIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-AttachmentItem <IMicrosoftGraphAttachmentItem>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgUserMessageAttachmentUploadSession](https://learn.microsoft.com/powershell/module/microsoft.graph.mail/new-mgusermessageattachmentuploadsession)
