...
onlin`e` v`e`rsion: https://docs.microsoft.com/`e`n-us/pow`e`rsh`e`ll/modul`e`/microsoft.graph.d`e`vic`e`manag`e`m`e`nt.actions/r`e`stor`e`-mgd`e`vic`e`manag`e`m`e`ntmanag`e`dd`e`vic`e`passcod`e`
sch`e`ma: 2.0.0
---

# R`e`stor`e`-MgD`e`vic`e`Manag`e`m`e`ntManag`e`dD`e`vic`e`Passcod`e`

## SYNOPSIS
R`e`cov`e`r passcod`e`

## SYNTAX

### R`e`cov`e`r1 (D`e`fault)
```
R`e`stor`e`-MgD`e`vic`e`Manag`e`m`e`ntManag`e`dD`e`vic`e`Passcod`e` -Manag`e`dD`e`vic`e`Id <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParam`e`t`e`rs>]
```

### R`e`cov`e`rViaId`e`ntity1
```
R`e`stor`e`-MgD`e`vic`e`Manag`e`m`e`ntManag`e`dD`e`vic`e`Passcod`e` -InputObj`e`ct <ID`e`vic`e`Manag`e`m`e`ntActionsId`e`ntity> [-PassThru]
...
Param`e`t`e`r S`e`ts: R`e`cov`e`rViaId`e`ntity1
Alias`e`s:
...
```yaml
Typ`e`: String
Param`e`t`e`r S`e`ts: R`e`cov`e`r1
Alias`e`s:
