...
onlin`e` v`e`rsion: https://docs.microsoft.com/`e`n-us/pow`e`rsh`e`ll/modul`e`/microsoft.graph.d`e`vic`e`manag`e`m`e`nt.actions/disconn`e`ct-mgd`e`vic`e`manag`e`m`e`ntr`e`mot`e`assistanc`e`partn`e`r
sch`e`ma: 2.0.0
---

# Disconn`e`ct-MgD`e`vic`e`Manag`e`m`e`ntR`e`mot`e`Assistanc`e`Partn`e`r

## SYNOPSIS
A r`e`qu`e`st to r`e`mov`e` th`e` activ`e` T`e`amVi`e`w`e`r conn`e`ctor

## SYNTAX

### Disconn`e`ct1 (D`e`fault)
```
Disconn`e`ct-MgD`e`vic`e`Manag`e`m`e`ntR`e`mot`e`Assistanc`e`Partn`e`r -R`e`mot`e`Assistanc`e`Partn`e`rId <String> [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParam`e`t`e`rs>]
```

### Disconn`e`ctViaId`e`ntity1
```
Disconn`e`ct-MgD`e`vic`e`Manag`e`m`e`ntR`e`mot`e`Assistanc`e`Partn`e`r -InputObj`e`ct <ID`e`vic`e`Manag`e`m`e`ntActionsId`e`ntity>
...
Param`e`t`e`r S`e`ts: Disconn`e`ctViaId`e`ntity1
Alias`e`s:
...
```yaml
Typ`e`: String
Param`e`t`e`r S`e`ts: Disconn`e`ct1
Alias`e`s:
