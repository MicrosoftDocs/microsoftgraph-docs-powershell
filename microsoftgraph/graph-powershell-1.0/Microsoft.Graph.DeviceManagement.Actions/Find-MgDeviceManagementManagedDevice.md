...
### Locate (Default)
```
Find-MgDeviceManagementManagedDevice -ManagedDeviceId <String> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### LocateViaIdentity
```
Find-MgDeviceManagementManagedDevice -InputObject <IDeviceManagementActionsIdentity> [-Headers <IDictionary>]
