...
### Locate (Default)
```
Find-MgDeviceManagementManagedDevice -ManagedDeviceId <String> [-ResponseHeadersVariable <String>]
...
### LocateViaIdentity
```
Find-MgDeviceManagementManagedDevice -InputObject <IDeviceManagementActionsIdentity>
