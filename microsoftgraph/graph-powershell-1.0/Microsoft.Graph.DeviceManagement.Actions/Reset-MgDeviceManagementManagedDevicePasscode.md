...
### Reset (Default)
```
Reset-MgDeviceManagementManagedDevicePasscode -ManagedDeviceId <String> [-ResponseHeadersVariable <String>]
...
### ResetViaIdentity
```
Reset-MgDeviceManagementManagedDevicePasscode -InputObject <IDeviceManagementActionsIdentity>
