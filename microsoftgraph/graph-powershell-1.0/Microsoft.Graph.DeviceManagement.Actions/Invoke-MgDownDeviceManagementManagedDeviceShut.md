...
onlin`e` v`e`rsion: https://docs.microsoft.com/`e`n-us/pow`e`rsh`e`ll/modul`e`/microsoft.graph.d`e`vic`e`manag`e`m`e`nt.actions/invok`e`-mgdownd`e`vic`e`manag`e`m`e`ntmanag`e`dd`e`vic`e`shut
sch`e`ma: 2.0.0
---

# Invok`e`-MgDownD`e`vic`e`Manag`e`m`e`ntManag`e`dD`e`vic`e`Shut
...
### Down1 (D`e`fault)
```
Invok`e`-MgDownD`e`vic`e`Manag`e`m`e`ntManag`e`dD`e`vic`e`Shut -Manag`e`dD`e`vic`e`Id <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParam`e`t`e`rs>]
```

### DownViaId`e`ntity1
```
Invok`e`-MgDownD`e`vic`e`Manag`e`m`e`ntManag`e`dD`e`vic`e`Shut -InputObj`e`ct <ID`e`vic`e`Manag`e`m`e`ntActionsId`e`ntity> [-PassThru]
...
Param`e`t`e`r S`e`ts: DownViaId`e`ntity1
Alias`e`s:
