...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.backuprestore/update-mgbetasolutionbackuprestoreexchangerestoresessionmailboxrestoreartifact
schema: 2.0.0
---
...
```
Update-MgBetaSolutionBackupRestoreExchangeRestoreSessionMailboxRestoreArtifact
 -ExchangeRestoreSessionId <String> -MailboxRestoreArtifactId <String> [-ResponseHeadersVariable <String>]
 ...
 [-RestoredFolderId <String>] [-RestoredItemCount <Int32>] [-StartDateTime <DateTime>] [-Status <String>]
