...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.backuprestore/new-mgbetasolutionbackuprestoredriveprotectionunitbulkadditionjob
schema: 2.0.0
---
...
```
New-MgBetaSolutionBackupRestoreDriveProtectionUnitBulkAdditionJob [-ResponseHeadersVariable <String>]
