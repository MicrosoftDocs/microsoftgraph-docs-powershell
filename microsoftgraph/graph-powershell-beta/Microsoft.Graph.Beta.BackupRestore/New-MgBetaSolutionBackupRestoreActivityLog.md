...
```
New-MgBetaSolutionBackupRestoreActivityLog [-ResponseHeadersVariable <string>]
 [-ActivityType <string>] [-AdditionalProperties <hashtable>] [-Error <IMicrosoftGraphPublicError>]
 [-EventDateTime <datetime>] [-Id <string>] [-PerformedBy <string>] [-ResultStatus <string>]
 [-ServiceType <string>] [-Severity <string>] [-Break] [-Headers <IDictionary>]
...
```
New-MgBetaSolutionBackupRestoreActivityLog -BodyParameter <IMicrosoftGraphActivityLogBase>
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphActivityLogBase
