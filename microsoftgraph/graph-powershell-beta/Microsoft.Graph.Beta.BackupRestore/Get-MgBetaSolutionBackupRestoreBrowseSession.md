...
```
Get-MgBetaSolutionBackupRestoreBrowseSession [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaSolutionBackupRestoreBrowseSession -BrowseSessionBaseId <string>
...
```
Get-MgBetaSolutionBackupRestoreBrowseSession -InputObject <IBackupRestoreIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
...
- [Graph API Reference](https://learn.microsoft.com/graph/api/backuprestoreroot-list-browsesessions?view=graph-rest-beta)
