...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.backuprestore/get-mgbetasolutionbackuprestoreprotectionunit
Locale: en-US
Module Name: Microsoft.Graph.Beta.BackupRestore
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaSolutionBackupRestoreProtectionUnit
---
...
```
Get-MgBetaSolutionBackupRestoreProtectionUnit [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaSolutionBackupRestoreProtectionUnit -ProtectionUnitBaseId <string>
...
```
Get-MgBetaSolutionBackupRestoreProtectionUnit -InputObject <IBackupRestoreIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
...
- [Get-MgBetaSolutionBackupRestoreProtectionUnit](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.backuprestore/get-mgbetasolutionbackuprestoreprotectionunit)
- [Graph API Reference](https://learn.microsoft.com/graph/api/protectionunitbase-get?view=graph-rest-beta)
