...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.backuprestore/get-mgbetasolutionbackuprestoreactivitylog
Locale: en-US
Module Name: Microsoft.Graph.Beta.BackupRestore
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaSolutionBackupRestoreActivityLog
---
...
```
Get-MgBetaSolutionBackupRestoreActivityLog [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaSolutionBackupRestoreActivityLog -ActivityLogBaseId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaSolutionBackupRestoreActivityLog -InputObject <IBackupRestoreIdentity>
...
- [Get-MgBetaSolutionBackupRestoreActivityLog](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.backuprestore/get-mgbetasolutionbackuprestoreactivitylog)
