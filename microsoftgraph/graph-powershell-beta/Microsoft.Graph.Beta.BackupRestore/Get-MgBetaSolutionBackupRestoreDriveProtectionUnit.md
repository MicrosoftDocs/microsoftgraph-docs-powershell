...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.backuprestore/get-mgbetasolutionbackuprestoredriveprotectionunit
schema: 2.0.0
...
### List (Default)
```
Get-MgBetaSolutionBackupRestoreDriveProtectionUnit [-ExpandProperty <String[]>] [-Property <String[]>]
...
### Get
```
Get-MgBetaSolutionBackupRestoreDriveProtectionUnit -DriveProtectionUnitId <String> [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgBetaSolutionBackupRestoreDriveProtectionUnit -InputObject <IBackupRestoreIdentity>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.backuprestore/get-mgbetasolutionbackuprestoredriveprotectionunit](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.backuprestore/get-mgbetasolutionbackuprestoredriveprotectionunit)
