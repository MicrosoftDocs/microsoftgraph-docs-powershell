...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.backuprestore/new-mgbetasolutionbackuprestoresiteprotectionunit
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgSolutionBackupRestoreSiteProtectionUnit](/powershell/module/Microsoft.Graph.BackupRestore/New-MgSolutionBackupRestoreSiteProtectionUnit?view=graph-powershell-1.0)
...
New-MgBetaSolutionBackupRestoreSiteProtectionUnit [-ResponseHeadersVariable <String>]
 ...
 [-LastModifiedDateTime <DateTime>] [-PolicyId <String>] [-ProtectionSources <String>] [-SiteId <String>]
...
### Create
```
New-MgBetaSolutionBackupRestoreSiteProtectionUnit -BodyParameter <IMicrosoftGraphSiteProtectionUnit>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.backuprestore/new-mgbetasolutionbackuprestoresiteprotectionunit](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.backuprestore/new-mgbetasolutionbackuprestoresiteprotectionunit)
