...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.backuprestore/update-mgbetasolutionbackuprestoresharepointrestoresessionsiterestoreartifact
schema: 2.0.0
---
...
```
Update-MgBetaSolutionBackupRestoreSharePointRestoreSessionSiteRestoreArtifact
 -SharePointRestoreSessionId <String> -SiteRestoreArtifactId <String> [-ResponseHeadersVariable <String>]
