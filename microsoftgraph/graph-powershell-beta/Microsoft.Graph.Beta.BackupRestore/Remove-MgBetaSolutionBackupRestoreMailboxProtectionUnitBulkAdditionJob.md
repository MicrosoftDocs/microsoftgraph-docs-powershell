...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.backuprestore/remove-mgbetasolutionbackuprestoremailboxprotectionunitbulkadditionjob
schema: 2.0.0
---
...
```
Remove-MgBetaSolutionBackupRestoreMailboxProtectionUnitBulkAdditionJob
 -MailboxProtectionUnitsBulkAdditionJobId <String> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
...
### DeleteViaIdentity
```
Remove-MgBetaSolutionBackupRestoreMailboxProtectionUnitBulkAdditionJob -InputObject <IBackupRestoreIdentity>
