...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.backuprestore/get-mgbetasolutionbackuprestoremailboxprotectionunitbulkadditionjob
schema: 2.0.0
---
...
```
Get-MgBetaSolutionBackupRestoreMailboxProtectionUnitBulkAdditionJob
 -MailboxProtectionUnitsBulkAdditionJobId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgBetaSolutionBackupRestoreMailboxProtectionUnitBulkAdditionJob -InputObject <IBackupRestoreIdentity>
