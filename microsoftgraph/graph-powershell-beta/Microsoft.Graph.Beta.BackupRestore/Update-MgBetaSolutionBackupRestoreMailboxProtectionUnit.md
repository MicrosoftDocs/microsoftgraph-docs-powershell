...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.backuprestore/update-mgbetasolutionbackuprestoremailboxprotectionunit
schema: 2.0.0
---
...
Update-MgBetaSolutionBackupRestoreMailboxProtectionUnit -MailboxProtectionUnitId <String>
 ...
 [-LastModifiedDateTime <DateTime>] [-MailboxType <String>] [-PolicyId <String>] [-Status <String>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.backuprestore/update-mgbetasolutionbackuprestoremailboxprotectionunit](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.backuprestore/update-mgbetasolutionbackuprestoremailboxprotectionunit)
