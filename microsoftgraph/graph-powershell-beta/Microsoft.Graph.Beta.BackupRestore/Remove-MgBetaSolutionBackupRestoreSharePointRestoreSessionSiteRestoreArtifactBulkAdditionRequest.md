...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.backuprestore/remove-mgbetasolutionbackuprestoresharepointrestoresessionsiterestoreartifactbulkadditionrequest
schema: 2.0.0
...
```
Remove-MgBetaSolutionBackupRestoreSharePointRestoreSessionSiteRestoreArtifactBulkAdditionRequest
 -SharePointRestoreSessionId <String> -SiteRestoreArtifactsBulkAdditionRequestId <String> [-IfMatch <String>]
