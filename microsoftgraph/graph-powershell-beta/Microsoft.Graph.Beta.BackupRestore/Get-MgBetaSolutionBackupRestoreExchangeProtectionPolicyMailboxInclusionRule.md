...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.backuprestore/get-mgbetasolutionbackuprestoreexchangeprotectionpolicymailboxinclusionrule
Locale: en-US
Module Name: Microsoft.Graph.Beta.BackupRestore
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaSolutionBackupRestoreExchangeProtectionPolicyMailboxInclusionRule
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgSolutionBackupRestoreExchangeProtectionPolicyMailboxInclusionRule](/powershell/module/Microsoft.Graph.BackupRestore/Get-MgSolutionBackupRestoreExchangeProtectionPolicyMailboxInclusionRule?view=graph-powershell-1.0)
...
```
Get-MgBetaSolutionBackupRestoreExchangeProtectionPolicyMailboxInclusionRule
 -ExchangeProtectionPolicyId <string> -MailboxProtectionRuleId <string> [-ExpandProperty <string[]>]
...
- [Get-MgBetaSolutionBackupRestoreExchangeProtectionPolicyMailboxInclusionRule](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.backuprestore/get-mgbetasolutionbackuprestoreexchangeprotectionpolicymailboxinclusionrule)
- [Graph API Reference](https://learn.microsoft.com/graph/api/protectionrulebase-get?view=graph-rest-beta)
- [Graph API Reference](https://learn.microsoft.com/graph/api/exchangeprotectionpolicy-list-mailboxinclusionrules?view=graph-rest-beta)
