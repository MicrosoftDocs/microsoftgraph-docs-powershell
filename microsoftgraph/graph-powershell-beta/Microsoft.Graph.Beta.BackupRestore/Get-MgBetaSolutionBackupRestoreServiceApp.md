...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.backuprestore/get-mgbetasolutionbackuprestoreserviceapp
Locale: en-US
Module Name: Microsoft.Graph.Beta.BackupRestore
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaSolutionBackupRestoreServiceApp
---
...
```
Get-MgBetaSolutionBackupRestoreServiceApp [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaSolutionBackupRestoreServiceApp -ServiceAppId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaSolutionBackupRestoreServiceApp -InputObject <IBackupRestoreIdentity>
...
- [Get-MgBetaSolutionBackupRestoreServiceApp](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.backuprestore/get-mgbetasolutionbackuprestoreserviceapp)
- [Graph API Reference](https://learn.microsoft.com/graph/api/serviceapp-get?view=graph-rest-beta)
- [Graph API Reference](https://learn.microsoft.com/graph/api/backuprestoreroot-list-serviceapps?view=graph-rest-beta)
