...
- [](https://learn.microsoft.com/graph/api/sharepointbrowsesession-get?view=graph-rest-beta)
- [](https://learn.microsoft.com/graph/api/backuprestoreroot-list-sharepointbrowsesessions?view=graph-rest-beta)
