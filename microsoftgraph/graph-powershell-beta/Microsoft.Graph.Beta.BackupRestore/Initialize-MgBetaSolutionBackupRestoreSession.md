...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.backuprestore/initialize-mgbetasolutionbackuprestoresession
Locale: en-US
Module Name: Microsoft.Graph.Beta.BackupRestore
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Initialize-MgBetaSolutionBackupRestoreSession
---
...
```
Initialize-MgBetaSolutionBackupRestoreSession -RestoreSessionBaseId <string>
...
```
Initialize-MgBetaSolutionBackupRestoreSession -InputObject <IBackupRestoreIdentity>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
 [<CommonParameters>]
