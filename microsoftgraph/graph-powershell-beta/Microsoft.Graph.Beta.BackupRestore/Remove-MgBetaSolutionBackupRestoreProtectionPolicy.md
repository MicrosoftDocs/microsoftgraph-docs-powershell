...
### Delete (Default)
```
Remove-MgBetaSolutionBackupRestoreProtectionPolicy -ProtectionPolicyBaseId <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgBetaSolutionBackupRestoreProtectionPolicy -InputObject <IBackupRestoreIdentity> [-IfMatch <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
