...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.backuprestore/update-mgbetasolutionbackuprestoresiteprotectionunitbulkadditionjob
schema: 2.0.0
---
...
Update-MgBetaSolutionBackupRestoreSiteProtectionUnitBulkAdditionJob
 ...
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-LastModifiedDateTime <DateTime>] [-SiteIds <String[]>]
 [-SiteWebUrls <String[]>] [-Status <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>]
...
Update-MgBetaSolutionBackupRestoreSiteProtectionUnitBulkAdditionJob
 ...
 -BodyParameter <IMicrosoftGraphSiteProtectionUnitsBulkAdditionJob> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgBetaSolutionBackupRestoreSiteProtectionUnitBulkAdditionJob -InputObject <IBackupRestoreIdentity>
 ...
 [-LastModifiedDateTime <DateTime>] [-SiteIds <String[]>] [-SiteWebUrls <String[]>] [-Status <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
