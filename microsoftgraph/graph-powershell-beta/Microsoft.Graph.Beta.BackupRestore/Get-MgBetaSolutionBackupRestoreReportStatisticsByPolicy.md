...
# Get-MgBetaSolutionBackupRestoreReportStatisticsByPolicy
...
```
Get-MgBetaSolutionBackupRestoreReportStatisticsByPolicy -PolicyId <string>
...
```
Get-MgBetaSolutionBackupRestoreReportStatisticsByPolicy -InputObject <IBackupRestoreIdentity>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
```
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphBackupPolicyReport
