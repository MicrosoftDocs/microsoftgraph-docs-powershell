...
### Get (Default)
```
Get-MgBetaReportSkypeForBusinessParticipantActivityCount -Period <String> -OutFile <String> [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportSkypeForBusinessParticipantActivityCount -InputObject <IReportsIdentity> -OutFile <String>
