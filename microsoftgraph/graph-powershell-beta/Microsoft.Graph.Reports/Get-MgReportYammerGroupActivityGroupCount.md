...
### Get (Default)
```
Get-MgBetaReportYammerGroupActivityGroupCount -Period <String> -OutFile <String> [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportYammerGroupActivityGroupCount -InputObject <IReportsIdentity> -OutFile <String> [-PassThru]
 [<CommonParameters>]
```
