...
### List (Default)
```
Get-MgReportApplicationSignInDetailedSummary [-ExpandProperty <String[]>] [-Property <String[]>]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.reports/get-mgreportapplicationsignindetailedsummary](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.reports/get-mgreportapplicationsignindetailedsummary)
