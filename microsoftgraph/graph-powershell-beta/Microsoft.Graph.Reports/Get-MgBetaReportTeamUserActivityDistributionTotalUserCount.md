...
### Get (Default)
```
Get-MgBetaReportTeamUserActivityDistributionTotalUserCount -Period <String> -OutFile <String> [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportTeamUserActivityDistributionTotalUserCount -InputObject <IReportsIdentity> -OutFile <String>
