...
### Get (Default)
```
Get-MgReportTeamDeviceUsageDistributionTotalUserCount -Period <String> -OutFile <String> [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgReportTeamDeviceUsageDistributionTotalUserCount -InputObject <IReportsIdentity> -OutFile <String>
