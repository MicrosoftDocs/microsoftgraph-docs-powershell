...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportyammerdeviceusagedistributionusercount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaReportYammerDeviceUsageDistributionUserCount -Period <String> -OutFile <String> [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportYammerDeviceUsageDistributionUserCount -InputObject <IReportsIdentity> -OutFile <String>
