...
### List (Default)
```
Get-MgBetaWindowsUpdatesCatalogEntry [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaWindowsUpdatesCatalogEntry -CatalogEntryId <String> [-ExpandProperty <String[]>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.windowsupdates/get-mgbetawindowsupdatescatalogentry](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.windowsupdates/get-mgbetawindowsupdatescatalogentry)
