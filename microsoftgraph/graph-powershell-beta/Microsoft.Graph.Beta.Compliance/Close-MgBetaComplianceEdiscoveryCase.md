...
### Close (Default)
```
Close-MgBetaComplianceEdiscoveryCase -CaseId <String> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### CloseViaIdentity
```
Close-MgBetaComplianceEdiscoveryCase -InputObject <IComplianceIdentity> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
