...
### Reopen (Default)
```
Invoke-MgBetaReopenComplianceEdiscoveryCase -CaseId <String> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### ReopenViaIdentity
```
Invoke-MgBetaReopenComplianceEdiscoveryCase -InputObject <IComplianceIdentity> [-Headers <IDictionary>]
