...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.compliance/get-mgbetacomplianceediscoverycasecustodian
Locale: en-US
Module Name: Microsoft.Graph.Beta.Compliance
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaComplianceEdiscoveryCaseCustodian
---
...
```
Get-MgBetaComplianceEdiscoveryCaseCustodian -InputObject <IComplianceIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
...
- [Get-MgBetaComplianceEdiscoveryCaseCustodian](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.compliance/get-mgbetacomplianceediscoverycasecustodian)
- [Graph API Reference](https://learn.microsoft.com/graph/api/ediscovery-custodian-get?view=graph-rest-beta)
- [Graph API Reference](https://learn.microsoft.com/graph/api/ediscovery-case-list-custodians?view=graph-rest-beta)
