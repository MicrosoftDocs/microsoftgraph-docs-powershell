...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.compliance/update-mgbetacomplianceediscoverycasereviewset
Locale: en-US
Module Name: Microsoft.Graph.Beta.Compliance
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: Update-MgBetaComplianceEdiscoveryCaseReviewSet
---
...
Update-MgBetaComplianceEdiscoveryCaseReviewSet -CaseId <string> -ReviewSetId <string>
 ...
 [-Id <string>] [-Queries <IMicrosoftGraphEdiscoveryReviewSetQuery[]>] [-Break]
...
```
Update-MgBetaComplianceEdiscoveryCaseReviewSet -CaseId <string> -ReviewSetId <string>
 -BodyParameter <IMicrosoftGraphEdiscoveryReviewSet> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm] [<CommonParameters>]
```
