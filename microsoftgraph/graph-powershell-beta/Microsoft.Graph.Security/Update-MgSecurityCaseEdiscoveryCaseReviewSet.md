...
Update-MgSecurityCaseEdiscoveryCaseReviewSet -EdiscoveryCaseId <String> -EdiscoveryReviewSetId <String>
 ...
 [-DisplayName <String>] [-Files <IMicrosoftGraphSecurityEdiscoveryFile[]>] [-Id <String>]
 [-Queries <IMicrosoftGraphSecurityEdiscoveryReviewSetQuery[]>] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.security/update-mgsecuritycaseediscoverycasereviewset](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.security/update-mgsecuritycaseediscoverycasereviewset)
