...
### Close (Default)
```
Close-MgBetaSecurityCaseEdiscoveryCase -EdiscoveryCaseId <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### CloseViaIdentity
```
Close-MgBetaSecurityCaseEdiscoveryCase -InputObject <ISecurityIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
