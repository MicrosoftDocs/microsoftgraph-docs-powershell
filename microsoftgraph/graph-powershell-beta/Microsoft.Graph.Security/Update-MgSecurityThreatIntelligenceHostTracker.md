...
Update-MgSecurityThreatIntelligenceHostTracker -HostTrackerId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-LastSeenDateTime <DateTime>] [-Value <String>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Update
```
Update-MgSecurityThreatIntelligenceHostTracker -HostTrackerId <String>
 -BodyParameter <IMicrosoftGraphSecurityHostTracker> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
Update-MgSecurityThreatIntelligenceHostTracker -InputObject <ISecurityIdentity>
 ...
 [-Id <String>] [-Kind <String>] [-LastSeenDateTime <DateTime>] [-Value <String>] [-PassThru] [-WhatIf]
