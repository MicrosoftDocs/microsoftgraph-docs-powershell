...
### Delete (Default)
```
Remove-MgBetaSecurityUserSecurityProfile -UserSecurityProfileId <String> [-IfMatch <String>] [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaSecurityUserSecurityProfile -InputObject <ISecurityIdentity> [-IfMatch <String>] [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
