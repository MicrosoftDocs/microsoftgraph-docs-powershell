...
Set-MgSecurityCaseEdiscoveryCaseReviewSetFileExtractedTextContent -EdiscoveryCaseId <String>
 -EdiscoveryFileId <String> -EdiscoveryReviewSetId <String> [-BodyParameter <Stream>] -InFile <String>
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.security/set-mgsecuritycaseediscoverycasereviewsetfileextractedtextcontent](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.security/set-mgsecuritycaseediscoverycasereviewsetfileextractedtextcontent)
