...
Update-MgSecurityAttackSimulationOperation -AttackSimulationOperationId <String>
 ...
 [-Status <String>] [-StatusDetail <String>] [-TenantId <String>] [-Type <String>] [-PassThru] [-WhatIf]
...
```
Update-MgSecurityAttackSimulationOperation -AttackSimulationOperationId <String>
 -BodyParameter <IMicrosoftGraphAttackSimulationOperation> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
