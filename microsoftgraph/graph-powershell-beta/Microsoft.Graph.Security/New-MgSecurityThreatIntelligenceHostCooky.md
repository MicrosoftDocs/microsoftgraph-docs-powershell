...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.security/new-mgsecuritythreatintelligencehostcooky
schema: 2.0.0
---

# New-MgSecurityThreatIntelligenceHostCooky
...
```
New-MgSecurityThreatIntelligenceHostCooky [-AdditionalProperties <Hashtable>] [-Domain <String>]
 [-FirstSeenDateTime <DateTime>] [-Host <IMicrosoftGraphSecurityHost>] [-Id <String>]
 [-LastSeenDateTime <DateTime>] [-Name <String>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Create
```
New-MgSecurityThreatIntelligenceHostCooky -BodyParameter <IMicrosoftGraphSecurityHostCookie> [-WhatIf]
...
### -Host
host
To construct, please use Get-Help -Online and see NOTES section for HOST properties and create a hash table.
