...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.security/update-mgsecuritythreatintelligencehost
schema: 2.0.0
---
...
Update-MgSecurityThreatIntelligenceHost -InputObject <ISecurityIdentity>
 -BodyParameter <IMicrosoftGraphSecurityHost> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
To construct, please use Get-Help -Online and see NOTES section for COMPONENTS properties and create a hash table.
...
To construct, please use Get-Help -Online and see NOTES section for COOKIES properties and create a hash table.
...
To construct, please use Get-Help -Online and see NOTES section for PASSIVEDNS properties and create a hash table.
...
To construct, please use Get-Help -Online and see NOTES section for PASSIVEDNSREVERSE properties and create a hash table.
...
### -Reputation
hostReputation
To construct, please use Get-Help -Online and see NOTES section for REPUTATION properties and create a hash table.
...
To construct, please use Get-Help -Online and see NOTES section for TRACKERS properties and create a hash table.
