...
### Delta1 (Default)
```
Get-MgUserTodoListTaskDelta -TodoTaskListId <String> -UserId <String> [-Filter <String>] [-Property <String[]>]
...
### DeltaViaIdentity1
```
Get-MgUserTodoListTaskDelta -InputObject <IUsersFunctionsIdentity> [-Filter <String>] [-Property <String[]>]
