...
### Preview (Default)
```
Invoke-MgBetaPreviewUserOnenotePage -OnenotePageId <String> -UserId <String> [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### PreviewViaIdentity
```
Invoke-MgBetaPreviewUserOnenotePage -InputObject <IUsersFunctionsIdentity> [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
