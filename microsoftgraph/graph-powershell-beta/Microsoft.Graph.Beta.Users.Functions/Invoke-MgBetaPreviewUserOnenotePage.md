...
### Preview (Default)
```
Invoke-MgBetaPreviewUserOnenotePage -OnenotePageId <String> -UserId <String>
...
### PreviewViaIdentity
```
Invoke-MgBetaPreviewUserOnenotePage -InputObject <IUsersFunctionsIdentity> [-ResponseHeadersVariable <String>]
