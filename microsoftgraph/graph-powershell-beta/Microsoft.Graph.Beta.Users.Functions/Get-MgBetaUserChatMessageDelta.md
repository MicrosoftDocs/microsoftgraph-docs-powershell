...
### Delta (Default)
```
Get-MgBetaUserChatMessageDelta -ChatId <String> -UserId <String> [-ExpandProperty <String[]>]
...
### DeltaViaIdentity
```
Get-MgBetaUserChatMessageDelta -InputObject <IUsersFunctionsIdentity> [-ExpandProperty <String[]>]
 [-Filter <String>] [-Property <String[]>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>] [-Top <Int32>]
