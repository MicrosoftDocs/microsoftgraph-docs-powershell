...
### Delta (Default)
```
Get-MgBetaUserPlannerTaskDelta -UserId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### DeltaViaIdentity
```
Get-MgBetaUserPlannerTaskDelta -InputObject <IUsersFunctionsIdentity> [-ExpandProperty <String[]>]
