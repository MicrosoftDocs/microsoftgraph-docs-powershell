...
### Get (Default)
```
Get-MgBetaUserLoggedOnManagedDevice -UserId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgBetaUserLoggedOnManagedDevice -InputObject <IUsersFunctionsIdentity> [-Count]
