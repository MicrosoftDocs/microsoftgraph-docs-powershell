...
### Retrieve (Default)
```
Get-MgBetaUserCloudPcSnapshot -CloudPcId <String> -UserId <String> [-Count] [-ExpandProperty <String[]>]
...
### RetrieveViaIdentity
```
Get-MgBetaUserCloudPcSnapshot -InputObject <IUsersFunctionsIdentity> [-Count] [-ExpandProperty <String[]>]
 [-Filter <String>] [-Property <String[]>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>] [-Top <Int32>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
