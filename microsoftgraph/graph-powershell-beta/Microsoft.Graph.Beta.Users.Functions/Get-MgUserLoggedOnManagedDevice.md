...
### Get (Default)
```
Get-MgUserLoggedOnManagedDevice -UserId <String> [-Count] [-Filter <String>] [-Property <String[]>]
 [-Search <String>] [-Skip <Int32>] [-Sort <String[]>] [-Top <Int32>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgUserLoggedOnManagedDevice -InputObject <IUsersFunctionsIdentity> [-Count] [-Filter <String>]
