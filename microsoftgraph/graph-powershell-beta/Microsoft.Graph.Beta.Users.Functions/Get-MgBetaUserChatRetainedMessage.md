...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgUserChatRetainedMessage](/powershell/module/Microsoft.Graph.Users.Functions/Get-MgUserChatRetainedMessage?view=graph-powershell-1.0)

## SYNTAX

### Get (Default)
```
Get-MgBetaUserChatRetainedMessage -UserId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgBetaUserChatRetainedMessage -InputObject <IUsersFunctionsIdentity> [-Count] [-ExpandProperty <String[]>]
