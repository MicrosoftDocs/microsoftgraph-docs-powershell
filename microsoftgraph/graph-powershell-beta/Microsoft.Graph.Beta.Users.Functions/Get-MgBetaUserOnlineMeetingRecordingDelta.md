...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgUserOnlineMeetingRecordingDelta](/powershell/module/Microsoft.Graph.Users.Functions/Get-MgUserOnlineMeetingRecordingDelta?view=graph-powershell-1.0)
...
### DeltaViaIdentity
```
Get-MgBetaUserOnlineMeetingRecordingDelta -InputObject <IUsersFunctionsIdentity> [-ExpandProperty <String[]>]
