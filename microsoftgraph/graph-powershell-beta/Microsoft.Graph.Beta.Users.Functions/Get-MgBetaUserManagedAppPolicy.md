...
```
Get-MgBetaUserManagedAppPolicy -UserId <string> [-Count] [-ExpandProperty <string[]>]
...
```
Get-MgBetaUserManagedAppPolicy -InputObject <IUsersFunctionsIdentity> [-Count]
...
- [Get-MgBetaUserManagedAppPolicy](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users.functions/get-mgbetausermanagedapppolicy)
