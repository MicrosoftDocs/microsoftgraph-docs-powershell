...
### Delta1 (Default)
```
Get-MgUserMailFolderMessageDelta -MailFolderId <String> -UserId <String> [-Filter <String>]
...
### DeltaViaIdentity1
```
Get-MgUserMailFolderMessageDelta -InputObject <IUsersFunctionsIdentity> [-Filter <String>]
