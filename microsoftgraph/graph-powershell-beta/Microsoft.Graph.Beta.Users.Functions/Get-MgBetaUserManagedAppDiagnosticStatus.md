...
```
Get-MgBetaUserManagedAppDiagnosticStatus -UserId <string> [-Count] [-Filter <string>]
...
```
Get-MgBetaUserManagedAppDiagnosticStatus -InputObject <IUsersFunctionsIdentity> [-Count]
