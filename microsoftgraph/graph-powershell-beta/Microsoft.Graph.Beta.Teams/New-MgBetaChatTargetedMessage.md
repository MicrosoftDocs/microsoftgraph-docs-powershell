...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetachattargetedmessage
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaChatTargetedMessage
---

# New-MgBetaChatTargetedMessage
...
```
New-MgBetaChatTargetedMessage -ChatId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaChatTargetedMessage -InputObject <ITeamsIdentity> [-ChatId <string>]
...
```
New-MgBetaChatTargetedMessage -ChatId <string> -BodyParameter <IMicrosoftGraphTargetedChatMessage>
...
```
New-MgBetaChatTargetedMessage -InputObject <ITeamsIdentity>
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphTargetedChatMessage
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
