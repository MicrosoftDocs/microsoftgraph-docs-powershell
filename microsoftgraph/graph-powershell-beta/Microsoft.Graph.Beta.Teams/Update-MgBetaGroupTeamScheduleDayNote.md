...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetagroupteamscheduledaynote
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaGroupTeamScheduleDayNote
---
...
Update-MgBetaGroupTeamScheduleDayNote -DayNoteId <string> -GroupId <string>
 ...
 [-CreatedBy <IMicrosoftGraphIdentitySet>] [-DayNoteDate <datetime>]
 [-DraftDayNote <IMicrosoftGraphItemBody>] [-Id <string>]
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-SharedDayNote <IMicrosoftGraphItemBody>] [-Break]
...
```
Update-MgBetaGroupTeamScheduleDayNote -DayNoteId <string> -GroupId <string>
 -BodyParameter <IMicrosoftGraphDayNote> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
```
Update-MgBetaGroupTeamScheduleDayNote -InputObject <ITeamsIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-CreatedBy <IMicrosoftGraphIdentitySet>] [-DayNoteDate <datetime>]
 [-DraftDayNote <IMicrosoftGraphItemBody>] [-Id <string>]
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-SharedDayNote <IMicrosoftGraphItemBody>] [-Break]
...
itemBody
To construct, see NOTES section for DRAFTDAYNOTE properties and create a hash table.
...
- [Update-MgBetaGroupTeamScheduleDayNote](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetagroupteamscheduledaynote)
