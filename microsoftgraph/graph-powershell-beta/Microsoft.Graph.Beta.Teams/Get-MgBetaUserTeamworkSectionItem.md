...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetauserteamworksectionitem
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaUserTeamworkSectionItem
---

# Get-MgBetaUserTeamworkSectionItem
...
```
Get-MgBetaUserTeamworkSectionItem -TeamworkSectionId <string> -UserId <string>
...
```
Get-MgBetaUserTeamworkSectionItem -TeamworkSectionId <string> -TeamworkSectionItemId <string>
...
```
Get-MgBetaUserTeamworkSectionItem -InputObject <ITeamsIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgBetaUserTeamworkSectionItem](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetauserteamworksectionitem)
- [Graph API Reference](https://learn.microsoft.com/graph/api/teamworksection-list-items?view=graph-rest-beta)
