...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetauserchatmessagehostedcontent
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaUserChatMessageHostedContent
---
...
Update-MgBetaUserChatMessageHostedContent -ChatId <string> -ChatMessageHostedContentId <string>
 -ChatMessageId <string> -UserId <string> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaUserChatMessageHostedContent -ChatId <string> -ChatMessageHostedContentId <string>
 -ChatMessageId <string> -UserId <string> -BodyParameter <hashtable>
...
```
Update-MgBetaUserChatMessageHostedContent -InputObject <ITeamsIdentity>
...
```
Update-MgBetaUserChatMessageHostedContent -InputObject <ITeamsIdentity> -BodyParameter <hashtable>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
- [Update-MgBetaUserChatMessageHostedContent](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetauserchatmessagehostedcontent)
