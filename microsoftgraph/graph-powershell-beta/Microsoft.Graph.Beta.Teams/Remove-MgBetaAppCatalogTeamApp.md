...
### Delete (Default)
```
Remove-MgBetaAppCatalogTeamApp -TeamsAppId <String> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
...
### DeleteViaIdentity
```
Remove-MgBetaAppCatalogTeamApp -InputObject <ITeamsIdentity> [-IfMatch <String>]
...
[https://learn.microsoft.com/graph/api/teamsapp-delete?view=graph-rest-beta](https://learn.microsoft.com/graph/api/teamsapp-delete?view=graph-rest-beta)
