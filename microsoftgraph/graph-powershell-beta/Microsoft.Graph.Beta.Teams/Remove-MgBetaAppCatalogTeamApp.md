...
```
Remove-MgBetaAppCatalogTeamApp -TeamsAppId <string> [-IfMatch <string>]
...
| --------------- | ------------------------------------------  |
| Delegated (work or school account) | AppCatalog.ReadWrite.All, AppCatalog.Submit, Directory.ReadWrite.All,  |
