...
### Get (Default)
```
Get-MgBetaTeamChannelRetainedMessage -TeamId <String> [-Count] [-Filter <String>] [-Property <String[]>]
 [-Search <String>] [-Skip <Int32>] [-Sort <String[]>] [-Top <Int32>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaTeamChannelRetainedMessage -InputObject <ITeamsIdentity> [-Count] [-Filter <String>]
