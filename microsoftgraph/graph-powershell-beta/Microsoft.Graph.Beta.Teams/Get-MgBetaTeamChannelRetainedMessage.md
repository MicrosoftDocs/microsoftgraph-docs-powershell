...
### Get (Default)
```
Get-MgBetaTeamChannelRetainedMessage -TeamId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgBetaTeamChannelRetainedMessage -InputObject <ITeamsIdentity> [-Count] [-ExpandProperty <String[]>]
