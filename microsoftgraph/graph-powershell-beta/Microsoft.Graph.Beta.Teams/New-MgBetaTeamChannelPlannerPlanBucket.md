...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetateamchannelplannerplanbucket
schema: 2.0.0
---

# New-MgBetaTeamChannelPlannerPlanBucket
...
```
New-MgBetaTeamChannelPlannerPlanBucket -ChannelId <String> -PlannerPlanId <String> -TeamId <String>
...
```
New-MgBetaTeamChannelPlannerPlanBucket -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
...
### CreateViaIdentity
```
New-MgBetaTeamChannelPlannerPlanBucket -InputObject <ITeamsIdentity>
 -BodyParameter <IMicrosoftGraphPlannerBucket> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetateamchannelplannerplanbucket](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetateamchannelplannerplanbucket)
