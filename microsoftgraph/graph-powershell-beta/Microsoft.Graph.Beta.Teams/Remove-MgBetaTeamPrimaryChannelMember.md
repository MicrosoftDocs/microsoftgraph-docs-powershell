...
```
Remove-MgBetaTeamPrimaryChannelMember -TeamId <string> [-ResponseHeadersVariable <string>]
...
```
Remove-MgBetaTeamPrimaryChannelMember -ConversationMemberId <string> -TeamId <string>
...
```
Remove-MgBetaTeamPrimaryChannelMember -TeamId <string>
...
```
Remove-MgBetaTeamPrimaryChannelMember -InputObject <ITeamsIdentity>
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths1Ubz3XtTeamsTeamIdPrimarychannelMembersMicrosoftGraphRemovePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths1Ubz3XtTeamsTeamIdPrimarychannelMembersMicrosoftGraphRemovePostRequestbodyContentApplicationJsonSchema
