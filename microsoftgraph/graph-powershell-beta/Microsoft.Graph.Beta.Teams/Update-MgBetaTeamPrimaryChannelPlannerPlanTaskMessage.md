...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetateamprimarychannelplannerplantaskmessage
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaTeamPrimaryChannelPlannerPlanTaskMessage
---

# Update-MgBetaTeamPrimaryChannelPlannerPlanTaskMessage
...
```
Update-MgBetaTeamPrimaryChannelPlannerPlanTaskMessage -PlannerPlanId <string>
...
```
Update-MgBetaTeamPrimaryChannelPlannerPlanTaskMessage -InputObject <ITeamsIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-Content <string>]
 [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <datetime>]
 [-DeletedDateTime <datetime>] [-EditedDateTime <datetime>] [-Id <string>]
 [-Mentions <IMicrosoftGraphPlannerTaskChatMention[]>] [-MessageType <string>]
...
- [Update-MgBetaTeamPrimaryChannelPlannerPlanTaskMessage](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetateamprimarychannelplannerplantaskmessage)
