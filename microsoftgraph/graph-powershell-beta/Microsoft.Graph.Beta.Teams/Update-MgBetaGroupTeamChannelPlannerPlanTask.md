...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetagroupteamchannelplannerplantask
schema: 2.0.0
---
...
```
Update-MgBetaGroupTeamChannelPlannerPlanTask -ChannelId <String> -GroupId <String> -PlannerPlanId <String>
...
```
Update-MgBetaGroupTeamChannelPlannerPlanTask -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
