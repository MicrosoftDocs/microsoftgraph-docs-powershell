...
### Create
```
New-MgBetaTeamScheduleDayNote -TeamId <String> -BodyParameter <IMicrosoftGraphDayNote> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### CreateViaIdentity
```
New-MgBetaTeamScheduleDayNote -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphDayNote> [-WhatIf]
