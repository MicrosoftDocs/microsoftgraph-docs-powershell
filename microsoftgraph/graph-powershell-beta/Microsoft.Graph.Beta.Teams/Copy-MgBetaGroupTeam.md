...
```
Copy-MgBetaGroupTeam -GroupId <string> [-ResponseHeadersVariable <string>]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths1Umefn4GroupsGroupIdTeamMicrosoftGraphClonePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
