...
```
Update-MgBetaUserChatPermissionGrant -ChatId <String> -ResourceSpecificPermissionGrantId <String>
 -UserId <String> -BodyParameter <IMicrosoftGraphResourceSpecificPermissionGrant>
...
```
Update-MgBetaUserChatPermissionGrant -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
