...
Update-MgBetaUserChatPermissionGrant -ChatId <String> -ResourceSpecificPermissionGrantId <String>
 ...
 [-ResourceAppId <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```
Update-MgBetaUserChatPermissionGrant -ChatId <String> -ResourceSpecificPermissionGrantId <String>
 -UserId <String> -BodyParameter <IMicrosoftGraphResourceSpecificPermissionGrant> [-Headers <IDictionary>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetauserchatpermissiongrant](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetauserchatpermissiongrant)
