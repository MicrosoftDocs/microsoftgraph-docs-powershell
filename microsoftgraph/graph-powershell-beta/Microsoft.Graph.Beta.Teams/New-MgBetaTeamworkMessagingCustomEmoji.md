...
# New-MgBetaTeamworkMessagingCustomEmoji
...
```
New-MgBetaTeamworkMessagingCustomEmoji [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-ContentBytes <string>] [-CreatedBy <hashtable>]
 [-CreatedDateTime <datetime>] [-DisplayName <string>] [-Break] [-Headers <IDictionary>]
...
```
New-MgBetaTeamworkMessagingCustomEmoji -BodyParameter <IMicrosoftGraphTeamworkCustomEmoji>
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphTeamworkCustomEmoji
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
The base64-encoded image content of the emoji.
...
The date and time when the emoji was created.
...
The unique display name of the custom emoji.
Key.
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphTeamworkCustomEmoji
...
Supported formats include PNG and GIF.
  [CreatedBy <IMicrosoftGraphCustomEmojiFromIdentitySet>]: customEmojiFromIdentitySet
    [(Any) <Object>]: This indicates any property can be added to this object.
...
For example, in the access reviews decisions API, this property might record the id of the principal, that is, the group, user, or application that's subject to review.
  ...
  [CreatedDateTime <DateTime?>]: The date and time when the emoji was created.
The timestamp type represents date and time information using ISO 8601 format and is always in UTC.
For example, midnight UTC on Jan 1, 2024, is 2024-01-01T00:00:00Z.
  [DisplayName <String>]: The unique display name of the custom emoji.
Key.
Must be unique and must not conflict with existing emoji names.
