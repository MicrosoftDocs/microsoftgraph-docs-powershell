...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphteamworkdeletedteamchannelmessagereply
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: Invoke-MgBetaGraphTeamworkDeletedTeamChannelMessageReply
---

# Invoke-MgBetaGraphTeamworkDeletedTeamChannelMessageReply
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Invoke-MgGraphTeamworkDeletedTeamChannelMessageReply](/powershell/module/Microsoft.Graph.Teams/Invoke-MgGraphTeamworkDeletedTeamChannelMessageReply?view=graph-powershell-1.0)
...
```
Invoke-MgBetaGraphTeamworkDeletedTeamChannelMessageReply -ChannelId <string> -ChatMessageId <string>
...
Invoke-MgBetaGraphTeamworkDeletedTeamChannelMessageReply -ChannelId <string> -ChatMessageId <string>
 ...
 -Body <IPathsMkijfoTeamworkDeletedteamsDeletedteamIdChannelsChannelIdMessagesChatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema>
...
```
Invoke-MgBetaGraphTeamworkDeletedTeamChannelMessageReply -InputObject <ITeamsIdentity>
...
```
Invoke-MgBetaGraphTeamworkDeletedTeamChannelMessageReply -InputObject <ITeamsIdentity>
 -BodyParameter <IPathsMkijfoTeamworkDeletedteamsDeletedteamIdChannelsChannelIdMessagesChatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPathsMkijfoTeamworkDeletedteamsDeletedteamIdChannelsChannelIdMessagesChatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IPathsMkijfoTeamworkDeletedteamsDeletedteamIdChannelsChannelIdMessagesChatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
...
- [Invoke-MgBetaGraphTeamworkDeletedTeamChannelMessageReply](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphteamworkdeletedteamchannelmessagereply)
