...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphteamworkdeletedteamchannelmessagereply
schema: 2.0.0
ms.subservice: teams
---
...
Invoke-MgBetaGraphTeamworkDeletedTeamChannelMessageReply -ChannelId <String> -ChatMessageId <String>
 ...
 [-MessageIds <String[]>] [-ReplyMessage <IMicrosoftGraphChatMessage>] [-Headers <IDictionary>]
...
```yaml
Type: IPathsMkijfoTeamworkDeletedteamsDeletedteamIdChannelsChannelIdMessagesChatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphteamworkdeletedteamchannelmessagereply](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphteamworkdeletedteamchannelmessagereply)
