...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Remove-MgTeamScheduleOpenShift](/powershell/module/Microsoft.Graph.Teams/Remove-MgTeamScheduleOpenShift?view=graph-powershell-v1.0)

## SYNTAX

### Delete (Default)
```
Remove-MgBetaTeamScheduleOpenShift -OpenShiftId <String> -TeamId <String> [-IfMatch <String>] [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaTeamScheduleOpenShift -InputObject <ITeamsIdentity> [-IfMatch <String>] [-PassThru] [-WhatIf]
