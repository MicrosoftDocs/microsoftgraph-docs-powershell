...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetagroupteamchannelmessagedelta
schema: 2.0.0
ms.subservice: teams
---
...
### Delta (Default)
```
Get-MgBetaGroupTeamChannelMessageDelta -ChannelId <String> -GroupId <String> [-ExpandProperty <String[]>]
...
### DeltaViaIdentity
```
Get-MgBetaGroupTeamChannelMessageDelta -InputObject <ITeamsIdentity> [-ExpandProperty <String[]>]
 [-Filter <String>] [-Property <String[]>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>] [-Top <Int32>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetagroupteamchannelmessagedelta](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetagroupteamchannelmessagedelta)
