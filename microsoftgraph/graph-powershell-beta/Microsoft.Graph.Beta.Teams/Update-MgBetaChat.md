...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetachat
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaChat
---
...
```
Update-MgBetaChat -ChatId <string> [-ResponseHeadersVariable <string>]
 ...
 [-Operations <IMicrosoftGraphTeamsAsyncOperation[]>] [-OriginalCreatedDateTime <datetime>]
...
```
Update-MgBetaChat -ChatId <string> -BodyParameter <IMicrosoftGraphChat>
...
```
Update-MgBetaChat -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-ChatType <string>] [-CreatedBy <IMicrosoftGraphIdentitySet>]
 [-CreatedDateTime <datetime>] [-Id <string>]
 [-InstalledApps <IMicrosoftGraphTeamsAppInstallation[]>] [-IsHiddenForAllMembers]
 [-LastMessagePreview <IMicrosoftGraphChatMessageInfo>] [-LastUpdatedDateTime <datetime>]
...
```
Update-MgBetaChat -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphChat>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
