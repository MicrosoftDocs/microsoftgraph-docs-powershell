...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/remove-mgbetagroupteamchanneljoineduser
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Remove-MgBetaGroupTeamChannelJoinedUser
---

# Remove-MgBetaGroupTeamChannelJoinedUser
...
```
Remove-MgBetaGroupTeamChannelJoinedUser -ChannelId <string> -GroupId <string>
...
```
Remove-MgBetaGroupTeamChannelJoinedUser -ChannelId <string> -GroupId <string>
 -BodyParameter <IPathsS07F6LGroupsGroupIdTeamChannelsChannelIdJoinedusersMicrosoftGraphRemovePostRequestbodyContentApplicationJsonSchema>
...
```
Remove-MgBetaGroupTeamChannelJoinedUser -ChannelId <string> -ConversationMemberId <string>
...
```
Remove-MgBetaGroupTeamChannelJoinedUser -InputObject <ITeamsIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-Values <IMicrosoftGraphConversationMember[]>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```
Remove-MgBetaGroupTeamChannelJoinedUser -InputObject <ITeamsIdentity> [-IfMatch <string>]
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPathsS07F6LGroupsGroupIdTeamChannelsChannelIdJoinedusersMicrosoftGraphRemovePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IPathsS07F6LGroupsGroupIdTeamChannelsChannelIdJoinedusersMicrosoftGraphRemovePostRequestbodyContentApplicationJsonSchema
