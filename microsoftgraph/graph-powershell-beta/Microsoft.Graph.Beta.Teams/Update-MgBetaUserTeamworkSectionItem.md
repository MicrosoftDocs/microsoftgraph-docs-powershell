...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetauserteamworksectionitem
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaUserTeamworkSectionItem
---

# Update-MgBetaUserTeamworkSectionItem
...
```
Update-MgBetaUserTeamworkSectionItem -TeamworkSectionId <string> -TeamworkSectionItemId <string>
 -UserId <string> [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-CreatedDateTime <datetime>] [-Id <string>] [-ItemType <string>]
...
```
Update-MgBetaUserTeamworkSectionItem -TeamworkSectionId <string> -TeamworkSectionItemId <string>
 -UserId <string> -BodyParameter <IMicrosoftGraphTeamworkSectionItem>
...
```
Update-MgBetaUserTeamworkSectionItem -InputObject <ITeamsIdentity>
...
```
Update-MgBetaUserTeamworkSectionItem -InputObject <ITeamsIdentity>
 -BodyParameter <IMicrosoftGraphTeamworkSectionItem> [-ResponseHeadersVariable <string>] [-Break]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphTeamworkSectionItem
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
Date and time when the item was added to the section.
Read-only.
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphTeamworkSectionItem
...
- [Update-MgBetaUserTeamworkSectionItem](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetauserteamworksectionitem)
