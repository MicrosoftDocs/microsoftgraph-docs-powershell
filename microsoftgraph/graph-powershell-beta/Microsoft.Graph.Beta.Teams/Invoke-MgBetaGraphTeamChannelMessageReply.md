...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphteamchannelmessagereply
schema: 2.0.0
ms.subservice: teams
---

# Invoke-MgBetaGraphTeamChannelMessageReply
...
```
Invoke-MgBetaGraphTeamChannelMessageReply -ChannelId <String> -ChatMessageId <String> -TeamId <String>
...
```
Invoke-MgBetaGraphTeamChannelMessageReply -ChannelId <String> -ChatMessageId <String> -TeamId <String>
 -Body <IPaths1Y1G21JTeamsTeamIdChannelsChannelIdMessagesChatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema>
...
```
Invoke-MgBetaGraphTeamChannelMessageReply -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
...
```yaml
Type: IPaths1Y1G21JTeamsTeamIdChannelsChannelIdMessagesChatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths1Y1G21JTeamsTeamIdChannelsChannelIdMessagesChatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphteamchannelmessagereply](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphteamchannelmessagereply)
