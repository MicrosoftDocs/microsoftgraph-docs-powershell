...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/add-mgbetateamworkdeletedteamchanneljoineduser
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Add-MgBetaTeamworkDeletedTeamChannelJoinedUser
---

# Add-MgBetaTeamworkDeletedTeamChannelJoinedUser
...
```
Add-MgBetaTeamworkDeletedTeamChannelJoinedUser -ChannelId <string> -DeletedTeamId <string>
...
```
Add-MgBetaTeamworkDeletedTeamChannelJoinedUser -ChannelId <string> -DeletedTeamId <string>
 -BodyParameter <IPaths49E4DlTeamworkDeletedteamsDeletedteamIdChannelsChannelIdJoinedusersMicrosoftGraphAddPostRequestbodyContentApplicationJsonSchema>
...
```
Add-MgBetaTeamworkDeletedTeamChannelJoinedUser -InputObject <ITeamsIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-Values <IMicrosoftGraphConversationMember[]>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths49E4DlTeamworkDeletedteamsDeletedteamIdChannelsChannelIdJoinedusersMicrosoftGraphAddPostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths49E4DlTeamworkDeletedteamsDeletedteamIdChannelsChannelIdJoinedusersMicrosoftGraphAddPostRequestbodyContentApplicationJsonSchema
...
- [Add-MgBetaTeamworkDeletedTeamChannelJoinedUser](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/add-mgbetateamworkdeletedteamchanneljoineduser)
