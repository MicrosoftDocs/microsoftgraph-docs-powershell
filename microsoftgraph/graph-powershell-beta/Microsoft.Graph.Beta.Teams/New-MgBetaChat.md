...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetachat
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: New-MgBetaChat
---
...
```
New-MgBetaChat [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-ChatType <string>] [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <datetime>]
...
```
New-MgBetaChat -BodyParameter <IMicrosoftGraphChat> [-ResponseHeadersVariable <string>] [-Break]
