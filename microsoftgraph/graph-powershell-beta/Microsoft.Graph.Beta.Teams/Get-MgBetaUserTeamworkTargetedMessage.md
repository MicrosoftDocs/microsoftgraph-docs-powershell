...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetauserteamworktargetedmessage
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaUserTeamworkTargetedMessage
---

# Get-MgBetaUserTeamworkTargetedMessage
...
```
Get-MgBetaUserTeamworkTargetedMessage -UserId <string> [-Count] [-ExpandProperty <string[]>]
...
```
Get-MgBetaUserTeamworkTargetedMessage -InputObject <ITeamsIdentity> [-Count]
