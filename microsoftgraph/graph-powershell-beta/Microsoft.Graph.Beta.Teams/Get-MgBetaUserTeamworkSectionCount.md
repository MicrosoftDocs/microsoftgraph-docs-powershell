...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetauserteamworksectioncount
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaUserTeamworkSectionCount
---

# Get-MgBetaUserTeamworkSectionCount
...
```
Get-MgBetaUserTeamworkSectionCount -UserId <string> [-Filter <string>] [-Search <string>]
...
```
Get-MgBetaUserTeamworkSectionCount -InputObject <ITeamsIdentity> [-Filter <string>]
...
- [Get-MgBetaUserTeamworkSectionCount](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetauserteamworksectioncount)
