...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetachattargetedmessagehostedcontent
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaChatTargetedMessageHostedContent
---

# New-MgBetaChatTargetedMessageHostedContent
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgChatTargetedMessageHostedContent](/powershell/module/Microsoft.Graph.Teams/New-MgChatTargetedMessageHostedContent?view=graph-powershell-1.0)
...
```
New-MgBetaChatTargetedMessageHostedContent -ChatId <string> -TargetedChatMessageId <string>
...
```
New-MgBetaChatTargetedMessageHostedContent -InputObject <ITeamsIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-ContentBytesInputFile <string>] [-ContentType <string>] [-Id <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
...
```
New-MgBetaChatTargetedMessageHostedContent -InputObject <ITeamsIdentity> -BodyParameter <hashtable>
...
- [New-MgBetaChatTargetedMessageHostedContent](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetachattargetedmessagehostedcontent)
