...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/add-mgbetateamchanneljoineduser
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Add-MgBetaTeamChannelJoinedUser
---

# Add-MgBetaTeamChannelJoinedUser
...
```
Add-MgBetaTeamChannelJoinedUser -ChannelId <string> -TeamId <string>
...
```
Add-MgBetaTeamChannelJoinedUser -ChannelId <string> -TeamId <string>
 -BodyParameter <IPaths1Uwj229TeamsTeamIdChannelsChannelIdJoinedusersMicrosoftGraphAddPostRequestbodyContentApplicationJsonSchema>
...
```
Add-MgBetaTeamChannelJoinedUser -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
...
```
Add-MgBetaTeamChannelJoinedUser -InputObject <ITeamsIdentity>
 -BodyParameter <IPaths1Uwj229TeamsTeamIdChannelsChannelIdJoinedusersMicrosoftGraphAddPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths1Uwj229TeamsTeamIdChannelsChannelIdJoinedusersMicrosoftGraphAddPostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths1Uwj229TeamsTeamIdChannelsChannelIdJoinedusersMicrosoftGraphAddPostRequestbodyContentApplicationJsonSchema
