...
```
Invoke-MgBetaGraphGroupTeamChannelMessageReply -ChannelId <string> -ChatMessageId <string>
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPathsFmgo51GroupsGroupIdTeamChannelsChannelIdMessagesChatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
- [Invoke-MgBetaGraphGroupTeamChannelMessageReply](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphgroupteamchannelmessagereply)
