...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphgroupteamchannelmessagereply
schema: 2.0.0
ms.subservice: teams
---

# Invoke-MgBetaGraphGroupTeamChannelMessageReply
...
```
Invoke-MgBetaGraphGroupTeamChannelMessageReply -ChannelId <String> -ChatMessageId <String> -GroupId <String>
...
```
Invoke-MgBetaGraphGroupTeamChannelMessageReply -InputObject <ITeamsIdentity>
 [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>] [-MessageIds <String[]>]
 [-ReplyMessage <IMicrosoftGraphChatMessage>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```yaml
Type: IPathsFmgo51GroupsGroupIdTeamChannelsChannelIdMessagesChatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.Beta.PowerShell.Models.IPathsFmgo51GroupsGroupIdTeamChannelsChannelIdMessagesChatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphgroupteamchannelmessagereply](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphgroupteamchannelmessagereply)
