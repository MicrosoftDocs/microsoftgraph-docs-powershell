...
### DeleteViaIdentity
```
Remove-MgBetaTeamChannelMember -InputObject <ITeamsIdentity> [-IfMatch <String>] [-Headers <IDictionary>]
...
## RELATED LINKS
[Remove-MgTeamChannelMember](/powershell/module/Microsoft.Graph.Teams/Remove-MgTeamChannelMember?view=graph-powershell-1.0)
