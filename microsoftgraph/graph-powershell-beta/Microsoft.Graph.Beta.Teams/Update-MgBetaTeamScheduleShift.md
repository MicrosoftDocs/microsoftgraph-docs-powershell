...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetateamscheduleshift
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Update-MgBetaTeamScheduleShift
---
...
```
Update-MgBetaTeamScheduleShift -ShiftId <string> -TeamId <string>
 ...
 [-SharedShift <IMicrosoftGraphShiftItem>] [-TeamInfo <IMicrosoftGraphShiftsTeamInfo>]
...
```
Update-MgBetaTeamScheduleShift -ShiftId <string> -TeamId <string>
 -BodyParameter <IMicrosoftGraphShift> [-ResponseHeadersVariable <string>] [-Break]
