...
### Delete (Default)
```
Remove-MgBetaTeamChannel -ChannelId <String> -TeamId <String> [-IfMatch <String>] [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaTeamChannel -InputObject <ITeamsIdentity> [-IfMatch <String>] [-Headers <IDictionary>] [-PassThru]
