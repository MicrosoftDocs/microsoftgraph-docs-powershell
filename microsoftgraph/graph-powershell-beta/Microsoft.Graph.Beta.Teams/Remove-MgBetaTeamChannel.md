...
### Delete (Default)
```
Remove-MgBetaTeamChannel -ChannelId <String> -TeamId <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgBetaTeamChannel -InputObject <ITeamsIdentity> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
...
**Permissions**
[!INCLUDE [permissions-table](~/../graphref/api-reference/beta/includes/permissions/channel-delete-permissions.md)]
...
[https://learn.microsoft.com/graph/api/channel-delete?view=graph-rest-beta](https://learn.microsoft.com/graph/api/channel-delete?view=graph-rest-beta)
