...
Get-MgBetaUserChatMessageReplyHostedContent -ChatId <String> -ChatMessageHostedContentId <String>
 -ChatMessageId <String> -ChatMessageId1 <String> -UserId <String> [-Format <String>] -OutFile <String>
...
### GetViaIdentity1
```
Get-MgBetaUserChatMessageReplyHostedContent -InputObject <ITeamsIdentity> [-Format <String>] -OutFile <String>
 [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
