...
### Set (Default)
```
Set-MgBetaTeamPhotoContent -TeamId <String> [-Data <Stream>] -InFile <String> [-ContentType <String>]
...
### SetViaIdentity
```
Set-MgBetaTeamPhotoContent -InputObject <ITeamsIdentity> [-Data <Stream>] -InFile <String>
