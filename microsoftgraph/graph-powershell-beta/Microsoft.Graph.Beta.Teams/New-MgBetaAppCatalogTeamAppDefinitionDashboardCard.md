...
```
New-MgBetaAppCatalogTeamAppDefinitionDashboardCard -TeamsAppDefinitionId <string>
...
```
New-MgBetaAppCatalogTeamAppDefinitionDashboardCard -TeamsAppDefinitionId <string>
 -TeamsAppId <string> -BodyParameter <IMicrosoftGraphTeamsAppDashboardCardDefinition>
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphTeamsAppDashboardCardContentSource
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphTeamsAppDashboardCardIcon
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
