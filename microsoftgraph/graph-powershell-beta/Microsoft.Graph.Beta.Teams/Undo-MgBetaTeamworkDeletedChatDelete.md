...
### Undo (Default)
```
Undo-MgBetaTeamworkDeletedChatDelete -DeletedChatId <String> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UndoViaIdentity
```
Undo-MgBetaTeamworkDeletedChatDelete -InputObject <ITeamsIdentity> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
