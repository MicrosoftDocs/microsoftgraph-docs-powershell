...
# New-MgBetaUserTeamworkSectionItem

## SYNOPSIS

Add an item, such as a chat, channel, meeting, or community, to a user-defined section in a user's teamwork.
Each item can belong to only one section at a time.
...
```
New-MgBetaUserTeamworkSectionItem -TeamworkSectionId <string> -UserId <string>
...
```
New-MgBetaUserTeamworkSectionItem -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-CreatedDateTime <datetime>] [-Id <string>]
 [-ItemType <string>] [-LastModifiedDateTime <datetime>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
```
New-MgBetaUserTeamworkSectionItem -InputObject <ITeamsIdentity>
 -BodyParameter <IMicrosoftGraphTeamworkSectionItem> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
