...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetateamprimarychanneljoineduser
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaTeamPrimaryChannelJoinedUser
---

# Get-MgBetaTeamPrimaryChannelJoinedUser
...
```
Get-MgBetaTeamPrimaryChannelJoinedUser -TeamId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaTeamPrimaryChannelJoinedUser -ConversationMemberId <string> -TeamId <string>
...
```
Get-MgBetaTeamPrimaryChannelJoinedUser -InputObject <ITeamsIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgBetaTeamPrimaryChannelJoinedUser](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetateamprimarychanneljoineduser)
