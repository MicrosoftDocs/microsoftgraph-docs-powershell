...
### Get (Default)
```
Get-MgBetaTeamworkDeletedTeamChannelRetainedMessage -DeletedTeamId <String> [-Count] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgBetaTeamworkDeletedTeamChannelRetainedMessage -InputObject <ITeamsIdentity> [-Count] [-Filter <String>]
 [-Property <String[]>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>] [-Top <Int32>]
 [<CommonParameters>]
```
