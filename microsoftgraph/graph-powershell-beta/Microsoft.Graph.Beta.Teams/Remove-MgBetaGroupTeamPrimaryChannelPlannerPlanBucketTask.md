...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/remove-mgbetagroupteamprimarychannelplannerplanbuckettask
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaGroupTeamPrimaryChannelPlannerPlanBucketTask -GroupId <String> -PlannerBucketId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaGroupTeamPrimaryChannelPlannerPlanBucketTask -InputObject <ITeamsIdentity> [-IfMatch <String>]
