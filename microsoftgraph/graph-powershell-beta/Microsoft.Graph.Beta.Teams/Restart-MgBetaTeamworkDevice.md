...
```
Restart-MgBetaTeamworkDevice -TeamworkDeviceId <string> [-ResponseHeadersVariable <string>] [-Break]
...
```
Restart-MgBetaTeamworkDevice -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
