...
# Add-MgBetaTeamPrimaryChannelJoinedUser
...
```
Add-MgBetaTeamPrimaryChannelJoinedUser -TeamId <string> [-ResponseHeadersVariable <string>]
...
```
Add-MgBetaTeamPrimaryChannelJoinedUser -TeamId <string>
...
```
Add-MgBetaTeamPrimaryChannelJoinedUser -InputObject <ITeamsIdentity>
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths1J48LdtTeamsTeamIdPrimarychannelJoinedusersMicrosoftGraphAddPostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths1J48LdtTeamsTeamIdPrimarychannelJoinedusersMicrosoftGraphAddPostRequestbodyContentApplicationJsonSchema
