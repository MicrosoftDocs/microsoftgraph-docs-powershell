...
```
Get-MgBetaChatOperation -ChatId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaChatOperation -ChatId <string> -TeamsAsyncOperationId <string>
...
```
Get-MgBetaChatOperation -InputObject <ITeamsIdentity> [-ExpandProperty <string[]>]
...
| Application | Chat.Manage.Chat, Chat.Read.All, Chat.ReadBasic.All, Chat.ReadWrite.All, ChatSettings.Read.Chat, ChatSettings.ReadWrite.Chat,  |
