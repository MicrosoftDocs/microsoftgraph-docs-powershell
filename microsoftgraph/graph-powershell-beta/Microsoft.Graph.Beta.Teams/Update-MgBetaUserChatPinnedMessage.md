...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetauserchatpinnedmessage
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Update-MgBetaUserChatPinnedMessage
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgUserChatPinnedMessage](/powershell/module/Microsoft.Graph.Teams/Update-MgUserChatPinnedMessage?view=graph-powershell-1.0)
...
```
Update-MgBetaUserChatPinnedMessage -ChatId <string> -PinnedChatMessageInfoId <string>
 -UserId <string> [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-Id <string>] [-Message <IMicrosoftGraphChatMessage>] [-Break] [-Headers <IDictionary>]
...
```
Update-MgBetaUserChatPinnedMessage -ChatId <string> -PinnedChatMessageInfoId <string>
 -UserId <string> -BodyParameter <IMicrosoftGraphPinnedChatMessageInfo>
...
```
Update-MgBetaUserChatPinnedMessage -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
