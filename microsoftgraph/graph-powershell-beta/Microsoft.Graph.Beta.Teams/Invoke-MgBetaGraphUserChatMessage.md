...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphuserchatmessage
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Invoke-MgBetaGraphUserChatMessage
---

# Invoke-MgBetaGraphUserChatMessage
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Invoke-MgGraphUserChatMessage](/powershell/module/Microsoft.Graph.Teams/Invoke-MgGraphUserChatMessage?view=graph-powershell-1.0)
...
```
Invoke-MgBetaGraphUserChatMessage -ChatId <string> -UserId <string>
...
```
Invoke-MgBetaGraphUserChatMessage -ChatId <string> -UserId <string>
 -Body <IPathsDfn6EyUsersUserIdChatsChatIdMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema>
...
```
Invoke-MgBetaGraphUserChatMessage -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
...
```
Invoke-MgBetaGraphUserChatMessage -InputObject <ITeamsIdentity>
 -BodyParameter <IPathsDfn6EyUsersUserIdChatsChatIdMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPathsDfn6EyUsersUserIdChatsChatIdMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IPathsDfn6EyUsersUserIdChatsChatIdMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
...
- [Invoke-MgBetaGraphUserChatMessage](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphuserchatmessage)
