...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphuserchatmessage
schema: 2.0.0
ms.subservice: teams
---
...
```
Invoke-MgBetaGraphUserChatMessage -ChatId <String> -UserId <String> [-ResponseHeadersVariable <String>]
...
```yaml
Type: IPathsDfn6EyUsersUserIdChatsChatIdMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphuserchatmessage](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphuserchatmessage)
