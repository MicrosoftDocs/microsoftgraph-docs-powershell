...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgChatOperation](/powershell/module/Microsoft.Graph.Teams/New-MgChatOperation?view=graph-powershell-v1.0)
...
### Create
```
New-MgBetaChatOperation -ChatId <String> -BodyParameter <IMicrosoftGraphTeamsAsyncOperation> [-WhatIf]
...
## RELATED LINKS
[New-MgChatOperation](/powershell/module/Microsoft.Graph.Teams/New-MgChatOperation?view=graph-powershell-v1.0)
