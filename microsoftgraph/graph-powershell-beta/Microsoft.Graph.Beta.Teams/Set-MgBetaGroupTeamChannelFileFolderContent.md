...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/set-mgbetagroupteamchannelfilefoldercontent
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Set-MgBetaGroupTeamChannelFileFolderContent
---
...
```
Set-MgBetaGroupTeamChannelFileFolderContent -ChannelId <string> -GroupId <string> -InFile <string>
...
```
Set-MgBetaGroupTeamChannelFileFolderContent -InputObject <ITeamsIdentity> -InFile <string>
 [-Data <Stream>] [-ResponseHeadersVariable <string>] [-Break] [-ContentType <string>]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [Set-MgBetaGroupTeamChannelFileFolderContent](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/set-mgbetagroupteamchannelfilefoldercontent)
