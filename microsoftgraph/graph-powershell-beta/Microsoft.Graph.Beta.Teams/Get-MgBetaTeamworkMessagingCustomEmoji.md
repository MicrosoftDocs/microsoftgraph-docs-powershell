...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetateamworkmessagingcustomemoji
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaTeamworkMessagingCustomEmoji
---
...
```
Get-MgBetaTeamworkMessagingCustomEmoji [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaTeamworkMessagingCustomEmoji -TeamworkCustomEmojiDisplayName <string>
...
```
Get-MgBetaTeamworkMessagingCustomEmoji -InputObject <ITeamsIdentity> [-ExpandProperty <string[]>]
