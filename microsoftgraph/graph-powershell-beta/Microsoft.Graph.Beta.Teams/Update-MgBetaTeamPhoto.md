...
```
Update-MgBetaTeamPhoto -TeamId <String> [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>]
...
```
Update-MgBetaTeamPhoto -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
...
## RELATED LINKS
[Update-MgTeamPhoto](/powershell/module/Microsoft.Graph.Teams/Update-MgTeamPhoto?view=graph-powershell-1.0)
