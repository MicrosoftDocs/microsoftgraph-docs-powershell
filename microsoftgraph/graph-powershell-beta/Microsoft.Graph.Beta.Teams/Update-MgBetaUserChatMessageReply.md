...
```
Update-MgBetaUserChatMessageReply -ChatId <String> -ChatMessageId <String> -ChatMessageId1 <String>
 -UserId <String> -BodyParameter <IMicrosoftGraphChatMessage> [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgUserChatMessageReply](/powershell/module/Microsoft.Graph.Teams/Update-MgUserChatMessageReply?view=graph-powershell-1.0)
