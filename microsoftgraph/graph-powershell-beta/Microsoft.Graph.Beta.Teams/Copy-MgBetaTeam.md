...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/copy-mgbetateam
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Copy-MgBetaTeam
---
...
```
Copy-MgBetaTeam -TeamId <string> [-ResponseHeadersVariable <string>]
...
```
Copy-MgBetaTeam -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Classification <string>] [-Description <string>]
 [-DisplayName <string>] [-MailNickname <string>] [-PartsToClone <string>] [-Visibility <string>]
 [-Break] [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru] [-Proxy <uri>]
...
- [Copy-MgBetaTeam](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/copy-mgbetateam)
