...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetagroupteamchannelplannerplantaskassignedtotaskboardformat
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaGroupTeamChannelPlannerPlanTaskAssignedToTaskBoardFormat
---

# Update-MgBetaGroupTeamChannelPlannerPlanTaskAssignedToTaskBoardFormat
...
```
Update-MgBetaGroupTeamChannelPlannerPlanTaskAssignedToTaskBoardFormat -ChannelId <string>
...
```
Update-MgBetaGroupTeamChannelPlannerPlanTaskAssignedToTaskBoardFormat -InputObject <ITeamsIdentity>
 -IfMatch <string> [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-Id <string>] [-OrderHintsByAssignee <hashtable>] [-UnassignedOrderHint <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
- [Update-MgBetaGroupTeamChannelPlannerPlanTaskAssignedToTaskBoardFormat](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetagroupteamchannelplannerplantaskassignedtotaskboardformat)
