...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetagroupteamchannelplannerplantaskassignedtotaskboardformat
schema: 2.0.0
---
...
```
Update-MgBetaGroupTeamChannelPlannerPlanTaskAssignedToTaskBoardFormat -ChannelId <String> -GroupId <String>
