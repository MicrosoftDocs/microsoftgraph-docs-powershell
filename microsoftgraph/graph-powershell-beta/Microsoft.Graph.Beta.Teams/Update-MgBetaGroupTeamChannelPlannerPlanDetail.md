...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetagroupteamchannelplannerplandetail
schema: 2.0.0
---

# Update-MgBetaGroupTeamChannelPlannerPlanDetail
...
```
Update-MgBetaGroupTeamChannelPlannerPlanDetail -ChannelId <String> -GroupId <String> -PlannerPlanId <String>
...
```
Update-MgBetaGroupTeamChannelPlannerPlanDetail -InputObject <ITeamsIdentity> -IfMatch <String>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetagroupteamchannelplannerplandetail](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetagroupteamchannelplannerplandetail)
