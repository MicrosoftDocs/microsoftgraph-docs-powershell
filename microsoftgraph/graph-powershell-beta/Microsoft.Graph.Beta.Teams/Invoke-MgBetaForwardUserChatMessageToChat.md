...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetaforwarduserchatmessagetochat
schema: 2.0.0
ms.subservice: teams
---

# Invoke-MgBetaForwardUserChatMessageToChat
...
```
Invoke-MgBetaForwardUserChatMessageToChat -ChatId <String> -UserId <String> [-ResponseHeadersVariable <String>]
...
### Forward
```
Invoke-MgBetaForwardUserChatMessageToChat -ChatId <String> -UserId <String>
 -BodyParameter <IPathsSy1Dy4UsersUserIdChatsChatIdMessagesMicrosoftGraphForwardtochatPostRequestbodyContentApplicationJsonSchema>
...
```
Invoke-MgBetaForwardUserChatMessageToChat -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalMessage <IMicrosoftGraphChatMessage>] [-AdditionalProperties <Hashtable>] [-MessageIds <String[]>]
 [-TargetChatIds <String[]>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### ForwardViaIdentity
```
Invoke-MgBetaForwardUserChatMessageToChat -InputObject <ITeamsIdentity>
 -BodyParameter <IPathsSy1Dy4UsersUserIdChatsChatIdMessagesMicrosoftGraphForwardtochatPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
```yaml
Type: IPathsSy1Dy4UsersUserIdChatsChatIdMessagesMicrosoftGraphForwardtochatPostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.Beta.PowerShell.Models.IPathsSy1Dy4UsersUserIdChatsChatIdMessagesMicrosoftGraphForwardtochatPostRequestbodyContentApplicationJsonSchema
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetaforwarduserchatmessagetochat](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetaforwarduserchatmessagetochat)
