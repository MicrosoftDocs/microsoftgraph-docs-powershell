...
```
New-MgBetaChatMessageHostedContent -ChatId <String> -ChatMessageId <String> [-ResponseHeadersVariable <String>]
...
```
New-MgBetaChatMessageHostedContent -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-ContentBytesInputFile <String>] [-ContentType <String>] [-Id <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```
This example shows how to use the New-MgBetaBetaChatMessageHostedContent Cmdlet.
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetachatmessagehostedcontent](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetachatmessagehostedcontent)
