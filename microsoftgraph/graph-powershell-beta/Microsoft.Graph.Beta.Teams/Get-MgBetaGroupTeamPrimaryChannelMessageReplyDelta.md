...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetagroupteamprimarychannelmessagereplydelta
schema: 2.0.0
ms.subservice: teams
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgGroupTeamPrimaryChannelMessageReplyDelta](/powershell/module/Microsoft.Graph.Teams/Get-MgGroupTeamPrimaryChannelMessageReplyDelta?view=graph-powershell-1.0)

## SYNTAX

### Delta (Default)
```
Get-MgBetaGroupTeamPrimaryChannelMessageReplyDelta -ChatMessageId <String> -GroupId <String>
...
### DeltaViaIdentity
```
Get-MgBetaGroupTeamPrimaryChannelMessageReplyDelta -InputObject <ITeamsIdentity> [-ExpandProperty <String[]>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetagroupteamprimarychannelmessagereplydelta](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetagroupteamprimarychannelmessagereplydelta)
