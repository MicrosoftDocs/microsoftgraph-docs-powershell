...
### Set (Default)
```
Set-MgBetaTeamPrimaryChannelFileFolderContent -TeamId <String> [-Data <Stream>]
...
### SetViaIdentity
```
Set-MgBetaTeamPrimaryChannelFileFolderContent -InputObject <ITeamsIdentity> [-Data <Stream>]
 [-ResponseHeadersVariable <String>] -InFile <String> [-ContentType <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
