...
```
Get-MgBetaChatCount [-Filter <String>] [-Search <String>] [-Headers <IDictionary>]
...
## RELATED LINKS
[Get-MgChatCount](/powershell/module/Microsoft.Graph.Teams/Get-MgChatCount?view=graph-powershell-1.0)
