...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetauserchattargetedmessagehostedcontent
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaUserChatTargetedMessageHostedContent
---

# Update-MgBetaUserChatTargetedMessageHostedContent
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgUserChatTargetedMessageHostedContent](/powershell/module/Microsoft.Graph.Teams/Update-MgUserChatTargetedMessageHostedContent?view=graph-powershell-1.0)
...
```
Update-MgBetaUserChatTargetedMessageHostedContent -ChatId <string>
 -ChatMessageHostedContentId <string> -TargetedChatMessageId <string> -UserId <string>
...
```
Update-MgBetaUserChatTargetedMessageHostedContent -InputObject <ITeamsIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-ContentBytesInputFile <string>] [-ContentType <string>] [-Id <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
...
- [Update-MgBetaUserChatTargetedMessageHostedContent](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetauserchattargetedmessagehostedcontent)
