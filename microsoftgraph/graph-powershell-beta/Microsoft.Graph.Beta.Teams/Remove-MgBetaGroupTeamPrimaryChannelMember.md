...
```
Remove-MgBetaGroupTeamPrimaryChannelMember -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-Values <IMicrosoftGraphConversationMember[]>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```yaml
Type: IPaths1U0Ye8TGroupsGroupIdTeamPrimarychannelMembersMicrosoftGraphRemovePostRequestbodyContentApplicationJsonSchema
