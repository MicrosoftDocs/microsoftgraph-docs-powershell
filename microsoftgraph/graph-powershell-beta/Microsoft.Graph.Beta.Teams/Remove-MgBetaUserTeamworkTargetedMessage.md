...
# Remove-MgBetaUserTeamworkTargetedMessage
...
```
Remove-MgBetaUserTeamworkTargetedMessage -UserId <string> [-ResponseHeadersVariable <string>]
...
```
Remove-MgBetaUserTeamworkTargetedMessage -UserId <string>
...
```
Remove-MgBetaUserTeamworkTargetedMessage -InputObject <ITeamsIdentity>
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPathsHp1YlpUsersUserIdTeamworkMicrosoftGraphDeletetargetedmessagePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IPathsHp1YlpUsersUserIdTeamworkMicrosoftGraphDeletetargetedmessagePostRequestbodyContentApplicationJsonSchema
