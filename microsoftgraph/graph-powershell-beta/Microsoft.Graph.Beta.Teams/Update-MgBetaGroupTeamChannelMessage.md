...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetagroupteamchannelmessage
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaGroupTeamChannelMessage
---
...
```
Update-MgBetaGroupTeamChannelMessage -InputObject <ITeamsIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-Attachments <IMicrosoftGraphChatMessageAttachment[]>] [-Body <IMicrosoftGraphItemBody>]
 [-ChannelIdentity <IMicrosoftGraphChannelIdentity>] [-ChatId <string>]
 [-CreatedDateTime <datetime>] [-DeletedDateTime <datetime>] [-Etag <string>]
...
- [Update-MgBetaGroupTeamChannelMessage](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetagroupteamchannelmessage)
