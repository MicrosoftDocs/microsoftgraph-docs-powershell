...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetateamprimarychannelplannerplanbuckettaskmessage
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaTeamPrimaryChannelPlannerPlanBucketTaskMessage
---

# Update-MgBetaTeamPrimaryChannelPlannerPlanBucketTaskMessage
...
```
Update-MgBetaTeamPrimaryChannelPlannerPlanBucketTaskMessage -PlannerBucketId <string>
...
```
Update-MgBetaTeamPrimaryChannelPlannerPlanBucketTaskMessage -InputObject <ITeamsIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-Content <string>]
 [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <datetime>]
 [-DeletedDateTime <datetime>] [-EditedDateTime <datetime>] [-Id <string>]
 [-Mentions <IMicrosoftGraphPlannerTaskChatMention[]>] [-MessageType <string>]
...
- [Update-MgBetaTeamPrimaryChannelPlannerPlanBucketTaskMessage](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetateamprimarychannelplannerplanbuckettaskmessage)
