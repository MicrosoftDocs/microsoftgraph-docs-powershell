...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetateamworkdeletedteamchannelplannerplantaskmessage
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaTeamworkDeletedTeamChannelPlannerPlanTaskMessage
---

# New-MgBetaTeamworkDeletedTeamChannelPlannerPlanTaskMessage
...
```
New-MgBetaTeamworkDeletedTeamChannelPlannerPlanTaskMessage -ChannelId <string>
...
```
New-MgBetaTeamworkDeletedTeamChannelPlannerPlanTaskMessage -InputObject <ITeamsIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-Content <string>]
 [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <datetime>]
 [-DeletedDateTime <datetime>] [-EditedDateTime <datetime>] [-Id <string>]
 [-Mentions <IMicrosoftGraphPlannerTaskChatMention[]>] [-MessageType <string>]
...
- [New-MgBetaTeamworkDeletedTeamChannelPlannerPlanTaskMessage](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetateamworkdeletedteamchannelplannerplantaskmessage)
