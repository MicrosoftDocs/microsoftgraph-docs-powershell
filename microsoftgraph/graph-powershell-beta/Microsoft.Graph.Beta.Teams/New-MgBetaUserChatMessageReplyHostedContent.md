...
```
New-MgBetaUserChatMessageReplyHostedContent -ChatId <string> -ChatMessageId <string>
 -ChatMessageId1 <string> -UserId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaUserChatMessageReplyHostedContent -ChatId <string> -ChatMessageId <string>
 -ChatMessageId1 <string> -UserId <string> -BodyParameter <hashtable>
...
```
New-MgBetaUserChatMessageReplyHostedContent -InputObject <ITeamsIdentity>
