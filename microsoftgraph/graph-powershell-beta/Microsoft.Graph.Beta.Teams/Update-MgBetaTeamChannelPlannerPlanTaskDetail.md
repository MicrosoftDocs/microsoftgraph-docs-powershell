...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetateamchannelplannerplantaskdetail
schema: 2.0.0
---
...
```
Update-MgBetaTeamChannelPlannerPlanTaskDetail -ChannelId <String> -PlannerPlanId <String>
 -PlannerTaskId <String> -TeamId <String> -IfMatch <String> -BodyParameter <IMicrosoftGraphPlannerTaskDetails>
