...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/remove-mgbetagroupteamchannelmember
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: Remove-MgBetaGroupTeamChannelMember
---
...
```
Remove-MgBetaGroupTeamChannelMember -ChannelId <string> -GroupId <string>
...
```
Remove-MgBetaGroupTeamChannelMember -ChannelId <string> -ConversationMemberId <string>
...
```
Remove-MgBetaGroupTeamChannelMember -InputObject <ITeamsIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-Values <IMicrosoftGraphConversationMember[]>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```
Remove-MgBetaGroupTeamChannelMember -InputObject <ITeamsIdentity> [-IfMatch <string>]
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPathsEfbccgGroupsGroupIdTeamChannelsChannelIdMembersMicrosoftGraphRemovePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IPathsEfbccgGroupsGroupIdTeamChannelsChannelIdMembersMicrosoftGraphRemovePostRequestbodyContentApplicationJsonSchema
...
- [Remove-MgBetaGroupTeamChannelMember](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/remove-mgbetagroupteamchannelmember)
