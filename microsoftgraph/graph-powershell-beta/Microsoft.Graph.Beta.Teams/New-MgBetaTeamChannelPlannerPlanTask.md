...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetateamchannelplannerplantask
schema: 2.0.0
---

# New-MgBetaTeamChannelPlannerPlanTask
...
```
New-MgBetaTeamChannelPlannerPlanTask -ChannelId <String> -PlannerPlanId <String> -TeamId <String>
...
```
New-MgBetaTeamChannelPlannerPlanTask -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
...
### CreateViaIdentity
```
New-MgBetaTeamChannelPlannerPlanTask -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphPlannerTask>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetateamchannelplannerplantask](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetateamchannelplannerplantask)
