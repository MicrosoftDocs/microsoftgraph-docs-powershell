...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetateamworkdeletedteamchannelmessage
schema: 2.0.0
---
...
```
New-MgBetaTeamworkDeletedTeamChannelMessage -ChannelId <String> -DeletedTeamId <String>
...
```
New-MgBetaTeamworkDeletedTeamChannelMessage -InputObject <ITeamsIdentity> [-AdditionalProperties <Hashtable>]
...
### CreateViaIdentity
```
New-MgBetaTeamworkDeletedTeamChannelMessage -InputObject <ITeamsIdentity>
 -BodyParameter <IMicrosoftGraphChatMessage> [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
## RELATED LINKS
[New-MgTeamworkDeletedTeamChannelMessage](/powershell/module/Microsoft.Graph.Teams/New-MgTeamworkDeletedTeamChannelMessage?view=graph-powershell-1.0)

[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetateamworkdeletedteamchannelmessage](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetateamworkdeletedteamchannelmessage)
