...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetaforwardgroupteamchannelmessagereplytochat
schema: 2.0.0
ms.subservice: teams
---

# Invoke-MgBetaForwardGroupTeamChannelMessageReplyToChat
...
```
Invoke-MgBetaForwardGroupTeamChannelMessageReplyToChat -ChannelId <String> -ChatMessageId <String>
 -GroupId <String> [-ResponseHeadersVariable <String>] [-AdditionalMessage <IMicrosoftGraphChatMessage>]
...
Invoke-MgBetaForwardGroupTeamChannelMessageReplyToChat -ChannelId <String> -ChatMessageId <String>
 -GroupId <String>
 -BodyParameter <IPaths4Z8AniGroupsGroupIdTeamChannelsChannelIdMessagesChatmessageIdRepliesMicrosoftGraphForwardtochatPostRequestbodyContentApplicationJsonSchema>
...
```
Invoke-MgBetaForwardGroupTeamChannelMessageReplyToChat -InputObject <ITeamsIdentity>
...
```yaml
Type: IPaths4Z8AniGroupsGroupIdTeamChannelsChannelIdMessagesChatmessageIdRepliesMicrosoftGraphForwardtochatPostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths4Z8AniGroupsGroupIdTeamChannelsChannelIdMessagesChatmessageIdRepliesMicrosoftGraphForwardtochatPostRequestbodyContentApplicationJsonSchema
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetaforwardgroupteamchannelmessagereplytochat](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetaforwardgroupteamchannelmessagereplytochat)
