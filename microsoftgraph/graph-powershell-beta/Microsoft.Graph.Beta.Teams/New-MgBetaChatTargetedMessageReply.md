...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetachattargetedmessagereply
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaChatTargetedMessageReply
---

# New-MgBetaChatTargetedMessageReply
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgChatTargetedMessageReply](/powershell/module/Microsoft.Graph.Teams/New-MgChatTargetedMessageReply?view=graph-powershell-1.0)
...
```
New-MgBetaChatTargetedMessageReply -ChatId <string> -TargetedChatMessageId <string>
...
```
New-MgBetaChatTargetedMessageReply -InputObject <ITeamsIdentity> [-ChatId <string>]
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-Attachments <IMicrosoftGraphChatMessageAttachment[]>] [-Body <IMicrosoftGraphChatMessageBody>]
...
```
New-MgBetaChatTargetedMessageReply -InputObject <ITeamsIdentity>
 -BodyParameter <IMicrosoftGraphChatMessage> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgBetaChatTargetedMessageReply](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetachattargetedmessagereply)
