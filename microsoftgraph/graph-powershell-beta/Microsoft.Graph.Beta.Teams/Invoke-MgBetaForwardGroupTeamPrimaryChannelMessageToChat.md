...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetaforwardgroupteamprimarychannelmessagetochat
schema: 2.0.0
ms.subservice: teams
---

# Invoke-MgBetaForwardGroupTeamPrimaryChannelMessageToChat
...
```
Invoke-MgBetaForwardGroupTeamPrimaryChannelMessageToChat -GroupId <String> [-ResponseHeadersVariable <String>]
...
### Forward
```
Invoke-MgBetaForwardGroupTeamPrimaryChannelMessageToChat -GroupId <String>
 -BodyParameter <IPaths1Hhm58BGroupsGroupIdTeamPrimarychannelMessagesMicrosoftGraphForwardtochatPostRequestbodyContentApplicationJsonSchema>
...
```
Invoke-MgBetaForwardGroupTeamPrimaryChannelMessageToChat -InputObject <ITeamsIdentity>
...
```yaml
Type: IPaths1Hhm58BGroupsGroupIdTeamPrimarychannelMessagesMicrosoftGraphForwardtochatPostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths1Hhm58BGroupsGroupIdTeamPrimarychannelMessagesMicrosoftGraphForwardtochatPostRequestbodyContentApplicationJsonSchema
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetaforwardgroupteamprimarychannelmessagetochat](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetaforwardgroupteamprimarychannelmessagetochat)
