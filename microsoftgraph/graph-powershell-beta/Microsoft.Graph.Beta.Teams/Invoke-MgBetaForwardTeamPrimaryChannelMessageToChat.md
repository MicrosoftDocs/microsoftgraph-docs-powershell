...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetaforwardteamprimarychannelmessagetochat
schema: 2.0.0
ms.subservice: teams
---

# Invoke-MgBetaForwardTeamPrimaryChannelMessageToChat
...
```
Invoke-MgBetaForwardTeamPrimaryChannelMessageToChat -TeamId <String> [-ResponseHeadersVariable <String>]
...
### Forward
```
Invoke-MgBetaForwardTeamPrimaryChannelMessageToChat -TeamId <String>
 -BodyParameter <IPaths1Yk1X7BTeamsTeamIdPrimarychannelMessagesMicrosoftGraphForwardtochatPostRequestbodyContentApplicationJsonSchema>
...
```
Invoke-MgBetaForwardTeamPrimaryChannelMessageToChat -InputObject <ITeamsIdentity>
...
```yaml
Type: IPaths1Yk1X7BTeamsTeamIdPrimarychannelMessagesMicrosoftGraphForwardtochatPostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths1Yk1X7BTeamsTeamIdPrimarychannelMessagesMicrosoftGraphForwardtochatPostRequestbodyContentApplicationJsonSchema
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetaforwardteamprimarychannelmessagetochat](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetaforwardteamprimarychannelmessagetochat)
