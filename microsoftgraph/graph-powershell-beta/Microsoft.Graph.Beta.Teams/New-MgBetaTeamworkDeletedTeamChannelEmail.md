...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetateamworkdeletedteamchannelemail
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaTeamworkDeletedTeamChannelEmail
---
...
```
New-MgBetaTeamworkDeletedTeamChannelEmail -InputObject <ITeamsIdentity>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
- [New-MgBetaTeamworkDeletedTeamChannelEmail](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetateamworkdeletedteamchannelemail)
