...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetateamchannelplannerplantaskbuckettaskboardformat
schema: 2.0.0
---
...
```
Update-MgBetaTeamChannelPlannerPlanTaskBucketTaskBoardFormat -ChannelId <String> -PlannerPlanId <String>
...
```
Update-MgBetaTeamChannelPlannerPlanTaskBucketTaskBoardFormat -InputObject <ITeamsIdentity> -IfMatch <String>
