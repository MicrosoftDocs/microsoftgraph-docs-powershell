...
# Start-MgBetaGroupTeamPrimaryChannelMigration
...
```
Start-MgBetaGroupTeamPrimaryChannelMigration -GroupId <string> [-ResponseHeadersVariable <string>]
...
```
Start-MgBetaGroupTeamPrimaryChannelMigration -GroupId <string>
...
```
Start-MgBetaGroupTeamPrimaryChannelMigration -InputObject <ITeamsIdentity>
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths10301BtGroupsGroupIdTeamPrimarychannelMicrosoftGraphStartmigrationPostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths10301BtGroupsGroupIdTeamPrimarychannelMicrosoftGraphStartmigrationPostRequestbodyContentApplicationJsonSchema
