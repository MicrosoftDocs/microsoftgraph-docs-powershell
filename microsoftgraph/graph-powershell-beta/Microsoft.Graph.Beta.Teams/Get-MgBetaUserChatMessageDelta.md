...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetauserchatmessagedelta
schema: 2.0.0
ms.subservice: teams
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgUserChatMessageDelta](/powershell/module/Microsoft.Graph.Teams/Get-MgUserChatMessageDelta?view=graph-powershell-1.0)
...
### DeltaViaIdentity
```
Get-MgBetaUserChatMessageDelta -InputObject <ITeamsIdentity> [-ExpandProperty <String[]>] [-Filter <String>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetauserchatmessagedelta](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetauserchatmessagedelta)
