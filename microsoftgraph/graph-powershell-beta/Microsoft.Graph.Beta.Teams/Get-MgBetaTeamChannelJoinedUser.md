...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetateamchanneljoineduser
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaTeamChannelJoinedUser
---

# Get-MgBetaTeamChannelJoinedUser
...
```
Get-MgBetaTeamChannelJoinedUser -ChannelId <string> -TeamId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaTeamChannelJoinedUser -ChannelId <string> -ConversationMemberId <string> -TeamId <string>
...
```
Get-MgBetaTeamChannelJoinedUser -InputObject <ITeamsIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgBetaTeamChannelJoinedUser](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetateamchanneljoineduser)
