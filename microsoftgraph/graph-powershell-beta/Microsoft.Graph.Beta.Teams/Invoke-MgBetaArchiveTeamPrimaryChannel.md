...
```
Invoke-MgBetaArchiveTeamPrimaryChannel -TeamId <String> [-AdditionalProperties <Hashtable>]
...
```
Invoke-MgBetaArchiveTeamPrimaryChannel -InputObject <ITeamsIdentity> [-AdditionalProperties <Hashtable>]
 [-ShouldSetSpoSiteReadOnlyForMembers] [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
