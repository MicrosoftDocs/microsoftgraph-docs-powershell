...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetateamchannelplannerplantask
schema: 2.0.0
---

# Update-MgBetaTeamChannelPlannerPlanTask
...
```
Update-MgBetaTeamChannelPlannerPlanTask -ChannelId <String> -PlannerPlanId <String> -PlannerTaskId <String>
 -TeamId <String> [-ResponseHeadersVariable <String>] [-ActiveChecklistItemCount <Int32>]
...
```
Update-MgBetaTeamChannelPlannerPlanTask -ChannelId <String> -PlannerPlanId <String> -PlannerTaskId <String>
 -TeamId <String> -BodyParameter <IMicrosoftGraphPlannerTask> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgBetaTeamChannelPlannerPlanTask -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
...
### UpdateViaIdentity
```
Update-MgBetaTeamChannelPlannerPlanTask -InputObject <ITeamsIdentity>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetateamchannelplannerplantask](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetateamchannelplannerplantask)
