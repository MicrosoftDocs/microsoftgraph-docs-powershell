...
```
Update-MgBetaChatMessage -ChatId <String> -ChatMessageId <String> [-ResponseHeadersVariable <String>]
...
```
Update-MgBetaChatMessage [-ChatId <String>] -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-Attachments <IMicrosoftGraphChatMessageAttachment[]>]
