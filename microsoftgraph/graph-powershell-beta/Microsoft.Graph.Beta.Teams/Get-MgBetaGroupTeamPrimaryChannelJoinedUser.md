...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetagroupteamprimarychanneljoineduser
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaGroupTeamPrimaryChannelJoinedUser
---

# Get-MgBetaGroupTeamPrimaryChannelJoinedUser
...
```
Get-MgBetaGroupTeamPrimaryChannelJoinedUser -GroupId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaGroupTeamPrimaryChannelJoinedUser -ConversationMemberId <string> -GroupId <string>
...
```
Get-MgBetaGroupTeamPrimaryChannelJoinedUser -InputObject <ITeamsIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
...
- [Get-MgBetaGroupTeamPrimaryChannelJoinedUser](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetagroupteamprimarychanneljoineduser)
