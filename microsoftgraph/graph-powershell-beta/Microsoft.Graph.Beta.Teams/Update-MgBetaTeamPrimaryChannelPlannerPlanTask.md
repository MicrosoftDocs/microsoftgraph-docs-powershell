...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetateamprimarychannelplannerplantask
schema: 2.0.0
---
...
```
Update-MgBetaTeamPrimaryChannelPlannerPlanTask -PlannerPlanId <String> -PlannerTaskId <String> -TeamId <String>
