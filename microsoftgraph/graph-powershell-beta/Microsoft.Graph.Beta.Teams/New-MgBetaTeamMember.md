...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgTeamMember](/powershell/module/Microsoft.Graph.Teams/New-MgTeamMember?view=graph-powershell-v1.0)
...
### Create
```
New-MgBetaTeamMember -TeamId <String> -BodyParameter <IMicrosoftGraphConversationMember> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### CreateViaIdentity
```
New-MgBetaTeamMember -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphConversationMember> [-WhatIf]
...
## RELATED LINKS
[New-MgTeamMember](/powershell/module/Microsoft.Graph.Teams/New-MgTeamMember?view=graph-powershell-v1.0)
