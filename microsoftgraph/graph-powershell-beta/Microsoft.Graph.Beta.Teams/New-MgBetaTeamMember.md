...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetateammember
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 06/17/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaTeamMember
---
...
```
New-MgBetaTeamMember -TeamId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaTeamMember -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-DisplayName <string>] [-Id <string>] [-Roles <string[]>]
 [-VisibleHistoryStartDateTime <datetime>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```
New-MgBetaTeamMember -InputObject <ITeamsIdentity>
...
| --------------- | ------------------------------------------  |
| Delegated (work or school account) | TeamMember.ReadWrite.All, TeamMember.ReadWriteNonOwnerRole.All,  |
| Delegated (personal Microsoft account) | Not supported |
| Application | TeamMember.ReadWrite.All, TeamMember.ReadWriteNonOwnerRole.All,  |
...
- [New-MgBetaTeamMember](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetateammember)
- [Graph API Reference](https://learn.microsoft.com/graph/api/team-post-members?view=graph-rest-beta)
