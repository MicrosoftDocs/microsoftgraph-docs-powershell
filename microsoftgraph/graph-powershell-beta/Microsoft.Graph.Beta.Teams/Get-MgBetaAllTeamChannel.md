...
### List (Default)
```
Get-MgBetaAllTeamChannel -TeamId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
[https://learn.microsoft.com/graph/api/team-list-allchannels?view=graph-rest-beta](https://learn.microsoft.com/graph/api/team-list-allchannels?view=graph-rest-beta)
