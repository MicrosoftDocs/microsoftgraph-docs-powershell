...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetagroupteamchanneljoineduser
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaGroupTeamChannelJoinedUser
---

# Update-MgBetaGroupTeamChannelJoinedUser

## SYNOPSIS

Update the navigation property joinedUsers in groups
...
```
Update-MgBetaGroupTeamChannelJoinedUser -ChannelId <string> -ConversationMemberId <string>
 -GroupId <string> [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-DisplayName <string>] [-Id <string>] [-Roles <string[]>]
...
```
Update-MgBetaGroupTeamChannelJoinedUser -ChannelId <string> -ConversationMemberId <string>
 -GroupId <string> -BodyParameter <IMicrosoftGraphConversationMember>
...
```
Update-MgBetaGroupTeamChannelJoinedUser -InputObject <ITeamsIdentity>
...
- [Update-MgBetaGroupTeamChannelJoinedUser](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetagroupteamchanneljoineduser)
