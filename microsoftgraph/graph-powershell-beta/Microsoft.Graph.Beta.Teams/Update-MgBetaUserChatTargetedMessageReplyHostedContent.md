...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetauserchattargetedmessagereplyhostedcontent
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaUserChatTargetedMessageReplyHostedContent
---

# Update-MgBetaUserChatTargetedMessageReplyHostedContent
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgUserChatTargetedMessageReplyHostedContent](/powershell/module/Microsoft.Graph.Teams/Update-MgUserChatTargetedMessageReplyHostedContent?view=graph-powershell-1.0)
...
```
Update-MgBetaUserChatTargetedMessageReplyHostedContent -ChatId <string>
...
Update-MgBetaUserChatTargetedMessageReplyHostedContent -ChatId <string>
 -ChatMessageHostedContentId <string> -ChatMessageId <string> -TargetedChatMessageId <string>
 -UserId <string> -BodyParameter <hashtable> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
```
Update-MgBetaUserChatTargetedMessageReplyHostedContent -InputObject <ITeamsIdentity>
...
- [Update-MgBetaUserChatTargetedMessageReplyHostedContent](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetauserchattargetedmessagereplyhostedcontent)
