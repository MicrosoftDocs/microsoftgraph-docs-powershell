...
Get-MgBetaTeamChannelMessageHostedContent -ChannelId <String> -ChatMessageHostedContentId <String>
 -ChatMessageId <String> -TeamId <String> [-Format <String>] -OutFile <String> [-Headers <IDictionary>]
...
### GetViaIdentity1
```
Get-MgBetaTeamChannelMessageHostedContent -InputObject <ITeamsIdentity> [-Format <String>] -OutFile <String>
...
## RELATED LINKS
[Get-MgTeamChannelMessageHostedContent](/powershell/module/Microsoft.Graph.Teams/Get-MgTeamChannelMessageHostedContent?view=graph-powershell-1.0)
