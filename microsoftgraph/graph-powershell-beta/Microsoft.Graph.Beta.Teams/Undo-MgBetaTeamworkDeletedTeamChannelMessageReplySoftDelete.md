...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/undo-mgbetateamworkdeletedteamchannelmessagereplysoftdelete
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Undo-MgBetaTeamworkDeletedTeamChannelMessageReplySoftDelete
---
...
```
Undo-MgBetaTeamworkDeletedTeamChannelMessageReplySoftDelete -ChannelId <string>
 -ChatMessageId <string> -ChatMessageId1 <string> -DeletedTeamId <string>
...
```
Undo-MgBetaTeamworkDeletedTeamChannelMessageReplySoftDelete -InputObject <ITeamsIdentity>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru]
 [-Proxy <uri>] [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
 [<CommonParameters>]
