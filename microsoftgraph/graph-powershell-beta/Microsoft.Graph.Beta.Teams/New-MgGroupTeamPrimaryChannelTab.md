...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams/new-mggroupteamprimarychanneltab
schema: 2.0.0
...
### Create
```
New-MgGroupTeamPrimaryChannelTab -GroupId <String> -BodyParameter <IMicrosoftGraphTeamsTab1> [-WhatIf]
...
### CreateViaIdentity
```
New-MgGroupTeamPrimaryChannelTab -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphTeamsTab1>
