...
### Unarchive (Default)
```
Invoke-MgBetaUnarchiveTeamworkDeletedTeamChannel -ChannelId <String> -DeletedTeamId <String> [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UnarchiveViaIdentity
```
Invoke-MgBetaUnarchiveTeamworkDeletedTeamChannel -InputObject <ITeamsIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
