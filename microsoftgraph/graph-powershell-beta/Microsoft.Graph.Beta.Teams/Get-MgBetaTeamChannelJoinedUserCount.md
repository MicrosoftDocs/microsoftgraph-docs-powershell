...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetateamchanneljoinedusercount
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaTeamChannelJoinedUserCount
---

# Get-MgBetaTeamChannelJoinedUserCount
...
```
Get-MgBetaTeamChannelJoinedUserCount -ChannelId <string> -TeamId <string> [-Filter <string>]
...
```
Get-MgBetaTeamChannelJoinedUserCount -InputObject <ITeamsIdentity> [-Filter <string>]
 [-Search <string>] [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
```
...
- [Get-MgBetaTeamChannelJoinedUserCount](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetateamchanneljoinedusercount)
