...
```
New-MgBetaChatMessageReply -ChatId <String> -ChatMessageId <String> [-ResponseHeadersVariable <String>]
...
```
New-MgBetaChatMessageReply [-ChatId <String>] -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-Attachments <IMicrosoftGraphChatMessageAttachment[]>]
