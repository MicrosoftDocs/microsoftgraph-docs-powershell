...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetagroupteammember
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaGroupTeamMember
---
...
```
Update-MgBetaGroupTeamMember -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaGroupTeamMember -InputObject <ITeamsIdentity>
 -BodyParameter <IMicrosoftGraphConversationMember> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [Update-MgBetaGroupTeamMember](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetagroupteammember)
