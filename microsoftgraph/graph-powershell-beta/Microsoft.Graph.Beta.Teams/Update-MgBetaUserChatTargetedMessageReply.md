...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetauserchattargetedmessagereply
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaUserChatTargetedMessageReply
---

# Update-MgBetaUserChatTargetedMessageReply
...
```
Update-MgBetaUserChatTargetedMessageReply -ChatId <string> -ChatMessageId <string>
 -TargetedChatMessageId <string> -UserId <string> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Attachments <IMicrosoftGraphChatMessageAttachment[]>]
 [-Body <IMicrosoftGraphChatMessageBody>] [-ChannelIdentity <IMicrosoftGraphChannelIdentity>]
 [-ChatId1 <string>] [-Citations <IMicrosoftGraphChatMessageCitation[]>]
 [-CreatedDateTime <datetime>] [-DeletedDateTime <datetime>] [-Etag <string>]
 [-EventDetail <hashtable>] [-From <hashtable>] [-HasReplies]
 ...
 [-OnBehalfOf <hashtable>] [-PolicyViolation <IMicrosoftGraphChatMessagePolicyViolation>]
...
```
Update-MgBetaUserChatTargetedMessageReply -InputObject <ITeamsIdentity> [-ChatId <string>]
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-Attachments <IMicrosoftGraphChatMessageAttachment[]>] [-Body <IMicrosoftGraphChatMessageBody>]
 [-ChannelIdentity <IMicrosoftGraphChannelIdentity>]
 [-Citations <IMicrosoftGraphChatMessageCitation[]>] [-CreatedDateTime <datetime>]
 [-DeletedDateTime <datetime>] [-Etag <string>] [-EventDetail <hashtable>] [-From <hashtable>]
 [-HasReplies] [-HostedContents <IMicrosoftGraphChatMessageHostedContent[]>] [-Id <string>]
 [-Importance <string>] [-LastEditedDateTime <datetime>] [-LastModifiedDateTime <datetime>]
 [-Locale <string>] [-Mentions <IMicrosoftGraphChatMessageMention[]>]
 [-MessageHistory <IMicrosoftGraphChatMessageHistoryItem[]>] [-MessageType <string>]
 [-OnBehalfOf <hashtable>] [-PolicyViolation <IMicrosoftGraphChatMessagePolicyViolation>]
 [-Reactions <IMicrosoftGraphChatMessageReaction[]>] [-Replies <IMicrosoftGraphChatMessage[]>]
 [-ReplyToId <string>] [-Subject <string>] [-Summary <string>] [-WebUrl <string>] [-Break]
...
```
Update-MgBetaUserChatTargetedMessageReply -ChatId <string> -ChatMessageId <string>
 -TargetedChatMessageId <string> -UserId <string> -BodyParameter <IMicrosoftGraphChatMessage>
...
```
Update-MgBetaUserChatTargetedMessageReply -InputObject <ITeamsIdentity>
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphChatMessageCitation[]
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
- [Update-MgBetaUserChatTargetedMessageReply](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetauserchattargetedmessagereply)
