...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetagroupteamoperation
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaGroupTeamOperation
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgGroupTeamOperation](/powershell/module/Microsoft.Graph.Teams/New-MgGroupTeamOperation?view=graph-powershell-1.0)
...
```
New-MgBetaGroupTeamOperation -GroupId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaGroupTeamOperation -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-AttemptsCount <int>] [-CreatedDateTime <datetime>]
 [-Error <IMicrosoftGraphOperationError>] [-Id <string>] [-LastActionDateTime <datetime>]
 [-OperationType <string>] [-Status <string>] [-TargetResourceId <string>]
 [-TargetResourceLocation <string>] [-Break] [-Headers <IDictionary>]
...
```
New-MgBetaGroupTeamOperation -InputObject <ITeamsIdentity>
...
- [New-MgBetaGroupTeamOperation](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetagroupteamoperation)
