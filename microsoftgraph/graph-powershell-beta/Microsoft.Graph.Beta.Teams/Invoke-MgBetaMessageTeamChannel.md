...
```
Invoke-MgBetaMessageTeamChannel -TeamId <string> [-Count] [-ExpandProperty <string[]>]
...
- [Invoke-MgBetaMessageTeamChannel](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetamessageteamchannel)
