...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetagroupteamchannelplannerplanbuckettaskdelta
schema: 2.0.0
...
### DeltaViaIdentity
```
Get-MgBetaGroupTeamChannelPlannerPlanBucketTaskDelta -InputObject <ITeamsIdentity> [-ExpandProperty <String[]>]
