...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetateamprimarychannelplannerplanbuckettaskdetail
schema: 2.0.0
---
...
```
Update-MgBetaTeamPrimaryChannelPlannerPlanBucketTaskDetail -PlannerBucketId <String> -PlannerPlanId <String>
...
```
Update-MgBetaTeamPrimaryChannelPlannerPlanBucketTaskDetail -InputObject <ITeamsIdentity> -IfMatch <String>
