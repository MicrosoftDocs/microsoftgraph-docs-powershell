...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetagroupteamprimarychannelplannerplantaskmessage
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaGroupTeamPrimaryChannelPlannerPlanTaskMessage
---

# Update-MgBetaGroupTeamPrimaryChannelPlannerPlanTaskMessage
...
```
Update-MgBetaGroupTeamPrimaryChannelPlannerPlanTaskMessage -GroupId <string> -PlannerPlanId <string>
 -PlannerTaskChatMessageId <string> -PlannerTaskId <string> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaGroupTeamPrimaryChannelPlannerPlanTaskMessage -GroupId <string> -PlannerPlanId <string>
 -PlannerTaskChatMessageId <string> -PlannerTaskId <string>
...
```
Update-MgBetaGroupTeamPrimaryChannelPlannerPlanTaskMessage -InputObject <ITeamsIdentity>
...
- [Update-MgBetaGroupTeamPrimaryChannelPlannerPlanTaskMessage](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetagroupteamprimarychannelplannerplantaskmessage)
