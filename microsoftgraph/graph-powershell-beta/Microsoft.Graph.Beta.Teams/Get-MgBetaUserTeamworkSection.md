...
```
Get-MgBetaUserTeamworkSection -UserId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaUserTeamworkSection -TeamworkSectionId <string> -UserId <string>
...
```
Get-MgBetaUserTeamworkSection -InputObject <ITeamsIdentity> [-ExpandProperty <string[]>]
