...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetaarchivegroupteamprimarychannel
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Invoke-MgBetaArchiveGroupTeamPrimaryChannel
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Invoke-MgArchiveGroupTeamPrimaryChannel](/powershell/module/Microsoft.Graph.Teams/Invoke-MgArchiveGroupTeamPrimaryChannel?view=graph-powershell-1.0)
...
```
Invoke-MgBetaArchiveGroupTeamPrimaryChannel -GroupId <string> [-ResponseHeadersVariable <string>]
...
```
Invoke-MgBetaArchiveGroupTeamPrimaryChannel -GroupId <string>
...
```
Invoke-MgBetaArchiveGroupTeamPrimaryChannel -InputObject <ITeamsIdentity>
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPathsWcserzGroupsGroupIdTeamPrimarychannelMicrosoftGraphArchivePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IPathsWcserzGroupsGroupIdTeamPrimarychannelMicrosoftGraphArchivePostRequestbodyContentApplicationJsonSchema
...
- [Invoke-MgBetaArchiveGroupTeamPrimaryChannel](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetaarchivegroupteamprimarychannel)
