...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/remove-mgbetauserteamworksectionitem
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Remove-MgBetaUserTeamworkSectionItem
---

# Remove-MgBetaUserTeamworkSectionItem

## SYNOPSIS

Remove an item from a user-defined section in a user's teamwork.
...
```
Remove-MgBetaUserTeamworkSectionItem -TeamworkSectionId <string> -TeamworkSectionItemId <string>
...
```
Remove-MgBetaUserTeamworkSectionItem -InputObject <ITeamsIdentity> [-IfMatch <string>]
...
The unique identifier of teamworkSection
