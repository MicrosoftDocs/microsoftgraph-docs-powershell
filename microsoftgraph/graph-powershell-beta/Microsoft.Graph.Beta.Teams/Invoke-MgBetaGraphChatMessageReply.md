...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphchatmessagereply
schema: 2.0.0
ms.subservice: teams
---
...
```
Invoke-MgBetaGraphChatMessageReply -ChatId <String> -ChatMessageId <String> [-ResponseHeadersVariable <String>]
...
```yaml
Type: IPaths4A0Tl8ChatsChatIdMessagesChatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphchatmessagereply](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphchatmessagereply)
