...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphchatmessagereply
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Invoke-MgBetaGraphChatMessageReply
---

# Invoke-MgBetaGraphChatMessageReply
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Invoke-MgGraphChatMessageReply](/powershell/module/Microsoft.Graph.Teams/Invoke-MgGraphChatMessageReply?view=graph-powershell-1.0)
...
```
Invoke-MgBetaGraphChatMessageReply -ChatId <string> -ChatMessageId <string>
...
```
Invoke-MgBetaGraphChatMessageReply -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
...
```
Invoke-MgBetaGraphChatMessageReply -InputObject <ITeamsIdentity>
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths4A0Tl8ChatsChatIdMessagesChatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths4A0Tl8ChatsChatIdMessagesChatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
...
- [Invoke-MgBetaGraphChatMessageReply](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphchatmessagereply)
