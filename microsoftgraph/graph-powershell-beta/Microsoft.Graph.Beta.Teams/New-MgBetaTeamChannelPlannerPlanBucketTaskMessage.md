...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetateamchannelplannerplanbuckettaskmessage
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaTeamChannelPlannerPlanBucketTaskMessage
---

# New-MgBetaTeamChannelPlannerPlanBucketTaskMessage
...
```
New-MgBetaTeamChannelPlannerPlanBucketTaskMessage -ChannelId <string> -PlannerBucketId <string>
...
```
New-MgBetaTeamChannelPlannerPlanBucketTaskMessage -InputObject <ITeamsIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-Content <string>]
 [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <datetime>]
 [-DeletedDateTime <datetime>] [-EditedDateTime <datetime>] [-Id <string>]
 [-Mentions <IMicrosoftGraphPlannerTaskChatMention[]>] [-MessageType <string>]
...
- [New-MgBetaTeamChannelPlannerPlanBucketTaskMessage](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetateamchannelplannerplanbuckettaskmessage)
