...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetauserteamworksection
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaUserTeamworkSection
---

# New-MgBetaUserTeamworkSection
...
```
New-MgBetaUserTeamworkSection -UserId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaUserTeamworkSection -UserId <string> -BodyParameter <IMicrosoftGraphTeamworkSection>
...
```
New-MgBetaUserTeamworkSection -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-CreatedDateTime <datetime>]
 [-DisplayIcon <IMicrosoftGraphSectionDisplayIcon>] [-DisplayName <string>] [-Id <string>]
 [-IsExpanded] [-IsHierarchicalViewEnabled] [-Items <IMicrosoftGraphTeamworkSectionItem[]>]
 [-LastModifiedDateTime <datetime>] [-SectionType <string>] [-SortType <string>] [-Break]
...
```
New-MgBetaUserTeamworkSection -InputObject <ITeamsIdentity>
