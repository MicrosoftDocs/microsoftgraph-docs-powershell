...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetauserteamworksection
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaUserTeamworkSection
---

# Update-MgBetaUserTeamworkSection

## SYNOPSIS

Update the properties of a section in a user's teamwork.
For system-defined sections, only the sortType property can be updated.
...
```
Update-MgBetaUserTeamworkSection -TeamworkSectionId <string> -UserId <string>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-CreatedDateTime <datetime>] [-DisplayIcon <IMicrosoftGraphSectionDisplayIcon>]
 [-DisplayName <string>] [-Id <string>] [-IsExpanded] [-IsHierarchicalViewEnabled]
 [-Items <IMicrosoftGraphTeamworkSectionItem[]>] [-LastModifiedDateTime <datetime>]
 [-SectionType <string>] [-SortType <string>] [-Break] [-Headers <IDictionary>]
...
```
Update-MgBetaUserTeamworkSection -TeamworkSectionId <string> -UserId <string>
 -BodyParameter <IMicrosoftGraphTeamworkSection> [-ResponseHeadersVariable <string>] [-Break]
...
```
Update-MgBetaUserTeamworkSection -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-CreatedDateTime <datetime>]
 [-DisplayIcon <IMicrosoftGraphSectionDisplayIcon>] [-DisplayName <string>] [-Id <string>]
 [-IsExpanded] [-IsHierarchicalViewEnabled] [-Items <IMicrosoftGraphTeamworkSectionItem[]>]
 [-LastModifiedDateTime <datetime>] [-SectionType <string>] [-SortType <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
```
Update-MgBetaUserTeamworkSection -InputObject <ITeamsIdentity>
 -BodyParameter <IMicrosoftGraphTeamworkSection> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphTeamworkSection
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
sectionDisplayIcon
To construct, see NOTES section for DISPLAYICON properties and create a hash table.

```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphSectionDisplayIcon
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
Indicates whether the section is expanded in the user interface.
...
Indicates whether the hierarchical view is enabled for the section.
Read-only.
...
Date and time when the section was last modified.
Read-only.
The timestamp type represents date and time information using ISO 8601 format and is always in UTC.
For example, midnight UTC on Jan 1, 2024, is 2024-01-01T00:00:00Z.
...
BODYPARAMETER `<IMicrosoftGraphTeamworkSection>`: teamworkSection
...
- [Update-MgBetaUserTeamworkSection](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetauserteamworksection)
- [Graph API Reference](https://learn.microsoft.com/graph/api/teamworksection-update?view=graph-rest-beta)
