...
### Complete (Default)
```
Complete-MgBetaTeamMigration -TeamId <String> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### CompleteViaIdentity
```
Complete-MgBetaTeamMigration -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
