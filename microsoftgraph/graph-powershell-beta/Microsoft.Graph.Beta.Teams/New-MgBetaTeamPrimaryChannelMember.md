...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetateamprimarychannelmember
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaTeamPrimaryChannelMember
---
...
```
New-MgBetaTeamPrimaryChannelMember -TeamId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaTeamPrimaryChannelMember -TeamId <string>
...
```
New-MgBetaTeamPrimaryChannelMember -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-DisplayName <string>] [-Id <string>] [-Roles <string[]>]
 [-VisibleHistoryStartDateTime <datetime>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgBetaTeamPrimaryChannelMember](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetateamprimarychannelmember)
