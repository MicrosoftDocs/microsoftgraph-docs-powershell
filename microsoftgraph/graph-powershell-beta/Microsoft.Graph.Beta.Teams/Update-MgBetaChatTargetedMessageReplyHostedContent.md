...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetachattargetedmessagereplyhostedcontent
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaChatTargetedMessageReplyHostedContent
---

# Update-MgBetaChatTargetedMessageReplyHostedContent
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgChatTargetedMessageReplyHostedContent](/powershell/module/Microsoft.Graph.Teams/Update-MgChatTargetedMessageReplyHostedContent?view=graph-powershell-1.0)
...
```
Update-MgBetaChatTargetedMessageReplyHostedContent -ChatId <string>
...
```
Update-MgBetaChatTargetedMessageReplyHostedContent -InputObject <ITeamsIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-ContentBytesInputFile <string>] [-ContentType <string>] [-Id <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
...
- [Update-MgBetaChatTargetedMessageReplyHostedContent](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetachattargetedmessagereplyhostedcontent)
