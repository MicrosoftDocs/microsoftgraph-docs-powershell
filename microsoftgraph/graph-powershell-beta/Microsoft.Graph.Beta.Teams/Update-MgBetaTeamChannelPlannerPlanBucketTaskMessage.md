...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetateamchannelplannerplanbuckettaskmessage
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaTeamChannelPlannerPlanBucketTaskMessage
---

# Update-MgBetaTeamChannelPlannerPlanBucketTaskMessage
...
```
Update-MgBetaTeamChannelPlannerPlanBucketTaskMessage -ChannelId <string> -PlannerBucketId <string>
...
```
Update-MgBetaTeamChannelPlannerPlanBucketTaskMessage -InputObject <ITeamsIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-Content <string>]
 [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <datetime>]
 [-DeletedDateTime <datetime>] [-EditedDateTime <datetime>] [-Id <string>]
 [-Mentions <IMicrosoftGraphPlannerTaskChatMention[]>] [-MessageType <string>]
...
- [Update-MgBetaTeamChannelPlannerPlanBucketTaskMessage](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetateamchannelplannerplanbuckettaskmessage)
