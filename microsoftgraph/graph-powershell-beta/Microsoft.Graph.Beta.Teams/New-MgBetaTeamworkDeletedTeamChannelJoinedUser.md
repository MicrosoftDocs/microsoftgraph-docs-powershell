...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetateamworkdeletedteamchanneljoineduser
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaTeamworkDeletedTeamChannelJoinedUser
---

# New-MgBetaTeamworkDeletedTeamChannelJoinedUser
...
```
New-MgBetaTeamworkDeletedTeamChannelJoinedUser -ChannelId <string> -DeletedTeamId <string>
...
```
New-MgBetaTeamworkDeletedTeamChannelJoinedUser -InputObject <ITeamsIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-DisplayName <string>]
 [-Id <string>] [-Roles <string[]>] [-VisibleHistoryStartDateTime <datetime>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
...
- [New-MgBetaTeamworkDeletedTeamChannelJoinedUser](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetateamworkdeletedteamchanneljoineduser)
