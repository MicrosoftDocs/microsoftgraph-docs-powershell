...
# Invoke-MgBetaReorderUserTeamworkSection
...
```
Invoke-MgBetaReorderUserTeamworkSection -UserId <string> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-SectionsOrder <string[]>] [-Break] [-Headers <IDictionary>]
...
```
Invoke-MgBetaReorderUserTeamworkSection -UserId <string>
...
```
Invoke-MgBetaReorderUserTeamworkSection -InputObject <ITeamsIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-SectionsOrder <string[]>]
...
Aliases: []
ParameterSets:
- Name: ReorderViaIdentityExpanded
  Position: Named
  IsRequired: false
  ValueFromPipeline: false
  ValueFromPipelineByPropertyName: false
  ValueFromRemainingArguments: false
- Name: ReorderExpanded
  Position: Named
  IsRequired: false
  ValueFromPipeline: false
  ValueFromPipelineByPropertyName: false
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPathsX9CysrUsersUserIdTeamworkSectionsMicrosoftGraphReorderPostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IPathsX9CysrUsersUserIdTeamworkSectionsMicrosoftGraphReorderPostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphTeamworkSection
