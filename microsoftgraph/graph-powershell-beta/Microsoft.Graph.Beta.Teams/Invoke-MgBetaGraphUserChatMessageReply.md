...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphuserchatmessagereply
schema: 2.0.0
ms.subservice: teams
---

# Invoke-MgBetaGraphUserChatMessageReply
...
```
Invoke-MgBetaGraphUserChatMessageReply -ChatId <String> -ChatMessageId <String> -UserId <String>
...
```
Invoke-MgBetaGraphUserChatMessageReply -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
...
```yaml
Type: IPaths1Y1Ve8UUsersUserIdChatsChatIdMessagesChatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths1Y1Ve8UUsersUserIdChatsChatIdMessagesChatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphuserchatmessagereply](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphuserchatmessagereply)
