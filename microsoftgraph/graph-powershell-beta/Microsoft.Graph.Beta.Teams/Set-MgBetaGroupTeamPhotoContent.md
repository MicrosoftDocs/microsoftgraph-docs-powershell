...
### Set (Default)
```
Set-MgBetaGroupTeamPhotoContent -GroupId <String> [-Data <Stream>] -InFile <String> [-ContentType <String>]
...
### SetViaIdentity
```
Set-MgBetaGroupTeamPhotoContent -InputObject <ITeamsIdentity> [-Data <Stream>] -InFile <String>
...
## RELATED LINKS
[Set-MgGroupTeamPhotoContent](/powershell/module/Microsoft.Graph.Teams/Set-MgGroupTeamPhotoContent?view=graph-powershell-1.0)
