...
### Set (Default)
```
Set-MgBetaGroupTeamPhotoContent -GroupId <String> [-Data <Stream>] [-ResponseHeadersVariable <String>]
...
### SetViaIdentity
```
Set-MgBetaGroupTeamPhotoContent -InputObject <ITeamsIdentity> [-Data <Stream>]
