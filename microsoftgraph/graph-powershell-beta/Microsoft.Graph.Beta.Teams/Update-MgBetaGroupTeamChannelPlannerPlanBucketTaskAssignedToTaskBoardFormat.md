...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetagroupteamchannelplannerplanbuckettaskassignedtotaskboardformat
schema: 2.0.0
---

# Update-MgBetaGroupTeamChannelPlannerPlanBucketTaskAssignedToTaskBoardFormat
...
```
Update-MgBetaGroupTeamChannelPlannerPlanBucketTaskAssignedToTaskBoardFormat -ChannelId <String>
 -GroupId <String> -PlannerBucketId <String> -PlannerPlanId <String> -PlannerTaskId <String> -IfMatch <String>
...
```
Update-MgBetaGroupTeamChannelPlannerPlanBucketTaskAssignedToTaskBoardFormat -InputObject <ITeamsIdentity>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetagroupteamchannelplannerplanbuckettaskassignedtotaskboardformat](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetagroupteamchannelplannerplanbuckettaskassignedtotaskboardformat)
