...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetateamchannelplannerplanbucket
schema: 2.0.0
---

# Update-MgBetaTeamChannelPlannerPlanBucket
...
```
Update-MgBetaTeamChannelPlannerPlanBucket -ChannelId <String> -PlannerBucketId <String> -PlannerPlanId <String>
...
```
Update-MgBetaTeamChannelPlannerPlanBucket -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
...
### UpdateViaIdentity
```
Update-MgBetaTeamChannelPlannerPlanBucket -InputObject <ITeamsIdentity>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetateamchannelplannerplanbucket](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetateamchannelplannerplanbucket)
