...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphgroupteamchannelmessage
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Invoke-MgBetaGraphGroupTeamChannelMessage
---

# Invoke-MgBetaGraphGroupTeamChannelMessage
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Invoke-MgGraphGroupTeamChannelMessage](/powershell/module/Microsoft.Graph.Teams/Invoke-MgGraphGroupTeamChannelMessage?view=graph-powershell-1.0)
...
```
Invoke-MgBetaGraphGroupTeamChannelMessage -ChannelId <string> -GroupId <string>
...
```
Invoke-MgBetaGraphGroupTeamChannelMessage -InputObject <ITeamsIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-MessageIds <string[]>]
 [-ReplyMessage <IMicrosoftGraphChatMessage>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths1CiexhuGroupsGroupIdTeamChannelsChannelIdMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths1CiexhuGroupsGroupIdTeamChannelsChannelIdMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
...
- [Invoke-MgBetaGraphGroupTeamChannelMessage](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphgroupteamchannelmessage)
