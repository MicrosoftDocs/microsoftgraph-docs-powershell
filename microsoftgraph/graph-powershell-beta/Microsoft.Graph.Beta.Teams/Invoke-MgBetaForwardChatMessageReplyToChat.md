...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetaforwardchatmessagereplytochat
schema: 2.0.0
ms.subservice: teams
---

# Invoke-MgBetaForwardChatMessageReplyToChat
...
```
Invoke-MgBetaForwardChatMessageReplyToChat -ChatId <String> -ChatMessageId <String>
...
```
Invoke-MgBetaForwardChatMessageReplyToChat -ChatId <String> -ChatMessageId <String>
 -BodyParameter <IPaths9Qtc7SChatsChatIdMessagesChatmessageIdRepliesMicrosoftGraphForwardtochatPostRequestbodyContentApplicationJsonSchema>
...
```
Invoke-MgBetaForwardChatMessageReplyToChat -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
...
### ForwardViaIdentity
```
Invoke-MgBetaForwardChatMessageReplyToChat -InputObject <ITeamsIdentity>
 -BodyParameter <IPaths9Qtc7SChatsChatIdMessagesChatmessageIdRepliesMicrosoftGraphForwardtochatPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
```yaml
Type: IPaths9Qtc7SChatsChatIdMessagesChatmessageIdRepliesMicrosoftGraphForwardtochatPostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths9Qtc7SChatsChatIdMessagesChatmessageIdRepliesMicrosoftGraphForwardtochatPostRequestbodyContentApplicationJsonSchema
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetaforwardchatmessagereplytochat](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetaforwardchatmessagereplytochat)
