...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetagroupteamchannelemail
schema: 2.0.0
ms.subservice: teams
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgGroupTeamChannelEmail](/powershell/module/Microsoft.Graph.Teams/New-MgGroupTeamChannelEmail?view=graph-powershell-1.0)

## SYNTAX

### Provision (Default)
```
New-MgBetaGroupTeamChannelEmail -ChannelId <String> -GroupId <String> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### ProvisionViaIdentity
```
New-MgBetaGroupTeamChannelEmail -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetagroupteamchannelemail](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetagroupteamchannelemail)
