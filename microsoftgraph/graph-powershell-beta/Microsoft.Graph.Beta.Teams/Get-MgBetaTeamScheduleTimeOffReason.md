...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgTeamScheduleTimeOffReason](/powershell/module/Microsoft.Graph.Teams/Get-MgTeamScheduleTimeOffReason?view=graph-powershell-v1.0)

## SYNTAX

### List (Default)
```
Get-MgBetaTeamScheduleTimeOffReason -TeamId <String> [-Property <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgBetaTeamScheduleTimeOffReason -InputObject <ITeamsIdentity> [-Property <String[]>] [<CommonParameters>]
```
