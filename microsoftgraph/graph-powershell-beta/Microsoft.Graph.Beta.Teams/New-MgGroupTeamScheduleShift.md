...
### Create1
```
New-MgGroupTeamScheduleShift -GroupId <String> -BodyParameter <IMicrosoftGraphShift1> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### CreateViaIdentity1
```
New-MgGroupTeamScheduleShift -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphShift1> [-WhatIf]
