...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/add-mgbetagroupteamchanneljoineduser
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Add-MgBetaGroupTeamChannelJoinedUser
---

# Add-MgBetaGroupTeamChannelJoinedUser
...
```
Add-MgBetaGroupTeamChannelJoinedUser -ChannelId <string> -GroupId <string>
...
```
Add-MgBetaGroupTeamChannelJoinedUser -ChannelId <string> -GroupId <string>
 -BodyParameter <IPaths10Iomh0GroupsGroupIdTeamChannelsChannelIdJoinedusersMicrosoftGraphAddPostRequestbodyContentApplicationJsonSchema>
...
```
Add-MgBetaGroupTeamChannelJoinedUser -InputObject <ITeamsIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-Values <IMicrosoftGraphConversationMember[]>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths10Iomh0GroupsGroupIdTeamChannelsChannelIdJoinedusersMicrosoftGraphAddPostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths10Iomh0GroupsGroupIdTeamChannelsChannelIdJoinedusersMicrosoftGraphAddPostRequestbodyContentApplicationJsonSchema
...
- [Add-MgBetaGroupTeamChannelJoinedUser](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/add-mgbetagroupteamchanneljoineduser)
