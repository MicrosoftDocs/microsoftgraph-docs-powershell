...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphteamprimarychannelmessage
schema: 2.0.0
ms.subservice: teams
---

# Invoke-MgBetaGraphTeamPrimaryChannelMessage
...
```
Invoke-MgBetaGraphTeamPrimaryChannelMessage -TeamId <String> [-ResponseHeadersVariable <String>]
...
### Graph
```
Invoke-MgBetaGraphTeamPrimaryChannelMessage -TeamId <String>
...
```
Invoke-MgBetaGraphTeamPrimaryChannelMessage -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-MessageIds <String[]>] [-ReplyMessage <IMicrosoftGraphChatMessage>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```yaml
Type: IPaths1Cgj308TeamsTeamIdPrimarychannelMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths1Cgj308TeamsTeamIdPrimarychannelMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphteamprimarychannelmessage](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphteamprimarychannelmessage)
