...
### List (Default)
```
Get-MgBetaTeamMember -TeamId <String> [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
**Permissions**
[!INCLUDE [permissions-table](~/../graphref/api-reference/beta/includes/permissions/team-get-members-permissions.md)]

**Permissions**
[!INCLUDE [permissions-table](~/../graphref/api-reference/beta/includes/permissions/team-list-members-permissions.md)]
...
[https://learn.microsoft.com/graph/api/team-get-members?view=graph-rest-beta](https://learn.microsoft.com/graph/api/team-get-members?view=graph-rest-beta)

[https://learn.microsoft.com/graph/api/team-list-members?view=graph-rest-beta](https://learn.microsoft.com/graph/api/team-list-members?view=graph-rest-beta)
