...
```
Update-MgBetaAppCatalogTeamAppDefinitionColorIcon -TeamsAppDefinitionId <string>
 -TeamsAppId <string> [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
...
```
Update-MgBetaAppCatalogTeamAppDefinitionColorIcon -TeamsAppDefinitionId <string>
 -TeamsAppId <string> -BodyParameter <IMicrosoftGraphTeamsAppIcon>
