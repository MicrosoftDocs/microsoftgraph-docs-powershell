...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetateamprimarychanneljoineduser
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaTeamPrimaryChannelJoinedUser
---

# Update-MgBetaTeamPrimaryChannelJoinedUser
...
```
Update-MgBetaTeamPrimaryChannelJoinedUser -ConversationMemberId <string> -TeamId <string>
...
```
Update-MgBetaTeamPrimaryChannelJoinedUser -InputObject <ITeamsIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-DisplayName <string>]
 [-Id <string>] [-Roles <string[]>] [-VisibleHistoryStartDateTime <datetime>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
...
- [Update-MgBetaTeamPrimaryChannelJoinedUser](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetateamprimarychanneljoineduser)
