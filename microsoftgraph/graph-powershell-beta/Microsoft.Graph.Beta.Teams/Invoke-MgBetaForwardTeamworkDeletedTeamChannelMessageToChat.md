...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetaforwardteamworkdeletedteamchannelmessagetochat
schema: 2.0.0
ms.subservice: teams
---
...
```
Invoke-MgBetaForwardTeamworkDeletedTeamChannelMessageToChat -ChannelId <String> -DeletedTeamId <String>
...
```yaml
Type: IPaths691589TeamworkDeletedteamsDeletedteamIdChannelsChannelIdMessagesMicrosoftGraphForwardtochatPostRequestbodyContentApplicationJsonSchema
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetaforwardteamworkdeletedteamchannelmessagetochat](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetaforwardteamworkdeletedteamchannelmessagetochat)
