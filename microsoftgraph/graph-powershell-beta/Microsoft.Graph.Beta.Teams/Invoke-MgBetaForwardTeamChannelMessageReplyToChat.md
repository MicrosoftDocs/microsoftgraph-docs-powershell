...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetaforwardteamchannelmessagereplytochat
schema: 2.0.0
ms.subservice: teams
---
...
```
Invoke-MgBetaForwardTeamChannelMessageReplyToChat -ChannelId <String> -ChatMessageId <String> -TeamId <String>
...
```yaml
Type: IPaths1FqshynTeamsTeamIdChannelsChannelIdMessagesChatmessageIdRepliesMicrosoftGraphForwardtochatPostRequestbodyContentApplicationJsonSchema
