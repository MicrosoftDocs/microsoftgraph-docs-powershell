...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphteamchannelmessage
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: Invoke-MgBetaGraphTeamChannelMessage
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Invoke-MgGraphTeamChannelMessage](/powershell/module/Microsoft.Graph.Teams/Invoke-MgGraphTeamChannelMessage?view=graph-powershell-1.0)
...
```
Invoke-MgBetaGraphTeamChannelMessage -InputObject <ITeamsIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-MessageIds <string[]>]
 [-ReplyMessage <IMicrosoftGraphChatMessage>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths1Am35GsTeamsTeamIdChannelsChannelIdMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
