...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphteamchannelmessage
schema: 2.0.0
ms.subservice: teams
---

# Invoke-MgBetaGraphTeamChannelMessage
...
```
Invoke-MgBetaGraphTeamChannelMessage -ChannelId <String> -TeamId <String> [-ResponseHeadersVariable <String>]
...
### Graph
```
Invoke-MgBetaGraphTeamChannelMessage -ChannelId <String> -TeamId <String>
...
```
Invoke-MgBetaGraphTeamChannelMessage -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-MessageIds <String[]>] [-ReplyMessage <IMicrosoftGraphChatMessage>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```yaml
Type: IPaths1Am35GsTeamsTeamIdChannelsChannelIdMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths1Am35GsTeamsTeamIdChannelsChannelIdMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphteamchannelmessage](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphteamchannelmessage)
