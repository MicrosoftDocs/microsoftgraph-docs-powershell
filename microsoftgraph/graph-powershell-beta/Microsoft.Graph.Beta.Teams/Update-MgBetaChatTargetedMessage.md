...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetachattargetedmessage
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaChatTargetedMessage
---

# Update-MgBetaChatTargetedMessage
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgChatTargetedMessage](/powershell/module/Microsoft.Graph.Teams/Update-MgChatTargetedMessage?view=graph-powershell-1.0)
...
```
Update-MgBetaChatTargetedMessage -ChatId <string> -TargetedChatMessageId <string>
...
```
Update-MgBetaChatTargetedMessage -InputObject <ITeamsIdentity> [-ChatId <string>]
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-Attachments <IMicrosoftGraphChatMessageAttachment[]>] [-Body <IMicrosoftGraphChatMessageBody>]
...
```
Update-MgBetaChatTargetedMessage -InputObject <ITeamsIdentity>
 -BodyParameter <IMicrosoftGraphTargetedChatMessage> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [Update-MgBetaChatTargetedMessage](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetachattargetedmessage)
