...
### List (Default)
```
Get-MgBetaTeam [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>] [-Search <String>]
...
**Permissions**
[!INCLUDE [permissions-table](~/../graphref/api-reference/beta/includes/permissions/team-get-permissions.md)]

**Permissions**
[!INCLUDE [permissions-table](~/../graphref/api-reference/beta/includes/permissions/teams-list-permissions.md)]
...
[https://learn.microsoft.com/graph/api/team-get?view=graph-rest-beta](https://learn.microsoft.com/graph/api/team-get?view=graph-rest-beta)

[https://learn.microsoft.com/graph/api/teams-list?view=graph-rest-beta](https://learn.microsoft.com/graph/api/teams-list?view=graph-rest-beta)
