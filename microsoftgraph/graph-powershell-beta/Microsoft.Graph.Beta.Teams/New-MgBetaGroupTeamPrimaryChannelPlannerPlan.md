...
New-MgBetaGroupTeamPrimaryChannelPlannerPlan -GroupId <string> [-ResponseHeadersVariable <string>]
 ...
 [-Details <IMicrosoftGraphPlannerPlanDetails>] [-Goals <IMicrosoftGraphPlannerGoal[]>]
...
```
New-MgBetaGroupTeamPrimaryChannelPlannerPlan -GroupId <string>
...
Read-only.
Nullable.
To construct, see NOTES section for GOALS properties and create a hash table.

```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphPlannerGoal[]
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
Collection of history items for entities in the plan.
Read-only.
Nullable.
...
- [New-MgBetaGroupTeamPrimaryChannelPlannerPlan](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetagroupteamprimarychannelplannerplan)
