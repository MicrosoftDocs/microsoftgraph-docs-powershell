...
```
Invoke-MgBetaArchiveGroupTeamChannelPlannerPlan -ChannelId <string> -GroupId <string>
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPathsS0Tj9ZGroupsGroupIdTeamChannelsChannelIdPlannerPlansPlannerplanIdMicrosoftGraphArchivePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
