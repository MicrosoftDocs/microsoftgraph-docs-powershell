...
### DeleteViaIdentity
```
Remove-MgBetaChatInstalledApp -InputObject <ITeamsIdentity> [-IfMatch <String>] [-Headers <IDictionary>]
...
## RELATED LINKS
[Remove-MgChatInstalledApp](/powershell/module/Microsoft.Graph.Teams/Remove-MgChatInstalledApp?view=graph-powershell-1.0)
