...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetachatmessage
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 06/17/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaChatMessage
---
...
```
New-MgBetaChatMessage -ChatId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaChatMessage -InputObject <ITeamsIdentity> [-ChatId <string>]
...
| --------------- | ------------------------------------------  |
| Delegated (work or school account) | Chat.ReadWrite, ChatMessage.Send, Group.ReadWrite.All,  |
...
- [Graph API Reference](https://learn.microsoft.com/graph/api/chat-post-messages?view=graph-rest-beta)
