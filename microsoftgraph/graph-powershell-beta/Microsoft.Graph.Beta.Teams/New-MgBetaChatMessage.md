...
```
New-MgBetaChatMessage -ChatId <String> [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>]
...
```
New-MgBetaChatMessage [-ChatId <String>] -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
...
[https://learn.microsoft.com/graph/api/chat-post-messages?view=graph-rest-beta](https://learn.microsoft.com/graph/api/chat-post-messages?view=graph-rest-beta)
