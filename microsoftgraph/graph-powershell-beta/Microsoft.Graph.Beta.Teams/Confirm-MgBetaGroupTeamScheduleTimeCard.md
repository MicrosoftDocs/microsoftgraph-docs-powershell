...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/confirm-mgbetagroupteamscheduletimecard
schema: 2.0.0
ms.subservice: teams
---
...
### Confirm (Default)
```
Confirm-MgBetaGroupTeamScheduleTimeCard -GroupId <String> -TimeCardId <String>
...
### ConfirmViaIdentity
```
Confirm-MgBetaGroupTeamScheduleTimeCard -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
