...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetateamchanneljoineduser
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaTeamChannelJoinedUser
---

# Update-MgBetaTeamChannelJoinedUser
...
```
Update-MgBetaTeamChannelJoinedUser -ChannelId <string> -ConversationMemberId <string>
...
```
Update-MgBetaTeamChannelJoinedUser -ChannelId <string> -ConversationMemberId <string>
 -TeamId <string> -BodyParameter <IMicrosoftGraphConversationMember>
...
```
Update-MgBetaTeamChannelJoinedUser -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaTeamChannelJoinedUser -InputObject <ITeamsIdentity>
...
- [Update-MgBetaTeamChannelJoinedUser](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetateamchanneljoineduser)
