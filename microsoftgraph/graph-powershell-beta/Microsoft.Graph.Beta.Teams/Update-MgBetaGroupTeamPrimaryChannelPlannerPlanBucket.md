...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetagroupteamprimarychannelplannerplanbucket
schema: 2.0.0
---

# Update-MgBetaGroupTeamPrimaryChannelPlannerPlanBucket
...
```
Update-MgBetaGroupTeamPrimaryChannelPlannerPlanBucket -GroupId <String> -PlannerBucketId <String>
...
```
Update-MgBetaGroupTeamPrimaryChannelPlannerPlanBucket -GroupId <String> -PlannerBucketId <String>
 -PlannerPlanId <String> -BodyParameter <IMicrosoftGraphPlannerBucket> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgBetaGroupTeamPrimaryChannelPlannerPlanBucket -InputObject <ITeamsIdentity>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetagroupteamprimarychannelplannerplanbucket](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetagroupteamprimarychannelplannerplanbucket)
