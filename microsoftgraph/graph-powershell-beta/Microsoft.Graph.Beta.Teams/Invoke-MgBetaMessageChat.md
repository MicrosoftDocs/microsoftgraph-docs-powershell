...
```
Invoke-MgBetaMessageChat [-Count] [-ExpandProperty <string[]>] [-Filter <string>]
...
| Application | Chat.Manage.Chat, Chat.Read.All, Chat.ReadBasic.All, ChatSettings.Read.Chat, ChatSettings.ReadWrite.Chat,  |
