...
# Invoke-MgBetaGraphTeamworkDeletedTeamChannelMessage
...
```
Invoke-MgBetaGraphTeamworkDeletedTeamChannelMessage -ChannelId <string> -DeletedTeamId <string>
...
```
Invoke-MgBetaGraphTeamworkDeletedTeamChannelMessage -ChannelId <string> -DeletedTeamId <string>
 -Body <IPaths6Mb5SaTeamworkDeletedteamsDeletedteamIdChannelsChannelIdMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema>
...
```
Invoke-MgBetaGraphTeamworkDeletedTeamChannelMessage -InputObject <ITeamsIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-MessageIds <string[]>]
 [-ReplyMessage <IMicrosoftGraphChatMessage>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```
Invoke-MgBetaGraphTeamworkDeletedTeamChannelMessage -InputObject <ITeamsIdentity>
 -BodyParameter <IPaths6Mb5SaTeamworkDeletedteamsDeletedteamIdChannelsChannelIdMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths6Mb5SaTeamworkDeletedteamsDeletedteamIdChannelsChannelIdMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths6Mb5SaTeamworkDeletedteamsDeletedteamIdChannelsChannelIdMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
...
- [Invoke-MgBetaGraphTeamworkDeletedTeamChannelMessage](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphteamworkdeletedteamchannelmessage)
