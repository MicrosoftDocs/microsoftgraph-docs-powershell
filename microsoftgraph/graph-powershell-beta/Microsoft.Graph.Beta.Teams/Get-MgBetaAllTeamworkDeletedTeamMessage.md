...
```
Get-MgBetaAllTeamworkDeletedTeamMessage [-Count] [-ExpandProperty <string[]>] [-Filter <string>]
 [-Model <string>] [-Property <string[]>] [-Search <string>] [-Skip <int>] [-Sort <string[]>]
...
- [Get-MgBetaAllTeamworkDeletedTeamMessage](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetaallteamworkdeletedteammessage)
