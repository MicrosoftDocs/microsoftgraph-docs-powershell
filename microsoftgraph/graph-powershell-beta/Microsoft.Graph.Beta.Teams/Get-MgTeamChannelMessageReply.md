...
### GetViaIdentity1
```
Get-MgTeamChannelMessageReply -InputObject <ITeamsIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
...
### Example 1: Using the Get-MgTeamChannelMessageReply Cmdlet
```powershell
