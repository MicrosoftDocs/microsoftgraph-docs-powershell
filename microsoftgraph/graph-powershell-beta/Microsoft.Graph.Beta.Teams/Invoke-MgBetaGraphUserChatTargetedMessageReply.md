...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphuserchattargetedmessagereply
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Invoke-MgBetaGraphUserChatTargetedMessageReply
---

# Invoke-MgBetaGraphUserChatTargetedMessageReply
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Invoke-MgGraphUserChatTargetedMessageReply](/powershell/module/Microsoft.Graph.Teams/Invoke-MgGraphUserChatTargetedMessageReply?view=graph-powershell-1.0)
...
```
Invoke-MgBetaGraphUserChatTargetedMessageReply -ChatId <string> -TargetedChatMessageId <string>
...
Invoke-MgBetaGraphUserChatTargetedMessageReply -ChatId <string> -TargetedChatMessageId <string>
 -UserId <string>
 -Body <IPathsZmtt4JUsersUserIdChatsChatIdTargetedmessagesTargetedchatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema>
...
```
Invoke-MgBetaGraphUserChatTargetedMessageReply -InputObject <ITeamsIdentity>
...
```
Invoke-MgBetaGraphUserChatTargetedMessageReply -InputObject <ITeamsIdentity>
 -BodyParameter <IPathsZmtt4JUsersUserIdChatsChatIdTargetedmessagesTargetedchatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPathsZmtt4JUsersUserIdChatsChatIdTargetedmessagesTargetedchatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IPathsZmtt4JUsersUserIdChatsChatIdTargetedmessagesTargetedchatmessageIdRepliesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
...
- [Invoke-MgBetaGraphUserChatTargetedMessageReply](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphuserchattargetedmessagereply)
