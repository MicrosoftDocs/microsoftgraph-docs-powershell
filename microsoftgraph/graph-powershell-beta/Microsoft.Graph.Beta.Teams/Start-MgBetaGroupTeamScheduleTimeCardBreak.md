...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/start-mgbetagroupteamscheduletimecardbreak
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Start-MgBetaGroupTeamScheduleTimeCardBreak
---
...
```
Start-MgBetaGroupTeamScheduleTimeCardBreak -InputObject <ITeamsIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-AtApprovedLocation]
 [-IsAtApprovedLocation] [-Notes <IMicrosoftGraphItemBody>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths1Qw8GlwGroupsGroupIdTeamScheduleTimecardsTimecardIdMicrosoftGraphStartbreakPostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths1Qw8GlwGroupsGroupIdTeamScheduleTimecardsTimecardIdMicrosoftGraphStartbreakPostRequestbodyContentApplicationJsonSchema
...
- [Start-MgBetaGroupTeamScheduleTimeCardBreak](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/start-mgbetagroupteamscheduletimecardbreak)
- [Graph API Reference](https://learn.microsoft.com/graph/api/timecard-startbreak?view=graph-rest-beta)
