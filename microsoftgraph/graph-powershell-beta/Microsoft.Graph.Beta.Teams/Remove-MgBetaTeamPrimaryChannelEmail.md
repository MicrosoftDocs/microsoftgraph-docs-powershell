...
### Remove (Default)
```
Remove-MgBetaTeamPrimaryChannelEmail -TeamId <String> [-ResponseHeadersVariable <String>]
...
### RemoveViaIdentity
```
Remove-MgBetaTeamPrimaryChannelEmail -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
