...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetauserchattargetedmessage
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaUserChatTargetedMessage
---

# New-MgBetaUserChatTargetedMessage
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgUserChatTargetedMessage](/powershell/module/Microsoft.Graph.Teams/New-MgUserChatTargetedMessage?view=graph-powershell-1.0)
...
```
New-MgBetaUserChatTargetedMessage -ChatId <string> -UserId <string>
...
```
New-MgBetaUserChatTargetedMessage -InputObject <ITeamsIdentity> [-ChatId <string>]
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-Attachments <IMicrosoftGraphChatMessageAttachment[]>] [-Body <IMicrosoftGraphChatMessageBody>]
...
```
New-MgBetaUserChatTargetedMessage -InputObject <ITeamsIdentity>
 -BodyParameter <IMicrosoftGraphTargetedChatMessage> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgBetaUserChatTargetedMessage](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetauserchattargetedmessage)
