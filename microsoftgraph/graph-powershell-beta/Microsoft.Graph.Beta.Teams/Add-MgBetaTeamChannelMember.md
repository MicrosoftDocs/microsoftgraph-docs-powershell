...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/add-mgbetateamchannelmember
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: Add-MgBetaTeamChannelMember
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Add-MgTeamChannelMember](/powershell/module/Microsoft.Graph.Teams/Add-MgTeamChannelMember?view=graph-powershell-1.0)
...
```
Add-MgBetaTeamChannelMember -ChannelId <string> -TeamId <string> [-ResponseHeadersVariable <string>]
...
```
Add-MgBetaTeamChannelMember -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Values <IMicrosoftGraphConversationMember[]>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [Add-MgBetaTeamChannelMember](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/add-mgbetateamchannelmember)
