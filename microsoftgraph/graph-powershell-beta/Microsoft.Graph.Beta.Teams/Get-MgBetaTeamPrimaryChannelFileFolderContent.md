...
### Get (Default)
```
Get-MgBetaTeamPrimaryChannelFileFolderContent -TeamId <String> [-Format <String>] -OutFile <String>
...
### GetViaIdentity
```
Get-MgBetaTeamPrimaryChannelFileFolderContent -InputObject <ITeamsIdentity> [-Format <String>]
