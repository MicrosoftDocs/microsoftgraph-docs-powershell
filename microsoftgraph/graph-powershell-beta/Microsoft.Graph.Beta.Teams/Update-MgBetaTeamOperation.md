...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetateamoperation
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaTeamOperation
---
...
```
Update-MgBetaTeamOperation -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaTeamOperation -InputObject <ITeamsIdentity>
 -BodyParameter <IMicrosoftGraphTeamsAsyncOperation> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [Update-MgBetaTeamOperation](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetateamoperation)
