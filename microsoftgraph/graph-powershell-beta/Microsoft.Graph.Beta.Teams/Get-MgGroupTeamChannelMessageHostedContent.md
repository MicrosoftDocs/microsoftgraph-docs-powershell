...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams/get-mggroupteamchannelmessagehostedcontent
schema: 2.0.0
...
### GetViaIdentity1
```
Get-MgGroupTeamChannelMessageHostedContent -InputObject <ITeamsIdentity> -OutFile <String> [-PassThru]
 [<CommonParameters>]
```
