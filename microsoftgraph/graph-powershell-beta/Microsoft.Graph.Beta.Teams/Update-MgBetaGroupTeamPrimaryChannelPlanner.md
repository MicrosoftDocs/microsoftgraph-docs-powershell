...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetagroupteamprimarychannelplanner
schema: 2.0.0
---

# Update-MgBetaGroupTeamPrimaryChannelPlanner
...
```
Update-MgBetaGroupTeamPrimaryChannelPlanner -GroupId <String> [-ResponseHeadersVariable <String>]
...
### Update
```
Update-MgBetaGroupTeamPrimaryChannelPlanner -GroupId <String>
...
```
Update-MgBetaGroupTeamPrimaryChannelPlanner -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-Id <String>] [-Plans <IMicrosoftGraphPlannerPlan[]>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### UpdateViaIdentity
```
Update-MgBetaGroupTeamPrimaryChannelPlanner -InputObject <ITeamsIdentity>
 -BodyParameter <IMicrosoftGraphTeamsChannelPlanner> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
