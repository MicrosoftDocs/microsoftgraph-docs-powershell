...
### Run (Default)
```
Start-MgBetaTeamworkDeviceDiagnostic -TeamworkDeviceId <String> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### RunViaIdentity
```
Start-MgBetaTeamworkDeviceDiagnostic -InputObject <ITeamsIdentity> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
