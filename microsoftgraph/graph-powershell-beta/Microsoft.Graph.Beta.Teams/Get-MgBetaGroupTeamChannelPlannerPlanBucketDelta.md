...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetagroupteamchannelplannerplanbucketdelta
schema: 2.0.0
...
### Delta (Default)
```
Get-MgBetaGroupTeamChannelPlannerPlanBucketDelta -ChannelId <String> -GroupId <String> -PlannerPlanId <String>
...
### DeltaViaIdentity
```
Get-MgBetaGroupTeamChannelPlannerPlanBucketDelta -InputObject <ITeamsIdentity> [-ExpandProperty <String[]>]
