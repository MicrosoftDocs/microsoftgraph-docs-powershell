...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetaunarchiveteamchannel
schema: 2.0.0
ms.subservice: teams
---
...
### Unarchive (Default)
```
Invoke-MgBetaUnarchiveTeamChannel -ChannelId <String> -TeamId <String> [-ResponseHeadersVariable <String>]
...
```
Invoke-MgBetaUnarchiveTeamChannel -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetaunarchiveteamchannel](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetaunarchiveteamchannel)
