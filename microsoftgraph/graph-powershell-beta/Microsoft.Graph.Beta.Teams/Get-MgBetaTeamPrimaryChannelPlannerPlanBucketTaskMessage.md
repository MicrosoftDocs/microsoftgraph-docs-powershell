...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetateamprimarychannelplannerplanbuckettaskmessage
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaTeamPrimaryChannelPlannerPlanBucketTaskMessage
---

# Get-MgBetaTeamPrimaryChannelPlannerPlanBucketTaskMessage
...
```
Get-MgBetaTeamPrimaryChannelPlannerPlanBucketTaskMessage -PlannerBucketId <string>
...
```
Get-MgBetaTeamPrimaryChannelPlannerPlanBucketTaskMessage -InputObject <ITeamsIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
...
- [Get-MgBetaTeamPrimaryChannelPlannerPlanBucketTaskMessage](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetateamprimarychannelplannerplanbuckettaskmessage)
