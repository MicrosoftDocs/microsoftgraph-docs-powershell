...
```
Update-MgBetaGroupTeamTagMember -GroupId <string> -TeamworkTagId <string>
 -TeamworkTagMemberId <string> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaGroupTeamTagMember -GroupId <string> -TeamworkTagId <string>
 -TeamworkTagMemberId <string> -BodyParameter <IMicrosoftGraphTeamworkTagMember>
