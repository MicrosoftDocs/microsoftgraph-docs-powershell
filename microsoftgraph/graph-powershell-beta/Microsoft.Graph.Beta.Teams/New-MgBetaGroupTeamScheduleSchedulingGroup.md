...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetagroupteamscheduleschedulinggroup
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaGroupTeamScheduleSchedulingGroup
---
...
```
New-MgBetaGroupTeamScheduleSchedulingGroup -GroupId <string>
 -BodyParameter <IMicrosoftGraphSchedulingGroup> [-ResponseHeadersVariable <string>] [-Break]
...
New-MgBetaGroupTeamScheduleSchedulingGroup -InputObject <ITeamsIdentity>
 ...
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-UserIds <string[]>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
- [New-MgBetaGroupTeamScheduleSchedulingGroup](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetagroupteamscheduleschedulinggroup)
