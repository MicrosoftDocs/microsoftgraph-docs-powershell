...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/invoke-mgbetagraphchatmessage
schema: 2.0.0
ms.subservice: teams
---
...
```yaml
Type: IPaths1Cmn95OChatsChatIdMessagesMicrosoftGraphReplywithquotePostRequestbodyContentApplicationJsonSchema
