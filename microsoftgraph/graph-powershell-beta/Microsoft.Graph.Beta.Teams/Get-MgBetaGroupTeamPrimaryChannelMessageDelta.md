...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetagroupteamprimarychannelmessagedelta
schema: 2.0.0
ms.subservice: teams
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgGroupTeamPrimaryChannelMessageDelta](/powershell/module/Microsoft.Graph.Teams/Get-MgGroupTeamPrimaryChannelMessageDelta?view=graph-powershell-1.0)

## SYNTAX

### Delta (Default)
```
Get-MgBetaGroupTeamPrimaryChannelMessageDelta -GroupId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### DeltaViaIdentity
```
Get-MgBetaGroupTeamPrimaryChannelMessageDelta -InputObject <ITeamsIdentity> [-ExpandProperty <String[]>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetagroupteamprimarychannelmessagedelta](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/get-mgbetagroupteamprimarychannelmessagedelta)
