...
Get-MgBetaChatMessageHostedContent -ChatId <String> -ChatMessageHostedContentId <String>
 -ChatMessageId <String> [-ResponseHeadersVariable <String>] -OutFile <String> [-Headers <IDictionary>]
...
### GetViaIdentity1
```
Get-MgBetaChatMessageHostedContent -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
...
[https://learn.microsoft.com/graph/api/chatmessagehostedcontent-get?view=graph-rest-beta](https://learn.microsoft.com/graph/api/chatmessagehostedcontent-get?view=graph-rest-beta)
