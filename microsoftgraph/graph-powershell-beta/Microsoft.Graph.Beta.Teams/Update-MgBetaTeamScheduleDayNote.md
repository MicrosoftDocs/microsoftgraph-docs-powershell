...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetateamscheduledaynote
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Update-MgBetaTeamScheduleDayNote
---
...
```
Update-MgBetaTeamScheduleDayNote -DayNoteId <string> -TeamId <string>
...
```
Update-MgBetaTeamScheduleDayNote -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaTeamScheduleDayNote -InputObject <ITeamsIdentity>
 -BodyParameter <IMicrosoftGraphDayNote> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm] [<CommonParameters>]
