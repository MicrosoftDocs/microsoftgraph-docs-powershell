...
Update-MgBetaTeamScheduleTimeOffReason -InputObject <ITeamsIdentity> [-AdditionalProperties <Hashtable>]
 ...
 [-Id <String>] [-IsActive] [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-Headers <IDictionary>]
...
## RELATED LINKS
[Update-MgTeamScheduleTimeOffReason](/powershell/module/Microsoft.Graph.Teams/Update-MgTeamScheduleTimeOffReason?view=graph-powershell-1.0)
