...
### Remove1 (Default)
```
Remove-MgTeamPrimaryChannelEmail -TeamId <String> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### RemoveViaIdentity1
```
Remove-MgTeamPrimaryChannelEmail -InputObject <ITeamsIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
