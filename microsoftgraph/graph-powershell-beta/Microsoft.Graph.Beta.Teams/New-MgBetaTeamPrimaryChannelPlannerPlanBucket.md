...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetateamprimarychannelplannerplanbucket
schema: 2.0.0
---

# New-MgBetaTeamPrimaryChannelPlannerPlanBucket
...
```
New-MgBetaTeamPrimaryChannelPlannerPlanBucket -PlannerPlanId <String> -TeamId <String>
...
```
New-MgBetaTeamPrimaryChannelPlannerPlanBucket -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <String>]
...
### CreateViaIdentity
```
New-MgBetaTeamPrimaryChannelPlannerPlanBucket -InputObject <ITeamsIdentity>
 -BodyParameter <IMicrosoftGraphPlannerBucket> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetateamprimarychannelplannerplanbucket](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetateamprimarychannelplannerplanbucket)
