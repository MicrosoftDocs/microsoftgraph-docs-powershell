...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetauserchatoperation
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaUserChatOperation
---
...
```
New-MgBetaUserChatOperation -ChatId <string> -UserId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaUserChatOperation -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-AttemptsCount <int>] [-CreatedDateTime <datetime>]
 [-Error <IMicrosoftGraphOperationError>] [-Id <string>] [-LastActionDateTime <datetime>]
 [-OperationType <string>] [-Status <string>] [-TargetResourceId <string>]
 [-TargetResourceLocation <string>] [-Break] [-Headers <IDictionary>]
...
```
New-MgBetaUserChatOperation -InputObject <ITeamsIdentity>
 -BodyParameter <IMicrosoftGraphTeamsAsyncOperation> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgBetaUserChatOperation](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetauserchatoperation)
