...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/remove-mgbetateammember
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: Remove-MgBetaTeamMember
---
...
```
Remove-MgBetaTeamMember -TeamId <string> [-ResponseHeadersVariable <string>]
...
```
Remove-MgBetaTeamMember -TeamId <string>
 -BodyParameter <IPaths183Cm6MTeamsTeamIdMembersMicrosoftGraphRemovePostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
...
```
Remove-MgBetaTeamMember -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Values <IMicrosoftGraphConversationMember[]>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```
Remove-MgBetaTeamMember -InputObject <ITeamsIdentity>
 -BodyParameter <IPaths183Cm6MTeamsTeamIdMembersMicrosoftGraphRemovePostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```
Remove-MgBetaTeamMember -InputObject <ITeamsIdentity> [-IfMatch <string>]
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru]
 [-Proxy <uri>] [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths183Cm6MTeamsTeamIdMembersMicrosoftGraphRemovePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths183Cm6MTeamsTeamIdMembersMicrosoftGraphRemovePostRequestbodyContentApplicationJsonSchema
...
- [Remove-MgBetaTeamMember](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/remove-mgbetateammember)
- [Graph API Reference](https://learn.microsoft.com/graph/api/team-delete-members?view=graph-rest-beta)
