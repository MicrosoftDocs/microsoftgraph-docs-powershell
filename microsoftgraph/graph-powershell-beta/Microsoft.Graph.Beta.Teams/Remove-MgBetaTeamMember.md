...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Remove-MgTeamMember](/powershell/module/Microsoft.Graph.Teams/Remove-MgTeamMember?view=graph-powershell-v1.0)

## SYNTAX

### Delete (Default)
```
Remove-MgBetaTeamMember -ConversationMemberId <String> -TeamId <String> [-IfMatch <String>] [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaTeamMember -InputObject <ITeamsIdentity> [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
