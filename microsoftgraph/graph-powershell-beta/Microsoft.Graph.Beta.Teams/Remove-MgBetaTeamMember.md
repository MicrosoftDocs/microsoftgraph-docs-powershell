...
### DeleteViaIdentity
```
Remove-MgBetaTeamMember -InputObject <ITeamsIdentity> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
...
```yaml
Type: IPaths183Cm6MTeamsTeamIdMembersMicrosoftGraphRemovePostRequestbodyContentApplicationJsonSchema
