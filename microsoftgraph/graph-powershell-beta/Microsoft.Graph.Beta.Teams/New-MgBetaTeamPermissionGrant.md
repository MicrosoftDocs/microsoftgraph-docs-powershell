...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetateampermissiongrant
Locale: en-US
Module Name: Microsoft.Graph.Beta.Teams
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaTeamPermissionGrant
---
...
```
New-MgBetaTeamPermissionGrant -TeamId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaTeamPermissionGrant -TeamId <string>
...
```
New-MgBetaTeamPermissionGrant -InputObject <ITeamsIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-ClientAppId <string>] [-ClientId <string>]
 [-DeletedDateTime <datetime>] [-Id <string>] [-Permission <string>] [-PermissionType <string>]
 [-ResourceAppId <string>] [-Break] [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
...
- [New-MgBetaTeamPermissionGrant](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/new-mgbetateampermissiongrant)
