...
### List (Default)
```
Get-MgBetaUserMailFolderMessageRule -MailFolderId <String> -UserId <String> [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgBetaUserMailFolderMessageRule -InputObject <IMailIdentity> [-Property <String[]>] [<CommonParameters>]
```
