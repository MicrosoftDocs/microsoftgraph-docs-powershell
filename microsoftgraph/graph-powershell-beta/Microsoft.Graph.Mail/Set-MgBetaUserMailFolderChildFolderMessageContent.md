...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.mail/set-mgbetausermailfolderchildfoldermessagecontent
schema: 2.0.0
---
...
Set-MgBetaUserMailFolderChildFolderMessageContent -MailFolderId <String> -MailFolderId1 <String>
 -MessageId <String> -UserId <String> [-Data <Stream>] -InFile <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### SetViaIdentity
```
Set-MgBetaUserMailFolderChildFolderMessageContent -InputObject <IMailIdentity> [-Data <Stream>]
