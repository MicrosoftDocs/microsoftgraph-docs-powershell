...
### List (Default)
```
Get-MgBetaEducationClassAssignmentSubmissionOutcome -EducationAssignmentId <String> -EducationClassId <String>
...
### GetViaIdentity
```
Get-MgBetaEducationClassAssignmentSubmissionOutcome -InputObject <IEducationIdentity>
