...
Remove-MgEducationSynchronizationProfileError -EducationSynchronizationErrorId <String>
 -EducationSynchronizationProfileId <String> [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgEducationSynchronizationProfileError -InputObject <IEducationIdentity> [-IfMatch <String>] [-PassThru]
