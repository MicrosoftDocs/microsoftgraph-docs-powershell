...
### Delta (Default)
```
Get-MgEducationUserAssignmentDelta -EducationUserId <String> [<CommonParameters>]
```

### DeltaViaIdentity
```
Get-MgEducationUserAssignmentDelta -InputObject <IEducationIdentity> [<CommonParameters>]
```
