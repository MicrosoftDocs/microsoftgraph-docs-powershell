...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.education/remove-mgbetaeducationuserassignmentrubric
schema: 2.0.0
ms.prod: education
---
...
### Delete (Default)
```
Remove-MgBetaEducationUserAssignmentRubric -EducationAssignmentId <String> -EducationUserId <String>
 [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaEducationUserAssignmentRubric -InputObject <IEducationIdentity> [-IfMatch <String>] [-PassThru]
