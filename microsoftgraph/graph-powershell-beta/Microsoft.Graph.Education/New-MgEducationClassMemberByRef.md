...
### Create1 (Default)
```
New-MgEducationClassMemberByRef -EducationClassId <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### CreateViaIdentity1
```
New-MgEducationClassMemberByRef -InputObject <IEducationIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
