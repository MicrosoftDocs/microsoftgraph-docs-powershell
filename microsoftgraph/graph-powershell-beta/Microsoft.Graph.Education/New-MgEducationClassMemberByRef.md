...
```
New-MgEducationClassMemberByRef -EducationClassId <String> [-AdditionalProperties <Hashtable>] [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Create1
```
New-MgEducationClassMemberByRef -EducationClassId <String> -BodyParameter <Hashtable> [-PassThru] [-WhatIf]
...
### CreateViaIdentity1
```
New-MgEducationClassMemberByRef -InputObject <IEducationIdentity> -BodyParameter <Hashtable> [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
