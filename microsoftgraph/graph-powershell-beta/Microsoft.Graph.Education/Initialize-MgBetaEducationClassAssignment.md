...
### Activate (Default)
```
Initialize-MgBetaEducationClassAssignment -EducationAssignmentId <String> -EducationClassId <String> [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### ActivateViaIdentity
```
Initialize-MgBetaEducationClassAssignment -InputObject <IEducationIdentity> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
