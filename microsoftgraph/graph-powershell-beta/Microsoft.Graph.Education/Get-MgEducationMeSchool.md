...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.education/get-mgeducationmeschool
schema: 2.0.0
---
...
### List (Default)
```
Get-MgEducationMeSchool [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
