...
### Delete (Default)
```
Remove-MgBetaEducationClass -EducationClassId <String> [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaEducationClass -InputObject <IEducationIdentity> [-IfMatch <String>] [-PassThru] [-WhatIf]
