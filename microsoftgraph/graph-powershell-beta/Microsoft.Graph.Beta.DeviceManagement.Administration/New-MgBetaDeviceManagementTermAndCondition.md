...
```
New-MgBetaDeviceManagementTermAndCondition [-ResponseHeadersVariable <String>] [-AcceptanceStatement <String>]
 ...
 [-Title <String>] [-Version <Int32>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
