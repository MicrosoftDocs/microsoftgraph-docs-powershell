...
```
Get-MgBetaDeviceManagementVirtualEndpointBulkAction [-ExpandProperty <string[]>]
...
```
Get-MgBetaDeviceManagementVirtualEndpointBulkAction -CloudPcBulkActionId <string>
