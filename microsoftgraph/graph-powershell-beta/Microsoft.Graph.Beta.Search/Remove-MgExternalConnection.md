...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.search/remove-mgexternalconnection
schema: 2.0.0
---
...
### Example 1: Using the Remove-MgExternalConnection Cmdlet
```powershell
