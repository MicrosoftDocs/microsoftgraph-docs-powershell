...
### Get (Default)
```
Get-MgBetaExternalConnectionOperationCount -ExternalConnectionId <String> [-Filter <String>] [-Search <String>]
...
### GetViaIdentity
```
Get-MgBetaExternalConnectionOperationCount -InputObject <ISearchIdentity> [-Filter <String>] [-Search <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
