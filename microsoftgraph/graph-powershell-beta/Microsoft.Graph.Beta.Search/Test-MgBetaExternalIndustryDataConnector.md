...
### Validate (Default)
```
Test-MgBetaExternalIndustryDataConnector -IndustryDataConnectorId <String> [-ResponseHeadersVariable <String>]
...
### ValidateViaIdentity
```
Test-MgBetaExternalIndustryDataConnector -InputObject <ISearchIdentity> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
