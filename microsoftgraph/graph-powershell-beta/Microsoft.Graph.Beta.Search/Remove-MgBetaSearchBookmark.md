...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.search/remove-mgbetasearchbookmark
Locale: en-US
Module Name: Microsoft.Graph.Beta.Search
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: Remove-MgBetaSearchBookmark
---
...
```
Remove-MgBetaSearchBookmark -BookmarkId <string> [-IfMatch <string>]
...
- [Remove-MgBetaSearchBookmark](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.search/remove-mgbetasearchbookmark)
- [Graph API Reference](https://learn.microsoft.com/graph/api/search-bookmark-delete?view=graph-rest-beta)
