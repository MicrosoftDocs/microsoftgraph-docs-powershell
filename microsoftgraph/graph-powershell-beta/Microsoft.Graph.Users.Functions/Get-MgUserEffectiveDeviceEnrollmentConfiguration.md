...
### Get (Default)
```
Get-MgUserEffectiveDeviceEnrollmentConfiguration -UserId <String> [-Count] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgUserEffectiveDeviceEnrollmentConfiguration -InputObject <IUsersFunctionsIdentity> [-Count]
