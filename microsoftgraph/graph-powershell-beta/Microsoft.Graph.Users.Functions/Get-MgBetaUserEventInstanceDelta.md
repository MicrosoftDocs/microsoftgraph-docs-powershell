...
### Delta (Default)
```
Get-MgBetaUserEventInstanceDelta -EventId <String> -UserId <String> [-Filter <String>] [-Property <String[]>]
...
### DeltaViaIdentity
```
Get-MgBetaUserEventInstanceDelta -InputObject <IUsersFunctionsIdentity> [-Filter <String>]
