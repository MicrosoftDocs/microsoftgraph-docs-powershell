...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.functions/get-mguserplannerplandelta
schema: 2.0.0
---

# Get-MgUserPlannerPlanDelta
...
### Delta (Default)
```
Get-MgUserPlannerPlanDelta -UserId <String> [-Filter <String>] [-Property <String[]>] [-Search <String>]
...
### DeltaViaIdentity
```
Get-MgUserPlannerPlanDelta -InputObject <IUsersFunctionsIdentity> [-Filter <String>] [-Property <String[]>]
