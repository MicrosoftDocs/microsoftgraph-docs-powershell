...
### Delta1
```
Get-MgBetaUserDriveListItemDelta -DriveId <String> -UserId <String> -Token <String> [-Filter <String>]
...
### DeltaViaIdentity1
```
Get-MgBetaUserDriveListItemDelta -InputObject <IUsersFunctionsIdentity> [-Filter <String>]
