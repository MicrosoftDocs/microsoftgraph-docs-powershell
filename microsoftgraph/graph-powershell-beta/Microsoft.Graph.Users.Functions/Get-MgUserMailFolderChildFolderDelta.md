...
### Delta1 (Default)
```
Get-MgUserMailFolderChildFolderDelta -MailFolderId <String> -UserId <String> [<CommonParameters>]
```

### DeltaViaIdentity1
```
Get-MgUserMailFolderChildFolderDelta -InputObject <IUsersFunctionsIdentity> [<CommonParameters>]
```
