...
### Delta1
```
Get-MgUserDriveListItemDelta -DriveId <String> -UserId <String> -Token <String> [-Filter <String>]
...
### DeltaViaIdentity1
```
Get-MgUserDriveListItemDelta -InputObject <IUsersFunctionsIdentity> [-Filter <String>] [-Property <String[]>]
