...
### Get (Default)
```
Get-MgBetaUserCloudPcShiftWorkCloudPcAccessState -CloudPcId <String> -UserId <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaUserCloudPcShiftWorkCloudPcAccessState -InputObject <IUsersFunctionsIdentity> [<CommonParameters>]
```
