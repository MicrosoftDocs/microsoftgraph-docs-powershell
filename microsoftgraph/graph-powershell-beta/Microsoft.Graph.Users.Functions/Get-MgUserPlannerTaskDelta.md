...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.functions/get-mguserplannertaskdelta
schema: 2.0.0
---

# Get-MgUserPlannerTaskDelta
...
### Delta (Default)
```
Get-MgUserPlannerTaskDelta -UserId <String> [-Filter <String>] [-Property <String[]>] [-Search <String>]
...
### DeltaViaIdentity
```
Get-MgUserPlannerTaskDelta -InputObject <IUsersFunctionsIdentity> [-Filter <String>] [-Property <String[]>]
