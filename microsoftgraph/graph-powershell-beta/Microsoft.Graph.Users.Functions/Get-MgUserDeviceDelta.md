...
### Delta (Default)
```
Get-MgUserDeviceDelta -UserId <String> [-Filter <String>] [-Property <String[]>] [-Search <String>]
...
### DeltaViaIdentity
```
Get-MgUserDeviceDelta -InputObject <IUsersFunctionsIdentity> [-Filter <String>] [-Property <String[]>]
