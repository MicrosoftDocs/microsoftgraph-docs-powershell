...
# Remove-MgBetaAdminConfigurationManagementConfigurationMonitoringResult
...
```
Remove-MgBetaAdminConfigurationManagementConfigurationMonitoringResult
 -ConfigurationMonitoringResultId <string> [-IfMatch <string>] [-ResponseHeadersVariable <string>]
