...
# Update-MgBetaAdminConfigurationManagementConfigurationDrift
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgAdminConfigurationManagementConfigurationDrift](/powershell/module/Microsoft.Graph.ConfigurationManagement/Update-MgAdminConfigurationManagementConfigurationDrift?view=graph-powershell-1.0)
...
```
Update-MgBetaAdminConfigurationManagementConfigurationDrift -ConfigurationDriftId <string>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-Id <string>]
 [-ResourceInstanceIdentifier <hashtable>] [-Status <DriftStatus>] [-Break] [-Headers <IDictionary>]
...
```
Update-MgBetaAdminConfigurationManagementConfigurationDrift -ConfigurationDriftId <string>
 -BodyParameter <IMicrosoftGraphConfigurationDrift> [-ResponseHeadersVariable <string>] [-Break]
...
Update-MgBetaAdminConfigurationManagementConfigurationDrift
 ...
 [-AdditionalProperties <hashtable>] [-Id <string>] [-ResourceInstanceIdentifier <hashtable>]
 [-Status <DriftStatus>] [-Break] [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
```
Update-MgBetaAdminConfigurationManagementConfigurationDrift
 -InputObject <IConfigurationManagementIdentity> -BodyParameter <IMicrosoftGraphConfigurationDrift>
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphConfigurationDrift
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Support.DriftStatus
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphConfigurationDrift
