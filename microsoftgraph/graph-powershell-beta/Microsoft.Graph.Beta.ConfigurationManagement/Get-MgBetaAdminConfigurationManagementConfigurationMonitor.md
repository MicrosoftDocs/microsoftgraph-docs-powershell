...
```
Get-MgBetaAdminConfigurationManagementConfigurationMonitor [-ExpandProperty <string[]>]
...
```
Get-MgBetaAdminConfigurationManagementConfigurationMonitor -ConfigurationMonitorId <string>
