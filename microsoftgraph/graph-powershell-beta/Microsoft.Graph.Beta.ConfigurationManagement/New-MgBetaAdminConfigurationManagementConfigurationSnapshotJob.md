...
# New-MgBetaAdminConfigurationManagementConfigurationSnapshotJob
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgAdminConfigurationManagementConfigurationSnapshotJob](/powershell/module/Microsoft.Graph.ConfigurationManagement/New-MgAdminConfigurationManagementConfigurationSnapshotJob?view=graph-powershell-1.0)
...
```
New-MgBetaAdminConfigurationManagementConfigurationSnapshotJob [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-CreatedBy <IMicrosoftGraphIdentitySet>]
 [-Description <string>] [-DisplayName <string>] [-Id <string>] [-Resources <string[]>]
 [-Status <SnapshotJobStatus>] [-Break] [-Headers <IDictionary>]
...
```
New-MgBetaAdminConfigurationManagementConfigurationSnapshotJob
 -BodyParameter <IMicrosoftGraphConfigurationSnapshotJob> [-ResponseHeadersVariable <string>]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphConfigurationSnapshotJob
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Support.SnapshotJobStatus
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
