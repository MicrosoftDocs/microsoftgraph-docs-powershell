...
### Set1 (Default)
```
Set-MgSiteOnenotePageContent -OnenotePageId <String> -SiteId <String> [-BodyParameter <Stream>]
 -InFile <String> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### SetViaIdentity1
```
Set-MgSiteOnenotePageContent -InputObject <INotesIdentity> [-BodyParameter <Stream>] -InFile <String>
