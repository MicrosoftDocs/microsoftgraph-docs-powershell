...
### Create1
```
New-MgUserOnenoteNotebook -UserId <String> -BodyParameter <IMicrosoftGraphNotebook1> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity1
```
New-MgUserOnenoteNotebook -InputObject <INotesIdentity> -BodyParameter <IMicrosoftGraphNotebook1> [-Confirm]
