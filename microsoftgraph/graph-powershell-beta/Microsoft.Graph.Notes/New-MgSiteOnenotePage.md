...
### Create1
```
New-MgSiteOnenotePage -SiteId <String> -BodyParameter <IMicrosoftGraphOnenotePage1> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### CreateViaIdentity1
```
New-MgSiteOnenotePage -InputObject <INotesIdentity> -BodyParameter <IMicrosoftGraphOnenotePage1> [-WhatIf]
