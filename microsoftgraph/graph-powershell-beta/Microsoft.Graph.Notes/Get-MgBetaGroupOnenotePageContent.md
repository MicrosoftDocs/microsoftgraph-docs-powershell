...
### Get (Default)
```
Get-MgBetaGroupOnenotePageContent -GroupId <String> -OnenotePageId <String> -OutFile <String> [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaGroupOnenotePageContent -InputObject <INotesIdentity> -OutFile <String> [-PassThru]
 [<CommonParameters>]
```
