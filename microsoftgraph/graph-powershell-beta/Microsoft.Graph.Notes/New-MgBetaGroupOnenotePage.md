...
```
New-MgBetaGroupOnenotePage -GroupId <String> [-AdditionalProperties <Hashtable>] [-ContentInputFile <String>]
...
### Create
```
New-MgBetaGroupOnenotePage -GroupId <String> -BodyParameter <IMicrosoftGraphOnenotePage> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgBetaGroupOnenotePage -InputObject <INotesIdentity> [-AdditionalProperties <Hashtable>]
...
### CreateViaIdentity
```
New-MgBetaGroupOnenotePage -InputObject <INotesIdentity> -BodyParameter <IMicrosoftGraphOnenotePage> [-WhatIf]
