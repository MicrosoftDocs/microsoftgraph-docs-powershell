...
### Create1
```
New-MgSiteOnenoteNotebook -SiteId <String> -BodyParameter <IMicrosoftGraphNotebook1> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### CreateViaIdentity1
```
New-MgSiteOnenoteNotebook -InputObject <INotesIdentity> -BodyParameter <IMicrosoftGraphNotebook1> [-WhatIf]
