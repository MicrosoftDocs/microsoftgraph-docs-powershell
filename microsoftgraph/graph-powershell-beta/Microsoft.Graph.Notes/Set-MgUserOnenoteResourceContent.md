...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.notes/set-mguseronenoteresourcecontent
schema: 2.0.0
---
...
### Set1 (Default)
```
Set-MgUserOnenoteResourceContent -OnenoteResourceId <String> -UserId <String> [-BodyParameter <Stream>]
 -InFile <String> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### SetViaIdentity1
```
Set-MgUserOnenoteResourceContent -InputObject <INotesIdentity> [-BodyParameter <Stream>] -InFile <String>
