...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetagrouponenotesection
schema: 2.0.0
ms.prod: onenote
---

# Update-MgBetaGroupOnenoteSection
...
```
Update-MgBetaGroupOnenoteSection -GroupId <String> -OnenoteSectionId <String>
...
```
Update-MgBetaGroupOnenoteSection -InputObject <INotesIdentity> [-AdditionalProperties <Hashtable>]
...
### UpdateViaIdentity
```
Update-MgBetaGroupOnenoteSection -InputObject <INotesIdentity> -BodyParameter <IMicrosoftGraphOnenoteSection>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetagrouponenotesection](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetagrouponenotesection)
