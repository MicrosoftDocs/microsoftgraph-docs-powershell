...
### Set (Default)
```
Set-MgBetaSiteOnenoteResourceContent -OnenoteResourceId <String> -SiteId <String> [-Data <Stream>]
 -InFile <String> [-WhatIf] [-Confirm] [<CommonParameters>]
```

### SetViaIdentity
```
Set-MgBetaSiteOnenoteResourceContent -InputObject <INotesIdentity> [-Data <Stream>] -InFile <String> [-WhatIf]
