...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.financials/new-mgbetafinancialcompanyvendor
Locale: en-US
Module Name: Microsoft.Graph.Beta.Financials
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaFinancialCompanyVendor
---
...
New-MgBetaFinancialCompanyVendor -CompanyId <string> [-ResponseHeadersVariable <string>]
 ...
 [-Balance <decimal>] [-Blocked <string>] [-Currency <IMicrosoftGraphCurrency>]
 [-CurrencyCode <string>] [-CurrencyId <string>] [-DisplayName <string>] [-Email <string>]
 [-Id <string>] [-LastModifiedDateTime <datetime>] [-Number <string>]
...
```
New-MgBetaFinancialCompanyVendor -InputObject <IFinancialsIdentity>
...
- [New-MgBetaFinancialCompanyVendor](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.financials/new-mgbetafinancialcompanyvendor)
