...
Remove-MgBetaFinancialCompanySaleInvoiceLineItemPicture -CompanyId <String> -PictureId <String>
 -SalesInvoiceLineId <String> [-IfMatch <String>] [-Headers <IDictionary>] [-PassThru]
...
```
Remove-MgBetaFinancialCompanySaleInvoiceLineItemPicture -CompanyId <String> -PictureId <String>
 -SalesInvoiceLineId <String> -SalesInvoiceId <String> [-IfMatch <String>] [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
