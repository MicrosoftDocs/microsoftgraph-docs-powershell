...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.financials/update-mgbetafinancialcompanycustomerpaymentjournalcustomerpaymentcustomer
Locale: en-US
Module Name: Microsoft.Graph.Beta.Financials
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaFinancialCompanyCustomerPaymentJournalCustomerPaymentCustomer
---
...
Update-MgBetaFinancialCompanyCustomerPaymentJournalCustomerPaymentCustomer -CompanyId <string>
 ...
 [-Blocked <string>] [-Currency <IMicrosoftGraphCurrency>] [-CurrencyCode <string>]
 [-CurrencyId <string>] [-DisplayName <string>] [-Email <string>] [-Id <string>]
...
```
Update-MgBetaFinancialCompanyCustomerPaymentJournalCustomerPaymentCustomer
 -InputObject <IFinancialsIdentity> -BodyParameter <IMicrosoftGraphCustomer>
...
- [Update-MgBetaFinancialCompanyCustomerPaymentJournalCustomerPaymentCustomer](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.financials/update-mgbetafinancialcompanycustomerpaymentjournalcustomerpaymentcustomer)
