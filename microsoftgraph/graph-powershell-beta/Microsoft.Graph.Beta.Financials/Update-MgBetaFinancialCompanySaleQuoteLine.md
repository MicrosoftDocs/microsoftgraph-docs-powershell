...
Update-MgBetaFinancialCompanySaleQuoteLine -CompanyId <string> -SalesQuoteLineId <string>
 ...
 [-DiscountPercent <decimal>] [-DocumentId <string>] [-Id <string>] [-Item <IMicrosoftGraphItem>]
 [-ItemId <string>] [-LineType <string>] [-NetAmount <decimal>] [-NetAmountIncludingTax <decimal>]
 [-NetTaxAmount <decimal>] [-Quantity <decimal>] [-Sequence <int>] [-TaxCode <string>]
 [-TaxPercent <decimal>] [-TotalTaxAmount <decimal>] [-UnitOfMeasureId <string>]
...
Update-MgBetaFinancialCompanySaleQuoteLine -CompanyId <string> -SalesQuoteLineId <string>
 ...
 [-UnitOfMeasureId <string>] [-UnitPrice <decimal>] [-Break] [-Headers <IDictionary>]
...
```
Update-MgBetaFinancialCompanySaleQuoteLine -CompanyId <string> -SalesQuoteLineId <string>
 -SalesQuoteId <string> -BodyParameter <IMicrosoftGraphSalesQuoteLine>
...
```
Update-MgBetaFinancialCompanySaleQuoteLine -CompanyId <string> -SalesQuoteLineId <string>
 -BodyParameter <IMicrosoftGraphSalesQuoteLine> [-ResponseHeadersVariable <string>] [-Break]
