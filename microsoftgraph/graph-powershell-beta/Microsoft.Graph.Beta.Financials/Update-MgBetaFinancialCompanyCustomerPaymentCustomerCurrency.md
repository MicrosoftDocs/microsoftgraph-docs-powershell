...
```
Update-MgBetaFinancialCompanyCustomerPaymentCustomerCurrency -CompanyId <string>
 -CustomerPaymentId <string> [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
...
```
Update-MgBetaFinancialCompanyCustomerPaymentCustomerCurrency -CompanyId <string>
 -CustomerPaymentId <string> -BodyParameter <IMicrosoftGraphCurrency>
