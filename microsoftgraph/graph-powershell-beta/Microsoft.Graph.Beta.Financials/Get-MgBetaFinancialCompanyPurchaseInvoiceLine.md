...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.financials/get-mgbetafinancialcompanypurchaseinvoiceline
Locale: en-US
Module Name: Microsoft.Graph.Beta.Financials
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaFinancialCompanyPurchaseInvoiceLine
---
...
```
Get-MgBetaFinancialCompanyPurchaseInvoiceLine -InputObject <IFinancialsIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
...
- [Get-MgBetaFinancialCompanyPurchaseInvoiceLine](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.financials/get-mgbetafinancialcompanypurchaseinvoiceline)
