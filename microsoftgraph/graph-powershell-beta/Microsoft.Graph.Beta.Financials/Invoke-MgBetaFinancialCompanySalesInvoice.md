...
### Post (Default)
```
Invoke-MgBetaFinancialCompanySalesInvoice -CompanyId <String> -SalesInvoiceId <String> [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### PostViaIdentity
```
Invoke-MgBetaFinancialCompanySalesInvoice -InputObject <IFinancialsIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
