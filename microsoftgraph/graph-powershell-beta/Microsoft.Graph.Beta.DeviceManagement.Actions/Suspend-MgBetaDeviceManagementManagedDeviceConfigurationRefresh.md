...
```
Suspend-MgBetaDeviceManagementManagedDeviceConfigurationRefresh -InputObject <IDeviceManagementActionsIdentity>
 [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>] [-PauseTimePeriodInMinutes <Int32>]
 [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```yaml
Type: IPaths18Ks7VwDevicemanagementManageddevicesManageddeviceIdMicrosoftGraphPauseconfigurationrefreshPostRequestbodyContentApplicationJsonSchema
