...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Invoke-MgRotateDeviceManagementManagedDeviceFileVaultKey](/powershell/module/Microsoft.Graph.DeviceManagement.Actions/Invoke-MgRotateDeviceManagementManagedDeviceFileVaultKey?view=graph-powershell-v1.0)

## SYNTAX

### Rotate (Default)
```
Invoke-MgBetaRotateDeviceManagementManagedDeviceFileVaultKey -ManagedDeviceId <String> [-PassThru] [-WhatIf]
