...
### Lock (Default)
```
Lock-MgBetaDeviceManagementComanagedDeviceRemote -ManagedDeviceId <String> [-ResponseHeadersVariable <String>]
...
### LockViaIdentity
```
Lock-MgBetaDeviceManagementComanagedDeviceRemote -InputObject <IDeviceManagementActionsIdentity>
