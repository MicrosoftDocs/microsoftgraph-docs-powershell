...
### Reboot (Default)
```
Restart-MgBetaDeviceManagementComanagedDeviceNow -ManagedDeviceId <String> [-Headers <IDictionary>] [-PassThru]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/restart-mgbetadevicemanagementcomanageddevicenow](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/restart-mgbetadevicemanagementcomanageddevicenow)
