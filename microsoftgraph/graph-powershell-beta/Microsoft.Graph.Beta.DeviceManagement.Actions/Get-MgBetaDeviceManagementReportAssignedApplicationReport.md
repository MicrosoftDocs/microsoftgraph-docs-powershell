...
```
Get-MgBetaDeviceManagementReportAssignedApplicationReport -OutFile <String> [-ResponseHeadersVariable <String>]
...
### Retrieve
```
Get-MgBetaDeviceManagementReportAssignedApplicationReport -OutFile <String>
...
```yaml
Type: IPathsRsc767DevicemanagementReportsMicrosoftGraphRetrieveassignedapplicationsreportPostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.Beta.PowerShell.Models.IPathsRsc767DevicemanagementReportsMicrosoftGraphRetrieveassignedapplicationsreportPostRequestbodyContentApplicationJsonSchema
