...
### Recover (Default)
```
Restore-MgBetaDeviceManagementManagedDevicePasscode -ManagedDeviceId <String> [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### RecoverViaIdentity
```
Restore-MgBetaDeviceManagementManagedDevicePasscode -InputObject <IDeviceManagementActionsIdentity>
