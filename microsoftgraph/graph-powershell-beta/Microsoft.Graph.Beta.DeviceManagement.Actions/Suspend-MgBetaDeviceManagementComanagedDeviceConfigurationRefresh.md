...
Suspend-MgBetaDeviceManagementComanagedDeviceConfigurationRefresh
 ...
 [-PauseTimePeriodInMinutes <Int32>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```yaml
Type: IPaths1C770VqDevicemanagementComanageddevicesManageddeviceIdMicrosoftGraphPauseconfigurationrefreshPostRequestbodyContentApplicationJsonSchema
