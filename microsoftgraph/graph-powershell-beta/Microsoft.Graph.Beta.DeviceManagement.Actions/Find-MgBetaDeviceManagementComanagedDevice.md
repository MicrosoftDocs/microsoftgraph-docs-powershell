...
### Locate (Default)
```
Find-MgBetaDeviceManagementComanagedDevice -ManagedDeviceId <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### LocateViaIdentity
```
Find-MgBetaDeviceManagementComanagedDevice -InputObject <IDeviceManagementActionsIdentity> [-PassThru]
