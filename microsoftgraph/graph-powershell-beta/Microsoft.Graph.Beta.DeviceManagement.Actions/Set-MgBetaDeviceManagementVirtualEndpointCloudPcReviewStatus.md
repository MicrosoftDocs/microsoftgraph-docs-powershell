...
### SetExpanded (Default)
```
Set-MgBetaDeviceManagementVirtualEndpointCloudPcReviewStatus -CloudPcId <String>
...
```
Set-MgBetaDeviceManagementVirtualEndpointCloudPcReviewStatus -CloudPcId <String>
 -BodyParameter <IPaths1O7DokaDevicemanagementVirtualendpointCloudpcsCloudpcIdMicrosoftGraphSetreviewstatusPostRequestbodyContentApplicationJsonSchema>
...
```
Set-MgBetaDeviceManagementVirtualEndpointCloudPcReviewStatus -InputObject <IDeviceManagementActionsIdentity>
 [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>]
 [-ReviewStatus <IMicrosoftGraphCloudPcReviewStatus>] [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```yaml
Type: IPaths1O7DokaDevicemanagementVirtualendpointCloudpcsCloudpcIdMicrosoftGraphSetreviewstatusPostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths1O7DokaDevicemanagementVirtualendpointCloudpcsCloudpcIdMicrosoftGraphSetreviewstatusPostRequestbodyContentApplicationJsonSchema
