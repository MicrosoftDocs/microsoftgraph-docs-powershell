...
### Get (Default)
```
Get-MgBetaDeviceManagementElevationRequest -PrivilegeManagementElevationRequestId <String> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDeviceManagementElevationRequest -InputObject <IDeviceManagementActionsIdentity> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/get-mgbetadevicemanagementelevationrequest](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/get-mgbetadevicemanagementelevationrequest)
