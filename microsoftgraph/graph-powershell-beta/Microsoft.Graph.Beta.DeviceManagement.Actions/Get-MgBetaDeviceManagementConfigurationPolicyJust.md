...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/get-mgbetadevicemanagementconfigurationpolicyjust
schema: 2.0.0
---
...
### Retrieve (Default)
```
Get-MgBetaDeviceManagementConfigurationPolicyJust -DeviceManagementConfigurationPolicyId <String>
...
### RetrieveViaIdentity
```
Get-MgBetaDeviceManagementConfigurationPolicyJust -InputObject <IDeviceManagementActionsIdentity>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphDeviceManagementConfigurationJustInTimeAssignmentPolicy
## NOTES
