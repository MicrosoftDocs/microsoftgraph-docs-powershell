...
Deny-MgBetaDeviceManagementElevationRequest -PrivilegeManagementElevationRequestId <String>
 [-AdditionalProperties <Hashtable>] [-ReviewerJustification <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```yaml
Type: IPaths1Sy0ZovDevicemanagementElevationrequestsPrivilegemanagementelevationrequestIdMicrosoftGraphDenyPostRequestbodyContentApplicationJsonSchema
Parameter Sets: Deny
Aliases:
...
Parameter Sets: DenyViaIdentityExpanded, DenyViaIdentity
Aliases:
...
```yaml
Type: String
Parameter Sets: DenyExpanded, Deny
Aliases:
