...
Set-MgBetaDeviceManagementWindowsQualityUpdateProfile -WindowsQualityUpdateProfileId <String>
 ...
 [-Assignments <IMicrosoftGraphWindowsQualityUpdateProfileAssignment[]>] [-Headers <IDictionary>] [-PassThru]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/set-mgbetadevicemanagementwindowsqualityupdateprofile](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/set-mgbetadevicemanagementwindowsqualityupdateprofile)
