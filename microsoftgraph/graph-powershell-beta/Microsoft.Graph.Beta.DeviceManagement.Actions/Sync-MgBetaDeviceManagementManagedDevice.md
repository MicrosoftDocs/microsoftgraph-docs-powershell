...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Sync-MgDeviceManagementManagedDevice](/powershell/module/Microsoft.Graph.DeviceManagement.Actions/Sync-MgDeviceManagementManagedDevice?view=graph-powershell-1.0)

## SYNTAX

### Sync (Default)
```
Sync-MgBetaDeviceManagementManagedDevice -ManagedDeviceId <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### SyncViaIdentity
```
Sync-MgBetaDeviceManagementManagedDevice -InputObject <IDeviceManagementActionsIdentity> [-PassThru] [-WhatIf]
