...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/update-mgbetauserauthenticationqrcodepinmethodtemporaryqrcode
schema: 2.0.0
---

# Update-MgBetaUserAuthenticationQrCodePinMethodTemporaryQrCode
...
```
Update-MgBetaUserAuthenticationQrCodePinMethodTemporaryQrCode -UserId <String>
 [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>] [-CreatedDateTime <DateTime>]
 [-ExpireDateTime <DateTime>] [-Id <String>] [-Image <IMicrosoftGraphQrCodeImageDetails>]
 [-LastUsedDateTime <DateTime>] [-StartDateTime <DateTime>] [-Headers <IDictionary>]
...
```
Update-MgBetaUserAuthenticationQrCodePinMethodTemporaryQrCode -UserId <String>
 -BodyParameter <IMicrosoftGraphQrCode> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgBetaUserAuthenticationQrCodePinMethodTemporaryQrCode -InputObject <IIdentitySignInsIdentity>
 [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>] [-CreatedDateTime <DateTime>]
 [-ExpireDateTime <DateTime>] [-Id <String>] [-Image <IMicrosoftGraphQrCodeImageDetails>]
 [-LastUsedDateTime <DateTime>] [-StartDateTime <DateTime>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
...
```yaml
Type: IMicrosoftGraphQrCodeImageDetails
Parameter Sets: UpdateExpanded, UpdateViaIdentityExpanded
Aliases:
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/update-mgbetauserauthenticationqrcodepinmethodtemporaryqrcode](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/update-mgbetauserauthenticationqrcodepinmethodtemporaryqrcode)
