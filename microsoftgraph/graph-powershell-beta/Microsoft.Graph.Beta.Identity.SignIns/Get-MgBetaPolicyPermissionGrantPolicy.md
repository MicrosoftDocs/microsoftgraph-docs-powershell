...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/get-mgbetapolicypermissiongrantpolicy
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.SignIns
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaPolicyPermissionGrantPolicy
---
...
```
Get-MgBetaPolicyPermissionGrantPolicy [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaPolicyPermissionGrantPolicy -InputObject <IIdentitySignInsIdentity>
...
- [Get-MgBetaPolicyPermissionGrantPolicy](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/get-mgbetapolicypermissiongrantpolicy)
- [Graph API Reference](https://learn.microsoft.com/graph/api/permissiongrantpolicy-get?view=graph-rest-beta)
- [Graph API Reference](https://learn.microsoft.com/graph/api/permissiongrantpolicy-list?view=graph-rest-beta)
