...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/get-mgbetauserauthenticationfido2methodcount
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.SignIns
ms.date: 06/17/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaUserAuthenticationFido2MethodCount
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgUserAuthenticationFido2MethodCount](/powershell/module/Microsoft.Graph.Identity.SignIns/Get-MgUserAuthenticationFido2MethodCount?view=graph-powershell-1.0)
...
```
Get-MgBetaUserAuthenticationFido2MethodCount -InputObject <IIdentitySignInsIdentity>
...
| --------------- | ------------------------------------------  |
| Delegated (work or school account) | UserAuthenticationMethod.Read, UserAuthenticationMethod.ReadWrite, UserAuthMethod-Passkey.Read, UserAuthMethod-Passkey.Read.All, UserAuthMethod-Passkey.ReadWrite,  |
...
- [Get-MgBetaUserAuthenticationFido2MethodCount](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/get-mgbetauserauthenticationfido2methodcount)
