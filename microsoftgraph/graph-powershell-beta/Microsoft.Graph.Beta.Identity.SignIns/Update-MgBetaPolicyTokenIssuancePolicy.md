...
```
Update-MgBetaPolicyTokenIssuancePolicy -TokenIssuancePolicyId <String> [-ResponseHeadersVariable <String>]
...
[https://learn.microsoft.com/graph/api/tokenissuancepolicy-update?view=graph-rest-beta](https://learn.microsoft.com/graph/api/tokenissuancepolicy-update?view=graph-rest-beta)
