...
# New-MgBetaIdentityRiskPreventionWebApplicationFirewallProvider
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgIdentityRiskPreventionWebApplicationFirewallProvider](/powershell/module/Microsoft.Graph.Identity.SignIns/New-MgIdentityRiskPreventionWebApplicationFirewallProvider?view=graph-powershell-1.0)
...
```
New-MgBetaIdentityRiskPreventionWebApplicationFirewallProvider [-ResponseHeadersVariable <string>]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphWebApplicationFirewallProvider
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
