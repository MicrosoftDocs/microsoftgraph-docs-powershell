...
### List (Default)
```
Get-MgBetaPolicyPermissionGrantPreApprovalPolicy [-ExpandProperty <String[]>] [-Property <String[]>]
...
### Get
```
Get-MgBetaPolicyPermissionGrantPreApprovalPolicy -PermissionGrantPreApprovalPolicyId <String>
...
### GetViaIdentity
```
Get-MgBetaPolicyPermissionGrantPreApprovalPolicy -InputObject <IIdentitySignInsIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/get-mgbetapolicypermissiongrantpreapprovalpolicy](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/get-mgbetapolicypermissiongrantpreapprovalpolicy)
