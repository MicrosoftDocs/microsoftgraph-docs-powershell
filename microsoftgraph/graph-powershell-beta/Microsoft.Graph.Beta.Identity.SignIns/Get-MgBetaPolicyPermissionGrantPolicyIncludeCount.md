...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/get-mgbetapolicypermissiongrantpolicyincludecount
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.SignIns
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaPolicyPermissionGrantPolicyIncludeCount
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgPolicyPermissionGrantPolicyIncludeCount](/powershell/module/Microsoft.Graph.Identity.SignIns/Get-MgPolicyPermissionGrantPolicyIncludeCount?view=graph-powershell-1.0)
...
```
Get-MgBetaPolicyPermissionGrantPolicyIncludeCount -PermissionGrantPolicyId <string>
...
```
Get-MgBetaPolicyPermissionGrantPolicyIncludeCount -InputObject <IIdentitySignInsIdentity>
 [-Filter <string>] [-Search <string>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
...
- [Get-MgBetaPolicyPermissionGrantPolicyIncludeCount](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/get-mgbetapolicypermissiongrantpolicyincludecount)
