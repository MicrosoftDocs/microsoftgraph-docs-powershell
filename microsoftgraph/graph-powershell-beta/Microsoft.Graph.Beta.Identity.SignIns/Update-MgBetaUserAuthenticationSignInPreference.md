...
Update-MgBetaUserAuthenticationSignInPreference -UserId <string> [-ResponseHeadersVariable <string>]
 ...
 [-UserPreferredMethodForSecondaryAuthentication <string>] [-Break] [-Headers <IDictionary>]
...
Update-MgBetaUserAuthenticationSignInPreference -UserId <string>
 -BodyParameter <IMicrosoftGraphSignInPreferences> [-ResponseHeadersVariable <string>] [-Break]
