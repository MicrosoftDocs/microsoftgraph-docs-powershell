...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/get-mgbetameauthenticationplatformcredentialmethod
schema: 2.0.0
...
### List (Default)
```
Get-MgBetaMeAuthenticationPlatformCredentialMethod [-ExpandProperty <String[]>] [-Property <String[]>]
...
### Get
```
Get-MgBetaMeAuthenticationPlatformCredentialMethod -PlatformCredentialAuthenticationMethodId <String>
...
### GetViaIdentity
```
Get-MgBetaMeAuthenticationPlatformCredentialMethod -InputObject <IIdentitySignInsIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/get-mgbetameauthenticationplatformcredentialmethod](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/get-mgbetameauthenticationplatformcredentialmethod)
