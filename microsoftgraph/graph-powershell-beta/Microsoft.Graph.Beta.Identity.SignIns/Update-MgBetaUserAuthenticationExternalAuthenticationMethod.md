...
# Update-MgBetaUserAuthenticationExternalAuthenticationMethod
...
```
Update-MgBetaUserAuthenticationExternalAuthenticationMethod -ExternalAuthenticationMethodId <string>
 -UserId <string> [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-ConfigurationId <string>] [-CreatedDateTime <datetime>] [-DisplayName <string>] [-Id <string>]
...
```
Update-MgBetaUserAuthenticationExternalAuthenticationMethod -ExternalAuthenticationMethodId <string>
 -UserId <string> -BodyParameter <IMicrosoftGraphExternalAuthenticationMethod>
...
```
Update-MgBetaUserAuthenticationExternalAuthenticationMethod -InputObject <IIdentitySignInsIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-ConfigurationId <string>]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphExternalAuthenticationMethod
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### -ExternalAuthenticationMethodId
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphExternalAuthenticationMethod
...
- [Update-MgBetaUserAuthenticationExternalAuthenticationMethod](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/update-mgbetauserauthenticationexternalauthenticationmethod)
