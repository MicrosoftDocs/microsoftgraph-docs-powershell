...
# Get-MgBetaPolicyDeletedItemCrossTenantSyncPolicyPartner
...
```
Get-MgBetaPolicyDeletedItemCrossTenantSyncPolicyPartner [-ExpandProperty <string[]>]
...
```
Get-MgBetaPolicyDeletedItemCrossTenantSyncPolicyPartner
 -CrossTenantIdentitySyncPolicyPartnerTenantId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaPolicyDeletedItemCrossTenantSyncPolicyPartner -InputObject <IIdentitySignInsIdentity>
...
## EXAMPLES
### Example 1: Retrieve a deleted crossTenantIdentitySyncPolicyPartner object
...
```
This example will retrieve a deleted crosstenantidentitysyncpolicypartner object
