...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/invoke-mgbetabufferuserinformationprotectionencrypt
schema: 2.0.0
---
...
```
Invoke-MgBetaBufferUserInformationProtectionEncrypt -UserId <String> [-ResponseHeadersVariable <String>]
