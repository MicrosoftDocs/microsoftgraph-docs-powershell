...
```
Update-MgBetaUserAuthenticationQrCodePinMethodPin -UserId <string>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-Code <string>]
 [-CreatedDateTime <datetime>] [-ForceChangePinNextSignIn] [-Id <string>]
 [-UpdatedDateTime <datetime>] [-Break] [-Headers <IDictionary>]
...
```
Update-MgBetaUserAuthenticationQrCodePinMethodPin -UserId <string>
 -BodyParameter <IMicrosoftGraphQrPin> [-ResponseHeadersVariable <string>] [-Break]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphQrPin
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
