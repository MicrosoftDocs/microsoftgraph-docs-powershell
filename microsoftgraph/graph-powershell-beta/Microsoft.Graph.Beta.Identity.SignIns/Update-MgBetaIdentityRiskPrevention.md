...
# Update-MgBetaIdentityRiskPrevention
...
```
Update-MgBetaIdentityRiskPrevention [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaIdentityRiskPrevention -BodyParameter <IMicrosoftGraphRiskPreventionContainer>
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphRiskPreventionContainer
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphRiskPreventionContainer
