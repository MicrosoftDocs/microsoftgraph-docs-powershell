...
```
New-MgBetaUserAuthenticationExternalAuthenticationMethod -UserId <string>
...
```
New-MgBetaUserAuthenticationExternalAuthenticationMethod -InputObject <IIdentitySignInsIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-ConfigurationId <string>]
 [-CreatedDateTime <datetime>] [-DisplayName <string>] [-Id <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
