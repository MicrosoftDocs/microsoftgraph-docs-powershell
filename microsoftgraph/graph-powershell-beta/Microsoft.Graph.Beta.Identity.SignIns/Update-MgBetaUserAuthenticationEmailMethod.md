...
Update-MgBetaUserAuthenticationEmailMethod -EmailAuthenticationMethodId <String> -UserId <String>
 ...
 [-EmailAddress <String>] [-Id <String>] [-Headers <IDictionary>]
...
[https://learn.microsoft.com/graph/api/emailauthenticationmethod-update?view=graph-rest-beta](https://learn.microsoft.com/graph/api/emailauthenticationmethod-update?view=graph-rest-beta)
