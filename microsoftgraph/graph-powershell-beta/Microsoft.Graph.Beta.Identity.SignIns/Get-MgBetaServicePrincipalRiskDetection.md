...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/get-mgbetaserviceprincipalriskdetection
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.SignIns
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaServicePrincipalRiskDetection
---
...
```
Get-MgBetaServicePrincipalRiskDetection [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaServicePrincipalRiskDetection -ServicePrincipalRiskDetectionId <string>
...
```
Get-MgBetaServicePrincipalRiskDetection -InputObject <IIdentitySignInsIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
...
- [Get-MgBetaServicePrincipalRiskDetection](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/get-mgbetaserviceprincipalriskdetection)
- [Graph API Reference](https://learn.microsoft.com/graph/api/serviceprincipalriskdetection-get?view=graph-rest-beta)
- [Graph API Reference](https://learn.microsoft.com/graph/api/identityprotectionroot-list-serviceprincipalriskdetections?view=graph-rest-beta)
