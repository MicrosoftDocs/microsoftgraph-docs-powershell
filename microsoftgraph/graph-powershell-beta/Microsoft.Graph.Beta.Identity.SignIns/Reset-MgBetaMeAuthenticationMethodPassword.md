...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/reset-mgbetameauthenticationmethodpassword
schema: 2.0.0
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Reset-MgMeAuthenticationMethodPassword](/powershell/module/Microsoft.Graph.Identity.SignIns/Reset-MgMeAuthenticationMethodPassword?view=graph-powershell-1.0)

## SYNTAX

### ResetExpanded (Default)
```
Reset-MgBetaMeAuthenticationMethodPassword -AuthenticationMethodId <String> [-ResponseHeadersVariable <String>]
...
### Reset
```
Reset-MgBetaMeAuthenticationMethodPassword -AuthenticationMethodId <String>
 -BodyParameter <IPathsR0PzawMeAuthenticationMethodsAuthenticationmethodIdMicrosoftGraphResetpasswordPostRequestbodyContentApplicationJsonSchema>
...
```
Reset-MgBetaMeAuthenticationMethodPassword -InputObject <IIdentitySignInsIdentity>
...
```yaml
Type: IPathsR0PzawMeAuthenticationMethodsAuthenticationmethodIdMicrosoftGraphResetpasswordPostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.Beta.PowerShell.Models.IPathsR0PzawMeAuthenticationMethodsAuthenticationmethodIdMicrosoftGraphResetpasswordPostRequestbodyContentApplicationJsonSchema
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/reset-mgbetameauthenticationmethodpassword](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/reset-mgbetameauthenticationmethodpassword)
