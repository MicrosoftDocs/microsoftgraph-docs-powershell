...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/find-mgbetapolicyauthenticationstrengthpolicybymethodmode
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.SignIns
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Find-MgBetaPolicyAuthenticationStrengthPolicyByMethodMode
---
...
```
Find-MgBetaPolicyAuthenticationStrengthPolicyByMethodMode -AuthenticationMethodModes <string[]>
...
```
Find-MgBetaPolicyAuthenticationStrengthPolicyByMethodMode -InputObject <IIdentitySignInsIdentity>
 [-Count] [-ExpandProperty <string[]>] [-Filter <string>] [-Property <string[]>] [-Search <string>]
 [-Skip <int>] [-Sort <string[]>] [-Top <int>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
