...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/get-mgbetadatapolicyoperation
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.SignIns
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaDataPolicyOperation
---
...
```
Get-MgBetaDataPolicyOperation [-ExpandProperty <string[]>] [-Property <string[]>] [-Filter <string>]
...
- [Get-MgBetaDataPolicyOperation](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/get-mgbetadatapolicyoperation)
- [Graph API Reference](https://learn.microsoft.com/graph/api/datapolicyoperation-get?view=graph-rest-beta)
