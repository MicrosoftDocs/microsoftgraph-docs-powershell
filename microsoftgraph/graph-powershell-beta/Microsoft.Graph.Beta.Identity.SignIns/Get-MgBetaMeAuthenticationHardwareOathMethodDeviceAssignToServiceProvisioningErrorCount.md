...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/get-mgbetameauthenticationhardwareoathmethoddeviceassigntoserviceprovisioningerrorcount
schema: 2.0.0
---
...
```
Get-MgBetaMeAuthenticationHardwareOathMethodDeviceAssignToServiceProvisioningErrorCount
 -HardwareOathAuthenticationMethodId <String> [-Filter <String>] [-Search <String>]
