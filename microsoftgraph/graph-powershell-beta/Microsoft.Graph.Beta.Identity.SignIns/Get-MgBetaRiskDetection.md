...
Get-MgBetaRiskDetection -All ### Example 1: Get all riskDetections### Example 2: Get riskDetections by user displayname
```powershell
Connect-MgBetaGraph -Scopes "IdentityRiskEvent.Read.All"
Get-MgBetaRiskDetection -Filter "UserDisplayname eq 'Jason Mayer'" ### Example 2: Get riskDetections by user displayname### Example 3: Get riskDetections by risk type
```powershell
Connect-MgBetaGraph -Scopes "IdentityRiskEvent.Read.All"
Get-MgBetaRiskDetection -Filter "RiskType eq 'anonymizedIPAddress'" ### Example 3: Get riskDetections by risk type### Example 4: Get all riskDetections for a particular user with high risk
```powershell
Connect-MgBetaGraph -Scopes "IdentityRiskEvent.Read.All"
Get-MgBetaRiskDetection -Filter "UserDisplayName eq 'Jason Mayer' and Risklevel eq 'high'" ### Example 4: Get all riskDetections for a particular user with high risk
## PARAMETERS
