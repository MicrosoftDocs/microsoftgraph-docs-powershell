...
New-MgBetaPolicyServicePrincipalCreationPolicyExclude -ServicePrincipalCreationPolicyId <string>
 ...
 [-ApplicationIds <string[]>] [-ApplicationPublisherIds <string[]>]
 [-ApplicationTenantIds <string[]>] [-ApplicationsFromVerifiedPublisherOnly]
...
```
New-MgBetaPolicyServicePrincipalCreationPolicyExclude -ServicePrincipalCreationPolicyId <string>
 -BodyParameter <IMicrosoftGraphServicePrincipalCreationConditionSet>
...
- [New-MgBetaPolicyServicePrincipalCreationPolicyExclude](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/new-mgbetapolicyserviceprincipalcreationpolicyexclude)
