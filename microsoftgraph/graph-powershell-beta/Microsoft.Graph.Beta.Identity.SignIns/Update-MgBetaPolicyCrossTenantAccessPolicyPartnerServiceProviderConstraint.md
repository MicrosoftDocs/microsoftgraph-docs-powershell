...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/update-mgbetapolicycrosstenantaccesspolicypartnerserviceproviderconstraint
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.SignIns
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaPolicyCrossTenantAccessPolicyPartnerServiceProviderConstraint
---

# Update-MgBetaPolicyCrossTenantAccessPolicyPartnerServiceProviderConstraint
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgPolicyCrossTenantAccessPolicyPartnerServiceProviderConstraint](/powershell/module/Microsoft.Graph.Identity.SignIns/Update-MgPolicyCrossTenantAccessPolicyPartnerServiceProviderConstraint?view=graph-powershell-1.0)
...
Update-MgBetaPolicyCrossTenantAccessPolicyPartnerServiceProviderConstraint
 ...
 [-AdditionalProperties <hashtable>] [-DeletedDateTime <datetime>] [-Id <string>] [-Break]
...
Update-MgBetaPolicyCrossTenantAccessPolicyPartnerServiceProviderConstraint
 ...
 -BodyParameter <IMicrosoftGraphServiceProviderConstraints> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaPolicyCrossTenantAccessPolicyPartnerServiceProviderConstraint
 -InputObject <IIdentitySignInsIdentity> -BodyParameter <IMicrosoftGraphServiceProviderConstraints>
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphServiceProviderConstraints
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphServiceProviderConstraints
...
BODYPARAMETER `<IMicrosoftGraphServiceProviderConstraints>`: serviceProviderConstraints
...
- [Update-MgBetaPolicyCrossTenantAccessPolicyPartnerServiceProviderConstraint](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/update-mgbetapolicycrosstenantaccesspolicypartnerserviceproviderconstraint)
