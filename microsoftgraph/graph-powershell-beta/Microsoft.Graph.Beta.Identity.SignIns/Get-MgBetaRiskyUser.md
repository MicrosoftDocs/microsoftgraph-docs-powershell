...
### List (Default)
```
Get-MgBetaRiskyUser [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>] [-Search <String>]
...
Get-MgBetaRiskyUser ### Example 1: List all risky users### Example 2: List all risky users by RiskLevel
```powershell
Connect-MgBetaGraph -Scopes "IdentityRiskyUser.Read.All"
Select-MgBetaProfile beta
Get-MgBetaRiskyUser -Filter "RiskLevel ne 'none'" ### Example 2: List all risky users by RiskLevel
## PARAMETERS
