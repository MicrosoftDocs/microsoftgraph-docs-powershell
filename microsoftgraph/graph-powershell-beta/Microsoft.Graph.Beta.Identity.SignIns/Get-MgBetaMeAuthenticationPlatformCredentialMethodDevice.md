...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/get-mgbetameauthenticationplatformcredentialmethoddevice
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaMeAuthenticationPlatformCredentialMethodDevice -PlatformCredentialAuthenticationMethodId <String>
...
### GetViaIdentity
```
Get-MgBetaMeAuthenticationPlatformCredentialMethodDevice -InputObject <IIdentitySignInsIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/get-mgbetameauthenticationplatformcredentialmethoddevice](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/get-mgbetameauthenticationplatformcredentialmethoddevice)
