...
```
Update-MgBetaIdentityConditionalAccessDeletedItem [-ResponseHeadersVariable <string>]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphCaPoliciesDeletableRoot
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphCaPoliciesDeletableRoot
