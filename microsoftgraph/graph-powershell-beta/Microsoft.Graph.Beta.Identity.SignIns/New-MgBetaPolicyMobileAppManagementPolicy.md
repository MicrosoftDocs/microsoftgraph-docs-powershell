...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/new-mgbetapolicymobileappmanagementpolicy
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.SignIns
ms.date: 06/12/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaPolicyMobileAppManagementPolicy
---
...
New-MgBetaPolicyMobileAppManagementPolicy [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-AppliesTo <string>] [-ComplianceUrl <string>]
 [-Description <string>] [-DiscoveryUrl <string>] [-DisplayName <string>] [-Id <string>]
 [-IncludedGroups <IMicrosoftGraphGroup[]>] [-IsValid] [-TermsOfUseUrl <string>] [-Break]
...
```
New-MgBetaPolicyMobileAppManagementPolicy -BodyParameter <hashtable>
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphMobileAppManagementPolicy
...
INCLUDEDGROUPS <IMicrosoftGraphGroup[]>: Microsoft Entra groups under the scope of the mobility management application if appliesTo is selected
...
For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.
        ...
        [SharedDeviceDetail <IMicrosoftGraphCloudPcFrontlineSharedDeviceDetail>]: cloudPcFrontlineSharedDeviceDetail
          [(Any) <Object>]: This indicates any property can be added to this object.
...
Use GET driveItem resource operation and read  sharepointIds property to get listItemUniqueId.
        ...
        [Extensions <IMicrosoftGraphExtension[]>]: The collection of open extensions defined for this site.
Nullable.
...
Read-only.
          ...
          [Drive <IMicrosoftGraphDrive>]: drive
          [ItemCount <Int32?>]: The number of items in the list.
Read-only.
 ...
 For more information about filtering behavior for this property, see Filtering on the identities property of a user.
      [IdentityGovernance <IMicrosoftGraphIdentityGovernanceUserSettings>]: identityGovernanceUserSettings
        ...
        [ApproverDelegate <IMicrosoftGraphApproverDelegate>]: approverDelegate
          [(Any) <Object>]: This indicates any property can be added to this object.
          [Delegate <IMicrosoftGraphSubjectSet>]: subjectSet
            [(Any) <Object>]: This indicates any property can be added to this object.
...
- [New-MgBetaPolicyMobileAppManagementPolicy](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/new-mgbetapolicymobileappmanagementpolicy)
