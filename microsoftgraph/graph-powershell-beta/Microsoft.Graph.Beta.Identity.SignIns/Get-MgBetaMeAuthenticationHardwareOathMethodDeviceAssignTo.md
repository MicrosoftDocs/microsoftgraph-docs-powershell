...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/get-mgbetameauthenticationhardwareoathmethoddeviceassignto
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaMeAuthenticationHardwareOathMethodDeviceAssignTo -HardwareOathAuthenticationMethodId <String>
...
### GetViaIdentity
```
Get-MgBetaMeAuthenticationHardwareOathMethodDeviceAssignTo -InputObject <IIdentitySignInsIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
