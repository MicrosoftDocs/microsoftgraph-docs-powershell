...
```
New-MgBetaPolicyB2BManagementPolicy [-ResponseHeadersVariable <string>]
...
```
New-MgBetaPolicyB2BManagementPolicy -BodyParameter <hashtable> [-ResponseHeadersVariable <string>]
