...
### List (Default)
```
Get-MgBetaIdentityApiConnector [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
**Permissions**
[!INCLUDE [permissions-table](~/../graphref/api-reference/beta/includes/permissions/identityapiconnector-list-permissions.md)]
...
[https://learn.microsoft.com/graph/api/identityapiconnector-get?view=graph-rest-beta](https://learn.microsoft.com/graph/api/identityapiconnector-get?view=graph-rest-beta)

[https://learn.microsoft.com/graph/api/identityapiconnector-list?view=graph-rest-beta](https://learn.microsoft.com/graph/api/identityapiconnector-list?view=graph-rest-beta)
