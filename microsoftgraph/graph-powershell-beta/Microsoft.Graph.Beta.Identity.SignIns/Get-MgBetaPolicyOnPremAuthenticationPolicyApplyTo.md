...
# Get-MgBetaPolicyOnPremAuthenticationPolicyApplyTo
...
```
Get-MgBetaPolicyOnPremAuthenticationPolicyApplyTo -OnPremAuthenticationPolicyId <string>
...
```
Get-MgBetaPolicyOnPremAuthenticationPolicyApplyTo -DirectoryObjectId <string>
...
```
Get-MgBetaPolicyOnPremAuthenticationPolicyApplyTo -InputObject <IIdentitySignInsIdentity>
