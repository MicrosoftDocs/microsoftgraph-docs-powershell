...
Update-MgBetaPolicyCrossTenantAccessPolicyDefault [-ResponseHeadersVariable <string>]
 ...
 [-BlockServiceProviderOutboundAccess] [-Id <string>]
...
- [Update-MgBetaPolicyCrossTenantAccessPolicyDefault](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/update-mgbetapolicycrosstenantaccesspolicydefault)
- [Graph API Reference](https://learn.microsoft.com/graph/api/crosstenantaccesspolicyconfigurationdefault-update?view=graph-rest-beta)
