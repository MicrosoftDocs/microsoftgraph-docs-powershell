...
### Get
```
Get-MgBetaIdentityB2XUserFlowLanguage -B2XIdentityUserFlowId <String> -UserFlowLanguageConfigurationId <String>
...
**Permissions**
[!INCLUDE [permissions-table](~/../graphref/api-reference/beta/includes/permissions/b2xidentityuserflow-list-languages-permissions.md)]
...
[https://learn.microsoft.com/graph/api/b2xidentityuserflow-list-languages?view=graph-rest-beta](https://learn.microsoft.com/graph/api/b2xidentityuserflow-list-languages?view=graph-rest-beta)
