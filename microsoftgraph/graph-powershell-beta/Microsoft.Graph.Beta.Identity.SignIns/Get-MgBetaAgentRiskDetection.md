...
```
Get-MgBetaAgentRiskDetection [-ExpandProperty <string[]>] [-Property <string[]>] [-Filter <string>]
...
The unique identifier of agentRiskDetection
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphAgentRiskDetection
