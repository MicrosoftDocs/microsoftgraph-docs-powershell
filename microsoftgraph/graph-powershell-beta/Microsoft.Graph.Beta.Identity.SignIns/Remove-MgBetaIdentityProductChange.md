...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/remove-mgbetaidentityproductchange
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaIdentityProductChange -ChangeItemBaseId <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgBetaIdentityProductChange -InputObject <IIdentitySignInsIdentity> [-IfMatch <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
