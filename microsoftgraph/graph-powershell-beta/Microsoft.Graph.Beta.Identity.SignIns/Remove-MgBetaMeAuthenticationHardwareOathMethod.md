...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/remove-mgbetameauthenticationhardwareoathmethod
schema: 2.0.0
...
### Delete (Default)
```
Remove-MgBetaMeAuthenticationHardwareOathMethod -HardwareOathAuthenticationMethodId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaMeAuthenticationHardwareOathMethod -InputObject <IIdentitySignInsIdentity> [-IfMatch <String>]
