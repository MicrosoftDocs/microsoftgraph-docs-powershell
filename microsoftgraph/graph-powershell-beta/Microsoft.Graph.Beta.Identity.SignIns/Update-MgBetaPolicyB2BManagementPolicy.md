...
```
Update-MgBetaPolicyB2BManagementPolicy -B2BManagementPolicyId <string>
...
```
Update-MgBetaPolicyB2BManagementPolicy -B2BManagementPolicyId <string> -BodyParameter <hashtable>
...
```
Update-MgBetaPolicyB2BManagementPolicy -InputObject <IIdentitySignInsIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-AppliesTo <IMicrosoftGraphDirectoryObject[]>] [-Definition <string[]>]
 [-DeletedDateTime <datetime>] [-Description <string>] [-DisplayName <string>] [-Id <string>]
 [-IsOrganizationDefault] [-Break] [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
...
The unique identifier of b2bManagementPolicy
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphB2BManagementPolicy
