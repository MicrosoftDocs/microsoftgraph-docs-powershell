...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/update-mgbetameauthenticationoperation
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgMeAuthenticationOperation](/powershell/module/Microsoft.Graph.Identity.SignIns/Update-MgMeAuthenticationOperation?view=graph-powershell-1.0)

## SYNTAX

### UpdateExpanded (Default)
```
Update-MgBetaMeAuthenticationOperation -LongRunningOperationId <String> [-ResponseHeadersVariable <String>]
...
### Update
```
Update-MgBetaMeAuthenticationOperation -LongRunningOperationId <String>
...
```
Update-MgBetaMeAuthenticationOperation -InputObject <IIdentitySignInsIdentity>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/update-mgbetameauthenticationoperation](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/update-mgbetameauthenticationoperation)
