...
```
Get-MgBetaTrustFrameworkKeySetKeyV2 -TrustFrameworkKeySetId <string>
 -TrustFrameworkKeyV2Kid <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaTrustFrameworkKeySetKeyV2 -InputObject <IIdentitySignInsIdentity>
