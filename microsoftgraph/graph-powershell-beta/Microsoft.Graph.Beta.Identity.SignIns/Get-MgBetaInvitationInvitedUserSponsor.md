...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/get-mgbetainvitationinvitedusersponsor
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.SignIns
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaInvitationInvitedUserSponsor
---
...
```
Get-MgBetaInvitationInvitedUserSponsor [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaInvitationInvitedUserSponsor -DirectoryObjectId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaInvitationInvitedUserSponsor -InputObject <IIdentitySignInsIdentity>
...
- [Get-MgBetaInvitationInvitedUserSponsor](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/get-mgbetainvitationinvitedusersponsor)
