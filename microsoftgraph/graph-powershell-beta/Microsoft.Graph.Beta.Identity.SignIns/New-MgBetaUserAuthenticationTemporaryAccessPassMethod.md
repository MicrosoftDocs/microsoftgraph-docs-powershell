...
```
New-MgBetaUserAuthenticationTemporaryAccessPassMethod -UserId <String> [-ResponseHeadersVariable <String>]
...
New-MgBetaUserAuthenticationTemporaryAccessPassMethod -InputObject <IIdentitySignInsIdentity>
 ...
 [-Id <String>] [-IsUsableOnce] [-LifetimeInMinutes <Int32>] [-StartDateTime <DateTime>]
...
[https://learn.microsoft.com/graph/api/authentication-post-temporaryaccesspassmethods?view=graph-rest-beta](https://learn.microsoft.com/graph/api/authentication-post-temporaryaccesspassmethods?view=graph-rest-beta)
