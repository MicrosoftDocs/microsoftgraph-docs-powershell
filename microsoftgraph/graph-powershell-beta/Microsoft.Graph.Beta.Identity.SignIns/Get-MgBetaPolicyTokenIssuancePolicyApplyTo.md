...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgPolicyTokenIssuancePolicyApplyTo](/powershell/module/Microsoft.Graph.Identity.SignIns/Get-MgPolicyTokenIssuancePolicyApplyTo?view=graph-powershell-1.0)

## SYNTAX

### List (Default)
```
Get-MgBetaPolicyTokenIssuancePolicyApplyTo -TokenIssuancePolicyId <String> [-ExpandProperty <String[]>]
...
### Get
```
Get-MgBetaPolicyTokenIssuancePolicyApplyTo -DirectoryObjectId <String> -TokenIssuancePolicyId <String>
...
### GetViaIdentity
```
Get-MgBetaPolicyTokenIssuancePolicyApplyTo -InputObject <IIdentitySignInsIdentity> [-ExpandProperty <String[]>]
...
[https://learn.microsoft.com/graph/api/tokenissuancepolicy-list-appliesto?view=graph-rest-beta](https://learn.microsoft.com/graph/api/tokenissuancepolicy-list-appliesto?view=graph-rest-beta)
