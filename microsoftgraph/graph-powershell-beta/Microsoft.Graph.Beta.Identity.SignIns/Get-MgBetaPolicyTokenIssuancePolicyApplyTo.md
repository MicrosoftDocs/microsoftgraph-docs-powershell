...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/get-mgbetapolicytokenissuancepolicyapplyto
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.SignIns
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: Get-MgBetaPolicyTokenIssuancePolicyApplyTo
---
...
```
Get-MgBetaPolicyTokenIssuancePolicyApplyTo -TokenIssuancePolicyId <string>
...
```
Get-MgBetaPolicyTokenIssuancePolicyApplyTo -DirectoryObjectId <string>
 -TokenIssuancePolicyId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaPolicyTokenIssuancePolicyApplyTo -InputObject <IIdentitySignInsIdentity>
