...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/new-mgbetapolicydeleteditemcrosstenantpartner
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.SignIns
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaPolicyDeletedItemCrossTenantPartner
---

# New-MgBetaPolicyDeletedItemCrossTenantPartner
...
```
New-MgBetaPolicyDeletedItemCrossTenantPartner [-ResponseHeadersVariable <string>]
 ...
 [-BlockServiceProviderOutboundAccess] [-DeletedDateTime <datetime>]
 ...
 [-ServiceProviderConstraints <IMicrosoftGraphServiceProviderConstraints>] [-TenantId <string>]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphCrossTenantAccessPolicyAppServiceConnectSetting
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphCrossTenantAccessPolicyM365CollaborationInboundSetting
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphCrossTenantAccessPolicyM365CollaborationOutboundSetting
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
serviceProviderConstraints
To construct, see NOTES section for SERVICEPROVIDERCONSTRAINTS properties and create a hash table.
...
- [New-MgBetaPolicyDeletedItemCrossTenantPartner](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/new-mgbetapolicydeleteditemcrosstenantpartner)
