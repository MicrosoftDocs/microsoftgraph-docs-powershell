...
```
Get-MgBetaPolicyTokenLifetimePolicyApplyTo -TokenLifetimePolicyId <string>
...
```
Get-MgBetaPolicyTokenLifetimePolicyApplyTo -DirectoryObjectId <string>
 -TokenLifetimePolicyId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
