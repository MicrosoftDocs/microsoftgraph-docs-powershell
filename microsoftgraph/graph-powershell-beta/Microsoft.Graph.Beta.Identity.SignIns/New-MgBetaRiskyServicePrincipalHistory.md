...
```
New-MgBetaRiskyServicePrincipalHistory -RiskyServicePrincipalId <String> [-ResponseHeadersVariable <String>]
 [-AccountEnabled] [-Activity <IMicrosoftGraphRiskServicePrincipalActivity>]
...
## RELATED LINKS
[New-MgRiskyServicePrincipalHistory](/powershell/module/Microsoft.Graph.Identity.SignIns/New-MgRiskyServicePrincipalHistory?view=graph-powershell-1.0)
