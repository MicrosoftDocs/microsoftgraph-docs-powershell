...
```
Get-MgBetaIdentityConditionalAccessDeletedItemPolicy [-ExpandProperty <string[]>]
...
```
Get-MgBetaIdentityConditionalAccessDeletedItemPolicy -ConditionalAccessPolicyId <string>
...
```
Get-MgBetaIdentityConditionalAccessDeletedItemPolicy -InputObject <IIdentitySignInsIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
