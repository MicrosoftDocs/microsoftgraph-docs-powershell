...
```
Get-MgBetaPolicyOnPremAuthenticationPolicy [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaPolicyOnPremAuthenticationPolicy -OnPremAuthenticationPolicyId <string>
...
```
Get-MgBetaPolicyOnPremAuthenticationPolicy -InputObject <IIdentitySignInsIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
