...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgUserInformationProtectionThreatAssessmentRequestResult](/powershell/module/Microsoft.Graph.Identity.SignIns/New-MgUserInformationProtectionThreatAssessmentRequestResult?view=graph-powershell-v1.0)
...
New-MgBetaUserInformationProtectionThreatAssessmentRequestResult -ThreatAssessmentRequestId <String>
 ...
 [-Message <String>] [-ResultType <String>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Create
```
New-MgBetaUserInformationProtectionThreatAssessmentRequestResult -ThreatAssessmentRequestId <String>
 -UserId <String> -BodyParameter <IMicrosoftGraphThreatAssessmentResult> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
## RELATED LINKS
[New-MgUserInformationProtectionThreatAssessmentRequestResult](/powershell/module/Microsoft.Graph.Identity.SignIns/New-MgUserInformationProtectionThreatAssessmentRequestResult?view=graph-powershell-v1.0)
