...
**Permissions**
[!INCLUDE [permissions-table](~/../graphref/api-reference/beta/includes/permissions/authenticationstrengthroot-list-policies-permissions.md)]
...
[https://learn.microsoft.com/graph/api/authenticationstrengthpolicy-get?view=graph-rest-beta](https://learn.microsoft.com/graph/api/authenticationstrengthpolicy-get?view=graph-rest-beta)

[https://learn.microsoft.com/graph/api/authenticationstrengthroot-list-policies?view=graph-rest-beta](https://learn.microsoft.com/graph/api/authenticationstrengthroot-list-policies?view=graph-rest-beta)
