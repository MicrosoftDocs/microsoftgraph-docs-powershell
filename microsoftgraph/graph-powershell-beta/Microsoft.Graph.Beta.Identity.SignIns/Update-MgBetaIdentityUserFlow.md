...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/update-mgbetaidentityuserflow
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.SignIns
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaIdentityUserFlow
---
...
```
Update-MgBetaIdentityUserFlow -IdentityUserFlowId <string> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Id <string>] [-UserFlowType <string>]
...
```
Update-MgBetaIdentityUserFlow -IdentityUserFlowId <string>
 -BodyParameter <IMicrosoftGraphIdentityUserFlow> [-ResponseHeadersVariable <string>] [-Break]
...
Update-MgBetaIdentityUserFlow -InputObject <IIdentitySignInsIdentity>
 ...
 [-UserFlowType <string>] [-UserFlowTypeVersion <float>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
- [Update-MgBetaIdentityUserFlow](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/update-mgbetaidentityuserflow)
