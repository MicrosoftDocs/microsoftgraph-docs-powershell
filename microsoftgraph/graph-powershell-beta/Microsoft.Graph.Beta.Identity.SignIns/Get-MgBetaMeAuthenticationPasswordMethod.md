...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/get-mgbetameauthenticationpasswordmethod
schema: 2.0.0
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgMeAuthenticationPasswordMethod](/powershell/module/Microsoft.Graph.Identity.SignIns/Get-MgMeAuthenticationPasswordMethod?view=graph-powershell-1.0)

## SYNTAX

### List (Default)
```
Get-MgBetaMeAuthenticationPasswordMethod [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaMeAuthenticationPasswordMethod -PasswordAuthenticationMethodId <String> [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgBetaMeAuthenticationPasswordMethod -InputObject <IIdentitySignInsIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/get-mgbetameauthenticationpasswordmethod](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/get-mgbetameauthenticationpasswordmethod)
