...
Update-MgBetaRiskyServicePrincipalHistory -RiskyServicePrincipalHistoryItemId <string>
 ...
 [-History <IMicrosoftGraphRiskyServicePrincipalHistoryItem[]>] [-Id <string>]
 [-InitiatedBy <string>] [-IsEnabled] [-IsProcessing] [-RiskDetail <string>]
...
```
Update-MgBetaRiskyServicePrincipalHistory -InputObject <IIdentitySignInsIdentity>
 -BodyParameter <IMicrosoftGraphRiskyServicePrincipalHistoryItem>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
- [Update-MgBetaRiskyServicePrincipalHistory](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/update-mgbetariskyserviceprincipalhistory)
