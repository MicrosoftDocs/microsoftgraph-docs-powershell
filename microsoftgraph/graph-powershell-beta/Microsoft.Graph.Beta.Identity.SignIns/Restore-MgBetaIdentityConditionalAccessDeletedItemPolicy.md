...
# Restore-MgBetaIdentityConditionalAccessDeletedItemPolicy
...
```
Restore-MgBetaIdentityConditionalAccessDeletedItemPolicy -ConditionalAccessPolicyId <string>
...
```
Restore-MgBetaIdentityConditionalAccessDeletedItemPolicy -InputObject <IIdentitySignInsIdentity>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
