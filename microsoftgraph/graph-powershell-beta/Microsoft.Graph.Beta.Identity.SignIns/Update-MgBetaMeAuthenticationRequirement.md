...
```
Update-MgBetaMeAuthenticationRequirement [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-PerUserMfaState <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Update
```
Update-MgBetaMeAuthenticationRequirement -BodyParameter <IMicrosoftGraphStrongAuthenticationRequirements>
...
```yaml
Type: IMicrosoftGraphStrongAuthenticationRequirements
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphStrongAuthenticationRequirements
