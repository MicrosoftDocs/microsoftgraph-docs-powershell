...
# New-MgBetaIdentityVerifiedIdProfile
...
```
New-MgBetaIdentityVerifiedIdProfile [-ResponseHeadersVariable <string>]
...
```
New-MgBetaIdentityVerifiedIdProfile -BodyParameter <IMicrosoftGraphVerifiedIdProfile>
