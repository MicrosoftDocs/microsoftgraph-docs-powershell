...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/update-mgbetauserinformationprotectionthreatassessmentrequest
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.SignIns
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaUserInformationProtectionThreatAssessmentRequest
---
...
Update-MgBetaUserInformationProtectionThreatAssessmentRequest -ThreatAssessmentRequestId <string>
 ...
 [-CreatedDateTime <datetime>] [-ExpectedAssessment <string>] [-Id <string>]
 [-RequestSource <string>] [-Results <IMicrosoftGraphThreatAssessmentResult[]>] [-Status <string>]
...
```
Update-MgBetaUserInformationProtectionThreatAssessmentRequest -ThreatAssessmentRequestId <string>
 -UserId <string> -BodyParameter <IMicrosoftGraphThreatAssessmentRequest>
...
```
Update-MgBetaUserInformationProtectionThreatAssessmentRequest
 -InputObject <IIdentitySignInsIdentity> -BodyParameter <IMicrosoftGraphThreatAssessmentRequest>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
- [Update-MgBetaUserInformationProtectionThreatAssessmentRequest](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/update-mgbetauserinformationprotectionthreatassessmentrequest)
