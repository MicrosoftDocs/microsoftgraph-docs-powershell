...
```
Update-MgBetaPolicyClaimMappingPolicy -ClaimsMappingPolicyId <String> [-ResponseHeadersVariable <String>]
...
[https://learn.microsoft.com/graph/api/claimsmappingpolicy-update?view=graph-rest-beta](https://learn.microsoft.com/graph/api/claimsmappingpolicy-update?view=graph-rest-beta)
