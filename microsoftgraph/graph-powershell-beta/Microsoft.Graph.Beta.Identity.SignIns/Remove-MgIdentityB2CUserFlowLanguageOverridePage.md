...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.signins/remove-mgidentityb2cuserflowlanguageoverridepage
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgIdentityB2CUserFlowLanguageOverridePage -B2CIdentityUserFlowId <String>
...
### DeleteViaIdentity
```
Remove-MgIdentityB2CUserFlowLanguageOverridePage -InputObject <IIdentitySignInsIdentity> [-IfMatch <String>]
