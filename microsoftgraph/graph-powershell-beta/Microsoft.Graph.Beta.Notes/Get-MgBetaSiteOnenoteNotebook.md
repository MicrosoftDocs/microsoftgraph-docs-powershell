...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/get-mgbetasiteonenotenotebook
Locale: en-US
Module Name: Microsoft.Graph.Beta.Notes
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaSiteOnenoteNotebook
---
...
```
Get-MgBetaSiteOnenoteNotebook -InputObject <INotesIdentity> [-ExpandProperty <string[]>]
 [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
```
...
- [Get-MgBetaSiteOnenoteNotebook](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/get-mgbetasiteonenotenotebook)
