...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/new-mgbetauseronenotesection
Locale: en-US
Module Name: Microsoft.Graph.Beta.Notes
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaUserOnenoteSection
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgUserOnenoteSection](/powershell/module/Microsoft.Graph.Notes/New-MgUserOnenoteSection?view=graph-powershell-1.0)
...
```
New-MgBetaUserOnenoteSection -UserId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaUserOnenoteSection -InputObject <INotesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-CreatedBy <IMicrosoftGraphIdentitySet>]
 [-CreatedDateTime <datetime>] [-DisplayName <string>] [-Id <string>] [-IsDefault]
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-LastModifiedDateTime <datetime>]
 [-Links <IMicrosoftGraphSectionLinks>] [-Pages <IMicrosoftGraphOnenotePage[]>] [-PagesUrl <string>]
...
```
New-MgBetaUserOnenoteSection -InputObject <INotesIdentity>
...
- [New-MgBetaUserOnenoteSection](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/new-mgbetauseronenotesection)
