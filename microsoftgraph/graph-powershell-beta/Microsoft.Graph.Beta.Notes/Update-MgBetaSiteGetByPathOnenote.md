...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetasitegetbypathonenote
Locale: en-US
Module Name: Microsoft.Graph.Beta.Notes
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaSiteGetByPathOnenote
---
...
```
Update-MgBetaSiteGetByPathOnenote -Path <string> -SiteId <string>
...
```
Update-MgBetaSiteGetByPathOnenote -Path <string> -SiteId <string>
 -BodyParameter <IMicrosoftGraphOnenote> [-ResponseHeadersVariable <string>] [-Break]
...
```
Update-MgBetaSiteGetByPathOnenote -InputObject <INotesIdentity>
 -BodyParameter <IMicrosoftGraphOnenote> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphOnenoteResource[]
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
- [Update-MgBetaSiteGetByPathOnenote](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetasitegetbypathonenote)
