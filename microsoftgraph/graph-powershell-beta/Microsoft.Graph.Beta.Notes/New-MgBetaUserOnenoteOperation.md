...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/new-mgbetauseronenoteoperation
schema: 2.0.0
---
...
```
New-MgBetaUserOnenoteOperation -UserId <String> [-ResponseHeadersVariable <String>]
...
### Create
```
New-MgBetaUserOnenoteOperation -UserId <String> -BodyParameter <IMicrosoftGraphOnenoteOperation>
...
```
New-MgBetaUserOnenoteOperation -InputObject <INotesIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-CreatedDateTime <DateTime>]
 [-Error <IMicrosoftGraphOnenoteOperationError>] [-Id <String>] [-LastActionDateTime <DateTime>]
 [-PercentComplete <String>] [-ResourceId <String>] [-ResourceLocation <String>] [-Status <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
...
### CreateViaIdentity
```
New-MgBetaUserOnenoteOperation -InputObject <INotesIdentity> -BodyParameter <IMicrosoftGraphOnenoteOperation>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/new-mgbetauseronenoteoperation](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/new-mgbetauseronenoteoperation)
