...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/copy-mgbetasiteonenotenotebook
Locale: en-US
Module Name: Microsoft.Graph.Beta.Notes
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Copy-MgBetaSiteOnenoteNotebook
---
...
```
Copy-MgBetaSiteOnenoteNotebook -InputObject <INotesIdentity> [-SiteId <string>]
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-GroupId <string>]
...
- [Copy-MgBetaSiteOnenoteNotebook](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/copy-mgbetasiteonenotenotebook)
