...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/copy-mgbetasiteonenotenotebook
schema: 2.0.0
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Copy-MgSiteOnenoteNotebook](/powershell/module/Microsoft.Graph.Notes/Copy-MgSiteOnenoteNotebook?view=graph-powershell-1.0)
...
```
Copy-MgBetaSiteOnenoteNotebook [-SiteId <String>] -InputObject <INotesIdentity>
...
### CopyViaIdentity
```
Copy-MgBetaSiteOnenoteNotebook -InputObject <INotesIdentity>
 -BodyParameter <IPathsS3Y1MrSitesSiteIdOnenoteNotebooksNotebookIdMicrosoftGraphCopynotebookPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/copy-mgbetasiteonenotenotebook](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/copy-mgbetasiteonenotenotebook)
