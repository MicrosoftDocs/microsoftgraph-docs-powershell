...
```
Set-MgBetaUserOnenoteSectionGroupSectionPageContent -OnenotePageId <string>
 -OnenoteSectionId <string> -SectionGroupId <string> -UserId <string> -InFile <string>
...
```
Set-MgBetaUserOnenoteSectionGroupSectionPageContent -InputObject <INotesIdentity> -InFile <string>
 [-Data <Stream>] [-ResponseHeadersVariable <string>] [-Break] [-ContentType <string>]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm] [<CommonParameters>]
