...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/get-mgbetagrouponenoteresource
Locale: en-US
Module Name: Microsoft.Graph.Beta.Notes
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaGroupOnenoteResource
---
...
```
Get-MgBetaGroupOnenoteResource -GroupId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaGroupOnenoteResource -GroupId <string> -OnenoteResourceId <string>
...
- [Get-MgBetaGroupOnenoteResource](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/get-mgbetagrouponenoteresource)
