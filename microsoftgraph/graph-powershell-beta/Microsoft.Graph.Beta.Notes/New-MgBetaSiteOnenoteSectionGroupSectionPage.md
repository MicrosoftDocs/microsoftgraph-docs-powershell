...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/new-mgbetasiteonenotesectiongroupsectionpage
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgSiteOnenoteSectionGroupSectionPage](/powershell/module/Microsoft.Graph.Notes/New-MgSiteOnenoteSectionGroupSectionPage?view=graph-powershell-1.0)

## SYNTAX

### CreateExpanded (Default)
```
New-MgBetaSiteOnenoteSectionGroupSectionPage -OnenoteSectionId <String> -SectionGroupId <String>
...
```
New-MgBetaSiteOnenoteSectionGroupSectionPage -InputObject <INotesIdentity> [-ResponseHeadersVariable <String>]
...
### CreateViaIdentity
```
New-MgBetaSiteOnenoteSectionGroupSectionPage -InputObject <INotesIdentity>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/new-mgbetasiteonenotesectiongroupsectionpage](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/new-mgbetasiteonenotesectiongroupsectionpage)
