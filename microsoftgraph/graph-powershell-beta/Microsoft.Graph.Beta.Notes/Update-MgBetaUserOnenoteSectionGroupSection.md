...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetauseronenotesectiongroupsection
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgUserOnenoteSectionGroupSection](/powershell/module/Microsoft.Graph.Notes/Update-MgUserOnenoteSectionGroupSection?view=graph-powershell-1.0)

## SYNTAX

### UpdateExpanded (Default)
```
Update-MgBetaUserOnenoteSectionGroupSection -OnenoteSectionId <String> -SectionGroupId <String>
...
```
Update-MgBetaUserOnenoteSectionGroupSection -InputObject <INotesIdentity> [-ResponseHeadersVariable <String>]
...
### UpdateViaIdentity
```
Update-MgBetaUserOnenoteSectionGroupSection -InputObject <INotesIdentity>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetauseronenotesectiongroupsection](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetauseronenotesectiongroupsection)
