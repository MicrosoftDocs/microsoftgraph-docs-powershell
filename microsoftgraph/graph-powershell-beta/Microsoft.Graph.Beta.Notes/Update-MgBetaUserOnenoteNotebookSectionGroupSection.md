...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetauseronenotenotebooksectiongroupsection
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgUserOnenoteNotebookSectionGroupSection](/powershell/module/Microsoft.Graph.Notes/Update-MgUserOnenoteNotebookSectionGroupSection?view=graph-powershell-1.0)

## SYNTAX

### UpdateExpanded (Default)
```
Update-MgBetaUserOnenoteNotebookSectionGroupSection -NotebookId <String> -OnenoteSectionId <String>
...
```
Update-MgBetaUserOnenoteNotebookSectionGroupSection -NotebookId <String> -OnenoteSectionId <String>
 -SectionGroupId <String> -UserId <String> -BodyParameter <IMicrosoftGraphOnenoteSection>
...
```
Update-MgBetaUserOnenoteNotebookSectionGroupSection -InputObject <INotesIdentity>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetauseronenotenotebooksectiongroupsection](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetauseronenotenotebooksectiongroupsection)
