...
```
Get-MgBetaUserOnenoteNotebookSection -NotebookId <string> -UserId <string>
...
```
Get-MgBetaUserOnenoteNotebookSection -NotebookId <string> -OnenoteSectionId <string>
...
```
Get-MgBetaUserOnenoteNotebookSection -InputObject <INotesIdentity> [-ExpandProperty <string[]>]
