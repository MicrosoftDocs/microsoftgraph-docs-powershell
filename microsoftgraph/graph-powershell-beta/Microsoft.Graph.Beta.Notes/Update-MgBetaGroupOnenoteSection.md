...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetagrouponenotesection
Locale: en-US
Module Name: Microsoft.Graph.Beta.Notes
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaGroupOnenoteSection
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgGroupOnenoteSection](/powershell/module/Microsoft.Graph.Notes/Update-MgGroupOnenoteSection?view=graph-powershell-1.0)
...
```
Update-MgBetaGroupOnenoteSection -InputObject <INotesIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaGroupOnenoteSection -InputObject <INotesIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [Update-MgBetaGroupOnenoteSection](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetagrouponenotesection)
