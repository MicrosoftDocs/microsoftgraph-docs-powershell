...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/new-mgbetasiteonenotepage
schema: 2.0.0
---

# New-MgBetaSiteOnenotePage

## SYNOPSIS
Create new navigation property to pages for sites

> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgSiteOnenoteSectionGroupSection](/powershell/module/Microsoft.Graph.Notes/New-MgSiteOnenoteSectionGroupSection?view=graph-powershell-v1.0)

## SYNTAX

### CreateExpanded (Default)
```
New-MgBetaSiteOnenotePage -SiteId <String> [-AdditionalProperties <Hashtable>] [-ContentInputFile <String>]
...
### Create
```
New-MgBetaSiteOnenotePage -SiteId <String> -BodyParameter <IMicrosoftGraphOnenotePage> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgBetaSiteOnenotePage -InputObject <INotesIdentity> [-AdditionalProperties <Hashtable>]
...
### CreateViaIdentity
```
New-MgBetaSiteOnenotePage -InputObject <INotesIdentity> -BodyParameter <IMicrosoftGraphOnenotePage> [-WhatIf]
...
## RELATED LINKS
[New-MgSiteOnenoteSectionGroupSection](/powershell/module/Microsoft.Graph.Notes/New-MgSiteOnenoteSectionGroupSection?view=graph-powershell-v1.0)
