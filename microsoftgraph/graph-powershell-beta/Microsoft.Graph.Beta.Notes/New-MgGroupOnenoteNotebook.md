...
### Create
```
New-MgGroupOnenoteNotebook -GroupId <String> -BodyParameter <IMicrosoftGraphNotebook1> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### CreateViaIdentity
```
New-MgGroupOnenoteNotebook -InputObject <INotesIdentity> -BodyParameter <IMicrosoftGraphNotebook1> [-WhatIf]
