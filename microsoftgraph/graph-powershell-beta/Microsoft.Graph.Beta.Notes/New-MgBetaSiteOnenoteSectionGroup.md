...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/new-mgbetasiteonenotesectiongroup
Locale: en-US
Module Name: Microsoft.Graph.Beta.Notes
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaSiteOnenoteSectionGroup
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgSiteOnenoteSectionGroup](/powershell/module/Microsoft.Graph.Notes/New-MgSiteOnenoteSectionGroup?view=graph-powershell-1.0)
...
```
New-MgBetaSiteOnenoteSectionGroup -SiteId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaSiteOnenoteSectionGroup -InputObject <INotesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-CreatedBy <IMicrosoftGraphIdentitySet>]
 [-CreatedDateTime <datetime>] [-DisplayName <string>] [-Id <string>]
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-LastModifiedDateTime <datetime>]
 [-ParentNotebook <IMicrosoftGraphNotebook>] [-ParentSectionGroup <IMicrosoftGraphSectionGroup>]
...
```
New-MgBetaSiteOnenoteSectionGroup -InputObject <INotesIdentity>
...
- [New-MgBetaSiteOnenoteSectionGroup](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/new-mgbetasiteonenotesectiongroup)
