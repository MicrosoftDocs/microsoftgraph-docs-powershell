...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPathsQegv42UsersUserIdOnenoteNotebooksNotebookIdSectionsOnenotesectionIdMicrosoftGraphCopytonotebookPostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
- [Copy-MgBetaUserOnenoteNotebookSectionToNotebook](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/copy-mgbetauseronenotenotebooksectiontonotebook)
