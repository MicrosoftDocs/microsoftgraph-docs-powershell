...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/copy-mgbetauseronenotenotebooksectiontonotebook
schema: 2.0.0
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Copy-MgUserOnenoteNotebookSectionToNotebook](/powershell/module/Microsoft.Graph.Notes/Copy-MgUserOnenoteNotebookSectionToNotebook?view=graph-powershell-1.0)

## SYNTAX

### CopyExpanded (Default)
```
Copy-MgBetaUserOnenoteNotebookSectionToNotebook -NotebookId <String> -OnenoteSectionId <String>
...
```
Copy-MgBetaUserOnenoteNotebookSectionToNotebook -InputObject <INotesIdentity>
...
### Microsoft.Graph.Beta.PowerShell.Models.IPathsQegv42UsersUserIdOnenoteNotebooksNotebookIdSectionsOnenotesectionIdMicrosoftGraphCopytonotebookPostRequestbodyContentApplicationJsonSchema
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/copy-mgbetauseronenotenotebooksectiontonotebook](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/copy-mgbetauseronenotenotebooksectiontonotebook)
