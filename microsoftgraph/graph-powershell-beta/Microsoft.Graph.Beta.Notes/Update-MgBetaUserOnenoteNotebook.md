...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetauseronenotenotebook
Locale: en-US
Module Name: Microsoft.Graph.Beta.Notes
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: Update-MgBetaUserOnenoteNotebook
---
...
```
Update-MgBetaUserOnenoteNotebook -InputObject <INotesIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaUserOnenoteNotebook -InputObject <INotesIdentity>
 -BodyParameter <IMicrosoftGraphNotebook> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm] [<CommonParameters>]
