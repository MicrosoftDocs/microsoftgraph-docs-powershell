...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetasiteonenotenotebooksectiongroupcontent
schema: 2.0.0
---

# Update-MgBetaSiteOnenoteNotebookSectionGroupContent

## SYNOPSIS
Update the navigation property sectionGroups in sites

> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgSiteOnenoteNotebookSectionGroupContent](/powershell/module/Microsoft.Graph.Notes/Update-MgSiteOnenoteNotebookSectionGroupContent?view=graph-powershell-1.0)

## SYNTAX

### UpdateExpanded (Default)
```
Update-MgBetaSiteOnenoteNotebookSectionGroupContent -NotebookId <String> -SectionGroupId <String>
...
```
Update-MgBetaSiteOnenoteNotebookSectionGroupContent -InputObject <INotesIdentity>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetasiteonenotenotebooksectiongroupcontent](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetasiteonenotenotebooksectiongroupcontent)
