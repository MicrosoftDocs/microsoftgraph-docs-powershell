...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/copy-mgbetasiteonenotepagetosection
schema: 2.0.0
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Copy-MgSiteOnenotePageToSection](/powershell/module/Microsoft.Graph.Notes/Copy-MgSiteOnenotePageToSection?view=graph-powershell-1.0)
...
```
Copy-MgBetaSiteOnenotePageToSection [-SiteId <String>] -InputObject <INotesIdentity>
 [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>] [-GroupId <String>] [-Id <String>]
...
### CopyViaIdentity
```
Copy-MgBetaSiteOnenotePageToSection -InputObject <INotesIdentity>
 -BodyParameter <IPaths1LarwmeSitesSiteIdOnenotePagesOnenotepageIdMicrosoftGraphCopytosectionPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/copy-mgbetasiteonenotepagetosection](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/copy-mgbetasiteonenotepagetosection)
