...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/copy-mgbetasiteonenotepagetosection
Locale: en-US
Module Name: Microsoft.Graph.Beta.Notes
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: Copy-MgBetaSiteOnenotePageToSection
---
...
```
Copy-MgBetaSiteOnenotePageToSection -InputObject <INotesIdentity> [-SiteId <string>]
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-GroupId <string>]
...
- [Copy-MgBetaSiteOnenotePageToSection](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/copy-mgbetasiteonenotepagetosection)
