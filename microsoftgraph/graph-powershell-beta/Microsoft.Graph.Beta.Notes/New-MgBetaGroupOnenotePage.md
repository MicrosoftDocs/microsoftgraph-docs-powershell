...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/new-mgbetagrouponenotepage
Locale: en-US
Module Name: Microsoft.Graph.Beta.Notes
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaGroupOnenotePage
---
...
```
New-MgBetaGroupOnenotePage -GroupId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaGroupOnenotePage -InputObject <INotesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-ContentInputFile <string>] [-ContentUrl <string>]
 [-CreatedByAppId <string>] [-CreatedDateTime <datetime>] [-Id <string>]
 [-LastModifiedDateTime <datetime>] [-Level <int>] [-Links <IMicrosoftGraphPageLinks>]
 [-Order <int>] [-ParentNotebook <IMicrosoftGraphNotebook>]
...
- [New-MgBetaGroupOnenotePage](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/new-mgbetagrouponenotepage)
