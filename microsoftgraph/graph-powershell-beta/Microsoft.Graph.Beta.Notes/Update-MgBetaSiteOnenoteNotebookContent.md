...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetasiteonenotenotebookcontent
schema: 2.0.0
---

# Update-MgBetaSiteOnenoteNotebookContent

## SYNOPSIS
Update the navigation property notebooks in sites

> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgSiteOnenoteNotebookContent](/powershell/module/Microsoft.Graph.Notes/Update-MgSiteOnenoteNotebookContent?view=graph-powershell-1.0)

## SYNTAX

### UpdateExpanded (Default)
```
Update-MgBetaSiteOnenoteNotebookContent -NotebookId <String> -SiteId <String>
...
```
Update-MgBetaSiteOnenoteNotebookContent -InputObject <INotesIdentity> [-ResponseHeadersVariable <String>]
...
### UpdateViaIdentity
```
Update-MgBetaSiteOnenoteNotebookContent -InputObject <INotesIdentity> -BodyParameter <IMicrosoftGraphNotebook>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetasiteonenotenotebookcontent](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetasiteonenotenotebookcontent)
