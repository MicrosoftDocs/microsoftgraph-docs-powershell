...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetasiteonenotenotebookcontent
Locale: en-US
Module Name: Microsoft.Graph.Beta.Notes
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaSiteOnenoteNotebookContent
---
...
```
Update-MgBetaSiteOnenoteNotebookContent -InputObject <INotesIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <datetime>] [-DisplayName <string>]
 [-Id <string>] [-IsDefault] [-IsShared] [-LastModifiedBy <IMicrosoftGraphIdentitySet>]
 [-LastModifiedDateTime <datetime>] [-Links <IMicrosoftGraphNotebookLinks>]
...
- [Update-MgBetaSiteOnenoteNotebookContent](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetasiteonenotenotebookcontent)
