...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/new-mgbetagrouponenotesectiongroupsectionpage
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgGroupOnenoteSectionGroupSectionPage](/powershell/module/Microsoft.Graph.Notes/New-MgGroupOnenoteSectionGroupSectionPage?view=graph-powershell-1.0)

## SYNTAX

### CreateExpanded (Default)
```
New-MgBetaGroupOnenoteSectionGroupSectionPage -GroupId <String> -OnenoteSectionId <String>
...
```
New-MgBetaGroupOnenoteSectionGroupSectionPage -GroupId <String> -OnenoteSectionId <String>
 -SectionGroupId <String> -BodyParameter <IMicrosoftGraphOnenotePage> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgBetaGroupOnenoteSectionGroupSectionPage -InputObject <INotesIdentity> [-ResponseHeadersVariable <String>]
...
### CreateViaIdentity
```
New-MgBetaGroupOnenoteSectionGroupSectionPage -InputObject <INotesIdentity>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/new-mgbetagrouponenotesectiongroupsectionpage](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/new-mgbetagrouponenotesectiongroupsectionpage)
