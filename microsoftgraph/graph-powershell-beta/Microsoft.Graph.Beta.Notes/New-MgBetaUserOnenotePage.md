...
### Create
```
New-MgBetaUserOnenotePage -UserId <String> -BodyParameter <IMicrosoftGraphOnenotePage> [-Headers <IDictionary>]
...
## RELATED LINKS
[New-MgUserOnenotePage](/powershell/module/Microsoft.Graph.Notes/New-MgUserOnenotePage?view=graph-powershell-1.0)
