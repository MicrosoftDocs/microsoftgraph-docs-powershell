...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgUserOnenoteSectionGroup](/powershell/module/Microsoft.Graph.Notes/Get-MgUserOnenoteSectionGroup?view=graph-powershell-v1.0)

## SYNTAX

### List (Default)
```
Get-MgBetaUserOnenoteSectionGroup -UserId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
## RELATED LINKS
[Get-MgUserOnenoteSectionGroup](/powershell/module/Microsoft.Graph.Notes/Get-MgUserOnenoteSectionGroup?view=graph-powershell-v1.0)
