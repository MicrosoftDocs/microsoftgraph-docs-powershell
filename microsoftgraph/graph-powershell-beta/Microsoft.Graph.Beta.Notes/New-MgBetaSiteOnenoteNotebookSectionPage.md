...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/new-mgbetasiteonenotenotebooksectionpage
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgSiteOnenoteNotebookSectionPage](/powershell/module/Microsoft.Graph.Notes/New-MgSiteOnenoteNotebookSectionPage?view=graph-powershell-1.0)

## SYNTAX

### CreateExpanded (Default)
```
New-MgBetaSiteOnenoteNotebookSectionPage -NotebookId <String> -OnenoteSectionId <String> -SiteId <String>
...
```
New-MgBetaSiteOnenoteNotebookSectionPage -InputObject <INotesIdentity> [-ResponseHeadersVariable <String>]
...
### CreateViaIdentity
```
New-MgBetaSiteOnenoteNotebookSectionPage -InputObject <INotesIdentity>
 -BodyParameter <IMicrosoftGraphOnenotePage> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/new-mgbetasiteonenotenotebooksectionpage](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/new-mgbetasiteonenotenotebooksectionpage)
