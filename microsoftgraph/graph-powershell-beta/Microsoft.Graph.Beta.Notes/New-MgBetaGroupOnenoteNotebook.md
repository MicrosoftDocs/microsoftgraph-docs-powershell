...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/new-mgbetagrouponenotenotebook
Locale: en-US
Module Name: Microsoft.Graph.Beta.Notes
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaGroupOnenoteNotebook
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgGroupOnenoteNotebook](/powershell/module/Microsoft.Graph.Notes/New-MgGroupOnenoteNotebook?view=graph-powershell-1.0)
...
```
New-MgBetaGroupOnenoteNotebook -GroupId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaGroupOnenoteNotebook -GroupId <string> -BodyParameter <IMicrosoftGraphNotebook>
...
```
New-MgBetaGroupOnenoteNotebook -InputObject <INotesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-CreatedBy <IMicrosoftGraphIdentitySet>]
 [-CreatedDateTime <datetime>] [-DisplayName <string>] [-Id <string>] [-IsDefault] [-IsShared]
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-LastModifiedDateTime <datetime>]
 [-Links <IMicrosoftGraphNotebookLinks>] [-SectionGroups <IMicrosoftGraphSectionGroup[]>]
...
```
New-MgBetaGroupOnenoteNotebook -InputObject <INotesIdentity>
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphNotebookLinks
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
- [New-MgBetaGroupOnenoteNotebook](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/new-mgbetagrouponenotenotebook)
