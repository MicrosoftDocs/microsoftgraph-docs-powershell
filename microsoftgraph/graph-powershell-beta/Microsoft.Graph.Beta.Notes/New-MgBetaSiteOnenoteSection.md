...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/new-mgbetasiteonenotesection
Locale: en-US
Module Name: Microsoft.Graph.Beta.Notes
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaSiteOnenoteSection
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgSiteOnenoteSection](/powershell/module/Microsoft.Graph.Notes/New-MgSiteOnenoteSection?view=graph-powershell-1.0)
...
```
New-MgBetaSiteOnenoteSection -SiteId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaSiteOnenoteSection -InputObject <INotesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-CreatedBy <IMicrosoftGraphIdentitySet>]
 [-CreatedDateTime <datetime>] [-DisplayName <string>] [-Id <string>] [-IsDefault]
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-LastModifiedDateTime <datetime>]
 [-Links <IMicrosoftGraphSectionLinks>] [-Pages <IMicrosoftGraphOnenotePage[]>] [-PagesUrl <string>]
...
```
New-MgBetaSiteOnenoteSection -InputObject <INotesIdentity>
...
- [New-MgBetaSiteOnenoteSection](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/new-mgbetasiteonenotesection)
