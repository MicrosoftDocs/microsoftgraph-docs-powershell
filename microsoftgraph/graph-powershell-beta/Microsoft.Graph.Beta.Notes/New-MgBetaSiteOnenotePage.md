...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/new-mgbetasiteonenotepage
Locale: en-US
Module Name: Microsoft.Graph.Beta.Notes
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaSiteOnenotePage
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgSiteOnenotePage](/powershell/module/Microsoft.Graph.Notes/New-MgSiteOnenotePage?view=graph-powershell-1.0)
...
```
New-MgBetaSiteOnenotePage -SiteId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaSiteOnenotePage -InputObject <INotesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-ContentInputFile <string>] [-ContentUrl <string>]
 [-CreatedByAppId <string>] [-CreatedDateTime <datetime>] [-Id <string>]
 [-LastModifiedDateTime <datetime>] [-Level <int>] [-Links <IMicrosoftGraphPageLinks>]
 [-Order <int>] [-ParentNotebook <IMicrosoftGraphNotebook>]
...
- [New-MgBetaSiteOnenotePage](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/new-mgbetasiteonenotepage)
