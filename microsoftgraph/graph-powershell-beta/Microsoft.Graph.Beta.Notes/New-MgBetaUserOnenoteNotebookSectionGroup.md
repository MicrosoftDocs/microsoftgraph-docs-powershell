...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/new-mgbetasiteonenotesectionpage
schema: 2.0.0
---

# New-MgBetaSiteOnenoteSectionPage

## SYNOPSIS
Create new navigation property to pages for sites

> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgUserOnenoteNotebookSectionGroup](/powershell/module/Microsoft.Graph.Notes/New-MgUserOnenoteNotebookSectionGroup?view=graph-powershell-v1.0)

## SYNTAX

### CreateExpanded (Default)
```
New-MgBetaSiteOnenoteSectionPage -OnenoteSectionId <String> -SiteId <String>
...
```
New-MgBetaSiteOnenoteSectionPage -InputObject <INotesIdentity> [-AdditionalProperties <Hashtable>]
...
### CreateViaIdentity
```
New-MgBetaSiteOnenoteSectionPage -InputObject <INotesIdentity> -BodyParameter <IMicrosoftGraphOnenotePage>
...
## RELATED LINKS
[New-MgUserOnenoteNotebookSectionGroup](/powershell/module/Microsoft.Graph.Notes/New-MgUserOnenoteNotebookSectionGroup?view=graph-powershell-v1.0)
