...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetasiteonenoteresourcecontent
schema: 2.0.0
---

# Update-MgBetaSiteOnenoteResourceContent

## SYNOPSIS
Update the navigation property resources in sites

> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgSiteOnenoteResourceContent](/powershell/module/Microsoft.Graph.Notes/Update-MgSiteOnenoteResourceContent?view=graph-powershell-1.0)

## SYNTAX

### UpdateExpanded (Default)
```
Update-MgBetaSiteOnenoteResourceContent -OnenoteResourceId <String> -SiteId <String>
...
```
Update-MgBetaSiteOnenoteResourceContent -InputObject <INotesIdentity> [-ResponseHeadersVariable <String>]
...
### UpdateViaIdentity
```
Update-MgBetaSiteOnenoteResourceContent -InputObject <INotesIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteResource> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetasiteonenoteresourcecontent](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetasiteonenoteresourcecontent)
