...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetauseronenotesection
Locale: en-US
Module Name: Microsoft.Graph.Beta.Notes
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaUserOnenoteSection
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgUserOnenoteSection](/powershell/module/Microsoft.Graph.Notes/Update-MgUserOnenoteSection?view=graph-powershell-1.0)
...
```
Update-MgBetaUserOnenoteSection -InputObject <INotesIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaUserOnenoteSection -InputObject <INotesIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [Update-MgBetaUserOnenoteSection](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetauseronenotesection)
