...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetauseronenoteresource
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgUserOnenoteResource](/powershell/module/Microsoft.Graph.Notes/Update-MgUserOnenoteResource?view=graph-powershell-1.0)

## SYNTAX

### UpdateExpanded (Default)
```
Update-MgBetaUserOnenoteResource -OnenoteResourceId <String> -UserId <String>
...
```
Update-MgBetaUserOnenoteResource -InputObject <INotesIdentity> [-ResponseHeadersVariable <String>]
...
### UpdateViaIdentity
```
Update-MgBetaUserOnenoteResource -InputObject <INotesIdentity> -BodyParameter <IMicrosoftGraphOnenoteResource>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetauseronenoteresource](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetauseronenoteresource)
