...
### Set (Default)
```
Set-MgBetaSiteOnenotePageContent -OnenotePageId <String> -SiteId <String> [-Data <Stream>]
...
### SetViaIdentity
```
Set-MgBetaSiteOnenotePageContent -InputObject <INotesIdentity> [-Data <Stream>]
 [-ResponseHeadersVariable <String>] -InFile <String> [-ContentType <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
