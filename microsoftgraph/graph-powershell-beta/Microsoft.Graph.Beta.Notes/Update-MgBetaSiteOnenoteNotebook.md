...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgSiteOnenoteNotebook](/powershell/module/Microsoft.Graph.Notes/Update-MgSiteOnenoteNotebook?view=graph-powershell-1.0)

## SYNTAX

### UpdateExpanded (Default)
```
Update-MgBetaSiteOnenoteNotebook -NotebookId <String> -SiteId <String> [-ResponseHeadersVariable <String>]
...
### Update
```
Update-MgBetaSiteOnenoteNotebook -NotebookId <String> -SiteId <String> -BodyParameter <IMicrosoftGraphNotebook>
...
```
Update-MgBetaSiteOnenoteNotebook -InputObject <INotesIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <DateTime>]
 [-DisplayName <String>] [-Id <String>] [-IsDefault] [-IsShared] [-LastModifiedBy <IMicrosoftGraphIdentitySet>]
 [-LastModifiedDateTime <DateTime>] [-Links <IMicrosoftGraphNotebookLinks>]
 [-SectionGroups <IMicrosoftGraphSectionGroup[]>] [-SectionGroupsUrl <String>]
...
## RELATED LINKS
[Update-MgSiteOnenoteNotebook](/powershell/module/Microsoft.Graph.Notes/Update-MgSiteOnenoteNotebook?view=graph-powershell-1.0)
