...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetauseronenotenotebooksectiongroup
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgUserOnenoteNotebookSectionGroup](/powershell/module/Microsoft.Graph.Notes/Update-MgUserOnenoteNotebookSectionGroup?view=graph-powershell-1.0)

## SYNTAX

### UpdateExpanded (Default)
```
Update-MgBetaUserOnenoteNotebookSectionGroup -NotebookId <String> -SectionGroupId <String> -UserId <String>
...
```
Update-MgBetaUserOnenoteNotebookSectionGroup -InputObject <INotesIdentity> [-ResponseHeadersVariable <String>]
...
### UpdateViaIdentity
```
Update-MgBetaUserOnenoteNotebookSectionGroup -InputObject <INotesIdentity>
 -BodyParameter <IMicrosoftGraphSectionGroup> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetauseronenotenotebooksectiongroup](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/update-mgbetauseronenotenotebooksectiongroup)
