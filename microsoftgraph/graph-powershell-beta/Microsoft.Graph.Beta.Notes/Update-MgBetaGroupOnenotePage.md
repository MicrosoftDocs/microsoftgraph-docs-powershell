...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgGroupOnenotePage](/powershell/module/Microsoft.Graph.Notes/Update-MgGroupOnenotePage?view=graph-powershell-1.0)

## SYNTAX

### UpdateExpanded (Default)
```
Update-MgBetaGroupOnenotePage -GroupId <String> -OnenotePageId <String> [-ResponseHeadersVariable <String>]
...
```
Update-MgBetaGroupOnenotePage -InputObject <INotesIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-ContentInputFile <String>] [-ContentUrl <String>]
 [-CreatedByAppId <String>] [-CreatedDateTime <DateTime>] [-Id <String>] [-LastModifiedDateTime <DateTime>]
 [-Level <Int32>] [-Links <IMicrosoftGraphPageLinks>] [-Order <Int32>]
 [-ParentNotebook <IMicrosoftGraphNotebook>] [-ParentSection <IMicrosoftGraphOnenoteSection>] [-Self <String>]
...
## RELATED LINKS
[Update-MgGroupOnenotePage](/powershell/module/Microsoft.Graph.Notes/Update-MgGroupOnenotePage?view=graph-powershell-1.0)
