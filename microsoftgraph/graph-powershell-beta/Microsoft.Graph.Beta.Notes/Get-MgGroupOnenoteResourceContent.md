...
### Get1 (Default)
```
Get-MgGroupOnenoteResourceContent -GroupId <String> -OnenoteResourceId <String> -OutFile <String> [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgGroupOnenoteResourceContent -InputObject <INotesIdentity> -OutFile <String> [-PassThru]
 [<CommonParameters>]
```
