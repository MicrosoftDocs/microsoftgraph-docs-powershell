...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/get-mgbetasiteonenotenotebooksection
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaSiteOnenoteNotebookSection -NotebookId <String> -SiteId <String> [-ExpandProperty <String[]>]
...
### Get
```
Get-MgBetaSiteOnenoteNotebookSection -NotebookId <String> -OnenoteSectionId <String> -SiteId <String>
