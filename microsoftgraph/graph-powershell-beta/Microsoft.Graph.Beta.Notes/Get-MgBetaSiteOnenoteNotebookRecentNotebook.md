...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/get-mgbetasiteonenotenotebookrecentnotebook
schema: 2.0.0
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgSiteOnenoteNotebookRecentNotebook](/powershell/module/Microsoft.Graph.Notes/Get-MgSiteOnenoteNotebookRecentNotebook?view=graph-powershell-1.0)

## SYNTAX

### Get (Default)
```
Get-MgBetaSiteOnenoteNotebookRecentNotebook [-IncludePersonalNotebooks] -SiteId <String> [-Count]
...
### GetViaIdentity
```
Get-MgBetaSiteOnenoteNotebookRecentNotebook -InputObject <INotesIdentity> [-Count] [-Filter <String>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/get-mgbetasiteonenotenotebookrecentnotebook](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/get-mgbetasiteonenotenotebookrecentnotebook)
