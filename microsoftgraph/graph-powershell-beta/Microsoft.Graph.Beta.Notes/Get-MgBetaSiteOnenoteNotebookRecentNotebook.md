...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.notes/get-mgbetasiteonenotenotebookrecentnotebook
Locale: en-US
Module Name: Microsoft.Graph.Beta.Notes
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: Get-MgBetaSiteOnenoteNotebookRecentNotebook
---
...
```
Get-MgBetaSiteOnenoteNotebookRecentNotebook -InputObject <INotesIdentity> [-Count]
 [-Filter <string>] [-Search <string>] [-Skip <int>] [-Top <int>]
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [<CommonParameters>]
