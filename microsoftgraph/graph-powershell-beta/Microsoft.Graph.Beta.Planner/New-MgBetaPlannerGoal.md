...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.planner/new-mgbetaplannergoal
Locale: en-US
Module Name: Microsoft.Graph.Beta.Planner
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaPlannerGoal
---

# New-MgBetaPlannerGoal
...
```
New-MgBetaPlannerGoal [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-DisplayName <string>] [-FinishDate <datetime>] [-Id <string>] [-Notes <IMicrosoftGraphItemBody>]
 [-PlanId <string>] [-Priority <int>] [-StartDate <datetime>] [-Status <string>]
...
```
New-MgBetaPlannerGoal -BodyParameter <IMicrosoftGraphPlannerGoal>
...
BODYPARAMETER `<IMicrosoftGraphPlannerGoal>`: plannerGoal
...
- [New-MgBetaPlannerGoal](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.planner/new-mgbetaplannergoal)
