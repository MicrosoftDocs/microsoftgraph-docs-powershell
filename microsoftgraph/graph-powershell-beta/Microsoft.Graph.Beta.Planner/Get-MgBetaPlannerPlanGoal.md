...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.planner/get-mgbetaplannerplangoal
Locale: en-US
Module Name: Microsoft.Graph.Beta.Planner
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaPlannerPlanGoal
---

# Get-MgBetaPlannerPlanGoal
...
```
Get-MgBetaPlannerPlanGoal -PlannerPlanId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaPlannerPlanGoal -PlannerGoalId <string> -PlannerPlanId <string>
...
```
Get-MgBetaPlannerPlanGoal -InputObject <IPlannerIdentity> [-ExpandProperty <string[]>]
