...
### List (Default)
```
Get-MgBetaPlannerPlan [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>] [-Search <String>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.planner/get-mgbetaplannerplan](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.planner/get-mgbetaplannerplan)

[https://learn.microsoft.com/graph/api/plannerplan-get?view=graph-rest-beta](https://learn.microsoft.com/graph/api/plannerplan-get?view=graph-rest-beta)

[https://learn.microsoft.com/graph/api/planner-list-plans?view=graph-rest-beta](https://learn.microsoft.com/graph/api/planner-list-plans?view=graph-rest-beta)
