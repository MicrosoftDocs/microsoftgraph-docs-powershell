...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.planner/get-mgbetaplannerplangoalcount
Locale: en-US
Module Name: Microsoft.Graph.Beta.Planner
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaPlannerPlanGoalCount
---

# Get-MgBetaPlannerPlanGoalCount
...
```
Get-MgBetaPlannerPlanGoalCount -PlannerPlanId <string> [-Filter <string>] [-Search <string>]
...
```
Get-MgBetaPlannerPlanGoalCount -InputObject <IPlannerIdentity> [-Filter <string>] [-Search <string>]
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
```
