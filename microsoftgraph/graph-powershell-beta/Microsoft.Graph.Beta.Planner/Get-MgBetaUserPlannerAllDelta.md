...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.planner/get-mgbetauserplanneralldelta
Locale: en-US
Module Name: Microsoft.Graph.Beta.Planner
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaUserPlannerAllDelta
---
...
```
Get-MgBetaUserPlannerAllDelta -UserId <string> [-ExpandProperty <string[]>] [-Filter <string>]
...
```
Get-MgBetaUserPlannerAllDelta -InputObject <IPlannerIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgBetaUserPlannerAllDelta](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.planner/get-mgbetauserplanneralldelta)
- [Graph API Reference](https://learn.microsoft.com/graph/api/planneruser-list-delta?view=graph-rest-beta)
