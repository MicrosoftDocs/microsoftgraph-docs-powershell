...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.planner/get-mgbetaplannergoaltask
Locale: en-US
Module Name: Microsoft.Graph.Beta.Planner
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaPlannerGoalTask
---

# Get-MgBetaPlannerGoalTask
...
```
Get-MgBetaPlannerGoalTask -PlannerGoalId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaPlannerGoalTask -PlannerGoalId <string> -PlannerTaskId <string>
...
```
Get-MgBetaPlannerGoalTask -InputObject <IPlannerIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgBetaPlannerGoalTask](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.planner/get-mgbetaplannergoaltask)
