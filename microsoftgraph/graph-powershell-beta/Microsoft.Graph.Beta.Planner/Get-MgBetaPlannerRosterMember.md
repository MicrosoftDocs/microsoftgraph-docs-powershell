...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.planner/get-mgbetaplannerrostermember
Locale: en-US
Module Name: Microsoft.Graph.Beta.Planner
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: Get-MgBetaPlannerRosterMember
---
...
```
Get-MgBetaPlannerRosterMember -PlannerRosterId <string> [-ExpandProperty <string[]>]
