...
```
New-MgBetaPlannerRoster [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>] [-Id <String>]
...
[https://learn.microsoft.com/graph/api/planner-post-rosters?view=graph-rest-1.0](https://learn.microsoft.com/graph/api/planner-post-rosters?view=graph-rest-1.0)
