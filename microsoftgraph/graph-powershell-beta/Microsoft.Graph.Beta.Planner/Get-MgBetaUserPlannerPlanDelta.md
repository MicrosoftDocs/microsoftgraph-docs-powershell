...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.planner/get-mgbetauserplannerplandelta
schema: 2.0.0
...
### DeltaViaIdentity
```
Get-MgBetaUserPlannerPlanDelta -InputObject <IPlannerIdentity> [-ExpandProperty <String[]>] [-Filter <String>]
