...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.planner/new-mgbetagroupplannerplanhistoryitem
Locale: en-US
Module Name: Microsoft.Graph.Beta.Planner
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaGroupPlannerPlanHistoryItem
---

# New-MgBetaGroupPlannerPlanHistoryItem
...
```
New-MgBetaGroupPlannerPlanHistoryItem -GroupId <string> -PlannerPlanId <string>
...
```
New-MgBetaGroupPlannerPlanHistoryItem -InputObject <IPlannerIdentity>
 [-ResponseHeadersVariable <string>] [-Actor <IMicrosoftGraphIdentitySet>]
 [-AdditionalProperties <hashtable>] [-EntityId <string>] [-EntityType <string>]
 [-EventType <string>] [-Id <string>] [-OccurredDateTime <datetime>] [-PlanId <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
