...
```
Get-MgBetaUserPlannerRosterPlan -PlannerPlanId <string> -UserId <string>
...
- [Get-MgBetaUserPlannerRosterPlan](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.planner/get-mgbetauserplannerrosterplan)
- [Graph API Reference](https://learn.microsoft.com/graph/api/planneruser-list-rosterplans?view=graph-rest-beta)
