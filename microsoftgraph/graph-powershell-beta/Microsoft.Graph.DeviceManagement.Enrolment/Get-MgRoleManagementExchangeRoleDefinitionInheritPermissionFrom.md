...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/get-mgrolemanagementexchangeroledefinitioninheritpermissionfrom
schema: 2.0.0
---
...
### List (Default)
```
Get-MgRoleManagementExchangeRoleDefinitionInheritPermissionFrom -UnifiedRoleDefinitionId <String>
