...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/get-mgrolemanagementdirectoryroleassignmentrequestdirectoryscopebyref
schema: 2.0.0
---

# Get-MgRoleManagementDirectoryRoleAssignmentRequestDirectoryScopeByRef
...
### Get (Default)
```
Get-MgRoleManagementDirectoryRoleAssignmentRequestDirectoryScopeByRef -UnifiedRoleAssignmentRequestId <String>
 [<CommonParameters>]
```
