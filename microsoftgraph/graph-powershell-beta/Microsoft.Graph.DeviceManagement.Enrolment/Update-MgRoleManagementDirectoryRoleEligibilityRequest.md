...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/update-mgrolemanagementdirectoryroleeligibilityrequest
schema: 2.0.0
---

# Update-MgRoleManagementDirectoryRoleEligibilityRequest
...
```
Update-MgRoleManagementDirectoryRoleEligibilityRequest -UnifiedRoleEligibilityRequestId <String>
...
```
Update-MgRoleManagementDirectoryRoleEligibilityRequest -UnifiedRoleEligibilityRequestId <String>
 -BodyParameter <IMicrosoftGraphUnifiedRoleEligibilityRequest> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgRoleManagementDirectoryRoleEligibilityRequest -InputObject <IDeviceManagementEnrolmentIdentity>
 [-Action <String>] [-AdditionalProperties <Hashtable>] [-AppScope <IMicrosoftGraphAppScope>]
 [-AppScopeId <String>] [-ApprovalId <String>] [-CompletedDateTime <DateTime>]
 [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <DateTime>] [-CustomData <String>]
 [-DirectoryScope <IMicrosoftGraphDirectoryObject>] [-DirectoryScopeId <String>] [-Id <String>]
...
### -UnifiedRoleEligibilityRequestId
...
### Microsoft.Graph.PowerShell.Models.IMicrosoftGraphUnifiedRoleEligibilityRequest
...
BODYPARAMETER <IMicrosoftGraphUnifiedRoleEligibilityRequest>: unifiedRoleEligibilityRequest
  - `[(Any) <Object>]`: This indicates any property can be added to this object.
  - `[ApprovalId <String>]`: 
