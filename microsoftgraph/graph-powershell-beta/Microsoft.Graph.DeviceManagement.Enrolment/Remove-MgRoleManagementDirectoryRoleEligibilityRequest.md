...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/remove-mgrolemanagementdirectoryroleeligibilityrequest
schema: 2.0.0
---

# Remove-MgRoleManagementDirectoryRoleEligibilityRequest
...
### Delete (Default)
```
Remove-MgRoleManagementDirectoryRoleEligibilityRequest -UnifiedRoleEligibilityRequestId <String>
 [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgRoleManagementDirectoryRoleEligibilityRequest -InputObject <IDeviceManagementEnrolmentIdentity>
 [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
