...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/set-mgrolemanagemententitlementmanagementroleassignmentdirectoryscopebyref
schema: 2.0.0
---
...
### SetExpanded (Default)
```
Set-MgRoleManagementEntitlementManagementRoleAssignmentDirectoryScopeByRef -UnifiedRoleAssignmentId <String>
