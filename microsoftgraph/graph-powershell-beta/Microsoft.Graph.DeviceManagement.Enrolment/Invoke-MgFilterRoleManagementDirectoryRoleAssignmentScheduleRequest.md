...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/invoke-mgfilterrolemanagementdirectoryroleassignmentschedulerequest
schema: 2.0.0
---
...
### Filter (Default)
```
Invoke-MgFilterRoleManagementDirectoryRoleAssignmentScheduleRequest -On <String> [<CommonParameters>]
```
