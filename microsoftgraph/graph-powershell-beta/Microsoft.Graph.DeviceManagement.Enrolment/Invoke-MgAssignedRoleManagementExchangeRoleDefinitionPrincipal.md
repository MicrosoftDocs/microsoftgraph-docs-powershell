...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/invoke-mgassignedrolemanagementexchangeroledefinitionprincipal
schema: 2.0.0
---

# Invoke-MgAssignedRoleManagementExchangeRoleDefinitionPrincipal
...
### Assigned (Default)
```
Invoke-MgAssignedRoleManagementExchangeRoleDefinitionPrincipal -UnifiedRoleDefinitionId <String> [-Count]
