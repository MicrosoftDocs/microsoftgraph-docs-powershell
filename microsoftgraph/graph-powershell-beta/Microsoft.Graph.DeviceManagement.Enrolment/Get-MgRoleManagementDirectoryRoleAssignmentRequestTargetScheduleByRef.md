...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/get-mgrolemanagementdirectoryroleassignmentrequesttargetschedulebyref
schema: 2.0.0
---

# Get-MgRoleManagementDirectoryRoleAssignmentRequestTargetScheduleByRef
...
### Get (Default)
```
Get-MgRoleManagementDirectoryRoleAssignmentRequestTargetScheduleByRef -UnifiedRoleAssignmentRequestId <String>
 [<CommonParameters>]
```
