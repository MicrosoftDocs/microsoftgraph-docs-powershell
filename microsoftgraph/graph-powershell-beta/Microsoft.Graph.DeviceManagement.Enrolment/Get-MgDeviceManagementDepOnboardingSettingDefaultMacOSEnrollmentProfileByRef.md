...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/get-mgdevicemanagementdeponboardingsettingdefaultmacosenrollmentprofilebyref
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgDeviceManagementDepOnboardingSettingDefaultMacOSEnrollmentProfileByRef -DepOnboardingSettingId <String>
 [<CommonParameters>]
```
