...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/get-mgrolemanagementcloudpcroleassignmentappscope
schema: 2.0.0
---
...
### Get
```
Get-MgRoleManagementCloudPcRoleAssignmentAppScope -AppScopeId <String>
...
### GetViaIdentity
```
Get-MgRoleManagementCloudPcRoleAssignmentAppScope -InputObject <IDeviceManagementEnrolmentIdentity>
