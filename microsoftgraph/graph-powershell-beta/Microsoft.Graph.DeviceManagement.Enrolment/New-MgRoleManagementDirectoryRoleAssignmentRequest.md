...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/new-mgrolemanagementdirectoryroleassignmentrequest
schema: 2.0.0
---

# New-MgRoleManagementDirectoryRoleAssignmentRequest
...
```
New-MgRoleManagementDirectoryRoleAssignmentRequest [-Action <String>]
...
### Create
```
New-MgRoleManagementDirectoryRoleAssignmentRequest -BodyParameter <IMicrosoftGraphUnifiedRoleAssignmentRequest>
...
### Microsoft.Graph.PowerShell.Models.IMicrosoftGraphUnifiedRoleAssignmentRequest
...
BODYPARAMETER <IMicrosoftGraphUnifiedRoleAssignmentRequest>: unifiedRoleAssignmentRequest
  - `[(Any) <Object>]`: This indicates any property can be added to this object.
  - `[ApprovalId <String>]`: 
