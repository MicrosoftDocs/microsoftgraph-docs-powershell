...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/set-mgrolemanagementdirectoryroleassignmentrequesttargetschedulebyref
schema: 2.0.0
---

# Set-MgRoleManagementDirectoryRoleAssignmentRequestTargetScheduleByRef
...
### SetExpanded (Default)
```
Set-MgRoleManagementDirectoryRoleAssignmentRequestTargetScheduleByRef -UnifiedRoleAssignmentRequestId <String>
