...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/remove-mgrolemanagementcloudpcroleassignmentroledefinitionbyref
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgRoleManagementCloudPcRoleAssignmentRoleDefinitionByRef -UnifiedRoleAssignmentMultipleId <String>
