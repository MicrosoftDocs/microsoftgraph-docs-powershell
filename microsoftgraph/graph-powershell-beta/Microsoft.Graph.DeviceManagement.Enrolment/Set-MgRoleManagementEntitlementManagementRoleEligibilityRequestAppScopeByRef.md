...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/set-mgrolemanagemententitlementmanagementroleeligibilityrequestappscopebyref
schema: 2.0.0
---

# Set-MgRoleManagementEntitlementManagementRoleEligibilityRequestAppScopeByRef
...
```
Set-MgRoleManagementEntitlementManagementRoleEligibilityRequestAppScopeByRef
 -UnifiedRoleEligibilityRequestId <String> [-AdditionalProperties <Hashtable>] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```
Set-MgRoleManagementEntitlementManagementRoleEligibilityRequestAppScopeByRef
 -UnifiedRoleEligibilityRequestId <String> -BodyParameter <Hashtable> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
