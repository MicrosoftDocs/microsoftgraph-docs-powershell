...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/get-mgrolemanagementcloudpcresourcenamespaceresourceactionresourcescope
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgRoleManagementCloudPcResourceNamespaceResourceActionResourceScope -UnifiedRbacResourceActionId <String>
