...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/stop-mgrolemanagementdirectoryroleassignmentrequest
schema: 2.0.0
---

# Stop-MgRoleManagementDirectoryRoleAssignmentRequest
...
### Cancel (Default)
```
Stop-MgRoleManagementDirectoryRoleAssignmentRequest -UnifiedRoleAssignmentRequestId <String> [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### CancelViaIdentity
```
Stop-MgRoleManagementDirectoryRoleAssignmentRequest -InputObject <IDeviceManagementEnrolmentIdentity>
