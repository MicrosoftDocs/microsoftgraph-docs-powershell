...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/get-mgdevicemanagementwindowautopilotdeviceidentityintendeddeploymentprofilebyref
schema: 2.0.0
---
...
```
Get-MgDeviceManagementWindowAutopilotDeviceIdentityIntendedDeploymentProfileByRef
 -WindowsAutopilotDeviceIdentityId <String> [<CommonParameters>]
```
