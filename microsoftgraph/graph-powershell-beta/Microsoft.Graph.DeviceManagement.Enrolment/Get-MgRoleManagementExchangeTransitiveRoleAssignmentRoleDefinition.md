...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/get-mgrolemanagementexchangetransitiveroleassignmentroledefinition
schema: 2.0.0
---

# Get-MgRoleManagementExchangeTransitiveRoleAssignmentRoleDefinition
...
### Get (Default)
```
Get-MgRoleManagementExchangeTransitiveRoleAssignmentRoleDefinition -UnifiedRoleAssignmentId <String>
