...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/get-mgrolemanagementcloudpcroleassignmentdirectoryscope
schema: 2.0.0
---
...
### List (Default)
```
Get-MgRoleManagementCloudPcRoleAssignmentDirectoryScope -UnifiedRoleAssignmentMultipleId <String>
...
### Get
```
Get-MgRoleManagementCloudPcRoleAssignmentDirectoryScope -DirectoryObjectId <String>
...
### GetViaIdentity
```
Get-MgRoleManagementCloudPcRoleAssignmentDirectoryScope -InputObject <IDeviceManagementEnrolmentIdentity>
