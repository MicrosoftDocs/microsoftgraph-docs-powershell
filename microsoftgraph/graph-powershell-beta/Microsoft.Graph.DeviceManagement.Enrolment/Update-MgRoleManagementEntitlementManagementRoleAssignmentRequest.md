...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/update-mgrolemanagemententitlementmanagementroleassignmentrequest
schema: 2.0.0
---

# Update-MgRoleManagementEntitlementManagementRoleAssignmentRequest
...
```
Update-MgRoleManagementEntitlementManagementRoleAssignmentRequest -UnifiedRoleAssignmentRequestId <String>
...
```
Update-MgRoleManagementEntitlementManagementRoleAssignmentRequest -UnifiedRoleAssignmentRequestId <String>
 -BodyParameter <IMicrosoftGraphUnifiedRoleAssignmentRequest> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```
Update-MgRoleManagementEntitlementManagementRoleAssignmentRequest
 -InputObject <IDeviceManagementEnrolmentIdentity> -BodyParameter <IMicrosoftGraphUnifiedRoleAssignmentRequest>
