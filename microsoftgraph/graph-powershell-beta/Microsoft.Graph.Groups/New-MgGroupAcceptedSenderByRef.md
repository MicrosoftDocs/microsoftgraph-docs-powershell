...
### Create (Default)
```
New-MgGroupAcceptedSenderByRef -GroupId <String> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgGroupAcceptedSenderByRef -InputObject <IGroupsIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
