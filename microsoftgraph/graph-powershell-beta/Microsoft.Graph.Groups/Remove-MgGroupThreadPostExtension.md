...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/remove-mgbetagroupthreadpostextension
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgBetaGroupThreadPostExtension -InputObject <IGroupsIdentity> [-IfMatch <String>] [-PassThru] [-WhatIf]
