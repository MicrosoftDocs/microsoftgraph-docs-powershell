...
### Delta (Default)
```
Get-MgBetaGroupDriveListItemDelta -DriveId <String> -GroupId <String> [-Filter <String>] [-Property <String[]>]
...
### Delta1
```
Get-MgBetaGroupDriveListItemDelta -DriveId <String> -GroupId <String> -Token <String> [-Filter <String>]
...
### DeltaViaIdentity1
```
Get-MgBetaGroupDriveListItemDelta -InputObject <IGroupsIdentity> [-Filter <String>] [-Property <String[]>]
