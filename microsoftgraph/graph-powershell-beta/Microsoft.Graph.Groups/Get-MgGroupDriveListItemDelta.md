...
### Delta (Default)
```
Get-MgGroupDriveListItemDelta -DriveId <String> -GroupId <String> [-Filter <String>] [-Property <String[]>]
...
### Delta1
```
Get-MgGroupDriveListItemDelta -DriveId <String> -GroupId <String> -Token <String> [-Filter <String>]
...
### DeltaViaIdentity1
```
Get-MgGroupDriveListItemDelta -InputObject <IGroupsIdentity> [-Filter <String>] [-Property <String[]>]
