...
### Dismiss (Default)
```
Invoke-MgDismissGroupCalendarEventReminder -EventId <String> -GroupId <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### DismissViaIdentity
```
Invoke-MgDismissGroupCalendarEventReminder -InputObject <IGroupsIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
