...
### Publish (Default)
```
Publish-MgBetaGroupDriveListContentType -ContentTypeId <String> -DriveId <String> -GroupId <String> [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### PublishViaIdentity
```
Publish-MgBetaGroupDriveListContentType -InputObject <IGroupsIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
