...
### Create
```
New-MgBetaGroupEndpoint -GroupId <String> -BodyParameter <IMicrosoftGraphEndpoint> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### CreateViaIdentity
```
New-MgBetaGroupEndpoint -InputObject <IGroupsIdentity> -BodyParameter <IMicrosoftGraphEndpoint> [-WhatIf]
