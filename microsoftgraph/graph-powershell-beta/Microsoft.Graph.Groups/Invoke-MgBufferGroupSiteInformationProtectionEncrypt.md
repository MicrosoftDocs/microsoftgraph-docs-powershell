...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups/invoke-mgbuffergroupsiteinformationprotectionencrypt
schema: 2.0.0
---
...
```
Invoke-MgBufferGroupSiteInformationProtectionEncrypt -GroupId <String> -SiteId <String>
...
```
Invoke-MgBufferGroupSiteInformationProtectionEncrypt -InputObject <IGroupsIdentity>
 [-AdditionalProperties <Hashtable>] [-BufferInputFile <String>] [-LabelId <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### Microsoft.Graph.PowerShell.Models.IPaths1G9H29GGroupsGroupIdSitesSiteIdInformationprotectionMicrosoftGraphEncryptbufferPostRequestbodyContentApplicationJsonSchema
## OUTPUTS
