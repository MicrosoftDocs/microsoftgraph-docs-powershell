...
```
New-MgBetaSubscription [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>]
...
### Create
```
New-MgBetaSubscription -BodyParameter <IMicrosoftGraphSubscription> [-ResponseHeadersVariable <String>]
