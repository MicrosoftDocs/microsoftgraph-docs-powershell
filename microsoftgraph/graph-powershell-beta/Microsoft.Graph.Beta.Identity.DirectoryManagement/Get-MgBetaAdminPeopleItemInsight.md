...
| --------------- | ------------------------------------------  |
| Delegated (work or school account) | AgentIdUser.ReadWrite.All, AgentIdUser.ReadWrite.IdentityParentedBy, PeopleSettings.Read.All, PeopleSettings.ReadWrite.All, User.Read, User.Read.All, User.ReadWrite, User.ReadWrite.All,  |
