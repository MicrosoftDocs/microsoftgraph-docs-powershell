...
### List1 (Default)
```
Get-MgContactTransitiveMemberOf -OrgContactId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
### Get1
```
Get-MgContactTransitiveMemberOf -DirectoryObjectId <String> -OrgContactId <String> [-ExpandProperty <String[]>]
