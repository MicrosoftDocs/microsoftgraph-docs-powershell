...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/remove-mgbetadomain
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.DirectoryManagement
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: Remove-MgBetaDomain
---
...
```
Remove-MgBetaDomain -DomainId <string> [-IfMatch <string>] [-ResponseHeadersVariable <string>]
...
- [Remove-MgBetaDomain](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/remove-mgbetadomain)
- [Graph API Reference](https://learn.microsoft.com/graph/api/domain-delete?view=graph-rest-beta)
