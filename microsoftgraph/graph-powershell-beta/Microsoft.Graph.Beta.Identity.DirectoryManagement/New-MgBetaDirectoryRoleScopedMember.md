...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgDirectoryRoleScopedMember](/powershell/module/Microsoft.Graph.Identity.DirectoryManagement/New-MgDirectoryRoleScopedMember?view=graph-powershell-1.0)
...
```
New-MgBetaDirectoryRoleScopedMember -DirectoryRoleId <string> [-ResponseHeadersVariable <string>]
...
- [New-MgBetaDirectoryRoleScopedMember](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/new-mgbetadirectoryrolescopedmember)
