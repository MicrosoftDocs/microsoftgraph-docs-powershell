...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgDomainNameReference](/powershell/module/Microsoft.Graph.Identity.DirectoryManagement/Get-MgDomainNameReference?view=graph-powershell-v1.0)

## SYNTAX

### List (Default)
```
Get-MgBetaDomainNameReference -DomainId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
