...
```
Update-MgBetaDomainSharedEmailDomainInvitation -DomainId <String> -SharedEmailDomainInvitationId <String>
 [-AdditionalProperties <Hashtable>] [-ExpiryTime <DateTime>] [-Id <String>] [-InvitationDomain <String>]
 [-InvitationStatus <String>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Update
```
Update-MgBetaDomainSharedEmailDomainInvitation -DomainId <String> -SharedEmailDomainInvitationId <String>
 -BodyParameter <IMicrosoftGraphSharedEmailDomainInvitation> [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgDomainSharedEmailDomainInvitation](/powershell/module/Microsoft.Graph.Identity.DirectoryManagement/Update-MgDomainSharedEmailDomainInvitation?view=graph-powershell-v1.0)
