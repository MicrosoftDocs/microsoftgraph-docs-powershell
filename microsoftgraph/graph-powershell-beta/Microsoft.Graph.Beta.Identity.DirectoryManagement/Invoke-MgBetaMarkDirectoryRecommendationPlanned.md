...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/invoke-mgbetamarkdirectoryrecommendationplanned
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.DirectoryManagement
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Invoke-MgBetaMarkDirectoryRecommendationPlanned
---

# Invoke-MgBetaMarkDirectoryRecommendationPlanned
...
```
Invoke-MgBetaMarkDirectoryRecommendationPlanned -RecommendationId <string>
...
```
Invoke-MgBetaMarkDirectoryRecommendationPlanned -InputObject <IIdentityDirectoryManagementIdentity>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
- [Invoke-MgBetaMarkDirectoryRecommendationPlanned](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/invoke-mgbetamarkdirectoryrecommendationplanned)
