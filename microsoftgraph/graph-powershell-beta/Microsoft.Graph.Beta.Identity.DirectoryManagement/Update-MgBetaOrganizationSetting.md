...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/update-mgbetaorganizationsetting
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.DirectoryManagement
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaOrganizationSetting
---
...
Update-MgBetaOrganizationSetting -OrganizationId <string> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-ContactInsights <IMicrosoftGraphInsightsSettings>]
 ...
 [-PeopleInsights <IMicrosoftGraphInsightsSettings>] [-Break] [-Headers <IDictionary>]
...
```
Update-MgBetaOrganizationSetting -OrganizationId <string>
 -BodyParameter <IMicrosoftGraphOrganizationSettings> [-ResponseHeadersVariable <string>] [-Break]
...
- [Update-MgBetaOrganizationSetting](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/update-mgbetaorganizationsetting)
