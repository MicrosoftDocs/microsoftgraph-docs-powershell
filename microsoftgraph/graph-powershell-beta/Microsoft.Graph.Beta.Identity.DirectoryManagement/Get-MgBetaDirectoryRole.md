...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgDirectoryRole](/powershell/module/Microsoft.Graph.Identity.DirectoryManagement/Get-MgDirectoryRole?view=graph-powershell-v1.0)
...
```powershell
Get-MgBetaDirectoryRole ### Example 1: Get all directory roles### Example 2: Get a directory role by Id

```powershell
Get-MgBetaDirectoryRole -DirectoryRoleId 'a2d10e79-df32-47fc-86ef-64d199860810' ### Example 2: Get a directory role by Id
## PARAMETERS
