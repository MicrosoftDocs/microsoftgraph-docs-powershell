...
# Remove-MgBetaOrganizationBrandingTheme
...
```
Remove-MgBetaOrganizationBrandingTheme -OrganizationId <string>
 -OrganizationalBrandingThemeId <string> [-IfMatch <string>] [-ResponseHeadersVariable <string>]
...
```
Remove-MgBetaOrganizationBrandingTheme -InputObject <IIdentityDirectoryManagementIdentity>
