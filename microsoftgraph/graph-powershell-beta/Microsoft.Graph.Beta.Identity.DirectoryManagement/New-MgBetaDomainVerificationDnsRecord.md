...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/new-mgbetadomainverificationdnsrecord
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.DirectoryManagement
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaDomainVerificationDnsRecord
---
...
New-MgBetaDomainVerificationDnsRecord -DomainId <string> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Id <string>] [-IsOptional] [-Label <string>]
 [-RecordType <string>] [-SupportedService <string>] [-Ttl <int>] [-Break] [-Headers <IDictionary>]
...
```
New-MgBetaDomainVerificationDnsRecord -DomainId <string>
 -BodyParameter <IMicrosoftGraphDomainDnsRecord> [-ResponseHeadersVariable <string>] [-Break]
...
New-MgBetaDomainVerificationDnsRecord -InputObject <IIdentityDirectoryManagementIdentity>
 ...
 [-IsOptional] [-Label <string>] [-RecordType <string>] [-SupportedService <string>] [-Ttl <int>]
...
- [New-MgBetaDomainVerificationDnsRecord](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/new-mgbetadomainverificationdnsrecord)
