...
# New-MgBetaDirectoryRecoverySnapshot
...
```
New-MgBetaDirectoryRecoverySnapshot [-ResponseHeadersVariable <string>]
 ...
 [-TotalChangedObjects <int>] [-Break] [-Headers <IDictionary>]
...
```
New-MgBetaDirectoryRecoverySnapshot -BodyParameter <IMicrosoftGraphEntraRecoveryServicesSnapshot>
...
To construct, see NOTES section for RECOVERYJOBS properties and create a hash table.

```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphEntraRecoveryServicesRecoveryJob[]
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
To construct, see NOTES section for RECOVERYPREVIEWJOBS properties and create a hash table.

```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphEntraRecoveryServicesRecoveryPreviewJob[]
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
BODYPARAMETER <IMicrosoftGraphEntraRecoveryServicesSnapshot>: snapshot
