...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/add-mgbetadirectoryimpactedresourcetag
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.DirectoryManagement
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Add-MgBetaDirectoryImpactedResourceTag
---

# Add-MgBetaDirectoryImpactedResourceTag
...
```
Add-MgBetaDirectoryImpactedResourceTag -ImpactedResourceId <string>
...
```
Add-MgBetaDirectoryImpactedResourceTag -ImpactedResourceId <string>
 -BodyParameter <IPaths1DjlyacDirectoryImpactedresourcesImpactedresourceIdMicrosoftGraphAddtagPostRequestbodyContentApplicationJsonSchema>
...
```
Add-MgBetaDirectoryImpactedResourceTag -InputObject <IIdentityDirectoryManagementIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-DisplayName <string>]
 [-Break] [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths1DjlyacDirectoryImpactedresourcesImpactedresourceIdMicrosoftGraphAddtagPostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths1DjlyacDirectoryImpactedresourcesImpactedresourceIdMicrosoftGraphAddtagPostRequestbodyContentApplicationJsonSchema
...
- [Add-MgBetaDirectoryImpactedResourceTag](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/add-mgbetadirectoryimpactedresourcetag)
