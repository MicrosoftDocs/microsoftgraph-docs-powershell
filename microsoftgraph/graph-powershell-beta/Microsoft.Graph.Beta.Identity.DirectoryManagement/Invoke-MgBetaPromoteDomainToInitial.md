...
### Promote (Default)
```
Invoke-MgBetaPromoteDomainToInitial -DomainId <String> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### PromoteViaIdentity
```
Invoke-MgBetaPromoteDomainToInitial -InputObject <IIdentityDirectoryManagementIdentity> [-PassThru] [-WhatIf]
