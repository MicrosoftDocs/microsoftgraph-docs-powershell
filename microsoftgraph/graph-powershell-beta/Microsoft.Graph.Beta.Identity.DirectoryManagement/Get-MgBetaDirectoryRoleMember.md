...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/get-mgbetadirectoryrolemember
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.DirectoryManagement
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Get-MgBetaDirectoryRoleMember
---
...
```
Get-MgBetaDirectoryRoleMember -DirectoryRoleId <string> [-ExpandProperty <string[]>]
