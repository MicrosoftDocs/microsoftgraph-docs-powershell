...
# New-MgBetaDirectoryRemoteTenantGroup
...
```
New-MgBetaDirectoryRemoteTenantGroup [-ResponseHeadersVariable <string>]
...
```
New-MgBetaDirectoryRemoteTenantGroup -BodyParameter <IMicrosoftGraphRemoteTenantGroup>
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphRemoteTenantGroup
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphRemoteTenantGroup
...
- [New-MgBetaDirectoryRemoteTenantGroup](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/new-mgbetadirectoryremotetenantgroup)
