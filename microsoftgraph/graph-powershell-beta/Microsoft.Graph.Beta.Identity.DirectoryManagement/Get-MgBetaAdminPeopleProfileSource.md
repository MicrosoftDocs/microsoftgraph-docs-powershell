...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/get-mgbetaadminpeopleprofilesource
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.DirectoryManagement
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaAdminPeopleProfileSource
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgAdminPeopleProfileSource](/powershell/module/Microsoft.Graph.Identity.DirectoryManagement/Get-MgAdminPeopleProfileSource?view=graph-powershell-1.0)
...
```
Get-MgBetaAdminPeopleProfileSource [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaAdminPeopleProfileSource -ProfileSourceId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaAdminPeopleProfileSource -InputObject <IIdentityDirectoryManagementIdentity>
...
- [Get-MgBetaAdminPeopleProfileSource](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/get-mgbetaadminpeopleprofilesource)
- [Graph API Reference](https://learn.microsoft.com/graph/api/peopleadminsettings-list-profilesources?view=graph-rest-beta)
