...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/get-mgbetaadministrativeunitdelta
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.DirectoryManagement
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaAdministrativeUnitDelta
---
...
```
Get-MgBetaAdministrativeUnitDelta [-ExpandProperty <string[]>] [-Filter <string>]
...
- [Get-MgBetaAdministrativeUnitDelta](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/get-mgbetaadministrativeunitdelta)
- [Graph API Reference](https://learn.microsoft.com/graph/api/administrativeunit-delta?view=graph-rest-beta)
