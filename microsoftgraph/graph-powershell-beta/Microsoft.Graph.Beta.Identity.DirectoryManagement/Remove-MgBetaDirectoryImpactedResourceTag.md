...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/remove-mgbetadirectoryimpactedresourcetag
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.DirectoryManagement
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Remove-MgBetaDirectoryImpactedResourceTag
---

# Remove-MgBetaDirectoryImpactedResourceTag
...
```
Remove-MgBetaDirectoryImpactedResourceTag -ImpactedResourceId <string>
...
```
Remove-MgBetaDirectoryImpactedResourceTag -ImpactedResourceId <string>
 -BodyParameter <IPaths11OgdfjDirectoryImpactedresourcesImpactedresourceIdMicrosoftGraphRemovetagPostRequestbodyContentApplicationJsonSchema>
...
```
Remove-MgBetaDirectoryImpactedResourceTag -ImpactedResourceId <string> -RecommendationTagId <string>
...
```
Remove-MgBetaDirectoryImpactedResourceTag -InputObject <IIdentityDirectoryManagementIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-TagId <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths11OgdfjDirectoryImpactedresourcesImpactedresourceIdMicrosoftGraphRemovetagPostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths11OgdfjDirectoryImpactedresourcesImpactedresourceIdMicrosoftGraphRemovetagPostRequestbodyContentApplicationJsonSchema
...
- [Remove-MgBetaDirectoryImpactedResourceTag](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/remove-mgbetadirectoryimpactedresourcetag)
