...
### Delete (Default)
```
Remove-MgBetaDirectoryPendingExternalUserProfile -PendingExternalUserProfileId <String> [-IfMatch <String>]
...
[https://learn.microsoft.com/graph/api/directory-delete-pendingexternaluserprofiles?view=graph-rest-beta](https://learn.microsoft.com/graph/api/directory-delete-pendingexternaluserprofiles?view=graph-rest-beta)
