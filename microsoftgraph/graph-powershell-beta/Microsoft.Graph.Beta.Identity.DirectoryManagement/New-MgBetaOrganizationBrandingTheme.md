...
# New-MgBetaOrganizationBrandingTheme
...
```
New-MgBetaOrganizationBrandingTheme -OrganizationId <string> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Id <string>] [-IsDefaultTheme]
...
```
New-MgBetaOrganizationBrandingTheme -OrganizationId <string>
...
```
New-MgBetaOrganizationBrandingTheme -InputObject <IIdentityDirectoryManagementIdentity>
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphOrganizationalBrandingTheme
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
Indicates whether the theme is set as the default branding theme for the entire tenant and includes all applications within the tenant.
