...
# Stop-MgBetaDirectoryRecoveryJob
...
```
Stop-MgBetaDirectoryRecoveryJob -RecoveryJobBaseId <string> [-ResponseHeadersVariable <string>]
...
```
Stop-MgBetaDirectoryRecoveryJob -InputObject <IIdentityDirectoryManagementIdentity>
