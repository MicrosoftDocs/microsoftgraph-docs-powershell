...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/add-mgbetabulkdirectoryrecommendationimpactedresourcetag
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.DirectoryManagement
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Add-MgBetaBulkDirectoryRecommendationImpactedResourceTag
---

# Add-MgBetaBulkDirectoryRecommendationImpactedResourceTag
...
```
Add-MgBetaBulkDirectoryRecommendationImpactedResourceTag -RecommendationId <string>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-DisplayName <string>]
 [-ResourceIds <string[]>] [-Break] [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
...
```
Add-MgBetaBulkDirectoryRecommendationImpactedResourceTag -RecommendationId <string>
 -BodyParameter <IPaths1Equ8OtDirectoryRecommendationsRecommendationIdImpactedresourcesMicrosoftGraphAddtagPostRequestbodyContentApplicationJsonSchema>
...
Add-MgBetaBulkDirectoryRecommendationImpactedResourceTag
 ...
 [-AdditionalProperties <hashtable>] [-DisplayName <string>] [-ResourceIds <string[]>] [-Break]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths1Equ8OtDirectoryRecommendationsRecommendationIdImpactedresourcesMicrosoftGraphAddtagPostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
- Name: AddViaIdentity1
  Position: Named
  IsRequired: true
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths1Equ8OtDirectoryRecommendationsRecommendationIdImpactedresourcesMicrosoftGraphAddtagPostRequestbodyContentApplicationJsonSchema
...
- [Add-MgBetaBulkDirectoryRecommendationImpactedResourceTag](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/add-mgbetabulkdirectoryrecommendationimpactedresourcetag)
