...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgContact](/powershell/module/Microsoft.Graph.Identity.DirectoryManagement/Get-MgContact?view=graph-powershell-v1.0)
...
```powershell
Get-MgBetaContact ### Example 1: Retrieve contact objects in the directory 
## PARAMETERS
