...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/remove-mgbetadirectoryexternaluserprofile
schema: 2.0.0
...
### Delete (Default)
```
Remove-MgBetaDirectoryExternalUserProfile -ExternalUserProfileId <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgBetaDirectoryExternalUserProfile -InputObject <IIdentityDirectoryManagementIdentity>
...
[https://learn.microsoft.com/graph/api/directory-delete-externaluserprofiles?view=graph-rest-beta](https://learn.microsoft.com/graph/api/directory-delete-externaluserprofiles?view=graph-rest-beta)
