...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/get-mgbetadomain
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.DirectoryManagement
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaDomain
---
...
```
Get-MgBetaDomain [-ExpandProperty <string[]>] [-Property <string[]>] [-Filter <string>]
...
- [Get-MgBetaDomain](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/get-mgbetadomain)
- [Graph API Reference](https://learn.microsoft.com/graph/api/domain-get?view=graph-rest-beta)
- [Graph API Reference](https://learn.microsoft.com/graph/api/domain-list?view=graph-rest-beta)
