...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/get-mgbetaorganizationbrandingthemecount
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.DirectoryManagement
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaOrganizationBrandingThemeCount
---

# Get-MgBetaOrganizationBrandingThemeCount
...
```
Get-MgBetaOrganizationBrandingThemeCount -OrganizationId <string> [-Filter <string>]
...
```
Get-MgBetaOrganizationBrandingThemeCount -InputObject <IIdentityDirectoryManagementIdentity>
...
| --------------- | ------------------------------------------  |
| Delegated (work or school account) | OrganizationalBranding.Read.All,  |
| Delegated (personal Microsoft account) | Not supported |
| Application | OrganizationalBranding.Read.All,  |
...
- [Get-MgBetaOrganizationBrandingThemeCount](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/get-mgbetaorganizationbrandingthemecount)
