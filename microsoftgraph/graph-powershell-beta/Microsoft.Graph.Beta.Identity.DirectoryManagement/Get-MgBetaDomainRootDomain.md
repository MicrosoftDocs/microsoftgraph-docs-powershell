...
### Get (Default)
```
Get-MgBetaDomainRootDomain -DomainId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgBetaDomainRootDomain -InputObject <IIdentityDirectoryManagementIdentity> [-ExpandProperty <String[]>]
