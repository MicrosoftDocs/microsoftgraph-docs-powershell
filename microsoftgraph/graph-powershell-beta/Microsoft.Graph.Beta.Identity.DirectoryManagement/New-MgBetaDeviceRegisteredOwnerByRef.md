...
```
New-MgBetaDeviceRegisteredOwnerByRef -DeviceId <String> [-ResponseHeadersVariable <String>] -OdataId <String>
...
[https://learn.microsoft.com/graph/api/device-post-registeredowners?view=graph-rest-beta](https://learn.microsoft.com/graph/api/device-post-registeredowners?view=graph-rest-beta)
