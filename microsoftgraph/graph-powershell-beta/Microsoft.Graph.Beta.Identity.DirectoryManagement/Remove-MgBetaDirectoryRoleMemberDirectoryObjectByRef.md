...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/remove-mgbetadirectoryrolememberdirectoryobjectbyref
schema: 2.0.0
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Remove-MgDirectoryRoleMemberDirectoryObjectByRef](/powershell/module/Microsoft.Graph.Identity.DirectoryManagement/Remove-MgDirectoryRoleMemberDirectoryObjectByRef?view=graph-powershell-1.0)

## SYNTAX

### Delete (Default)
```
Remove-MgBetaDirectoryRoleMemberDirectoryObjectByRef -DirectoryObjectId <String> -DirectoryRoleId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaDirectoryRoleMemberDirectoryObjectByRef -InputObject <IIdentityDirectoryManagementIdentity>
 [-IfMatch <String>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/graph/api/directoryrole-delete-member?view=graph-rest-beta](https://learn.microsoft.com/graph/api/directoryrole-delete-member?view=graph-rest-beta)
