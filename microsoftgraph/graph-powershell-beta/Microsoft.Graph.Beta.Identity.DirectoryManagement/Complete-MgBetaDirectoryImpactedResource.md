...
### Complete (Default)
```
Complete-MgBetaDirectoryImpactedResource -ImpactedResourceId <String> [-WhatIf] [-Confirm] [<CommonParameters>]
```

### CompleteViaIdentity
```
Complete-MgBetaDirectoryImpactedResource -InputObject <IIdentityDirectoryManagementIdentity> [-WhatIf]
...
## RELATED LINKS
[Complete-MgDirectoryImpactedResource](/powershell/module/Microsoft.Graph.Identity.DirectoryManagement/Complete-MgDirectoryImpactedResource?view=graph-powershell-v1.0)
