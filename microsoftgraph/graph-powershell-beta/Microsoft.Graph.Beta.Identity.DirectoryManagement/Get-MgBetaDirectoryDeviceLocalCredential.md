...
### List (Default)
```
Get-MgBetaDirectoryDeviceLocalCredential [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaDirectoryDeviceLocalCredential -DeviceLocalCredentialInfoId <String> [-ExpandProperty <String[]>]
