...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/get-mgbetacontacttransitivereport
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.DirectoryManagement
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaContactTransitiveReport
---
...
```
Get-MgBetaContactTransitiveReport -OrgContactId <string> [-ExpandProperty <string[]>]
...
- [Get-MgBetaContactTransitiveReport](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/get-mgbetacontacttransitivereport)
- [Graph API Reference](https://learn.microsoft.com/graph/api/orgcontact-get-transitivereports?view=graph-rest-beta)
