...
Update-MgBetaAdminPeopleProfileCardProperty -ProfileCardPropertyId <String> [-ResponseHeadersVariable <String>]
 ...
 [-DirectoryPropertyName <String>] [-Id <String>] [-Headers <IDictionary>]
...
[https://learn.microsoft.com/graph/api/profilecardproperty-update?view=graph-rest-beta](https://learn.microsoft.com/graph/api/profilecardproperty-update?view=graph-rest-beta)
