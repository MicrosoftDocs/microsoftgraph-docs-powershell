...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/new-mgbetadirectoryoutboundshareduserprofiletenant
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.DirectoryManagement
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaDirectoryOutboundSharedUserProfileTenant
---
...
New-MgBetaDirectoryOutboundSharedUserProfileTenant -OutboundSharedUserProfileUserId <string>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-TenantId <string>]
...
```
New-MgBetaDirectoryOutboundSharedUserProfileTenant -OutboundSharedUserProfileUserId <string>
 -BodyParameter <IMicrosoftGraphTenantReference> [-ResponseHeadersVariable <string>] [-Break]
...
New-MgBetaDirectoryOutboundSharedUserProfileTenant
 ...
 [-AdditionalProperties <hashtable>] [-TenantId <string>] [-Break] [-Headers <IDictionary>]
...
```
New-MgBetaDirectoryOutboundSharedUserProfileTenant
 -InputObject <IIdentityDirectoryManagementIdentity> -BodyParameter <IMicrosoftGraphTenantReference>
...
- [New-MgBetaDirectoryOutboundSharedUserProfileTenant](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/new-mgbetadirectoryoutboundshareduserprofiletenant)
