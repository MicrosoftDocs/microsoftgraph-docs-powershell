...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgSubscribedSku](/powershell/module/Microsoft.Graph.Identity.DirectoryManagement/Get-MgSubscribedSku?view=graph-powershell-v1.0)
...
```powershell
Get-MgBetaSubscribedSKU ### Example 1: Get subscribed SKUs
## PARAMETERS
...
## RELATED LINKS
[Get-MgSubscribedSku](/powershell/module/Microsoft.Graph.Identity.DirectoryManagement/Get-MgSubscribedSku?view=graph-powershell-v1.0)
