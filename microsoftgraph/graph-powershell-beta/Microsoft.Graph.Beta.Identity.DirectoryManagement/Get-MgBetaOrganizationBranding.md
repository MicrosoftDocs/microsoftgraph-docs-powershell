...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/get-mgbetaorganizationbranding
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.DirectoryManagement
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaOrganizationBranding
---
...
```
Get-MgBetaOrganizationBranding -OrganizationId <string> [-ExpandProperty <string[]>]
...
- [Get-MgBetaOrganizationBranding](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/get-mgbetaorganizationbranding)
- [Graph API Reference](https://learn.microsoft.com/graph/api/organizationalbranding-get?view=graph-rest-beta)
