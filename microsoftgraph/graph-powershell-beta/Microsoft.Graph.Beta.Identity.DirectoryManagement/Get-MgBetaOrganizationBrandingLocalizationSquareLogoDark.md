...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/get-mgbetaorganizationbrandinglocalizationsquarelogodark
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.DirectoryManagement
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaOrganizationBrandingLocalizationSquareLogoDark
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgOrganizationBrandingLocalizationSquareLogoDark](/powershell/module/Microsoft.Graph.Identity.DirectoryManagement/Get-MgOrganizationBrandingLocalizationSquareLogoDark?view=graph-powershell-1.0)
...
Get-MgBetaOrganizationBrandingLocalizationSquareLogoDark -OrganizationId <string>
 -OrganizationalBrandingLocalizationId <string> -OutFile <string>
...
```
Get-MgBetaOrganizationBrandingLocalizationSquareLogoDark
 -InputObject <IIdentityDirectoryManagementIdentity> -OutFile <string>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru]
 [-Proxy <uri>] [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
```
...
- [Get-MgBetaOrganizationBrandingLocalizationSquareLogoDark](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/get-mgbetaorganizationbrandinglocalizationsquarelogodark)
