...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/new-mgbetadeviceusagerights
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.DirectoryManagement
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaDeviceUsageRights
---
...
```
New-MgBetaDeviceUsageRights -DeviceId <string> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-CatalogId <string>] [-Id <string>]
 [-ServiceIdentifier <string>] [-State <string>] [-Break] [-Headers <IDictionary>]
...
New-MgBetaDeviceUsageRights -InputObject <IIdentityDirectoryManagementIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-CatalogId <string>]
 [-Id <string>] [-ServiceIdentifier <string>] [-State <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
```
New-MgBetaDeviceUsageRights -InputObject <IIdentityDirectoryManagementIdentity>
 -BodyParameter <IMicrosoftGraphUsageRight> [-ResponseHeadersVariable <string>] [-Break]
...
- [New-MgBetaDeviceUsageRights](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/new-mgbetadeviceusagerights)
