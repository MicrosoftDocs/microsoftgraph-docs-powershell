...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgDirectoryAdministrativeUnitUserOwnedObject](/powershell/module/Microsoft.Graph.Identity.DirectoryManagement/Get-MgDirectoryAdministrativeUnitUserOwnedObject?view=graph-powershell-v1.0)
...
```yaml
Type: IPaths1LemjnvDirectoryAdministrativeunitsMicrosoftGraphGetuserownedobjectsPostRequestbodyContentApplicationJsonSchema
Parameter Sets: Get
Aliases:
...
## RELATED LINKS
[Get-MgDirectoryAdministrativeUnitUserOwnedObject](/powershell/module/Microsoft.Graph.Identity.DirectoryManagement/Get-MgDirectoryAdministrativeUnitUserOwnedObject?view=graph-powershell-v1.0)
