...
# Update-MgBetaAdminPeoplePhotoUpdateSetting
...
```
Update-MgBetaAdminPeoplePhotoUpdateSetting [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaAdminPeoplePhotoUpdateSetting -BodyParameter <IMicrosoftGraphPhotoUpdateSettings>
...
Contains a list of roles to perform edit operations in the cloud.
Optional.
