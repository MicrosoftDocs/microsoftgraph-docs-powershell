...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/get-mgbetadirectorytenantgovernancerelationship
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.DirectoryManagement
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaDirectoryTenantGovernanceRelationship
---
...
```
Get-MgBetaDirectoryTenantGovernanceRelationship [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaDirectoryTenantGovernanceRelationship -GovernanceRelationshipId <string>
...
```
Get-MgBetaDirectoryTenantGovernanceRelationship -InputObject <IIdentityDirectoryManagementIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
...
- [Get-MgBetaDirectoryTenantGovernanceRelationship](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/get-mgbetadirectorytenantgovernancerelationship)
- [Graph API Reference](https://learn.microsoft.com/graph/api/tenantgovernanceservices-governancerelationship-get?view=graph-rest-beta)
- [Graph API Reference](https://learn.microsoft.com/graph/api/tenantgovernanceservices-list-governancerelationships?view=graph-rest-beta)
