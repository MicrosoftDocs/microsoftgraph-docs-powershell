...
```
Update-MgBetaDirectoryRecommendationImpactedResource -ImpactedResourceId <string>
...
```
Update-MgBetaDirectoryRecommendationImpactedResource -ImpactedResourceId <string>
 -RecommendationId <string> -BodyParameter <IMicrosoftGraphImpactedResource>
...
```
Update-MgBetaDirectoryRecommendationImpactedResource
 -InputObject <IIdentityDirectoryManagementIdentity> [-RecommendationId <string>]
 ...
 [-SubjectId <string>] [-Tags <IMicrosoftGraphRecommendationTag[]>] [-Break]
