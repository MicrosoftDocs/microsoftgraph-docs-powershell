...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/get-mgbetadirectorytenantgovernancerelatedtenant
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.DirectoryManagement
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaDirectoryTenantGovernanceRelatedTenant
---
...
```
Get-MgBetaDirectoryTenantGovernanceRelatedTenant [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaDirectoryTenantGovernanceRelatedTenant -RelatedTenantId <string>
...
```
Get-MgBetaDirectoryTenantGovernanceRelatedTenant -InputObject <IIdentityDirectoryManagementIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
...
```
This example shows how to use the Get-MgBetaDirectoryTenantGovernanceRelatedTenant Cmdlet.
...
- [Get-MgBetaDirectoryTenantGovernanceRelatedTenant](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/get-mgbetadirectorytenantgovernancerelatedtenant)
- [Graph API Reference](https://learn.microsoft.com/graph/api/tenantgovernanceservices-relatedtenant-get?view=graph-rest-beta)
- [Graph API Reference](https://learn.microsoft.com/graph/api/tenantgovernanceservices-list-relatedtenants?view=graph-rest-beta)
