...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/update-mgbetadevicebydeviceid
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.DirectoryManagement
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: Update-MgBetaDeviceByDeviceId
---
...
```
Update-MgBetaDeviceByDeviceId -DeviceId <string> [-ResponseHeadersVariable <string>]
...
Update-MgBetaDeviceByDeviceId -InputObject <IIdentityDirectoryManagementIdentity>
 [-DeviceId <string>] [-ResponseHeadersVariable <string>] [-AccountEnabled]
