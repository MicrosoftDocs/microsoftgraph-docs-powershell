...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/remove-mgbetadirectorysetting
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.DirectoryManagement
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: Remove-MgBetaDirectorySetting
---
...
```
Remove-MgBetaDirectorySetting -DirectorySettingId <string> [-IfMatch <string>]
...
```
Remove-MgBetaDirectorySetting -InputObject <IIdentityDirectoryManagementIdentity>
...
- [Remove-MgBetaDirectorySetting](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/remove-mgbetadirectorysetting)
- [Graph API Reference](https://learn.microsoft.com/graph/api/directorysetting-delete?view=graph-rest-beta)
