...
Invoke-MgBetaReactivateDirectoryRecommendationImpactedResource -ImpactedResourceId <String>
 -RecommendationId <String> [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```
Invoke-MgBetaReactivateDirectoryRecommendationImpactedResource
 -InputObject <IIdentityDirectoryManagementIdentity> [-Headers <IDictionary>]
