...
# Update-MgBetaDirectoryRecommendationConfiguration
...
```
Update-MgBetaDirectoryRecommendationConfiguration [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Id <string>] [-IsNotificationEnabled] [-Break]
...
```
Update-MgBetaDirectoryRecommendationConfiguration
 -BodyParameter <IMicrosoftGraphRecommendationConfiguration> [-ResponseHeadersVariable <string>]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphRecommendationConfiguration
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphRecommendationConfiguration
