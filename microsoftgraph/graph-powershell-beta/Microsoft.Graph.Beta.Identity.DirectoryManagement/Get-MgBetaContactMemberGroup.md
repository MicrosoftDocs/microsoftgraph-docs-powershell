...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/get-mgbetacontactmembergroup
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.DirectoryManagement
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaContactMemberGroup
---
...
```
Get-MgBetaContactMemberGroup -OrgContactId <string> [-ResponseHeadersVariable <string>]
...
```
Get-MgBetaContactMemberGroup -OrgContactId <string>
...
```
Get-MgBetaContactMemberGroup -InputObject <IIdentityDirectoryManagementIdentity>
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths3Y2P0KContactsOrgcontactIdMicrosoftGraphGetmembergroupsPostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths3Y2P0KContactsOrgcontactIdMicrosoftGraphGetmembergroupsPostRequestbodyContentApplicationJsonSchema
...
- [Get-MgBetaContactMemberGroup](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/get-mgbetacontactmembergroup)
