...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/remove-mgbetadirectoryrecommendationtag
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.DirectoryManagement
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Remove-MgBetaDirectoryRecommendationTag
---

# Remove-MgBetaDirectoryRecommendationTag
...
```
Remove-MgBetaDirectoryRecommendationTag -RecommendationId <string>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-TagId <string>] [-Break]
...
```
Remove-MgBetaDirectoryRecommendationTag -RecommendationId <string>
 -BodyParameter <IPathsR1XcaxDirectoryRecommendationsRecommendationIdMicrosoftGraphRemovetagPostRequestbodyContentApplicationJsonSchema>
...
```
Remove-MgBetaDirectoryRecommendationTag -RecommendationId <string> -RecommendationTagId <string>
...
```
Remove-MgBetaDirectoryRecommendationTag -InputObject <IIdentityDirectoryManagementIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-TagId <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPathsR1XcaxDirectoryRecommendationsRecommendationIdMicrosoftGraphRemovetagPostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IPathsR1XcaxDirectoryRecommendationsRecommendationIdMicrosoftGraphRemovetagPostRequestbodyContentApplicationJsonSchema
...
- [Remove-MgBetaDirectoryRecommendationTag](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/remove-mgbetadirectoryrecommendationtag)
