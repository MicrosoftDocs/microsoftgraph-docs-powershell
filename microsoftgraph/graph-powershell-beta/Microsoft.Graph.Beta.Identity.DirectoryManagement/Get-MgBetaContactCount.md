...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgContactCount](/powershell/module/Microsoft.Graph.Identity.DirectoryManagement/Get-MgContactCount?view=graph-powershell-v1.0)

## SYNTAX

```
Get-MgBetaContactCount [-Filter <String>] [-Search <String>] -ConsistencyLevel <String> [<CommonParameters>]
```
