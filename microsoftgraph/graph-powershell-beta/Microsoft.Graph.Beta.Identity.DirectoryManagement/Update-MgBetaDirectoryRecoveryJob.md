...
# Update-MgBetaDirectoryRecoveryJob
...
```
Update-MgBetaDirectoryRecoveryJob -RecoveryJobBaseId <string> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaDirectoryRecoveryJob -RecoveryJobBaseId <string>
...
```
Update-MgBetaDirectoryRecoveryJob -InputObject <IIdentityDirectoryManagementIdentity>
...
- [Update-MgBetaDirectoryRecoveryJob](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/update-mgbetadirectoryrecoveryjob)
