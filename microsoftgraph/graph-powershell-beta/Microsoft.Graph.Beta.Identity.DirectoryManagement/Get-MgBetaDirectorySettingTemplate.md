...
```
Get-MgBetaDirectorySettingTemplate [-ExpandProperty <string[]>] [-Property <string[]>]
...
| --------------- | ------------------------------------------  |
| Delegated (work or school account) | Directory.Read.All, Directory.ReadWrite.All, GroupSettings.Read.All, GroupSettings.ReadWrite.All,  |
| Delegated (personal Microsoft account) | Not supported |
| Application | Directory.Read.All, Directory.ReadWrite.All, GroupSettings.Read.All, GroupSettings.ReadWrite.All,  |
