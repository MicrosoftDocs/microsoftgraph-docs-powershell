...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/invoke-mgbetaacceptdirectoryrecommendationrisk
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.DirectoryManagement
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Invoke-MgBetaAcceptDirectoryRecommendationRisk
---

# Invoke-MgBetaAcceptDirectoryRecommendationRisk
...
```
Invoke-MgBetaAcceptDirectoryRecommendationRisk -RecommendationId <string>
...
```
Invoke-MgBetaAcceptDirectoryRecommendationRisk -InputObject <IIdentityDirectoryManagementIdentity>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
