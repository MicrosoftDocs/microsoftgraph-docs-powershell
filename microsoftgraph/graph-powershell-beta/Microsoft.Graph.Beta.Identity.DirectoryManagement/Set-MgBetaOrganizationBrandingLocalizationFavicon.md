...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/set-mgbetaorganizationbrandinglocalizationfavicon
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.DirectoryManagement
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Set-MgBetaOrganizationBrandingLocalizationFavicon
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Set-MgOrganizationBrandingLocalizationFavicon](/powershell/module/Microsoft.Graph.Identity.DirectoryManagement/Set-MgOrganizationBrandingLocalizationFavicon?view=graph-powershell-1.0)
...
```
Set-MgBetaOrganizationBrandingLocalizationFavicon -OrganizationId <string>
...
```
Set-MgBetaOrganizationBrandingLocalizationFavicon
 -InputObject <IIdentityDirectoryManagementIdentity> -InFile <string> [-Data <Stream>]
 [-ResponseHeadersVariable <string>] [-Break] [-ContentType <string>] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru]
 [-Proxy <uri>] [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
- [Set-MgBetaOrganizationBrandingLocalizationFavicon](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/set-mgbetaorganizationbrandinglocalizationfavicon)
