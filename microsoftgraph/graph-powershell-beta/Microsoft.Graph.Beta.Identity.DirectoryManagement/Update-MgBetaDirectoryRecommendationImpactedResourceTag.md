...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/update-mgbetadirectoryrecommendationimpactedresourcetag
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.DirectoryManagement
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaDirectoryRecommendationImpactedResourceTag
---

# Update-MgBetaDirectoryRecommendationImpactedResourceTag
...
```
Update-MgBetaDirectoryRecommendationImpactedResourceTag -ImpactedResourceId <string>
 -RecommendationId <string> -RecommendationTagId <string> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaDirectoryRecommendationImpactedResourceTag -ImpactedResourceId <string>
 -RecommendationId <string> -RecommendationTagId <string>
 -BodyParameter <IMicrosoftGraphRecommendationTag> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
BODYPARAMETER `<IMicrosoftGraphRecommendationTag>`: recommendationTag
...
- [Update-MgBetaDirectoryRecommendationImpactedResourceTag](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.directorymanagement/update-mgbetadirectoryrecommendationimpactedresourcetag)
