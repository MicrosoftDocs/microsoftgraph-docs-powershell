...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Remove-MgAdministrativeUnitScopedRoleMember](/powershell/module/Microsoft.Graph.Identity.DirectoryManagement/Remove-MgAdministrativeUnitScopedRoleMember?view=graph-powershell-v1.0)

## SYNTAX

### Delete (Default)
```
Remove-MgBetaAdministrativeUnitScopedRoleMember -AdministrativeUnitId <String> -ScopedRoleMembershipId <String>
