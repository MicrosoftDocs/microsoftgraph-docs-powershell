...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.planner/update-mguserplannertaskprogresstaskboardformat
schema: 2.0.0
---
...
```
Update-MgUserPlannerTaskProgressTaskBoardFormat -PlannerTaskId <String> -UserId <String>
...
```
Update-MgUserPlannerTaskProgressTaskBoardFormat -InputObject <IPlannerIdentity>
 [-AdditionalProperties <Hashtable>] [-Id <String>] [-OrderHint <String>] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
