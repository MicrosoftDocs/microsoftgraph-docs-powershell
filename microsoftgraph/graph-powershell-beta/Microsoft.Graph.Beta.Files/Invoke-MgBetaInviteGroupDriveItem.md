...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/invoke-mgbetainvitegroupdriveitem
schema: 2.0.0
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Invoke-MgInviteGroupDriveItem](/powershell/module/Microsoft.Graph.Files/Invoke-MgInviteGroupDriveItem?view=graph-powershell-1.0)
...
```
Invoke-MgBetaInviteGroupDriveItem -InputObject <IFilesIdentity> [-ResponseHeadersVariable <String>]
...
### InviteViaIdentity
```
Invoke-MgBetaInviteGroupDriveItem -InputObject <IFilesIdentity>
 -BodyParameter <IPathsLx1Fn7GroupsGroupIdDrivesDriveIdItemsDriveitemIdMicrosoftGraphInvitePostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/invoke-mgbetainvitegroupdriveitem](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/invoke-mgbetainvitegroupdriveitem)
