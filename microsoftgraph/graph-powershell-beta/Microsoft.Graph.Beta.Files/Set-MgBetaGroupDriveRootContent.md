...
### Set (Default)
```
Set-MgBetaGroupDriveRootContent -DriveId <String> -GroupId <String> [-Data <Stream>] -InFile <String>
...
### SetViaIdentity
```
Set-MgBetaGroupDriveRootContent -InputObject <IFilesIdentity> [-Data <Stream>] -InFile <String>
 [-ContentType <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
