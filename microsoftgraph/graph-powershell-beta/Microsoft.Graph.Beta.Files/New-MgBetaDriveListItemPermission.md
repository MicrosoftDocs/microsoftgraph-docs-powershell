...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetadrivelistitempermission
Locale: en-US
Module Name: Microsoft.Graph.Beta.Files
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaDriveListItemPermission
---

# New-MgBetaDriveListItemPermission
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgDriveListItemPermission](/powershell/module/Microsoft.Graph.Files/New-MgDriveListItemPermission?view=graph-powershell-1.0)
...
```
New-MgBetaDriveListItemPermission -DriveId <string> -ListItemId <string>
...
```
New-MgBetaDriveListItemPermission -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaDriveListItemPermission -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphPermission> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgBetaDriveListItemPermission](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetadrivelistitempermission)
