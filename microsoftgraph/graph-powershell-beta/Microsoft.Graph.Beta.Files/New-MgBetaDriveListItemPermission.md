...
```
New-MgBetaDriveListItemPermission -DriveId <String> -ListItemId <String> [-ResponseHeadersVariable <String>]
...
### CreateViaIdentity
```
New-MgBetaDriveListItemPermission -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphPermission>
