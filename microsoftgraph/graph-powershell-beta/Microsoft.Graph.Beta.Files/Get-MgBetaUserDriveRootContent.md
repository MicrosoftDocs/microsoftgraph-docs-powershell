...
### Get (Default)
```
Get-MgBetaUserDriveRootContent -DriveId <String> -UserId <String> [-Format <String>] -OutFile <String>
...
### GetViaIdentity
```
Get-MgBetaUserDriveRootContent -InputObject <IFilesIdentity> [-Format <String>] -OutFile <String>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
