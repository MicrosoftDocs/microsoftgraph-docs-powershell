...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/set-mguserdriveitemchildcontent
schema: 2.0.0
---
...
### SetViaIdentity1
```
Set-MgUserDriveItemChildContent -InputObject <IFilesIdentity> [-BodyParameter <Stream>] -InFile <String>
