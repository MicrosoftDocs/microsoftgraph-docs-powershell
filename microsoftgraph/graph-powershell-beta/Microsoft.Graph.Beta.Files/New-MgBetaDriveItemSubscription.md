...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetadriveitemsubscription
Locale: en-US
Module Name: Microsoft.Graph.Beta.Files
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaDriveItemSubscription
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgDriveItemSubscription](/powershell/module/Microsoft.Graph.Files/New-MgDriveItemSubscription?view=graph-powershell-1.0)
...
```
New-MgBetaDriveItemSubscription -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaDriveItemSubscription -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphSubscription> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgBetaDriveItemSubscription](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetadriveitemsubscription)
