...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/copy-mgbetauserdriveitem
schema: 2.0.0
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Copy-MgUserDriveItem](/powershell/module/Microsoft.Graph.Files/Copy-MgUserDriveItem?view=graph-powershell-1.0)
...
```
Copy-MgBetaUserDriveItem -InputObject <IFilesIdentity> [-ResponseHeadersVariable <String>]
...
### CopyViaIdentity
```
Copy-MgBetaUserDriveItem -InputObject <IFilesIdentity>
 -BodyParameter <IPaths8Bxd2FUsersUserIdDrivesDriveIdItemsDriveitemIdMicrosoftGraphCopyPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/copy-mgbetauserdriveitem](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/copy-mgbetauserdriveitem)
