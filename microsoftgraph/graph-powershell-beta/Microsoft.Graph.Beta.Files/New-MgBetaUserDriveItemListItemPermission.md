...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetauserdriveitemlistitempermission
Locale: en-US
Module Name: Microsoft.Graph.Beta.Files
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaUserDriveItemListItemPermission
---

# New-MgBetaUserDriveItemListItemPermission
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgUserDriveItemListItemPermission](/powershell/module/Microsoft.Graph.Files/New-MgUserDriveItemListItemPermission?view=graph-powershell-1.0)
...
```
New-MgBetaUserDriveItemListItemPermission -DriveId <string> -DriveItemId <string> -UserId <string>
...
```
New-MgBetaUserDriveItemListItemPermission -InputObject <IFilesIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-ExpirationDateTime <datetime>] [-GrantedTo <IMicrosoftGraphIdentitySet>]
 [-GrantedToIdentities <IMicrosoftGraphIdentitySet[]>]
 [-GrantedToIdentitiesV2 <IMicrosoftGraphSharePointIdentitySet[]>]
...
- [New-MgBetaUserDriveItemListItemPermission](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetauserdriveitemlistitempermission)
