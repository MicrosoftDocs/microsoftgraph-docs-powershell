...
### Delete1 (Default)
```
Remove-MgBetaShareListItemField -SharedDriveItemId <String> [-IfMatch <String>] [-Headers <IDictionary>]
...
### DeleteViaIdentity1
```
Remove-MgBetaShareListItemField -InputObject <IFilesIdentity> [-IfMatch <String>] [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
