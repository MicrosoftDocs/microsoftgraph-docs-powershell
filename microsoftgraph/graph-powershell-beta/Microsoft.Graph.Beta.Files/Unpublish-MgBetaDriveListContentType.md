...
### Unpublish (Default)
```
Unpublish-MgBetaDriveListContentType -ContentTypeId <String> -DriveId <String> [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UnpublishViaIdentity
```
Unpublish-MgBetaDriveListContentType -InputObject <IFilesIdentity> [-Headers <IDictionary>] [-PassThru]
