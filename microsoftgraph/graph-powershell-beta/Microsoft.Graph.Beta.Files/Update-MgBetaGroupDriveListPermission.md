...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetagroupdrivelistpermission
Locale: en-US
Module Name: Microsoft.Graph.Beta.Files
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaGroupDriveListPermission
---

# Update-MgBetaGroupDriveListPermission
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgGroupDriveListPermission](/powershell/module/Microsoft.Graph.Files/Update-MgGroupDriveListPermission?view=graph-powershell-1.0)
...
```
Update-MgBetaGroupDriveListPermission -DriveId <string> -GroupId <string> -PermissionId <string>
...
```
Update-MgBetaGroupDriveListPermission -InputObject <IFilesIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-ExpirationDateTime <datetime>] [-GrantedTo <IMicrosoftGraphIdentitySet>]
 [-GrantedToIdentities <IMicrosoftGraphIdentitySet[]>]
 [-GrantedToIdentitiesV2 <IMicrosoftGraphSharePointIdentitySet[]>]
...
- [Update-MgBetaGroupDriveListPermission](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetagroupdrivelistpermission)
