...
Remove-MgBetaUserDriveListItemDocumentSetVersion -DocumentSetVersionId <String> -DriveId <String>
 -ListItemId <String> -UserId <String> [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaUserDriveListItemDocumentSetVersion -InputObject <IFilesIdentity> [-IfMatch <String>] [-PassThru]
