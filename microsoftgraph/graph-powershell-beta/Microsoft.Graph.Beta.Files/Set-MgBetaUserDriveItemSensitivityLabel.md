...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/set-mgbetauserdriveitemsensitivitylabel
schema: 2.0.0
---
...
```
Set-MgBetaUserDriveItemSensitivityLabel -InputObject <IFilesIdentity> [-ResponseHeadersVariable <String>]
...
### AssignViaIdentity
```
Set-MgBetaUserDriveItemSensitivityLabel -InputObject <IFilesIdentity>
 -BodyParameter <IPathsWslwlcUsersUserIdDrivesDriveIdItemsDriveitemIdMicrosoftGraphAssignsensitivitylabelPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/set-mgbetauserdriveitemsensitivitylabel](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/set-mgbetauserdriveitemsensitivitylabel)
