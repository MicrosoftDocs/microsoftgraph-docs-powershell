...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetadriveitemlistitemlastmodifiedbyusermailboxsetting
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgDriveItemListItemLastModifiedByUserMailboxSetting](/powershell/module/Microsoft.Graph.Files/Update-MgDriveItemListItemLastModifiedByUserMailboxSetting?view=graph-powershell-1.0)

## SYNTAX

### UpdateExpanded (Default)
```
Update-MgBetaDriveItemListItemLastModifiedByUserMailboxSetting -DriveId <String> -DriveItemId <String>
...
```
Update-MgBetaDriveItemListItemLastModifiedByUserMailboxSetting -InputObject <IFilesIdentity>
 [-AdditionalProperties <Hashtable>] [-ArchiveFolder <String>]
 [-AutomaticRepliesSetting <IMicrosoftGraphAutomaticRepliesSetting>] [-DateFormat <String>]
 [-DelegateMeetingMessageDeliveryOptions <String>] [-Language <IMicrosoftGraphLocaleInfo>]
 [-TimeFormat <String>] [-TimeZone <String>] [-UserPurpose <String>] [-UserPurposeV2 <String>]
...
## RELATED LINKS
[Update-MgDriveItemListItemLastModifiedByUserMailboxSetting](/powershell/module/Microsoft.Graph.Files/Update-MgDriveItemListItemLastModifiedByUserMailboxSetting?view=graph-powershell-1.0)

[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetadriveitemlistitemlastmodifiedbyusermailboxsetting](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetadriveitemlistitemlastmodifiedbyusermailboxsetting)
