...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/get-mgbetagroupdriverootdelta
schema: 2.0.0
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgGroupDriveRootDelta](/powershell/module/Microsoft.Graph.Files/Get-MgGroupDriveRootDelta?view=graph-powershell-1.0)
...
### DeltaViaIdentity1
```
Get-MgBetaGroupDriveRootDelta -InputObject <IFilesIdentity> [-ExpandProperty <String[]>] [-Filter <String>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/get-mgbetagroupdriverootdelta](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/get-mgbetagroupdriverootdelta)
