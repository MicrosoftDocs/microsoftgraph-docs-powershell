...
```
Get-MgBetaGroupDriveRootDelta -DriveId <string> -GroupId <string> -Token <string>
...
```
Get-MgBetaGroupDriveRootDelta -InputObject <IFilesIdentity> [-ExpandProperty <string[]>]
 [-Filter <string>] [-Property <string[]>] [-Search <string>] [-Skip <int>] [-Sort <string[]>]
