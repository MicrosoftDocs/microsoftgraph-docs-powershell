...
```
Get-MgBetaGroupDriveRootListItemPermission -DriveId <string> -GroupId <string>
...
```
Get-MgBetaGroupDriveRootListItemPermission -InputObject <IFilesIdentity>
...
- [Get-MgBetaGroupDriveRootListItemPermission](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/get-mgbetagroupdriverootlistitempermission)
