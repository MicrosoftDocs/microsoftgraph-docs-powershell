...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/get-mgbetadriverootversioncontent
schema: 2.0.0
ms.prod: sharepoint
---
...
### GetViaIdentity
```
Get-MgBetaDriveRootVersionContent -InputObject <IFilesIdentity> -OutFile <String> [-Headers <IDictionary>]
