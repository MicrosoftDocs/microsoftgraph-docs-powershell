...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/search-mgbetadriveitem
Locale: en-US
Module Name: Microsoft.Graph.Beta.Files
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Search-MgBetaDriveItem
---
...
```
Search-MgBetaDriveItem -DriveId <string> -DriveItemId <string> -Q <string> [-Count]
...
```
Search-MgBetaDriveItem -InputObject <IFilesIdentity> [-Count] [-ExpandProperty <string[]>]
...
- [Search-MgBetaDriveItem](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/search-mgbetadriveitem)
