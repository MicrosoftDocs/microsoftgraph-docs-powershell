...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetadriverootlastmodifiedbyusermailboxsetting
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgDriveRootLastModifiedByUserMailboxSetting](/powershell/module/Microsoft.Graph.Files/Update-MgDriveRootLastModifiedByUserMailboxSetting?view=graph-powershell-1.0)

## SYNTAX

### UpdateExpanded (Default)
```
Update-MgBetaDriveRootLastModifiedByUserMailboxSetting -DriveId <String> [-ResponseHeadersVariable <String>]
...
### Update
```
Update-MgBetaDriveRootLastModifiedByUserMailboxSetting -DriveId <String>
...
```
Update-MgBetaDriveRootLastModifiedByUserMailboxSetting -InputObject <IFilesIdentity>
...
## RELATED LINKS
[Update-MgDriveRootLastModifiedByUserMailboxSetting](/powershell/module/Microsoft.Graph.Files/Update-MgDriveRootLastModifiedByUserMailboxSetting?view=graph-powershell-1.0)

[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetadriverootlastmodifiedbyusermailboxsetting](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetadriverootlastmodifiedbyusermailboxsetting)
