...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetadrivelistitempermission
Locale: en-US
Module Name: Microsoft.Graph.Beta.Files
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaDriveListItemPermission
---

# Update-MgBetaDriveListItemPermission
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgDriveListItemPermission](/powershell/module/Microsoft.Graph.Files/Update-MgDriveListItemPermission?view=graph-powershell-1.0)
...
```
Update-MgBetaDriveListItemPermission -DriveId <string> -ListItemId <string> -PermissionId <string>
...
```
Update-MgBetaDriveListItemPermission -InputObject <IFilesIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-ExpirationDateTime <datetime>] [-GrantedTo <IMicrosoftGraphIdentitySet>]
 [-GrantedToIdentities <IMicrosoftGraphIdentitySet[]>]
 [-GrantedToIdentitiesV2 <IMicrosoftGraphSharePointIdentitySet[]>]
...
- [Update-MgBetaDriveListItemPermission](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetadrivelistitempermission)
