...
```
Update-MgBetaGroupDriveRootSubscription -InputObject <IFilesIdentity> [-ResponseHeadersVariable <String>]
...
## RELATED LINKS
[Update-MgGroupDriveRootSubscription](/powershell/module/Microsoft.Graph.Files/Update-MgGroupDriveRootSubscription?view=graph-powershell-1.0)
