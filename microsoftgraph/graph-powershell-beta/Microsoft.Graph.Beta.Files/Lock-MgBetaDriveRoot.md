...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/lock-mgbetadriveroot
Locale: en-US
Module Name: Microsoft.Graph.Beta.Files
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Lock-MgBetaDriveRoot
---

# Lock-MgBetaDriveRoot
...
```
Lock-MgBetaDriveRoot -DriveId <string> [-ResponseHeadersVariable <string>]
...
```
Lock-MgBetaDriveRoot -DriveId <string>
 -BodyParameter <IPaths6B4FthDrivesDriveIdRootMicrosoftGraphLockPostRequestbodyContentApplicationJsonSchema>
...
```
Lock-MgBetaDriveRoot -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-DurationMinutes <int>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
```
Lock-MgBetaDriveRoot -InputObject <IFilesIdentity>
 -BodyParameter <IPaths6B4FthDrivesDriveIdRootMicrosoftGraphLockPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths6B4FthDrivesDriveIdRootMicrosoftGraphLockPostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths6B4FthDrivesDriveIdRootMicrosoftGraphLockPostRequestbodyContentApplicationJsonSchema
...
- [Lock-MgBetaDriveRoot](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/lock-mgbetadriveroot)
