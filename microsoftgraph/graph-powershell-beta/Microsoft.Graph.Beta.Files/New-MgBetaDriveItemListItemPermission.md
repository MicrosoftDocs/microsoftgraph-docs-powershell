...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetadriveitemlistitempermission
Locale: en-US
Module Name: Microsoft.Graph.Beta.Files
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaDriveItemListItemPermission
---

# New-MgBetaDriveItemListItemPermission
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgDriveItemListItemPermission](/powershell/module/Microsoft.Graph.Files/New-MgDriveItemListItemPermission?view=graph-powershell-1.0)
...
```
New-MgBetaDriveItemListItemPermission -DriveId <string> -DriveItemId <string>
...
```
New-MgBetaDriveItemListItemPermission -InputObject <IFilesIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-ExpirationDateTime <datetime>] [-GrantedTo <IMicrosoftGraphIdentitySet>]
 [-GrantedToIdentities <IMicrosoftGraphIdentitySet[]>]
 [-GrantedToIdentitiesV2 <IMicrosoftGraphSharePointIdentitySet[]>]
...
- [New-MgBetaDriveItemListItemPermission](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetadriveitemlistitempermission)
