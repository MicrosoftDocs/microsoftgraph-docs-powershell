...
```
Restore-MgBetaGroupDriveItemVersion -DriveId <string> -DriveItemId <string>
 -DriveItemVersionId <string> -GroupId <string> [-ResponseHeadersVariable <string>] [-Break]
...
```
Restore-MgBetaGroupDriveItemVersion -InputObject <IFilesIdentity>
