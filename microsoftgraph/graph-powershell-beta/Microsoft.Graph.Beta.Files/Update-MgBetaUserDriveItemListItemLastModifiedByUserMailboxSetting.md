...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetauserdriveitemlistitemlastmodifiedbyusermailboxsetting
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgUserDriveItemListItemLastModifiedByUserMailboxSetting](/powershell/module/Microsoft.Graph.Files/Update-MgUserDriveItemListItemLastModifiedByUserMailboxSetting?view=graph-powershell-1.0)

## SYNTAX

### UpdateExpanded (Default)
```
Update-MgBetaUserDriveItemListItemLastModifiedByUserMailboxSetting -DriveId <String> -DriveItemId <String>
...
```
Update-MgBetaUserDriveItemListItemLastModifiedByUserMailboxSetting -DriveId <String> -DriveItemId <String>
 -UserId <String> -BodyParameter <IMicrosoftGraphMailboxSettings> [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgBetaUserDriveItemListItemLastModifiedByUserMailboxSetting -InputObject <IFilesIdentity>
...
## RELATED LINKS
[Update-MgUserDriveItemListItemLastModifiedByUserMailboxSetting](/powershell/module/Microsoft.Graph.Files/Update-MgUserDriveItemListItemLastModifiedByUserMailboxSetting?view=graph-powershell-1.0)

[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetauserdriveitemlistitemlastmodifiedbyusermailboxsetting](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetauserdriveitemlistitemlastmodifiedbyusermailboxsetting)
