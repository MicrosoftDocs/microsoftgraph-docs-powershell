...
```
Revoke-MgBetaSharePermissionGrant -SharedDriveItemId <String> [-ResponseHeadersVariable <String>]
...
```
Revoke-MgBetaSharePermissionGrant -InputObject <IFilesIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-Grantees <IMicrosoftGraphDriveRecipient[]>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
