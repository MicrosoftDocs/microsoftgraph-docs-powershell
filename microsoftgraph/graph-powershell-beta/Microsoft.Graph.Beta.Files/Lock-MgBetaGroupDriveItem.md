...
```
Lock-MgBetaGroupDriveItem -DriveId <string> -DriveItemId <string> -GroupId <string>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-DurationMinutes <int>]
...
```
Lock-MgBetaGroupDriveItem -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
...
```
Lock-MgBetaGroupDriveItem -InputObject <IFilesIdentity>
 -BodyParameter <IPaths9CaugzGroupsGroupIdDrivesDriveIdItemsDriveitemIdMicrosoftGraphLockPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths9CaugzGroupsGroupIdDrivesDriveIdItemsDriveitemIdMicrosoftGraphLockPostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths9CaugzGroupsGroupIdDrivesDriveIdItemsDriveitemIdMicrosoftGraphLockPostRequestbodyContentApplicationJsonSchema
