...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetagroupdriveitemlistitempermission
Locale: en-US
Module Name: Microsoft.Graph.Beta.Files
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaGroupDriveItemListItemPermission
---

# Update-MgBetaGroupDriveItemListItemPermission
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgGroupDriveItemListItemPermission](/powershell/module/Microsoft.Graph.Files/Update-MgGroupDriveItemListItemPermission?view=graph-powershell-1.0)
...
```
Update-MgBetaGroupDriveItemListItemPermission -DriveId <string> -DriveItemId <string>
 -GroupId <string> -PermissionId <string> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaGroupDriveItemListItemPermission -DriveId <string> -DriveItemId <string>
 -GroupId <string> -PermissionId <string> -BodyParameter <IMicrosoftGraphPermission>
...
```
Update-MgBetaGroupDriveItemListItemPermission -InputObject <IFilesIdentity>
...
- [Update-MgBetaGroupDriveItemListItemPermission](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetagroupdriveitemlistitempermission)
