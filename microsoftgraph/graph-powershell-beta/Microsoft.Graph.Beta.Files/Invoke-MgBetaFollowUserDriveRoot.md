...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/invoke-mgbetafollowuserdriveroot
schema: 2.0.0
...
### Follow (Default)
```
Invoke-MgBetaFollowUserDriveRoot -DriveId <String> -UserId <String> [-ResponseHeadersVariable <String>]
