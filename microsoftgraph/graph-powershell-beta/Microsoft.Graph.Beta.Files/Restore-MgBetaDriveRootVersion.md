...
### Restore (Default)
```
Restore-MgBetaDriveRootVersion -DriveId <String> -DriveItemVersionId <String> [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### RestoreViaIdentity
```
Restore-MgBetaDriveRootVersion -InputObject <IFilesIdentity> [-Headers <IDictionary>] [-PassThru]
