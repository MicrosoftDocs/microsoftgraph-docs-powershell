...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/get-mgbetagroupdrivelistitemdelta
schema: 2.0.0
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgGroupDriveListItemDelta](/powershell/module/Microsoft.Graph.Files/Get-MgGroupDriveListItemDelta?view=graph-powershell-1.0)
...
### DeltaViaIdentity1
```
Get-MgBetaGroupDriveListItemDelta -InputObject <IFilesIdentity> [-ExpandProperty <String[]>] [-Filter <String>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/get-mgbetagroupdrivelistitemdelta](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/get-mgbetagroupdrivelistitemdelta)
