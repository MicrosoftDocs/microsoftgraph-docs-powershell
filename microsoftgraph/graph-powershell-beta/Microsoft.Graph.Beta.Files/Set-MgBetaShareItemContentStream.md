...
### Set (Default)
```
Set-MgBetaShareItemContentStream -DriveItemId <String> -SharedDriveItemId <String> [-Data <Stream>]
...
### SetViaIdentity
```
Set-MgBetaShareItemContentStream -InputObject <IFilesIdentity> [-Data <Stream>]
 [-ResponseHeadersVariable <String>] -InFile <String> [-ContentType <String>] [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
