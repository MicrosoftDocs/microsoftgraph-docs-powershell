...
# Publish-MgBetaUserDriveRootLock
...
```
Publish-MgBetaUserDriveRootLock -DriveId <string> -UserId <string>
...
```
Publish-MgBetaUserDriveRootLock -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
