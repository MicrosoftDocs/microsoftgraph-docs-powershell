...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetagroupdriveitemlistitempermission
Locale: en-US
Module Name: Microsoft.Graph.Beta.Files
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaGroupDriveItemListItemPermission
---

# New-MgBetaGroupDriveItemListItemPermission
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgGroupDriveItemListItemPermission](/powershell/module/Microsoft.Graph.Files/New-MgGroupDriveItemListItemPermission?view=graph-powershell-1.0)
...
```
New-MgBetaGroupDriveItemListItemPermission -DriveId <string> -DriveItemId <string> -GroupId <string>
...
```
New-MgBetaGroupDriveItemListItemPermission -InputObject <IFilesIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-ExpirationDateTime <datetime>] [-GrantedTo <IMicrosoftGraphIdentitySet>]
 [-GrantedToIdentities <IMicrosoftGraphIdentitySet[]>]
 [-GrantedToIdentitiesV2 <IMicrosoftGraphSharePointIdentitySet[]>]
...
- [New-MgBetaGroupDriveItemListItemPermission](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetagroupdriveitemlistitempermission)
