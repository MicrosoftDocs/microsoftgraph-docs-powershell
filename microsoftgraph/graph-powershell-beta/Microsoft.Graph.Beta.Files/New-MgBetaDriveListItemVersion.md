...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetadrivelistitemversion
Locale: en-US
Module Name: Microsoft.Graph.Beta.Files
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaDriveListItemVersion
---
...
```
New-MgBetaDriveListItemVersion -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaDriveListItemVersion -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphListItemVersion> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgBetaDriveListItemVersion](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetadrivelistitemversion)
