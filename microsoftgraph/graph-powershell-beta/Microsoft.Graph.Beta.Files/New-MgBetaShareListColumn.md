...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetasharelistcolumn
Locale: en-US
Module Name: Microsoft.Graph.Beta.Files
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: New-MgBetaShareListColumn
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgShareListColumn](/powershell/module/Microsoft.Graph.Files/New-MgShareListColumn?view=graph-powershell-1.0)
...
```
New-MgBetaShareListColumn -SharedDriveItemId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaShareListColumn -SharedDriveItemId <string>
...
```
New-MgBetaShareListColumn -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Boolean <hashtable>]
 [-Calculated <IMicrosoftGraphCalculatedColumn>] [-Choice <IMicrosoftGraphChoiceColumn>]
 [-ColumnGroup <string>] [-ContentApprovalStatus <hashtable>]
 [-Currency <IMicrosoftGraphCurrencyColumn>] [-DateTime <IMicrosoftGraphDateTimeColumn>]
...
```
New-MgBetaShareListColumn -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphColumnDefinition> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm] [<CommonParameters>]
