...
### Get (Default)
```
Get-MgBetaUserDriveBundleContent -DriveId <String> -DriveItemId <String> -UserId <String> [-Format <String>]
...
### GetViaIdentity
```
Get-MgBetaUserDriveBundleContent -InputObject <IFilesIdentity> [-Format <String>] -OutFile <String>
