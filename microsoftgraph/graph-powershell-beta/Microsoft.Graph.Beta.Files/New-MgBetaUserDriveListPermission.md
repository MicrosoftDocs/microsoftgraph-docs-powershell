...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetauserdrivelistpermission
Locale: en-US
Module Name: Microsoft.Graph.Beta.Files
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaUserDriveListPermission
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgUserDriveListPermission](/powershell/module/Microsoft.Graph.Files/New-MgUserDriveListPermission?view=graph-powershell-1.0)
...
```
New-MgBetaUserDriveListPermission -DriveId <string> -UserId <string>
...
```
New-MgBetaUserDriveListPermission -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphPermission> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgBetaUserDriveListPermission](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetauserdrivelistpermission)
