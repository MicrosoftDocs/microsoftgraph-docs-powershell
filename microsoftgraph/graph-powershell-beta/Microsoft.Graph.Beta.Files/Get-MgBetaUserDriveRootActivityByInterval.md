...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/get-mgbetauserdriverootactivitybyinterval
schema: 2.0.0
...
### Get (Default)
```
Get-MgBetaUserDriveRootActivityByInterval -DriveId <String> -EndDateTime <String> -Interval <String>
...
### GetViaIdentity
```
Get-MgBetaUserDriveRootActivityByInterval -InputObject <IFilesIdentity> [-Count] [-ExpandProperty <String[]>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/get-mgbetauserdriverootactivitybyinterval](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/get-mgbetauserdriverootactivitybyinterval)
