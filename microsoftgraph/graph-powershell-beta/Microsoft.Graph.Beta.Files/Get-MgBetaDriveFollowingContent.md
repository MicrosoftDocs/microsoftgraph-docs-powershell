...
### Get (Default)
```
Get-MgBetaDriveFollowingContent -DriveId <String> -DriveItemId <String> [-Format <String>] -OutFile <String>
...
### GetViaIdentity
```
Get-MgBetaDriveFollowingContent -InputObject <IFilesIdentity> [-Format <String>] -OutFile <String>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
