...
```
Get-MgBetaDriveListItemDelta -DriveId <string> -Token <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaDriveListItemDelta -InputObject <IFilesIdentity> [-ExpandProperty <string[]>]
 [-Filter <string>] [-Property <string[]>] [-Search <string>] [-Skip <int>] [-Sort <string[]>]
