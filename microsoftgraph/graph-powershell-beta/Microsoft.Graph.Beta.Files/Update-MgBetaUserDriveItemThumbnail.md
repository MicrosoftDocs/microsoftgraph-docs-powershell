...
```
Update-MgBetaUserDriveItemThumbnail -InputObject <IFilesIdentity> [-ResponseHeadersVariable <String>]
...
## RELATED LINKS
[Update-MgUserDriveItemThumbnail](/powershell/module/Microsoft.Graph.Files/Update-MgUserDriveItemThumbnail?view=graph-powershell-1.0)
