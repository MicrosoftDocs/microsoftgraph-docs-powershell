...
### Get (Default)
```
Get-MgBetaShareRootContent -SharedDriveItemId <String> [-Format <String>] -OutFile <String>
...
### GetViaIdentity
```
Get-MgBetaShareRootContent -InputObject <IFilesIdentity> [-Format <String>] -OutFile <String>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
