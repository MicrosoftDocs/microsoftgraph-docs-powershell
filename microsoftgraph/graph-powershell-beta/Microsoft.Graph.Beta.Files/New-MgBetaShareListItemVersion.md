...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetasharelistitemversion
Locale: en-US
Module Name: Microsoft.Graph.Beta.Files
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaShareListItemVersion
---
...
```
New-MgBetaShareListItemVersion -SharedDriveItemId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaShareListItemVersion -SharedDriveItemId <string>
 -BodyParameter <IMicrosoftGraphListItemVersion> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```
New-MgBetaShareListItemVersion -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Fields <hashtable>] [-Id <string>]
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-LastModifiedDateTime <datetime>]
 [-Publication <IMicrosoftGraphPublicationFacet>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
...
```
New-MgBetaShareListItemVersion -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphListItemVersion> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgBetaShareListItemVersion](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetasharelistitemversion)
