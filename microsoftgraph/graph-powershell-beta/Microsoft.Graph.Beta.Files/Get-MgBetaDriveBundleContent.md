...
### Get (Default)
```
Get-MgBetaDriveBundleContent -DriveId <String> -DriveItemId <String> [-Format <String>] -OutFile <String>
 [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDriveBundleContent -InputObject <IFilesIdentity> [-Format <String>] -OutFile <String>
 [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
## RELATED LINKS
[Get-MgDriveBundleContent](/powershell/module/Microsoft.Graph.Files/Get-MgDriveBundleContent?view=graph-powershell-1.0)
