...
### Set (Default)
```
Set-MgBetaShareRootContent -SharedDriveItemId <String> [-Data <Stream>] -InFile <String>
...
### SetViaIdentity
```
Set-MgBetaShareRootContent -InputObject <IFilesIdentity> [-Data <Stream>] -InFile <String>
 [-ContentType <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
