...
### Set (Default)
```
Set-MgBetaShareRootContent -SharedDriveItemId <String> [-Data <Stream>] [-ResponseHeadersVariable <String>]
...
### SetViaIdentity
```
Set-MgBetaShareRootContent -InputObject <IFilesIdentity> [-Data <Stream>] [-ResponseHeadersVariable <String>]
 -InFile <String> [-ContentType <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
