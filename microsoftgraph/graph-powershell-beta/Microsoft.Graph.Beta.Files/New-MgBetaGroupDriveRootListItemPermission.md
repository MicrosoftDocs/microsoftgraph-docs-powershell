...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetagroupdriverootlistitempermission
Locale: en-US
Module Name: Microsoft.Graph.Beta.Files
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaGroupDriveRootListItemPermission
---

# New-MgBetaGroupDriveRootListItemPermission
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgGroupDriveRootListItemPermission](/powershell/module/Microsoft.Graph.Files/New-MgGroupDriveRootListItemPermission?view=graph-powershell-1.0)
...
```
New-MgBetaGroupDriveRootListItemPermission -DriveId <string> -GroupId <string>
...
```
New-MgBetaGroupDriveRootListItemPermission -InputObject <IFilesIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-ExpirationDateTime <datetime>] [-GrantedTo <IMicrosoftGraphIdentitySet>]
 [-GrantedToIdentities <IMicrosoftGraphIdentitySet[]>]
 [-GrantedToIdentitiesV2 <IMicrosoftGraphSharePointIdentitySet[]>]
...
- [New-MgBetaGroupDriveRootListItemPermission](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetagroupdriverootlistitempermission)
