...
### Get (Default)
```
Get-MgBetaUserDriveFollowingContent -DriveId <String> -DriveItemId <String> -UserId <String> [-Format <String>]
...
### GetViaIdentity
```
Get-MgBetaUserDriveFollowingContent -InputObject <IFilesIdentity> [-Format <String>] -OutFile <String>
