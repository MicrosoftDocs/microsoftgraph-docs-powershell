...
### Delete (Default)
```
Remove-MgBetaShareListItem -SharedDriveItemId <String> [-IfMatch <String>] [-Headers <IDictionary>] [-PassThru]
...
### DeleteViaIdentity1
```
Remove-MgBetaShareListItem -InputObject <IFilesIdentity> [-IfMatch <String>] [-Headers <IDictionary>]
