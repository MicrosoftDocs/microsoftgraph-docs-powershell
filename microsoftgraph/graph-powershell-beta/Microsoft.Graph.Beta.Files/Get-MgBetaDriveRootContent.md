...
### Get (Default)
```
Get-MgBetaDriveRootContent -DriveId <String> [-Format <String>] -OutFile <String> [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDriveRootContent -InputObject <IFilesIdentity> [-Format <String>] -OutFile <String>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/get-mgbetadriverootcontent](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/get-mgbetadriverootcontent)
