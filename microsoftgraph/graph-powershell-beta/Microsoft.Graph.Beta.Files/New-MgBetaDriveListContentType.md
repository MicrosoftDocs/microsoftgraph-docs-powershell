...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetadrivelistcontenttype
Locale: en-US
Module Name: Microsoft.Graph.Beta.Files
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaDriveListContentType
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgDriveListContentType](/powershell/module/Microsoft.Graph.Files/New-MgDriveListContentType?view=graph-powershell-1.0)
...
```
New-MgBetaDriveListContentType -DriveId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaDriveListContentType -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-AssociatedHubsUrls <string[]>]
 [-Base <IMicrosoftGraphContentType>] [-BaseTypes <IMicrosoftGraphContentType[]>]
 [-ColumnLinks <IMicrosoftGraphColumnLink[]>] [-ColumnPositions <IMicrosoftGraphColumnDefinition[]>]
 [-Columns <IMicrosoftGraphColumnDefinition[]>] [-Description <string>]
...
```
New-MgBetaDriveListContentType -InputObject <IFilesIdentity>
...
- [New-MgBetaDriveListContentType](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetadrivelistcontenttype)
