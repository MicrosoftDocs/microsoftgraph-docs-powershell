...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetadrivelistpermission
schema: 2.0.0
---

# Update-MgBetaDriveListPermission
...
```
Update-MgBetaDriveListPermission -DriveId <String> -PermissionId <String> [-ResponseHeadersVariable <String>]
...
### Update
```
Update-MgBetaDriveListPermission -DriveId <String> -PermissionId <String>
...
```
Update-MgBetaDriveListPermission -InputObject <IFilesIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-ExpirationDateTime <DateTime>] [-GrantedTo <IMicrosoftGraphIdentitySet>]
 [-GrantedToIdentities <IMicrosoftGraphIdentitySet[]>]
 [-GrantedToIdentitiesV2 <IMicrosoftGraphSharePointIdentitySet[]>]
 [-GrantedToV2 <IMicrosoftGraphSharePointIdentitySet>] [-HasPassword] [-Id <String>]
...
### UpdateViaIdentity
```
Update-MgBetaDriveListPermission -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphPermission>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetadrivelistpermission](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetadrivelistpermission)
