...
```
Grant-MgBetaDriveItemListItemPermission -DriveId <string> -DriveItemId <string>
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths1T5GjxoDrivesDriveIdItemsDriveitemIdListitemPermissionsPermissionIdMicrosoftGraphGrantPostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
- [Grant-MgBetaDriveItemListItemPermission](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/grant-mgbetadriveitemlistitempermission)
