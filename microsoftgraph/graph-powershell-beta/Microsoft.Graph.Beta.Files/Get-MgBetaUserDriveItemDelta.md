...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/get-mgbetauserdriveitemdelta
schema: 2.0.0
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgUserDriveItemDelta](/powershell/module/Microsoft.Graph.Files/Get-MgUserDriveItemDelta?view=graph-powershell-1.0)
...
### DeltaViaIdentity1
```
Get-MgBetaUserDriveItemDelta -InputObject <IFilesIdentity> [-ExpandProperty <String[]>] [-Filter <String>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/get-mgbetauserdriveitemdelta](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/get-mgbetauserdriveitemdelta)
