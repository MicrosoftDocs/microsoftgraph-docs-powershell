...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetasharepermission
Locale: en-US
Module Name: Microsoft.Graph.Beta.Files
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaSharePermission
---
...
```
Update-MgBetaSharePermission -SharedDriveItemId <string> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaSharePermission -SharedDriveItemId <string> -BodyParameter <IMicrosoftGraphPermission>
...
```
Update-MgBetaSharePermission -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-ExpirationDateTime <datetime>]
 [-GrantedTo <IMicrosoftGraphIdentitySet>] [-GrantedToIdentities <IMicrosoftGraphIdentitySet[]>]
 [-GrantedToIdentitiesV2 <IMicrosoftGraphSharePointIdentitySet[]>]
 [-GrantedToV2 <IMicrosoftGraphSharePointIdentitySet>] [-HasPassword] [-Id <string>]
...
```
Update-MgBetaSharePermission -InputObject <IFilesIdentity>
...
- [Update-MgBetaSharePermission](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetasharepermission)
