...
### Follow (Default)
```
Invoke-MgBetaFollowDriveItem -DriveId <String> -DriveItemId <String> [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### FollowViaIdentity
```
Invoke-MgBetaFollowDriveItem -InputObject <IFilesIdentity> [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
