...
### Get (Default)
```
Get-MgBetaDriveSpecialContent -DriveId <String> -DriveItemId <String> [-Format <String>] -OutFile <String>
...
### GetViaIdentity
```
Get-MgBetaDriveSpecialContent -InputObject <IFilesIdentity> [-Format <String>] -OutFile <String>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
