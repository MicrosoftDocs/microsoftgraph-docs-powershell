...
### Set (Default)
```
Set-MgBetaDriveRootContent -DriveId <String> [-Data <Stream>] [-ResponseHeadersVariable <String>]
...
### SetViaIdentity
```
Set-MgBetaDriveRootContent -InputObject <IFilesIdentity> [-Data <Stream>] [-ResponseHeadersVariable <String>]
 -InFile <String> [-ContentType <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
