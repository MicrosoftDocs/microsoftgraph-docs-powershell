...
### Set (Default)
```
Set-MgBetaDriveRootContent -DriveId <String> [-Data <Stream>] -InFile <String> [-ContentType <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### SetViaIdentity
```
Set-MgBetaDriveRootContent -InputObject <IFilesIdentity> [-Data <Stream>] -InFile <String>
