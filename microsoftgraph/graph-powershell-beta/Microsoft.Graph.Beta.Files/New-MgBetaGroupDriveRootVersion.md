...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetagroupdriverootversion
Locale: en-US
Module Name: Microsoft.Graph.Beta.Files
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaGroupDriveRootVersion
---
...
```
New-MgBetaGroupDriveRootVersion -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaGroupDriveRootVersion -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphDriveItemVersion> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgBetaGroupDriveRootVersion](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetagroupdriverootversion)
