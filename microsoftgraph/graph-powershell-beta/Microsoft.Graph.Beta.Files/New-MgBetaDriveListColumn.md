...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetadrivelistcolumn
Locale: en-US
Module Name: Microsoft.Graph.Beta.Files
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaDriveListColumn
---
...
```
New-MgBetaDriveListColumn -DriveId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaDriveListColumn -DriveId <string> -BodyParameter <IMicrosoftGraphColumnDefinition>
...
```
New-MgBetaDriveListColumn -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Boolean <hashtable>]
 [-Calculated <IMicrosoftGraphCalculatedColumn>] [-Choice <IMicrosoftGraphChoiceColumn>]
 [-ColumnGroup <string>] [-ContentApprovalStatus <hashtable>]
 [-Currency <IMicrosoftGraphCurrencyColumn>] [-DateTime <IMicrosoftGraphDateTimeColumn>]
...
```
New-MgBetaDriveListColumn -InputObject <IFilesIdentity>
...
- [New-MgBetaDriveListColumn](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetadrivelistcolumn)
