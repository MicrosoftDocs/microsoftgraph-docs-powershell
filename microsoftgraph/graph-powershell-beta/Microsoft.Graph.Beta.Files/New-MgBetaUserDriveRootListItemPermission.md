...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetauserdriverootlistitempermission
Locale: en-US
Module Name: Microsoft.Graph.Beta.Files
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaUserDriveRootListItemPermission
---

# New-MgBetaUserDriveRootListItemPermission
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgUserDriveRootListItemPermission](/powershell/module/Microsoft.Graph.Files/New-MgUserDriveRootListItemPermission?view=graph-powershell-1.0)
...
```
New-MgBetaUserDriveRootListItemPermission -DriveId <string> -UserId <string>
...
```
New-MgBetaUserDriveRootListItemPermission -InputObject <IFilesIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-ExpirationDateTime <datetime>] [-GrantedTo <IMicrosoftGraphIdentitySet>]
 [-GrantedToIdentities <IMicrosoftGraphIdentitySet[]>]
 [-GrantedToIdentitiesV2 <IMicrosoftGraphSharePointIdentitySet[]>]
...
- [New-MgBetaUserDriveRootListItemPermission](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetauserdriverootlistitempermission)
