...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetauserdriverootpermission
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgUserDriveRootPermission](/powershell/module/Microsoft.Graph.Files/Update-MgUserDriveRootPermission?view=graph-powershell-v1.0)

## SYNTAX

### UpdateExpanded (Default)
```
Update-MgBetaUserDriveRootPermission -DriveId <String> -PermissionId <String> -UserId <String>
...
```
Update-MgBetaUserDriveRootPermission -InputObject <IFilesIdentity> [-AdditionalProperties <Hashtable>]
...
### UpdateViaIdentity
```
Update-MgBetaUserDriveRootPermission -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphPermission>
...
## RELATED LINKS
[Update-MgUserDriveRootPermission](/powershell/module/Microsoft.Graph.Files/Update-MgUserDriveRootPermission?view=graph-powershell-v1.0)
