...
### Create1
```
New-MgUserDriveListContentType -DriveId <String> -UserId <String> -BodyParameter <IMicrosoftGraphContentType1>
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### CreateViaIdentity1
```
New-MgUserDriveListContentType -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphContentType1>
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
