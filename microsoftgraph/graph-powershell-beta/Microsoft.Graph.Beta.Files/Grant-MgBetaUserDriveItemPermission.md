...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/grant-mgbetauserdriveitempermission
schema: 2.0.0
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Grant-MgUserDriveItemPermission](/powershell/module/Microsoft.Graph.Files/Grant-MgUserDriveItemPermission?view=graph-powershell-1.0)
...
```
Grant-MgBetaUserDriveItemPermission -InputObject <IFilesIdentity> [-ResponseHeadersVariable <String>]
...
### GrantViaIdentity
```
Grant-MgBetaUserDriveItemPermission -InputObject <IFilesIdentity>
 -BodyParameter <IPaths1Sp3KjhUsersUserIdDrivesDriveIdItemsDriveitemIdPermissionsPermissionIdMicrosoftGraphGrantPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/grant-mgbetauserdriveitempermission](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/grant-mgbetauserdriveitempermission)
