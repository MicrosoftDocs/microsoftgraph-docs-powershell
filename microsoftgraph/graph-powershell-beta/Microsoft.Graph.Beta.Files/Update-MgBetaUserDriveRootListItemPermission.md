...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetauserdriverootlistitempermission
schema: 2.0.0
---
...
```
Update-MgBetaUserDriveRootListItemPermission -DriveId <String> -PermissionId <String> -UserId <String>
...
```
Update-MgBetaUserDriveRootListItemPermission -InputObject <IFilesIdentity> [-ResponseHeadersVariable <String>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetauserdriverootlistitempermission](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetauserdriverootlistitempermission)
