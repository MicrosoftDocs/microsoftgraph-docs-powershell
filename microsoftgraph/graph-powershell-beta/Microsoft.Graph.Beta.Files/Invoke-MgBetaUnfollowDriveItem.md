...
### Unfollow (Default)
```
Invoke-MgBetaUnfollowDriveItem -DriveId <String> -DriveItemId <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### UnfollowViaIdentity
```
Invoke-MgBetaUnfollowDriveItem -InputObject <IFilesIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
