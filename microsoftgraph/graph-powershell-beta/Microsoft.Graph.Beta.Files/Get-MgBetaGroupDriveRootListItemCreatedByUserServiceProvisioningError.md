...
```
Get-MgBetaGroupDriveRootListItemCreatedByUserServiceProvisioningError -DriveId <string>
 -GroupId <string> [-ExpandProperty <string[]>] [-Filter <string>] [-Property <string[]>]
