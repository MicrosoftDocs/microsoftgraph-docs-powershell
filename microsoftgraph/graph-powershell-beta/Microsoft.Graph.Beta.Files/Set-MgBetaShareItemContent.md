...
### Set (Default)
```
Set-MgBetaShareItemContent -DriveItemId <String> -SharedDriveItemId <String> [-Data <Stream>]
...
### SetViaIdentity
```
Set-MgBetaShareItemContent -InputObject <IFilesIdentity> [-Data <Stream>] [-ResponseHeadersVariable <String>]
