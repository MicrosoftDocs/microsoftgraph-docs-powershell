...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetasharelistcontenttype
Locale: en-US
Module Name: Microsoft.Graph.Beta.Files
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaShareListContentType
---
...
```
Update-MgBetaShareListContentType -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaShareListContentType -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphContentType> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [Update-MgBetaShareListContentType](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetasharelistcontenttype)
