...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetadriveitempermission
Locale: en-US
Module Name: Microsoft.Graph.Beta.Files
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaDriveItemPermission
---
...
```
New-MgBetaDriveItemPermission -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaDriveItemPermission -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphPermission> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgBetaDriveItemPermission](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetadriveitempermission)
