...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/add-mgbetagroupdrivelistcontenttypecopy
schema: 2.0.0
...
### AddExpanded (Default)
```
Add-MgBetaGroupDriveListContentTypeCopy -DriveId <String> -GroupId <String> [-ResponseHeadersVariable <String>]
...
```
Add-MgBetaGroupDriveListContentTypeCopy -InputObject <IFilesIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-ContentType <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
