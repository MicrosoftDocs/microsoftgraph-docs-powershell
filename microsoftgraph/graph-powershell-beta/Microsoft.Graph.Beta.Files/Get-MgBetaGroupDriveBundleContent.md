...
### Get (Default)
```
Get-MgBetaGroupDriveBundleContent -DriveId <String> -DriveItemId <String> -GroupId <String> [-Format <String>]
...
### GetViaIdentity
```
Get-MgBetaGroupDriveBundleContent -InputObject <IFilesIdentity> [-Format <String>] -OutFile <String>
