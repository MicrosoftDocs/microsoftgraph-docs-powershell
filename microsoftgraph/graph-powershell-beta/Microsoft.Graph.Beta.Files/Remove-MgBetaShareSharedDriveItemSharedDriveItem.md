...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Remove-MgShareSharedDriveItemSharedDriveItem](/powershell/module/Microsoft.Graph.Files/Remove-MgShareSharedDriveItemSharedDriveItem?view=graph-powershell-v1.0)

## SYNTAX

### Delete (Default)
```
Remove-MgBetaShareSharedDriveItemSharedDriveItem -SharedDriveItemId <String> [-IfMatch <String>] [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaShareSharedDriveItemSharedDriveItem -InputObject <IFilesIdentity> [-IfMatch <String>] [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
