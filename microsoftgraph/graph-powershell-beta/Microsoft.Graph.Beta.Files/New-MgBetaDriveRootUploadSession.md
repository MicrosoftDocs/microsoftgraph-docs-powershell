...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetadriverootuploadsession
Locale: en-US
Module Name: Microsoft.Graph.Beta.Files
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaDriveRootUploadSession
---
...
```
New-MgBetaDriveRootUploadSession -DriveId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaDriveRootUploadSession -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Item <IMicrosoftGraphDriveItemUploadableProperties>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgBetaDriveRootUploadSession](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetadriverootuploadsession)
