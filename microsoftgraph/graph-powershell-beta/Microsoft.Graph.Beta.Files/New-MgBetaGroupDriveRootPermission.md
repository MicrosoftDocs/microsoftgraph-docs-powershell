...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetagroupdriverootpermission
Locale: en-US
Module Name: Microsoft.Graph.Beta.Files
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaGroupDriveRootPermission
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgGroupDriveRootPermission](/powershell/module/Microsoft.Graph.Files/New-MgGroupDriveRootPermission?view=graph-powershell-1.0)
...
```
New-MgBetaGroupDriveRootPermission -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaGroupDriveRootPermission -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphPermission> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgBetaGroupDriveRootPermission](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetagroupdriverootpermission)
