...
### Graph (Default)
```
Invoke-MgBetaGraphDrive -DriveId <String> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
...
### GraphViaIdentity
```
Invoke-MgBetaGraphDrive -InputObject <IFilesIdentity> [-Count] [-ExpandProperty <String[]>] [-Filter <String>]
 [-Property <String[]>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>] [-Top <Int32>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
