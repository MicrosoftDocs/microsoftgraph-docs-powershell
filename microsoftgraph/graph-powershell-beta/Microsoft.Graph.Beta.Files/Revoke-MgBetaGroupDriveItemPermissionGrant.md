...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/revoke-mgbetagroupdriveitempermissiongrant
schema: 2.0.0
...
```
Revoke-MgBetaGroupDriveItemPermissionGrant -InputObject <IFilesIdentity> [-ResponseHeadersVariable <String>]
...
### RevokeViaIdentity
```
Revoke-MgBetaGroupDriveItemPermissionGrant -InputObject <IFilesIdentity>
 -BodyParameter <IPaths198XryjGroupsGroupIdDrivesDriveIdItemsDriveitemIdPermissionsPermissionIdMicrosoftGraphRevokegrantsPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/revoke-mgbetagroupdriveitempermissiongrant](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/revoke-mgbetagroupdriveitempermissiongrant)
