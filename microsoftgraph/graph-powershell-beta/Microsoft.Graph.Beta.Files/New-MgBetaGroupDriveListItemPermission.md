...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetagroupdrivelistitempermission
Locale: en-US
Module Name: Microsoft.Graph.Beta.Files
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaGroupDriveListItemPermission
---

# New-MgBetaGroupDriveListItemPermission
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgGroupDriveListItemPermission](/powershell/module/Microsoft.Graph.Files/New-MgGroupDriveListItemPermission?view=graph-powershell-1.0)
...
```
New-MgBetaGroupDriveListItemPermission -DriveId <string> -GroupId <string> -ListItemId <string>
...
```
New-MgBetaGroupDriveListItemPermission -InputObject <IFilesIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-ExpirationDateTime <datetime>] [-GrantedTo <IMicrosoftGraphIdentitySet>]
 [-GrantedToIdentities <IMicrosoftGraphIdentitySet[]>]
 [-GrantedToIdentitiesV2 <IMicrosoftGraphSharePointIdentitySet[]>]
...
- [New-MgBetaGroupDriveListItemPermission](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetagroupdrivelistitempermission)
