...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Grant-MgGroupDriveListItemPermission](/powershell/module/Microsoft.Graph.Files/Grant-MgGroupDriveListItemPermission?view=graph-powershell-1.0)
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths1Twm8A8GroupsGroupIdDrivesDriveIdListItemsListitemIdPermissionsPermissionIdMicrosoftGraphGrantPostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
