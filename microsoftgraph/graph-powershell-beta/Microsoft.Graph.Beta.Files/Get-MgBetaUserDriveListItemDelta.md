...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/get-mgbetauserdrivelistitemdelta
schema: 2.0.0
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgUserDriveListItemDelta](/powershell/module/Microsoft.Graph.Files/Get-MgUserDriveListItemDelta?view=graph-powershell-1.0)
...
### Delta1
```
Get-MgBetaUserDriveListItemDelta -DriveId <String> -UserId <String> -Token <String>
...
### DeltaViaIdentity1
```
Get-MgBetaUserDriveListItemDelta -InputObject <IFilesIdentity> [-ExpandProperty <String[]>] [-Filter <String>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/get-mgbetauserdrivelistitemdelta](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/get-mgbetauserdrivelistitemdelta)
