...
### Get (Default)
```
Get-MgBetaShareItemContent -DriveItemId <String> -SharedDriveItemId <String> [-Format <String>]
...
### GetViaIdentity
```
Get-MgBetaShareItemContent -InputObject <IFilesIdentity> [-Format <String>] -OutFile <String>
