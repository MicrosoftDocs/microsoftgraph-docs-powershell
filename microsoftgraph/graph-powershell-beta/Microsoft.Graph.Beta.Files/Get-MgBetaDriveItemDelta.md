...
### DeltaViaIdentity1
```
Get-MgBetaDriveItemDelta -InputObject <IFilesIdentity> [-ExpandProperty <String[]>] [-Filter <String>]
...
## RELATED LINKS
[Get-MgDriveItemDelta](/powershell/module/Microsoft.Graph.Files/Get-MgDriveItemDelta?view=graph-powershell-1.0)
