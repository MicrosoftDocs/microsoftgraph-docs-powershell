...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/invoke-mgbetapreviewuserdriveitem
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Invoke-MgPreviewUserDriveItem](/powershell/module/Microsoft.Graph.Files/Invoke-MgPreviewUserDriveItem?view=graph-powershell-1.0)
...
```
Invoke-MgBetaPreviewUserDriveItem -InputObject <IFilesIdentity> [-ResponseHeadersVariable <String>]
...
### PreviewViaIdentity
```
Invoke-MgBetaPreviewUserDriveItem -InputObject <IFilesIdentity>
 -BodyParameter <IPathsZ9C15KUsersUserIdDrivesDriveIdItemsDriveitemIdMicrosoftGraphPreviewPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/invoke-mgbetapreviewuserdriveitem](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/invoke-mgbetapreviewuserdriveitem)
