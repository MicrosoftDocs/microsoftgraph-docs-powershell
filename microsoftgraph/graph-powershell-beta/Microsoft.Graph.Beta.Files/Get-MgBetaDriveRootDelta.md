...
```
Get-MgBetaDriveRootDelta -DriveId <string> -Token <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaDriveRootDelta -InputObject <IFilesIdentity> [-ExpandProperty <string[]>]
 [-Filter <string>] [-Property <string[]>] [-Search <string>] [-Skip <int>] [-Sort <string[]>]
...
- [Get-MgBetaDriveRootDelta](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/get-mgbetadriverootdelta)
