...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/get-mgbetadrivelistitemactivitybyinterval
Locale: en-US
Module Name: Microsoft.Graph.Beta.Files
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaDriveListItemActivityByInterval
---
...
Get-MgBetaDriveListItemActivityByInterval -DriveId <string> -EndDateTime <string> -Interval <string>
 -ListItemId <string> -StartDateTime <string> [-Count] [-ExpandProperty <string[]>]
...
```
Get-MgBetaDriveListItemActivityByInterval -InputObject <IFilesIdentity> [-Count]
...
- [Get-MgBetaDriveListItemActivityByInterval](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/get-mgbetadrivelistitemactivitybyinterval)
