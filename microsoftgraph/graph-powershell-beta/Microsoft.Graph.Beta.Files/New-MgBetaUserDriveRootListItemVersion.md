...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgUserDriveRootListItemVersion](/powershell/module/Microsoft.Graph.Files/New-MgUserDriveRootListItemVersion?view=graph-powershell-1.0)

## SYNTAX

### CreateExpanded (Default)
```
New-MgBetaUserDriveRootListItemVersion -DriveId <String> -UserId <String> [-ResponseHeadersVariable <String>]
...
```
New-MgBetaUserDriveRootListItemVersion -InputObject <IFilesIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-Fields <Hashtable>] [-Id <String>]
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-LastModifiedDateTime <DateTime>]
 [-Publication <IMicrosoftGraphPublicationFacet>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetauserdriverootlistitemversion](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetauserdriverootlistitemversion)
