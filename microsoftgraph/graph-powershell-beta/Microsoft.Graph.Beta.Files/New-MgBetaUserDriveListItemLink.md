...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetauserdrivelistitemlink
Locale: en-US
Module Name: Microsoft.Graph.Beta.Files
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaUserDriveListItemLink
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgUserDriveListItemLink](/powershell/module/Microsoft.Graph.Files/New-MgUserDriveListItemLink?view=graph-powershell-1.0)
...
```
New-MgBetaUserDriveListItemLink -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-ExpirationDateTime <datetime>] [-Message <string>]
 [-Password <string>] [-Recipients <IMicrosoftGraphDriveRecipient[]>] [-RetainInheritedPermissions]
...
```
New-MgBetaUserDriveListItemLink -InputObject <IFilesIdentity>
 -BodyParameter <IPathsA00Hz4UsersUserIdDrivesDriveIdListItemsListitemIdMicrosoftGraphCreatelinkPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgBetaUserDriveListItemLink](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetauserdrivelistitemlink)
