...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetagroupdriverootlistitempermission
schema: 2.0.0
---
...
```
Update-MgBetaGroupDriveRootListItemPermission -DriveId <String> -GroupId <String> -PermissionId <String>
...
```
Update-MgBetaGroupDriveRootListItemPermission -InputObject <IFilesIdentity> [-ResponseHeadersVariable <String>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetagroupdriverootlistitempermission](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetagroupdriverootlistitempermission)
