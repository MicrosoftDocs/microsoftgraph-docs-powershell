...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/add-mgbetasharelistcontenttypecopy
Locale: en-US
Module Name: Microsoft.Graph.Beta.Files
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: Add-MgBetaShareListContentTypeCopy
---
...
```
Add-MgBetaShareListContentTypeCopy -SharedDriveItemId <string> [-ResponseHeadersVariable <string>]
...
```
Add-MgBetaShareListContentTypeCopy -InputObject <IFilesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-ContentType <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
- [Add-MgBetaShareListContentTypeCopy](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/add-mgbetasharelistcontenttypecopy)
