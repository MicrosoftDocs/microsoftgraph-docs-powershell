...
### Extract (Default)
```
Invoke-MgExtractDriveItemSensitivityLabel -DriveId <String> -DriveItemId <String> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### ExtractViaIdentity
```
Invoke-MgExtractDriveItemSensitivityLabel -InputObject <IFilesIdentity> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
