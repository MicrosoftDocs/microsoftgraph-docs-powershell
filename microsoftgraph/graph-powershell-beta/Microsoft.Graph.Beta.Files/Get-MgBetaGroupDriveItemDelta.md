...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/get-mgbetagroupdriveitemdelta
Locale: en-US
Module Name: Microsoft.Graph.Beta.Files
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Get-MgBetaGroupDriveItemDelta
---
...
```
Get-MgBetaGroupDriveItemDelta -DriveId <string> -DriveItemId <string> -GroupId <string>
 -Token <string> [-ExpandProperty <string[]>] [-Filter <string>] [-Property <string[]>]
...
```
Get-MgBetaGroupDriveItemDelta -InputObject <IFilesIdentity> [-ExpandProperty <string[]>]
