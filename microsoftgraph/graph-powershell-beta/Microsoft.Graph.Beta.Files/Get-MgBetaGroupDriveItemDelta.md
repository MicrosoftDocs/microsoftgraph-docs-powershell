...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/get-mgbetagroupdriveitemdelta
schema: 2.0.0
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgGroupDriveItemDelta](/powershell/module/Microsoft.Graph.Files/Get-MgGroupDriveItemDelta?view=graph-powershell-1.0)
...
### DeltaViaIdentity1
```
Get-MgBetaGroupDriveItemDelta -InputObject <IFilesIdentity> [-ExpandProperty <String[]>] [-Filter <String>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/get-mgbetagroupdriveitemdelta](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/get-mgbetagroupdriveitemdelta)
