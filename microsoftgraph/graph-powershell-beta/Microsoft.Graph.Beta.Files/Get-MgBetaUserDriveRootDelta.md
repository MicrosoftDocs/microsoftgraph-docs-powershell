...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/get-mgbetauserdriverootdelta
schema: 2.0.0
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgUserDriveRootDelta](/powershell/module/Microsoft.Graph.Files/Get-MgUserDriveRootDelta?view=graph-powershell-1.0)

## SYNTAX

### Delta (Default)
```
Get-MgBetaUserDriveRootDelta -DriveId <String> -UserId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### Delta1
```
Get-MgBetaUserDriveRootDelta -DriveId <String> -UserId <String> -Token <String> [-ExpandProperty <String[]>]
...
### DeltaViaIdentity1
```
Get-MgBetaUserDriveRootDelta -InputObject <IFilesIdentity> [-ExpandProperty <String[]>] [-Filter <String>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/get-mgbetauserdriverootdelta](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/get-mgbetauserdriverootdelta)
