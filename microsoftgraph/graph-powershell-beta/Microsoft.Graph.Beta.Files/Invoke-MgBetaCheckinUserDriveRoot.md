...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/invoke-mgbetacheckinuserdriveroot
schema: 2.0.0
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Invoke-MgCheckinUserDriveRoot](/powershell/module/Microsoft.Graph.Files/Invoke-MgCheckinUserDriveRoot?view=graph-powershell-1.0)

## SYNTAX

### CheckinExpanded (Default)
```
Invoke-MgBetaCheckinUserDriveRoot -DriveId <String> -UserId <String> [-ResponseHeadersVariable <String>]
...
```
Invoke-MgBetaCheckinUserDriveRoot -InputObject <IFilesIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-CheckInAs <String>] [-Comment <String>] [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/invoke-mgbetacheckinuserdriveroot](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/invoke-mgbetacheckinuserdriveroot)
