...
### Set (Default)
```
Set-MgBetaUserDriveRootContent -DriveId <String> -UserId <String> [-Data <Stream>] -InFile <String>
...
### SetViaIdentity
```
Set-MgBetaUserDriveRootContent -InputObject <IFilesIdentity> [-Data <Stream>] -InFile <String>
 [-ContentType <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
## RELATED LINKS
[Set-MgUserDriveRootContent](/powershell/module/Microsoft.Graph.Files/Set-MgUserDriveRootContent?view=graph-powershell-1.0)
