...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetagroupdrivelistitemlastmodifiedbyusermailboxsetting
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgGroupDriveListItemLastModifiedByUserMailboxSetting](/powershell/module/Microsoft.Graph.Files/Update-MgGroupDriveListItemLastModifiedByUserMailboxSetting?view=graph-powershell-1.0)

## SYNTAX

### UpdateExpanded (Default)
```
Update-MgBetaGroupDriveListItemLastModifiedByUserMailboxSetting -DriveId <String> -GroupId <String>
 -ListItemId <String> [-AdditionalProperties <Hashtable>] [-ArchiveFolder <String>]
...
```
Update-MgBetaGroupDriveListItemLastModifiedByUserMailboxSetting -DriveId <String> -GroupId <String>
 -ListItemId <String> -BodyParameter <IMicrosoftGraphMailboxSettings> [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgBetaGroupDriveListItemLastModifiedByUserMailboxSetting -InputObject <IFilesIdentity>
...
## RELATED LINKS
[Update-MgGroupDriveListItemLastModifiedByUserMailboxSetting](/powershell/module/Microsoft.Graph.Files/Update-MgGroupDriveListItemLastModifiedByUserMailboxSetting?view=graph-powershell-1.0)

[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetagroupdrivelistitemlastmodifiedbyusermailboxsetting](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetagroupdrivelistitemlastmodifiedbyusermailboxsetting)
