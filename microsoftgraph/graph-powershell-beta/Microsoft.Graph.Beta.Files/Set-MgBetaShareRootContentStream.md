...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/set-mgbetasharerootcontentstream
schema: 2.0.0
---
...
### Set (Default)
```
Set-MgBetaShareRootContentStream -SharedDriveItemId <String> [-Data <Stream>]
...
### SetViaIdentity
```
Set-MgBetaShareRootContentStream -InputObject <IFilesIdentity> [-Data <Stream>]
 [-ResponseHeadersVariable <String>] -InFile <String> [-ContentType <String>] [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
