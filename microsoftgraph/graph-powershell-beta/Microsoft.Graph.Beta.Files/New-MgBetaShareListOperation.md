...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgShareListOperation](/powershell/module/Microsoft.Graph.Files/New-MgShareListOperation?view=graph-powershell-v1.0)

## SYNTAX

### CreateExpanded (Default)
```
New-MgBetaShareListOperation -SharedDriveItemId <String> [-AdditionalProperties <Hashtable>]
...
```
New-MgBetaShareListOperation -InputObject <IFilesIdentity> [-AdditionalProperties <Hashtable>]
 [-CreatedDateTime <DateTime>] [-Error <IMicrosoftGraphPublicError>] [-Id <String>]
 [-LastActionDateTime <DateTime>] [-PercentageComplete <Int32>] [-ResourceId <String>]
 [-ResourceLocation <String>] [-Status <String>] [-StatusDetail <String>] [-Type <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
