...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgGroupDriveListItemDocumentSetVersion](/powershell/module/Microsoft.Graph.Files/Update-MgGroupDriveListItemDocumentSetVersion?view=graph-powershell-v1.0)
...
```
Update-MgBetaGroupDriveListItemDocumentSetVersion -DocumentSetVersionId <String> -DriveId <String>
 -GroupId <String> -ListItemId <String> -BodyParameter <IMicrosoftGraphDocumentSetVersion> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgGroupDriveListItemDocumentSetVersion](/powershell/module/Microsoft.Graph.Files/Update-MgGroupDriveListItemDocumentSetVersion?view=graph-powershell-v1.0)
