...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users.actions/revoke-mgbetausermanageddeviceapplevpplicense
schema: 2.0.0
---
...
### Revoke (Default)
```
Revoke-MgBetaUserManagedDeviceAppleVppLicense -ManagedDeviceId <String> -UserId <String> [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### RevokeViaIdentity
```
Revoke-MgBetaUserManagedDeviceAppleVppLicense -InputObject <IUsersActionsIdentity> [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
