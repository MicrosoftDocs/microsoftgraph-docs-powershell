...
### EnableViaIdentity
```
Enable-MgUserAuthenticationMethodSmsSignIn -InputObject <IUsersActionsIdentity> [-PassThru] [-WhatIf]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/enable-mguserauthenticationmethodsmssignin](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/enable-mguserauthenticationmethodsmssignin)
