...
### Unblock (Default)
```
Unblock-MgBetaUserManagedApp -UserId <String> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UnblockViaIdentity
```
Unblock-MgBetaUserManagedApp -InputObject <IUsersActionsIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
