...
```
Invoke-MgReauthorizeUserDriveItemSubscription -InputObject <IUsersActionsIdentity> [-PassThru] [-WhatIf]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/invoke-mgreauthorizeuserdriveitemsubscription](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/invoke-mgreauthorizeuserdriveitemsubscription)
