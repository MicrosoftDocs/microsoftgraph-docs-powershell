...
### Retry (Default)
```
Invoke-MgBetaRetryUserServiceProvisioning -UserId <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### RetryViaIdentity
```
Invoke-MgBetaRetryUserServiceProvisioning -InputObject <IUsersActionsIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
