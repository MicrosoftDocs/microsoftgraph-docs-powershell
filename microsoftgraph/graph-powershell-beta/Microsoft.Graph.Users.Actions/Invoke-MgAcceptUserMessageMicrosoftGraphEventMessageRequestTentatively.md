...
```yaml
Type: IPaths11Ofb9ZUsersUserIdMessagesMessageIdMicrosoftGraphEventmessagerequestMicrosoftGraphTentativelyacceptPostRequestbodyContentApplicationJsonSchema
