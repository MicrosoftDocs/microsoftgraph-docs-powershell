...
```
Invoke-MgBetaCleanUserManagedDeviceWindowsDevice -ManagedDeviceId <String> -UserId <String>
...
```
Invoke-MgBetaCleanUserManagedDeviceWindowsDevice -InputObject <IUsersActionsIdentity>
 [-AdditionalProperties <Hashtable>] [-KeepUserData] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths1Nos4SfUsersUserIdManageddevicesManageddeviceIdMicrosoftGraphCleanwindowsdevicePostRequestbodyContentApplicationJsonSchema
