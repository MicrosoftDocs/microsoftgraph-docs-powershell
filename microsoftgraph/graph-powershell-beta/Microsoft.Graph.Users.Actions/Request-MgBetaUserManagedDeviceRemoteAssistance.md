...
### Request (Default)
```
Request-MgBetaUserManagedDeviceRemoteAssistance -ManagedDeviceId <String> -UserId <String> [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### RequestViaIdentity
```
Request-MgBetaUserManagedDeviceRemoteAssistance -InputObject <IUsersActionsIdentity> [-PassThru] [-WhatIf]
