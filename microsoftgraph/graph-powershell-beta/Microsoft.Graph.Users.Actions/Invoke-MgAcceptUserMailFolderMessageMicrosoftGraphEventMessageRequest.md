...
```yaml
Type: IPathsC0T5DtUsersUserIdMailfoldersMailfolderIdMessagesMessageIdMicrosoftGraphEventmessagerequestMicrosoftGraphAcceptPostRequestbodyContentApplicationJsonSchema
