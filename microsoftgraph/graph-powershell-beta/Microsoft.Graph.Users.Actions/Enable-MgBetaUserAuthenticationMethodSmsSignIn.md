...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users.actions/enable-mgbetauserauthenticationmethodsmssignin
schema: 2.0.0
---
...
### EnableViaIdentity
```
Enable-MgBetaUserAuthenticationMethodSmsSignIn -InputObject <IUsersActionsIdentity> [-PassThru] [-WhatIf]
