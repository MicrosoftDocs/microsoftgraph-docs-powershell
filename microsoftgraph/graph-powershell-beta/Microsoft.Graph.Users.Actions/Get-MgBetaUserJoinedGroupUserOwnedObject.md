...
```
Get-MgBetaUserJoinedGroupUserOwnedObject [-UserId <String>] -InputObject <IUsersActionsIdentity>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users.actions/get-mgbetauserjoinedgroupuserownedobject](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users.actions/get-mgbetauserjoinedgroupuserownedobject)
