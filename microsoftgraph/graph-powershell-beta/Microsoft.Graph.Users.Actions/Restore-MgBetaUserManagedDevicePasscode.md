...
### Recover (Default)
```
Restore-MgBetaUserManagedDevicePasscode -ManagedDeviceId <String> -UserId <String> [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### RecoverViaIdentity
```
Restore-MgBetaUserManagedDevicePasscode -InputObject <IUsersActionsIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
