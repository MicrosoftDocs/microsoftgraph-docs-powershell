...
### GetExpanded (Default)
```
Get-MgUserDeviceById -UserId <String> [-AdditionalProperties <Hashtable>] [-Ids <String[]>] [-Types <String[]>]
...
```
Get-MgUserDeviceById -InputObject <IUsersActionsIdentity> [-AdditionalProperties <Hashtable>] [-Ids <String[]>]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/get-mguserdevicebyid](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/get-mguserdevicebyid)
