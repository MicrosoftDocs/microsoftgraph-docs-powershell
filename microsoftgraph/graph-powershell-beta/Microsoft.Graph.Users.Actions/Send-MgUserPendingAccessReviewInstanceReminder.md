...
### Send (Default)
```
Send-MgBetaUserPendingAccessReviewInstanceReminder -AccessReviewInstanceId <String> -UserId <String>
 [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### SendViaIdentity
```
Send-MgBetaUserPendingAccessReviewInstanceReminder -InputObject <IUsersActionsIdentity> [-PassThru] [-WhatIf]
