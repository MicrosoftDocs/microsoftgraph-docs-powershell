...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/get-mgbetagroupsitetermstoresettermchildrelationtoterm
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaGroupSiteTermStoreSetTermChildRelationToTerm -GroupId <String> -RelationId <String> -SetId <String>
...
### GetViaIdentity
```
Get-MgBetaGroupSiteTermStoreSetTermChildRelationToTerm -InputObject <ISitesIdentity>
