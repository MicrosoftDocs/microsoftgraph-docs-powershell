...
### DeleteViaIdentity1
```
Remove-MgGroupSiteListOperation -InputObject <ISitesIdentity> [-IfMatch <String>] [-PassThru] [-WhatIf]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/remove-mggroupsitelistoperation](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/remove-mggroupsitelistoperation)
