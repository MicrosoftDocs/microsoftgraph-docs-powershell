...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetagroupsitetermstoresetterm
schema: 2.0.0
---
...
```
New-MgBetaGroupSiteTermStoreSetTerm -GroupId <String> -SetId <String> -SiteId <String>
...
```
New-MgBetaGroupSiteTermStoreSetTerm -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]
...
### CreateViaIdentity
```
New-MgBetaGroupSiteTermStoreSetTerm -InputObject <ISitesIdentity> -BodyParameter <IMicrosoftGraphTermStoreTerm>
