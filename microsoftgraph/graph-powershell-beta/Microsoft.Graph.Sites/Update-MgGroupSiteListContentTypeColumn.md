...
```
Update-MgBetaGroupSiteListContentTypeColumn -ColumnDefinitionId <String> -ContentTypeId <String>
 -GroupId <String> -ListId <String> -SiteId <String> [-AdditionalProperties <Hashtable>] [-Boolean <Hashtable>]
...
```
Update-MgBetaGroupSiteListContentTypeColumn -ColumnDefinitionId <String> -ContentTypeId <String>
 -GroupId <String> -ListId <String> -SiteId <String> -BodyParameter <IMicrosoftGraphColumnDefinition> [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgBetaGroupSiteListContentTypeColumn -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]
...
### UpdateViaIdentity
```
Update-MgBetaGroupSiteListContentTypeColumn -InputObject <ISitesIdentity>
