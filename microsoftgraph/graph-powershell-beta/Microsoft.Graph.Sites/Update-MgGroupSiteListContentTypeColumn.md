...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/update-mggroupsitelistcontenttypecolumn
schema: 2.0.0
---
...
```
Update-MgGroupSiteListContentTypeColumn -ColumnDefinitionId <String> -ContentTypeId <String> -GroupId <String>
 -ListId <String> -SiteId <String> [-AdditionalProperties <Hashtable>] [-Boolean <Hashtable>]
...
```
Update-MgGroupSiteListContentTypeColumn -ColumnDefinitionId <String> -ContentTypeId <String> -GroupId <String>
 -ListId <String> -SiteId <String> -BodyParameter <IMicrosoftGraphColumnDefinition> [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### UpdateViaIdentityExpanded1
```
Update-MgGroupSiteListContentTypeColumn -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]
...
### UpdateViaIdentity1
```
Update-MgGroupSiteListContentTypeColumn -InputObject <ISitesIdentity>
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/update-mggroupsitelistcontenttypecolumn](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/update-mggroupsitelistcontenttypecolumn)
