...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetasitetermstoregroupsetterm
schema: 2.0.0
---
...
```
New-MgBetaSiteTermStoreGroupSetTerm -GroupId <String> -SetId <String> -SiteId <String>
...
```
New-MgBetaSiteTermStoreGroupSetTerm -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]
...
### CreateViaIdentity
```
New-MgBetaSiteTermStoreGroupSetTerm -InputObject <ISitesIdentity> -BodyParameter <IMicrosoftGraphTermStoreTerm>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetasitetermstoregroupsetterm](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetasitetermstoregroupsetterm)
