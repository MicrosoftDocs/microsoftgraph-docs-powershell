...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetagroupsitelistitemdocumentsetversion
schema: 2.0.0
...
```
New-MgBetaGroupSiteListItemDocumentSetVersion -GroupId <String> -ListId <String> -ListItemId <String>
...
```
New-MgBetaGroupSiteListItemDocumentSetVersion -GroupId <String> -ListId <String> -ListItemId <String>
 -SiteId <String> -BodyParameter <IMicrosoftGraphDocumentSetVersion> [-WhatIf] [-Confirm] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgBetaGroupSiteListItemDocumentSetVersion -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]
...
### CreateViaIdentity
```
New-MgBetaGroupSiteListItemDocumentSetVersion -InputObject <ISitesIdentity>
