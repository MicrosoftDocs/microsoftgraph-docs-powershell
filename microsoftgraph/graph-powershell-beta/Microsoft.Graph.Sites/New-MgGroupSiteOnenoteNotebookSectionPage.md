...
```
New-MgBetaGroupSiteOnenoteNotebookSectionPage -GroupId <String> -NotebookId <String> -OnenoteSectionId <String>
...
```
New-MgBetaGroupSiteOnenoteNotebookSectionPage -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]
