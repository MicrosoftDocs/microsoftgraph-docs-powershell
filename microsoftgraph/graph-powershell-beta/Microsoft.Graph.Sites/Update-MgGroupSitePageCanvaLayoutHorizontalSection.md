...
```
Update-MgGroupSitePageCanvaLayoutHorizontalSection -GroupId <String> -HorizontalSectionId <String>
 -SiteId <String> -SitePageId <String> -BodyParameter <IMicrosoftGraphHorizontalSection> [-PassThru] [-WhatIf]
...
Update-MgGroupSitePageCanvaLayoutHorizontalSection -InputObject <ISitesIdentity>
 ...
 [-Id <String>] [-Layout <String>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-MgGroupSitePageCanvaLayoutHorizontalSection -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphHorizontalSection> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
