...
### List2 (Default)
```
Get-MgBetaSubSite [-SiteId <String>] [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
### Get1
```
Get-MgBetaSubSite [-SiteId <String>] -SiteId1 <String> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
