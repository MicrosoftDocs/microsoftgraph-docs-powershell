...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsitecolumn
schema: 2.0.0
---

# Update-MgBetaGroupSiteColumn
...
```
Update-MgBetaGroupSiteColumn -ColumnDefinitionId <String> -GroupId <String> -SiteId <String>
...
```
Update-MgBetaGroupSiteColumn -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]
...
### UpdateViaIdentity
```
Update-MgBetaGroupSiteColumn -InputObject <ISitesIdentity> -BodyParameter <IMicrosoftGraphColumnDefinition>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsitecolumn](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsitecolumn)
