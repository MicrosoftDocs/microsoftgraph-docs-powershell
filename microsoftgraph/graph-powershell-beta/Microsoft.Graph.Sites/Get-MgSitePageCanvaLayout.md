...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.sites/get-mgsitepagecanvalayout
schema: 2.0.0
---

# Get-MgSitePageCanvaLayout
...
### Get (Default)
```
Get-MgSitePageCanvaLayout -SiteId <String> -SitePageId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgSitePageCanvaLayout -InputObject <ISitesIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
