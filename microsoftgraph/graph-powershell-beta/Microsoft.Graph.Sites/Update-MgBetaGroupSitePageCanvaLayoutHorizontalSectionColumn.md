...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsitepagecanvalayouthorizontalsectioncolumn
schema: 2.0.0
---
...
```
Update-MgBetaGroupSitePageCanvaLayoutHorizontalSectionColumn -GroupId <String>
...
```
Update-MgBetaGroupSitePageCanvaLayoutHorizontalSectionColumn -InputObject <ISitesIdentity>
 [-AdditionalProperties <Hashtable>] [-Id <String>] [-Webparts <IMicrosoftGraphWebPart[]>] [-Width <Int32>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsitepagecanvalayouthorizontalsectioncolumn](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsitepagecanvalayouthorizontalsectioncolumn)
