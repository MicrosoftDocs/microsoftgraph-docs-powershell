...
### Unpublish (Default)
```
Unpublish-MgBetaSiteContentType -ContentTypeId <String> -SiteId <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### UnpublishViaIdentity
```
Unpublish-MgBetaSiteContentType -InputObject <ISitesIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
