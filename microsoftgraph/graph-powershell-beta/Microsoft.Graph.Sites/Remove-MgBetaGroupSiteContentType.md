...
### Delete (Default)
```
Remove-MgBetaGroupSiteContentType -ContentTypeId <String> -GroupId <String> -SiteId <String>
 [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaGroupSiteContentType -InputObject <ISitesIdentity> [-IfMatch <String>] [-PassThru] [-WhatIf]
