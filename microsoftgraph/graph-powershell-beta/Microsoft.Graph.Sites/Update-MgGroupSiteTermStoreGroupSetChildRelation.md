...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsitetermstoregroupsetchildrelation
schema: 2.0.0
---
...
```
Update-MgBetaGroupSiteTermStoreGroupSetChildRelation -GroupId <String> -GroupId1 <String> -RelationId <String>
...
```
Update-MgBetaGroupSiteTermStoreGroupSetChildRelation -InputObject <ISitesIdentity>
