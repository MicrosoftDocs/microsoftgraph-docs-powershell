...
```
Update-MgGroupSiteInformationProtectionPolicy -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]
 [-Id <String>] [-Labels <IMicrosoftGraphInformationProtectionLabel[]>] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
