...
# Update-MgBetaWindowsUpdatesUpdatePolicy
...
```
Update-MgBetaWindowsUpdatesUpdatePolicy -UpdatePolicyId <string> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaWindowsUpdatesUpdatePolicy -UpdatePolicyId <string>
...
```
Update-MgBetaWindowsUpdatesUpdatePolicy -InputObject <IWindowsUpdatesIdentity>
