...
# Get-MgBetaWindowsUpdatesPolicyApplicableContent
...
```
Get-MgBetaWindowsUpdatesPolicyApplicableContent -PolicyId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaWindowsUpdatesPolicyApplicableContent -ApplicableContentCatalogEntryId <string>
...
```
Get-MgBetaWindowsUpdatesPolicyApplicableContent -InputObject <IWindowsUpdatesIdentity>
