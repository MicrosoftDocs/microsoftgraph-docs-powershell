...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.windowsupdates/find-mgbetawindowsupdatesproductbykbnumber
Locale: en-US
Module Name: Microsoft.Graph.Beta.WindowsUpdates
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Find-MgBetaWindowsUpdatesProductByKbNumber
---
...
```
Find-MgBetaWindowsUpdatesProductByKbNumber -KbNumber <int> [-Count] [-ExpandProperty <string[]>]
...
```
Find-MgBetaWindowsUpdatesProductByKbNumber -InputObject <IWindowsUpdatesIdentity> [-Count]
