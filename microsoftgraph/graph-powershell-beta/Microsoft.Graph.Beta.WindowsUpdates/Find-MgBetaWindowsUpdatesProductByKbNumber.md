...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.windowsupdates/find-mgbetawindowsupdatesproductbykbnumber
schema: 2.0.0
---
...
### Find (Default)
```
Find-MgBetaWindowsUpdatesProductByKbNumber -KbNumber <Int32> [-Count] [-ExpandProperty <String[]>]
