...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.windowsupdates/update-mgbetawindowsupdatespolicyapproval
Locale: en-US
Module Name: Microsoft.Graph.Beta.WindowsUpdates
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaWindowsUpdatesPolicyApproval
---

# Update-MgBetaWindowsUpdatesPolicyApproval
...
```
Update-MgBetaWindowsUpdatesPolicyApproval -PolicyApprovalId <string> -PolicyId <string>
...
```
Update-MgBetaWindowsUpdatesPolicyApproval -InputObject <IWindowsUpdatesIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-CatalogEntry <IMicrosoftGraphWindowsUpdatesCatalogEntry>] [-CatalogEntryId <string>]
 [-CreatedDateTime <datetime>] [-Id <string>] [-LastModifiedDateTime <datetime>] [-Status <string>]
 [-Break] [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
...
The unique identifier of policyApproval
...
- [Update-MgBetaWindowsUpdatesPolicyApproval](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.windowsupdates/update-mgbetawindowsupdatespolicyapproval)
- [Graph API Reference](https://learn.microsoft.com/graph/api/windowsupdates-policyapproval-update?view=graph-rest-beta)
