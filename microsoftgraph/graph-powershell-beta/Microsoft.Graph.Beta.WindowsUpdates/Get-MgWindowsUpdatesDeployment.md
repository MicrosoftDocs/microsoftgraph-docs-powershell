...
### List (Default)
```
Get-MgWindowsUpdatesDeployment [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.windowsupdates/get-mgwindowsupdatesdeployment](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.windowsupdates/get-mgwindowsupdatesdeployment)
