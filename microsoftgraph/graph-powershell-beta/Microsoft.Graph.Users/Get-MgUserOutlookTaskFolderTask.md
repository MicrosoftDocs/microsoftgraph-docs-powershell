...
### List (Default)
```
Get-MgBetaUserOutlookTaskFolderTask -OutlookTaskFolderId <String> -UserId <String> [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgBetaUserOutlookTaskFolderTask -InputObject <IUsersIdentity> [-Property <String[]>] [<CommonParameters>]
```
