...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users/remove-mguserphoto
schema: 2.0.0
---
...
### Delete1
```
Remove-MgUserPhoto -UserId <String> -ProfilePhotoId <String> [-IfMatch <String>] [-PassThru] [-WhatIf]
