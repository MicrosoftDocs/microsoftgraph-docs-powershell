...
### Delete (Default)
```
Remove-MgBetaUserSettingContactMergeSuggestion -UserId <String> [-IfMatch <String>] [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaUserSettingContactMergeSuggestion -InputObject <IUsersIdentity> [-IfMatch <String>] [-PassThru]
