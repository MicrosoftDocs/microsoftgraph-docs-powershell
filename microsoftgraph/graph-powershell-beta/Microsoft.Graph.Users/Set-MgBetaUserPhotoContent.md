...
### Set (Default)
```
Set-MgBetaUserPhotoContent -UserId <String> [-Data <Stream>] -InFile <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### Set1
```
Set-MgBetaUserPhotoContent -UserId <String> -ProfilePhotoId <String> [-Data <Stream>] -InFile <String>
 [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### SetViaIdentity1
```
Set-MgBetaUserPhotoContent -InputObject <IUsersIdentity> [-Data <Stream>] -InFile <String> [-PassThru]
