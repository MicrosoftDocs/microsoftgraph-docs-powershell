...
### List (Default)
```
Get-MgBetaUserMemberOfAsGroup -UserId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgBetaUserMemberOfAsGroup -InputObject <IUsersIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
