...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/update-mgbetaplaceasfloorcheck
Locale: en-US
Module Name: Microsoft.Graph.Beta.Calendar
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaPlaceAsFloorCheck
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgPlaceAsFloorCheck](/powershell/module/Microsoft.Graph.Calendar/Update-MgPlaceAsFloorCheck?view=graph-powershell-1.0)
...
```
Update-MgBetaPlaceAsFloorCheck -CheckInClaimCalendarEventId <string> -PlaceId <string>
...
```
Update-MgBetaPlaceAsFloorCheck -InputObject <ICalendarIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaPlaceAsFloorCheck -InputObject <ICalendarIdentity>
 -BodyParameter <IMicrosoftGraphCheckInClaim> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [Update-MgBetaPlaceAsFloorCheck](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/update-mgbetaplaceasfloorcheck)
