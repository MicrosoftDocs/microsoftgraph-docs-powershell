...
```
Update-MgBetaPlaceAsBuildingMapLevelUnit -LevelMapId <string> -PlaceId <string> -UnitMapId <string>
...
```
Update-MgBetaPlaceAsBuildingMapLevelUnit -InputObject <ICalendarIdentity> [-PlaceId <string>]
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-Id <string>]
...
```
Update-MgBetaPlaceAsBuildingMapLevelUnit -InputObject <ICalendarIdentity>
 -BodyParameter <IMicrosoftGraphUnitMap> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
