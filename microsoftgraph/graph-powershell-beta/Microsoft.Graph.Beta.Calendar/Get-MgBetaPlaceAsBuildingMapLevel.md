...
```
Get-MgBetaPlaceAsBuildingMapLevel -PlaceId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaPlaceAsBuildingMapLevel -LevelMapId <string> -PlaceId <string>
...
```
Get-MgBetaPlaceAsBuildingMapLevel -InputObject <ICalendarIdentity> [-ExpandProperty <string[]>]
