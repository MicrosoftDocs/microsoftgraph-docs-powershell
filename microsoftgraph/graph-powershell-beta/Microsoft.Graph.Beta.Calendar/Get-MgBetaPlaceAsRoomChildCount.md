...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetaplaceasroomchildcount
Locale: en-US
Module Name: Microsoft.Graph.Beta.Calendar
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaPlaceAsRoomChildCount
---
...
```
Get-MgBetaPlaceAsRoomChildCount -PlaceId <string> [-Filter <string>] [-Search <string>]
...
```
Get-MgBetaPlaceAsRoomChildCount -InputObject <ICalendarIdentity> [-Filter <string>]
...
- [Get-MgBetaPlaceAsRoomChildCount](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetaplaceasroomchildcount)
