...
Typically, synchronizing calendars in a mailbox in a local store entails a round of multiple delta function calls.
...
```
Get-MgBetaUserCalendarDelta -UserId <string> [-ExpandProperty <string[]>] [-Filter <string>]
...
```
Get-MgBetaUserCalendarDelta -InputObject <ICalendarIdentity> [-ExpandProperty <string[]>]
