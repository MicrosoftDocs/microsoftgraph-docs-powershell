...
```
Get-MgBetaUserCalendarView -UserId <string> -EndDateTime <string> -StartDateTime <string>
...
```
Get-MgBetaUserCalendarView -UserId <string> -CalendarId <string> -EndDateTime <string>
...
- [Get-MgBetaUserCalendarView](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetausercalendarview)
