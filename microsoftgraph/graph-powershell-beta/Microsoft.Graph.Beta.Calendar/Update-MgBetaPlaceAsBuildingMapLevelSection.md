...
```
Update-MgBetaPlaceAsBuildingMapLevelSection -LevelMapId <string> -PlaceId <string>
 -SectionMapId <string> [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
...
```
Update-MgBetaPlaceAsBuildingMapLevelSection -LevelMapId <string> -PlaceId <string>
 -SectionMapId <string> -BodyParameter <IMicrosoftGraphSectionMap>
...
```
Update-MgBetaPlaceAsBuildingMapLevelSection -InputObject <ICalendarIdentity> [-PlaceId <string>]
...
```
Update-MgBetaPlaceAsBuildingMapLevelSection -InputObject <ICalendarIdentity>
 -BodyParameter <IMicrosoftGraphSectionMap> [-ResponseHeadersVariable <string>] [-Break]
