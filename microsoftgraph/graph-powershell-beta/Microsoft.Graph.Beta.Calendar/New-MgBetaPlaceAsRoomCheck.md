...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/new-mgbetaplaceasroomcheck
Locale: en-US
Module Name: Microsoft.Graph.Beta.Calendar
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaPlaceAsRoomCheck
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgPlaceAsRoomCheck](/powershell/module/Microsoft.Graph.Calendar/New-MgPlaceAsRoomCheck?view=graph-powershell-1.0)
...
```
New-MgBetaPlaceAsRoomCheck -PlaceId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaPlaceAsRoomCheck -PlaceId <string> -BodyParameter <IMicrosoftGraphCheckInClaim>
...
```
New-MgBetaPlaceAsRoomCheck -InputObject <ICalendarIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-CalendarEventId <string>] [-CheckInMethod <string>]
 [-CreatedDateTime <datetime>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```
New-MgBetaPlaceAsRoomCheck -InputObject <ICalendarIdentity>
...
- [New-MgBetaPlaceAsRoomCheck](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/new-mgbetaplaceasroomcheck)
