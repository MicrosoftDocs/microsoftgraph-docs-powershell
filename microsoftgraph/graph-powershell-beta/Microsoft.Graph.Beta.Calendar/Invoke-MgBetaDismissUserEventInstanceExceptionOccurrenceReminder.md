...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/invoke-mgbetadismissusereventinstanceexceptionoccurrencereminder
schema: 2.0.0
...
### Dismiss (Default)
```
Invoke-MgBetaDismissUserEventInstanceExceptionOccurrenceReminder -EventId <String> -EventId1 <String>
...
### DismissViaIdentity
```
Invoke-MgBetaDismissUserEventInstanceExceptionOccurrenceReminder -InputObject <ICalendarIdentity>
