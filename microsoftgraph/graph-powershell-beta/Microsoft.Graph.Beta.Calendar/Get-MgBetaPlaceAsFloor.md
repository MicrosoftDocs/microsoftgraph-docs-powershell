...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetaplaceasfloor
Locale: en-US
Module Name: Microsoft.Graph.Beta.Calendar
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaPlaceAsFloor
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgPlaceAsFloor](/powershell/module/Microsoft.Graph.Calendar/Get-MgPlaceAsFloor?view=graph-powershell-1.0)
...
```
Get-MgBetaPlaceAsFloor [-ExpandProperty <string[]>] [-Property <string[]>] [-Filter <string>]
...
```
Get-MgBetaPlaceAsFloor -PlaceId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
...
```
Get-MgBetaPlaceAsFloor -InputObject <ICalendarIdentity> [-ExpandProperty <string[]>]
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphFloor
