...
```
Get-MgBetaPlaceCheck -PlaceId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaPlaceCheck -CheckInClaimCalendarEventId <string> -PlaceId <string>
...
```
Get-MgBetaPlaceCheck -InputObject <ICalendarIdentity> [-ExpandProperty <string[]>]
