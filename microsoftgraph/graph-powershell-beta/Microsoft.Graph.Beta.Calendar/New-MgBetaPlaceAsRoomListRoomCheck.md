...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/new-mgbetaplaceasroomlistroomcheck
Locale: en-US
Module Name: Microsoft.Graph.Beta.Calendar
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaPlaceAsRoomListRoomCheck
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgPlaceAsRoomListRoomCheck](/powershell/module/Microsoft.Graph.Calendar/New-MgPlaceAsRoomListRoomCheck?view=graph-powershell-1.0)
...
```
New-MgBetaPlaceAsRoomListRoomCheck -PlaceId <string> -RoomId <string>
...
```
New-MgBetaPlaceAsRoomListRoomCheck -InputObject <ICalendarIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-CalendarEventId <string>]
 [-CheckInMethod <string>] [-CreatedDateTime <datetime>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgBetaPlaceAsRoomListRoomCheck](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/new-mgbetaplaceasroomlistroomcheck)
