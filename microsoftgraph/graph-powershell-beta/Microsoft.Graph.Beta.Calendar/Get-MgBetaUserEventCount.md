...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetausereventcount
Locale: en-US
Module Name: Microsoft.Graph.Beta.Calendar
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaUserEventCount
---
...
```
Get-MgBetaUserEventCount -UserId <string> [-Filter <string>] [-Search <string>]
...
```
Get-MgBetaUserEventCount -InputObject <ICalendarIdentity> [-Filter <string>] [-Search <string>]
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
```
...
- [Get-MgBetaUserEventCount](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetausereventcount)
