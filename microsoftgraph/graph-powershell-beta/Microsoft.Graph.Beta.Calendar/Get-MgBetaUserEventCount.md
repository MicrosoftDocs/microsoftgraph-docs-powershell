...
### Get (Default)
```
Get-MgBetaUserEventCount -UserId <String> [-Filter <String>] [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaUserEventCount -InputObject <ICalendarIdentity> [-Filter <String>]
