...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetausereventexceptionoccurrencedelta
schema: 2.0.0
...
### Delta (Default)
```
Get-MgBetaUserEventExceptionOccurrenceDelta -EventId <String> -UserId <String> -EndDateTime <String>
...
### DeltaViaIdentity
```
Get-MgBetaUserEventExceptionOccurrenceDelta -InputObject <ICalendarIdentity> -EndDateTime <String>
 -StartDateTime <String> [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetausereventexceptionoccurrencedelta](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetausereventexceptionoccurrencedelta)
