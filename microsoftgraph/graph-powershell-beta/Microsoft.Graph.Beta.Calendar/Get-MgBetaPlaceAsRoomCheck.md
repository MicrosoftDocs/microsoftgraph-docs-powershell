...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetaplaceasroomcheck
Locale: en-US
Module Name: Microsoft.Graph.Beta.Calendar
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaPlaceAsRoomCheck
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgPlaceAsRoomCheck](/powershell/module/Microsoft.Graph.Calendar/Get-MgPlaceAsRoomCheck?view=graph-powershell-1.0)
...
```
Get-MgBetaPlaceAsRoomCheck -PlaceId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaPlaceAsRoomCheck -CheckInClaimCalendarEventId <string> -PlaceId <string>
...
```
Get-MgBetaPlaceAsRoomCheck -InputObject <ICalendarIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgBetaPlaceAsRoomCheck](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetaplaceasroomcheck)
