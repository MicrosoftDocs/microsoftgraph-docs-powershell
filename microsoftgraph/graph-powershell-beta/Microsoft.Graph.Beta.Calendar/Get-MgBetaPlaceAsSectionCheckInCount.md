...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetaplaceassectioncheckincount
Locale: en-US
Module Name: Microsoft.Graph.Beta.Calendar
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaPlaceAsSectionCheckInCount
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgPlaceAsSectionCheckInCount](/powershell/module/Microsoft.Graph.Calendar/Get-MgPlaceAsSectionCheckInCount?view=graph-powershell-1.0)
...
```
Get-MgBetaPlaceAsSectionCheckInCount -PlaceId <string> [-Filter <string>] [-Search <string>]
...
```
Get-MgBetaPlaceAsSectionCheckInCount -InputObject <ICalendarIdentity> [-Filter <string>]
