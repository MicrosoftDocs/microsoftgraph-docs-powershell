...
```
Update-MgBetaPlaceAsBuildingMapLevelFixture -FixtureMapId <string> -LevelMapId <string>
...
```
Update-MgBetaPlaceAsBuildingMapLevelFixture -InputObject <ICalendarIdentity> [-PlaceId <string>]
...
```
Update-MgBetaPlaceAsBuildingMapLevelFixture -InputObject <ICalendarIdentity>
