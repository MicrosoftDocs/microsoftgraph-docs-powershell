...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/new-mgbetaplaceasroomlistcheck
Locale: en-US
Module Name: Microsoft.Graph.Beta.Calendar
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaPlaceAsRoomListCheck
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgPlaceAsRoomListCheck](/powershell/module/Microsoft.Graph.Calendar/New-MgPlaceAsRoomListCheck?view=graph-powershell-1.0)
...
```
New-MgBetaPlaceAsRoomListCheck -PlaceId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaPlaceAsRoomListCheck -PlaceId <string> -BodyParameter <IMicrosoftGraphCheckInClaim>
...
```
New-MgBetaPlaceAsRoomListCheck -InputObject <ICalendarIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-CalendarEventId <string>] [-CheckInMethod <string>]
 [-CreatedDateTime <datetime>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```
New-MgBetaPlaceAsRoomListCheck -InputObject <ICalendarIdentity>
...
- [New-MgBetaPlaceAsRoomListCheck](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/new-mgbetaplaceasroomlistcheck)
