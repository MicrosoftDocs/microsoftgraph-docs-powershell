...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/update-mgbetaplaceasdeskcheck
Locale: en-US
Module Name: Microsoft.Graph.Beta.Calendar
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaPlaceAsDeskCheck
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgPlaceAsDeskCheck](/powershell/module/Microsoft.Graph.Calendar/Update-MgPlaceAsDeskCheck?view=graph-powershell-1.0)
...
```
Update-MgBetaPlaceAsDeskCheck -CheckInClaimCalendarEventId <string> -PlaceId <string>
...
```
Update-MgBetaPlaceAsDeskCheck -InputObject <ICalendarIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaPlaceAsDeskCheck -InputObject <ICalendarIdentity>
 -BodyParameter <IMicrosoftGraphCheckInClaim> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [Update-MgBetaPlaceAsDeskCheck](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/update-mgbetaplaceasdeskcheck)
