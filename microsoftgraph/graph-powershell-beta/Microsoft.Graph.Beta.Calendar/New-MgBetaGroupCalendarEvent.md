...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/new-mgbetagroupcalendarevent
Locale: en-US
Module Name: Microsoft.Graph.Beta.Calendar
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaGroupCalendarEvent
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgGroupCalendarEvent](/powershell/module/Microsoft.Graph.Calendar/New-MgGroupCalendarEvent?view=graph-powershell-1.0)
...
```
New-MgBetaGroupCalendarEvent -GroupId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaGroupCalendarEvent -InputObject <ICalendarIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-AllowNewTimeProposals]
 [-Attachments <IMicrosoftGraphAttachment[]>] [-Attendees <IMicrosoftGraphAttendee[]>]
 [-Body <IMicrosoftGraphItemBody>] [-BodyPreview <string>] [-Calendar <IMicrosoftGraphCalendar>]
 [-CancelledOccurrences <string[]>] [-Categories <string[]>] [-ChangeKey <string>]
...
- [New-MgBetaGroupCalendarEvent](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/new-mgbetagroupcalendarevent)
