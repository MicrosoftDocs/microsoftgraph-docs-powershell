...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetaplaceasfloorcheck
Locale: en-US
Module Name: Microsoft.Graph.Beta.Calendar
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaPlaceAsFloorCheck
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgPlaceAsFloorCheck](/powershell/module/Microsoft.Graph.Calendar/Get-MgPlaceAsFloorCheck?view=graph-powershell-1.0)
...
```
Get-MgBetaPlaceAsFloorCheck -PlaceId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaPlaceAsFloorCheck -CheckInClaimCalendarEventId <string> -PlaceId <string>
...
```
Get-MgBetaPlaceAsFloorCheck -InputObject <ICalendarIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgBetaPlaceAsFloorCheck](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetaplaceasfloorcheck)
