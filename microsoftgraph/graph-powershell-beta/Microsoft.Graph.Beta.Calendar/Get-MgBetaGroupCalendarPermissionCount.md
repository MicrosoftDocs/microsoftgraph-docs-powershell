...
### Get (Default)
```
Get-MgBetaGroupCalendarPermissionCount -GroupId <String> [-Filter <String>] [-ResponseHeadersVariable <String>]
...
## RELATED LINKS
[Get-MgGroupCalendarPermissionCount](/powershell/module/Microsoft.Graph.Calendar/Get-MgGroupCalendarPermissionCount?view=graph-powershell-1.0)
