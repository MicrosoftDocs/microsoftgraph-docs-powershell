...
```
Get-MgBetaPlaceAsBuildingMapLevelFixture -LevelMapId <string> -PlaceId <string>
...
```
Get-MgBetaPlaceAsBuildingMapLevelFixture -FixtureMapId <string> -LevelMapId <string>
 -PlaceId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaPlaceAsBuildingMapLevelFixture -InputObject <ICalendarIdentity>
