...
```
Get-MgBetaUserCalendarPermission -UserId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaUserCalendarPermission -CalendarPermissionId <string> -UserId <string>
 -CalendarId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
