...
```
New-MgBetaPlaceAsSectionCheck -PlaceId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaPlaceAsSectionCheck -PlaceId <string> -BodyParameter <IMicrosoftGraphCheckInClaim>
...
```
New-MgBetaPlaceAsSectionCheck -InputObject <ICalendarIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-CalendarEventId <string>] [-CheckInMethod <string>]
 [-CreatedDateTime <datetime>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```
New-MgBetaPlaceAsSectionCheck -InputObject <ICalendarIdentity>
...
- [New-MgBetaPlaceAsSectionCheck](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/new-mgbetaplaceassectioncheck)
