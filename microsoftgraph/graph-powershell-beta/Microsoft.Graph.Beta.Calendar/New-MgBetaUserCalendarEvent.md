...
```
New-MgBetaUserCalendarEvent -CalendarId <string> -UserId <string>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-AllowNewTimeProposals]
...
```
New-MgBetaUserCalendarEvent -InputObject <ICalendarIdentity> [-ResponseHeadersVariable <string>]
