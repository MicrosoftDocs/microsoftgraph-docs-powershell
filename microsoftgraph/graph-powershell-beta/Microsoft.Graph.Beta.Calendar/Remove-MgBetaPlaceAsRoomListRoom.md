...
### Delete (Default)
```
Remove-MgBetaPlaceAsRoomListRoom -PlaceId <String> -RoomId <String> [-IfMatch <String>] [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaPlaceAsRoomListRoom -InputObject <ICalendarIdentity> [-IfMatch <String>] [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
