...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/new-mgbetagroupeventattachment
Locale: en-US
Module Name: Microsoft.Graph.Beta.Calendar
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaGroupEventAttachment
---
...
```
New-MgBetaGroupEventAttachment -EventId <string> -GroupId <string>
...
```
New-MgBetaGroupEventAttachment -InputObject <ICalendarIdentity>
 -BodyParameter <IMicrosoftGraphAttachment> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgBetaGroupEventAttachment](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/new-mgbetagroupeventattachment)
