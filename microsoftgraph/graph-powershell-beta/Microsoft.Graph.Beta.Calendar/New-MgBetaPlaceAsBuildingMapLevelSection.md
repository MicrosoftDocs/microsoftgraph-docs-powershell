...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/new-mgbetaplaceasbuildingmaplevelsection
Locale: en-US
Module Name: Microsoft.Graph.Beta.Calendar
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaPlaceAsBuildingMapLevelSection
---
...
```
New-MgBetaPlaceAsBuildingMapLevelSection -LevelMapId <string> -PlaceId <string>
...
```
New-MgBetaPlaceAsBuildingMapLevelSection -InputObject <ICalendarIdentity> [-PlaceId <string>]
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-Id <string>]
...
```
New-MgBetaPlaceAsBuildingMapLevelSection -InputObject <ICalendarIdentity>
 -BodyParameter <IMicrosoftGraphSectionMap> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgBetaPlaceAsBuildingMapLevelSection](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/new-mgbetaplaceasbuildingmaplevelsection)
