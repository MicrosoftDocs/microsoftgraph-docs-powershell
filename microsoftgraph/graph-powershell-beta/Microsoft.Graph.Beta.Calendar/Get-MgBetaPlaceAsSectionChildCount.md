...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetaplaceassectionchildcount
Locale: en-US
Module Name: Microsoft.Graph.Beta.Calendar
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaPlaceAsSectionChildCount
---
...
```
Get-MgBetaPlaceAsSectionChildCount -PlaceId <string> [-Filter <string>] [-Search <string>]
...
```
Get-MgBetaPlaceAsSectionChildCount -InputObject <ICalendarIdentity> [-Filter <string>]
...
- [Get-MgBetaPlaceAsSectionChildCount](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetaplaceassectionchildcount)
