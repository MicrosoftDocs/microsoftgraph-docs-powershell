...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetaplaceasdeskchildcount
Locale: en-US
Module Name: Microsoft.Graph.Beta.Calendar
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaPlaceAsDeskChildCount
---
...
```
Get-MgBetaPlaceAsDeskChildCount -PlaceId <string> [-Filter <string>] [-Search <string>]
...
```
Get-MgBetaPlaceAsDeskChildCount -InputObject <ICalendarIdentity> [-Filter <string>]
...
- [Get-MgBetaPlaceAsDeskChildCount](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetaplaceasdeskchildcount)
