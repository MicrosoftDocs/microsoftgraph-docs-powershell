...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/new-mgbetaplaceasfloorcheck
Locale: en-US
Module Name: Microsoft.Graph.Beta.Calendar
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaPlaceAsFloorCheck
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgPlaceAsFloorCheck](/powershell/module/Microsoft.Graph.Calendar/New-MgPlaceAsFloorCheck?view=graph-powershell-1.0)
...
```
New-MgBetaPlaceAsFloorCheck -PlaceId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaPlaceAsFloorCheck -PlaceId <string> -BodyParameter <IMicrosoftGraphCheckInClaim>
...
```
New-MgBetaPlaceAsFloorCheck -InputObject <ICalendarIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-CalendarEventId <string>] [-CheckInMethod <string>]
 [-CreatedDateTime <datetime>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```
New-MgBetaPlaceAsFloorCheck -InputObject <ICalendarIdentity>
...
- [New-MgBetaPlaceAsFloorCheck](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/new-mgbetaplaceasfloorcheck)
