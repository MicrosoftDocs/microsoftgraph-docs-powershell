...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetaplaceasfloorchildcount
Locale: en-US
Module Name: Microsoft.Graph.Beta.Calendar
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaPlaceAsFloorChildCount
---
...
```
Get-MgBetaPlaceAsFloorChildCount -PlaceId <string> [-Filter <string>] [-Search <string>]
...
```
Get-MgBetaPlaceAsFloorChildCount -InputObject <ICalendarIdentity> [-Filter <string>]
...
- [Get-MgBetaPlaceAsFloorChildCount](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetaplaceasfloorchildcount)
