...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/remove-mgbetagroupevent
Locale: en-US
Module Name: Microsoft.Graph.Beta.Calendar
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Remove-MgBetaGroupEvent
---
...
```
Remove-MgBetaGroupEvent -EventId <string> -GroupId <string> [-IfMatch <string>]
...
```
Remove-MgBetaGroupEvent -InputObject <ICalendarIdentity> [-IfMatch <string>]
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru]
 [-Proxy <uri>] [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
 [<CommonParameters>]
