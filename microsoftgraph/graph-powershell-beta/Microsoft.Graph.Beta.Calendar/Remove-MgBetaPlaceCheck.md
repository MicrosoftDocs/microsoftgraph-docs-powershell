...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/remove-mgbetaplacecheck
Locale: en-US
Module Name: Microsoft.Graph.Beta.Calendar
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Remove-MgBetaPlaceCheck
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Remove-MgPlaceCheck](/powershell/module/Microsoft.Graph.Calendar/Remove-MgPlaceCheck?view=graph-powershell-1.0)
...
```
Remove-MgBetaPlaceCheck -CheckInClaimCalendarEventId <string> -PlaceId <string> [-IfMatch <string>]
...
```
Remove-MgBetaPlaceCheck -InputObject <ICalendarIdentity> [-IfMatch <string>]
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru]
 [-Proxy <uri>] [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
