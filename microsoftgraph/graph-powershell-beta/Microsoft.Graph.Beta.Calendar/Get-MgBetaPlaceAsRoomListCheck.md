...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetaplaceasroomlistcheck
Locale: en-US
Module Name: Microsoft.Graph.Beta.Calendar
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaPlaceAsRoomListCheck
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgPlaceAsRoomListCheck](/powershell/module/Microsoft.Graph.Calendar/Get-MgPlaceAsRoomListCheck?view=graph-powershell-1.0)
...
```
Get-MgBetaPlaceAsRoomListCheck -PlaceId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaPlaceAsRoomListCheck -CheckInClaimCalendarEventId <string> -PlaceId <string>
...
```
Get-MgBetaPlaceAsRoomListCheck -InputObject <ICalendarIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgBetaPlaceAsRoomListCheck](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetaplaceasroomlistcheck)
