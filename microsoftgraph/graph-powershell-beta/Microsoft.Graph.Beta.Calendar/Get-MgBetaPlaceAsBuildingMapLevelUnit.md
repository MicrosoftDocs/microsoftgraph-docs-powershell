...
```
Get-MgBetaPlaceAsBuildingMapLevelUnit -LevelMapId <string> -PlaceId <string>
...
```
Get-MgBetaPlaceAsBuildingMapLevelUnit -LevelMapId <string> -PlaceId <string> -UnitMapId <string>
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphUnitMap
