...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetaplaceassectionchild
Locale: en-US
Module Name: Microsoft.Graph.Beta.Calendar
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaPlaceAsSectionChild
---
...
```
Get-MgBetaPlaceAsSectionChild -PlaceId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaPlaceAsSectionChild -PlaceId <string> -PlaceId1 <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaPlaceAsSectionChild -InputObject <ICalendarIdentity> [-ExpandProperty <string[]>]
 [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
```
