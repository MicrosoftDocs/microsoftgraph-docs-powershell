...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetaplaceasroomlistchildcount
Locale: en-US
Module Name: Microsoft.Graph.Beta.Calendar
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaPlaceAsRoomListChildCount
---
...
```
Get-MgBetaPlaceAsRoomListChildCount -PlaceId <string> [-Filter <string>] [-Search <string>]
...
```
Get-MgBetaPlaceAsRoomListChildCount -InputObject <ICalendarIdentity> [-Filter <string>]
...
- [Get-MgBetaPlaceAsRoomListChildCount](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetaplaceasroomlistchildcount)
