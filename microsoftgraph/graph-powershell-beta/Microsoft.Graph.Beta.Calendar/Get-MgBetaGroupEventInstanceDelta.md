...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetagroupeventinstancedelta
schema: 2.0.0
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgGroupEventInstanceDelta](/powershell/module/Microsoft.Graph.Calendar/Get-MgGroupEventInstanceDelta?view=graph-powershell-1.0)

## SYNTAX

### Delta (Default)
```
Get-MgBetaGroupEventInstanceDelta -EventId <String> -GroupId <String> -EndDateTime <String>
...
### DeltaViaIdentity
```
Get-MgBetaGroupEventInstanceDelta -InputObject <ICalendarIdentity> -EndDateTime <String>
 -StartDateTime <String> [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetagroupeventinstancedelta](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetagroupeventinstancedelta)
