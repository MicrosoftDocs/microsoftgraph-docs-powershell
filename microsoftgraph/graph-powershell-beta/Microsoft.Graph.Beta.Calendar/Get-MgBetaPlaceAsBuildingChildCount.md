...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetaplaceasbuildingchildcount
Locale: en-US
Module Name: Microsoft.Graph.Beta.Calendar
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaPlaceAsBuildingChildCount
---
...
```
Get-MgBetaPlaceAsBuildingChildCount -PlaceId <string> [-Filter <string>] [-Search <string>]
...
```
Get-MgBetaPlaceAsBuildingChildCount -InputObject <ICalendarIdentity> [-Filter <string>]
...
- [Get-MgBetaPlaceAsBuildingChildCount](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetaplaceasbuildingchildcount)
