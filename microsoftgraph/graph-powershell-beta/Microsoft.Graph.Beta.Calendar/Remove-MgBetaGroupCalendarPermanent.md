...
```
Remove-MgBetaGroupCalendarPermanent -GroupId <string> [-ResponseHeadersVariable <string>] [-Break]
...
```
Remove-MgBetaGroupCalendarPermanent -InputObject <ICalendarIdentity>
