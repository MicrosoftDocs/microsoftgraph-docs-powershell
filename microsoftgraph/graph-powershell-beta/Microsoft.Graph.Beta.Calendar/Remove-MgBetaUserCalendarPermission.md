...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/remove-mgbetausercalendarpermission
Locale: en-US
Module Name: Microsoft.Graph.Beta.Calendar
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: Remove-MgBetaUserCalendarPermission
---
...
```
Remove-MgBetaUserCalendarPermission -CalendarPermissionId <string> -UserId <string>
...
```
Remove-MgBetaUserCalendarPermission -CalendarPermissionId <string> -UserId <string>
 -CalendarId <string> [-IfMatch <string>] [-ResponseHeadersVariable <string>] [-Break]
