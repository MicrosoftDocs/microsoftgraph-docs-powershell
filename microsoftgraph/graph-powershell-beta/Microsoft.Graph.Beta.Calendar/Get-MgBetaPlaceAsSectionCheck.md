...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetaplaceassectioncheck
Locale: en-US
Module Name: Microsoft.Graph.Beta.Calendar
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaPlaceAsSectionCheck
---
...
```
Get-MgBetaPlaceAsSectionCheck -PlaceId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaPlaceAsSectionCheck -CheckInClaimCalendarEventId <string> -PlaceId <string>
...
```
Get-MgBetaPlaceAsSectionCheck -InputObject <ICalendarIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgBetaPlaceAsSectionCheck](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetaplaceassectioncheck)
