...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/new-mgbetaplaceasbuildingcheck
Locale: en-US
Module Name: Microsoft.Graph.Beta.Calendar
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaPlaceAsBuildingCheck
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgPlaceAsBuildingCheck](/powershell/module/Microsoft.Graph.Calendar/New-MgPlaceAsBuildingCheck?view=graph-powershell-1.0)
...
```
New-MgBetaPlaceAsBuildingCheck -PlaceId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaPlaceAsBuildingCheck -PlaceId <string> -BodyParameter <IMicrosoftGraphCheckInClaim>
...
```
New-MgBetaPlaceAsBuildingCheck -InputObject <ICalendarIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-CalendarEventId <string>] [-CheckInMethod <string>]
 [-CreatedDateTime <datetime>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```
New-MgBetaPlaceAsBuildingCheck -InputObject <ICalendarIdentity>
...
- [New-MgBetaPlaceAsBuildingCheck](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/new-mgbetaplaceasbuildingcheck)
