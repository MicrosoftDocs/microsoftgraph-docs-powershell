...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetausereventexceptionoccurrenceinstancedelta
schema: 2.0.0
...
### Delta (Default)
```
Get-MgBetaUserEventExceptionOccurrenceInstanceDelta -EventId <String> -EventId1 <String> -UserId <String>
...
### DeltaViaIdentity
```
Get-MgBetaUserEventExceptionOccurrenceInstanceDelta -InputObject <ICalendarIdentity> -EndDateTime <String>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetausereventexceptionoccurrenceinstancedelta](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetausereventexceptionoccurrenceinstancedelta)
