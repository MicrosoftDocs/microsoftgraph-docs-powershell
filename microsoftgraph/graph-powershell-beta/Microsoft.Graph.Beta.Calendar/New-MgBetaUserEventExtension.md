...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/new-mgbetausereventextension
Locale: en-US
Module Name: Microsoft.Graph.Beta.Calendar
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaUserEventExtension
---
...
```
New-MgBetaUserEventExtension -EventId <string> -UserId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaUserEventExtension -EventId <string> -UserId <string> -BodyParameter <hashtable>
...
```
New-MgBetaUserEventExtension -InputObject <ICalendarIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Id <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
```
New-MgBetaUserEventExtension -InputObject <ICalendarIdentity> -BodyParameter <hashtable>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
- [New-MgBetaUserEventExtension](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/new-mgbetausereventextension)
