...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetaplaceasworkspacecheck
Locale: en-US
Module Name: Microsoft.Graph.Beta.Calendar
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaPlaceAsWorkspaceCheck
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgPlaceAsWorkspaceCheck](/powershell/module/Microsoft.Graph.Calendar/Get-MgPlaceAsWorkspaceCheck?view=graph-powershell-1.0)
...
```
Get-MgBetaPlaceAsWorkspaceCheck -PlaceId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaPlaceAsWorkspaceCheck -CheckInClaimCalendarEventId <string> -PlaceId <string>
...
```
Get-MgBetaPlaceAsWorkspaceCheck -InputObject <ICalendarIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgBetaPlaceAsWorkspaceCheck](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetaplaceasworkspacecheck)
