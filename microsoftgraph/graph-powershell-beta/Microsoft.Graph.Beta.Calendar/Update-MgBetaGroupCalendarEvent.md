...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/update-mgbetagroupcalendarevent
Locale: en-US
Module Name: Microsoft.Graph.Beta.Calendar
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaGroupCalendarEvent
---
...
```
Update-MgBetaGroupCalendarEvent -EventId <string> -GroupId <string>
...
```
Update-MgBetaGroupCalendarEvent -InputObject <ICalendarIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaGroupCalendarEvent -InputObject <ICalendarIdentity>
 -BodyParameter <IMicrosoftGraphEvent> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [Update-MgBetaGroupCalendarEvent](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/update-mgbetagroupcalendarevent)
