...
```
Get-MgBetaUserEventDelta -InputObject <ICalendarIdentity> -EndDateTime <string>
...
- [Get-MgBetaUserEventDelta](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/get-mgbetausereventdelta)
