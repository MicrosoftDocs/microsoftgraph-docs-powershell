...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/new-mgbetausercalendargroup
Locale: en-US
Module Name: Microsoft.Graph.Beta.Calendar
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaUserCalendarGroup
---
...
```
New-MgBetaUserCalendarGroup -UserId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaUserCalendarGroup -InputObject <ICalendarIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Calendars <IMicrosoftGraphCalendar[]>] [-ChangeKey <string>]
 [-ClassId <string>] [-Id <string>] [-Name <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```
New-MgBetaUserCalendarGroup -InputObject <ICalendarIdentity>
...
- [New-MgBetaUserCalendarGroup](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.calendar/new-mgbetausercalendargroup)
