...
```
New-MgBetaPlaceAsRoomListWorkspace -InputObject <ICalendarIdentity>
...
An alternate immutable unique identifier of the workspace.
Read-only.
...
For example, 1 for first floor, 2 for second floor, and so on.
  ...
  [PlaceId <String>]: An alternate immutable unique identifier of the workspace.
Read-only.
