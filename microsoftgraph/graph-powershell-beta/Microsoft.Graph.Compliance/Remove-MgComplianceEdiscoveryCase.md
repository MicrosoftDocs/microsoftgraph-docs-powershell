...
### Delete (Default)
```
Remove-MgBetaComplianceEdiscoveryCase -CaseId <String> [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaComplianceEdiscoveryCase -InputObject <IComplianceIdentity> [-IfMatch <String>] [-PassThru]
