...
### List (Default)
```
Get-MgComplianceEdiscoveryCaseLegalHold -CaseId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.compliance/get-mgcomplianceediscoverycaselegalhold](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.compliance/get-mgcomplianceediscoverycaselegalhold)
