...
Set-MgComplianceEdiscoveryCaseCustodianUnifiedGroupSourceGroupByRef -CaseId <String> -CustodianId <String>
 -UnifiedGroupSourceId <String> [-AdditionalProperties <Hashtable>] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```
Set-MgComplianceEdiscoveryCaseCustodianUnifiedGroupSourceGroupByRef -CaseId <String> -CustodianId <String>
 -UnifiedGroupSourceId <String> -BodyParameter <Hashtable> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
