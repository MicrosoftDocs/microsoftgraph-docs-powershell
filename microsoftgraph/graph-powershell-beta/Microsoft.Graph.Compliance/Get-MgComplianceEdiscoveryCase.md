...
### List (Default)
```
Get-MgComplianceEdiscoveryCase [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.compliance/get-mgcomplianceediscoverycase](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.compliance/get-mgcomplianceediscoverycase)
