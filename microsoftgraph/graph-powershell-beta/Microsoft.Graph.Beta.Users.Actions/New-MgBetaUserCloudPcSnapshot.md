...
### Create (Default)
```
New-MgBetaUserCloudPcSnapshot -CloudPcId <String> -UserId <String> [-ResponseHeadersVariable <String>]
...
### CreateViaIdentity
```
New-MgBetaUserCloudPcSnapshot -InputObject <IUsersActionsIdentity> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
