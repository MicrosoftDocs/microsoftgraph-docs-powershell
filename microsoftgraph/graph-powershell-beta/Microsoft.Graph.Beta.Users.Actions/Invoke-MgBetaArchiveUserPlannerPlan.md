...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users.actions/invoke-mgbetaarchiveuserplannerplan
schema: 2.0.0
...
```
Invoke-MgBetaArchiveUserPlannerPlan -InputObject <IUsersActionsIdentity> [-ResponseHeadersVariable <String>]
...
### ArchiveViaIdentity
```
Invoke-MgBetaArchiveUserPlannerPlan -InputObject <IUsersActionsIdentity>
 -BodyParameter <IPaths1877BnnUsersUserIdPlannerPlansPlannerplanIdMicrosoftGraphArchivePostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```yaml
Type: IPaths1877BnnUsersUserIdPlannerPlansPlannerplanIdMicrosoftGraphArchivePostRequestbodyContentApplicationJsonSchema
