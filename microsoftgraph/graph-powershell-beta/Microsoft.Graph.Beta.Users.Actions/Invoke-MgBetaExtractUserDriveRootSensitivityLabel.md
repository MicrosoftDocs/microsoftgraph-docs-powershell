...
### Extract (Default)
```
Invoke-MgBetaExtractUserDriveRootSensitivityLabel -DriveId <String> -UserId <String> [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### ExtractViaIdentity
```
Invoke-MgBetaExtractUserDriveRootSensitivityLabel -InputObject <IUsersActionsIdentity> [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
