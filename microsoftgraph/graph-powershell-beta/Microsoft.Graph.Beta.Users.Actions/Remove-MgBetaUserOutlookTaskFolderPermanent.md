...
### Delete (Default)
```
Remove-MgBetaUserOutlookTaskFolderPermanent -OutlookTaskFolderId <String> -UserId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaUserOutlookTaskFolderPermanent -InputObject <IUsersActionsIdentity>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
