...
### PowerOff (Default)
```
Stop-MgBetaUserCloudPc -CloudPcId <String> -UserId <String> [-Headers <IDictionary>] [-PassThru]
...
### StopViaIdentity
```
Stop-MgBetaUserCloudPc -InputObject <IUsersActionsIdentity> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
