...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users.actions/remove-mgbetauserdriverootcheckout
schema: 2.0.0
...
### Discard (Default)
```
Remove-MgBetaUserDriveRootCheckout -DriveId <String> -UserId <String> [-ResponseHeadersVariable <String>]
...
### DiscardViaIdentity
```
Remove-MgBetaUserDriveRootCheckout -InputObject <IUsersActionsIdentity> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users.actions/remove-mgbetauserdriverootcheckout](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users.actions/remove-mgbetauserdriverootcheckout)
