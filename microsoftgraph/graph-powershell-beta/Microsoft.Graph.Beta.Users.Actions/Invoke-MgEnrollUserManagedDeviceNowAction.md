...
### Enroll (Default)
```
Invoke-MgEnrollUserManagedDeviceNowAction -ManagedDeviceId <String> -UserId <String> [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### EnrollViaIdentity
```
Invoke-MgEnrollUserManagedDeviceNowAction -InputObject <IUsersActionsIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
