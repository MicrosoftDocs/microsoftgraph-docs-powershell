...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users.actions/remove-mgbetauseroutlooktaskpermanent
schema: 2.0.0
...
### Delete (Default)
```
Remove-MgBetaUserOutlookTaskPermanent -OutlookTaskId <String> -UserId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaUserOutlookTaskPermanent -InputObject <IUsersActionsIdentity> [-ResponseHeadersVariable <String>]
