...
### PowerOn (Default)
```
Start-MgBetaUserCloudPc -CloudPcId <String> -UserId <String> [-ResponseHeadersVariable <String>]
...
### StartViaIdentity
```
Start-MgBetaUserCloudPc -InputObject <IUsersActionsIdentity> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
