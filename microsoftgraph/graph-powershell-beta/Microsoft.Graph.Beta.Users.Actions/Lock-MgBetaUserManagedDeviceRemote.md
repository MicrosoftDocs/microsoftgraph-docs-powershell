...
### Lock (Default)
```
Lock-MgBetaUserManagedDeviceRemote -ManagedDeviceId <String> -UserId <String> [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### LockViaIdentity
```
Lock-MgBetaUserManagedDeviceRemote -InputObject <IUsersActionsIdentity> [-Headers <IDictionary>] [-PassThru]
