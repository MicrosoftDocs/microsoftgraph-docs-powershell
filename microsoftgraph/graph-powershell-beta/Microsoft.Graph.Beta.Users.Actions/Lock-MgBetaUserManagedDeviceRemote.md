...
### Lock (Default)
```
Lock-MgBetaUserManagedDeviceRemote -ManagedDeviceId <String> -UserId <String>
...
### LockViaIdentity
```
Lock-MgBetaUserManagedDeviceRemote -InputObject <IUsersActionsIdentity> [-ResponseHeadersVariable <String>]
