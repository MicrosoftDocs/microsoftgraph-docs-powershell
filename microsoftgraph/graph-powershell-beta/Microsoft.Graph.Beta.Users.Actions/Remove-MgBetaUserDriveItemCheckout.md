...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users.actions/remove-mgbetauserdriveitemcheckout
schema: 2.0.0
...
### DiscardViaIdentity
```
Remove-MgBetaUserDriveItemCheckout -InputObject <IUsersActionsIdentity> [-ResponseHeadersVariable <String>]
