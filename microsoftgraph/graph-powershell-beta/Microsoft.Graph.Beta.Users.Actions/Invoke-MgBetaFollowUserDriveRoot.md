...
### Follow (Default)
```
Invoke-MgBetaFollowUserDriveRoot -DriveId <String> -UserId <String> [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### FollowViaIdentity
```
Invoke-MgBetaFollowUserDriveRoot -InputObject <IUsersActionsIdentity> [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
