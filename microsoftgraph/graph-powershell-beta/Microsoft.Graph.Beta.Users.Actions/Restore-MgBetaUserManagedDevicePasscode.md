...
### Recover (Default)
```
Restore-MgBetaUserManagedDevicePasscode -ManagedDeviceId <String> -UserId <String> [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### RecoverViaIdentity
```
Restore-MgBetaUserManagedDevicePasscode -InputObject <IUsersActionsIdentity> [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
