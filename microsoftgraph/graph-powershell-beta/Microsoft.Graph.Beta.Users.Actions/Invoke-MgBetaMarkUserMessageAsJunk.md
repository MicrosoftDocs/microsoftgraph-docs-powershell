...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Invoke-MgMarkUserMessageAsJunk](/powershell/module/Microsoft.Graph.Users.Actions/Invoke-MgMarkUserMessageAsJunk?view=graph-powershell-v1.0)
...
Invoke-MgBetaMarkUserMessageAsJunk -MessageId <String> -UserId <String> [-AdditionalProperties <Hashtable>]
 [-MoveToJunk] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```yaml
Type: IPaths1808Jk7UsersUserIdMessagesMessageIdMicrosoftGraphMarkasjunkPostRequestbodyContentApplicationJsonSchema
