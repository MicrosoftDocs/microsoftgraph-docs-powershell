...
### Complete (Default)
```
Complete-MgBetaUserOutlookTask -OutlookTaskId <String> -UserId <String> [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### CompleteViaIdentity
```
Complete-MgBetaUserOutlookTask -InputObject <IUsersActionsIdentity> [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
