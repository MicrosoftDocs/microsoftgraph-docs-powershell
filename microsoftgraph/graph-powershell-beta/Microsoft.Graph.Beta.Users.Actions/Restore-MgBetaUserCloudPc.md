...
```
Restore-MgBetaUserCloudPc -CloudPcId <String> -UserId <String> [-ResponseHeadersVariable <String>]
...
```
Restore-MgBetaUserCloudPc -InputObject <IUsersActionsIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-CloudPcSnapshotId <String>] [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/graph/api/cloudpc-restore?view=graph-rest-beta](https://learn.microsoft.com/graph/api/cloudpc-restore?view=graph-rest-beta)
