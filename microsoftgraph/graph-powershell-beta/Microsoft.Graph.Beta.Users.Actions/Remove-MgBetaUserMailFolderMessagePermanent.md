...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users.actions/remove-mgbetausermailfoldermessagepermanent
schema: 2.0.0
...
### Delete (Default)
```
Remove-MgBetaUserMailFolderMessagePermanent -MailFolderId <String> -MessageId <String> -UserId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaUserMailFolderMessagePermanent -InputObject <IUsersActionsIdentity>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users.actions/remove-mgbetausermailfoldermessagepermanent](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users.actions/remove-mgbetausermailfoldermessagepermanent)
