...
### Delete (Default)
```
Remove-MgBetaUserOutlookTaskFolderTaskPermanent -OutlookTaskFolderId <String> -OutlookTaskId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaUserOutlookTaskFolderTaskPermanent -InputObject <IUsersActionsIdentity>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users.actions/remove-mgbetauseroutlooktaskfoldertaskpermanent](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users.actions/remove-mgbetauseroutlooktaskfoldertaskpermanent)
