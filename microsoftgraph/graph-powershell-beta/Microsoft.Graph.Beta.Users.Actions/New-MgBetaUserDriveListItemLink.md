...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgUserDriveListItemLink](/powershell/module/Microsoft.Graph.Users.Actions/New-MgUserDriveListItemLink?view=graph-powershell-1.0)
...
```
New-MgBetaUserDriveListItemLink -InputObject <IUsersActionsIdentity> [-ResponseHeadersVariable <String>]
