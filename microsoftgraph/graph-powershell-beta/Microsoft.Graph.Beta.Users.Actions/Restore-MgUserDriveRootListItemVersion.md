...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.actions/restore-mguserdriverootlistitemversion
schema: 2.0.0
---
...
### Restore1 (Default)
```
Restore-MgUserDriveRootListItemVersion -DriveId <String> -ListItemVersionId <String> -UserId <String>
 [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### RestoreViaIdentity1
```
Restore-MgUserDriveRootListItemVersion -InputObject <IUsersActionsIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
