...
### Rotate (Default)
```
Invoke-MgBetaRotateUserManagedDeviceFileVaultKey -ManagedDeviceId <String> -UserId <String> [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### RotateViaIdentity
```
Invoke-MgBetaRotateUserManagedDeviceFileVaultKey -InputObject <IUsersActionsIdentity> [-PassThru] [-WhatIf]
