...
```
Invoke-MgTroubleshootUserCloudPc -CloudPcId <String> -UserId <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### TroubleshootViaIdentity
```
Invoke-MgTroubleshootUserCloudPc -InputObject <IUsersActionsIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
