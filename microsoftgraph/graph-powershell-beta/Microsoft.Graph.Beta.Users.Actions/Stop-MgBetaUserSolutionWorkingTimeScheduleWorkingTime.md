...
### End (Default)
```
Stop-MgBetaUserSolutionWorkingTimeScheduleWorkingTime -UserId <String> [-ResponseHeadersVariable <String>]
...
### EndViaIdentity
```
Stop-MgBetaUserSolutionWorkingTimeScheduleWorkingTime -InputObject <IUsersActionsIdentity>
