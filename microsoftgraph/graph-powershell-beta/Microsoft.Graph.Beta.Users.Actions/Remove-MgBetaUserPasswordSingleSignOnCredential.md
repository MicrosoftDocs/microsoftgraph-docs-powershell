...
```
Remove-MgBetaUserPasswordSingleSignOnCredential -UserId <String> [-AdditionalProperties <Hashtable>]
 [-Id <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
