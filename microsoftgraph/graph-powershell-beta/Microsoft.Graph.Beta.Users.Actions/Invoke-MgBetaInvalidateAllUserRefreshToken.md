...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users.actions/invoke-mgbetainvalidatealluserrefreshtoken
Locale: en-US
Module Name: Microsoft.Graph.Beta.Users.Actions
ms.date: 06/17/2026
PlatyPS schema version: 2024-05-01
title: Invoke-MgBetaInvalidateAllUserRefreshToken
---
...
| --------------- | ------------------------------------------  |
| Delegated (work or school account) | Directory.ReadWrite.All, User.ReadWrite, User.RevokeSessions.All,  |
...
- [Invoke-MgBetaInvalidateAllUserRefreshToken](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users.actions/invoke-mgbetainvalidatealluserrefreshtoken)
- [Graph API Reference](https://learn.microsoft.com/graph/api/user-invalidateallrefreshtokens?view=graph-rest-beta)
