...
### Reboot (Default)
```
Restart-MgBetaUserManagedDeviceNow -ManagedDeviceId <String> -UserId <String> [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### RebootViaIdentity
```
Restart-MgBetaUserManagedDeviceNow -InputObject <IUsersActionsIdentity> [-Headers <IDictionary>] [-PassThru]
