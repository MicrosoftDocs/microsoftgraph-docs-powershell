...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users.actions/remove-mgbetausercontactfoldercontactpermanent
schema: 2.0.0
...
### Delete (Default)
```
Remove-MgBetaUserContactFolderContactPermanent -ContactFolderId <String> -ContactId <String> -UserId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaUserContactFolderContactPermanent -InputObject <IUsersActionsIdentity>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users.actions/remove-mgbetausercontactfoldercontactpermanent](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users.actions/remove-mgbetausercontactfoldercontactpermanent)
