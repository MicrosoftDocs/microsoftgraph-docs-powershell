...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users.actions/remove-mgbetausercontactpermanent
schema: 2.0.0
...
### Delete (Default)
```
Remove-MgBetaUserContactPermanent -ContactId <String> -UserId <String> [-ResponseHeadersVariable <String>]
...
### DeleteViaIdentity
```
Remove-MgBetaUserContactPermanent -InputObject <IUsersActionsIdentity> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
