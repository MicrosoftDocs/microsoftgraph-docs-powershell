...
### Wipe (Default)
```
Clear-MgUserAndBlockManagedApp -UserId <String> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### WipeViaIdentity
```
Clear-MgUserAndBlockManagedApp -InputObject <IUsersActionsIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
