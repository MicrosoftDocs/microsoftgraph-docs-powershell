...
### Soft (Default)
```
Invoke-MgBetaSoftUserChatMessageDelete -ChatId <String> -ChatMessageId <String> -UserId <String>
...
### SoftViaIdentity
```
Invoke-MgBetaSoftUserChatMessageDelete -InputObject <IUsersActionsIdentity> [-ResponseHeadersVariable <String>]
