...
```
Move-MgBetaUserPlannerPlanToContainer -InputObject <IUsersActionsIdentity> [-ResponseHeadersVariable <String>]
...
```yaml
Type: IPathsTla1L2UsersUserIdPlannerPlansPlannerplanIdMicrosoftGraphMovetocontainerPostRequestbodyContentApplicationJsonSchema
