...
### Get (Default)
```
Get-MgBetaUserPasswordSingleSignOnCredential -UserId <String> [-WhatIf] [-Confirm] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaUserPasswordSingleSignOnCredential -InputObject <IUsersActionsIdentity> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
