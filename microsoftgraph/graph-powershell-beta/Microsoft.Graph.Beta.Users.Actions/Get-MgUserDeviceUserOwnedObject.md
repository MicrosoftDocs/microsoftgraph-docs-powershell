...
```
Get-MgUserDeviceUserOwnedObject [-UserId <String>] -InputObject <IUsersActionsIdentity>
...
```yaml
Type: IPaths2DbnpzUsersUserIdDevicesMicrosoftGraphGetuserownedobjectsPostRequestbodyContentApplicationJsonSchema
