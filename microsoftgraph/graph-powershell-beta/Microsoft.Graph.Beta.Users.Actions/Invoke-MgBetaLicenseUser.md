...
### License (Default)
```
Invoke-MgBetaLicenseUser -UserId <String> [-Headers <IDictionary>] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### LicenseViaIdentity
```
Invoke-MgBetaLicenseUser -InputObject <IUsersActionsIdentity> [-Headers <IDictionary>]
