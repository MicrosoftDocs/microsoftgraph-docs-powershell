...
### Bypass (Default)
```
Skip-MgBetaUserManagedDeviceActivationLock -ManagedDeviceId <String> -UserId <String>
...
### BypassViaIdentity
```
Skip-MgBetaUserManagedDeviceActivationLock -InputObject <IUsersActionsIdentity>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
