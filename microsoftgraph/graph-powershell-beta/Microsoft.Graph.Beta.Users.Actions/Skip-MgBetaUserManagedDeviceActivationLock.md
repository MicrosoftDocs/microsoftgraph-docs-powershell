...
### Bypass (Default)
```
Skip-MgBetaUserManagedDeviceActivationLock -ManagedDeviceId <String> -UserId <String> [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### BypassViaIdentity
```
Skip-MgBetaUserManagedDeviceActivationLock -InputObject <IUsersActionsIdentity> [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
