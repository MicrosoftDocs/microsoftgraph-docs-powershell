...
### Reset (Default)
```
Reset-MgBetaUserManagedDevicePasscode -ManagedDeviceId <String> -UserId <String>
...
### ResetViaIdentity
```
Reset-MgBetaUserManagedDevicePasscode -InputObject <IUsersActionsIdentity> [-ResponseHeadersVariable <String>]
