...
### Complete (Default)
```
Complete-MgUserOutlookTask -OutlookTaskId <String> -UserId <String> [-WhatIf] [-Confirm] [<CommonParameters>]
```

### CompleteViaIdentity
```
Complete-MgUserOutlookTask -InputObject <IUsersActionsIdentity> [-WhatIf] [-Confirm] [<CommonParameters>]
```
