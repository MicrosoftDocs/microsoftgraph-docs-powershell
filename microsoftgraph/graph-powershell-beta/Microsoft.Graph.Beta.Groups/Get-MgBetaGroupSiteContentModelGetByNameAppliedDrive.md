...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/get-mgbetagroupsitecontentmodelgetbynameapplieddrive
Locale: en-US
Module Name: Microsoft.Graph.Beta.Groups
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Get-MgBetaGroupSiteContentModelGetByNameAppliedDrive
---
...
```
Get-MgBetaGroupSiteContentModelGetByNameAppliedDrive -GroupId <string> -ModelName <string>
 -SiteId <string> [-Count] [-Filter <string>] [-Search <string>] [-Skip <int>] [-Top <int>]
...
```
Get-MgBetaGroupSiteContentModelGetByNameAppliedDrive -InputObject <IGroupsIdentity> [-Count]
