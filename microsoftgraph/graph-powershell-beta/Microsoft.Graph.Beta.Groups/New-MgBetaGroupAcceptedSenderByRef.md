...
```
New-MgBetaGroupAcceptedSenderByRef -GroupId <String> [-ResponseHeadersVariable <String>] -OdataId <String>
...
```
New-MgBetaGroupAcceptedSenderByRef -InputObject <IGroupsIdentity> [-ResponseHeadersVariable <String>]
