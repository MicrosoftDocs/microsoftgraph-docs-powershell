...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/grant-mgbetagroupsdrivesitemspermission
schema: 2.0.0
---
...
```
Grant-MgBetaGroupsDrivesItemsPermission -DriveId <String> -DriveItemId <String> -GroupId <String>
...
```
Grant-MgBetaGroupsDrivesItemsPermission -InputObject <IGroupsIdentity> [-AdditionalProperties <Hashtable>]
 [-Recipients <IMicrosoftGraphDriveRecipient[]>] [-Roles <String[]>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### GrantViaIdentity
```
Grant-MgBetaGroupsDrivesItemsPermission -InputObject <IGroupsIdentity>
 -BodyParameter <IPaths15Pe6B7GroupsGroupIdDrivesDriveIdItemsDriveitemIdPermissionsPermissionIdMicrosoftGraphGrantPostRequestbodyContentApplicationJsonSchema>
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/grant-mgbetagroupsdrivesitemspermission](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/grant-mgbetagroupsdrivesitemspermission)
