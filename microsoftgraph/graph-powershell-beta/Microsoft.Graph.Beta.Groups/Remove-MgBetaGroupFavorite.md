...
### Remove (Default)
```
Remove-MgBetaGroupFavorite -GroupId <String> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### RemoveViaIdentity
```
Remove-MgBetaGroupFavorite -InputObject <IGroupsIdentity> [-ResponseHeadersVariable <String>]
...
**Permissions**
[!INCLUDE [permissions-table](~/../graphref/api-reference/beta/includes/permissions/group-removefavorite-permissions.md)]
...
[https://learn.microsoft.com/graph/api/group-removefavorite?view=graph-rest-beta](https://learn.microsoft.com/graph/api/group-removefavorite?view=graph-rest-beta)
