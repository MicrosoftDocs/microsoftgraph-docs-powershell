...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/remove-mgbetagroupownerdirectoryobjectbyref
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaGroupOwnerDirectoryObjectByRef -DirectoryObjectId <String> -GroupId <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgBetaGroupOwnerDirectoryObjectByRef -InputObject <IGroupsIdentity> [-IfMatch <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
## RELATED LINKS
[Remove-MgGroupOwnerDirectoryObjectByRef](/powershell/module/Microsoft.Graph.Groups/Remove-MgGroupOwnerDirectoryObjectByRef?view=graph-powershell-1.0)
