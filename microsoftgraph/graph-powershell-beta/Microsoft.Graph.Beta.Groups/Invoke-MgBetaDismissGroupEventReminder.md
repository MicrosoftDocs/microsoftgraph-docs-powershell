...
### Dismiss (Default)
```
Invoke-MgBetaDismissGroupEventReminder -EventId <String> -GroupId <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### DismissViaIdentity
```
Invoke-MgBetaDismissGroupEventReminder -InputObject <IGroupsIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
