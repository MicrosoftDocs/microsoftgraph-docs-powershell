...
### Dismiss (Default)
```
Invoke-MgBetaDismissGroupEventReminder -EventId <String> -GroupId <String> [-ResponseHeadersVariable <String>]
...
### DismissViaIdentity
```
Invoke-MgBetaDismissGroupEventReminder -InputObject <IGroupsIdentity> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
