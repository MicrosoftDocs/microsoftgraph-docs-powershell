...
### Get (Default)
```
Get-MgBetaGroupSiteContentModelByName -GroupId <String> -ModelName <String> -SiteId <String>
...
### GetViaIdentity
```
Get-MgBetaGroupSiteContentModelByName -InputObject <IGroupsIdentity> [-ResponseHeadersVariable <String>]
