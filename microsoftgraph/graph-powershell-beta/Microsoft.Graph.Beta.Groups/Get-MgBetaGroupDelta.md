...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/get-mgbetagroupdelta
Locale: en-US
Module Name: Microsoft.Graph.Beta.Groups
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaGroupDelta
---
...
```
Get-MgBetaGroupDelta [-ExpandProperty <string[]>] [-Filter <string>] [-Property <string[]>]
...
- [Get-MgBetaGroupDelta](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/get-mgbetagroupdelta)
- [Graph API Reference](https://learn.microsoft.com/graph/api/group-delta?view=graph-rest-beta)
