...
### Delete (Default)
```
Remove-MgBetaGroupByUniqueName -UniqueName <String> [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaGroupByUniqueName -InputObject <IGroupsIdentity> [-IfMatch <String>] [-PassThru] [-WhatIf]
