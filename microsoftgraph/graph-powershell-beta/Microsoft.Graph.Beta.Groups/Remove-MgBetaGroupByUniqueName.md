...
### Delete (Default)
```
Remove-MgBetaGroupByUniqueName -UniqueName <String> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
...
### DeleteViaIdentity
```
Remove-MgBetaGroupByUniqueName -InputObject <IGroupsIdentity> [-IfMatch <String>]
