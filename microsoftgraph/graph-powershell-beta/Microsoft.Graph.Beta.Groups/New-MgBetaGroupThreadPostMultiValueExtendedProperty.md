...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/new-mgbetagroupthreadpostmultivalueextendedproperty
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgGroupThreadPostMultiValueExtendedProperty](/powershell/module/Microsoft.Graph.Groups/New-MgGroupThreadPostMultiValueExtendedProperty?view=graph-powershell-v1.0)

## SYNTAX

### CreateExpanded (Default)
```
New-MgBetaGroupThreadPostMultiValueExtendedProperty -ConversationThreadId <String> -GroupId <String>
...
```
New-MgBetaGroupThreadPostMultiValueExtendedProperty -InputObject <IGroupsIdentity>
