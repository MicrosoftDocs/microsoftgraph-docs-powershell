...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/new-mgbetagroupownerbyref
Locale: en-US
Module Name: Microsoft.Graph.Beta.Groups
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: New-MgBetaGroupOwnerByRef
---
...
```
New-MgBetaGroupOwnerByRef -GroupId <string> -OdataId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaGroupOwnerByRef -InputObject <IGroupsIdentity> -OdataId <string>
