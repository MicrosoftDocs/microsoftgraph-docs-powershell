...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/invoke-mgbetaunarchivegroupplannerplan
schema: 2.0.0
...
```
Invoke-MgBetaUnarchiveGroupPlannerPlan -InputObject <IGroupsIdentity> [-ResponseHeadersVariable <String>]
...
```
Invoke-MgBetaUnarchiveGroupPlannerPlan -InputObject <IGroupsIdentity>
 -BodyParameter <IPathsF1ZkrsGroupsGroupIdPlannerPlansPlannerplanIdMicrosoftGraphUnarchivePostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
