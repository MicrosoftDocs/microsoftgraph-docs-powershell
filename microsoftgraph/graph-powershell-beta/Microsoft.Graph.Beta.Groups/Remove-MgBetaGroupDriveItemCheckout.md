...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/remove-mgbetagroupdriveitemcheckout
schema: 2.0.0
...
### Discard (Default)
```
Remove-MgBetaGroupDriveItemCheckout -DriveId <String> -DriveItemId <String> -GroupId <String>
...
### DiscardViaIdentity
```
Remove-MgBetaGroupDriveItemCheckout -InputObject <IGroupsIdentity> [-ResponseHeadersVariable <String>]
