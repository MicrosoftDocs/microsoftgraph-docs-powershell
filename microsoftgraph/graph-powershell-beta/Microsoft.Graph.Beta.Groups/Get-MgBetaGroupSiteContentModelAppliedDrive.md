...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/get-mgbetagroupsitecontentmodelapplieddrive
schema: 2.0.0
...
### Get (Default)
```
Get-MgBetaGroupSiteContentModelAppliedDrive -ContentModelId <String> -GroupId <String> -SiteId <String>
...
### GetViaIdentity
```
Get-MgBetaGroupSiteContentModelAppliedDrive -InputObject <IGroupsIdentity> [-Count] [-Filter <String>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/get-mgbetagroupsitecontentmodelapplieddrive](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/get-mgbetagroupsitecontentmodelapplieddrive)
