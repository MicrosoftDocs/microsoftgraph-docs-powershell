...
### Get (Default)
```
Get-MgGroupSiteActivityByInterval -EndDateTime <String> -GroupId <String> -Interval <String> -SiteId <String>
...
### GetViaIdentity
```
Get-MgGroupSiteActivityByInterval -InputObject <IGroupsIdentity> [-Count] [-Filter <String>]
