...
```
Test-MgBetaGroupDynamicMembershipRule [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-MemberId <string>] [-MembershipRule <string>] [-Break]
