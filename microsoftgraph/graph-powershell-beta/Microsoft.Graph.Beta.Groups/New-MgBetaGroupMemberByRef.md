...
```
New-MgBetaGroupMemberByRef -GroupId <String> [-AdditionalProperties <Hashtable>] [-OdataId <String>]
...
```
New-MgBetaGroupMemberByRef -InputObject <IGroupsIdentity> [-AdditionalProperties <Hashtable>]
