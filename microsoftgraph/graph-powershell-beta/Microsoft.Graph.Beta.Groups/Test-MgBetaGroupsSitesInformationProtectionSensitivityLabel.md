...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/test-mgbetagroupssitesinformationprotectionsensitivitylabel
schema: 2.0.0
---

# Test-MgBetaGroupsSitesInformationProtectionSensitivityLabel
...
```
Test-MgBetaGroupsSitesInformationProtectionSensitivityLabel -GroupId <String> -SiteId <String>
...
```
Test-MgBetaGroupsSitesInformationProtectionSensitivityLabel -InputObject <IGroupsIdentity>
 [-AdditionalProperties <Hashtable>] [-CurrentLabel <IMicrosoftGraphCurrentLabel>]
 [-DiscoveredSensitiveTypes <IMicrosoftGraphDiscoveredSensitiveType[]>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/test-mgbetagroupssitesinformationprotectionsensitivitylabel](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/test-mgbetagroupssitesinformationprotectionsensitivitylabel)
