...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/new-mgbetagroupthread
Locale: en-US
Module Name: Microsoft.Graph.Beta.Groups
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: New-MgBetaGroupThread
---
...
```
New-MgBetaGroupThread -GroupId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaGroupThread -InputObject <IGroupsIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-CcRecipients <IMicrosoftGraphRecipient[]>] [-HasAttachments]
 [-Id <string>] [-IsLocked] [-LastDeliveredDateTime <datetime>] [-Posts <IMicrosoftGraphPost[]>]
 [-Preview <string>] [-ToRecipients <IMicrosoftGraphRecipient[]>] [-Topic <string>]
 [-UniqueSenders <string[]>] [-Break] [-Headers <IDictionary>]
...
```
New-MgBetaGroupThread -InputObject <IGroupsIdentity>
