...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgGroupPlannerPlanDelta](/powershell/module/Microsoft.Graph.Groups/Get-MgGroupPlannerPlanDelta?view=graph-powershell-v1.0)
...
### DeltaViaIdentity
```
Get-MgBetaGroupPlannerPlanDelta -InputObject <IGroupsIdentity> [-Filter <String>] [-Property <String[]>]
