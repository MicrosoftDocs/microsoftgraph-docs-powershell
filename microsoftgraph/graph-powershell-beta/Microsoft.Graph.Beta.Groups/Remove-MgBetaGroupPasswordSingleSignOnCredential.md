...
```
Remove-MgBetaGroupPasswordSingleSignOnCredential -GroupId <String> [-ResponseHeadersVariable <String>]
...
```yaml
Type: IPaths1GrwiofGroupsGroupIdMicrosoftGraphDeletepasswordsinglesignoncredentialsPostRequestbodyContentApplicationJsonSchema
