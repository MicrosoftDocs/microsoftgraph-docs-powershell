...
### Follow (Default)
```
Invoke-MgBetaFollowGroupDriveRoot -DriveId <String> -GroupId <String> [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### FollowViaIdentity
```
Invoke-MgBetaFollowGroupDriveRoot -InputObject <IGroupsIdentity> [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
