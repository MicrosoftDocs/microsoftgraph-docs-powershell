...
# Update-MgBetaGroupOnPremiseSyncBehavior
...
```
Update-MgBetaGroupOnPremiseSyncBehavior -GroupId <string> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaGroupOnPremiseSyncBehavior -GroupId <string>
...
```
Update-MgBetaGroupOnPremiseSyncBehavior -InputObject <IGroupsIdentity>
