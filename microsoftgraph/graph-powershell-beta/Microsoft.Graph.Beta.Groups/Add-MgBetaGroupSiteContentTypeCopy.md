...
### AddExpanded (Default)
```
Add-MgBetaGroupSiteContentTypeCopy -GroupId <String> -SiteId <String> [-ResponseHeadersVariable <String>]
...
```
Add-MgBetaGroupSiteContentTypeCopy -InputObject <IGroupsIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-ContentType <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
