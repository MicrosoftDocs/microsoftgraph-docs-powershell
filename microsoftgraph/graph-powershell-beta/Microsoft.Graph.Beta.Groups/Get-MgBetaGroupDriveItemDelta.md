...
### Delta (Default)
```
Get-MgBetaGroupDriveItemDelta -DriveId <String> -DriveItemId <String> -GroupId <String> [-Count]
...
### DeltaViaIdentity1
```
Get-MgBetaGroupDriveItemDelta -InputObject <IGroupsIdentity> [-Count] [-Filter <String>] [-Property <String[]>]
