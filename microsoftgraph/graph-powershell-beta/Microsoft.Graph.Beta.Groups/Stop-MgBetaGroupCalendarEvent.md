...
```
Stop-MgBetaGroupCalendarEvent -EventId <String> -GroupId <String> [-ResponseHeadersVariable <String>]
...
```
Stop-MgBetaGroupCalendarEvent -InputObject <IGroupsIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-Comment <String>] [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
