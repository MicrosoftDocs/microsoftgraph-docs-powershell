...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/remove-mgbetagroupsitecontentmodelfromdrive
schema: 2.0.0
...
```
Remove-MgBetaGroupSiteContentModelFromDrive -ContentModelId <String> -GroupId <String> -SiteId <String>
...
```
Remove-MgBetaGroupSiteContentModelFromDrive -InputObject <IGroupsIdentity> [-ResponseHeadersVariable <String>]
...
### RemoveViaIdentity
```
Remove-MgBetaGroupSiteContentModelFromDrive -InputObject <IGroupsIdentity>
 -BodyParameter <IPaths115N6UrGroupsGroupIdSitesSiteIdContentmodelsContentmodelIdMicrosoftGraphRemovefromdrivePostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```yaml
Type: IPaths115N6UrGroupsGroupIdSitesSiteIdContentmodelsContentmodelIdMicrosoftGraphRemovefromdrivePostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths115N6UrGroupsGroupIdSitesSiteIdContentmodelsContentmodelIdMicrosoftGraphRemovefromdrivePostRequestbodyContentApplicationJsonSchema
