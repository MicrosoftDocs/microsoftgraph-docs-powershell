...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/get-mgbetagrouprejectedsenderbyref
Locale: en-US
Module Name: Microsoft.Graph.Beta.Groups
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaGroupRejectedSenderByRef
---
...
```
Get-MgBetaGroupRejectedSenderByRef -GroupId <string> [-Filter <string>] [-Search <string>]
...
- [Get-MgBetaGroupRejectedSenderByRef](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/get-mgbetagrouprejectedsenderbyref)
- [Graph API Reference](https://learn.microsoft.com/graph/api/group-list-rejectedsenders?view=graph-rest-beta)
