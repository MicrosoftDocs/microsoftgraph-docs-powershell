...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/grant-mgbetagroupsitelistpermission
schema: 2.0.0
...
```
Grant-MgBetaGroupSiteListPermission -GroupId <String> -ListId <String> -PermissionId <String> -SiteId <String>
...
```
Grant-MgBetaGroupSiteListPermission -InputObject <IGroupsIdentity> [-ResponseHeadersVariable <String>]
...
### GrantViaIdentity
```
Grant-MgBetaGroupSiteListPermission -InputObject <IGroupsIdentity>
 -BodyParameter <IPaths1Ky60AsGroupsGroupIdSitesSiteIdListsListIdPermissionsPermissionIdMicrosoftGraphGrantPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
```yaml
Type: IPaths1Ky60AsGroupsGroupIdSitesSiteIdListsListIdPermissionsPermissionIdMicrosoftGraphGrantPostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths1Ky60AsGroupsGroupIdSitesSiteIdListsListIdPermissionsPermissionIdMicrosoftGraphGrantPostRequestbodyContentApplicationJsonSchema
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/grant-mgbetagroupsitelistpermission](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/grant-mgbetagroupsitelistpermission)
