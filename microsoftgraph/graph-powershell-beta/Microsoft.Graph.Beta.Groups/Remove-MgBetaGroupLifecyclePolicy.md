...
### Delete (Default)
```
Remove-MgBetaGroupLifecyclePolicy -GroupLifecyclePolicyId <String> [-IfMatch <String>] [-Headers <IDictionary>]
...
### DeleteViaIdentity1
```
Remove-MgBetaGroupLifecyclePolicy -InputObject <IGroupsIdentity> [-IfMatch <String>] [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
