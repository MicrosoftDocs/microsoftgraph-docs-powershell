...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgGroupDriveRootListItemLink](/powershell/module/Microsoft.Graph.Groups/New-MgGroupDriveRootListItemLink?view=graph-powershell-1.0)
...
```
New-MgBetaGroupDriveRootListItemLink -InputObject <IGroupsIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-ExpirationDateTime <DateTime>] [-Message <String>] [-Password <String>]
 [-Recipients <IMicrosoftGraphDriveRecipient[]>] [-RetainInheritedPermissions] [-Scope <String>]
 [-SendNotification] [-Type <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
...
## RELATED LINKS
[New-MgGroupDriveRootListItemLink](/powershell/module/Microsoft.Graph.Groups/New-MgGroupDriveRootListItemLink?view=graph-powershell-1.0)
