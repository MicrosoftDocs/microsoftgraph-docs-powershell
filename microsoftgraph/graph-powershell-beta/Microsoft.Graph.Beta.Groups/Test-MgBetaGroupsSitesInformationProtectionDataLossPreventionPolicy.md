...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/test-mgbetagroupssitesinformationprotectiondatalosspreventionpolicy
schema: 2.0.0
---

# Test-MgBetaGroupsSitesInformationProtectionDataLossPreventionPolicy
...
```
Test-MgBetaGroupsSitesInformationProtectionDataLossPreventionPolicy -GroupId <String> -SiteId <String>
...
```
Test-MgBetaGroupsSitesInformationProtectionDataLossPreventionPolicy -InputObject <IGroupsIdentity>
 [-AdditionalProperties <Hashtable>] [-EvaluationInput <IMicrosoftGraphDlpEvaluationInput>]
 [-NotificationInfo <IMicrosoftGraphDlpNotification>] [-Target <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/test-mgbetagroupssitesinformationprotectiondatalosspreventionpolicy](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/test-mgbetagroupssitesinformationprotectiondatalosspreventionpolicy)
