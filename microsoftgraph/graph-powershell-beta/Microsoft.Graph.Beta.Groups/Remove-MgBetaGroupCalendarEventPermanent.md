...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/remove-mgbetagroupcalendareventpermanent
schema: 2.0.0
...
### Delete (Default)
```
Remove-MgBetaGroupCalendarEventPermanent -EventId <String> -GroupId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaGroupCalendarEventPermanent -InputObject <IGroupsIdentity> [-ResponseHeadersVariable <String>]
