...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/add-mgbetagroupsitecontentmodeltodrive
schema: 2.0.0
...
```
Add-MgBetaGroupSiteContentModelToDrive -InputObject <IGroupsIdentity> [-ResponseHeadersVariable <String>]
...
### AddViaIdentity
```
Add-MgBetaGroupSiteContentModelToDrive -InputObject <IGroupsIdentity>
 -BodyParameter <IPathsUhvg4VGroupsGroupIdSitesSiteIdContentmodelsContentmodelIdMicrosoftGraphAddtodrivePostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
