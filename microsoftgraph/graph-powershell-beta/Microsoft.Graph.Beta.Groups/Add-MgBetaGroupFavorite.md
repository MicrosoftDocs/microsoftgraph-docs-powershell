...
### Add (Default)
```
Add-MgBetaGroupFavorite -GroupId <String> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### AddViaIdentity
```
Add-MgBetaGroupFavorite -InputObject <IGroupsIdentity> [-ResponseHeadersVariable <String>]
...
[https://learn.microsoft.com/graph/api/group-addfavorite?view=graph-rest-beta](https://learn.microsoft.com/graph/api/group-addfavorite?view=graph-rest-beta)
