...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/revoke-mgbetagroupsitelistpermissiongrant
schema: 2.0.0
...
```
Revoke-MgBetaGroupSiteListPermissionGrant -GroupId <String> -ListId <String> -PermissionId <String>
...
Revoke-MgBetaGroupSiteListPermissionGrant -GroupId <String> -ListId <String> -PermissionId <String>
 -SiteId <String>
 -BodyParameter <IPaths1Ty5HapGroupsGroupIdSitesSiteIdListsListIdPermissionsPermissionIdMicrosoftGraphRevokegrantsPostRequestbodyContentApplicationJsonSchema>
...
```
Revoke-MgBetaGroupSiteListPermissionGrant -InputObject <IGroupsIdentity> [-ResponseHeadersVariable <String>]
...
### RevokeViaIdentity
```
Revoke-MgBetaGroupSiteListPermissionGrant -InputObject <IGroupsIdentity>
 -BodyParameter <IPaths1Ty5HapGroupsGroupIdSitesSiteIdListsListIdPermissionsPermissionIdMicrosoftGraphRevokegrantsPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
```yaml
Type: IPaths1Ty5HapGroupsGroupIdSitesSiteIdListsListIdPermissionsPermissionIdMicrosoftGraphRevokegrantsPostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths1Ty5HapGroupsGroupIdSitesSiteIdListsListIdPermissionsPermissionIdMicrosoftGraphRevokegrantsPostRequestbodyContentApplicationJsonSchema
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/revoke-mgbetagroupsitelistpermissiongrant](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/revoke-mgbetagroupsitelistpermissiongrant)
