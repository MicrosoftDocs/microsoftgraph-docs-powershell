...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/remove-mgbetagroupdriverootcheckout
schema: 2.0.0
...
### Discard (Default)
```
Remove-MgBetaGroupDriveRootCheckout -DriveId <String> -GroupId <String> [-ResponseHeadersVariable <String>]
...
### DiscardViaIdentity
```
Remove-MgBetaGroupDriveRootCheckout -InputObject <IGroupsIdentity> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/remove-mgbetagroupdriverootcheckout](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.groups/remove-mgbetagroupdriverootcheckout)
