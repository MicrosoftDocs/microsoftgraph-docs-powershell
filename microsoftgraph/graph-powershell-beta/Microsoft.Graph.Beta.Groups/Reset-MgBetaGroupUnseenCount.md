...
### Reset (Default)
```
Reset-MgBetaGroupUnseenCount -GroupId <String> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### ResetViaIdentity
```
Reset-MgBetaGroupUnseenCount -InputObject <IGroupsIdentity> [-ResponseHeadersVariable <String>]
...
[https://learn.microsoft.com/graph/api/group-resetunseencount?view=graph-rest-beta](https://learn.microsoft.com/graph/api/group-resetunseencount?view=graph-rest-beta)
