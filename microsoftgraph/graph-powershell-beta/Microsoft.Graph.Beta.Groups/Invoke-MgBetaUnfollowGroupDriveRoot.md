...
### Unfollow (Default)
```
Invoke-MgBetaUnfollowGroupDriveRoot -DriveId <String> -GroupId <String> [-ResponseHeadersVariable <String>]
...
### UnfollowViaIdentity
```
Invoke-MgBetaUnfollowGroupDriveRoot -InputObject <IGroupsIdentity> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
