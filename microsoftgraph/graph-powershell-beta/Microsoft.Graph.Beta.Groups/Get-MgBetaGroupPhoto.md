...
### Get (Default)
```
Get-MgBetaGroupPhoto -GroupId <String> [-Property <String[]>] [-Headers <IDictionary>]
...
### Get1
```
Get-MgBetaGroupPhoto -GroupId <String> -ProfilePhotoId <String> [-Property <String[]>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
