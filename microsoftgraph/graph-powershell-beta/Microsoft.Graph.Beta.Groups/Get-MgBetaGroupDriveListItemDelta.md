...
### Delta (Default)
```
Get-MgBetaGroupDriveListItemDelta -DriveId <String> -GroupId <String> [-Count] [-Filter <String>]
...
### Delta1
```
Get-MgBetaGroupDriveListItemDelta -DriveId <String> -GroupId <String> -Token <String> [-Count]
