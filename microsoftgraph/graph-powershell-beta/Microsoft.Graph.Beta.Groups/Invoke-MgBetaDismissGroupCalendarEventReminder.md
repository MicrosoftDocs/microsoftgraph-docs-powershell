...
### Dismiss (Default)
```
Invoke-MgBetaDismissGroupCalendarEventReminder -EventId <String> -GroupId <String>
...
### DismissViaIdentity
```
Invoke-MgBetaDismissGroupCalendarEventReminder -InputObject <IGroupsIdentity>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
