...
### Dismiss (Default)
```
Invoke-MgBetaDismissGroupCalendarEventReminder -EventId <String> -GroupId <String> [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### DismissViaIdentity
```
Invoke-MgBetaDismissGroupCalendarEventReminder -InputObject <IGroupsIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
