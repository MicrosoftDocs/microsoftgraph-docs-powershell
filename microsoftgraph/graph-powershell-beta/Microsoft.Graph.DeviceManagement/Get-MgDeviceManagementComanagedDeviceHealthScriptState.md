...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement/get-mgdevicemanagementcomanageddevicehealthscriptstate
schema: 2.0.0
---

# Get-MgDeviceManagementComanagedDeviceHealthScriptState
...
### List (Default)
```
Get-MgDeviceManagementComanagedDeviceHealthScriptState -ManagedDeviceId <String> [-ExpandProperty <String[]>]
...
### Get
```
Get-MgDeviceManagementComanagedDeviceHealthScriptState -DeviceId <String> -Id <String>
...
### GetViaIdentity
```
Get-MgDeviceManagementComanagedDeviceHealthScriptState -InputObject <IDeviceManagementIdentity>
...
### -DeviceId
key: deviceId of deviceHealthScriptPolicyState
...
### -Id
key: id of deviceHealthScriptPolicyState
...
### -PolicyId
key: policyId of deviceHealthScriptPolicyState
