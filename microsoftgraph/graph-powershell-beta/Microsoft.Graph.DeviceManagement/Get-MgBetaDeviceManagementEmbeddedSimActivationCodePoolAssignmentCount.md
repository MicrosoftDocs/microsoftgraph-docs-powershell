...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementembeddedsimactivationcodepoolassignmentcount
schema: 2.0.0
---
...
```
Get-MgBetaDeviceManagementEmbeddedSimActivationCodePoolAssignmentCount
 -EmbeddedSimActivationCodePoolId <String> [-Filter <String>] [-Search <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDeviceManagementEmbeddedSimActivationCodePoolAssignmentCount -InputObject <IDeviceManagementIdentity>
