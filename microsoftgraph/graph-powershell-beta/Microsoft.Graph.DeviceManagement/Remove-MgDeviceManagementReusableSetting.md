...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/remove-mgbetadevicemanagementreusablesetting
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaDeviceManagementReusableSetting -DeviceManagementConfigurationSettingDefinitionId <String>
 [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementReusableSetting -InputObject <IDeviceManagementIdentity> [-IfMatch <String>]
