...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/remove-mgbetadevicemanagementuserexperienceanalyticanomalydevice
schema: 2.0.0
---
...
```
Remove-MgBetaDeviceManagementUserExperienceAnalyticAnomalyDevice
 -UserExperienceAnalyticsAnomalyDeviceId <String> [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementUserExperienceAnalyticAnomalyDevice -InputObject <IDeviceManagementIdentity>
