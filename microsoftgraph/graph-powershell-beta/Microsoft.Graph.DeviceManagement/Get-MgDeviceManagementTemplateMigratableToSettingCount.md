...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementtemplatemigratabletosettingcount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaDeviceManagementTemplateMigratableToSettingCount -DeviceManagementTemplateId <String>
 -DeviceManagementTemplateId1 <String> [-Filter <String>] [-Search <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDeviceManagementTemplateMigratableToSettingCount -InputObject <IDeviceManagementIdentity>
