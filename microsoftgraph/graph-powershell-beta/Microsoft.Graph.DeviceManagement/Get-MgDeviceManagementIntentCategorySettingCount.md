...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementintentcategorysettingcount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaDeviceManagementIntentCategorySettingCount -DeviceManagementIntentId <String>
 -DeviceManagementIntentSettingCategoryId <String> [-Filter <String>] [-Search <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDeviceManagementIntentCategorySettingCount -InputObject <IDeviceManagementIdentity>
