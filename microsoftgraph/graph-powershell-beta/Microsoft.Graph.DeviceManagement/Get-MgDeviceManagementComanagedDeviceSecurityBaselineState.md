...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementcomanageddevicesecuritybaselinestate
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaDeviceManagementComanagedDeviceSecurityBaselineState -ManagedDeviceId <String>
...
### GetViaIdentity
```
Get-MgBetaDeviceManagementComanagedDeviceSecurityBaselineState -InputObject <IDeviceManagementIdentity>
