...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementgrouppolicyconfigurationdefinitionvaluecount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaDeviceManagementGroupPolicyConfigurationDefinitionValueCount -GroupPolicyConfigurationId <String>
 [-Filter <String>] [-Search <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDeviceManagementGroupPolicyConfigurationDefinitionValueCount -InputObject <IDeviceManagementIdentity>
 [-Filter <String>] [-Search <String>] [<CommonParameters>]
```
