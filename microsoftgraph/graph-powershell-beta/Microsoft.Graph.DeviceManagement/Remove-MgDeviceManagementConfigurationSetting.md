...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/remove-mgbetadevicemanagementconfigurationsetting
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaDeviceManagementConfigurationSetting -DeviceManagementConfigurationSettingDefinitionId <String>
 [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementConfigurationSetting -InputObject <IDeviceManagementIdentity> [-IfMatch <String>]
