...
### Get (Default)
```
Get-MgBetaDeviceManagementDeviceShellScriptDeviceRunStateCount -DeviceShellScriptId <String> [-Filter <String>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementdeviceshellscriptdevicerunstatecount](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementdeviceshellscriptdevicerunstatecount)
