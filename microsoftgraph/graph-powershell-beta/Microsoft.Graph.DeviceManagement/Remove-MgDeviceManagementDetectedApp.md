...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/remove-mgbetadevicemanagementdetectedapp
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaDeviceManagementDetectedApp -DetectedAppId <String> [-IfMatch <String>] [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementDetectedApp -InputObject <IDeviceManagementIdentity> [-IfMatch <String>]
