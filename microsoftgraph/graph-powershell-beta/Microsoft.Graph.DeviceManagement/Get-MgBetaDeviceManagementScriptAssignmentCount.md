...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementscriptassignmentcount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaDeviceManagementScriptAssignmentCount -DeviceManagementScriptId <String> [-Filter <String>]
 [-Search <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDeviceManagementScriptAssignmentCount -InputObject <IDeviceManagementIdentity> [-Filter <String>]
 [-Search <String>] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementscriptassignmentcount](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementscriptassignmentcount)
