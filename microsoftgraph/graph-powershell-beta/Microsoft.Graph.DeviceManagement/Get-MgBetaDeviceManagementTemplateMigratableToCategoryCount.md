...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementtemplatemigratabletocategorycount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaDeviceManagementTemplateMigratableToCategoryCount -DeviceManagementTemplateId <String>
 -DeviceManagementTemplateId1 <String> [-Filter <String>] [-Search <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDeviceManagementTemplateMigratableToCategoryCount -InputObject <IDeviceManagementIdentity>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementtemplatemigratabletocategorycount](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementtemplatemigratabletocategorycount)
