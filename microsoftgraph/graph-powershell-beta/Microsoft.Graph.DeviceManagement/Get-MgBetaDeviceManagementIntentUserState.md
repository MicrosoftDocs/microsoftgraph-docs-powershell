...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementintentuserstate
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaDeviceManagementIntentUserState -DeviceManagementIntentId <String> [-ExpandProperty <String[]>]
...
### Get
```
Get-MgBetaDeviceManagementIntentUserState -DeviceManagementIntentId <String>
...
### GetViaIdentity
```
Get-MgBetaDeviceManagementIntentUserState -InputObject <IDeviceManagementIdentity> [-ExpandProperty <String[]>]
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphDeviceManagementIntentUserState
## NOTES
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementintentuserstate](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementintentuserstate)
