...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementmanageddevicesecuritybaselinestatecount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaDeviceManagementManagedDeviceSecurityBaselineStateCount -ManagedDeviceId <String> [-Filter <String>]
 [-Search <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDeviceManagementManagedDeviceSecurityBaselineStateCount -InputObject <IDeviceManagementIdentity>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementmanageddevicesecuritybaselinestatecount](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementmanageddevicesecuritybaselinestatecount)
