...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/new-mgbetadevicemanagementdeviceshellscriptassignment
schema: 2.0.0
---
...
```
New-MgBetaDeviceManagementDeviceShellScriptAssignment -DeviceShellScriptId <String>
...
```
New-MgBetaDeviceManagementDeviceShellScriptAssignment -InputObject <IDeviceManagementIdentity>
 [-AdditionalProperties <Hashtable>] [-Id <String>]
 [-Target <IMicrosoftGraphDeviceAndAppManagementAssignmentTarget>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
BODYPARAMETER \<IMicrosoftGraphDeviceManagementScriptAssignment\>: Contains properties used to assign a device management script to a group.
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/new-mgbetadevicemanagementdeviceshellscriptassignment](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/new-mgbetadevicemanagementdeviceshellscriptassignment)
