...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/remove-mgbetadevicemanagementscriptgroupassignment
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaDeviceManagementScriptGroupAssignment -DeviceManagementScriptGroupAssignmentId <String>
 -DeviceManagementScriptId <String> [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementScriptGroupAssignment -InputObject <IDeviceManagementIdentity> [-IfMatch <String>]
