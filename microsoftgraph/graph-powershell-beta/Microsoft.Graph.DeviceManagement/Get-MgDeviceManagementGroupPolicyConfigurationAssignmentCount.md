...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementgrouppolicyconfigurationassignmentcount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaDeviceManagementGroupPolicyConfigurationAssignmentCount -GroupPolicyConfigurationId <String>
 [-Filter <String>] [-Search <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDeviceManagementGroupPolicyConfigurationAssignmentCount -InputObject <IDeviceManagementIdentity>
 [-Filter <String>] [-Search <String>] [<CommonParameters>]
```
