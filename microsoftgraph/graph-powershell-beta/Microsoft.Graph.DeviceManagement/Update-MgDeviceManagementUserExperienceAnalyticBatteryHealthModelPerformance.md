...
Update-MgDeviceManagementUserExperienceAnalyticBatteryHealthModelPerformance
 ...
 [-Manufacturer <String>] [-Model <String>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
Update-MgDeviceManagementUserExperienceAnalyticBatteryHealthModelPerformance
 ...
 [-AverageMaxCapacityPercentage <Int32>] [-Id <String>] [-Manufacturer <String>] [-Model <String>] [-PassThru]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement/update-mgdevicemanagementuserexperienceanalyticbatteryhealthmodelperformance](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement/update-mgdevicemanagementuserexperienceanalyticbatteryhealthmodelperformance)
