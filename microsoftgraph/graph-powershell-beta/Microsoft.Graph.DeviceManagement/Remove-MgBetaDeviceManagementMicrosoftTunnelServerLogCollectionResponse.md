...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/remove-mgbetadevicemanagementmicrosofttunnelserverlogcollectionresponse
schema: 2.0.0
---
...
```
Remove-MgBetaDeviceManagementMicrosoftTunnelServerLogCollectionResponse
 -MicrosoftTunnelServerLogCollectionResponseId <String> [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
