...
```
New-MgBetaChatMessageHostedContent -ChatId <String> -ChatMessageId <String> [-AdditionalProperties <Hashtable>]
...
### CreateViaIdentity
```
New-MgBetaChatMessageHostedContent -InputObject <ITeamsIdentity> -BodyParameter <Hashtable> [-WhatIf]
