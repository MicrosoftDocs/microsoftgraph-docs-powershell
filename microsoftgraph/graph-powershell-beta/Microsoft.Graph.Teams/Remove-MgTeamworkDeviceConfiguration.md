...
### Delete (Default)
```
Remove-MgTeamworkDeviceConfiguration -TeamworkDeviceId <String> [-IfMatch <String>] [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgTeamworkDeviceConfiguration -InputObject <ITeamsIdentity> [-IfMatch <String>] [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
