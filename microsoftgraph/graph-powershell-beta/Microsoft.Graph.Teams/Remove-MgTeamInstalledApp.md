...
### Delete (Default)
```
Remove-MgBetaTeamInstalledApp -TeamId <String> -TeamsAppInstallationId <String> [-IfMatch <String>] [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaTeamInstalledApp -InputObject <ITeamsIdentity> [-IfMatch <String>] [-PassThru] [-WhatIf]
