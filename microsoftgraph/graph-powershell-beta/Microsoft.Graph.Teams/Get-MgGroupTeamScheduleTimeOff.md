...
### List (Default)
```
Get-MgGroupTeamScheduleTimeOff -GroupId <String> [-Property <String[]>] [-Filter <String>] [-Search <String>]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams/get-mggroupteamscheduletimeoff](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams/get-mggroupteamscheduletimeoff)
