...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/remove-mgbetagroupteamscheduletimeoffrequest
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaGroupTeamScheduleTimeOffRequest -GroupId <String> -TimeOffRequestId <String> [-IfMatch <String>]
 [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaGroupTeamScheduleTimeOffRequest -InputObject <ITeamsIdentity> [-IfMatch <String>] [-PassThru]
