...
### List (Default)
```
Get-MgBetaTeamScheduleTimeCard -TeamId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
### Get
```
Get-MgBetaTeamScheduleTimeCard -TeamId <String> -TimeCardId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaTeamScheduleTimeCard -InputObject <ITeamsIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
