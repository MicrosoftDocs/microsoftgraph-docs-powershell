...
### List (Default)
```
Get-MgBetaTeamworkTeamTemplateDefinition -TeamTemplateId <String> [-ExpandProperty <String[]>]
...
The unique identifier of teamTemplateDefinition
...
### -TeamTemplateId
The unique identifier of teamTemplate
