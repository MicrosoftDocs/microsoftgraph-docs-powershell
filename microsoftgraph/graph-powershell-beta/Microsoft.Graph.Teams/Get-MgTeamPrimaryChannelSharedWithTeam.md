...
### List (Default)
```
Get-MgTeamPrimaryChannelSharedWithTeam -TeamId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams/get-mgteamprimarychannelsharedwithteam](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams/get-mgteamprimarychannelsharedwithteam)
