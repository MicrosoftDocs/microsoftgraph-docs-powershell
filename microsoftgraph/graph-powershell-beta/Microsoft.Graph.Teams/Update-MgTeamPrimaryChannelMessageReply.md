...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetateamprimarychannelmessagereply
schema: 2.0.0
---
...
```
Update-MgBetaTeamPrimaryChannelMessageReply -ChatMessageId <String> -ChatMessageId1 <String> -TeamId <String>
...
### UpdateViaIdentity
```
Update-MgBetaTeamPrimaryChannelMessageReply -InputObject <ITeamsIdentity>
 -BodyParameter <IMicrosoftGraphChatMessage> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgBetaTeamPrimaryChannelMessageReply -InputObject <ITeamsIdentity> [-AdditionalProperties <Hashtable>]
