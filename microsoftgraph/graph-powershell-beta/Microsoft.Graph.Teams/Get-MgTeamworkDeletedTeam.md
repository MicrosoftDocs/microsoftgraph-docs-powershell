...
### List (Default)
```
Get-MgTeamworkDeletedTeam [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams/get-mgteamworkdeletedteam](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams/get-mgteamworkdeletedteam)
