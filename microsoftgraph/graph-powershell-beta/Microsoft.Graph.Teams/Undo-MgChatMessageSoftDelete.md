...
### Undo (Default)
```
Undo-MgBetaChatMessageSoftDelete -ChatId <String> -ChatMessageId <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### UndoViaIdentity
```
Undo-MgBetaChatMessageSoftDelete -InputObject <ITeamsIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
