...
### List (Default)
```
Get-MgTeamworkDeviceOperation -TeamworkDeviceId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgTeamworkDeviceOperation -InputObject <ITeamsIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
