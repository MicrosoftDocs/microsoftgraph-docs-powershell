...
### List (Default)
```
Get-MgGroupTeamScheduleTimeCard -GroupId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams/get-mggroupteamscheduletimecard](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.teams/get-mggroupteamscheduletimecard)
