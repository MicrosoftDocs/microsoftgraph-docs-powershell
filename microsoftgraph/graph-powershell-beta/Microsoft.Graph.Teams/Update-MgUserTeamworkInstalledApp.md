...
Update-MgUserTeamworkInstalledApp -UserId <String> -UserScopeTeamsAppInstallationId <String>
 [-AdditionalProperties <Hashtable>] [-Chat <IMicrosoftGraphChat>] [-Id <String>]
 [-TeamsApp <IMicrosoftGraphTeamsApp>] [-TeamsAppDefinition <IMicrosoftGraphTeamsAppDefinition>] [-PassThru]
...
```
Update-MgUserTeamworkInstalledApp -UserId <String> -UserScopeTeamsAppInstallationId <String>
 -BodyParameter <IMicrosoftGraphUserScopeTeamsAppInstallation> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
Update-MgUserTeamworkInstalledApp -InputObject <ITeamsIdentity> [-AdditionalProperties <Hashtable>]
 ...
 [-TeamsAppDefinition <IMicrosoftGraphTeamsAppDefinition>] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
