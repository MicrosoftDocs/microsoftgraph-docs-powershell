...
### List (Default)
```
Get-MgBetaGroupTeamInstalledApp -GroupId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
### Get
```
Get-MgBetaGroupTeamInstalledApp -GroupId <String> -TeamsAppInstallationId <String> [-ExpandProperty <String[]>]
