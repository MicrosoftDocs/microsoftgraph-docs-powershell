...
### Delete (Default)
```
Remove-MgBetaGroupTeamInstalledApp -GroupId <String> -TeamsAppInstallationId <String> [-IfMatch <String>]
 [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaGroupTeamInstalledApp -InputObject <ITeamsIdentity> [-IfMatch <String>] [-PassThru] [-WhatIf]
