...
### Set
```
Set-MgBetaTeamSchedule -TeamId <String> -BodyParameter <IMicrosoftGraphSchedule> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### SetViaIdentity
```
Set-MgBetaTeamSchedule -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphSchedule> [-WhatIf]
