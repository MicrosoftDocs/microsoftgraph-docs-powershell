...
### List (Default)
```
Get-MgBetaTeamScheduleTimeOffRequest -TeamId <String> [-Property <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgBetaTeamScheduleTimeOffRequest -InputObject <ITeamsIdentity> [-Property <String[]>] [<CommonParameters>]
```
