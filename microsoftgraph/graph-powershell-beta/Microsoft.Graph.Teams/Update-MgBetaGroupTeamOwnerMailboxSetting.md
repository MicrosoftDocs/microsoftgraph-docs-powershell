...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetagroupteamownermailboxsetting
schema: 2.0.0
---
...
```
Update-MgBetaGroupTeamOwnerMailboxSetting -GroupId <String> -UserId <String>
...
```
Update-MgBetaGroupTeamOwnerMailboxSetting -InputObject <ITeamsIdentity> [-AdditionalProperties <Hashtable>]
...
### UpdateViaIdentity
```
Update-MgBetaGroupTeamOwnerMailboxSetting -InputObject <ITeamsIdentity>
 -BodyParameter <IMicrosoftGraphMailboxSettings> [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetagroupteamownermailboxsetting](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.teams/update-mgbetagroupteamownermailboxsetting)
