...
### Delete (Default)
```
Remove-MgBetaAppCatalogTeamAppDefinition -TeamsAppDefinitionId <String> -TeamsAppId <String>
 [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaAppCatalogTeamAppDefinition -InputObject <ITeamsIdentity> [-IfMatch <String>] [-PassThru]
