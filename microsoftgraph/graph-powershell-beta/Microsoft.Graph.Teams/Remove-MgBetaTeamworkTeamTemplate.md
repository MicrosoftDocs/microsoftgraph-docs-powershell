...
### Delete (Default)
```
Remove-MgBetaTeamworkTeamTemplate -TeamTemplateId <String> [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaTeamworkTeamTemplate -InputObject <ITeamsIdentity> [-IfMatch <String>] [-PassThru] [-WhatIf]
