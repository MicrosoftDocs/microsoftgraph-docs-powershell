...
Update-MgBetaGroupTeamScheduleTimeCard -GroupId <String> -TimeCardId <String>
 ...
 [-OriginalEntry <IMicrosoftGraphTimeCardEntry>] [-State <String>] [-UserId <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```
Update-MgBetaGroupTeamScheduleTimeCard -GroupId <String> -TimeCardId <String>
 -BodyParameter <IMicrosoftGraphTimeCard> [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgBetaGroupTeamScheduleTimeCard -InputObject <ITeamsIdentity> [-AdditionalProperties <Hashtable>]
