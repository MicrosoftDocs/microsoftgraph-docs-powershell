...
### Update
```
Update-MgBetaUserChat -ChatId <String> -UserId <String> -BodyParameter <IMicrosoftGraphChat> [-WhatIf]
...
### UpdateViaIdentity
```
Update-MgBetaUserChat -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphChat> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
