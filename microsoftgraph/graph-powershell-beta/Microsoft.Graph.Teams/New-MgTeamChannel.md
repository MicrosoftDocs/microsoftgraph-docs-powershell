...
### Create
```
New-MgTeamChannel -TeamId <String> -BodyParameter <IMicrosoftGraphChannel> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
New-MgTeamChannel -InputObject <ITeamsIdentity> [-AdditionalProperties <Hashtable>]
 ...
 [-Tabs <IMicrosoftGraphTeamsTab[]>] [-WebUrl <String>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgTeamChannel -InputObject <ITeamsIdentity> -BodyParameter <IMicrosoftGraphChannel> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
  ...
  - `[FilesFolder <IMicrosoftGraphDriveItem>]`: driveItem
    ...
    - `[CreatedByUser <IMicrosoftGraphUser>]`: user
      ...
      - `[JoinedGroups <IMicrosoftGraphGroup[]>]`: Read-only. Nullable.
        ...
        - `[Owners <IMicrosoftGraphDirectoryObject[]>]`: The owners of the group. The owners are a set of non-admin users who are allowed to modify this object. Nullable. If this property is not specified when creating a Microsoft 365 group, the calling user is automatically assigned as the group owner. Supports $expand.
