...
### Delete (Default)
```
Remove-MgBetaBookingBusiness -BookingBusinessId <String> [-IfMatch <String>] [-Headers <IDictionary>]
...
### DeleteViaIdentity1
```
Remove-MgBetaBookingBusiness -InputObject <IBookingsIdentity> [-IfMatch <String>] [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
