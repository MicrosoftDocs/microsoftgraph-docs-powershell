...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.bookings/new-mgbetabackuprestoresiteinclusionrule
schema: 2.0.0
---

# New-MgBetaBackupRestoreSiteInclusionRule
...
```
New-MgBetaBackupRestoreSiteInclusionRule [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <DateTime>]
 [-Error <IMicrosoftGraphPublicError>] [-Id <String>] [-IsAutoApplyEnabled]
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-LastModifiedDateTime <DateTime>] [-SiteExpression <String>]
...
### Create
```
New-MgBetaBackupRestoreSiteInclusionRule -BodyParameter <IMicrosoftGraphSiteProtectionRule>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.bookings/new-mgbetabackuprestoresiteinclusionrule](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.bookings/new-mgbetabackuprestoresiteinclusionrule)
