...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.bookings/new-mgbetavirtualeventsessionmeetingattendancereportattendancerecord
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgVirtualEventSessionMeetingAttendanceReportAttendanceRecord](/powershell/module/Microsoft.Graph.Bookings/New-MgVirtualEventSessionMeetingAttendanceReportAttendanceRecord?view=graph-powershell-v1.0)

## SYNTAX

### CreateExpanded (Default)
```
New-MgBetaVirtualEventSessionMeetingAttendanceReportAttendanceRecord -VirtualEventId <String>
...
```
New-MgBetaVirtualEventSessionMeetingAttendanceReportAttendanceRecord -VirtualEventId <String>
 -VirtualEventSessionId <String> -BodyParameter <IMicrosoftGraphAttendanceRecord> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgBetaVirtualEventSessionMeetingAttendanceReportAttendanceRecord -InputObject <IBookingsIdentity>
...
## RELATED LINKS
[New-MgVirtualEventSessionMeetingAttendanceReportAttendanceRecord](/powershell/module/Microsoft.Graph.Bookings/New-MgVirtualEventSessionMeetingAttendanceReportAttendanceRecord?view=graph-powershell-v1.0)
