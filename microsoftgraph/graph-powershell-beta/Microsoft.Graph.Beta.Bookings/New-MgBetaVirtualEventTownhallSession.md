...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgVirtualEventTownhallSession](/powershell/module/Microsoft.Graph.Bookings/New-MgVirtualEventTownhallSession?view=graph-powershell-1.0)

## SYNTAX

### CreateExpanded (Default)
```
New-MgBetaVirtualEventTownhallSession -VirtualEventTownhallId <String> [-ResponseHeadersVariable <String>]
...
```
New-MgBetaVirtualEventTownhallSession -InputObject <IBookingsIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-AllowAttendeeToEnableCamera] [-AllowAttendeeToEnableMic]
 [-AllowBreakoutRooms] [-AllowLiveShare <String>] [-AllowMeetingChat <String>] [-AllowParticipantsToChangeName]
 [-AllowPowerPointSharing] [-AllowRecording] [-AllowTeamworkReactions] [-AllowTranscription] [-AllowWhiteboard]
 [-AllowedPresenters <String>] [-AnonymizeIdentityForRoles <String[]>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.bookings/new-mgbetavirtualeventtownhallsession](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.bookings/new-mgbetavirtualeventtownhallsession)
