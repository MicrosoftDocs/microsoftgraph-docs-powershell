...
```
New-MgBetaBackupRestoreExchangeProtectionPolicy [-ResponseHeadersVariable <String>]
...
### Create
```
New-MgBetaBackupRestoreExchangeProtectionPolicy -BodyParameter <IMicrosoftGraphExchangeProtectionPolicy>
