...
```
New-MgBetaBusinessScenario [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>]
...
### Create
```
New-MgBetaBusinessScenario -BodyParameter <IMicrosoftGraphBusinessScenario> [-ResponseHeadersVariable <String>]
