...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.bookings/new-mgbetabackuprestorepoint
schema: 2.0.0
---

# New-MgBetaBackupRestorePoint
...
```
New-MgBetaBackupRestorePoint [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>]
...
### Create
```
New-MgBetaBackupRestorePoint -BodyParameter <IMicrosoftGraphRestorePoint> [-ResponseHeadersVariable <String>]
