...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.bookings/update-mgbetabackuprestorepoint
schema: 2.0.0
---

# Update-MgBetaBackupRestorePoint
...
```
Update-MgBetaBackupRestorePoint -RestorePointId <String> [-ResponseHeadersVariable <String>]
...
### Update
```
Update-MgBetaBackupRestorePoint -RestorePointId <String> -BodyParameter <IMicrosoftGraphRestorePoint>
...
```
Update-MgBetaBackupRestorePoint -InputObject <IBookingsIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-ExpirationDateTime <DateTime>] [-Id <String>]
 [-ProtectionDateTime <DateTime>] [-ProtectionUnit <IMicrosoftGraphProtectionUnitBase>] [-Tags <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### UpdateViaIdentity
```
Update-MgBetaBackupRestorePoint -InputObject <IBookingsIdentity> -BodyParameter <IMicrosoftGraphRestorePoint>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.bookings/update-mgbetabackuprestorepoint](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.bookings/update-mgbetabackuprestorepoint)
