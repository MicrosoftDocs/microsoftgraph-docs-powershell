...
# Get-MgBetaVirtualEventTownhallRegistration
...
```
Get-MgBetaVirtualEventTownhallRegistration -VirtualEventTownhallId <string>
...
```
Get-MgBetaVirtualEventTownhallRegistration -VirtualEventRegistrationId <string>
...
```
Get-MgBetaVirtualEventTownhallRegistration -InputObject <IBookingsIdentity>
...
- [Get-MgBetaVirtualEventTownhallRegistration](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.bookings/get-mgbetavirtualeventtownhallregistration)
