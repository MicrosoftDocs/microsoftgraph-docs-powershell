...
### Delete (Default)
```
Remove-MgBetaBackupRestoreServiceApp -ServiceAppId <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgBetaBackupRestoreServiceApp -InputObject <IBookingsIdentity> [-IfMatch <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
