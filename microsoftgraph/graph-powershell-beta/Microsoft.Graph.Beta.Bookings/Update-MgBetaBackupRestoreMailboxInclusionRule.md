...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.bookings/update-mgbetabackuprestoremailboxinclusionrule
schema: 2.0.0
---

# Update-MgBetaBackupRestoreMailboxInclusionRule
...
```
Update-MgBetaBackupRestoreMailboxInclusionRule -MailboxProtectionRuleId <String>
...
```
Update-MgBetaBackupRestoreMailboxInclusionRule -InputObject <IBookingsIdentity>
 [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>]
 [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <DateTime>] [-Error <IMicrosoftGraphPublicError>]
 [-Id <String>] [-IsAutoApplyEnabled] [-LastModifiedBy <IMicrosoftGraphIdentitySet>]
 [-LastModifiedDateTime <DateTime>] [-MailboxExpression <String>] [-Status <String>] [-Headers <IDictionary>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.bookings/update-mgbetabackuprestoremailboxinclusionrule](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.bookings/update-mgbetabackuprestoremailboxinclusionrule)
