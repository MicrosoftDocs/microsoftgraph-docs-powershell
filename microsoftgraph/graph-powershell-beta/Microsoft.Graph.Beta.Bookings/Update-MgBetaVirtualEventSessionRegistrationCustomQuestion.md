...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgVirtualEventSessionRegistrationCustomQuestion](/powershell/module/Microsoft.Graph.Bookings/Update-MgVirtualEventSessionRegistrationCustomQuestion?view=graph-powershell-v1.0)

## SYNTAX

### UpdateExpanded (Default)
```
Update-MgBetaVirtualEventSessionRegistrationCustomQuestion -MeetingRegistrationQuestionId <String>
...
```
Update-MgBetaVirtualEventSessionRegistrationCustomQuestion -MeetingRegistrationQuestionId <String>
 -VirtualEventId <String> -VirtualEventSessionId <String>
 -BodyParameter <IMicrosoftGraphMeetingRegistrationQuestion> [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgBetaVirtualEventSessionRegistrationCustomQuestion -InputObject <IBookingsIdentity>
...
## RELATED LINKS
[Update-MgVirtualEventSessionRegistrationCustomQuestion](/powershell/module/Microsoft.Graph.Bookings/Update-MgVirtualEventSessionRegistrationCustomQuestion?view=graph-powershell-v1.0)
