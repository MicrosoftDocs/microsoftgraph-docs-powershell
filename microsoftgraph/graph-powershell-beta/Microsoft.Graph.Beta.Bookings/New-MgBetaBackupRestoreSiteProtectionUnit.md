...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.bookings/new-mgbetabackuprestoresiteprotectionunit
schema: 2.0.0
---

# New-MgBetaBackupRestoreSiteProtectionUnit
...
```
New-MgBetaBackupRestoreSiteProtectionUnit [-ResponseHeadersVariable <String>]
...
### Create
```
New-MgBetaBackupRestoreSiteProtectionUnit -BodyParameter <IMicrosoftGraphSiteProtectionUnit>
