...
### List (Default)
```
Get-MgBetaBackupRestoreSiteProtectionUnit [-ExpandProperty <String[]>] [-Property <String[]>]
...
### Get
```
Get-MgBetaBackupRestoreSiteProtectionUnit -SiteProtectionUnitId <String> [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgBetaBackupRestoreSiteProtectionUnit -InputObject <IBookingsIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
