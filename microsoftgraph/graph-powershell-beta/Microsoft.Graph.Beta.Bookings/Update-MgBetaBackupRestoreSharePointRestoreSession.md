...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.bookings/update-mgbetabackuprestoresharepointrestoresession
schema: 2.0.0
---

# Update-MgBetaBackupRestoreSharePointRestoreSession
...
```
Update-MgBetaBackupRestoreSharePointRestoreSession -SharePointRestoreSessionId <String>
...
```
Update-MgBetaBackupRestoreSharePointRestoreSession -InputObject <IBookingsIdentity>
 [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>] [-CompletedDateTime <DateTime>]
 [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <DateTime>] [-Error <IMicrosoftGraphPublicError>]
 [-Id <String>] [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-LastModifiedDateTime <DateTime>]
 [-SiteRestoreArtifacts <IMicrosoftGraphSiteRestoreArtifact[]>] [-Status <String>] [-Headers <IDictionary>]
