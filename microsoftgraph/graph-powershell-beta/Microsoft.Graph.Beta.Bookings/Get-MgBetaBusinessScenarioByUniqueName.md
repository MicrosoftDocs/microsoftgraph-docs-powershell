...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.bookings/get-mgbetabusinessscenariobyuniquename
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaBusinessScenarioByUniqueName -UniqueName <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgBetaBusinessScenarioByUniqueName -InputObject <IBookingsIdentity> [-ExpandProperty <String[]>]
