...
### Delete (Default)
```
Remove-MgBetaBackupRestoreProtectionPolicy -ProtectionPolicyBaseId <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgBetaBackupRestoreProtectionPolicy -InputObject <IBookingsIdentity> [-IfMatch <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
