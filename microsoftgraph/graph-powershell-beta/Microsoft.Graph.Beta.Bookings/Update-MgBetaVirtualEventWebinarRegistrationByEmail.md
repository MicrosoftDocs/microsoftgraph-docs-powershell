...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.bookings/update-mgbetavirtualeventwebinarregistrationbyemail
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgVirtualEventWebinarRegistrationByEmail](/powershell/module/Microsoft.Graph.Bookings/Update-MgVirtualEventWebinarRegistrationByEmail?view=graph-powershell-1.0)

## SYNTAX

### UpdateExpanded (Default)
```
Update-MgBetaVirtualEventWebinarRegistrationByEmail -Email <String> -VirtualEventWebinarId <String>
 [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>] [-CancelationDateTime <DateTime>]
 [-Email1 <String>] [-FirstName <String>] [-Id <String>] [-LastName <String>] [-PreferredLanguage <String>]
...
```
Update-MgBetaVirtualEventWebinarRegistrationByEmail [-Email <String>] -InputObject <IBookingsIdentity>
 [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>] [-CancelationDateTime <DateTime>]
...
### UpdateViaIdentity
```
Update-MgBetaVirtualEventWebinarRegistrationByEmail -InputObject <IBookingsIdentity>
 -BodyParameter <IMicrosoftGraphVirtualEventRegistration> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.bookings/update-mgbetavirtualeventwebinarregistrationbyemail](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.bookings/update-mgbetavirtualeventwebinarregistrationbyemail)
