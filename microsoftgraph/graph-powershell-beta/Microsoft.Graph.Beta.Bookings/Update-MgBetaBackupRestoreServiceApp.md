...
# Update-MgBetaBackupRestoreServiceApp
...
```
Update-MgBetaBackupRestoreServiceApp -ServiceAppId <String> [-ResponseHeadersVariable <String>]
...
### Update
```
Update-MgBetaBackupRestoreServiceApp -ServiceAppId <String> -BodyParameter <IMicrosoftGraphServiceApp>
...
```
Update-MgBetaBackupRestoreServiceApp -InputObject <IBookingsIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-Application <IMicrosoftGraphIdentity>] [-EffectiveDateTime <DateTime>]
 [-Id <String>] [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-LastModifiedDateTime <DateTime>]
 [-RegistrationDateTime <DateTime>] [-Status <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
...
### UpdateViaIdentity
```
Update-MgBetaBackupRestoreServiceApp -InputObject <IBookingsIdentity>
