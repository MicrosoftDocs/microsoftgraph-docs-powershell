...
### Get
```
Get-MgBetaBackupRestoreOneDriveForBusinessProtectionPolicyDriveProtectionUnit -DriveProtectionUnitId <String>
 -OneDriveForBusinessProtectionPolicyId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgBetaBackupRestoreOneDriveForBusinessProtectionPolicyDriveProtectionUnit -InputObject <IBookingsIdentity>
