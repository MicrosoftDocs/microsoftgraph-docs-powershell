...
```
New-MgBetaBackupRestoreServiceApp [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>]
 [-Application <IMicrosoftGraphIdentity>] [-EffectiveDateTime <DateTime>] [-Id <String>]
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-LastModifiedDateTime <DateTime>]
 [-RegistrationDateTime <DateTime>] [-Status <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Create
```
New-MgBetaBackupRestoreServiceApp -BodyParameter <IMicrosoftGraphServiceApp>
