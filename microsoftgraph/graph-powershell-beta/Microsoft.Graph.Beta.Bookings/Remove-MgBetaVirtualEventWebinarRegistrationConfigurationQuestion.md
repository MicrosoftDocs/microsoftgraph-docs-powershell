...
```
Remove-MgBetaVirtualEventWebinarRegistrationConfigurationQuestion
 -VirtualEventRegistrationQuestionBaseId <String> -VirtualEventWebinarId <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgBetaVirtualEventWebinarRegistrationConfigurationQuestion -InputObject <IBookingsIdentity>
