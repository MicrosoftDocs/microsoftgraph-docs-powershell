...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.bookings/update-mgbetabookingcurrency
Locale: en-US
Module Name: Microsoft.Graph.Beta.Bookings
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaBookingCurrency
---
...
```
Update-MgBetaBookingCurrency -BookingCurrencyId <string>
...
```
Update-MgBetaBookingCurrency -InputObject <IBookingsIdentity>
 -BodyParameter <IMicrosoftGraphBookingCurrency> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [Update-MgBetaBookingCurrency](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.bookings/update-mgbetabookingcurrency)
