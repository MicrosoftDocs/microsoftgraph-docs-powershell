...
```
Update-MgBetaBackupRestore [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>]
...
### Update
```
Update-MgBetaBackupRestore -BodyParameter <IMicrosoftGraphBackupRestoreRoot>
