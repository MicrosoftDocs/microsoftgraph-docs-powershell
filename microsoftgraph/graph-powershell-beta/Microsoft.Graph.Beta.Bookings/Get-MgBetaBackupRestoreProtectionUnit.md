...
### List (Default)
```
Get-MgBetaBackupRestoreProtectionUnit [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaBackupRestoreProtectionUnit -ProtectionUnitBaseId <String> [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgBetaBackupRestoreProtectionUnit -InputObject <IBookingsIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
