...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.bookings/new-mgbetabackuprestoreexchangerestoresession
schema: 2.0.0
---

# New-MgBetaBackupRestoreExchangeRestoreSession
...
```
New-MgBetaBackupRestoreExchangeRestoreSession [-ResponseHeadersVariable <String>]
...
### Create
```
New-MgBetaBackupRestoreExchangeRestoreSession -BodyParameter <IMicrosoftGraphExchangeRestoreSession>
