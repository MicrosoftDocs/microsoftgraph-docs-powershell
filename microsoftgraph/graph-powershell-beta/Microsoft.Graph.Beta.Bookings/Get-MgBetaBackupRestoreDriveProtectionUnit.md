...
### List (Default)
```
Get-MgBetaBackupRestoreDriveProtectionUnit [-ExpandProperty <String[]>] [-Property <String[]>]
...
### Get
```
Get-MgBetaBackupRestoreDriveProtectionUnit -DriveProtectionUnitId <String> [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgBetaBackupRestoreDriveProtectionUnit -InputObject <IBookingsIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
