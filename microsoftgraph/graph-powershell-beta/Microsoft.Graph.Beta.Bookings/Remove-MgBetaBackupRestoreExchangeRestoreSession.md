...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.bookings/remove-mgbetabackuprestoreexchangerestoresession
schema: 2.0.0
---

# Remove-MgBetaBackupRestoreExchangeRestoreSession
...
### Delete (Default)
```
Remove-MgBetaBackupRestoreExchangeRestoreSession -ExchangeRestoreSessionId <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgBetaBackupRestoreExchangeRestoreSession -InputObject <IBookingsIdentity> [-IfMatch <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
