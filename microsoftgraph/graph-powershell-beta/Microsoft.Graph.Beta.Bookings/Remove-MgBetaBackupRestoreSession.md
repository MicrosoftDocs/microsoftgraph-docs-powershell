...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.bookings/remove-mgbetabackuprestoresession
schema: 2.0.0
---

# Remove-MgBetaBackupRestoreSession
...
### Delete (Default)
```
Remove-MgBetaBackupRestoreSession -RestoreSessionBaseId <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgBetaBackupRestoreSession -InputObject <IBookingsIdentity> [-IfMatch <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
