...
### Delete (Default)
```
Remove-MgBusinessScenarioPlanner -BusinessScenarioId <String> [-IfMatch <String>] [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBusinessScenarioPlanner -InputObject <IBookingsIdentity> [-IfMatch <String>] [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
