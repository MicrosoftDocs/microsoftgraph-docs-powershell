...
Set-MgBetaVirtualEventWebinarSessionPresenterProfilePhoto -VirtualEventPresenterId <String>
 -VirtualEventSessionId <String> -VirtualEventWebinarId <String> [-Data <Stream>] -InFile <String>
...
### SetViaIdentity
```
Set-MgBetaVirtualEventWebinarSessionPresenterProfilePhoto -InputObject <IBookingsIdentity> [-Data <Stream>]
