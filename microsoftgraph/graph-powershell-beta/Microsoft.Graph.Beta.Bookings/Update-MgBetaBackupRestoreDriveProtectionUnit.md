...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.bookings/update-mgbetabackuprestoredriveprotectionunit
schema: 2.0.0
---

# Update-MgBetaBackupRestoreDriveProtectionUnit
...
```
Update-MgBetaBackupRestoreDriveProtectionUnit -DriveProtectionUnitId <String>
...
```
Update-MgBetaBackupRestoreDriveProtectionUnit -InputObject <IBookingsIdentity>
 [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>]
 [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <DateTime>] [-DirectoryObjectId <String>]
 [-Error <IMicrosoftGraphPublicError>] [-Id <String>] [-LastModifiedBy <IMicrosoftGraphIdentitySet>]
 [-LastModifiedDateTime <DateTime>] [-PolicyId <String>] [-Status <String>] [-Headers <IDictionary>]
