...
# New-MgBetaBackupRestoreMailboxInclusionRule
...
```
New-MgBetaBackupRestoreMailboxInclusionRule [-ResponseHeadersVariable <String>]
...
### Create
```
New-MgBetaBackupRestoreMailboxInclusionRule -BodyParameter <IMicrosoftGraphMailboxProtectionRule>
