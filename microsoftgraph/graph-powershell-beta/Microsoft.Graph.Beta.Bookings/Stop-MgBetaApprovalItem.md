...
### Cancel (Default)
```
Stop-MgBetaApprovalItem -ApprovalItemId <String> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### CancelViaIdentity
```
Stop-MgBetaApprovalItem -InputObject <IBookingsIdentity> [-ResponseHeadersVariable <String>]
...
### -ApprovalItemId
The unique identifier of approvalItem
