...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.bookings/update-mgbetabackuprestoredriveinclusionrule
schema: 2.0.0
---

# Update-MgBetaBackupRestoreDriveInclusionRule
...
```
Update-MgBetaBackupRestoreDriveInclusionRule -DriveProtectionRuleId <String>
...
```
Update-MgBetaBackupRestoreDriveInclusionRule -InputObject <IBookingsIdentity>
 [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>]
 [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <DateTime>] [-DriveExpression <String>]
 [-Error <IMicrosoftGraphPublicError>] [-Id <String>] [-IsAutoApplyEnabled]
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-LastModifiedDateTime <DateTime>] [-Status <String>]
