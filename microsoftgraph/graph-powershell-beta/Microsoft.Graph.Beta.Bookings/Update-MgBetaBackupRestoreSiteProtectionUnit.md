...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.bookings/update-mgbetabackuprestoresiteprotectionunit
schema: 2.0.0
---

# Update-MgBetaBackupRestoreSiteProtectionUnit
...
```
Update-MgBetaBackupRestoreSiteProtectionUnit -SiteProtectionUnitId <String> [-ResponseHeadersVariable <String>]
...
### Update
```
Update-MgBetaBackupRestoreSiteProtectionUnit -SiteProtectionUnitId <String>
...
```
Update-MgBetaBackupRestoreSiteProtectionUnit -InputObject <IBookingsIdentity>
