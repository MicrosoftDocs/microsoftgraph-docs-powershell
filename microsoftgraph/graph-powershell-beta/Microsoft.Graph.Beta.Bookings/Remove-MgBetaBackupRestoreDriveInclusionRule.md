...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.bookings/remove-mgbetabackuprestoredriveinclusionrule
schema: 2.0.0
---

# Remove-MgBetaBackupRestoreDriveInclusionRule
...
### Delete (Default)
```
Remove-MgBetaBackupRestoreDriveInclusionRule -DriveProtectionRuleId <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgBetaBackupRestoreDriveInclusionRule -InputObject <IBookingsIdentity> [-IfMatch <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
