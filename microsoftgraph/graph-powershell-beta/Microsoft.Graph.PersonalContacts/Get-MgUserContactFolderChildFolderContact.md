...
### List (Default)
```
Get-MgUserContactFolderChildFolderContact -ContactFolderId <String> -ContactFolderId1 <String> -UserId <String>
...
### GetViaIdentity1
```
Get-MgUserContactFolderChildFolderContact -InputObject <IPersonalContactsIdentity> [-ExpandProperty <String[]>]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.personalcontacts/get-mgusercontactfolderchildfoldercontact](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.personalcontacts/get-mgusercontactfolderchildfoldercontact)
