...
```
New-MgBetaUserContact -UserId <String> [-AdditionalProperties <Hashtable>] [-AssistantName <String>]
...
### Create
```
New-MgBetaUserContact -UserId <String> -BodyParameter <IMicrosoftGraphContact> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgBetaUserContact -InputObject <IPersonalContactsIdentity> [-AdditionalProperties <Hashtable>]
...
### CreateViaIdentity
```
New-MgBetaUserContact -InputObject <IPersonalContactsIdentity> -BodyParameter <IMicrosoftGraphContact>
