...
Read the properties and relationships of crossTenantMigrationJob object.
...
```
Get-MgBetaCrossTenantMigrationJob [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaCrossTenantMigrationJob -CrossTenantMigrationJobId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaCrossTenantMigrationJob -InputObject <IMigrationsIdentity> [-ExpandProperty <string[]>]
 [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
```
