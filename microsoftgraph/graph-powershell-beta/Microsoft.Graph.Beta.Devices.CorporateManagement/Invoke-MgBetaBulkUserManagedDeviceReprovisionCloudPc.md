...
```
Invoke-MgBetaBulkUserManagedDeviceReprovisionCloudPc -UserId <String> [-ResponseHeadersVariable <String>]
...
### Bulk
```
Invoke-MgBetaBulkUserManagedDeviceReprovisionCloudPc -UserId <String>
...
```
Invoke-MgBetaBulkUserManagedDeviceReprovisionCloudPc -InputObject <IDevicesCorporateManagementIdentity>
