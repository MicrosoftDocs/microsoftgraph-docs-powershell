...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/update-mgbetadeviceappmanagementmobileappaswindowsappxrelationship
Locale: en-US
Module Name: Microsoft.Graph.Beta.Devices.CorporateManagement
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaDeviceAppManagementMobileAppAsWindowsAppXRelationship
---
...
```
Update-MgBetaDeviceAppManagementMobileAppAsWindowsAppXRelationship -MobileAppId <string>
 -MobileAppRelationshipId <string> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Id <string>] [-TargetId <string>]
 [-TargetType <MobileAppRelationshipType>] [-Break] [-Headers <IDictionary>]
...
```
Update-MgBetaDeviceAppManagementMobileAppAsWindowsAppXRelationship -MobileAppId <string>
 -MobileAppRelationshipId <string> -BodyParameter <IMicrosoftGraphMobileAppRelationship>
...
Update-MgBetaDeviceAppManagementMobileAppAsWindowsAppXRelationship
 ...
 -BodyParameter <IMicrosoftGraphMobileAppRelationship> [-ResponseHeadersVariable <string>] [-Break]
...
BODYPARAMETER `<IMicrosoftGraphMobileAppRelationship>`: The MobileAppRelationship describes the relationship between two mobile applications by providing information that tells if an application is dependent on or superseded by another application.
...
- [Update-MgBetaDeviceAppManagementMobileAppAsWindowsAppXRelationship](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/update-mgbetadeviceappmanagementmobileappaswindowsappxrelationship)
