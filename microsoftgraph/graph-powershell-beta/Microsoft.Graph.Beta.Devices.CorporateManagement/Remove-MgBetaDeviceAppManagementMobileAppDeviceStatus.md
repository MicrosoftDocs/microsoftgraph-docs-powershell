...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/remove-mgbetadeviceappmanagementmobileappdevicestatus
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Remove-MgDeviceAppManagementMobileAppDeviceStatus](/powershell/module/Microsoft.Graph.Devices.CorporateManagement/Remove-MgDeviceAppManagementMobileAppDeviceStatus?view=graph-powershell-v1.0)

## SYNTAX

### Delete (Default)
```
Remove-MgBetaDeviceAppManagementMobileAppDeviceStatus -MobileAppId <String> -MobileAppInstallStatusId <String>
 [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaDeviceAppManagementMobileAppDeviceStatus -InputObject <IDevicesCorporateManagementIdentity>
 [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
