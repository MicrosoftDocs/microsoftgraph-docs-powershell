...
Update-MgDeviceAppMgtiOSLobAppProvisioningConfigurationGroupAssignment
 -IosLobAppProvisioningConfigurationId <String> -MobileAppProvisioningConfigGroupAssignmentId <String>
 -BodyParameter <IMicrosoftGraphMobileAppProvisioningConfigGroupAssignment> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmgtioslobappprovisioningconfigurationgroupassignment](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/update-mgdeviceappmgtioslobappprovisioningconfigurationgroupassignment)
