...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/get-mgbetausermanageddevicepowerliftappdiagnosticdetail
schema: 2.0.0
---
...
### Retrieve (Default)
```
Get-MgBetaUserManagedDevicePowerliftAppDiagnosticDetail -UserId <String> -UserPrincipalName <String> [-Count]
...
### RetrieveViaIdentity
```
Get-MgBetaUserManagedDevicePowerliftAppDiagnosticDetail -InputObject <IDevicesCorporateManagementIdentity>
