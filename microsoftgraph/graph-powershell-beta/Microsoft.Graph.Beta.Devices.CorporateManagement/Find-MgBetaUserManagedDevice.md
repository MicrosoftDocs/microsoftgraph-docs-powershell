...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/find-mgbetausermanageddevice
schema: 2.0.0
---
...
### Locate (Default)
```
Find-MgBetaUserManagedDevice -ManagedDeviceId <String> -UserId <String> [-ResponseHeadersVariable <String>]
