...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/new-mgbetadeviceappmanagementmobileappaswindowsuniversalappxcontentversionfile
schema: 2.0.0
---
...
```
New-MgBetaDeviceAppManagementMobileAppAsWindowsUniversalAppXContentVersionFile -MobileAppContentId <String>
...
```
New-MgBetaDeviceAppManagementMobileAppAsWindowsUniversalAppXContentVersionFile -MobileAppContentId <String>
 -MobileAppId <String> -BodyParameter <IMicrosoftGraphMobileAppContentFile> [-Headers <IDictionary>]
