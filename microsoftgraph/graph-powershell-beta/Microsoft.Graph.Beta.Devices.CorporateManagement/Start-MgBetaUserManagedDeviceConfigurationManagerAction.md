...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/start-mgbetausermanageddeviceconfigurationmanageraction
schema: 2.0.0
---
...
```
Start-MgBetaUserManagedDeviceConfigurationManagerAction -InputObject <IDevicesCorporateManagementIdentity>
 [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>]
 [-ConfigurationManagerAction <IMicrosoftGraphConfigurationManagerAction>] [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
