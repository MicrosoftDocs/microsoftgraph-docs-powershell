...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/new-mgbetadeviceappmanagementmobileappuserstatus
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgDeviceAppManagementMobileAppUserStatus](/powershell/module/Microsoft.Graph.Devices.CorporateManagement/New-MgDeviceAppManagementMobileAppUserStatus?view=graph-powershell-v1.0)

## SYNTAX

### CreateExpanded (Default)
```
New-MgBetaDeviceAppManagementMobileAppUserStatus -MobileAppId <String> [-AdditionalProperties <Hashtable>]
...
### Create
```
New-MgBetaDeviceAppManagementMobileAppUserStatus -MobileAppId <String>
 -BodyParameter <IMicrosoftGraphUserAppInstallStatus> [-WhatIf] [-Confirm] [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-MgBetaDeviceAppManagementMobileAppUserStatus -InputObject <IDevicesCorporateManagementIdentity>
...
## RELATED LINKS
[New-MgDeviceAppManagementMobileAppUserStatus](/powershell/module/Microsoft.Graph.Devices.CorporateManagement/New-MgDeviceAppManagementMobileAppUserStatus?view=graph-powershell-v1.0)

[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/new-mgbetadeviceappmanagementmobileappuserstatus](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/new-mgbetadeviceappmanagementmobileappuserstatus)
