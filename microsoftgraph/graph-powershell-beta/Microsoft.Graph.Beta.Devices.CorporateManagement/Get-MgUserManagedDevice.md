...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgusermanageddevice
schema: 2.0.0
---
...
### List (Default)
```
Get-MgUserManagedDevice -UserId <String> [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
