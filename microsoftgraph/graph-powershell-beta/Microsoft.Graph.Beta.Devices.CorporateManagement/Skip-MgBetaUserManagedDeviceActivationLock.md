...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/skip-mgbetausermanageddeviceactivationlock
schema: 2.0.0
---
...
### BypassViaIdentity
```
Skip-MgBetaUserManagedDeviceActivationLock -InputObject <IDevicesCorporateManagementIdentity>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
