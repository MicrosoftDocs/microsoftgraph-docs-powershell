...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/get-mgbetausermanageddevicenoncompliantsetting
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgBetaUserManagedDeviceNonCompliantSetting -InputObject <IDevicesCorporateManagementIdentity> [-Count]
 [-Filter <String>] [-Search <String>] [-Skip <Int32>] [-Top <Int32>] [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
