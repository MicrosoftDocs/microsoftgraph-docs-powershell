...
### List (Default)
```
Get-MgBetaDeviceAppManagementMobileAppRelationship [-ExpandProperty <String[]>] [-Property <String[]>]
...
### Get1
```
Get-MgBetaDeviceAppManagementMobileAppRelationship -MobileAppRelationshipId <String> -MobileAppId <String>
