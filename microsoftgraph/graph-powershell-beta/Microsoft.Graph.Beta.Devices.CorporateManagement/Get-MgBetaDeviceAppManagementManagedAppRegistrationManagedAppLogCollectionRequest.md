...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/get-mgbetadeviceappmanagementmanagedappregistrationmanagedapplogcollectionrequest
schema: 2.0.0
---
...
```
Get-MgBetaDeviceAppManagementManagedAppRegistrationManagedAppLogCollectionRequest
 -ManagedAppRegistrationId <String> [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
```
Get-MgBetaDeviceAppManagementManagedAppRegistrationManagedAppLogCollectionRequest
 -ManagedAppLogCollectionRequestId <String> -ManagedAppRegistrationId <String> [-ExpandProperty <String[]>]
