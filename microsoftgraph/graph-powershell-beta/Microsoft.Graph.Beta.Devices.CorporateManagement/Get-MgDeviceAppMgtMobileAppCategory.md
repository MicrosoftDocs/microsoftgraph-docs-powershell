...
### List (Default)
```
Get-MgDeviceAppMgtMobileAppCategory [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
### List1
```
Get-MgDeviceAppMgtMobileAppCategory -MobileAppId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
