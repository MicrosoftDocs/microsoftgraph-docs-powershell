...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.people/new-mgbetauserprofileinterest
Locale: en-US
Module Name: Microsoft.Graph.Beta.People
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaUserProfileInterest
---
...
```
New-MgBetaUserProfileInterest -UserId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaUserProfileInterest -InputObject <IPeopleIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-AllowedAudiences <string>] [-Categories <string[]>]
 [-CollaborationTags <string[]>] [-CreatedBy <IMicrosoftGraphIdentitySet>]
 [-CreatedDateTime <datetime>] [-Description <string>] [-DisplayName <string>] [-Id <string>]
 [-Inference <IMicrosoftGraphInferenceData>] [-IsSearchable]
...
```
New-MgBetaUserProfileInterest -InputObject <IPeopleIdentity>
 -BodyParameter <IMicrosoftGraphPersonInterest> [-ResponseHeadersVariable <string>] [-Break]
...
- [New-MgBetaUserProfileInterest](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.people/new-mgbetauserprofileinterest)
