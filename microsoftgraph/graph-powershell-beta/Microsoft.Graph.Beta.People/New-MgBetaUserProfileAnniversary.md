...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.people/new-mgbetauserprofileanniversary
Locale: en-US
Module Name: Microsoft.Graph.Beta.People
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: New-MgBetaUserProfileAnniversary
---
...
```
New-MgBetaUserProfileAnniversary -UserId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaUserProfileAnniversary -InputObject <IPeopleIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-AllowedAudiences <string>]
 [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <datetime>] [-Date <datetime>]
 [-DisplayName <string>] [-Id <string>] [-Inference <IMicrosoftGraphInferenceData>] [-IsSearchable]
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-LastModifiedDateTime <datetime>]
...
New-MgBetaUserProfileAnniversary -InputObject <IPeopleIdentity>
 -BodyParameter <IMicrosoftGraphPersonAnnualEvent> [-ResponseHeadersVariable <string>] [-Break]
