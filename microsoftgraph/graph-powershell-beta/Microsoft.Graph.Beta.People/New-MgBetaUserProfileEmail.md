...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgUserProfileEmail](/powershell/module/Microsoft.Graph.People/New-MgUserProfileEmail?view=graph-powershell-v1.0)
...
### Create
```
New-MgBetaUserProfileEmail -UserId <String> -BodyParameter <IMicrosoftGraphItemEmail> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### CreateViaIdentity
```
New-MgBetaUserProfileEmail -InputObject <IPeopleIdentity> -BodyParameter <IMicrosoftGraphItemEmail> [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
## RELATED LINKS
[New-MgUserProfileEmail](/powershell/module/Microsoft.Graph.People/New-MgUserProfileEmail?view=graph-powershell-v1.0)
