...
```
Update-MgBetaUserProfileEmail -ItemEmailId <string> -UserId <string>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-Address <string>]
...
```
Update-MgBetaUserProfileEmail -ItemEmailId <string> -UserId <string>
 -BodyParameter <IMicrosoftGraphItemEmail> [-ResponseHeadersVariable <string>] [-Break]
...
```
Update-MgBetaUserProfileEmail -InputObject <IPeopleIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaUserProfileEmail -InputObject <IPeopleIdentity>
 -BodyParameter <IMicrosoftGraphItemEmail> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm] [<CommonParameters>]
