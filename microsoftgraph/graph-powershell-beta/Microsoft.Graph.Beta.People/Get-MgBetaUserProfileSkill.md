...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.people/get-mgbetauserprofileskill
Locale: en-US
Module Name: Microsoft.Graph.Beta.People
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaUserProfileSkill
---
...
```
Get-MgBetaUserProfileSkill -UserId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaUserProfileSkill -SkillProficiencyId <string> -UserId <string>
...
```
Get-MgBetaUserProfileSkill -InputObject <IPeopleIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgBetaUserProfileSkill](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.people/get-mgbetauserprofileskill)
