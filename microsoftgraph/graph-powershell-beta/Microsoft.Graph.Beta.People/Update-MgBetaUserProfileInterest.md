...
```
Update-MgBetaUserProfileInterest -InputObject <IPeopleIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaUserProfileInterest -InputObject <IPeopleIdentity>
 -BodyParameter <IMicrosoftGraphPersonInterest> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm] [<CommonParameters>]
