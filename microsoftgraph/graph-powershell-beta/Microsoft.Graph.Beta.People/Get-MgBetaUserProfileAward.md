...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.people/get-mgbetauserprofileaward
Locale: en-US
Module Name: Microsoft.Graph.Beta.People
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaUserProfileAward
---
...
```
Get-MgBetaUserProfileAward -InputObject <IPeopleIdentity> [-ExpandProperty <string[]>]
 [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
```
...
- [Get-MgBetaUserProfileAward](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.people/get-mgbetauserprofileaward)
