...
# Remove-MgBetaUserActivityStatistics
...
### Delete (Default)
```
Remove-MgBetaUserActivityStatistics -ActivityStatisticsId <String> -UserId <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgBetaUserActivityStatistics -InputObject <IPeopleIdentity> [-IfMatch <String>] [-Headers <IDictionary>]
