...
### Get (Default)
```
Get-MgBetaUserProfileAddressCount -UserId <String> [-Filter <String>] [-Search <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaUserProfileAddressCount -InputObject <IPeopleIdentity> [-Filter <String>] [-Search <String>]
 [<CommonParameters>]
```
