...
### List (Default)
```
Get-MgUserProfileAnniversary -UserId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgUserProfileAnniversary -InputObject <IPeopleIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
...
### -PersonAnnualEventId
The unique identifier of personAnnualEvent
