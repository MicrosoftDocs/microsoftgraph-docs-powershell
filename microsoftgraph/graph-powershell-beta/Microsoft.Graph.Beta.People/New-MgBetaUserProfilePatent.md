...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.people/new-mgbetauserprofilepatent
Locale: en-US
Module Name: Microsoft.Graph.Beta.People
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaUserProfilePatent
---
...
New-MgBetaUserProfilePatent -UserId <string> [-ResponseHeadersVariable <string>]
 ...
 [-Sources <IMicrosoftGraphProfileSourceAnnotation[]>] [-WebUrl <string>] [-Break]
...
```
New-MgBetaUserProfilePatent -InputObject <IPeopleIdentity>
 -BodyParameter <IMicrosoftGraphItemPatent> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
- [New-MgBetaUserProfilePatent](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.people/new-mgbetauserprofilepatent)
