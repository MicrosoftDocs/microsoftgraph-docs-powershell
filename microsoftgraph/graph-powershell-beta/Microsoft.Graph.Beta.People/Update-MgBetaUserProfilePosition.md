...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.people/update-mgbetauserprofileposition
Locale: en-US
Module Name: Microsoft.Graph.Beta.People
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaUserProfilePosition
---
...
Update-MgBetaUserProfilePosition -UserId <string> -WorkPositionId <string>
 ...
 [-AllowedAudiences <string>] [-Categories <string[]>]
...
```
Update-MgBetaUserProfilePosition -InputObject <IPeopleIdentity>
 -BodyParameter <IMicrosoftGraphWorkPosition> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [Update-MgBetaUserProfilePosition](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.people/update-mgbetauserprofileposition)
