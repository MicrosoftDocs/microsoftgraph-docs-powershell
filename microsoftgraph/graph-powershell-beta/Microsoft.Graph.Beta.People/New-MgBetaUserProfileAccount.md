...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.people/new-mgbetauserprofileaccount
Locale: en-US
Module Name: Microsoft.Graph.Beta.People
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: New-MgBetaUserProfileAccount
---
...
```
New-MgBetaUserProfileAccount -UserId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaUserProfileAccount -InputObject <IPeopleIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-AgeGroup <string>] [-AllowedAudiences <string>]
 [-CountryCode <string>] [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <datetime>]
 [-Id <string>] [-Inference <IMicrosoftGraphInferenceData>] [-IsSearchable]
 [-LastModifiedBy <IMicrosoftGraphIdentitySet>] [-LastModifiedDateTime <datetime>]
