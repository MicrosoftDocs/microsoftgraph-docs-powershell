...
```
New-MgBetaUserProfileEducationalActivity -UserId <string>
...
- [New-MgBetaUserProfileEducationalActivity](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.people/new-mgbetauserprofileeducationalactivity)
