...
### DeleteViaIdentity
```
Remove-MgBetaUserProfileAnniversary -InputObject <IPeopleIdentity> [-IfMatch <String>] [-Headers <IDictionary>]
...
**Permissions**
[!INCLUDE [permissions-table](~/../graphref/api-reference/beta/includes/permissions/personanniversary-delete-permissions.md)]
