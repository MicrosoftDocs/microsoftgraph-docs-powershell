...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.people/update-mgbetauseranalyticactivitystatistic
schema: 2.0.0
---

# Update-MgBetaUserAnalyticActivitystatistic

## SYNOPSIS
Update the navigation property activityStatistics in users

> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgUserAnalyticActivitystatistic](/powershell/module/Microsoft.Graph.People/Update-MgUserAnalyticActivitystatistic?view=graph-powershell-v1.0)

## SYNTAX

### UpdateExpanded (Default)
```
Update-MgBetaUserAnalyticActivitystatistic -ActivityStatisticsId <String> -UserId <String> [-Activity <String>]
...
### Update
```
Update-MgBetaUserAnalyticActivitystatistic -ActivityStatisticsId <String> -UserId <String>
 -BodyParameter <IMicrosoftGraphActivityStatistics> [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgBetaUserAnalyticActivitystatistic -InputObject <IPeopleIdentity> [-Activity <String>]
 [-AdditionalProperties <Hashtable>] [-Duration <TimeSpan>] [-EndDate <DateTime>] [-Id <String>]
 [-StartDate <DateTime>] [-TimeZoneUsed <String>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### UpdateViaIdentity
```
Update-MgBetaUserAnalyticActivitystatistic -InputObject <IPeopleIdentity>
 -BodyParameter <IMicrosoftGraphActivityStatistics> [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgUserAnalyticActivitystatistic](/powershell/module/Microsoft.Graph.People/Update-MgUserAnalyticActivitystatistic?view=graph-powershell-v1.0)

[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.people/update-mgbetauseranalyticactivitystatistic](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.people/update-mgbetauseranalyticactivitystatistic)
