...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgUserProfileName](/powershell/module/Microsoft.Graph.People/Get-MgUserProfileName?view=graph-powershell-v1.0)
...
### GetViaIdentity
```
Get-MgBetaUserProfileName -InputObject <IPeopleIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
