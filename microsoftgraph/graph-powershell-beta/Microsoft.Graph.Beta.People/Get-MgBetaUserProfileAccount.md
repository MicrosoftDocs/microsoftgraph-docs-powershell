...
```
Get-MgBetaUserProfileAccount -UserAccountInformationId <string> -UserId <string>
...
- [Get-MgBetaUserProfileAccount](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.people/get-mgbetauserprofileaccount)
