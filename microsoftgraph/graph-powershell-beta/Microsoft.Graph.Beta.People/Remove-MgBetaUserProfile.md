...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.people/remove-mgbetauserprofile
Locale: en-US
Module Name: Microsoft.Graph.Beta.People
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: Remove-MgBetaUserProfile
---
...
```
Remove-MgBetaUserProfile -UserId <string> [-IfMatch <string>] [-ResponseHeadersVariable <string>]
...
```
Remove-MgBetaUserProfile -InputObject <IPeopleIdentity> [-IfMatch <string>]
...
- [Remove-MgBetaUserProfile](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.people/remove-mgbetauserprofile)
