...
### Create (Default)
```
New-MgPrintPrinterShareAllowedUserByRef -PrinterShareId <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-MgPrintPrinterShareAllowedUserByRef -InputObject <IDevicesCloudPrintIdentity> [-PassThru] [-WhatIf]
