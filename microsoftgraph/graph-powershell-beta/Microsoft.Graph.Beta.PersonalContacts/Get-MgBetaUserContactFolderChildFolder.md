...
```
Get-MgBetaUserContactFolderChildFolder -ContactFolderId <string> -UserId <string>
...
```
Get-MgBetaUserContactFolderChildFolder -ContactFolderId <string> -ContactFolderId1 <string>
...
```
Get-MgBetaUserContactFolderChildFolder -InputObject <IPersonalContactsIdentity>
...
- [Get-MgBetaUserContactFolderChildFolder](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.personalcontacts/get-mgbetausercontactfolderchildfolder)
