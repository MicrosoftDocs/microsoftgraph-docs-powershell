...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.personalcontacts/get-mgbetausercontactfolderdelta
schema: 2.0.0
...
### Delta (Default)
```
Get-MgBetaUserContactFolderDelta -UserId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### DeltaViaIdentity
```
Get-MgBetaUserContactFolderDelta -InputObject <IPersonalContactsIdentity> [-ExpandProperty <String[]>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.personalcontacts/get-mgbetausercontactfolderdelta](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.personalcontacts/get-mgbetausercontactfolderdelta)
