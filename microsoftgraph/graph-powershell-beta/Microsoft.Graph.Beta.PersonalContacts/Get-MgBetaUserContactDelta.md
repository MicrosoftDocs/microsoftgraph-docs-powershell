...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.personalcontacts/get-mgbetausercontactdelta
schema: 2.0.0
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgUserContactDelta](/powershell/module/Microsoft.Graph.PersonalContacts/Get-MgUserContactDelta?view=graph-powershell-1.0)

## SYNTAX

### Delta (Default)
```
Get-MgBetaUserContactDelta -UserId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### DeltaViaIdentity
```
Get-MgBetaUserContactDelta -InputObject <IPersonalContactsIdentity> [-ExpandProperty <String[]>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.personalcontacts/get-mgbetausercontactdelta](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.personalcontacts/get-mgbetausercontactdelta)
