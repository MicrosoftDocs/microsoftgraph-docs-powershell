...
```
New-MgUserContactFolderChildFolderContactSingleValueExtendedProperty -ContactFolderId <String>
...
```
New-MgUserContactFolderChildFolderContactSingleValueExtendedProperty -InputObject <IPersonalContactsIdentity>
