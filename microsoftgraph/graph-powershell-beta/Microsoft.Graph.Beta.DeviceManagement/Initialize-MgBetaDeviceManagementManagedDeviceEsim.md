...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/initialize-mgbetadevicemanagementmanageddeviceesim
schema: 2.0.0
---
...
```
Initialize-MgBetaDeviceManagementManagedDeviceEsim -InputObject <IDeviceManagementIdentity>
 [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>] [-CarrierUrl <String>]
 [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/initialize-mgbetadevicemanagementmanageddeviceesim](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/initialize-mgbetadevicemanagementmanageddeviceesim)
