...
Update-MgBetaDeviceManagementIntentUserState -InputObject <IDeviceManagementIdentity>
 ...
 [-State <String>] [-UserName <String>] [-UserPrincipalName <String>] [-Headers <IDictionary>]
...
```
Update-MgBetaDeviceManagementIntentUserState -InputObject <IDeviceManagementIdentity>
 -BodyParameter <IMicrosoftGraphDeviceManagementIntentUserState> [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
