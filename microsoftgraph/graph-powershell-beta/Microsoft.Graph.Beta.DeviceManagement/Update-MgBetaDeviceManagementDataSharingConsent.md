...
Update-MgBetaDeviceManagementDataSharingConsent -DataSharingConsentId <String>
 ...
 [-GrantedByUserId <String>] [-Id <String>] [-ServiceDisplayName <String>] [-TermsUrl <String>] [-WhatIf]
...
```
Update-MgBetaDeviceManagementDataSharingConsent -DataSharingConsentId <String>
 -BodyParameter <IMicrosoftGraphDataSharingConsent> [-WhatIf] [-Confirm] [<CommonParameters>]
```
