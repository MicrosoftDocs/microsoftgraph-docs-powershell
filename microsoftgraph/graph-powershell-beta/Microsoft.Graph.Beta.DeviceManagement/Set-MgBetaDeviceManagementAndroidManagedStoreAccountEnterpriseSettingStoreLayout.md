...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths1LchbyDevicemanagementAndroidmanagedstoreaccountenterprisesettingsMicrosoftGraphSetstorelayoutPostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
The store layout types for Managed Google Play.
Values correspond directly to the store layout types of Google enterprise objects.

```yaml
Type: Microsoft.Graph.Beta.PowerShell.Support.AndroidManagedStoreLayoutType
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths1LchbyDevicemanagementAndroidmanagedstoreaccountenterprisesettingsMicrosoftGraphSetstorelayoutPostRequestbodyContentApplicationJsonSchema
