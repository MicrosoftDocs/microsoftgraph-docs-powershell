...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/update-mgbetadevicemanagementcomanageddeviceconfigurationstate
Locale: en-US
Module Name: Microsoft.Graph.Beta.DeviceManagement
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaDeviceManagementComanagedDeviceConfigurationState
---
...
Update-MgBetaDeviceManagementComanagedDeviceConfigurationState -DeviceConfigurationStateId <string>
 ...
 [-UserId <string>] [-UserPrincipalName <string>] [-Version <int>] [-Break] [-Headers <IDictionary>]
...
```
Update-MgBetaDeviceManagementComanagedDeviceConfigurationState
 -InputObject <IDeviceManagementIdentity> -BodyParameter <IMicrosoftGraphDeviceConfigurationState>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
- [Update-MgBetaDeviceManagementComanagedDeviceConfigurationState](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/update-mgbetadevicemanagementcomanageddeviceconfigurationstate)
