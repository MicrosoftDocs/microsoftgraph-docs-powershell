...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement/get-mgdevicemanagementuserexperienceanalyticnotautopilotreadydevice
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceManagementUserExperienceAnalyticNotAutopilotReadyDevice [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgDeviceManagementUserExperienceAnalyticNotAutopilotReadyDevice -InputObject <IDeviceManagementIdentity>
