...
### List (Default)
```
Get-MgBetaDeviceManagementManagedDeviceHealthScriptState -ManagedDeviceId <String> [-ExpandProperty <String[]>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementmanageddevicehealthscriptstate](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementmanageddevicehealthscriptstate)
