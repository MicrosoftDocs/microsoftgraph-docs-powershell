...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgAdminEdgeInternetExplorerMode](/powershell/module/Microsoft.Graph.DeviceManagement/Update-MgAdminEdgeInternetExplorerMode?view=graph-powershell-v1.0)
...
### Update
```
Update-MgBetaAdminEdgeInternetExplorerMode -BodyParameter <IMicrosoftGraphInternetExplorerMode> [-WhatIf]
...
## RELATED LINKS
[Update-MgAdminEdgeInternetExplorerMode](/powershell/module/Microsoft.Graph.DeviceManagement/Update-MgAdminEdgeInternetExplorerMode?view=graph-powershell-v1.0)
