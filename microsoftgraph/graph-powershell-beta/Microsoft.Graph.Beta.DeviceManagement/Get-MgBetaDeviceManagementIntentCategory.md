...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementintentcategory
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaDeviceManagementIntentCategory -DeviceManagementIntentId <String> [-ExpandProperty <String[]>]
...
### Get
```
Get-MgBetaDeviceManagementIntentCategory -DeviceManagementIntentId <String>
 -DeviceManagementIntentSettingCategoryId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgBetaDeviceManagementIntentCategory -InputObject <IDeviceManagementIdentity> [-ExpandProperty <String[]>]
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphDeviceManagementIntentSettingCategory
## NOTES
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementintentcategory](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementintentcategory)
