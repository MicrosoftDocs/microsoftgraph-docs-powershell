...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/remove-mgbetadevicemanagementdeviceshellscriptuserrunstate
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Remove-MgDeviceManagementDeviceShellScriptUserRunState](/powershell/module/Microsoft.Graph.DeviceManagement/Remove-MgDeviceManagementDeviceShellScriptUserRunState?view=graph-powershell-v1.0)

## SYNTAX

### Delete (Default)
```
Remove-MgBetaDeviceManagementDeviceShellScriptUserRunState -DeviceManagementScriptUserStateId <String>
 -DeviceShellScriptId <String> [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementDeviceShellScriptUserRunState -InputObject <IDeviceManagementIdentity>
...
## RELATED LINKS
[Remove-MgDeviceManagementDeviceShellScriptUserRunState](/powershell/module/Microsoft.Graph.DeviceManagement/Remove-MgDeviceManagementDeviceShellScriptUserRunState?view=graph-powershell-v1.0)
