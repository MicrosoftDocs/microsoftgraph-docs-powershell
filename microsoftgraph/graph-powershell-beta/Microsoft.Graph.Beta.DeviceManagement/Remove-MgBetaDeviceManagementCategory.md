...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Remove-MgDeviceManagementCategory](/powershell/module/Microsoft.Graph.DeviceManagement/Remove-MgDeviceManagementCategory?view=graph-powershell-v1.0)
...
### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementCategory -InputObject <IDeviceManagementIdentity> [-IfMatch <String>] [-PassThru]
...
## RELATED LINKS
[Remove-MgDeviceManagementCategory](/powershell/module/Microsoft.Graph.DeviceManagement/Remove-MgDeviceManagementCategory?view=graph-powershell-v1.0)
