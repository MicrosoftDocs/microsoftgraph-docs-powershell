...
New-MgBetaDeviceManagementTemplateMigratableToSetting -DeviceManagementTemplateId <String>
 -DeviceManagementTemplateId1 <String> [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>]
 [-DefinitionId <String>] [-Id <String>] [-ValueJson <String>] [-Headers <IDictionary>]
