...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/set-mgbetadevicemanagementmanageddevicename
schema: 2.0.0
---
...
### SetExpanded (Default)
```
Set-MgBetaDeviceManagementManagedDeviceName -ManagedDeviceId <String> [-ResponseHeadersVariable <String>]
...
```
Set-MgBetaDeviceManagementManagedDeviceName -InputObject <IDeviceManagementIdentity>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/set-mgbetadevicemanagementmanageddevicename](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/set-mgbetadevicemanagementmanageddevicename)
