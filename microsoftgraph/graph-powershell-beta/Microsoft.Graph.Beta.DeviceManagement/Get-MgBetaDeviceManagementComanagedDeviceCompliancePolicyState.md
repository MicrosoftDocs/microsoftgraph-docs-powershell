...
Get-MgBetaDeviceManagementComanagedDeviceCompliancePolicyState -DeviceCompliancePolicyStateId <String>
 -ManagedDeviceId <String> [-ExpandProperty <String[]>] [-Property <String[]>] [-Headers <IDictionary>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementcomanageddevicecompliancepolicystate](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementcomanageddevicecompliancepolicystate)
