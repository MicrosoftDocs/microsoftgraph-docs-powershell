...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementscriptuserrunstatecount
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgDeviceManagementScriptUserRunStateCount](/powershell/module/Microsoft.Graph.DeviceManagement/Get-MgDeviceManagementScriptUserRunStateCount?view=graph-powershell-v1.0)

## SYNTAX

### Get (Default)
```
Get-MgBetaDeviceManagementScriptUserRunStateCount -DeviceManagementScriptId <String> [-Filter <String>]
 [-Search <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDeviceManagementScriptUserRunStateCount -InputObject <IDeviceManagementIdentity> [-Filter <String>]
 [-Search <String>] [<CommonParameters>]
```
...
## RELATED LINKS
[Get-MgDeviceManagementScriptUserRunStateCount](/powershell/module/Microsoft.Graph.DeviceManagement/Get-MgDeviceManagementScriptUserRunStateCount?view=graph-powershell-v1.0)
