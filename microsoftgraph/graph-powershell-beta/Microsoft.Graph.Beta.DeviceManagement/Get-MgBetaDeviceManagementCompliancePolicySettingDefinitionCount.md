...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementcompliancepolicysettingdefinitioncount
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgDeviceManagementCompliancePolicySettingDefinitionCount](/powershell/module/Microsoft.Graph.DeviceManagement/Get-MgDeviceManagementCompliancePolicySettingDefinitionCount?view=graph-powershell-v1.0)

## SYNTAX

### Get (Default)
```
Get-MgBetaDeviceManagementCompliancePolicySettingDefinitionCount -DeviceManagementCompliancePolicyId <String>
 -DeviceManagementConfigurationSettingId <String> [-Filter <String>] [-Search <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDeviceManagementCompliancePolicySettingDefinitionCount -InputObject <IDeviceManagementIdentity>
...
## RELATED LINKS
[Get-MgDeviceManagementCompliancePolicySettingDefinitionCount](/powershell/module/Microsoft.Graph.DeviceManagement/Get-MgDeviceManagementCompliancePolicySettingDefinitionCount?view=graph-powershell-v1.0)
