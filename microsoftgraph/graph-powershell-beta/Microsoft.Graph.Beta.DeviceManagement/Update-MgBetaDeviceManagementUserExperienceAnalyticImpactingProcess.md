...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgDeviceManagementUserExperienceAnalyticImpactingProcess](/powershell/module/Microsoft.Graph.DeviceManagement/Update-MgDeviceManagementUserExperienceAnalyticImpactingProcess?view=graph-powershell-v1.0)
...
Update-MgBetaDeviceManagementUserExperienceAnalyticImpactingProcess
 ...
 [-Publisher <String>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
Update-MgBetaDeviceManagementUserExperienceAnalyticImpactingProcess -InputObject <IDeviceManagementIdentity>
 ...
 [-Id <String>] [-ImpactValue <Double>] [-ProcessName <String>] [-Publisher <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgDeviceManagementUserExperienceAnalyticImpactingProcess](/powershell/module/Microsoft.Graph.DeviceManagement/Update-MgDeviceManagementUserExperienceAnalyticImpactingProcess?view=graph-powershell-v1.0)
