...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/invoke-mgbetarotatedevicemanagementcomanageddevicelocaladminpassword
schema: 2.0.0
---
...
### RotateViaIdentity
```
Invoke-MgBetaRotateDeviceManagementComanagedDeviceLocalAdminPassword -InputObject <IDeviceManagementIdentity>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
