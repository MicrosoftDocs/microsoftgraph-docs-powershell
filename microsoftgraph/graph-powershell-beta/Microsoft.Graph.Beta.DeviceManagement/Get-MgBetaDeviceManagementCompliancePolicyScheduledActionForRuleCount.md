...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementcompliancepolicyscheduledactionforrulecount
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgDeviceManagementCompliancePolicyScheduledActionForRuleCount](/powershell/module/Microsoft.Graph.DeviceManagement/Get-MgDeviceManagementCompliancePolicyScheduledActionForRuleCount?view=graph-powershell-v1.0)
...
```
Get-MgBetaDeviceManagementCompliancePolicyScheduledActionForRuleCount
 -DeviceManagementCompliancePolicyId <String> [-Filter <String>] [-Search <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDeviceManagementCompliancePolicyScheduledActionForRuleCount -InputObject <IDeviceManagementIdentity>
...
## RELATED LINKS
[Get-MgDeviceManagementCompliancePolicyScheduledActionForRuleCount](/powershell/module/Microsoft.Graph.DeviceManagement/Get-MgDeviceManagementCompliancePolicyScheduledActionForRuleCount?view=graph-powershell-v1.0)
