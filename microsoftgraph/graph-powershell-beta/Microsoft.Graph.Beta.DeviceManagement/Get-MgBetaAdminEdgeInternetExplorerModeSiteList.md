...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgAdminEdgeInternetExplorerModeSiteList](/powershell/module/Microsoft.Graph.DeviceManagement/Get-MgAdminEdgeInternetExplorerModeSiteList?view=graph-powershell-v1.0)

## SYNTAX

### List (Default)
```
Get-MgBetaAdminEdgeInternetExplorerModeSiteList [-ExpandProperty <String[]>] [-Property <String[]>]
...
## RELATED LINKS
[Get-MgAdminEdgeInternetExplorerModeSiteList](/powershell/module/Microsoft.Graph.DeviceManagement/Get-MgAdminEdgeInternetExplorerModeSiteList?view=graph-powershell-v1.0)
