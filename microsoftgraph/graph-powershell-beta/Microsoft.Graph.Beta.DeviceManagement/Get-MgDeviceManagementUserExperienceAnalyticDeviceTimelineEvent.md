...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement/get-mgdevicemanagementuserexperienceanalyticdevicetimelineevent
schema: 2.0.0
---
...
### List (Default)
```
Get-MgDeviceManagementUserExperienceAnalyticDeviceTimelineEvent [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgDeviceManagementUserExperienceAnalyticDeviceTimelineEvent -InputObject <IDeviceManagementIdentity>
