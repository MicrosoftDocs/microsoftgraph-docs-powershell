...
- [Update-MgBetaAdminEdgeInternetExplorerModeSiteListSite](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/update-mgbetaadminedgeinternetexplorermodesitelistsite)
- [Graph API Reference](https://learn.microsoft.com/graph/api/browsersite-update?view=graph-rest-beta)
