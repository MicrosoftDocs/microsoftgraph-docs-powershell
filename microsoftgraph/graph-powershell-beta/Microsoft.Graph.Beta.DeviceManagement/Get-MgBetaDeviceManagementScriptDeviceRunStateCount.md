...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgDeviceManagementScriptDeviceRunStateCount](/powershell/module/Microsoft.Graph.DeviceManagement/Get-MgDeviceManagementScriptDeviceRunStateCount?view=graph-powershell-v1.0)
...
### GetViaIdentity
```
Get-MgBetaDeviceManagementScriptDeviceRunStateCount -InputObject <IDeviceManagementIdentity> [-Filter <String>]
 [-Search <String>] [<CommonParameters>]
```
...
## RELATED LINKS
[Get-MgDeviceManagementScriptDeviceRunStateCount](/powershell/module/Microsoft.Graph.DeviceManagement/Get-MgDeviceManagementScriptDeviceRunStateCount?view=graph-powershell-v1.0)
