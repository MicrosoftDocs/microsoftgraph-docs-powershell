...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/remove-mgbetadevicemanagementtemplatecategory
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaDeviceManagementTemplateCategory -DeviceManagementTemplateId <String>
 -DeviceManagementTemplateSettingCategoryId <String> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
...
### DeleteViaIdentity
```
Remove-MgBetaDeviceManagementTemplateCategory -InputObject <IDeviceManagementIdentity> [-IfMatch <String>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/remove-mgbetadevicemanagementtemplatecategory](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/remove-mgbetadevicemanagementtemplatecategory)
