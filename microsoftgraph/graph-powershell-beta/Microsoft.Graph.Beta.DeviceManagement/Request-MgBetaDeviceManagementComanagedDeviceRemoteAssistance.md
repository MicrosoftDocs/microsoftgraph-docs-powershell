...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/request-mgbetadevicemanagementcomanageddeviceremoteassistance
schema: 2.0.0
---
...
### RequestViaIdentity
```
Request-MgBetaDeviceManagementComanagedDeviceRemoteAssistance -InputObject <IDeviceManagementIdentity>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
