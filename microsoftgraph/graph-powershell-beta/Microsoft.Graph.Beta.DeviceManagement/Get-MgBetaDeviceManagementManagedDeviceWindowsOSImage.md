...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementmanageddevicewindowsosimage
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaDeviceManagementManagedDeviceWindowsOSImage [-ExpandProperty <String[]>] [-Property <String[]>]
...
### Get
```
Get-MgBetaDeviceManagementManagedDeviceWindowsOSImage -ManagedDeviceWindowsOperatingSystemImageId <String>
