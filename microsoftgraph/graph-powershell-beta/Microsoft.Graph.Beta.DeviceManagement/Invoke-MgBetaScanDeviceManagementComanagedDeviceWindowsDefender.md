...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/invoke-mgbetascandevicemanagementcomanageddevicewindowsdefender
schema: 2.0.0
---
...
```
Invoke-MgBetaScanDeviceManagementComanagedDeviceWindowsDefender -InputObject <IDeviceManagementIdentity>
 [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>] [-QuickScan] [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/invoke-mgbetascandevicemanagementcomanageddevicewindowsdefender](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/invoke-mgbetascandevicemanagementcomanageddevicewindowsdefender)
