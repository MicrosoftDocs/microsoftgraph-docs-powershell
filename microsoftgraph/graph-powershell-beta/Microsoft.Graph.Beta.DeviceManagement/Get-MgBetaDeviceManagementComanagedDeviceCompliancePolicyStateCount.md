...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementcomanageddevicecompliancepolicystatecount
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgDeviceManagementComanagedDeviceCompliancePolicyStateCount](/powershell/module/Microsoft.Graph.DeviceManagement/Get-MgDeviceManagementComanagedDeviceCompliancePolicyStateCount?view=graph-powershell-v1.0)

## SYNTAX

### Get (Default)
```
Get-MgBetaDeviceManagementComanagedDeviceCompliancePolicyStateCount -ManagedDeviceId <String>
 [-Filter <String>] [-Search <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDeviceManagementComanagedDeviceCompliancePolicyStateCount -InputObject <IDeviceManagementIdentity>
 [-Filter <String>] [-Search <String>] [<CommonParameters>]
```
...
## RELATED LINKS
[Get-MgDeviceManagementComanagedDeviceCompliancePolicyStateCount](/powershell/module/Microsoft.Graph.DeviceManagement/Get-MgDeviceManagementComanagedDeviceCompliancePolicyStateCount?view=graph-powershell-v1.0)
