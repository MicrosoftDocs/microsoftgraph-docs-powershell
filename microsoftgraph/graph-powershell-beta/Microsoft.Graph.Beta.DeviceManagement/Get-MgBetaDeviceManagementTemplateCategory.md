...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementtemplatecategory
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaDeviceManagementTemplateCategory -DeviceManagementTemplateId <String> [-ExpandProperty <String[]>]
...
### Get
```
Get-MgBetaDeviceManagementTemplateCategory -DeviceManagementTemplateId <String>
...
### GetViaIdentity
```
Get-MgBetaDeviceManagementTemplateCategory -InputObject <IDeviceManagementIdentity>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementtemplatecategory](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement/get-mgbetadevicemanagementtemplatecategory)
