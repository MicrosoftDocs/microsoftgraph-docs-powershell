...
```
Get-MgBetaCommunicationOnlineMeeting -InputObject <ICloudCommunicationsIdentity>
...
```
Get-MgBetaCommunicationOnlineMeeting [-ExpandProperty <string[]>] [-Property <string[]>]
