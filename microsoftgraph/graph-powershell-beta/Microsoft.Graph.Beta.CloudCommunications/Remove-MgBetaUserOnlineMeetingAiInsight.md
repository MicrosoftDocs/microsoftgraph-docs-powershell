...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.cloudcommunications/remove-mgbetauseronlinemeetingaiinsight
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaUserOnlineMeetingAiInsight -CallAiInsightId <String> -OnlineMeetingId <String> -UserId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaUserOnlineMeetingAiInsight -InputObject <ICloudCommunicationsIdentity> [-IfMatch <String>]
