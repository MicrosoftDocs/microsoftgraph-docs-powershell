...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.cloudcommunications/get-mgbetacommunicationadhoccall
Locale: en-US
Module Name: Microsoft.Graph.Beta.CloudCommunications
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaCommunicationAdhocCall
---

# Get-MgBetaCommunicationAdhocCall
...
```
Get-MgBetaCommunicationAdhocCall [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaCommunicationAdhocCall -AdhocCallId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaCommunicationAdhocCall -InputObject <ICloudCommunicationsIdentity>
...
- [Get-MgBetaCommunicationAdhocCall](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.cloudcommunications/get-mgbetacommunicationadhoccall)
