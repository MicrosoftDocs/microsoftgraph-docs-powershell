...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.cloudcommunications/set-mgbetauserpresencemanuallocation
Locale: en-US
Module Name: Microsoft.Graph.Beta.CloudCommunications
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Set-MgBetaUserPresenceManualLocation
---

# Set-MgBetaUserPresenceManualLocation
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Set-MgUserPresenceManualLocation](/powershell/module/Microsoft.Graph.CloudCommunications/Set-MgUserPresenceManualLocation?view=graph-powershell-1.0)
...
```
Set-MgBetaUserPresenceManualLocation -UserId <string> [-ResponseHeadersVariable <string>]
...
```
Set-MgBetaUserPresenceManualLocation -UserId <string>
...
```
Set-MgBetaUserPresenceManualLocation -InputObject <ICloudCommunicationsIdentity>
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths4TijaiUsersUserIdPresenceMicrosoftGraphSetmanuallocationPostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths4TijaiUsersUserIdPresenceMicrosoftGraphSetmanuallocationPostRequestbodyContentApplicationJsonSchema
...
- [Set-MgBetaUserPresenceManualLocation](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.cloudcommunications/set-mgbetauserpresencemanuallocation)
