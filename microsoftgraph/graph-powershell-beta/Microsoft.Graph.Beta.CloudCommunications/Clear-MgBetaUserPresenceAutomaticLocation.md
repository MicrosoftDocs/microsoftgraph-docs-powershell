...
# Clear-MgBetaUserPresenceAutomaticLocation
...
```
Clear-MgBetaUserPresenceAutomaticLocation -UserId <string> [-ResponseHeadersVariable <string>]
...
```
Clear-MgBetaUserPresenceAutomaticLocation -InputObject <ICloudCommunicationsIdentity>
