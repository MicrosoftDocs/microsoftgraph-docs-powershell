...
```
Update-MgBetaCommunicationCallRecordOrganizerV2 -CallRecordId <String> [-AdditionalProperties <Hashtable>]
 [-Id <String>] [-Identity <IMicrosoftGraphCallRecordsUserIdentity>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Update
```
Update-MgBetaCommunicationCallRecordOrganizerV2 -CallRecordId <String> -BodyParameter <Hashtable> [-WhatIf]
...
```yaml
Type: IMicrosoftGraphCallRecordsUserIdentity
Parameter Sets: UpdateExpanded, UpdateViaIdentityExpanded
Aliases:
