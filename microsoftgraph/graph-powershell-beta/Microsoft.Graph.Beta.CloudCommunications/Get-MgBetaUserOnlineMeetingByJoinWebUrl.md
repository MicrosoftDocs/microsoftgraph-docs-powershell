...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.cloudcommunications/get-mgbetauseronlinemeetingbyjoinweburl
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaUserOnlineMeetingByJoinWebUrl -JoinWebUrl <String> -UserId <String> [-ExpandProperty <String[]>]
