...
```
Get-MgBetaCommunicationPresence [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaCommunicationPresence -PresenceId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaCommunicationPresence -InputObject <ICloudCommunicationsIdentity>
