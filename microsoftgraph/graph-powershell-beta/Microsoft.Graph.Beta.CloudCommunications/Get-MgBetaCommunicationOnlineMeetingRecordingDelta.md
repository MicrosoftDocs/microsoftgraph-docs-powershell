...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.cloudcommunications/get-mgbetacommunicationonlinemeetingrecordingdelta
Locale: en-US
Module Name: Microsoft.Graph.Beta.CloudCommunications
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaCommunicationOnlineMeetingRecordingDelta
---
...
```
Get-MgBetaCommunicationOnlineMeetingRecordingDelta -OnlineMeetingId <string>
...
```
Get-MgBetaCommunicationOnlineMeetingRecordingDelta -InputObject <ICloudCommunicationsIdentity>
 [-ExpandProperty <string[]>] [-Filter <string>] [-Property <string[]>] [-Search <string>]
...
- [Get-MgBetaCommunicationOnlineMeetingRecordingDelta](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.cloudcommunications/get-mgbetacommunicationonlinemeetingrecordingdelta)
