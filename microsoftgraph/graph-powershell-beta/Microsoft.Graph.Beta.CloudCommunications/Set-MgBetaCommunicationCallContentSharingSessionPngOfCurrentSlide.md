...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.cloudcommunications/set-mgbetacommunicationcallcontentsharingsessionpngofcurrentslide
schema: 2.0.0
---
...
### Set (Default)
```
Set-MgBetaCommunicationCallContentSharingSessionPngOfCurrentSlide -CallId <String>
 -ContentSharingSessionId <String> [-Data <Stream>] [-ResponseHeadersVariable <String>] -InFile <String>
...
### SetViaIdentity
```
Set-MgBetaCommunicationCallContentSharingSessionPngOfCurrentSlide -InputObject <ICloudCommunicationsIdentity>
