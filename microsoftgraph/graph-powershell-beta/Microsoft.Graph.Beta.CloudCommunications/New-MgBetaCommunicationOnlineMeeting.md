...
```
New-MgBetaCommunicationOnlineMeeting [-ResponseHeadersVariable <string>]
...
- [New-MgBetaCommunicationOnlineMeeting](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.cloudcommunications/new-mgbetacommunicationonlinemeeting)
