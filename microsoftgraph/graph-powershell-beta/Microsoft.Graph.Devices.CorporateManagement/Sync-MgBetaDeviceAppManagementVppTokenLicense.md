...
### Sync (Default)
```
Sync-MgBetaDeviceAppManagementVppTokenLicense -VppTokenId <String> [-WhatIf] [-Confirm] [<CommonParameters>]
```

### SyncViaIdentity
```
Sync-MgBetaDeviceAppManagementVppTokenLicense -InputObject <IDevicesCorporateManagementIdentity> [-WhatIf]
