...
### Delete (Default)
```
Remove-MgDeviceAppMgtMobileAppConfiguration -ManagedDeviceMobileAppConfigurationId <String> [-IfMatch <String>]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/remove-mgdeviceappmgtmobileappconfiguration](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/remove-mgdeviceappmgtmobileappconfiguration)
