...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/get-mgbetauserdeviceenrollmentconfigurationassignment
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaUserDeviceEnrollmentConfigurationAssignment -DeviceEnrollmentConfigurationId <String>
...
### GetViaIdentity
```
Get-MgBetaUserDeviceEnrollmentConfigurationAssignment -InputObject <IDevicesCorporateManagementIdentity>
