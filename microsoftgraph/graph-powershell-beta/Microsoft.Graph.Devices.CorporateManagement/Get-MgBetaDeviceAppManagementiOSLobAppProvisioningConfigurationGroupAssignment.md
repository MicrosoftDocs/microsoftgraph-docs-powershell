...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/get-mgbetadeviceappmanagementioslobappprovisioningconfigurationgroupassignment
schema: 2.0.0
---
...
```
Get-MgBetaDeviceAppManagementiOSLobAppProvisioningConfigurationGroupAssignment
 -IosLobAppProvisioningConfigurationId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
The unique identifier of mobileAppProvisioningConfigGroupAssignment
