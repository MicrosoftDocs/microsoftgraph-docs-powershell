...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/get-mgbetadeviceappmanagementmobileappuserstatusdevicestatusapp
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaDeviceAppManagementMobileAppUserStatusDeviceStatusApp -MobileAppId <String>
