...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.corporatemanagement/get-mgbetadeviceappmanagementwindowsinformationprotectiondeviceregistration
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaDeviceAppManagementWindowsInformationProtectionDeviceRegistration [-ExpandProperty <String[]>]
