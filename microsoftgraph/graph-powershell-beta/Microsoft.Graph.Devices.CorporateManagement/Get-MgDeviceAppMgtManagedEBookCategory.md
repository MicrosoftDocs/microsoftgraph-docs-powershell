...
### List (Default)
```
Get-MgDeviceAppMgtManagedEBookCategory [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgdeviceappmgtmanagedebookcategory](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devices.corporatemanagement/get-mgdeviceappmgtmanagedebookcategory)
