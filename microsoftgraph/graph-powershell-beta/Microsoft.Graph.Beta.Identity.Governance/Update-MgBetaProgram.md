...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/update-mgbetaprogram
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.Governance
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaProgram
---
...
```
Update-MgBetaProgram -ProgramId <string> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaProgram -InputObject <IIdentityGovernanceIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Controls <IMicrosoftGraphProgramControl[]>]
 [-Description <string>] [-DisplayName <string>] [-Id <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```
Update-MgBetaProgram -InputObject <IIdentityGovernanceIdentity>
...
- [Update-MgBetaProgram](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/update-mgbetaprogram)
- [Graph API Reference](https://learn.microsoft.com/graph/api/program-update?view=graph-rest-beta)
