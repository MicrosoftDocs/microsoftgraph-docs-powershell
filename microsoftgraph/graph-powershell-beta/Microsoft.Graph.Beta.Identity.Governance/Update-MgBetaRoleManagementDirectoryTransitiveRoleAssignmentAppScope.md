...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgRoleManagementDirectoryTransitiveRoleAssignmentAppScope](/powershell/module/Microsoft.Graph.Identity.Governance/Update-MgRoleManagementDirectoryTransitiveRoleAssignmentAppScope?view=graph-powershell-v1.0)
...
```
Update-MgBetaRoleManagementDirectoryTransitiveRoleAssignmentAppScope -InputObject <IIdentityGovernanceIdentity>
 [-AdditionalProperties <Hashtable>] [-DisplayName <String>] [-Id <String>] [-Type <String>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgRoleManagementDirectoryTransitiveRoleAssignmentAppScope](/powershell/module/Microsoft.Graph.Identity.Governance/Update-MgRoleManagementDirectoryTransitiveRoleAssignmentAppScope?view=graph-powershell-v1.0)
