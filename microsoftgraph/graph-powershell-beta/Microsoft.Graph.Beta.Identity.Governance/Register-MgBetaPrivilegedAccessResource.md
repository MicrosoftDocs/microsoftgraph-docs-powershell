...
```
Register-MgBetaPrivilegedAccessResource -PrivilegedAccessId <String> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-ExternalId <String>] [-Headers <IDictionary>] [-PassThru]
