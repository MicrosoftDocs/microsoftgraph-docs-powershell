...
```
Get-MgBetaEntitlementManagementAccessPackage [-ExpandProperty <String[]>] [-Property <String[]>]
 [-Sort <String[]>] [-Top <Int32>] -CatalogId <String> [-All] [<CommonParameters>]
```
...
Get-MgBetaEntitlementManagementAccessPackage ### Example 1: Get a list of all access packages### Example 2: Get access package by Id

```powershell
Connect-MgBetaGraph -Scopes 'EntitlementManagement.ReadWrite.All'
Get-MgBetaEntitlementManagementAccessPackage -AccessPackageId 'bc041fda-b3ba-41fc-b911-ca95f7aac656'### Example 2: Get access package by Id
## PARAMETERS
