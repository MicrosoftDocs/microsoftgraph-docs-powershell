...
```
Remove-MgBetaRoleManagementDirectoryRoleDefinition -UnifiedRoleDefinitionId <string>
...
| --------------- | ------------------------------------------  |
| Delegated (work or school account) | Directory.ReadWrite.All, RoleManagement.ReadWrite.Directory,  |
