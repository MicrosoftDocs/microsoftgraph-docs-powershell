...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgIdentityGovernanceTermsOfUseAgreementAcceptance](/powershell/module/Microsoft.Graph.Identity.Governance/Get-MgIdentityGovernanceTermsOfUseAgreementAcceptance?view=graph-powershell-1.0)
...
```
Get-MgBetaIdentityGovernanceTermsOfUseAgreementAcceptance [-ExpandProperty <string[]>]
...
```
Get-MgBetaIdentityGovernanceTermsOfUseAgreementAcceptance -AgreementId <string>
...
- [Get-MgBetaIdentityGovernanceTermsOfUseAgreementAcceptance](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/get-mgbetaidentitygovernancetermsofuseagreementacceptance)
- [Graph API Reference](https://learn.microsoft.com/graph/api/agreement-list-acceptances?view=graph-rest-beta)
