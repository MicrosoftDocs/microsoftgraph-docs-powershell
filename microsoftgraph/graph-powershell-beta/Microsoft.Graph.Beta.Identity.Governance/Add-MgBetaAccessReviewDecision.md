...
```
Add-MgBetaAccessReviewDecision -AccessReviewId <string> [-ResponseHeadersVariable <string>] [-Break]
...
```
Add-MgBetaAccessReviewDecision -InputObject <IIdentityGovernanceIdentity>
