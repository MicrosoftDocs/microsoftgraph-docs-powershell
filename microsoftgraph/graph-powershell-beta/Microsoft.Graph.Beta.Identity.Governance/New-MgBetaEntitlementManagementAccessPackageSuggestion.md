...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/new-mgbetaentitlementmanagementaccesspackagesuggestion
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.Governance
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaEntitlementManagementAccessPackageSuggestion
---

# New-MgBetaEntitlementManagementAccessPackageSuggestion
...
```
New-MgBetaEntitlementManagementAccessPackageSuggestion [-ResponseHeadersVariable <string>]
 [-AccessPackage <IMicrosoftGraphAvailableAccessPackage>] [-AdditionalProperties <hashtable>]
 [-Id <string>] [-Reasons <IMicrosoftGraphAccessPackageSuggestionReason[]>] [-Break]
...
```
New-MgBetaEntitlementManagementAccessPackageSuggestion
 -BodyParameter <IMicrosoftGraphAccessPackageSuggestion> [-ResponseHeadersVariable <string>]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphAccessPackageSuggestion
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphAccessPackageSuggestionReason[]
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphAccessPackageSuggestion
...
- [New-MgBetaEntitlementManagementAccessPackageSuggestion](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/new-mgbetaentitlementmanagementaccesspackagesuggestion)
