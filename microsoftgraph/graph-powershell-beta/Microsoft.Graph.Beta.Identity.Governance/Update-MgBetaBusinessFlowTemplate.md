...
```
Update-MgBetaBusinessFlowTemplate -BusinessFlowTemplateId <String> [-ResponseHeadersVariable <String>]
...
Update-MgBetaBusinessFlowTemplate -BusinessFlowTemplateId <String>
 -BodyParameter <IMicrosoftGraphBusinessFlowTemplate> [-ResponseHeadersVariable <String>]
