...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/update-mgbetaidentitygovernancelifecycleworkflowexecutionscopemailboxsetting
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgIdentityGovernanceLifecycleWorkflowExecutionScopeMailboxSetting](/powershell/module/Microsoft.Graph.Identity.Governance/Update-MgIdentityGovernanceLifecycleWorkflowExecutionScopeMailboxSetting?view=graph-powershell-v1.0)

## SYNTAX

### UpdateExpanded (Default)
```
Update-MgBetaIdentityGovernanceLifecycleWorkflowExecutionScopeMailboxSetting -UserId <String>
 -WorkflowId <String> [-AdditionalProperties <Hashtable>] [-ArchiveFolder <String>]
...
```
Update-MgBetaIdentityGovernanceLifecycleWorkflowExecutionScopeMailboxSetting -UserId <String>
 -WorkflowId <String> -BodyParameter <IMicrosoftGraphMailboxSettings> [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgIdentityGovernanceLifecycleWorkflowExecutionScopeMailboxSetting](/powershell/module/Microsoft.Graph.Identity.Governance/Update-MgIdentityGovernanceLifecycleWorkflowExecutionScopeMailboxSetting?view=graph-powershell-v1.0)
