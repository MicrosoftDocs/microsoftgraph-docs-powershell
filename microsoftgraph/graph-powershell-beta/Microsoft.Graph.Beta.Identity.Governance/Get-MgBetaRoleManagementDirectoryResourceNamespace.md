...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgRoleManagementDirectoryResourceNamespace](/powershell/module/Microsoft.Graph.Identity.Governance/Get-MgRoleManagementDirectoryResourceNamespace?view=graph-powershell-v1.0)

## SYNTAX

### List (Default)
```
Get-MgBetaRoleManagementDirectoryResourceNamespace [-ExpandProperty <String[]>] [-Property <String[]>]
