...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgIdentityGovernanceLifecycleWorkflowTaskDefinition](/powershell/module/Microsoft.Graph.Identity.Governance/Get-MgIdentityGovernanceLifecycleWorkflowTaskDefinition?view=graph-powershell-v1.0)

## SYNTAX

### List (Default)
```
Get-MgBetaIdentityGovernanceLifecycleWorkflowTaskDefinition [-ExpandProperty <String[]>] [-Property <String[]>]
