...
```
Update-MgBetaEntitlementManagementSubject -AccessPackageSubjectId <String> [-ResponseHeadersVariable <String>]
...
Update-MgBetaEntitlementManagementSubject -InputObject <IIdentityGovernanceIdentity>
 ...
 [-SubjectLifecycle <String>] [-Type <String>] [-Headers <IDictionary>]
