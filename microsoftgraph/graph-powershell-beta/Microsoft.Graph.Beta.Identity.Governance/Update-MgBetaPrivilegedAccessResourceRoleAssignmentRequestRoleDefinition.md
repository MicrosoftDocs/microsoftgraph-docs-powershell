...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgPrivilegedAccessResourceRoleAssignmentRequestRoleDefinition](/powershell/module/Microsoft.Graph.Identity.Governance/Update-MgPrivilegedAccessResourceRoleAssignmentRequestRoleDefinition?view=graph-powershell-v1.0)
...
```
Update-MgBetaPrivilegedAccessResourceRoleAssignmentRequestRoleDefinition
 -InputObject <IIdentityGovernanceIdentity> -BodyParameter <IMicrosoftGraphGovernanceRoleDefinition> [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
