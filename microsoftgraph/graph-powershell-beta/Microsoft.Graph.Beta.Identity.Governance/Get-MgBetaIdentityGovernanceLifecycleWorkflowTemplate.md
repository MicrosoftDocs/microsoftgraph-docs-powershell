...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/get-mgbetaidentitygovernancelifecycleworkflowtemplate
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.Governance
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaIdentityGovernanceLifecycleWorkflowTemplate
---
...
```
Get-MgBetaIdentityGovernanceLifecycleWorkflowTemplate [-ExpandProperty <string[]>]
...
- [Get-MgBetaIdentityGovernanceLifecycleWorkflowTemplate](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/get-mgbetaidentitygovernancelifecycleworkflowtemplate)
- [Graph API Reference](https://learn.microsoft.com/graph/api/identitygovernance-workflowtemplate-get?view=graph-rest-beta)
- [Graph API Reference](https://learn.microsoft.com/graph/api/identitygovernance-lifecycleworkflowscontainer-list-workflowtemplates?view=graph-rest-beta)
