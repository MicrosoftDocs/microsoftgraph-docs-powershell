...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/new-mgbetaidentitygovernancecatalogaccesspackageresource
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.Governance
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaIdentityGovernanceCatalogAccessPackageResource
---

# New-MgBetaIdentityGovernanceCatalogAccessPackageResource
...
```
New-MgBetaIdentityGovernanceCatalogAccessPackageResource -AccessPackageCatalogId <string>
...
```
New-MgBetaIdentityGovernanceCatalogAccessPackageResource -InputObject <IIdentityGovernanceIdentity>
 [-ResponseHeadersVariable <string>]
 [-AccessPackageResourceEnvironment <IMicrosoftGraphAccessPackageResourceEnvironment>]
 [-AccessPackageResourceRoles <IMicrosoftGraphAccessPackageResourceRole[]>]
 [-AccessPackageResourceScopes <IMicrosoftGraphAccessPackageResourceScope[]>] [-AddedBy <string>]
...
- [New-MgBetaIdentityGovernanceCatalogAccessPackageResource](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/new-mgbetaidentitygovernancecatalogaccesspackageresource)
