...
Update-MgBetaPrivilegedAccessResourceRoleAssignmentRequestSubject -GovernanceResourceId <String>
 -GovernanceRoleAssignmentRequestId <String> -PrivilegedAccessId <String> [-ResponseHeadersVariable <String>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/update-mgbetaprivilegedaccessresourceroleassignmentrequestsubject](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/update-mgbetaprivilegedaccessresourceroleassignmentrequestsubject)
