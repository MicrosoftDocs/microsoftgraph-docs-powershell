...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgPrivilegedAccessResourceRoleAssignmentRequestSubject](/powershell/module/Microsoft.Graph.Identity.Governance/Update-MgPrivilegedAccessResourceRoleAssignmentRequestSubject?view=graph-powershell-v1.0)
...
Update-MgBetaPrivilegedAccessResourceRoleAssignmentRequestSubject -GovernanceResourceId <String>
 ...
 [-DisplayName <String>] [-Email <String>] [-Id <String>] [-PrincipalName <String>] [-Type <String>] [-WhatIf]
...
## RELATED LINKS
[Update-MgPrivilegedAccessResourceRoleAssignmentRequestSubject](/powershell/module/Microsoft.Graph.Identity.Governance/Update-MgPrivilegedAccessResourceRoleAssignmentRequestSubject?view=graph-powershell-v1.0)
