...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/remove-mgbetaentitlementmanagementaccesspackagebyuniquename
schema: 2.0.0
...
### Delete (Default)
```
Remove-MgBetaEntitlementManagementAccessPackageByUniqueName -UniqueName <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgBetaEntitlementManagementAccessPackageByUniqueName -InputObject <IIdentityGovernanceIdentity>
