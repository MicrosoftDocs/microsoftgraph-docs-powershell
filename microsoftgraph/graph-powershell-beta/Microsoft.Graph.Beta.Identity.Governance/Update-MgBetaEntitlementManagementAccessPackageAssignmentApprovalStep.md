...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgEntitlementManagementAccessPackageAssignmentApprovalStep](/powershell/module/Microsoft.Graph.Identity.Governance/Update-MgEntitlementManagementAccessPackageAssignmentApprovalStep?view=graph-powershell-v1.0)
...
```
Update-MgBetaEntitlementManagementAccessPackageAssignmentApprovalStep -ApprovalId <String>
 -ApprovalStepId <String> -BodyParameter <IMicrosoftGraphApprovalStep> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
