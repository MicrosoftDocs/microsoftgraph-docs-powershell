...
```powershell
Get-MgBetaEntitlementManagementAccessPackageAssignmentRequest ### Example 1: Get all access package assignment requests### Example 2: Get  access package assignment request using the request id

```powershell
Connect-MgBetaGraph -Scopes 'EntitlementManagement.ReadWrite.All'
Get-MgBetaEntitlementManagementAccessPackageAssignmentRequest -AccessPackageAssignmentRequestId 'c82bc0cd-4fbc-4492-8c75-54c41dc74803'### Example 2: Get  access package assignment request using the request id
## PARAMETERS
