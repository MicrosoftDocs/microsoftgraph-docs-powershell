...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/update-mgbetaagreementfile
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.Governance
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaAgreementFile
---
...
```
Update-MgBetaAgreementFile -AgreementId <string> [-ResponseHeadersVariable <string>]
 ...
 [-IsMajorVersion] [-Language <string>]
 [-Localizations <IMicrosoftGraphAgreementFileLocalization[]>] [-Break] [-Headers <IDictionary>]
...
```
Update-MgBetaAgreementFile -InputObject <IIdentityGovernanceIdentity>
 -BodyParameter <IMicrosoftGraphAgreementFile> [-ResponseHeadersVariable <string>] [-Break]
...
- [Update-MgBetaAgreementFile](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/update-mgbetaagreementfile)
