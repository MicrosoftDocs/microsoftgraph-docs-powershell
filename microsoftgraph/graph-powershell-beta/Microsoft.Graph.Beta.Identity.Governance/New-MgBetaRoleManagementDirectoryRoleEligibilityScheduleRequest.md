...
```
New-MgBetaRoleManagementDirectoryRoleEligibilityScheduleRequest [-ResponseHeadersVariable <String>]
...
**Permissions**
[!INCLUDE [permissions-table](~/../graphref/api-reference/beta/includes/permissions/rbacapplication-post-roleeligibilityschedulerequests-permissions.md)]
...
[https://learn.microsoft.com/graph/api/rbacapplication-post-roleeligibilityschedulerequests?view=graph-rest-beta](https://learn.microsoft.com/graph/api/rbacapplication-post-roleeligibilityschedulerequests?view=graph-rest-beta)
