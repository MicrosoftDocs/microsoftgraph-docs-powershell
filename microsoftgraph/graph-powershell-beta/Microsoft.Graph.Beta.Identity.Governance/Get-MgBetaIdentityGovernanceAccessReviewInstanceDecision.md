...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/get-mgbetaidentitygovernanceaccessreviewinstancedecision
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.Governance
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaIdentityGovernanceAccessReviewInstanceDecision
---

# Get-MgBetaIdentityGovernanceAccessReviewInstanceDecision
...
```
Get-MgBetaIdentityGovernanceAccessReviewInstanceDecision -AccessReviewInstanceId <string>
...
```
Get-MgBetaIdentityGovernanceAccessReviewInstanceDecision -InputObject <IIdentityGovernanceIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
...
- [Get-MgBetaIdentityGovernanceAccessReviewInstanceDecision](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/get-mgbetaidentitygovernanceaccessreviewinstancedecision)
