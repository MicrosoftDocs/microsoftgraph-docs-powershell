...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Initialize-MgIdentityGovernanceLifecycleWorkflowWithScope](/powershell/module/Microsoft.Graph.Identity.Governance/Initialize-MgIdentityGovernanceLifecycleWorkflowWithScope?view=graph-powershell-1.0)
...
```
Initialize-MgBetaIdentityGovernanceLifecycleWorkflowWithScope -WorkflowId <string>
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths22P23HIdentitygovernanceLifecycleworkflowsWorkflowsWorkflowIdMicrosoftGraphIdentitygovernanceActivatewithscopePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths22P23HIdentitygovernanceLifecycleworkflowsWorkflowsWorkflowIdMicrosoftGraphIdentitygovernanceActivatewithscopePostRequestbodyContentApplicationJsonSchema
