...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.governance/get-mgidentitygovernancelifecycleworkflowrunuserprocessingresultsubject
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgIdentityGovernanceLifecycleWorkflowRunUserProcessingResultSubject -RunId <String>
