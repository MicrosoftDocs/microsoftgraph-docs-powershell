...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/update-mgbetaidentitygovernancepermissionmanagementpermissionrequestchange
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.Governance
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaIdentityGovernancePermissionManagementPermissionRequestChange
---
...
```
Update-MgBetaIdentityGovernancePermissionManagementPermissionRequestChange
 -PermissionsRequestChangeId <string> [-ResponseHeadersVariable <string>]
 ...
 [-TicketId <string>] [-Break] [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
...
- [Update-MgBetaIdentityGovernancePermissionManagementPermissionRequestChange](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/update-mgbetaidentitygovernancepermissionmanagementpermissionrequestchange)
