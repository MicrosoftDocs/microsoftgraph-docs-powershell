...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/get-mgbetaentitlementmanagementaccesspackagecatalogbyuniquename
schema: 2.0.0
...
### Get (Default)
```
Get-MgBetaEntitlementManagementAccessPackageCatalogByUniqueName -UniqueName <String>
...
### GetViaIdentity
```
Get-MgBetaEntitlementManagementAccessPackageCatalogByUniqueName -InputObject <IIdentityGovernanceIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
### -UniqueName
Alternate key of accessPackageCatalog
