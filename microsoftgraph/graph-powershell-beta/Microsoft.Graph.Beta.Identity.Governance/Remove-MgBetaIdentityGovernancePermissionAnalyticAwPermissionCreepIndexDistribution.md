...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/remove-mgbetaidentitygovernancepermissionanalyticawpermissioncreepindexdistribution
schema: 2.0.0
---
...
```
Remove-MgBetaIdentityGovernancePermissionAnalyticAwPermissionCreepIndexDistribution
 -PermissionsCreepIndexDistributionId <String> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
