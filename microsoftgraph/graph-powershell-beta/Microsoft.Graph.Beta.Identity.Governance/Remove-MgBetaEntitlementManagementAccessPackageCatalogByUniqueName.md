...
### Delete (Default)
```
Remove-MgBetaEntitlementManagementAccessPackageCatalogByUniqueName -UniqueName <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgBetaEntitlementManagementAccessPackageCatalogByUniqueName -InputObject <IIdentityGovernanceIdentity>
