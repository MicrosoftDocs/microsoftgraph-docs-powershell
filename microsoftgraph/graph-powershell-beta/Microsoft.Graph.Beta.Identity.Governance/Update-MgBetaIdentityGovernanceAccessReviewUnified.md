...
# Update-MgBetaIdentityGovernanceAccessReviewUnified
...
```
Update-MgBetaIdentityGovernanceAccessReviewUnified [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>]
 [-Decisions <IMicrosoftGraphAccessReviewInstanceDecisionItem[]>]
 [-Definitions <IMicrosoftGraphAccessReviewScheduleDefinition[]>] [-Id <string>]
 [-Instances <IMicrosoftGraphAccessReviewInstance[]>] [-Break] [-Headers <IDictionary>]
...
```
Update-MgBetaIdentityGovernanceAccessReviewUnified -BodyParameter <IMicrosoftGraphUnifiedRoot>
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphUnifiedRoot
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
Read-only.
  [Decisions <IMicrosoftGraphAccessReviewInstanceDecisionItem[]>]: Represents the unified (vNext) access review decisions on an instance of a review.
    [Id <String>]: The unique identifier for an entity.
Read-only.
...
Read-only.
    [Target <IMicrosoftGraphAccessReviewInstanceDecisionItemTarget>]: accessReviewInstanceDecisionItemTarget
      [(Any) <Object>]: This indicates any property can be added to this object.
  [Definitions <IMicrosoftGraphAccessReviewScheduleDefinition[]>]: Represents the unified (vNext) template and scheduling for an access review.
  [Instances <IMicrosoftGraphAccessReviewInstance[]>]: Represents the unified (vNext) instance of a review.
...
- [Update-MgBetaIdentityGovernanceAccessReviewUnified](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/update-mgbetaidentitygovernanceaccessreviewunified)
