...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/initialize-mgbetaidentitygovernancelifecycleworkflowandwait
Locale: en-US
Module Name: Microsoft.Graph.Beta.Identity.Governance
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Initialize-MgBetaIdentityGovernanceLifecycleWorkflowAndWait
---

# Initialize-MgBetaIdentityGovernanceLifecycleWorkflowAndWait
...
```
Initialize-MgBetaIdentityGovernanceLifecycleWorkflowAndWait -WorkflowId <string>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-Subject <hashtable>]
...
```
Initialize-MgBetaIdentityGovernanceLifecycleWorkflowAndWait -WorkflowId <string>
 -BodyParameter <IPaths8F12FfIdentitygovernanceLifecycleworkflowsWorkflowsWorkflowIdMicrosoftGraphIdentitygovernanceActivateandwaitPostRequestbodyContentApplicationJsonSchema>
...
Initialize-MgBetaIdentityGovernanceLifecycleWorkflowAndWait
 ...
 [-AdditionalProperties <hashtable>] [-Subject <hashtable>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths8F12FfIdentitygovernanceLifecycleworkflowsWorkflowsWorkflowIdMicrosoftGraphIdentitygovernanceActivateandwaitPostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths8F12FfIdentitygovernanceLifecycleworkflowsWorkflowsWorkflowIdMicrosoftGraphIdentitygovernanceActivateandwaitPostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphIdentityGovernanceAwaitedWorkflowProcessingResult
