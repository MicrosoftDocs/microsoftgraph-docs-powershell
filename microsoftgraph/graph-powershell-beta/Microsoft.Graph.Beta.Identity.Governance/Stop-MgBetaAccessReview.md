...
### Stop (Default)
```
Stop-MgBetaAccessReview -AccessReviewId <String> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### StopViaIdentity
```
Stop-MgBetaAccessReview -InputObject <IIdentityGovernanceIdentity> [-ResponseHeadersVariable <String>]
