...
Update-MgBetaPrivilegedRoleSummary -PrivilegedRoleId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-UsersCount <Int32>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
Update-MgBetaPrivilegedRoleSummary -PrivilegedRoleId <String>
 -BodyParameter <IMicrosoftGraphPrivilegedRoleSummary> [-Headers <IDictionary>]
