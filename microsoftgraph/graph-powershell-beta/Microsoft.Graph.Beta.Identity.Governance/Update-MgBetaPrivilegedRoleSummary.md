...
```
Update-MgBetaPrivilegedRoleSummary -PrivilegedRoleId <string> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-ElevatedCount <int>] [-Id <string>] [-ManagedCount <int>]
 [-MfaEnabled] [-Status <string>] [-UsersCount <int>] [-Break] [-Headers <IDictionary>]
...
Update-MgBetaPrivilegedRoleSummary -PrivilegedRoleId <string>
 -BodyParameter <IMicrosoftGraphPrivilegedRoleSummary> [-ResponseHeadersVariable <string>] [-Break]
...
Update-MgBetaPrivilegedRoleSummary -InputObject <IIdentityGovernanceIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-ElevatedCount <int>]
 [-Id <string>] [-ManagedCount <int>] [-MfaEnabled] [-Status <string>] [-UsersCount <int>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm] [<CommonParameters>]
```
