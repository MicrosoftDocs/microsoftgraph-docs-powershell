...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/invoke-mgbetafilterentitlementmanagementaccesspackagebycurrentuser
schema: 2.0.0
...
### FilterViaIdentity
```
Invoke-MgBetaFilterEntitlementManagementAccessPackageByCurrentUser -InputObject <IIdentityGovernanceIdentity>
...
[https://learn.microsoft.com/graph/api/accesspackage-filterbycurrentuser?view=graph-rest-beta](https://learn.microsoft.com/graph/api/accesspackage-filterbycurrentuser?view=graph-rest-beta)
