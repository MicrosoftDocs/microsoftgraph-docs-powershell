...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgRoleManagementEnterpriseAppTransitiveRoleAssignment](/powershell/module/Microsoft.Graph.Identity.Governance/Update-MgRoleManagementEnterpriseAppTransitiveRoleAssignment?view=graph-powershell-v1.0)
...
```
Update-MgBetaRoleManagementEnterpriseAppTransitiveRoleAssignment -RbacApplicationId <String>
 -UnifiedRoleAssignmentId <String> -BodyParameter <IMicrosoftGraphUnifiedRoleAssignment> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgRoleManagementEnterpriseAppTransitiveRoleAssignment](/powershell/module/Microsoft.Graph.Identity.Governance/Update-MgRoleManagementEnterpriseAppTransitiveRoleAssignment?view=graph-powershell-v1.0)
