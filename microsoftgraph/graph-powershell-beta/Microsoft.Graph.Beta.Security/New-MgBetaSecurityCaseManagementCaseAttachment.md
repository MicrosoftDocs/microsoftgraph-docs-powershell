...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/new-mgbetasecuritycasemanagementcaseattachment
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaSecurityCaseManagementCaseAttachment
---

# New-MgBetaSecurityCaseManagementCaseAttachment

## SYNOPSIS

Create attachment metadata for a case.
This method doesn't upload the file content.
After creating the attachment, use Upload attachment content.
...
```
New-MgBetaSecurityCaseManagementCaseAttachment -CaseId <string> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-ContentInputFile <string>] [-CreatedBy <string>]
 [-CreatedDateTime <datetime>] [-Description <string>] [-DisplayName <string>]
 [-FileExtension <string>] [-FileSize <long>] [-Id <string>] [-LastModifiedBy <string>]
 [-LastModifiedDateTime <datetime>]
 [-Origin <IMicrosoftGraphSecurityCaseManagementAttachmentOrigin>] [-ScanResult <string>] [-Break]
...
```
New-MgBetaSecurityCaseManagementCaseAttachment -CaseId <string>
 -BodyParameter <IMicrosoftGraphSecurityCaseManagementAttachment>
...
```
New-MgBetaSecurityCaseManagementCaseAttachment -InputObject <ISecurityIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-ContentInputFile <string>] [-CreatedBy <string>] [-CreatedDateTime <datetime>]
 [-Description <string>] [-DisplayName <string>] [-FileExtension <string>] [-FileSize <long>]
 [-Id <string>] [-LastModifiedBy <string>] [-LastModifiedDateTime <datetime>]
 [-Origin <IMicrosoftGraphSecurityCaseManagementAttachmentOrigin>] [-ScanResult <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
Input File for Content (The binary content stream for the attachment.
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphSecurityCaseManagementAttachmentOrigin
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
