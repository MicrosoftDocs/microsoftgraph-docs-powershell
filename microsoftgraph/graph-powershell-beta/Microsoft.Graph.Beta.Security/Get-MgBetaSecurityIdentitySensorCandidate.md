...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/get-mgbetasecurityidentitysensorcandidate
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 09/23/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaSecurityIdentitySensorCandidate
---

# Get-MgBetaSecurityIdentitySensorCandidate
...
```
Get-MgBetaSecurityIdentitySensorCandidate [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaSecurityIdentitySensorCandidate -SensorCandidateId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaSecurityIdentitySensorCandidate -InputObject <ISecurityIdentity>
...
The unique identifier of sensorCandidate
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphSecuritySensorCandidate
...
- [Get-MgBetaSecurityIdentitySensorCandidate](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/get-mgbetasecurityidentitysensorcandidate)
- [Graph API Reference](https://learn.microsoft.com/graph/api/security-identitycontainer-list-sensorcandidates?view=graph-rest-beta)
