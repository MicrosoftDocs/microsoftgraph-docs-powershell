...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/get-mgbetasecurityzoneaggregationcount
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaSecurityZoneAggregationCount
---

# Get-MgBetaSecurityZoneAggregationCount
...
```
Get-MgBetaSecurityZoneAggregationCount -ZoneId <string> [-Filter <string>] [-Search <string>]
...
```
Get-MgBetaSecurityZoneAggregationCount -InputObject <ISecurityIdentity> [-Filter <string>]
...
- [Get-MgBetaSecurityZoneAggregationCount](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/get-mgbetasecurityzoneaggregationcount)
