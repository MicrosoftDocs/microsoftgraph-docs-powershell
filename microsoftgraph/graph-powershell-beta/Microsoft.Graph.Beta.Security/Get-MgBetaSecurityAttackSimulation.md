...
### List
```
Get-MgBetaSecurityAttackSimulation [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
[https://learn.microsoft.com/graph/api/simulation-get?view=graph-rest-beta](https://learn.microsoft.com/graph/api/simulation-get?view=graph-rest-beta)

[https://learn.microsoft.com/graph/api/attacksimulationroot-list-simulations?view=graph-rest-beta](https://learn.microsoft.com/graph/api/attacksimulationroot-list-simulations?view=graph-rest-beta)
