...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/get-mgbetasecuritythreatintelligencehostpair
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaSecurityThreatIntelligenceHostPair
---
...
```
Get-MgBetaSecurityThreatIntelligenceHostPair [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaSecurityThreatIntelligenceHostPair -HostPairId <string> -HostId <string>
...
```
Get-MgBetaSecurityThreatIntelligenceHostPair -HostId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaSecurityThreatIntelligenceHostPair -InputObject <ISecurityIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
...
- [Get-MgBetaSecurityThreatIntelligenceHostPair](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/get-mgbetasecuritythreatintelligencehostpair)
- [Graph API Reference](https://learn.microsoft.com/graph/api/security-hostpair-get?view=graph-rest-beta)
- [Graph API Reference](https://learn.microsoft.com/graph/api/security-host-list-hostpairs?view=graph-rest-beta)
