...
Update-MgBetaSecurityProviderTenantSetting -ProviderTenantSettingId <string>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-AzureTenantId <string>]
...
```
Update-MgBetaSecurityProviderTenantSetting -ProviderTenantSettingId <string>
 -BodyParameter <IMicrosoftGraphProviderTenantSetting> [-ResponseHeadersVariable <string>] [-Break]
