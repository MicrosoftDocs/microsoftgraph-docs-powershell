...
### Get1
```
Get-MgBetaSecurityThreatIntelligenceHostPort -HostPortId <String> -HostId <String> [-ExpandProperty <String[]>]
...
[https://learn.microsoft.com/graph/api/security-hostport-get?view=graph-rest-beta](https://learn.microsoft.com/graph/api/security-hostport-get?view=graph-rest-beta)

[https://learn.microsoft.com/graph/api/security-host-list-ports?view=graph-rest-beta](https://learn.microsoft.com/graph/api/security-host-list-ports?view=graph-rest-beta)
