...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/new-mgbetasecuritycopilotworkspace
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaSecurityCopilotWorkspace
---

# New-MgBetaSecurityCopilotWorkspace
...
```
New-MgBetaSecurityCopilotWorkspace [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-DisplayName <string>] [-Id <string>]
 [-Plugins <IMicrosoftGraphSecurityCopilotPlugin[]>]
 [-Sessions <IMicrosoftGraphSecurityCopilotSession[]>] [-Break] [-Headers <IDictionary>]
...
```
New-MgBetaSecurityCopilotWorkspace -BodyParameter <IMicrosoftGraphSecurityCopilotWorkspace>
...
To construct, see NOTES section for PLUGINS properties and create a hash table.

```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphSecurityCopilotPlugin[]
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphSecurityCopilotSession[]
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphSecurityCopilotWorkspace
...
BODYPARAMETER `<IMicrosoftGraphSecurityCopilotWorkspace>`: workspace
...
- [New-MgBetaSecurityCopilotWorkspace](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/new-mgbetasecuritycopilotworkspace)
