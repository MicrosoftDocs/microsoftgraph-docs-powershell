...
Get-MgBetaSecurityThreatIntelligenceHostTracker -HostTrackerId $hostTrackerId

```
This example shows how to use the Get-MgBetaSecurityThreatIntelligenceHostTracker Cmdlet.
...
[https://learn.microsoft.com/graph/api/security-hosttracker-get?view=graph-rest-beta](https://learn.microsoft.com/graph/api/security-hosttracker-get?view=graph-rest-beta)

[https://learn.microsoft.com/graph/api/security-host-list-trackers?view=graph-rest-beta](https://learn.microsoft.com/graph/api/security-host-list-trackers?view=graph-rest-beta)
