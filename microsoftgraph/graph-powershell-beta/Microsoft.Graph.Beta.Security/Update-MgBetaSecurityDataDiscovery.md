...
```
Update-MgBetaSecurityDataDiscovery [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>]
 [-CloudAppDiscovery <IMicrosoftGraphSecurityDataDiscoveryReport>] [-Id <String>] [-Headers <IDictionary>]
...
```yaml
Type: IMicrosoftGraphSecurityDataDiscoveryRoot
