...
```
Update-MgBetaSecurityZone -ZoneId <string> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaSecurityZone -ZoneId <string> -BodyParameter <IMicrosoftGraphSecurityZone>
...
```
Update-MgBetaSecurityZone -InputObject <ISecurityIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>]
 [-Aggregations <IMicrosoftGraphSecurityAggregatedEnvironment[]>]
 [-Created <IMicrosoftGraphSecurityAuditInfo>] [-Description <string>] [-DisplayName <string>]
 [-Environments <IMicrosoftGraphSecurityEnvironment[]>] [-Id <string>]
...
```
Update-MgBetaSecurityZone -InputObject <ISecurityIdentity>
 -BodyParameter <IMicrosoftGraphSecurityZone> [-ResponseHeadersVariable <string>] [-Break]
