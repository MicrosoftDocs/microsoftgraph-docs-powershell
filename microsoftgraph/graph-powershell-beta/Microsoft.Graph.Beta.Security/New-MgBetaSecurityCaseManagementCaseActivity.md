...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/new-mgbetasecuritycasemanagementcaseactivity
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaSecurityCaseManagementCaseActivity
---

# New-MgBetaSecurityCaseManagementCaseActivity
...
```
New-MgBetaSecurityCaseManagementCaseActivity -CaseId <string> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-CreatedBy <string>] [-CreatedDateTime <datetime>]
 [-Id <string>] [-LastModifiedBy <string>] [-LastModifiedDateTime <datetime>] [-Break]
...
```
New-MgBetaSecurityCaseManagementCaseActivity -CaseId <string> -BodyParameter <hashtable>
...
```
New-MgBetaSecurityCaseManagementCaseActivity -InputObject <ISecurityIdentity>
...
- [New-MgBetaSecurityCaseManagementCaseActivity](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/new-mgbetasecuritycasemanagementcaseactivity)
- [Graph API Reference](https://learn.microsoft.com/graph/api/security-casemanagement-case-post-activities?view=graph-rest-beta)
