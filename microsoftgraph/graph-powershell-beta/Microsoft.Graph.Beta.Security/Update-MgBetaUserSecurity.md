...
```
Update-MgBetaUserSecurity -UserId <String> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-Id <String>]
 [-InformationProtection <IMicrosoftGraphSecurityInformationProtection>] [-Headers <IDictionary>]
...
```
Update-MgBetaUserSecurity -InputObject <ISecurityIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-Id <String>]
 [-InformationProtection <IMicrosoftGraphSecurityInformationProtection>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
