...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/remove-mgbetasecurityzone
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 09/23/2026
PlatyPS schema version: 2024-05-01
title: Remove-MgBetaSecurityZone
---

# Remove-MgBetaSecurityZone
...
```
Remove-MgBetaSecurityZone -ZoneId <string> [-IfMatch <string>] [-ResponseHeadersVariable <string>]
...
```
Remove-MgBetaSecurityZone -InputObject <ISecurityIdentity> [-IfMatch <string>]
...
- [Remove-MgBetaSecurityZone](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/remove-mgbetasecurityzone)
- [Graph API Reference](https://learn.microsoft.com/graph/api/security-zone-delete?view=graph-rest-beta)
