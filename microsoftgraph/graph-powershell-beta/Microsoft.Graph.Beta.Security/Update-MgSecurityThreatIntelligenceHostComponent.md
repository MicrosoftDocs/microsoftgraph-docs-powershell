...
Update-MgSecurityThreatIntelligenceHostComponent -HostComponentId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-LastSeenDateTime <DateTime>] [-Name <String>] [-Version <String>] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
Update-MgSecurityThreatIntelligenceHostComponent -HostComponentId <String>
 -BodyParameter <IMicrosoftGraphSecurityHostComponent> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
