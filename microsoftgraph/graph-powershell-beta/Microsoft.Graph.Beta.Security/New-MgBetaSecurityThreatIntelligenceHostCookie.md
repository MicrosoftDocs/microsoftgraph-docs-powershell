...
```
New-MgBetaSecurityThreatIntelligenceHostCookie [-AdditionalProperties <Hashtable>] [-Domain <String>]
...
### Create
```
New-MgBetaSecurityThreatIntelligenceHostCookie -BodyParameter <IMicrosoftGraphSecurityHostCookie> [-WhatIf]
