...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/update-mgbetasecuritycopilotworkspacesessionprompt
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaSecurityCopilotWorkspaceSessionPrompt
---

# Update-MgBetaSecurityCopilotWorkspaceSessionPrompt
...
```
Update-MgBetaSecurityCopilotWorkspaceSessionPrompt -PromptId <string> -SessionId <string>
 -WorkspaceId <string> [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-Content <string>] [-CreatedDateTime <datetime>]
 [-Evaluations <IMicrosoftGraphSecurityCopilotEvaluation[]>] [-Id <string>]
 [-LastModifiedDateTime <datetime>]
 [-SkillInputDescriptors <IMicrosoftGraphSecurityCopilotSkillInputDescriptor[]>]
 [-SkillName <string>] [-Type <string>] [-Break] [-Headers <IDictionary>]
...
```
Update-MgBetaSecurityCopilotWorkspaceSessionPrompt -PromptId <string> -SessionId <string>
 -WorkspaceId <string> -BodyParameter <IMicrosoftGraphSecurityCopilotPrompt>
...
```
Update-MgBetaSecurityCopilotWorkspaceSessionPrompt -InputObject <ISecurityIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-Content <string>]
 [-CreatedDateTime <datetime>] [-Evaluations <IMicrosoftGraphSecurityCopilotEvaluation[]>]
...
```
Update-MgBetaSecurityCopilotWorkspaceSessionPrompt -InputObject <ISecurityIdentity>
 -BodyParameter <IMicrosoftGraphSecurityCopilotPrompt> [-ResponseHeadersVariable <string>] [-Break]
...
To construct, see NOTES section for EVALUATIONS properties and create a hash table.
...
To construct, see NOTES section for SKILLINPUTDESCRIPTORS properties and create a hash table.

```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphSecurityCopilotSkillInputDescriptor[]
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
- [Update-MgBetaSecurityCopilotWorkspaceSessionPrompt](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/update-mgbetasecuritycopilotworkspacesessionprompt)
