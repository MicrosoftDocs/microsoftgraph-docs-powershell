...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/update-mgbetasecuritycasemanagementcaseactivity
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaSecurityCaseManagementCaseActivity
---

# Update-MgBetaSecurityCaseManagementCaseActivity

## SYNOPSIS

Update a comment activity in a case timeline.
...
```
Update-MgBetaSecurityCaseManagementCaseActivity -ActivityId <string> -CaseId <string>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-CreatedBy <string>]
 [-CreatedDateTime <datetime>] [-Id <string>] [-LastModifiedBy <string>]
...
```
Update-MgBetaSecurityCaseManagementCaseActivity -InputObject <ISecurityIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-CreatedBy <string>]
 [-CreatedDateTime <datetime>] [-Id <string>] [-LastModifiedBy <string>]
 [-LastModifiedDateTime <datetime>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
...
- [Update-MgBetaSecurityCaseManagementCaseActivity](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/update-mgbetasecuritycasemanagementcaseactivity)
- [Graph API Reference](https://learn.microsoft.com/graph/api/security-casemanagement-activity-update?view=graph-rest-beta)
