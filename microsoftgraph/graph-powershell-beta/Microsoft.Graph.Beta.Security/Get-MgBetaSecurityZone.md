...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/get-mgbetasecurityzone
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaSecurityZone
---
...
```
Get-MgBetaSecurityZone [-ExpandProperty <string[]>] [-Property <string[]>] [-Filter <string>]
...
```
Get-MgBetaSecurityZone -ZoneId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
...
```
Get-MgBetaSecurityZone -InputObject <ISecurityIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgBetaSecurityZone](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/get-mgbetasecurityzone)
- [Graph API Reference](https://learn.microsoft.com/graph/api/security-zone-get?view=graph-rest-beta)
- [Graph API Reference](https://learn.microsoft.com/graph/api/security-security-list-zones?view=graph-rest-beta)
