...
# Invoke-MgBetaExecuteSecurityIncidentTaskResponseAction
...
```
Invoke-MgBetaExecuteSecurityIncidentTaskResponseAction -IncidentTaskId <string>
...
```
Invoke-MgBetaExecuteSecurityIncidentTaskResponseAction -InputObject <ISecurityIdentity>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru]
 [-Proxy <uri>] [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
 [<CommonParameters>]
