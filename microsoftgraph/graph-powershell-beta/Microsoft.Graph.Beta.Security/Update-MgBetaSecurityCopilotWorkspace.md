...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/update-mgbetasecuritycopilotworkspace
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaSecurityCopilotWorkspace
---

# Update-MgBetaSecurityCopilotWorkspace
...
```
Update-MgBetaSecurityCopilotWorkspace -WorkspaceId <string> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaSecurityCopilotWorkspace -WorkspaceId <string>
 -BodyParameter <IMicrosoftGraphSecurityCopilotWorkspace> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaSecurityCopilotWorkspace -InputObject <ISecurityIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-DisplayName <string>]
 [-Id <string>] [-Plugins <IMicrosoftGraphSecurityCopilotPlugin[]>]
 [-Sessions <IMicrosoftGraphSecurityCopilotSession[]>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
- [Update-MgBetaSecurityCopilotWorkspace](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/update-mgbetasecuritycopilotworkspace)
