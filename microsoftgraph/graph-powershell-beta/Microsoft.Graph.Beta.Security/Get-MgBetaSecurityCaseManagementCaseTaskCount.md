...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/get-mgbetasecuritycasemanagementcasetaskcount
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaSecurityCaseManagementCaseTaskCount
---

# Get-MgBetaSecurityCaseManagementCaseTaskCount
...
```
Get-MgBetaSecurityCaseManagementCaseTaskCount -CaseId <string> [-Filter <string>] [-Search <string>]
...
```
Get-MgBetaSecurityCaseManagementCaseTaskCount -InputObject <ISecurityIdentity> [-Filter <string>]
...
- [Get-MgBetaSecurityCaseManagementCaseTaskCount](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/get-mgbetasecuritycasemanagementcasetaskcount)
