...
### List (Default)
```
Get-MgBetaSecurityAction [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaSecurityAction -SecurityActionId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgBetaSecurityAction -InputObject <ISecurityIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
[https://learn.microsoft.com/graph/api/securityaction-get?view=graph-rest-beta](https://learn.microsoft.com/graph/api/securityaction-get?view=graph-rest-beta)

[https://learn.microsoft.com/graph/api/securityactions-list?view=graph-rest-beta](https://learn.microsoft.com/graph/api/securityactions-list?view=graph-rest-beta)
