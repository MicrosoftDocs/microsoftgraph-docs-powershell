...
# Set-MgBetaSecurityCaseManagementCaseAttachmentContent

## SYNOPSIS

Upload binary content for an attachment.
Create the attachment metadata first by using Create case attachment.
...
```
Set-MgBetaSecurityCaseManagementCaseAttachmentContent -AttachmentId <string> -CaseId <string>
...
```
Set-MgBetaSecurityCaseManagementCaseAttachmentContent -InputObject <ISecurityIdentity>
 -InFile <string> [-Data <Stream>] [-ResponseHeadersVariable <string>] [-Break]
 [-ContentType <string>] [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
