...
title: New-MgBetaSecurityThreatIntelligenceArticle
---
...
```
New-MgBetaSecurityThreatIntelligenceArticle [-ResponseHeadersVariable <string>]
 ...
 [-Indicators <IMicrosoftGraphSecurityArticleIndicator[]>] [-IsFeatured]
