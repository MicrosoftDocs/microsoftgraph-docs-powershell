...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/get-mgbetasecurityzoneenvironmentcount
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaSecurityZoneEnvironmentCount
---

# Get-MgBetaSecurityZoneEnvironmentCount
...
```
Get-MgBetaSecurityZoneEnvironmentCount -ZoneId <string> [-Filter <string>] [-Search <string>]
...
```
Get-MgBetaSecurityZoneEnvironmentCount -InputObject <ISecurityIdentity> [-Filter <string>]
...
- [Get-MgBetaSecurityZoneEnvironmentCount](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/get-mgbetasecurityzoneenvironmentcount)
