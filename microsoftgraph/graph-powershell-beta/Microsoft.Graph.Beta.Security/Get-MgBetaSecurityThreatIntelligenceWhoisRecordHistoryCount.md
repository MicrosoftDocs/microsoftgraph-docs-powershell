...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/get-mgbetasecuritythreatintelligencewhoisrecordhistorycount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaSecurityThreatIntelligenceWhoisRecordHistoryCount -WhoisRecordId <String> [-Filter <String>]
...
### GetViaIdentity
```
Get-MgBetaSecurityThreatIntelligenceWhoisRecordHistoryCount -InputObject <ISecurityIdentity> [-Filter <String>]
 [-Search <String>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
