...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/remove-mgbetasecurityattacksimulationtrainingcampaign
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: Remove-MgBetaSecurityAttackSimulationTrainingCampaign
---
...
```
Remove-MgBetaSecurityAttackSimulationTrainingCampaign -TrainingCampaignId <string>
...
```
Remove-MgBetaSecurityAttackSimulationTrainingCampaign -InputObject <ISecurityIdentity>
 [-IfMatch <string>] [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru]
 [-Proxy <uri>] [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
 [<CommonParameters>]
