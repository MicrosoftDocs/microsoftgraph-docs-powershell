...
### Delete (Default)
```
Remove-MgBetaSecurityAttackSimulationTrainingCampaign -TrainingCampaignId <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgBetaSecurityAttackSimulationTrainingCampaign -InputObject <ISecurityIdentity> [-IfMatch <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
Remove-MgBetaSecurityAttackSimulationTrainingCampaign -TrainingCampaignId $trainingCampaignId

```
This example shows how to use the Remove-MgBetaSecurityAttackSimulationTrainingCampaign Cmdlet.
...
[https://learn.microsoft.com/graph/api/attacksimulationroot-delete-trainingcampaigns?view=graph-rest-beta](https://learn.microsoft.com/graph/api/attacksimulationroot-delete-trainingcampaigns?view=graph-rest-beta)
