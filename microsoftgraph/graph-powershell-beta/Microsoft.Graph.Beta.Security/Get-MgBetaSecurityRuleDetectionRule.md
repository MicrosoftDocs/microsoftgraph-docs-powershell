...
### List (Default)
```
Get-MgBetaSecurityRuleDetectionRule [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
[https://learn.microsoft.com/graph/api/security-detectionrule-list?view=graph-rest-beta](https://learn.microsoft.com/graph/api/security-detectionrule-list?view=graph-rest-beta)
