...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/get-mgbetasecuritythreatintelligencehost
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaSecurityThreatIntelligenceHost
---
...
```
Get-MgBetaSecurityThreatIntelligenceHost [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaSecurityThreatIntelligenceHost -HostId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaSecurityThreatIntelligenceHost -InputObject <ISecurityIdentity>
...
- [Get-MgBetaSecurityThreatIntelligenceHost](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/get-mgbetasecuritythreatintelligencehost)
- [Graph API Reference](https://learn.microsoft.com/graph/api/security-host-get?view=graph-rest-beta)
