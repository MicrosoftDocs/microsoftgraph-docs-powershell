...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/get-mgbetasecuritycasemanagementcasetypeconfigurationstatus
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaSecurityCaseManagementCaseTypeConfigurationStatus
---

# Get-MgBetaSecurityCaseManagementCaseTypeConfigurationStatus

## SYNOPSIS

The contained top-level statuses that a case of this type can be set to.
Read-only.
...
```
Get-MgBetaSecurityCaseManagementCaseTypeConfigurationStatus -CaseTypeConfigurationId <string>
...
```
Get-MgBetaSecurityCaseManagementCaseTypeConfigurationStatus -CaseTypeConfigurationId <string>
 -StatusDefinitionId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaSecurityCaseManagementCaseTypeConfigurationStatus -InputObject <ISecurityIdentity>
...
The unique identifier of statusDefinition
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphSecurityCaseManagementStatusDefinition
...
- [Get-MgBetaSecurityCaseManagementCaseTypeConfigurationStatus](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/get-mgbetasecuritycasemanagementcasetypeconfigurationstatus)
