...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/get-mgbetasecuritycopilotworkspace
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaSecurityCopilotWorkspace
---

# Get-MgBetaSecurityCopilotWorkspace
...
```
Get-MgBetaSecurityCopilotWorkspace [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaSecurityCopilotWorkspace -WorkspaceId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaSecurityCopilotWorkspace -InputObject <ISecurityIdentity> [-ExpandProperty <string[]>]
 [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
```
