...
# Update-MgBetaSecurityCaseManagementCase
...
```
Update-MgBetaSecurityCaseManagementCase -CaseId <string> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaSecurityCaseManagementCase -CaseId <string>
 -BodyParameter <IMicrosoftGraphSecurityCaseManagementCase> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaSecurityCaseManagementCase -InputObject <ISecurityIdentity>
 [-ResponseHeadersVariable <string>] [-Activities <IMicrosoftGraphSecurityCaseManagementActivity[]>]
