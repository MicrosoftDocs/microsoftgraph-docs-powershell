...
# Invoke-MgBetaProcessSecurityDataSecurityAndGovernanceContent
...
```
Invoke-MgBetaProcessSecurityDataSecurityAndGovernanceContent [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-ContentToProcess <IMicrosoftGraphProcessContentRequest>]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths1IozinuSecurityDatasecurityandgovernanceMicrosoftGraphProcesscontentPostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
To construct, see NOTES section for CONTENTTOPROCESS properties and create a hash table.

```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphProcessContentRequest
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths1IozinuSecurityDatasecurityandgovernanceMicrosoftGraphProcesscontentPostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphProcessContentResponse
