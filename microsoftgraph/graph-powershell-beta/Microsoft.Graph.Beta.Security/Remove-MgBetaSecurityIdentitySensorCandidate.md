...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/remove-mgbetasecurityidentitysensorcandidate
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Remove-MgBetaSecurityIdentitySensorCandidate
---

# Remove-MgBetaSecurityIdentitySensorCandidate
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Remove-MgSecurityIdentitySensorCandidate](/powershell/module/Microsoft.Graph.Security/Remove-MgSecurityIdentitySensorCandidate?view=graph-powershell-1.0)
...
```
Remove-MgBetaSecurityIdentitySensorCandidate -SensorCandidateId <string> [-IfMatch <string>]
...
```
Remove-MgBetaSecurityIdentitySensorCandidate -InputObject <ISecurityIdentity> [-IfMatch <string>]
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru]
 [-Proxy <uri>] [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
- [Remove-MgBetaSecurityIdentitySensorCandidate](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/remove-mgbetasecurityidentitysensorcandidate)
