...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/get-mgbetasecurityidentitysensormigration
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaSecurityIdentitySensorMigration
---
...
```
Get-MgBetaSecurityIdentitySensorMigration [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaSecurityIdentitySensorMigration -SensorMigrationId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaSecurityIdentitySensorMigration -InputObject <ISecurityIdentity>
