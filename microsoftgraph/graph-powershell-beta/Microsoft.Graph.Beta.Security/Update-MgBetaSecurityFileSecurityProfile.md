...
Update-MgBetaSecurityFileSecurityProfile -FileSecurityProfileId <string>
 [-ResponseHeadersVariable <string>] [-ActivityGroupNames <string[]>]
 ...
 [-RiskScore <string>] [-Size <long>] [-Tags <string[]>]
...
```
Update-MgBetaSecurityFileSecurityProfile -FileSecurityProfileId <string>
 -BodyParameter <IMicrosoftGraphFileSecurityProfile> [-ResponseHeadersVariable <string>] [-Break]
