...
### List (Default)
```
Get-MgBetaSecurityThreatIntelligenceSslCertificate [-ExpandProperty <String[]>] [-Property <String[]>]
...
[https://learn.microsoft.com/graph/api/security-sslcertificate-get?view=graph-rest-beta](https://learn.microsoft.com/graph/api/security-sslcertificate-get?view=graph-rest-beta)

[https://learn.microsoft.com/graph/api/security-threatintelligence-list-sslcertificates?view=graph-rest-beta](https://learn.microsoft.com/graph/api/security-threatintelligence-list-sslcertificates?view=graph-rest-beta)
