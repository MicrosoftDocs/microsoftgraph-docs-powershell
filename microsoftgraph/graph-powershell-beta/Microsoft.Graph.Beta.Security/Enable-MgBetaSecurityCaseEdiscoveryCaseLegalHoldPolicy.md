...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/enable-mgbetasecuritycaseediscoverycaselegalholdpolicy
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 09/23/2026
PlatyPS schema version: 2024-05-01
title: Enable-MgBetaSecurityCaseEdiscoveryCaseLegalHoldPolicy
---

# Enable-MgBetaSecurityCaseEdiscoveryCaseLegalHoldPolicy

## SYNOPSIS

Enable an eDiscovery hold policy (legal hold) to apply the hold across all the data sources included in the policy in a single operation.
...
```
Enable-MgBetaSecurityCaseEdiscoveryCaseLegalHoldPolicy -EdiscoveryCaseId <string>
 -EdiscoveryHoldPolicyId <string> [-ResponseHeadersVariable <string>] [-Break]
...
```
Enable-MgBetaSecurityCaseEdiscoveryCaseLegalHoldPolicy -InputObject <ISecurityIdentity>
...
- [Enable-MgBetaSecurityCaseEdiscoveryCaseLegalHoldPolicy](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/enable-mgbetasecuritycaseediscoverycaselegalholdpolicy)
- [Graph API Reference](https://learn.microsoft.com/graph/api/security-ediscoveryholdpolicy-enablepolicy?view=graph-rest-beta)
