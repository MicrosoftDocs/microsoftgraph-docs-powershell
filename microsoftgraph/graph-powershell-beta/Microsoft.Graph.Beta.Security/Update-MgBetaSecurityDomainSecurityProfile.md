...
Update-MgBetaSecurityDomainSecurityProfile -DomainSecurityProfileId <string>
 ...
 [-CountHits <int>] [-CountInOrg <int>] [-DomainCategories <IMicrosoftGraphReputationCategory[]>]
...
```
Update-MgBetaSecurityDomainSecurityProfile -DomainSecurityProfileId <string>
 -BodyParameter <IMicrosoftGraphDomainSecurityProfile> [-ResponseHeadersVariable <string>] [-Break]
