...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/get-mgbetasecuritycasemanagementcasetypeconfigurationcustomfield
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 09/23/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaSecurityCaseManagementCaseTypeConfigurationCustomField
---

# Get-MgBetaSecurityCaseManagementCaseTypeConfigurationCustomField

## SYNOPSIS

The contained custom-field definitions that make up the blank-form schema for this case type.
Read-only.
...
```
Get-MgBetaSecurityCaseManagementCaseTypeConfigurationCustomField -CaseTypeConfigurationId <string>
...
```
Get-MgBetaSecurityCaseManagementCaseTypeConfigurationCustomField -CaseTypeConfigurationId <string>
 -CustomFieldDefinitionId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaSecurityCaseManagementCaseTypeConfigurationCustomField -InputObject <ISecurityIdentity>
...
### -CaseTypeConfigurationId

The unique identifier of caseTypeConfiguration
...
The unique identifier of customFieldDefinition
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphSecurityCaseManagementCustomFieldDefinition
