...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/remove-mgbetasecuritydatadiscoverycloudappdiscoveryuploadedstream
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaSecurityDataDiscoveryCloudAppDiscoveryUploadedStream -CloudAppDiscoveryReportId <String>
