...
### List (Default)
```
Get-MgBetaSecurityIdentitySensor [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaSecurityIdentitySensor -SensorId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgBetaSecurityIdentitySensor -InputObject <ISecurityIdentity> [-ExpandProperty <String[]>]
