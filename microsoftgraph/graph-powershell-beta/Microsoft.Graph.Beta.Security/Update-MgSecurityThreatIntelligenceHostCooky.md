...
Update-MgSecurityThreatIntelligenceHostCooky -HostCookieId <String> [-AdditionalProperties <Hashtable>]
 ...
 [-LastSeenDateTime <DateTime>] [-Name <String>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Update
```
Update-MgSecurityThreatIntelligenceHostCooky -HostCookieId <String>
 -BodyParameter <IMicrosoftGraphSecurityHostCookie> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
