...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/new-mgbetasecuritycopilotworkspaceplugin
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 09/23/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaSecurityCopilotWorkspacePlugin
---

# New-MgBetaSecurityCopilotWorkspacePlugin
...
```
New-MgBetaSecurityCopilotWorkspacePlugin -WorkspaceId <string> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Authorization <IMicrosoftGraphSecurityCopilotPluginAuth>]
 [-CatalogScope <string>] [-Category <string>] [-Description <string>] [-DisplayName <string>]
 [-IsEnabled] [-Name <string>] [-PreviewState <string>]
 [-Settings <IMicrosoftGraphSecurityCopilotPluginSetting[]>] [-SupportedAuthTypes <string>] [-Break]
...
```
New-MgBetaSecurityCopilotWorkspacePlugin -WorkspaceId <string>
...
```
New-MgBetaSecurityCopilotWorkspacePlugin -InputObject <ISecurityIdentity>
