...
# Update-MgBetaSecurityIdentitySettingAutoAuditingConfiguration
...
```
Update-MgBetaSecurityIdentitySettingAutoAuditingConfiguration [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Id <string>] [-IsAutomatic] [-Break] [-Headers <IDictionary>]
...
```
Update-MgBetaSecurityIdentitySettingAutoAuditingConfiguration
 -BodyParameter <IMicrosoftGraphSecurityAutoAuditingConfiguration>
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphSecurityAutoAuditingConfiguration
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphSecurityAutoAuditingConfiguration
