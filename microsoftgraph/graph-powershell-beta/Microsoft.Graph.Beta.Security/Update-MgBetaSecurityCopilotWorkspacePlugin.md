...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/update-mgbetasecuritycopilotworkspaceplugin
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaSecurityCopilotWorkspacePlugin
---

# Update-MgBetaSecurityCopilotWorkspacePlugin
...
```
Update-MgBetaSecurityCopilotWorkspacePlugin -PluginName <string> -WorkspaceId <string>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-Authorization <IMicrosoftGraphSecurityCopilotPluginAuth>] [-CatalogScope <string>]
 [-Category <string>] [-Description <string>] [-DisplayName <string>] [-IsEnabled] [-Name <string>]
 [-PreviewState <string>] [-Settings <IMicrosoftGraphSecurityCopilotPluginSetting[]>]
 [-SupportedAuthTypes <string>] [-Break] [-Headers <IDictionary>]
...
```
Update-MgBetaSecurityCopilotWorkspacePlugin -PluginName <string> -WorkspaceId <string>
 -BodyParameter <IMicrosoftGraphSecurityCopilotPlugin> [-ResponseHeadersVariable <string>] [-Break]
...
```
Update-MgBetaSecurityCopilotWorkspacePlugin -InputObject <ISecurityIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-Authorization <IMicrosoftGraphSecurityCopilotPluginAuth>] [-CatalogScope <string>]
 [-Category <string>] [-Description <string>] [-DisplayName <string>] [-IsEnabled] [-Name <string>]
 [-PreviewState <string>] [-Settings <IMicrosoftGraphSecurityCopilotPluginSetting[]>]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphSecurityCopilotPluginAuth
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
Displays whether the plugin is enabled for use within the catalogScope.
Supports $filter (eq).
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphSecurityCopilotPluginSetting[]
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphSecurityCopilotPlugin
