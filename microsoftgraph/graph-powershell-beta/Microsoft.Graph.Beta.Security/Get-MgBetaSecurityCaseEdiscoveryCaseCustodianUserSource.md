...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/get-mgbetasecuritycaseediscoverycasecustodianusersource
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaSecurityCaseEdiscoveryCaseCustodianUserSource
---
...
```
Get-MgBetaSecurityCaseEdiscoveryCaseCustodianUserSource -EdiscoveryCaseId <string>
 -EdiscoveryCustodianId <string> -UserSourceId <string> [-ExpandProperty <string[]>]
...
```
This example shows how to use the Get-MgBetaSecurityCaseEdiscoveryCaseCustodianUserSource Cmdlet.
...
- [Get-MgBetaSecurityCaseEdiscoveryCaseCustodianUserSource](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/get-mgbetasecuritycaseediscoverycasecustodianusersource)
- [Graph API Reference](https://learn.microsoft.com/graph/api/security-ediscoverycustodian-list-usersources?view=graph-rest-beta)
