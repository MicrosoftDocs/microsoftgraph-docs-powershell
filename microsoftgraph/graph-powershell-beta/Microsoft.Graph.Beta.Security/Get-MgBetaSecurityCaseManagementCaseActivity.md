...
# Get-MgBetaSecurityCaseManagementCaseActivity
...
```
Get-MgBetaSecurityCaseManagementCaseActivity -CaseId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaSecurityCaseManagementCaseActivity -ActivityId <string> -CaseId <string>
...
```
Get-MgBetaSecurityCaseManagementCaseActivity -InputObject <ISecurityIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphSecurityCaseManagementActivity
