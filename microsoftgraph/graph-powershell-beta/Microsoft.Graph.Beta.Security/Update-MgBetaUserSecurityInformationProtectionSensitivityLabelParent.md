...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/update-mgbetausersecurityinformationprotectionsensitivitylabelparent
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Update-MgBetaUserSecurityInformationProtectionSensitivityLabelParent
---
...
Update-MgBetaUserSecurityInformationProtectionSensitivityLabelParent -SensitivityLabelId <string>
 ...
 [-Color <string>] [-ContentFormats <string[]>] [-Description <string>] [-HasProtection]
 [-Id <string>] [-IsActive] [-IsAppliable] [-Name <string>]
 [-Parent <IMicrosoftGraphSecuritySensitivityLabel>] [-Sensitivity <int>] [-Tooltip <string>]
...
```
Update-MgBetaUserSecurityInformationProtectionSensitivityLabelParent -SensitivityLabelId <string>
 -UserId <string> -BodyParameter <IMicrosoftGraphSecuritySensitivityLabel>
...
```
Update-MgBetaUserSecurityInformationProtectionSensitivityLabelParent
 -InputObject <ISecurityIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Color <string>] [-ContentFormats <string[]>]
...
```
Update-MgBetaUserSecurityInformationProtectionSensitivityLabelParent
 -InputObject <ISecurityIdentity> -BodyParameter <IMicrosoftGraphSecuritySensitivityLabel>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
 [<CommonParameters>]
