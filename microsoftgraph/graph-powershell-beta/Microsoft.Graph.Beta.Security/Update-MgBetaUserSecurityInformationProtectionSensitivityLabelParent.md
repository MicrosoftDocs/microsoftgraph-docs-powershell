...
Update-MgBetaUserSecurityInformationProtectionSensitivityLabelParent -SensitivityLabelId <String>
 -UserId <String> [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>] [-Color <String>]
...
```
Update-MgBetaUserSecurityInformationProtectionSensitivityLabelParent -SensitivityLabelId <String>
 -UserId <String> -BodyParameter <IMicrosoftGraphSecuritySensitivityLabel> [-ResponseHeadersVariable <String>]
