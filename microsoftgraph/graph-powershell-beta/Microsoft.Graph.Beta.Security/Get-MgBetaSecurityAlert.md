...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/get-mgbetasecurityalert
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaSecurityAlert
---
...
```
Get-MgBetaSecurityAlert -InputObject <ISecurityIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgBetaSecurityAlert](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/get-mgbetasecurityalert)
- [Graph API Reference](https://learn.microsoft.com/graph/api/alert-get?view=graph-rest-beta)
- [Graph API Reference](https://learn.microsoft.com/graph/api/alert-list?view=graph-rest-beta)
