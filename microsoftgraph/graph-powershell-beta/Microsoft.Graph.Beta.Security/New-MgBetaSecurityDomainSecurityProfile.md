...
```
New-MgBetaSecurityDomainSecurityProfile [-ResponseHeadersVariable <string>]
 [-ActivityGroupNames <string[]>] [-AdditionalProperties <hashtable>]
 [-AzureSubscriptionId <string>] [-AzureTenantId <string>] [-CountHits <int>] [-CountInOrg <int>]
...
- [New-MgBetaSecurityDomainSecurityProfile](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/new-mgbetasecuritydomainsecurityprofile)
