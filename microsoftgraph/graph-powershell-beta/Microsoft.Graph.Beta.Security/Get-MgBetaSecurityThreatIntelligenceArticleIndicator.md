...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/get-mgbetasecuritythreatintelligencearticleindicator
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaSecurityThreatIntelligenceArticleIndicator
---
...
```
Get-MgBetaSecurityThreatIntelligenceArticleIndicator [-ExpandProperty <string[]>]
...
```
Get-MgBetaSecurityThreatIntelligenceArticleIndicator -ArticleIndicatorId <string>
 -ArticleId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaSecurityThreatIntelligenceArticleIndicator -ArticleId <string>
...
- [Get-MgBetaSecurityThreatIntelligenceArticleIndicator](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/get-mgbetasecuritythreatintelligencearticleindicator)
- [Graph API Reference](https://learn.microsoft.com/graph/api/security-articleindicator-get?view=graph-rest-beta)
- [Graph API Reference](https://learn.microsoft.com/graph/api/security-article-list-indicators?view=graph-rest-beta)
