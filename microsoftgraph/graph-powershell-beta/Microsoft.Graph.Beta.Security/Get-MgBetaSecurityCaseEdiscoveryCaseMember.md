...
```
Get-MgBetaSecurityCaseEdiscoveryCaseMember -EdiscoveryCaseId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaSecurityCaseEdiscoveryCaseMember -EdiscoveryCaseId <string>
 -EdiscoveryCaseMemberId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaSecurityCaseEdiscoveryCaseMember -InputObject <ISecurityIdentity>
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphSecurityEdiscoveryCaseMember
...
- [Get-MgBetaSecurityCaseEdiscoveryCaseMember](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/get-mgbetasecuritycaseediscoverycasemember)
- [Graph API Reference](https://learn.microsoft.com/graph/api/security-ediscoverycasemember-list?view=graph-rest-beta)
