...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/get-mgbetasecuritycaseediscoverycasemember
schema: 2.0.0
...
### Get
```
Get-MgBetaSecurityCaseEdiscoveryCaseMember -EdiscoveryCaseId <String> -EdiscoveryCaseMemberId <String>
...
### GetViaIdentity
```
Get-MgBetaSecurityCaseEdiscoveryCaseMember -InputObject <ISecurityIdentity> [-ExpandProperty <String[]>]
