...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/update-mgbetasecurityattacksimulationautomationrun
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaSecurityAttackSimulationAutomationRun
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgSecurityAttackSimulationAutomationRun](/powershell/module/Microsoft.Graph.Security/Update-MgSecurityAttackSimulationAutomationRun?view=graph-powershell-1.0)
...
Update-MgBetaSecurityAttackSimulationAutomationRun -SimulationAutomationId <string>
 -SimulationAutomationRunId <string> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-EndDateTime <datetime>] [-Id <string>]
 [-SimulationId <string>] [-StartDateTime <datetime>] [-Status <string>] [-Break]
...
- [Update-MgBetaSecurityAttackSimulationAutomationRun](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/update-mgbetasecurityattacksimulationautomationrun)
