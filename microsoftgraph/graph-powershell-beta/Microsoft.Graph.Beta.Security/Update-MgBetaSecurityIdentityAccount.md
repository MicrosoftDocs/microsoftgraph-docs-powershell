...
# Update-MgBetaSecurityIdentityAccount
...
```
Update-MgBetaSecurityIdentityAccount -IdentityAccountsId <string>
...
```
Update-MgBetaSecurityIdentityAccount -InputObject <ISecurityIdentity>
 [-ResponseHeadersVariable <string>] [-Accounts <IMicrosoftGraphSecurityAccount[]>]
 [-AdditionalProperties <hashtable>] [-CloudSecurityIdentifier <string>] [-DisplayName <string>]
 [-Domain <string>] [-Id <string>] [-IsEnabled] [-OnPremisesSecurityIdentifier <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphSecurityAccount[]
DefaultValue: ''
