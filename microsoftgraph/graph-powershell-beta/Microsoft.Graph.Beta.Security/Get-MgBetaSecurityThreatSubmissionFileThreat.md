...
### List (Default)
```
Get-MgBetaSecurityThreatSubmissionFileThreat [-ExpandProperty <String[]>] [-Property <String[]>]
...
[https://learn.microsoft.com/graph/api/security-filethreatsubmission-get?view=graph-rest-beta](https://learn.microsoft.com/graph/api/security-filethreatsubmission-get?view=graph-rest-beta)

[https://learn.microsoft.com/graph/api/security-filethreatsubmission-list?view=graph-rest-beta](https://learn.microsoft.com/graph/api/security-filethreatsubmission-list?view=graph-rest-beta)
