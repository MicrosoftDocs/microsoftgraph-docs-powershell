...
```
Update-MgBetaSecurityCaseEdiscoveryCaseTag -EdiscoveryCaseId <string>
 -EdiscoveryReviewTagId <string> [-ResponseHeadersVariable <string>]
 ...
 [-Parent <IMicrosoftGraphSecurityEdiscoveryReviewTag>] [-Break] [-Headers <IDictionary>]
...
```
Update-MgBetaSecurityCaseEdiscoveryCaseTag -EdiscoveryCaseId <string>
 -EdiscoveryReviewTagId <string> -BodyParameter <IMicrosoftGraphSecurityEdiscoveryReviewTag>
