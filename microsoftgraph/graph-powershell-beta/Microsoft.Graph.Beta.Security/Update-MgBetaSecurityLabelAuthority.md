...
```
Update-MgBetaSecurityLabelAuthority -AuthorityTemplateId <String> [-ResponseHeadersVariable <String>]
...
```
Update-MgBetaSecurityLabelAuthority -InputObject <ISecurityIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-CreatedBy <IMicrosoftGraphIdentitySet>] [-CreatedDateTime <DateTime>]
 [-DisplayName <String>] [-Id <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgSecurityLabelAuthority](/powershell/module/Microsoft.Graph.Security/Update-MgSecurityLabelAuthority?view=graph-powershell-1.0)
