...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/update-mgbetasecuritydatadiscoverycloudappdiscoveryuploadedstream
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Update-MgBetaSecurityDataDiscoveryCloudAppDiscoveryUploadedStream
---
...
```
Update-MgBetaSecurityDataDiscoveryCloudAppDiscoveryUploadedStream
 -CloudAppDiscoveryReportId <string> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-AnonymizeMachineData] [-AnonymizeUserData]
 [-CreatedDateTime <datetime>] [-Description <string>] [-DisplayName <string>] [-Id <string>]
 [-IsSnapshotReport] [-LastDataReceivedDateTime <datetime>] [-LastModifiedDateTime <datetime>]
 [-LogDataProvider <string>] [-LogFileCount <int>] [-ReceiverProtocol <string>]
 [-SupportedEntityTypes <string[]>] [-SupportedTrafficTypes <string[]>] [-Break]
...
```
Update-MgBetaSecurityDataDiscoveryCloudAppDiscoveryUploadedStream
 -CloudAppDiscoveryReportId <string> -BodyParameter <IMicrosoftGraphSecurityCloudAppDiscoveryReport>
...
Update-MgBetaSecurityDataDiscoveryCloudAppDiscoveryUploadedStream -InputObject <ISecurityIdentity>
 ...
 [-Id <string>] [-IsSnapshotReport] [-LastDataReceivedDateTime <datetime>]
 [-LastModifiedDateTime <datetime>] [-LogDataProvider <string>] [-LogFileCount <int>]
 [-ReceiverProtocol <string>] [-SupportedEntityTypes <string[]>] [-SupportedTrafficTypes <string[]>]
