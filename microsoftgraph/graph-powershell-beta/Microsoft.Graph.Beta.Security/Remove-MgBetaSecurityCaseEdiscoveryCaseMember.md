...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/remove-mgbetasecuritycaseediscoverycasemember
schema: 2.0.0
...
### Delete (Default)
```
Remove-MgBetaSecurityCaseEdiscoveryCaseMember -EdiscoveryCaseId <String> -EdiscoveryCaseMemberId <String>
