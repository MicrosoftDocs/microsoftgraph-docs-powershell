...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/get-mgbetasecuritythreatintelligencehostsslcertificate
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaSecurityThreatIntelligenceHostSslCertificate
---
...
```
Get-MgBetaSecurityThreatIntelligenceHostSslCertificate [-ExpandProperty <string[]>]
...
```
Get-MgBetaSecurityThreatIntelligenceHostSslCertificate -HostSslCertificateId <string>
 -HostId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
- [Get-MgBetaSecurityThreatIntelligenceHostSslCertificate](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/get-mgbetasecuritythreatintelligencehostsslcertificate)
- [Graph API Reference](https://learn.microsoft.com/graph/api/security-hostsslcertificate-get?view=graph-rest-beta)
- [Graph API Reference](https://learn.microsoft.com/graph/api/security-host-list-sslcertificates?view=graph-rest-beta)
