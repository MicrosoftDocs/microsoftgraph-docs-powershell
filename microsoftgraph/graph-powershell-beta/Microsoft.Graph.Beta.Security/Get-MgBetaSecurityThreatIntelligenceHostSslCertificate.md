...
### List (Default)
```
Get-MgBetaSecurityThreatIntelligenceHostSslCertificate [-ExpandProperty <String[]>] [-Property <String[]>]
...
### Get1
```
Get-MgBetaSecurityThreatIntelligenceHostSslCertificate -HostSslCertificateId <String> -HostId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
