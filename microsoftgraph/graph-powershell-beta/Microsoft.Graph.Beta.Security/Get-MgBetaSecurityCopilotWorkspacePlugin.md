...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/get-mgbetasecuritycopilotworkspaceplugin
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaSecurityCopilotWorkspacePlugin
---

# Get-MgBetaSecurityCopilotWorkspacePlugin
...
```
Get-MgBetaSecurityCopilotWorkspacePlugin -WorkspaceId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaSecurityCopilotWorkspacePlugin -PluginName <string> -WorkspaceId <string>
...
```
Get-MgBetaSecurityCopilotWorkspacePlugin -InputObject <ISecurityIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
...
- [Get-MgBetaSecurityCopilotWorkspacePlugin](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/get-mgbetasecuritycopilotworkspaceplugin)
