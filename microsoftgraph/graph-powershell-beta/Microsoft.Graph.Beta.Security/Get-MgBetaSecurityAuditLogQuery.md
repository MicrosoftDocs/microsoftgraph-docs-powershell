...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/get-mgbetasecurityauditlogquery
schema: 2.0.0
...
### List (Default)
```
Get-MgBetaSecurityAuditLogQuery [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaSecurityAuditLogQuery -AuditLogQueryId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
[https://learn.microsoft.com/graph/api/security-auditlogquery-get?view=graph-rest-beta](https://learn.microsoft.com/graph/api/security-auditlogquery-get?view=graph-rest-beta)

[https://learn.microsoft.com/graph/api/security-auditcoreroot-list-auditlogqueries?view=graph-rest-beta](https://learn.microsoft.com/graph/api/security-auditcoreroot-list-auditlogqueries?view=graph-rest-beta)
