...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/new-mgbetasecuritycaseediscoverycasesearchadditionalsource
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaSecurityCaseEdiscoveryCaseSearchAdditionalSource
---
...
New-MgBetaSecurityCaseEdiscoveryCaseSearchAdditionalSource -EdiscoveryCaseId <string>
 -EdiscoverySearchId <string> [-ResponseHeadersVariable <string>]
...
New-MgBetaSecurityCaseEdiscoveryCaseSearchAdditionalSource -InputObject <ISecurityIdentity>
 ...
 [-HoldStatus <string>] [-Id <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
```
New-MgBetaSecurityCaseEdiscoveryCaseSearchAdditionalSource -InputObject <ISecurityIdentity>
 -BodyParameter <IMicrosoftGraphSecurityDataSource> [-ResponseHeadersVariable <string>] [-Break]
...
- [New-MgBetaSecurityCaseEdiscoveryCaseSearchAdditionalSource](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/new-mgbetasecuritycaseediscoverycasesearchadditionalsource)
- [Graph API Reference](https://learn.microsoft.com/graph/api/security-ediscoverysearch-post-additionalsources?view=graph-rest-beta)
