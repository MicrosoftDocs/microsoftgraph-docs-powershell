...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/remove-mgbetasecuritycasemanagementcaseactivity
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Remove-MgBetaSecurityCaseManagementCaseActivity
---

# Remove-MgBetaSecurityCaseManagementCaseActivity

## SYNOPSIS

Delete a comment activity from a case timeline.
Only comment activities support delete.
...
```
Remove-MgBetaSecurityCaseManagementCaseActivity -ActivityId <string> -CaseId <string>
...
```
Remove-MgBetaSecurityCaseManagementCaseActivity -InputObject <ISecurityIdentity> [-IfMatch <string>]
...
- [Remove-MgBetaSecurityCaseManagementCaseActivity](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/remove-mgbetasecuritycasemanagementcaseactivity)
- [Graph API Reference](https://learn.microsoft.com/graph/api/security-casemanagement-activity-delete?view=graph-rest-beta)
