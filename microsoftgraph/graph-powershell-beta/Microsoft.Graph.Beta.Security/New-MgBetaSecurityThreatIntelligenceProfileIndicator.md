...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/new-mgbetasecuritythreatintelligenceprofileindicator
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaSecurityThreatIntelligenceProfileIndicator
---
...
New-MgBetaSecurityThreatIntelligenceProfileIndicator [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Artifact <hashtable>] [-FirstSeenDateTime <datetime>]
 [-Id <string>] [-LastSeenDateTime <datetime>] [-Source <string>] [-Break] [-Headers <IDictionary>]
...
```
New-MgBetaSecurityThreatIntelligenceProfileIndicator
 -BodyParameter <IMicrosoftGraphSecurityIntelligenceProfileIndicator>
...
- [New-MgBetaSecurityThreatIntelligenceProfileIndicator](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/new-mgbetasecuritythreatintelligenceprofileindicator)
