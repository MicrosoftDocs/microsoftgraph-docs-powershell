...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/get-mgbetasecuritycopilotworkspacesessionpromptevaluationcount
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaSecurityCopilotWorkspaceSessionPromptEvaluationCount
---

# Get-MgBetaSecurityCopilotWorkspaceSessionPromptEvaluationCount
...
```
Get-MgBetaSecurityCopilotWorkspaceSessionPromptEvaluationCount -PromptId <string>
 -SessionId <string> -WorkspaceId <string> [-Filter <string>] [-Search <string>]
...
```
Get-MgBetaSecurityCopilotWorkspaceSessionPromptEvaluationCount -InputObject <ISecurityIdentity>
