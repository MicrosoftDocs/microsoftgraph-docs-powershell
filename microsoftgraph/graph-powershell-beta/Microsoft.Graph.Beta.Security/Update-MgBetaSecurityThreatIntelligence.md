...
```
Update-MgBetaSecurityThreatIntelligence [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>]
 ...
 [-WhoisRecords <IMicrosoftGraphSecurityWhoisRecord[]>] [-Headers <IDictionary>]
