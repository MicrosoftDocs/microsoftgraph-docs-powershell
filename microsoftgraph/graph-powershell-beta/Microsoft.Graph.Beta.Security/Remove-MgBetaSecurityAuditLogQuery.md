...
### Delete (Default)
```
Remove-MgBetaSecurityAuditLogQuery -AuditLogQueryId <String> [-IfMatch <String>] [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaSecurityAuditLogQuery -InputObject <ISecurityIdentity> [-IfMatch <String>] [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
