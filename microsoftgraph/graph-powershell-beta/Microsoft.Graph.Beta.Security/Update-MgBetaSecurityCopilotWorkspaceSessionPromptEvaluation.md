...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/update-mgbetasecuritycopilotworkspacesessionpromptevaluation
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 09/23/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaSecurityCopilotWorkspaceSessionPromptEvaluation
---

# Update-MgBetaSecurityCopilotWorkspaceSessionPromptEvaluation
...
```
Update-MgBetaSecurityCopilotWorkspaceSessionPromptEvaluation -EvaluationId <string>
 -PromptId <string> -SessionId <string> -WorkspaceId <string> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-CompletedDateTime <datetime>] [-CreatedDateTime <datetime>]
 [-ExecutionCount <long>] [-Id <string>] [-IsCancelled] [-LastModifiedDateTime <datetime>]
 [-Result <IMicrosoftGraphSecurityCopilotEvaluationResult>] [-RunStartDateTime <datetime>]
...
```
Update-MgBetaSecurityCopilotWorkspaceSessionPromptEvaluation -EvaluationId <string>
 -PromptId <string> -SessionId <string> -WorkspaceId <string>
 -BodyParameter <IMicrosoftGraphSecurityCopilotEvaluation> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaSecurityCopilotWorkspaceSessionPromptEvaluation -InputObject <ISecurityIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-CompletedDateTime <datetime>] [-CreatedDateTime <datetime>] [-ExecutionCount <long>]
 [-Id <string>] [-IsCancelled] [-LastModifiedDateTime <datetime>]
 [-Result <IMicrosoftGraphSecurityCopilotEvaluationResult>] [-RunStartDateTime <datetime>]
 [-State <string>] [-Break] [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
| --------------- | ------------------------------------------  |
| Delegated (work or school account) | SecurityCopilotWorkspaces.ReadWrite.All,  |
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphSecurityCopilotEvaluation
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphSecurityCopilotEvaluationResult
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphSecurityCopilotEvaluation
...
- [Update-MgBetaSecurityCopilotWorkspaceSessionPromptEvaluation](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/update-mgbetasecuritycopilotworkspacesessionpromptevaluation)
