...
```
Get-MgBetaSecurityIdentityAccount [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaSecurityIdentityAccount -IdentityAccountsId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaSecurityIdentityAccount -InputObject <ISecurityIdentity> [-ExpandProperty <string[]>]
 [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [<CommonParameters>]
```
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphSecurityIdentityAccounts
