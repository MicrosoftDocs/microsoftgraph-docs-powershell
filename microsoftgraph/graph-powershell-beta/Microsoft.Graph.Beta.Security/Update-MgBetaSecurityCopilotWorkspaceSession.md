...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/update-mgbetasecuritycopilotworkspacesession
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaSecurityCopilotWorkspaceSession
---

# Update-MgBetaSecurityCopilotWorkspaceSession
...
```
Update-MgBetaSecurityCopilotWorkspaceSession -SessionId <string> -WorkspaceId <string>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-CreatedDateTime <datetime>] [-DisplayName <string>] [-Id <string>]
 [-LastModifiedDateTime <datetime>] [-Prompts <IMicrosoftGraphSecurityCopilotPrompt[]>] [-Break]
...
```
Update-MgBetaSecurityCopilotWorkspaceSession -SessionId <string> -WorkspaceId <string>
 -BodyParameter <IMicrosoftGraphSecurityCopilotSession> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
```
Update-MgBetaSecurityCopilotWorkspaceSession -InputObject <ISecurityIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-CreatedDateTime <datetime>] [-DisplayName <string>] [-Id <string>]
 [-LastModifiedDateTime <datetime>] [-Prompts <IMicrosoftGraphSecurityCopilotPrompt[]>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
...
Last modified time of the session (UTC).
...
To construct, see NOTES section for PROMPTS properties and create a hash table.

```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphSecurityCopilotPrompt[]
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
BODYPARAMETER `<IMicrosoftGraphSecurityCopilotSession>`: session
...
- [Update-MgBetaSecurityCopilotWorkspaceSession](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/update-mgbetasecuritycopilotworkspacesession)
