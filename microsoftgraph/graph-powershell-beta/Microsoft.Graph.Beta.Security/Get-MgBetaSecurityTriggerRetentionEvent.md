...
### List (Default)
```
Get-MgBetaSecurityTriggerRetentionEvent [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
[https://learn.microsoft.com/graph/api/security-retentionevent-get?view=graph-rest-beta](https://learn.microsoft.com/graph/api/security-retentionevent-get?view=graph-rest-beta)

[https://learn.microsoft.com/graph/api/security-retentionevent-list?view=graph-rest-beta](https://learn.microsoft.com/graph/api/security-retentionevent-list?view=graph-rest-beta)
