...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.security/new-mgbetasecuritycopilotworkspacesession
Locale: en-US
Module Name: Microsoft.Graph.Beta.Security
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaSecurityCopilotWorkspaceSession
---

# New-MgBetaSecurityCopilotWorkspaceSession
...
```
New-MgBetaSecurityCopilotWorkspaceSession -WorkspaceId <string> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-CreatedDateTime <datetime>] [-DisplayName <string>]
 [-Id <string>] [-LastModifiedDateTime <datetime>]
 [-Prompts <IMicrosoftGraphSecurityCopilotPrompt[]>] [-Break] [-Headers <IDictionary>]
...
```
New-MgBetaSecurityCopilotWorkspaceSession -WorkspaceId <string>
...
```
New-MgBetaSecurityCopilotWorkspaceSession -InputObject <ISecurityIdentity>
