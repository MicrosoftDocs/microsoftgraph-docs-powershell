...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.functions/get-mgbetadevicemanagementcomanageddevicefilevaultkey
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaDeviceManagementComanagedDeviceFileVaultKey -ManagedDeviceId <String> [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDeviceManagementComanagedDeviceFileVaultKey -InputObject <IDeviceManagementFunctionsIdentity>
