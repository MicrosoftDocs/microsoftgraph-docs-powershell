...
### List (Default)
```
Get-MgBetaEducationSynchronizationProfile [-ExpandProperty <String[]>] [-Property <String[]>]
...
### Get
```
Get-MgBetaEducationSynchronizationProfile -EducationSynchronizationProfileId <String>
