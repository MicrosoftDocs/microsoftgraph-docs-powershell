...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.education/new-mgbetaeducationreportreadingassignmentsubmission
schema: 2.0.0
---
...
```
New-MgBetaEducationReportReadingAssignmentSubmission [-ResponseHeadersVariable <String>]
 [-AccuracyScore <Double>] [-Action <String>] [-AdditionalProperties <Hashtable>] [-AssignmentId <String>]
