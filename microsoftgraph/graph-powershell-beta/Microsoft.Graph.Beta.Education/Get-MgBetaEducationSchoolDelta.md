...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.education/get-mgbetaeducationschooldelta
Locale: en-US
Module Name: Microsoft.Graph.Beta.Education
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaEducationSchoolDelta
---
...
```
Get-MgBetaEducationSchoolDelta [-ExpandProperty <string[]>] [-Filter <string>]
...
- [Get-MgBetaEducationSchoolDelta](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.education/get-mgbetaeducationschooldelta)
- [Graph API Reference](https://learn.microsoft.com/graph/api/educationschool-delta?view=graph-rest-beta)
