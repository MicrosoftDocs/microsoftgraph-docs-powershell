...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgEducationSchoolDelta](/powershell/module/Microsoft.Graph.Education/Get-MgEducationSchoolDelta?view=graph-powershell-v1.0)

## SYNTAX

```
Get-MgBetaEducationSchoolDelta [-Filter <String>] [-Property <String[]>] [-Search <String>] [-Skip <Int32>]
