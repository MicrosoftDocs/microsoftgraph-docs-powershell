...
### Delete (Default)
```
Remove-MgBetaEducationClassMemberByRef -EducationClassId <String> -EducationUserId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaEducationClassMemberByRef -InputObject <IEducationIdentity> [-IfMatch <String>]
