...
### Delete (Default)
```
Remove-MgBetaEducationClassMemberByRef -EducationClassId <String> -EducationUserId <String> [-IfMatch <String>]
...
### Delete1
```
Remove-MgBetaEducationClassMemberByRef -EducationClassId <String> -Id <String> [-IfMatch <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
