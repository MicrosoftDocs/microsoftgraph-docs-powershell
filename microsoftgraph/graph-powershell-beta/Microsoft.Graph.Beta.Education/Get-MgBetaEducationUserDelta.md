...
```
Get-MgBetaEducationUserDelta [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>]
...
## RELATED LINKS
[Get-MgEducationUserDelta](/powershell/module/Microsoft.Graph.Education/Get-MgEducationUserDelta?view=graph-powershell-1.0)
