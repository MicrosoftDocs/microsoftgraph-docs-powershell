...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.education/update-mgbetaeducationclassassignmentrubric
Locale: en-US
Module Name: Microsoft.Graph.Beta.Education
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaEducationClassAssignmentRubric
---
...
```
Update-MgBetaEducationClassAssignmentRubric -EducationAssignmentId <string>
 -EducationClassId <string> [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
...
```
Update-MgBetaEducationClassAssignmentRubric -EducationAssignmentId <string>
 -EducationClassId <string> -BodyParameter <IMicrosoftGraphEducationRubric>
...
- [Update-MgBetaEducationClassAssignmentRubric](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.education/update-mgbetaeducationclassassignmentrubric)
- [Graph API Reference](https://learn.microsoft.com/graph/api/educationassignment-put-rubric?view=graph-rest-beta)
