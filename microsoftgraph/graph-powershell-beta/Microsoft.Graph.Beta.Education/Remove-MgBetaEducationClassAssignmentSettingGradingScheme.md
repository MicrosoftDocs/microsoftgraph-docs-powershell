...
Remove-MgBetaEducationClassAssignmentSettingGradingScheme -EducationClassId <String>
 -EducationGradingSchemeId <String> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
...
### DeleteViaIdentity
```
Remove-MgBetaEducationClassAssignmentSettingGradingScheme -InputObject <IEducationIdentity> [-IfMatch <String>]
