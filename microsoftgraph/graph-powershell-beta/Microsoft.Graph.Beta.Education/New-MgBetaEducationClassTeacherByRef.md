...
```
New-MgBetaEducationClassTeacherByRef -EducationClassId <String> [-ResponseHeadersVariable <String>]
...
```
New-MgBetaEducationClassTeacherByRef -InputObject <IEducationIdentity> [-ResponseHeadersVariable <String>]
 -OdataId <String> [-AdditionalProperties <Hashtable>] [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
