...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.education/get-mgbetaeducationmeschool
Locale: en-US
Module Name: Microsoft.Graph.Beta.Education
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaEducationMeSchool
---
...
```
Get-MgBetaEducationMeSchool -EducationSchoolId <string> [-ExpandProperty <string[]>]
...
- [Get-MgBetaEducationMeSchool](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.education/get-mgbetaeducationmeschool)
- [Graph API Reference](https://learn.microsoft.com/graph/api/educationuser-list-schools?view=graph-rest-beta)
