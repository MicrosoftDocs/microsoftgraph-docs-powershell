...
```
Update-MgBetaEducationClassAssignmentSubmissionSubmittedResourceDependentResource
 -InputObject <IEducationIdentity> [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.education/update-mgbetaeducationclassassignmentsubmissionsubmittedresourcedependentresource](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.education/update-mgbetaeducationclassassignmentsubmissionsubmittedresourcedependentresource)
