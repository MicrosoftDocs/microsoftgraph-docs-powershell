...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.education/invoke-mgbetaexcuseeducationclassassignmentsubmission
schema: 2.0.0
---
...
### ExcuseViaIdentity
```
Invoke-MgBetaExcuseEducationClassAssignmentSubmission -InputObject <IEducationIdentity> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
