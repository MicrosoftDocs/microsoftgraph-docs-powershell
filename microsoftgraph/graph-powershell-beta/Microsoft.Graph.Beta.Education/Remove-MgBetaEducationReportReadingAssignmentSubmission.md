...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.education/remove-mgbetaeducationreportreadingassignmentsubmission
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgBetaEducationReportReadingAssignmentSubmission -InputObject <IEducationIdentity> [-IfMatch <String>]
