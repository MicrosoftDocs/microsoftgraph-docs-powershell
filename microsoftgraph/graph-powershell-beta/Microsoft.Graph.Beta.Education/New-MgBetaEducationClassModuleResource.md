...
```
New-MgBetaEducationClassModuleResource -InputObject <IEducationIdentity> [-ResponseHeadersVariable <String>]
...
[https://learn.microsoft.com/graph/api/educationmodule-post-resources?view=graph-rest-beta](https://learn.microsoft.com/graph/api/educationmodule-post-resources?view=graph-rest-beta)
