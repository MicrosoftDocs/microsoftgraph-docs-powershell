...
```
New-MgBetaEducationReportReadingCoachPassage [-ResponseHeadersVariable <string>]
...
```
New-MgBetaEducationReportReadingCoachPassage -BodyParameter <IMicrosoftGraphReadingCoachPassage>
