...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.education/publish-mgbetaeducationmeassignment
Locale: en-US
Module Name: Microsoft.Graph.Beta.Education
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Publish-MgBetaEducationMeAssignment
---
...
```
Publish-MgBetaEducationMeAssignment -EducationAssignmentId <string>
...
```
Publish-MgBetaEducationMeAssignment -InputObject <IEducationIdentity>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
- [Publish-MgBetaEducationMeAssignment](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.education/publish-mgbetaeducationmeassignment)
