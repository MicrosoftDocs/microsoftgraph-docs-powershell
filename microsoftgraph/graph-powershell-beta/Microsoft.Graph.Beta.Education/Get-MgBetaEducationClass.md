...
### List (Default)
```
Get-MgBetaEducationClass [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaEducationClass -EducationClassId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgBetaEducationClass -InputObject <IEducationIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
**Permissions**
[!INCLUDE [permissions-table](~/../graphref/api-reference/beta/includes/permissions/educationroot-list-classes-permissions.md)]
...
[https://learn.microsoft.com/graph/api/educationclass-get?view=graph-rest-beta](https://learn.microsoft.com/graph/api/educationclass-get?view=graph-rest-beta)

[https://learn.microsoft.com/graph/api/educationroot-list-classes?view=graph-rest-beta](https://learn.microsoft.com/graph/api/educationroot-list-classes?view=graph-rest-beta)
