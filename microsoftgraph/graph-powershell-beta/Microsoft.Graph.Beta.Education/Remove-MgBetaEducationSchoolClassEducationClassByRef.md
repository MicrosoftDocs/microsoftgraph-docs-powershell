...
### Delete (Default)
```
Remove-MgBetaEducationSchoolClassEducationClassByRef -EducationClassId <String> -EducationSchoolId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaEducationSchoolClassEducationClassByRef -InputObject <IEducationIdentity> [-IfMatch <String>]
