...
### List (Default)
```
Get-MgBetaIdentityGovernanceLifecycleWorkflowTemplate [-ExpandProperty <String[]>] [-Property <String[]>]
...
### Get
```
Get-MgBetaIdentityGovernanceLifecycleWorkflowTemplate -WorkflowTemplateId <String> [-ExpandProperty <String[]>]
