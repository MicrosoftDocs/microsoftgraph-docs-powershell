...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.governance/update-mgidentitygovernancelifecycleworkflowcustomtaskextensioncreatedbymailboxsetting
schema: 2.0.0
---
...
```
Update-MgIdentityGovernanceLifecycleWorkflowCustomTaskExtensionCreatedByMailboxSetting
 -CustomTaskExtensionId <String> -BodyParameter <IMicrosoftGraphMailboxSettings1> [-PassThru] [-WhatIf]
