...
### Delete (Default)
```
Remove-MgBetaRoleManagementEntitlementManagementResourceNamespace -UnifiedRbacResourceNamespaceId <String>
 [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaRoleManagementEntitlementManagementResourceNamespace -InputObject <IIdentityGovernanceIdentity>
 [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
