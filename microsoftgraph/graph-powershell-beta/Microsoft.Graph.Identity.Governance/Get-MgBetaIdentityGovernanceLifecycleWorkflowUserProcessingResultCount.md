...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/get-mgbetaidentitygovernancelifecycleworkflowuserprocessingresultcount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaIdentityGovernanceLifecycleWorkflowUserProcessingResultCount -WorkflowId <String> [-Filter <String>]
