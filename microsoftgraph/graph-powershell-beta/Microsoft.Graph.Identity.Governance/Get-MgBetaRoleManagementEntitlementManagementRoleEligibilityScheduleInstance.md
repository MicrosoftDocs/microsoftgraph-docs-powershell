...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/get-mgbetarolemanagemententitlementmanagementroleeligibilityscheduleinstance
schema: 2.0.0
ms.prod: governance
---
...
### List (Default)
```
Get-MgBetaRoleManagementEntitlementManagementRoleEligibilityScheduleInstance [-ExpandProperty <String[]>]
