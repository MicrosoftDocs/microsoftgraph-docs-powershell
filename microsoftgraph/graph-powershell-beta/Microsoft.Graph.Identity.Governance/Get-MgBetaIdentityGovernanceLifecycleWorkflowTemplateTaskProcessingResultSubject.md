...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/get-mgbetaidentitygovernancelifecycleworkflowtemplatetaskprocessingresultsubject
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaIdentityGovernanceLifecycleWorkflowTemplateTaskProcessingResultSubject -TaskId <String>
 -TaskProcessingResultId <String> -WorkflowTemplateId <String> [-ExpandProperty <String[]>]
