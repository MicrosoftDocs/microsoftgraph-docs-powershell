...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.governance/remove-mgidentitygovernanceprivilegedaccessgroupeligibilityschedulerequest
schema: 2.0.0
---
...
```
Remove-MgIdentityGovernancePrivilegedAccessGroupEligibilityScheduleRequest
 -PrivilegedAccessGroupEligibilityScheduleRequestId <String> [-IfMatch <String>] [-PassThru] [-WhatIf]
