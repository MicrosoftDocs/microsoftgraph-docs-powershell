...
### Delete (Default)
```
Remove-MgProgramControl -ProgramControlId <String> [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### DeleteViaIdentity2
```
Remove-MgProgramControl -InputObject <IIdentityGovernanceIdentity> [-IfMatch <String>] [-PassThru] [-WhatIf]
