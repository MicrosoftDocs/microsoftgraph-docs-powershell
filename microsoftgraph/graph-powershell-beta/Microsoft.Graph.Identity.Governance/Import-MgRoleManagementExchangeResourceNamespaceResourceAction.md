...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/import-mgbetarolemanagementexchangeresourcenamespaceresourceaction
schema: 2.0.0
---
...
```
Import-MgBetaRoleManagementExchangeResourceNamespaceResourceAction -UnifiedRbacResourceNamespaceId <String>
...
```
Import-MgBetaRoleManagementExchangeResourceNamespaceResourceAction -InputObject <IIdentityGovernanceIdentity>
 [-AdditionalProperties <Hashtable>] [-Format <String>] [-OverwriteResourceNamespace] [-Value <String>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths15BodmaRolemanagementExchangeResourcenamespacesUnifiedrbacresourcenamespaceIdMicrosoftGraphImportresourceactionsPostRequestbodyContentApplicationJsonSchema
## OUTPUTS
