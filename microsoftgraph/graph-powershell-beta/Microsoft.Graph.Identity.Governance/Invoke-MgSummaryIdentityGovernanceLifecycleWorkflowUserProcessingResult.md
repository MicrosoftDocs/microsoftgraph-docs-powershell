...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.governance/invoke-mgsummaryidentitygovernancelifecycleworkflowuserprocessingresult
schema: 2.0.0
---
...
### Summary (Default)
```
Invoke-MgSummaryIdentityGovernanceLifecycleWorkflowUserProcessingResult -EndDateTime <DateTime>
...
### Microsoft.Graph.PowerShell.Models.IMicrosoftGraphIdentityGovernanceUserSummary
## NOTES
