...
### Restore (Default)
```
Restore-MgIdentityGovernanceLifecycleWorkflow -WorkflowId <String> [-WhatIf] [-Confirm] [<CommonParameters>]
```

### RestoreViaIdentity
```
Restore-MgIdentityGovernanceLifecycleWorkflow -InputObject <IIdentityGovernanceIdentity> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
