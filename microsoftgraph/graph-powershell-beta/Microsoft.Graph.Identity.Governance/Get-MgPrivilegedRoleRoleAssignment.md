...
### List (Default)
```
Get-MgPrivilegedRoleRoleAssignment [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
### List1
```
Get-MgPrivilegedRoleRoleAssignment -PrivilegedRoleId <String> [-ExpandProperty <String[]>]
