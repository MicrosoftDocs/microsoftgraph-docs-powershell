...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/update-mgbetaidentitygovernancelifecycleworkflowcustomtaskextensionlastmodifiedbymailboxsetting
schema: 2.0.0
---
...
```
Update-MgBetaIdentityGovernanceLifecycleWorkflowCustomTaskExtensionLastModifiedByMailboxSetting
 -CustomTaskExtensionId <String> [-AdditionalProperties <Hashtable>] [-ArchiveFolder <String>]
...
```
Update-MgBetaIdentityGovernanceLifecycleWorkflowCustomTaskExtensionLastModifiedByMailboxSetting
 -CustomTaskExtensionId <String> -BodyParameter <IMicrosoftGraphMailboxSettings> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
