...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.governance/get-mgidentitygovernancelifecycleworkflowexecutionscope
schema: 2.0.0
---
...
### Get
```
Get-MgIdentityGovernanceLifecycleWorkflowExecutionScope -UserId <String> -WorkflowId <String>
