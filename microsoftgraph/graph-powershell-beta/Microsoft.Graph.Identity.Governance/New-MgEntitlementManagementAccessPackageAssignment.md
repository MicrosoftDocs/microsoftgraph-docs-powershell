...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphAccessPackageAnswer[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.MicrosoftGraphAccessPackageAssignment[]
Parameter Sets: (All)
Aliases:
...
`EXISTINGASSIGNMENT <MicrosoftGraphAccessPackageAssignment[]>`: To construct, see NOTES section for EXISTINGASSIGNMENT properties and create a hash table.
    ...
    - `[AccessPackageAssignmentPolicies <IMicrosoftGraphAccessPackageAssignmentPolicy[]>]`: Read-only. Nullable. Supports $expand.
      ...
      - `[RequestApprovalSettings <IMicrosoftGraphApprovalSettings>]`: approvalSettings
        ...
        - `[ApprovalStages <IMicrosoftGraphApprovalStage[]>]`: If approval is required, the one or two elements of this collection define each of the stages of approval. An empty array if no approval is required.
          ...
          - `[PrimaryApprovers <IMicrosoftGraphUserSet[]>]`: The users who will be asked to approve requests. A collection of singleUser, groupMembers, requestorManager, internalSponsors and externalSponsors. When creating or updating a policy, include at least one userSet in this collection.
  ...
  - `[AccessPackageAssignmentRequests <IMicrosoftGraphAccessPackageAssignmentRequest[]>]`: 
    ...
    - `[CustomExtensionHandlerInstances <IMicrosoftGraphCustomExtensionHandlerInstance[]>]`: A collection of custom workflow extension instances being run on an assignment request. Read-only.
      ...
      - `[Stage <String>]`: accessPackageCustomExtensionStage
      - `[Status <String>]`: accessPackageCustomExtensionHandlerStatus
    - `[ExpirationDateTime <DateTime?>]`: 
    ...
    - `[Schedule <IMicrosoftGraphRequestSchedule>]`: requestSchedule
    - `[VerifiedCredentialsData <IMicrosoftGraphVerifiedCredentialData[]>]`: The details of the verifiable credential that was presented by the requestor, such as the issuer and claims. Read-only.
