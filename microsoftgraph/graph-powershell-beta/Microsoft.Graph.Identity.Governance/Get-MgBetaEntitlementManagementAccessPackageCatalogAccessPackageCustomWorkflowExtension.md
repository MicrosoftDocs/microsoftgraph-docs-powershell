...
```
Get-MgBetaEntitlementManagementAccessPackageCatalogAccessPackageCustomWorkflowExtension
 -AccessPackageCatalogId <String> [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
```
Get-MgBetaEntitlementManagementAccessPackageCatalogAccessPackageCustomWorkflowExtension
 -AccessPackageCatalogId <String> -CustomCalloutExtensionId <String> [-ExpandProperty <String[]>]
