...
```
Update-MgBetaRoleManagementEntitlementManagement [-AdditionalProperties <Hashtable>] [-Id <String>]
...
### Update
```
Update-MgBetaRoleManagementEntitlementManagement -BodyParameter <IMicrosoftGraphRbacApplication> [-WhatIf]
