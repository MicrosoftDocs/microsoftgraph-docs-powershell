...
Read-only.
          ...
          \[ClientConfiguration \<IMicrosoftGraphCustomExtensionClientConfiguration\>\]: customExtensionClientConfiguration
            \[(Any) \<Object\>\]: This indicates any property can be added to this object.
            \[TimeoutInMilliseconds \<Int32?\>\]: The max duration in milliseconds that Azure AD will wait for a response from the logic app before it shuts down the connection.
...
A collection of singleUser, groupMembers, requestorManager, internalSponsors and externalSponsors.
