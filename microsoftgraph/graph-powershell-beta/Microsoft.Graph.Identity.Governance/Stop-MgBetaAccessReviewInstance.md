...
### Stop (Default)
```
Stop-MgBetaAccessReviewInstance -AccessReviewId <String> -AccessReviewId1 <String> [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### StopViaIdentity
```
Stop-MgBetaAccessReviewInstance -InputObject <IIdentityGovernanceIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
