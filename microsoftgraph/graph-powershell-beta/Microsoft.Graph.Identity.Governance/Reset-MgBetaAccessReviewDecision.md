...
### Reset (Default)
```
Reset-MgBetaAccessReviewDecision -AccessReviewId <String> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### ResetViaIdentity
```
Reset-MgBetaAccessReviewDecision -InputObject <IIdentityGovernanceIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
