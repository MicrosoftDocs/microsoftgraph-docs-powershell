...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.governance/get-mgbetaprivilegedaccessrolesettingroledefinition
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaPrivilegedAccessRoleSettingRoleDefinition -GovernanceRoleSettingId <String>
 -PrivilegedAccessId <String> [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaPrivilegedAccessRoleSettingRoleDefinition -InputObject <IIdentityGovernanceIdentity>
