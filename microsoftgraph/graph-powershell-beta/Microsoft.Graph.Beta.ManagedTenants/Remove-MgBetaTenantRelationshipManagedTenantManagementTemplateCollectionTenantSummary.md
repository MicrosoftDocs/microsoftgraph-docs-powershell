...
```
Remove-MgBetaTenantRelationshipManagedTenantManagementTemplateCollectionTenantSummary
 -ManagementTemplateCollectionTenantSummaryId <String> [-IfMatch <String>] [-Headers <IDictionary>] [-PassThru]
...
```
Remove-MgBetaTenantRelationshipManagedTenantManagementTemplateCollectionTenantSummary
 -InputObject <IManagedTenantsIdentity> [-IfMatch <String>] [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
