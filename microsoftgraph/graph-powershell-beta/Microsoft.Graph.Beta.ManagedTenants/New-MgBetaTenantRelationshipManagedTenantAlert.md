...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgTenantRelationshipManagedTenantAlert](/powershell/module/Microsoft.Graph.ManagedTenants/New-MgTenantRelationshipManagedTenantAlert?view=graph-powershell-v1.0)
...
New-MgBetaTenantRelationshipManagedTenantAlert [-AdditionalProperties <Hashtable>]
 ...
 [-Status <String>] [-TenantId <String>] [-Title <String>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
