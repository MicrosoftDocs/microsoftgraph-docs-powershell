...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgTenantRelationshipManagedTenantMyRole](/powershell/module/Microsoft.Graph.ManagedTenants/Update-MgTenantRelationshipManagedTenantMyRole?view=graph-powershell-v1.0)
...
Update-MgBetaTenantRelationshipManagedTenantMyRole -MyRoleTenantId <String>
 -BodyParameter <IMicrosoftGraphManagedTenantsMyRole> [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgTenantRelationshipManagedTenantMyRole](/powershell/module/Microsoft.Graph.ManagedTenants/Update-MgTenantRelationshipManagedTenantMyRole?view=graph-powershell-v1.0)
