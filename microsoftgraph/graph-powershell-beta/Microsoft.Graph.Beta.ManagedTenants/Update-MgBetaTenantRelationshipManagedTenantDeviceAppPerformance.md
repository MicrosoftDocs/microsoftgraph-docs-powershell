...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgTenantRelationshipManagedTenantDeviceAppPerformance](/powershell/module/Microsoft.Graph.ManagedTenants/Update-MgTenantRelationshipManagedTenantDeviceAppPerformance?view=graph-powershell-v1.0)
...
Update-MgBetaTenantRelationshipManagedTenantDeviceAppPerformance -DeviceAppPerformanceId <String>
 ...
 [-TenantId <String>] [-TotalAppCrashCount <Int32>] [-TotalAppFreezeCount <Int32>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgTenantRelationshipManagedTenantDeviceAppPerformance](/powershell/module/Microsoft.Graph.ManagedTenants/Update-MgTenantRelationshipManagedTenantDeviceAppPerformance?view=graph-powershell-v1.0)
