...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgTenantRelationshipManagedTenantCloudPcConnection](/powershell/module/Microsoft.Graph.ManagedTenants/Update-MgTenantRelationshipManagedTenantCloudPcConnection?view=graph-powershell-v1.0)
...
Update-MgBetaTenantRelationshipManagedTenantCloudPcConnection -CloudPcConnectionId <String>
 ...
 [-LastRefreshedDateTime <DateTime>] [-TenantDisplayName <String>] [-TenantId <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgTenantRelationshipManagedTenantCloudPcConnection](/powershell/module/Microsoft.Graph.ManagedTenants/Update-MgTenantRelationshipManagedTenantCloudPcConnection?view=graph-powershell-v1.0)
