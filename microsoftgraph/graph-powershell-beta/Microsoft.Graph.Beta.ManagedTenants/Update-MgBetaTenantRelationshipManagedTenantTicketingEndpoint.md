...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.managedtenants/update-mgbetatenantrelationshipmanagedtenantticketingendpoint
Locale: en-US
Module Name: Microsoft.Graph.Beta.ManagedTenants
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaTenantRelationshipManagedTenantTicketingEndpoint
---
...
```
Update-MgBetaTenantRelationshipManagedTenantTicketingEndpoint
 -ManagedTenantTicketingEndpointId <string> [-ResponseHeadersVariable <string>]
 ...
 [-LastActionDateTime <datetime>] [-PhoneNumber <string>] [-Break] [-Headers <IDictionary>]
...
```
Update-MgBetaTenantRelationshipManagedTenantTicketingEndpoint
 -ManagedTenantTicketingEndpointId <string>
...
Update-MgBetaTenantRelationshipManagedTenantTicketingEndpoint -InputObject <IManagedTenantsIdentity>
 ...
 [-LastActionByUserId <string>] [-LastActionDateTime <datetime>] [-PhoneNumber <string>] [-Break]
...
- [Update-MgBetaTenantRelationshipManagedTenantTicketingEndpoint](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.managedtenants/update-mgbetatenantrelationshipmanagedtenantticketingendpoint)
