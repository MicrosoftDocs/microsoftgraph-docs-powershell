...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.networkaccess/get-mgbetanetworkaccessforwardingpolicyrule
Locale: en-US
Module Name: Microsoft.Graph.Beta.NetworkAccess
ms.date: 09/19/2025
PlatyPS schema version: 2024-05-01
title: Get-MgBetaNetworkAccessForwardingPolicyRule
---
...
```
Get-MgBetaNetworkAccessForwardingPolicyRule -ForwardingPolicyId <string>
...
```
Get-MgBetaNetworkAccessForwardingPolicyRule -InputObject <INetworkAccessIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [<CommonParameters>]
