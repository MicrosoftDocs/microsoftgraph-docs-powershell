...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.networkaccess/new-mgbetanetworkaccesslogremotenetwork
Locale: en-US
Module Name: Microsoft.Graph.Beta.NetworkAccess
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: New-MgBetaNetworkAccessLogRemoteNetwork
---
...
```
New-MgBetaNetworkAccessLogRemoteNetwork [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-BgpRoutesAdvertisedCount <int>] [-CreatedDateTime <datetime>]
 [-Description <string>] [-DestinationIP <string>] [-Id <string>] [-ReceivedBytes <long>]
 [-RemoteNetworkId <string>] [-SentBytes <long>] [-SourceIP <string>] [-Status <string>] [-Break]
