...
# New-MgBetaNetworkAccessLogGenerativeAiInsight
...
```
New-MgBetaNetworkAccessLogGenerativeAiInsight [-ResponseHeadersVariable <string>]
 [-Activity <string>] [-AdditionalProperties <hashtable>] [-Content <string>]
 [-CreatedDateTime <datetime>] [-DestinationUrl <string>] [-EventId <string>] [-EventType <string>]
 [-McpClientName <string>] [-McpServerName <string>] [-SessionId <string>] [-Subactivity <string>]
 [-TransactionId <string>] [-UserPrincipalName <string>] [-Break] [-Headers <IDictionary>]
