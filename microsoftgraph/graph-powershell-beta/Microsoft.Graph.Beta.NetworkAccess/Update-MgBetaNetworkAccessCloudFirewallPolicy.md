...
# Update-MgBetaNetworkAccessCloudFirewallPolicy
...
```
Update-MgBetaNetworkAccessCloudFirewallPolicy -CloudFirewallPolicyId <string>
 ...
 [-Settings <IMicrosoftGraphNetworkaccessCloudFirewallPolicySettings>] [-Version <string>] [-Break]
...
```
Update-MgBetaNetworkAccessCloudFirewallPolicy -CloudFirewallPolicyId <string>
 -BodyParameter <IMicrosoftGraphNetworkaccessCloudFirewallPolicy>
...
```
Update-MgBetaNetworkAccessCloudFirewallPolicy -InputObject <INetworkAccessIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-Description <string>]
 [-Id <string>] [-LastModifiedDateTime <datetime>] [-Name <string>]
 [-PolicyRules <IMicrosoftGraphNetworkaccessPolicyRule[]>]
 [-Settings <IMicrosoftGraphNetworkaccessCloudFirewallPolicySettings>] [-Version <string>] [-Break]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphNetworkaccessCloudFirewallPolicy
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphNetworkaccessCloudFirewallPolicySettings
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphNetworkaccessCloudFirewallPolicy
