...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.networkaccess/get-mgbetanetworkaccessconnectivitywebcategorybyurl
Locale: en-US
Module Name: Microsoft.Graph.Beta.NetworkAccess
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaNetworkAccessConnectivityWebCategoryByUrl
---

# Get-MgBetaNetworkAccessConnectivityWebCategoryByUrl
...
```
Get-MgBetaNetworkAccessConnectivityWebCategoryByUrl -Url <string>
...
```
Get-MgBetaNetworkAccessConnectivityWebCategoryByUrl -InputObject <INetworkAccessIdentity>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
```
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphNetworkaccessWebCategory
