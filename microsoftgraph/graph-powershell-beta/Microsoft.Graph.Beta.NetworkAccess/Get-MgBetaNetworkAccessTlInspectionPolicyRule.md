...
```
Get-MgBetaNetworkAccessTlInspectionPolicyRule -TlsInspectionPolicyId <string>
...
```
Get-MgBetaNetworkAccessTlInspectionPolicyRule -PolicyRuleId <string> -TlsInspectionPolicyId <string>
...
```
Get-MgBetaNetworkAccessTlInspectionPolicyRule -InputObject <INetworkAccessIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [<CommonParameters>]
