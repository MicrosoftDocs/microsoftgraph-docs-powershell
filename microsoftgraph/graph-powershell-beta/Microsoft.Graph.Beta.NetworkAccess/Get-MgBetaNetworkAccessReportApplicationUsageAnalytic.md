...
```
Get-MgBetaNetworkAccessReportApplicationUsageAnalytic -AggregatedBy <string> -EndDateTime <datetime>
...
```
Get-MgBetaNetworkAccessReportApplicationUsageAnalytic -InputObject <INetworkAccessIdentity> [-Count]
...
```
This example shows how to use the Get-MgBetaNetworkAccessReportApplicationUsageAnalytic Cmdlet.
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphNetworkaccessApplicationAnalyticsUsagePoint
