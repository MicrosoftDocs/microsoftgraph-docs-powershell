...
```
Get-MgBetaNetworkAccessTlExternalCertificateAuthorityCertificate [-ExpandProperty <string[]>]
...
```
Get-MgBetaNetworkAccessTlExternalCertificateAuthorityCertificate
 -ExternalCertificateAuthorityCertificateId <string> [-ExpandProperty <string[]>]
