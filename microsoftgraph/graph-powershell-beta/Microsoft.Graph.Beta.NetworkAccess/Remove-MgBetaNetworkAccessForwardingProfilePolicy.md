...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.networkaccess/remove-mgbetanetworkaccessforwardingprofilepolicy
Locale: en-US
Module Name: Microsoft.Graph.Beta.NetworkAccess
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: Remove-MgBetaNetworkAccessForwardingProfilePolicy
---
...
```
Remove-MgBetaNetworkAccessForwardingProfilePolicy -ForwardingProfileId <string>
 -PolicyLinkId <string> [-IfMatch <string>] [-ResponseHeadersVariable <string>] [-Break]
...
```
Remove-MgBetaNetworkAccessForwardingProfilePolicy -InputObject <INetworkAccessIdentity>
...
- [Remove-MgBetaNetworkAccessForwardingProfilePolicy](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.networkaccess/remove-mgbetanetworkaccessforwardingprofilepolicy)
