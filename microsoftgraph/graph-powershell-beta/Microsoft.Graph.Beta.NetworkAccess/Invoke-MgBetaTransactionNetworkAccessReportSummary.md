...
### Transaction (Default)
```
Invoke-MgBetaTransactionNetworkAccessReportSummary -EndDateTime <DateTime> -StartDateTime <DateTime> [-Count]
...
Parameter Sets: TransactionViaIdentity
Aliases:
