...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.networkaccess/new-mgbetanetworkaccessconnectivitybranchconnectivityconfigurationlink
schema: 2.0.0
---
...
```
New-MgBetaNetworkAccessConnectivityBranchConnectivityConfigurationLink -InputObject <INetworkAccessIdentity>
 [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>] [-DisplayName <String>] [-Id <String>]
 [-LocalConfigurations <IMicrosoftGraphNetworkaccessLocalConnectivityConfiguration[]>]
 [-PeerConfiguration <IMicrosoftGraphNetworkaccessPeerConnectivityConfiguration>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
