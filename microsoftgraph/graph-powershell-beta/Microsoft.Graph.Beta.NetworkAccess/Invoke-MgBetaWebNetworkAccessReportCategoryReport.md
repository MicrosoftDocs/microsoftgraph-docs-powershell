...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.networkaccess/invoke-mgbetawebnetworkaccessreportcategoryreport
schema: 2.0.0
---
...
### Web (Default)
```
Invoke-MgBetaWebNetworkAccessReportCategoryReport -EndDateTime <DateTime> -StartDateTime <DateTime> [-Count]
