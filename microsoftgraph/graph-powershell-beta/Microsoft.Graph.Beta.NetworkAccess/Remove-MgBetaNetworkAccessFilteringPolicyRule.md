...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.networkaccess/remove-mgbetanetworkaccessfilteringpolicyrule
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgBetaNetworkAccessFilteringPolicyRule -InputObject <INetworkAccessIdentity> [-IfMatch <String>]
