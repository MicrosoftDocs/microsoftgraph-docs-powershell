...
```
Update-MgBetaNetworkAccessConnectivityRemoteNetworkDeviceLink -DeviceLinkId <string>
...
```
Update-MgBetaNetworkAccessConnectivityRemoteNetworkDeviceLink -DeviceLinkId <string>
 -RemoteNetworkId <string> -BodyParameter <IMicrosoftGraphNetworkaccessDeviceLink>
