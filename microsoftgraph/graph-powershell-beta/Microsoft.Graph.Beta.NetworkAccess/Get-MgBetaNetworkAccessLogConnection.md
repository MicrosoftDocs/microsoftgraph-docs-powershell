...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.networkaccess/get-mgbetanetworkaccesslogconnection
Locale: en-US
Module Name: Microsoft.Graph.Beta.NetworkAccess
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaNetworkAccessLogConnection
---
...
```
Get-MgBetaNetworkAccessLogConnection [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaNetworkAccessLogConnection -ConnectionId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaNetworkAccessLogConnection -InputObject <INetworkAccessIdentity>
...
```
This example shows how to use the Get-MgBetaNetworkAccessLogConnection Cmdlet.
...
- [Get-MgBetaNetworkAccessLogConnection](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.networkaccess/get-mgbetanetworkaccesslogconnection)
- [Graph API Reference](https://learn.microsoft.com/graph/api/networkaccess-connection-get?view=graph-rest-beta)
- [Graph API Reference](https://learn.microsoft.com/graph/api/networkaccess-logs-list-connections?view=graph-rest-beta)
