...
```
Update-MgBetaNetworkAccessConnectivity [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Branches <IMicrosoftGraphNetworkaccessBranchSite[]>]
 [-Id <string>] [-RemoteNetworks <IMicrosoftGraphNetworkaccessRemoteNetwork[]>]
 [-WebCategories <IMicrosoftGraphNetworkaccessWebCategory[]>] [-Break] [-Headers <IDictionary>]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphNetworkaccessConnectivity
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphNetworkaccessWebCategory[]
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
