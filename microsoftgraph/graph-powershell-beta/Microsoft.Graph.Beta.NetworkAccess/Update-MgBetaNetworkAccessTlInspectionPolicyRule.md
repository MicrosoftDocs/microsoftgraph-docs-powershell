...
```
Update-MgBetaNetworkAccessTlInspectionPolicyRule -PolicyRuleId <string>
 -TlsInspectionPolicyId <string> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaNetworkAccessTlInspectionPolicyRule -PolicyRuleId <string>
 -TlsInspectionPolicyId <string> -BodyParameter <IMicrosoftGraphNetworkaccessPolicyRule>
...
```
Update-MgBetaNetworkAccessTlInspectionPolicyRule -InputObject <INetworkAccessIdentity>
