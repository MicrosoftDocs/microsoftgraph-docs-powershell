...
```
Get-MgBetaNetworkAccessReportConnectionSummary -EndDateTime <datetime> -StartDateTime <datetime>
...
```
Get-MgBetaNetworkAccessReportConnectionSummary -InputObject <INetworkAccessIdentity> [-Count]
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphNetworkaccessConnectionSummary
