...
```
Remove-MgBetaNetworkAccessTlInspectionPolicy -TlsInspectionPolicyId <string> [-IfMatch <string>]
...
```
Remove-MgBetaNetworkAccessTlInspectionPolicy -InputObject <INetworkAccessIdentity>
...
```
This example shows how to use the Remove-MgBetaNetworkAccessTlInspectionPolicy Cmdlet.
