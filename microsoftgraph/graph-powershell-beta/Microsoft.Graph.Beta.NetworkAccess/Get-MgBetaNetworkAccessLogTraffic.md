...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.networkaccess/get-mgbetanetworkaccesslogtraffic
Locale: en-US
Module Name: Microsoft.Graph.Beta.NetworkAccess
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaNetworkAccessLogTraffic
---
...
```
Get-MgBetaNetworkAccessLogTraffic [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaNetworkAccessLogTraffic -NetworkAccessTrafficTransactionId <string>
...
- [Get-MgBetaNetworkAccessLogTraffic](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.networkaccess/get-mgbetanetworkaccesslogtraffic)
- [Graph API Reference](https://learn.microsoft.com/graph/api/networkaccess-logs-list-traffic?view=graph-rest-beta)
