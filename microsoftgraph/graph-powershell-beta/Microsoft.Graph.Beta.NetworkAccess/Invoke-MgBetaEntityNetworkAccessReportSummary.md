...
```
Invoke-MgBetaEntityNetworkAccessReportSummary -EndDateTime <datetime> -StartDateTime <datetime>
...
```
Invoke-MgBetaEntityNetworkAccessReportSummary -InputObject <INetworkAccessIdentity> [-Count]
