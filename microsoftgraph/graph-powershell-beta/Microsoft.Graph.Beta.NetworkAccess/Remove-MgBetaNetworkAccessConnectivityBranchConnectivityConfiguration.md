...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.networkaccess/remove-mgbetanetworkaccessconnectivitybranchconnectivityconfiguration
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgBetaNetworkAccessConnectivityBranchConnectivityConfiguration -InputObject <INetworkAccessIdentity>
 [-IfMatch <String>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
