...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.networkaccess/get-mgbetanetworkaccesscloudfirewallpolicyrule
Locale: en-US
Module Name: Microsoft.Graph.Beta.NetworkAccess
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaNetworkAccessCloudFirewallPolicyRule
---

# Get-MgBetaNetworkAccessCloudFirewallPolicyRule
...
```
Get-MgBetaNetworkAccessCloudFirewallPolicyRule -CloudFirewallPolicyId <string>
...
```
Get-MgBetaNetworkAccessCloudFirewallPolicyRule -CloudFirewallPolicyId <string>
 -PolicyRuleId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaNetworkAccessCloudFirewallPolicyRule -InputObject <INetworkAccessIdentity>
