...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.networkaccess/update-mgbetanetworkaccesscloudfirewallpolicyrule
Locale: en-US
Module Name: Microsoft.Graph.Beta.NetworkAccess
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaNetworkAccessCloudFirewallPolicyRule
---

# Update-MgBetaNetworkAccessCloudFirewallPolicyRule
...
```
Update-MgBetaNetworkAccessCloudFirewallPolicyRule -CloudFirewallPolicyId <string>
 -PolicyRuleId <string> [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
...
```
Update-MgBetaNetworkAccessCloudFirewallPolicyRule -CloudFirewallPolicyId <string>
 -PolicyRuleId <string> -BodyParameter <IMicrosoftGraphNetworkaccessPolicyRule>
...
```
Update-MgBetaNetworkAccessCloudFirewallPolicyRule -InputObject <INetworkAccessIdentity>
...
- [Update-MgBetaNetworkAccessCloudFirewallPolicyRule](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.networkaccess/update-mgbetanetworkaccesscloudfirewallpolicyrule)
- [Graph API Reference](https://learn.microsoft.com/graph/api/networkaccess-cloudfirewallrule-update?view=graph-rest-beta)
