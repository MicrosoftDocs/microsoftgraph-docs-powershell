...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.networkaccess/get-mgbetanetworkaccessthreatintelligencepolicyrule
Locale: en-US
Module Name: Microsoft.Graph.Beta.NetworkAccess
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaNetworkAccessThreatIntelligencePolicyRule
---
...
```
Get-MgBetaNetworkAccessThreatIntelligencePolicyRule -ThreatIntelligencePolicyId <string>
...
```
Get-MgBetaNetworkAccessThreatIntelligencePolicyRule -PolicyRuleId <string>
 -ThreatIntelligencePolicyId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaNetworkAccessThreatIntelligencePolicyRule -InputObject <INetworkAccessIdentity>
...
- [Get-MgBetaNetworkAccessThreatIntelligencePolicyRule](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.networkaccess/get-mgbetanetworkaccessthreatintelligencepolicyrule)
