...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.networkaccess/get-mgbetanetworkaccesscloudfirewallpolicyrulecount
Locale: en-US
Module Name: Microsoft.Graph.Beta.NetworkAccess
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaNetworkAccessCloudFirewallPolicyRuleCount
---

# Get-MgBetaNetworkAccessCloudFirewallPolicyRuleCount
...
```
Get-MgBetaNetworkAccessCloudFirewallPolicyRuleCount -CloudFirewallPolicyId <string>
...
```
Get-MgBetaNetworkAccessCloudFirewallPolicyRuleCount -InputObject <INetworkAccessIdentity>
 [-Filter <string>] [-Search <string>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
