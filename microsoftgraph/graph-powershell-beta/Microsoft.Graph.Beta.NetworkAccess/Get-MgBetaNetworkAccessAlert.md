...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.networkaccess/get-mgbetanetworkaccessalert
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaNetworkAccessAlert [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaNetworkAccessAlert -AlertId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgBetaNetworkAccessAlert -InputObject <INetworkAccessIdentity> [-ExpandProperty <String[]>]
