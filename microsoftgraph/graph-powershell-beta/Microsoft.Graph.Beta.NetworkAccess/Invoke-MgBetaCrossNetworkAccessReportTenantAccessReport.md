...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.networkaccess/invoke-mgbetacrossnetworkaccessreporttenantaccessreport
schema: 2.0.0
---
...
### Cross (Default)
```
Invoke-MgBetaCrossNetworkAccessReportTenantAccessReport -EndDateTime <DateTime> -StartDateTime <DateTime>
...
### CrossViaIdentity
```
Invoke-MgBetaCrossNetworkAccessReportTenantAccessReport -InputObject <INetworkAccessIdentity> [-Count]
...
Parameter Sets: CrossViaIdentity
Aliases:
