...
```
Update-MgBetaNetworkAccessSettingConditionalAccess
 -BodyParameter <IMicrosoftGraphNetworkaccessConditionalAccessSettings>
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphNetworkaccessConditionalAccessSettings
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
