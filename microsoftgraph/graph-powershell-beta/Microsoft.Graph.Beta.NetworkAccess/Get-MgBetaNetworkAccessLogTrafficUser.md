...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.networkaccess/get-mgbetanetworkaccesslogtrafficuser
Locale: en-US
Module Name: Microsoft.Graph.Beta.NetworkAccess
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaNetworkAccessLogTrafficUser
---
...
```
Get-MgBetaNetworkAccessLogTrafficUser -NetworkAccessTrafficTransactionId <string>
...
```
Get-MgBetaNetworkAccessLogTrafficUser -InputObject <INetworkAccessIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
...
- [Get-MgBetaNetworkAccessLogTrafficUser](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.networkaccess/get-mgbetanetworkaccesslogtrafficuser)
