...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.networkaccess/get-mgbetanetworkaccesslogtrafficdevice
Locale: en-US
Module Name: Microsoft.Graph.Beta.NetworkAccess
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaNetworkAccessLogTrafficDevice
---
...
```
Get-MgBetaNetworkAccessLogTrafficDevice -InputObject <INetworkAccessIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
...
- [Get-MgBetaNetworkAccessLogTrafficDevice](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.networkaccess/get-mgbetanetworkaccesslogtrafficdevice)
