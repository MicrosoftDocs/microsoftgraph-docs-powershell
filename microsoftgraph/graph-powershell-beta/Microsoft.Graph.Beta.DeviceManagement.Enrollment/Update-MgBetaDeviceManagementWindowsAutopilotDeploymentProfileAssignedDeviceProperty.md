...
Update-MgBetaDeviceManagementWindowsAutopilotDeploymentProfileAssignedDeviceProperty
 ...
 [-DeviceFriendlyName <string>] [-DisplayName <string>] [-GroupTag <string>]
...
Update-MgBetaDeviceManagementWindowsAutopilotDeploymentProfileAssignedDeviceProperty
 ...
 [-DisplayName <string>] [-GroupTag <string>] [-UserPrincipalName <string>] [-Break]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths19IcukwDevicemanagementWindowsautopilotdeploymentprofilesWindowsautopilotdeploymentprofileIdAssigneddevicesWindowsautopilotdeviceidentityIdMicrosoftGraphUpdatedevicepropertiesPostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
