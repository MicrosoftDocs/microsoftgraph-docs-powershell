...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgDeviceManagementAndroidForWorkEnrollmentProfile](/powershell/module/Microsoft.Graph.DeviceManagement.Enrollment/New-MgDeviceManagementAndroidForWorkEnrollmentProfile?view=graph-powershell-v1.0)
...
New-MgBetaDeviceManagementAndroidForWorkEnrollmentProfile [-AccountId <String>]
 ...
 [-TokenValue <String>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
## RELATED LINKS
[New-MgDeviceManagementAndroidForWorkEnrollmentProfile](/powershell/module/Microsoft.Graph.DeviceManagement.Enrollment/New-MgDeviceManagementAndroidForWorkEnrollmentProfile?view=graph-powershell-v1.0)
