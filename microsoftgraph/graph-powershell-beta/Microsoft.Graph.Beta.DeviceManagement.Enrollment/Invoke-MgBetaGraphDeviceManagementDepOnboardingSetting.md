...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.enrollment/invoke-mgbetagraphdevicemanagementdeponboardingsetting
schema: 2.0.0
---
...
### GraphViaIdentity
```
Invoke-MgBetaGraphDeviceManagementDepOnboardingSetting -InputObject <IDeviceManagementEnrollmentIdentity>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
