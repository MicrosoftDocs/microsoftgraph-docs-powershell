...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.enrollment/sync-mgbetadevicemanagementdeponboardingsettingwithappledeviceenrollmentprogram
schema: 2.0.0
---
...
```
Sync-MgBetaDeviceManagementDepOnboardingSettingWithAppleDeviceEnrollmentProgram
 -DepOnboardingSettingId <String> [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru]
