...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgDeviceManagementDepOnboardingSettingEnrollmentProfile](/powershell/module/Microsoft.Graph.DeviceManagement.Enrollment/Update-MgDeviceManagementDepOnboardingSettingEnrollmentProfile?view=graph-powershell-v1.0)
...
```
Update-MgBetaDeviceManagementDepOnboardingSettingEnrollmentProfile -DepOnboardingSettingId <String>
 -EnrollmentProfileId <String> -BodyParameter <IMicrosoftGraphEnrollmentProfile> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
