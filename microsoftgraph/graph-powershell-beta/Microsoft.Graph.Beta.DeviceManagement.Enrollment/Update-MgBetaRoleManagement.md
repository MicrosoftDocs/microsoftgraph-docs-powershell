...
Update-MgBetaRoleManagement [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>]
 [-CloudPc <IMicrosoftGraphRbacApplicationMultiple>] [-Defender <IMicrosoftGraphRbacApplicationMultiple>]
 ...
 [-Exchange <IMicrosoftGraphUnifiedRbacApplication>] [-Headers <IDictionary>]
...
Read-only when isBuiltIn is true.
  ...
  - `[Defender <IMicrosoftGraphRbacApplicationMultiple>]`: rbacApplicationMultiple
