...
```
New-MgBetaRoleManagementExchangeRoleDefinition [-ResponseHeadersVariable <String>]
...
### Create
```
New-MgBetaRoleManagementExchangeRoleDefinition -BodyParameter <IMicrosoftGraphUnifiedRoleDefinition>
