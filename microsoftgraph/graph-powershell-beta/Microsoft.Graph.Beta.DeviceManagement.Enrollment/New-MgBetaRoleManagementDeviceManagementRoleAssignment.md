...
The following RBAC providers are currently supported:n- Cloud PC n- device management (Intune) For other Microsoft 365 applications (like Microsoft Entra ID), use unifiedRoleAssignment.
