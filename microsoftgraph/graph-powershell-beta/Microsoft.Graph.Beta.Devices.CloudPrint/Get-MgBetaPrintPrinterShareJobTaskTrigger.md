...
### Get (Default)
```
Get-MgBetaPrintPrinterShareJobTaskTrigger -PrintJobId <String> -PrintTaskId <String> -PrinterShareId <String>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.cloudprint/get-mgbetaprintprintersharejobtasktrigger](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devices.cloudprint/get-mgbetaprintprintersharejobtasktrigger)
