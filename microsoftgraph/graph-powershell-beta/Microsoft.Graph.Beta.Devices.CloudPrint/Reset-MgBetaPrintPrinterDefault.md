...
### Reset (Default)
```
Reset-MgBetaPrintPrinterDefault -PrinterId <String> [-ResponseHeadersVariable <String>]
...
### ResetViaIdentity
```
Reset-MgBetaPrintPrinterDefault -InputObject <IDevicesCloudPrintIdentity> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
