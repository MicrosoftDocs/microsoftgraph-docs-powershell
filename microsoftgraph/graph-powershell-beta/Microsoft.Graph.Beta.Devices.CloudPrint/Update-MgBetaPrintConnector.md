...
Update-MgBetaPrintConnector -PrintConnectorId <string> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-AppVersion <string>]
 [-DeviceHealth <IMicrosoftGraphDeviceHealth>] [-DisplayName <string>]
...
```
Update-MgBetaPrintConnector -PrintConnectorId <string>
 -BodyParameter <IMicrosoftGraphPrintConnector> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
Update-MgBetaPrintConnector -InputObject <IDevicesCloudPrintIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-AppVersion <string>]
 [-DeviceHealth <IMicrosoftGraphDeviceHealth>] [-DisplayName <string>]
 [-FullyQualifiedDomainName <string>] [-Id <string>] [-Location <IMicrosoftGraphPrinterLocation>]
 [-Name <string>] [-OperatingSystem <string>] [-RegisteredDateTime <datetime>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
