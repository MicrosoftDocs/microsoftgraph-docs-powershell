...
### Start (Default)
```
Start-MgBetaPrintPrinterShareJob -PrintJobId <String> -PrinterShareId <String> [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### StartViaIdentity
```
Start-MgBetaPrintPrinterShareJob -InputObject <IDevicesCloudPrintIdentity> [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
