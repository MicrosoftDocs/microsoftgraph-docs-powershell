...
### Start (Default)
```
Start-MgBetaPrintPrinterJob -PrintJobId <String> -PrinterId <String> [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### StartViaIdentity
```
Start-MgBetaPrintPrinterJob -InputObject <IDevicesCloudPrintIdentity> [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
