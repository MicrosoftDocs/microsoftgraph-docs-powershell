...
### Start (Default)
```
Start-MgBetaPrintPrinterJobPrintJob -PrintJobId <String> -PrinterId <String> [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### StartViaIdentity
```
Start-MgBetaPrintPrinterJobPrintJob -InputObject <IDevicesCloudPrintIdentity> [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
