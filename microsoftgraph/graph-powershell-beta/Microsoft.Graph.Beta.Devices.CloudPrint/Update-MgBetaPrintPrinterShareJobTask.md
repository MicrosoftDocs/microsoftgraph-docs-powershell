...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgPrintPrinterShareJobTask](/powershell/module/Microsoft.Graph.Devices.CloudPrint/Update-MgPrintPrinterShareJobTask?view=graph-powershell-v1.0)

## SYNTAX

### UpdateExpanded (Default)
```
Update-MgBetaPrintPrinterShareJobTask -PrintJobId <String> -PrintTaskId <String> -PrinterShareId <String>
...
## RELATED LINKS
[Update-MgPrintPrinterShareJobTask](/powershell/module/Microsoft.Graph.Devices.CloudPrint/Update-MgPrintPrinterShareJobTask?view=graph-powershell-v1.0)
