...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.applications/get-mgbetaapplicationownerasserviceprincipal
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaApplicationOwnerAsServicePrincipal -ApplicationId <String> [-ExpandProperty <String[]>]
...
### Get
```
Get-MgBetaApplicationOwnerAsServicePrincipal -ApplicationId <String> -DirectoryObjectId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-ConsistencyLevel <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaApplicationOwnerAsServicePrincipal -InputObject <IApplicationsIdentity> [-ExpandProperty <String[]>]
