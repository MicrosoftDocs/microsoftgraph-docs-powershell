...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.applications/remove-mgbetaserviceprincipalsynchronizationtemplateschema
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaServicePrincipalSynchronizationTemplateSchema -ServicePrincipalId <String>
 -SynchronizationTemplateId <String> [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaServicePrincipalSynchronizationTemplateSchema -InputObject <IApplicationsIdentity>
