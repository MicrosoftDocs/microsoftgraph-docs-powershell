...
### Create1 (Default)
```
New-MgApplicationTokenIssuancePolicyByRef -ApplicationId <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### CreateViaIdentity1
```
New-MgApplicationTokenIssuancePolicyByRef -InputObject <IApplicationsIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
