...
### Set (Default)
```
Set-MgBetaApplicationLogo -ApplicationId <String> [-Data <Stream>] -InFile <String> [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### SetViaIdentity
```
Set-MgBetaApplicationLogo -InputObject <IApplicationsIdentity> [-Data <Stream>] -InFile <String> [-PassThru]
