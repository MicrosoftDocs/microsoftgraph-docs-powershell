...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/remove-mgbetaidentityb2cuserflowlanguageoverridepage
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaIdentityB2CUserFlowLanguageOverridePage -B2CIdentityUserFlowId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaIdentityB2CUserFlowLanguageOverridePage -InputObject <IIdentitySignInsIdentity>
