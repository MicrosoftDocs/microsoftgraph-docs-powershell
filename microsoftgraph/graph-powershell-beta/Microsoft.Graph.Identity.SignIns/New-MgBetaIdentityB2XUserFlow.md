...
```
New-MgBetaIdentityB2XUserFlow [-AdditionalProperties <Hashtable>]
...
### Create
```
New-MgBetaIdentityB2XUserFlow -BodyParameter <IMicrosoftGraphB2XIdentityUserFlow> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
