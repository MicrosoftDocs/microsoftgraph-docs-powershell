...
### List (Default)
```
Get-MgBetaUserAuthenticationPasswordlessMicrosoftAuthenticatorMethod -UserId <String>
...
### GetViaIdentity
```
Get-MgBetaUserAuthenticationPasswordlessMicrosoftAuthenticatorMethod -InputObject <IIdentitySignInsIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphPasswordlessMicrosoftAuthenticatorAuthenticationMethod
## NOTES
