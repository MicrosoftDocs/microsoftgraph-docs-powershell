...
### List (Default)
```
Get-MgBetaIdentityB2CUserFlow [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaIdentityB2CUserFlow -B2CIdentityUserFlowId <String> [-ExpandProperty <String[]>]
