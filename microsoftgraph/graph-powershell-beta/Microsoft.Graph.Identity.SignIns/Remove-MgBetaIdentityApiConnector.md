...
### Delete (Default)
```
Remove-MgBetaIdentityApiConnector -IdentityApiConnectorId <String> [-IfMatch <String>] [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaIdentityApiConnector -InputObject <IIdentitySignInsIdentity> [-IfMatch <String>] [-PassThru]
