...
### Delete (Default)
```
Remove-MgBetaTrustFrameworkPolicy -TrustFrameworkPolicyId <String> [-IfMatch <String>] [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaTrustFrameworkPolicy -InputObject <IIdentitySignInsIdentity> [-IfMatch <String>] [-PassThru]
