...
### Delta (Default)
```
Get-MgPolicyFeatureRolloutPolicyApplyToDelta -FeatureRolloutPolicyId <String> [-Filter <String>]
...
### DeltaViaIdentity
```
Get-MgPolicyFeatureRolloutPolicyApplyToDelta -InputObject <IIdentitySignInsIdentity> [-Filter <String>]
