...
### List (Default)
```
Get-MgBetaUserAuthenticationPasswordMethod -UserId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgBetaUserAuthenticationPasswordMethod -InputObject <IIdentitySignInsIdentity> [-ExpandProperty <String[]>]
