...
### List (Default)
```
Get-MgBetaInformationProtectionPolicyLabel [-ExpandProperty <String[]>] [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgBetaInformationProtectionPolicyLabel -InputObject <IIdentitySignInsIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
