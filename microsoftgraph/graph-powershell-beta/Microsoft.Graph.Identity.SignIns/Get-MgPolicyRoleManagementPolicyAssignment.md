...
### List (Default)
```
Get-MgPolicyRoleManagementPolicyAssignment [-ExpandProperty <String[]>] [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgPolicyRoleManagementPolicyAssignment -InputObject <IIdentitySignInsIdentity> [-ExpandProperty <String[]>]
