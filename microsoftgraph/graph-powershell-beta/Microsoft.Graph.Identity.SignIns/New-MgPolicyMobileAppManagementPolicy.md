...
### Create
```
New-MgPolicyMobileAppManagementPolicy -BodyParameter <IMicrosoftGraphMobilityManagementPolicy> [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.signins/new-mgpolicymobileappmanagementpolicy](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.signins/new-mgpolicymobileappmanagementpolicy)
