...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.identity.signins/remove-mgbetariskyserviceprincipalhistory
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-MgBetaRiskyServicePrincipalHistory -InputObject <IIdentitySignInsIdentity> [-IfMatch <String>]
