...
### List (Default)
```
Get-MgFinancialCompanySaleOrderLine -CompanyId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
### Get1
```
Get-MgFinancialCompanySaleOrderLine -CompanyId <String> -SalesOrderLineId <String> -SalesOrderId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```

### Get
```
Get-MgFinancialCompanySaleOrderLine -CompanyId <String> -SalesOrderLineId <String> [-ExpandProperty <String[]>]
