...
### Set (Default)
```
Set-MgFinancialCompanyInformationPicture -CompanyId <String> -CompanyInformationId <String>
 [-BodyParameter <Stream>] -InFile <String> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### SetViaIdentity
```
Set-MgFinancialCompanyInformationPicture -InputObject <IFinancialsIdentity> [-BodyParameter <Stream>]
