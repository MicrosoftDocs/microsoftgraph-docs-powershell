...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.financials/update-mgbetafinancialcompanypurchaseinvoicelineitempicture
schema: 2.0.0
---
...
```
Update-MgBetaFinancialCompanyPurchaseInvoiceLineItemPicture -CompanyId <String> -PictureId <String>
 -PurchaseInvoiceLineId <String> -PurchaseInvoiceId <String> -BodyParameter <IMicrosoftGraphPicture> [-WhatIf]
...
```
Update-MgBetaFinancialCompanyPurchaseInvoiceLineItemPicture -CompanyId <String> -PictureId <String>
 -PurchaseInvoiceLineId <String> -BodyParameter <IMicrosoftGraphPicture> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
