...
Set-MgBetaFinancialCompanySaleInvoiceLineItemPictureContent -CompanyId <String> -PictureId <String>
 -SalesInvoiceLineId <String> [-Data <Stream>] -InFile <String> [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Set1
```
Set-MgBetaFinancialCompanySaleInvoiceLineItemPictureContent -CompanyId <String> -PictureId <String>
 -SalesInvoiceLineId <String> -SalesInvoiceId <String> [-Data <Stream>] -InFile <String> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### SetViaIdentity1
```
Set-MgBetaFinancialCompanySaleInvoiceLineItemPictureContent -InputObject <IFinancialsIdentity> [-Data <Stream>]
