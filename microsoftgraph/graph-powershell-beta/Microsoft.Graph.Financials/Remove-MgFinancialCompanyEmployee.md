...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/remove-mgfinancialcompanyemployee
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgFinancialCompanyEmployee -CompanyId <String> -EmployeeId <String> [-IfMatch <String>] [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgFinancialCompanyEmployee -InputObject <IFinancialsIdentity> [-IfMatch <String>] [-PassThru] [-WhatIf]
