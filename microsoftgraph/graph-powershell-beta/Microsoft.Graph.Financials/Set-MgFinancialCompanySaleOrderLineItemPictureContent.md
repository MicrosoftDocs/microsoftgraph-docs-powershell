...
Set-MgFinancialCompanySaleOrderLineItemPictureContent -CompanyId <String> -PictureId <String>
 -SalesOrderLineId <String> [-BodyParameter <Stream>] -InFile <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```
Set-MgFinancialCompanySaleOrderLineItemPictureContent -CompanyId <String> -PictureId <String>
 -SalesOrderLineId <String> -SalesOrderId <String> [-BodyParameter <Stream>] -InFile <String> [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### SetViaIdentity1
```
Set-MgFinancialCompanySaleOrderLineItemPictureContent -InputObject <IFinancialsIdentity>
