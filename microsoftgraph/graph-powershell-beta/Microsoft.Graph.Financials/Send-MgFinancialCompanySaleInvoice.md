...
### Send (Default)
```
Send-MgFinancialCompanySaleInvoice -CompanyId <String> -SalesInvoiceId <String> [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### SendViaIdentity
```
Send-MgFinancialCompanySaleInvoice -InputObject <IFinancialsIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
