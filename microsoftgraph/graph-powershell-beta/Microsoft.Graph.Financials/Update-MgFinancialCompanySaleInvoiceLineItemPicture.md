...
```
Update-MgFinancialCompanySaleInvoiceLineItemPicture -CompanyId <String> -PictureId <String>
 -SalesInvoiceLineId <String> -SalesInvoiceId <String> -BodyParameter <IMicrosoftGraphPicture> [-PassThru]
...
```
Update-MgFinancialCompanySaleInvoiceLineItemPicture -CompanyId <String> -PictureId <String>
 -SalesInvoiceLineId <String> -BodyParameter <IMicrosoftGraphPicture> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
