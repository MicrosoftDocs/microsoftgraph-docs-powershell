...
```
Update-MgFinancialCompanySaleOrderLineAccount -CompanyId <String> -SalesOrderLineId <String>
 -SalesOrderId <String> [-AdditionalProperties <Hashtable>] [-Blocked] [-Category <String>]
...
```
Update-MgFinancialCompanySaleOrderLineAccount -CompanyId <String> -SalesOrderLineId <String>
 -SalesOrderId <String> -BodyParameter <IMicrosoftGraphAccount> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
