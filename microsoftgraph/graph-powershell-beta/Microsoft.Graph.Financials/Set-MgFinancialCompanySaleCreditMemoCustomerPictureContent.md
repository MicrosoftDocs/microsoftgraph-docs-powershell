...
Set-MgFinancialCompanySaleCreditMemoCustomerPictureContent -CompanyId <String> -PictureId <String>
 -SalesCreditMemoId <String> [-BodyParameter <Stream>] -InFile <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### SetViaIdentity
```
Set-MgFinancialCompanySaleCreditMemoCustomerPictureContent -InputObject <IFinancialsIdentity>
