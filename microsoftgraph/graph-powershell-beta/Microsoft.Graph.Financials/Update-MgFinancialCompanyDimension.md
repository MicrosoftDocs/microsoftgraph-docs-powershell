...
```
Update-MgFinancialCompanyDimension -CompanyId <String> -DimensionId <String>
 -BodyParameter <IMicrosoftGraphDimension> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### UpdateViaIdentity
```
Update-MgFinancialCompanyDimension -InputObject <IFinancialsIdentity> -BodyParameter <IMicrosoftGraphDimension>
