...
### Post (Default)
```
Invoke-MgFinancialCompanySaleInvoiceAndSend -CompanyId <String> -SalesInvoiceId <String> [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### PostViaIdentity
```
Invoke-MgFinancialCompanySaleInvoiceAndSend -InputObject <IFinancialsIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
