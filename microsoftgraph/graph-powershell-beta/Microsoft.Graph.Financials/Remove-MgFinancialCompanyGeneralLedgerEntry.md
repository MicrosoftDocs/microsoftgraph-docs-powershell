...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/remove-mgfinancialcompanygeneralledgerentry
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgFinancialCompanyGeneralLedgerEntry -CompanyId <String> -GeneralLedgerEntryId <String>
 [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgFinancialCompanyGeneralLedgerEntry -InputObject <IFinancialsIdentity> [-IfMatch <String>] [-PassThru]
