...
### Cancel (Default)
```
Stop-MgFinancialCompanySaleInvoiceAndSend -CompanyId <String> -SalesInvoiceId <String> [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### CancelViaIdentity
```
Stop-MgFinancialCompanySaleInvoiceAndSend -InputObject <IFinancialsIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
