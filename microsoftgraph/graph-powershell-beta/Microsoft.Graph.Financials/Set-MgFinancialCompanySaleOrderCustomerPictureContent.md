...
Set-MgFinancialCompanySaleOrderCustomerPictureContent -CompanyId <String> -PictureId <String>
 -SalesOrderId <String> [-BodyParameter <Stream>] -InFile <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### SetViaIdentity
```
Set-MgFinancialCompanySaleOrderCustomerPictureContent -InputObject <IFinancialsIdentity>
