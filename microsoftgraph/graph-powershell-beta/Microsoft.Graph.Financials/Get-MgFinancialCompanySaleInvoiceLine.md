...
### List (Default)
```
Get-MgFinancialCompanySaleInvoiceLine -CompanyId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
### List1
```
Get-MgFinancialCompanySaleInvoiceLine -CompanyId <String> -SalesInvoiceId <String> [-ExpandProperty <String[]>]
...
### Get1
```
Get-MgFinancialCompanySaleInvoiceLine -CompanyId <String> -SalesInvoiceLineId <String> -SalesInvoiceId <String>
