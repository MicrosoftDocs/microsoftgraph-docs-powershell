...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.financials/remove-mgfinancialcompanyjournalaccount
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgFinancialCompanyJournalAccount -CompanyId <String> -JournalId <String> [-IfMatch <String>] [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgFinancialCompanyJournalAccount -InputObject <IFinancialsIdentity> [-IfMatch <String>] [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
