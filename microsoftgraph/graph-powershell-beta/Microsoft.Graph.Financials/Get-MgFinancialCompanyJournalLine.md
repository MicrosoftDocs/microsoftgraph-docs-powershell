...
### List (Default)
```
Get-MgFinancialCompanyJournalLine -CompanyId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
### Get1
```
Get-MgFinancialCompanyJournalLine -CompanyId <String> -JournalLineId <String> -JournalId <String>
