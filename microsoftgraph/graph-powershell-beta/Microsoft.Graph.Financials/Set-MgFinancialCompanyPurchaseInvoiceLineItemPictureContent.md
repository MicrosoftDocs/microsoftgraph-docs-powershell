...
Set-MgFinancialCompanyPurchaseInvoiceLineItemPictureContent -CompanyId <String> -PictureId <String>
 -PurchaseInvoiceLineId <String> [-BodyParameter <Stream>] -InFile <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```
Set-MgFinancialCompanyPurchaseInvoiceLineItemPictureContent -CompanyId <String> -PictureId <String>
 -PurchaseInvoiceLineId <String> -PurchaseInvoiceId <String> [-BodyParameter <Stream>] -InFile <String>
