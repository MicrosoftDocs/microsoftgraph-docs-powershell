...
Set-MgBetaFinancialCompanySaleQuoteCustomerPictureContent -CompanyId <String> -PictureId <String>
 -SalesQuoteId <String> [-Data <Stream>] -InFile <String> [-WhatIf] [-Confirm] [<CommonParameters>]
```

### SetViaIdentity
```
Set-MgBetaFinancialCompanySaleQuoteCustomerPictureContent -InputObject <IFinancialsIdentity> [-Data <Stream>]
