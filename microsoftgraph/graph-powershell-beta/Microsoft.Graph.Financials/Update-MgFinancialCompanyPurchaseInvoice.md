...
Update-MgFinancialCompanyPurchaseInvoice -CompanyId <String> -PurchaseInvoiceId <String>
 ...
 [-VendorInvoiceNumber <String>] [-VendorName <String>] [-VendorNumber <String>] [-PassThru] [-WhatIf]
...
```
Update-MgFinancialCompanyPurchaseInvoice -CompanyId <String> -PurchaseInvoiceId <String>
 -BodyParameter <IMicrosoftGraphPurchaseInvoice> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgFinancialCompanyPurchaseInvoice -InputObject <IFinancialsIdentity> [-AdditionalProperties <Hashtable>]
