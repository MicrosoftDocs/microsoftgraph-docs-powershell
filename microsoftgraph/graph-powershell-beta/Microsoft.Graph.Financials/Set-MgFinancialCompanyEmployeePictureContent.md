...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.financials/set-mgbetafinancialcompanyemployeepicturecontent
schema: 2.0.0
---
...
### SetViaIdentity
```
Set-MgBetaFinancialCompanyEmployeePictureContent -InputObject <IFinancialsIdentity> [-Data <Stream>]
