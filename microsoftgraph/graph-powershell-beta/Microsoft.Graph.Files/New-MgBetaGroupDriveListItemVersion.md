...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetagroupdrivelistitemversion
schema: 2.0.0
ms.prod: sharepoint
---
...
```
New-MgBetaGroupDriveListItemVersion -DriveId <String> -GroupId <String> -ListItemId <String>
...
```
New-MgBetaGroupDriveListItemVersion -InputObject <IFilesIdentity> [-AdditionalProperties <Hashtable>]
...
### CreateViaIdentity
```
New-MgBetaGroupDriveListItemVersion -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphListItemVersion> [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetagroupdrivelistitemversion](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/new-mgbetagroupdrivelistitemversion)
