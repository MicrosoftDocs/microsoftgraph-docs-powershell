...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/remove-mgbetauserdriverootlistitemdocumentsetversion
schema: 2.0.0
...
### Delete (Default)
```
Remove-MgBetaUserDriveRootListItemDocumentSetVersion -DocumentSetVersionId <String> -DriveId <String>
 -UserId <String> [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaUserDriveRootListItemDocumentSetVersion -InputObject <IFilesIdentity> [-IfMatch <String>]
