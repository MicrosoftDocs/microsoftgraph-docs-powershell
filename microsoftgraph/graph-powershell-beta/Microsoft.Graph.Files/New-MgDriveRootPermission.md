...
### Create1
```
New-MgDriveRootPermission -DriveId <String> -BodyParameter <IMicrosoftGraphPermission1> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### CreateViaIdentity1
```
New-MgDriveRootPermission -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphPermission1> [-WhatIf]
