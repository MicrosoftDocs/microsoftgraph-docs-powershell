...
### Reauthorize (Default)
```
Invoke-MgBetaReauthorizeDriveListSubscription -DriveId <String> -SubscriptionId <String> [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### ReauthorizeViaIdentity
```
Invoke-MgBetaReauthorizeDriveListSubscription -InputObject <IFilesIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
