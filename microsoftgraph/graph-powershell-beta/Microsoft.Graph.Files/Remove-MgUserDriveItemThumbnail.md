...
### DeleteViaIdentity1
```
Remove-MgUserDriveItemThumbnail -InputObject <IFilesIdentity> [-IfMatch <String>] [-PassThru] [-WhatIf]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/remove-mguserdriveitemthumbnail](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/remove-mguserdriveitemthumbnail)
