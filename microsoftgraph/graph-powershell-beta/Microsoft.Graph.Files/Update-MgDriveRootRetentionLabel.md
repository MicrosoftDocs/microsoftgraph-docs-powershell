...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/update-mgdriverootretentionlabel
schema: 2.0.0
---
...
Update-MgDriveRootRetentionLabel -DriveId <String> [-AdditionalProperties <Hashtable>] [-Id <String>]
 ...
 [-Name <String>] [-RetentionSettings <IMicrosoftGraphRetentionLabelSettings>] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
