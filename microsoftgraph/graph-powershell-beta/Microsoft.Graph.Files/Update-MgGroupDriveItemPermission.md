...
```
Update-MgGroupDriveItemPermission -DriveId <String> -DriveItemId <String> -GroupId <String>
 -PermissionId <String> -BodyParameter <IMicrosoftGraphPermission1> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### UpdateViaIdentity1
```
Update-MgGroupDriveItemPermission -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphPermission1>
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/update-mggroupdriveitempermission](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/update-mggroupdriveitempermission)
