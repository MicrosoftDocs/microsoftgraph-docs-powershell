...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/invoke-mgbetaextractdriverootsensitivitylabel
schema: 2.0.0
---
...
### Extract (Default)
```
Invoke-MgBetaExtractDriveRootSensitivityLabel -DriveId <String> [-WhatIf] [-Confirm] [<CommonParameters>]
```

### ExtractViaIdentity
```
Invoke-MgBetaExtractDriveRootSensitivityLabel -InputObject <IFilesIdentity> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
