...
### Create1
```
New-MgUserDriveListColumn -DriveId <String> -UserId <String> -BodyParameter <IMicrosoftGraphColumnDefinition1>
...
### CreateViaIdentity1
```
New-MgUserDriveListColumn -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphColumnDefinition1>
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
