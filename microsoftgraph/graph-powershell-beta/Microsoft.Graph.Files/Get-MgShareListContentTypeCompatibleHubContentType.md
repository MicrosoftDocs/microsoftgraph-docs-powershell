...
### Get1 (Default)
```
Get-MgShareListContentTypeCompatibleHubContentType -SharedDriveItemId <String> [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgShareListContentTypeCompatibleHubContentType -InputObject <IFilesIdentity> [<CommonParameters>]
```
