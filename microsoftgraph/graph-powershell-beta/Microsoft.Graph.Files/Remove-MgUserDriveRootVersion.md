...
### DeleteViaIdentity1
```
Remove-MgUserDriveRootVersion -InputObject <IFilesIdentity> [-IfMatch <String>] [-PassThru] [-WhatIf]
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/remove-mguserdriverootversion](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/remove-mguserdriverootversion)
