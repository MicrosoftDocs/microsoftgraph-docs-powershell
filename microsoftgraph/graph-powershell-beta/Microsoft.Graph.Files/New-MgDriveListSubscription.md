...
```
New-MgBetaDriveListSubscription -DriveId <String> [-AdditionalProperties <Hashtable>] [-ApplicationId <String>]
...
### Create
```
New-MgBetaDriveListSubscription -DriveId <String> -BodyParameter <IMicrosoftGraphSubscription> [-WhatIf]
