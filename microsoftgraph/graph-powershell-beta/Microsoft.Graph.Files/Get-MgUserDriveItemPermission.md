...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/get-mgbetauserdriveitempermission
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaUserDriveItemPermission -DriveId <String> -DriveItemId <String> -UserId <String>
...
### Get
```
Get-MgBetaUserDriveItemPermission -DriveId <String> -DriveItemId <String> -PermissionId <String>
 -UserId <String> [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaUserDriveItemPermission -InputObject <IFilesIdentity> [-ExpandProperty <String[]>]
