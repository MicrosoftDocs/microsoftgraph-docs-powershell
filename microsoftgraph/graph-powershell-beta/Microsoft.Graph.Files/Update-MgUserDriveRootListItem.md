...
```
Update-MgUserDriveRootListItem -DriveId <String> -UserId <String>
...
### Update1
```
Update-MgUserDriveRootListItem -DriveId <String> -UserId <String> -BodyParameter <IMicrosoftGraphListItem1>
 [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UpdateViaIdentityExpanded1
```
Update-MgUserDriveRootListItem -InputObject <IFilesIdentity> [-Activities <IMicrosoftGraphItemActivityOld[]>]
...
### UpdateViaIdentity1
```
Update-MgUserDriveRootListItem -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphListItem1>
 [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
