...
```
Update-MgGroupDriveItem -InputObject <IFilesIdentity> [-Activities <IMicrosoftGraphItemActivityOld[]>]
...
### UpdateViaIdentity1
```
Update-MgGroupDriveItem -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphDriveItem1> [-PassThru]
