...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/update-mgbetauserdriveitemretentionlabel
schema: 2.0.0
---
...
```
Update-MgBetaUserDriveItemRetentionLabel -DriveId <String> -DriveItemId <String> -UserId <String>
...
```
Update-MgBetaUserDriveItemRetentionLabel -InputObject <IFilesIdentity> [-AdditionalProperties <Hashtable>]
...
### UpdateViaIdentity
```
Update-MgBetaUserDriveItemRetentionLabel -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphItemRetentionLabel> [-WhatIf] [-Confirm] [<CommonParameters>]
```
