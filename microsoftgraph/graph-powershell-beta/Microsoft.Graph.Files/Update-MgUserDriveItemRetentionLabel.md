...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/update-mguserdriveitemretentionlabel
schema: 2.0.0
---
...
```
Update-MgUserDriveItemRetentionLabel -DriveId <String> -DriveItemId <String> -UserId <String>
 ...
 [-RetentionSettings <IMicrosoftGraphRetentionLabelSettings>] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```
Update-MgUserDriveItemRetentionLabel -DriveId <String> -DriveItemId <String> -UserId <String>
 -BodyParameter <IMicrosoftGraphItemRetentionLabel> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgUserDriveItemRetentionLabel -InputObject <IFilesIdentity> [-AdditionalProperties <Hashtable>]
...
### UpdateViaIdentity
```
Update-MgUserDriveItemRetentionLabel -InputObject <IFilesIdentity>
 -BodyParameter <IMicrosoftGraphItemRetentionLabel> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
