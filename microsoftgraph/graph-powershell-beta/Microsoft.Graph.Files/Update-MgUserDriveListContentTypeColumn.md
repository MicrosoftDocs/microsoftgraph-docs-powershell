...
```
Update-MgUserDriveListContentTypeColumn -ColumnDefinitionId <String> -ContentTypeId <String> -DriveId <String>
 -UserId <String> -BodyParameter <IMicrosoftGraphColumnDefinition1> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/update-mguserdrivelistcontenttypecolumn](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/update-mguserdrivelistcontenttypecolumn)
