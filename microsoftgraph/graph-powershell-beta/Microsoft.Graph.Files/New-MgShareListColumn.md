...
### Create
```
New-MgShareListColumn -SharedDriveItemId <String> -BodyParameter <IMicrosoftGraphColumnDefinition> [-WhatIf]
...
### CreateViaIdentity
```
New-MgShareListColumn -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphColumnDefinition> [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
