...
```
New-MgUserDriveListItem -DriveId <String> -UserId <String> [-Activities <IMicrosoftGraphItemActivityOld[]>]
...
### Create1
```
New-MgUserDriveListItem -DriveId <String> -UserId <String> -BodyParameter <IMicrosoftGraphListItem1> [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### CreateViaIdentityExpanded1
```
New-MgUserDriveListItem -InputObject <IFilesIdentity> [-Activities <IMicrosoftGraphItemActivityOld[]>]
 [-AdditionalProperties <Hashtable>] [-Analytics <IMicrosoftGraphItemAnalytics1>]
 [-ContentType <IMicrosoftGraphContentTypeInfo>] [-CreatedBy <IMicrosoftGraphIdentitySet>]
 [-CreatedByUser <IMicrosoftGraphUser1>] [-CreatedDateTime <DateTime>] [-Deleted <IMicrosoftGraphDeleted>]
 [-Description <String>] [-DocumentSetVersions <IMicrosoftGraphDocumentSetVersion[]>]
...
### CreateViaIdentity1
```
New-MgUserDriveListItem -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphListItem1> [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
