...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.files/get-mgbetasharelistitem
schema: 2.0.0
ms.prod: sharepoint
---
...
### Get1
```
Get-MgBetaShareListItem -SharedDriveItemId <String> -ListItemId <String> [-ExpandProperty <String[]>]
