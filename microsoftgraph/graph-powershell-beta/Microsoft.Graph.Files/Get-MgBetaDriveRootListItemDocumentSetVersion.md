...
### List (Default)
```
Get-MgBetaDriveRootListItemDocumentSetVersion -DriveId <String> [-ExpandProperty <String[]>]
...
### Get
```
Get-MgBetaDriveRootListItemDocumentSetVersion -DocumentSetVersionId <String> -DriveId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDriveRootListItemDocumentSetVersion -InputObject <IFilesIdentity> [-ExpandProperty <String[]>]
