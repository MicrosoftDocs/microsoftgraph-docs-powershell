...
```
Update-MgUserDriveItemListItem -InputObject <IFilesIdentity> [-Activities <IMicrosoftGraphItemActivityOld[]>]
...
### UpdateViaIdentity1
```
Update-MgUserDriveItemListItem -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphListItem1>
