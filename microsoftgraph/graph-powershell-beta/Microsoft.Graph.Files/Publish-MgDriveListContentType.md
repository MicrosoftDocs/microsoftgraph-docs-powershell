...
### Publish (Default)
```
Publish-MgBetaDriveListContentType -ContentTypeId <String> -DriveId <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### PublishViaIdentity
```
Publish-MgBetaDriveListContentType -InputObject <IFilesIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
