...
### Update1
```
Update-MgBetaShareListItemField -SharedDriveItemId <String> -BodyParameter <Hashtable> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### UpdateViaIdentity1
```
Update-MgBetaShareListItemField -InputObject <IFilesIdentity> -BodyParameter <Hashtable> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
