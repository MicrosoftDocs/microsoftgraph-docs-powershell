...
```
Update-MgUserDriveItemPermission -DriveId <String> -DriveItemId <String> -PermissionId <String>
 -UserId <String> -BodyParameter <IMicrosoftGraphPermission1> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### UpdateViaIdentity1
```
Update-MgUserDriveItemPermission -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphPermission1>
