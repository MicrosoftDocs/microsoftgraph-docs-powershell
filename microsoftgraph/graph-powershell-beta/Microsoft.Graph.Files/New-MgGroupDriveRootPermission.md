...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/new-mggroupdriverootpermission
schema: 2.0.0
---
...
### Create1
```
New-MgGroupDriveRootPermission -DriveId <String> -GroupId <String> -BodyParameter <IMicrosoftGraphPermission1>
...
### CreateViaIdentity1
```
New-MgGroupDriveRootPermission -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphPermission1>
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/new-mggroupdriverootpermission](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.files/new-mggroupdriverootpermission)
