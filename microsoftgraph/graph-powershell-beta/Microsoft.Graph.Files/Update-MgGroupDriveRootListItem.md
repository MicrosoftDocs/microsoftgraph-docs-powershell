...
```
Update-MgGroupDriveRootListItem -DriveId <String> -GroupId <String>
...
### Update1
```
Update-MgGroupDriveRootListItem -DriveId <String> -GroupId <String> -BodyParameter <IMicrosoftGraphListItem1>
 [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UpdateViaIdentityExpanded1
```
Update-MgGroupDriveRootListItem -InputObject <IFilesIdentity> [-Activities <IMicrosoftGraphItemActivityOld[]>]
...
### UpdateViaIdentity1
```
Update-MgGroupDriveRootListItem -InputObject <IFilesIdentity> -BodyParameter <IMicrosoftGraphListItem1>
 [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
