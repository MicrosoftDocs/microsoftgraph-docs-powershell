...
```
Get-MgBetaServicePrincipalAppRoleAssignedTo -ServicePrincipalId <string>
...
```
Get-MgBetaServicePrincipalAppRoleAssignedTo -AppRoleAssignmentId <string>
...
```
Get-MgBetaServicePrincipalAppRoleAssignedTo -InputObject <IApplicationsIdentity>
