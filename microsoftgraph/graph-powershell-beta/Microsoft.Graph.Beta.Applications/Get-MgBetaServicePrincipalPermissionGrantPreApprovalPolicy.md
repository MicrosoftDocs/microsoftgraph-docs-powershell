...
### List (Default)
```
Get-MgBetaServicePrincipalPermissionGrantPreApprovalPolicy -ServicePrincipalId <String>
...
### Get
```
Get-MgBetaServicePrincipalPermissionGrantPreApprovalPolicy -PermissionGrantPreApprovalPolicyId <String>
...
### GetViaIdentity
```
Get-MgBetaServicePrincipalPermissionGrantPreApprovalPolicy -InputObject <IApplicationsIdentity>
