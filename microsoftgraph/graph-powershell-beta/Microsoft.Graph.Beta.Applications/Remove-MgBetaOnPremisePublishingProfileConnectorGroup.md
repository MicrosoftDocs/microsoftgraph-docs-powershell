...
Remove-MgBetaOnPremisePublishingProfileConnectorGroup -ConnectorGroupId <String>
 -OnPremisesPublishingProfileId <String> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
...
[https://learn.microsoft.com/graph/api/connectorgroup-delete?view=graph-rest-1.0](https://learn.microsoft.com/graph/api/connectorgroup-delete?view=graph-rest-1.0)
