...
```
New-MgBetaServicePrincipalAppRoleAssignedTo -ServicePrincipalId <String> [-ResponseHeadersVariable <String>]
...
**Permissions**
[!INCLUDE [permissions-table](~/../graphref/api-reference/beta/includes/permissions/serviceprincipal-post-approleassignedto-permissions.md)]
...
[https://learn.microsoft.com/graph/api/serviceprincipal-post-approleassignedto?view=graph-rest-beta](https://learn.microsoft.com/graph/api/serviceprincipal-post-approleassignedto?view=graph-rest-beta)
