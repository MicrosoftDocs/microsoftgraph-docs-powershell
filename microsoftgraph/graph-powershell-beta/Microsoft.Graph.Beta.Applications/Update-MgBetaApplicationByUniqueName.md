...
```
Update-MgBetaApplicationByUniqueName -UniqueName <String> [-ResponseHeadersVariable <String>]
...
```
Update-MgBetaApplicationByUniqueName [-UniqueName <String>] -InputObject <IApplicationsIdentity>
