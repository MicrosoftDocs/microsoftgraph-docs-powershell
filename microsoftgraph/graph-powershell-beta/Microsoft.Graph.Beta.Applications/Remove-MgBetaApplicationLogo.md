...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.applications/remove-mgbetaapplicationlogo
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaApplicationLogo -ApplicationId <String> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
