...
### Delete1
```
Remove-MgBetaOnPremisePublishingProfilePublishedResourceAgentGroupByRef -OnPremisesPublishingProfileId <String>
 -PublishedResourceId <String> -Id <String> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
