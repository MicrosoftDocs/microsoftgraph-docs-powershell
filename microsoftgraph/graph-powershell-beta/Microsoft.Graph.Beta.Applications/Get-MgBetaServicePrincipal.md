...
- [Graph API Reference](https://learn.microsoft.com/graph/api/serviceprincipal-get?view=graph-rest-beta)
- [Graph API Reference](https://learn.microsoft.com/graph/api/serviceprincipal-list?view=graph-rest-beta)
