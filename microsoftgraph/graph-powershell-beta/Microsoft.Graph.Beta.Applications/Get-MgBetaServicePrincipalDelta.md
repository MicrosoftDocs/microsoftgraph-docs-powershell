...
```
Get-MgBetaServicePrincipalDelta [-ExpandProperty <String[]>] [-Filter <String>] [-Property <String[]>]
...
**Permissions**
[!INCLUDE [permissions-table](~/../graphref/api-reference/beta/includes/permissions/serviceprincipal-delta-permissions.md)]
