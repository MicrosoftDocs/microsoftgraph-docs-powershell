...
Update-MgBetaApplicationFederatedIdentityCredentialByName -ApplicationId <String> -Name <String>
 ...
 [-Description <String>] [-Id <String>] [-Issuer <String>] [-Name1 <String>] [-Subject <String>]
...
Update-MgBetaApplicationFederatedIdentityCredentialByName [-Name <String>] -InputObject <IApplicationsIdentity>
 [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>] [-Audiences <String[]>]
 [-Description <String>] [-Id <String>] [-Issuer <String>] [-Subject <String>] [-Headers <IDictionary>]
...
**Permissions**
[!INCLUDE [permissions-table](~/../graphref/api-reference/beta/includes/permissions/federatedidentitycredential-upsert-permissions.md)]
