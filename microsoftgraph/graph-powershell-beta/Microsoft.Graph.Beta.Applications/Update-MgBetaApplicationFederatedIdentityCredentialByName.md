...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.applications/update-mgbetaapplicationfederatedidentitycredentialbyname
Locale: en-US
Module Name: Microsoft.Graph.Beta.Applications
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaApplicationFederatedIdentityCredentialByName
---
...
Create a new federatedIdentityCredential object for an application or an agentIdentityBlueprint if it doesn't exist, or update the properties of an existing federatedIdentityCredential object.
...
Update-MgBetaApplicationFederatedIdentityCredentialByName -ApplicationId <string> -Name <string>
 ...
 [-Id <string>] [-Issuer <string>] [-Name1 <string>] [-Subject <string>] [-Break]
...
Update-MgBetaApplicationFederatedIdentityCredentialByName -InputObject <IApplicationsIdentity>
 [-Name <string>] [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-Audiences <string[]>] [-ClaimsMatchingExpression <IMicrosoftGraphFederatedIdentityExpression>]
 [-Description <string>] [-Id <string>] [-Issuer <string>] [-Subject <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphFederatedIdentityExpression
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
- [Update-MgBetaApplicationFederatedIdentityCredentialByName](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.applications/update-mgbetaapplicationfederatedidentitycredentialbyname)
