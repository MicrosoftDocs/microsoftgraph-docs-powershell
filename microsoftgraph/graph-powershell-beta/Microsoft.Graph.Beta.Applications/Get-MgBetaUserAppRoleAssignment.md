...
[https://learn.microsoft.com/graph/api/user-list-approleassignments?view=graph-rest-beta](https://learn.microsoft.com/graph/api/user-list-approleassignments?view=graph-rest-beta)
