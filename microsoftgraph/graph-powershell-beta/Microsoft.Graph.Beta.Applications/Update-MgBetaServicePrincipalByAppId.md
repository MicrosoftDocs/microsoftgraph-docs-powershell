...
```
Update-MgBetaServicePrincipalByAppId -AppId <string> [-ResponseHeadersVariable <string>]
 [-AccountEnabled] [-AddIns <IMicrosoftGraphAddIn[]>] [-AdditionalProperties <hashtable>]
 [-AlternativeNames <string[]>] [-AppDescription <string>] [-AppDisplayName <string>]
 [-AppId1 <string>] [-AppManagementPolicies <IMicrosoftGraphAppManagementPolicy[]>]
 ...
 [-Synchronization <IMicrosoftGraphSynchronization>] [-Tags <string[]>]
...
```
Update-MgBetaServicePrincipalByAppId -InputObject <IApplicationsIdentity> [-AppId <string>]
 [-ResponseHeadersVariable <string>] [-AccountEnabled] [-AddIns <IMicrosoftGraphAddIn[]>]
 [-AdditionalProperties <hashtable>] [-AlternativeNames <string[]>] [-AppDescription <string>]
 [-AppDisplayName <string>] [-AppManagementPolicies <IMicrosoftGraphAppManagementPolicy[]>]
 [-AppOwnerOrganizationId <string>] [-AppRoleAssignedTo <IMicrosoftGraphAppRoleAssignment[]>]
 [-AppRoleAssignmentRequired] [-AppRoleAssignments <IMicrosoftGraphAppRoleAssignment[]>]
 [-AppRoles <IMicrosoftGraphAppRole[]>] [-ApplicationTemplateId <string>]
 [-ClaimsMappingPolicies <IMicrosoftGraphClaimsMappingPolicy[]>]
...
```
Update-MgBetaServicePrincipalByAppId -AppId <string>
...
Specifies whether the service principal of the app in a tenant or across tenants for multi-tenant apps can obtain new access tokens or access protected resources.
