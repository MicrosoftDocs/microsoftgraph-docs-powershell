...
### Set (Default)
```
Set-MgBetaApplicationLogo -ApplicationId <String> [-Data <Stream>] -InFile <String> [-ContentType <String>]
...
### SetViaIdentity
```
Set-MgBetaApplicationLogo -InputObject <IApplicationsIdentity> [-Data <Stream>] -InFile <String>
