...
### Set (Default)
```
Set-MgBetaApplicationLogo -ApplicationId <String> [-Data <Stream>] [-ResponseHeadersVariable <String>]
...
### SetViaIdentity
```
Set-MgBetaApplicationLogo -InputObject <IApplicationsIdentity> [-Data <Stream>]
