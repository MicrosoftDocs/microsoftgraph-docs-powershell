...
```
Remove-MgBetaServicePrincipalAppRoleAssignedTo -AppRoleAssignmentId <string>
...
```
Remove-MgBetaServicePrincipalAppRoleAssignedTo -InputObject <IApplicationsIdentity>
