...
# Get-MgBetaOnPremisePublishingProfileSensor
...
```
Get-MgBetaOnPremisePublishingProfileSensor -OnPremisesPublishingProfileId <string>
...
```
Get-MgBetaOnPremisePublishingProfileSensor -OnPremisesPublishingProfileId <string>
 -PrivateAccessSensorId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaOnPremisePublishingProfileSensor -InputObject <IApplicationsIdentity>
...
- [Get-MgBetaOnPremisePublishingProfileSensor](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.applications/get-mgbetaonpremisepublishingprofilesensor)
