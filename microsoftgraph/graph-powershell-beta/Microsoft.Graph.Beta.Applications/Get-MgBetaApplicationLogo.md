...
### Get (Default)
```
Get-MgBetaApplicationLogo -ApplicationId <String> -OutFile <String> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaApplicationLogo -InputObject <IApplicationsIdentity> -OutFile <String> [-Headers <IDictionary>]
...
## RELATED LINKS
[Get-MgApplicationLogo](/powershell/module/Microsoft.Graph.Applications/Get-MgApplicationLogo?view=graph-powershell-1.0)
