...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.applications/update-mgbetaonpremisepublishingprofilepublishedresource
Locale: en-US
Module Name: Microsoft.Graph.Beta.Applications
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaOnPremisePublishingProfilePublishedResource
---
...
Update-MgBetaOnPremisePublishingProfilePublishedResource -OnPremisesPublishingProfileId <string>
 -PublishedResourceId <string> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-AgentGroups <IMicrosoftGraphOnPremisesAgentGroup[]>]
 [-DisplayName <string>] [-Id <string>] [-PublishingType <string>] [-ResourceName <string>] [-Break]
...
```
Update-MgBetaOnPremisePublishingProfilePublishedResource -OnPremisesPublishingProfileId <string>
 -PublishedResourceId <string> -BodyParameter <IMicrosoftGraphPublishedResource>
...
- [Update-MgBetaOnPremisePublishingProfilePublishedResource](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.applications/update-mgbetaonpremisepublishingprofilepublishedresource)
