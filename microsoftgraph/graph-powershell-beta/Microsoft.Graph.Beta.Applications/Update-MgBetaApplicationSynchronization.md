...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.applications/update-mgbetaapplicationsynchronization
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgApplicationSynchronization](/powershell/module/Microsoft.Graph.Applications/Update-MgApplicationSynchronization?view=graph-powershell-v1.0)

## SYNTAX

### UpdateExpanded (Default)
```
Update-MgBetaApplicationSynchronization -ApplicationId <String> [-AdditionalProperties <Hashtable>]
...
### Update
```
Update-MgBetaApplicationSynchronization -ApplicationId <String> -BodyParameter <IMicrosoftGraphSynchronization>
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgBetaApplicationSynchronization -InputObject <IApplicationsIdentity>
