...
```
Update-MgBetaApplicationByAppId -AppId <string> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Api <IMicrosoftGraphApiApplication>] [-AppId1 <string>]
 ...
 [-CreatedByAppId <string>] [-CreatedDateTime <datetime>]
 ...
 [-NativeAuthenticationApisEnabled <string>] [-Notes <string>]
 ...
 [-SignInAudienceRestrictions <IMicrosoftGraphSignInAudienceRestrictionsBase>]
 [-Spa <IMicrosoftGraphSpaApplication>] [-Synchronization <IMicrosoftGraphSynchronization>]
 ...
 [-Windows <IMicrosoftGraphWindowsApplication>] [-Break] [-Headers <IDictionary>]
...
```
Update-MgBetaApplicationByAppId -InputObject <IApplicationsIdentity> [-AppId <string>]
...
```
Update-MgBetaApplicationByAppId -AppId <string> -BodyParameter <IMicrosoftGraphApplication>
...
```
Update-MgBetaApplicationByAppId -InputObject <IApplicationsIdentity>
 -BodyParameter <IMicrosoftGraphApplication> [-ResponseHeadersVariable <string>] [-Break]
...
Deactivate an app without deleting it.
...
A collection of application IDs for applications designated as managers of this application.
...
To construct, see NOTES section for SIGNINAUDIENCERESTRICTIONS properties and create a hash table.

```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphSignInAudienceRestrictionsBase
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
