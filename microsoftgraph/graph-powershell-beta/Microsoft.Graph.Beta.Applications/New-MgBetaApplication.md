...
[https://learn.microsoft.com/graph/api/application-post-applications?view=graph-rest-beta](https://learn.microsoft.com/graph/api/application-post-applications?view=graph-rest-beta)
