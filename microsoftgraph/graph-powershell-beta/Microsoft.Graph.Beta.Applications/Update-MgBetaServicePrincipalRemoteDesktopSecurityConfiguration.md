...
Update-MgBetaServicePrincipalRemoteDesktopSecurityConfiguration -ServicePrincipalId <String>
 ...
 [-ApprovedClientApps <IMicrosoftGraphApprovedClientApp[]>] [-Id <String>] [-IsRemoteDesktopProtocolEnabled]
 [-TargetDeviceGroups <IMicrosoftGraphTargetDeviceGroup[]>] [-Headers <IDictionary>]
...
```yaml
Type: IMicrosoftGraphApprovedClientApp[]
Parameter Sets: UpdateExpanded, UpdateViaIdentityExpanded
Aliases:
...
[https://learn.microsoft.com/graph/api/remotedesktopsecurityconfiguration-update?view=graph-rest-beta](https://learn.microsoft.com/graph/api/remotedesktopsecurityconfiguration-update?view=graph-rest-beta)
