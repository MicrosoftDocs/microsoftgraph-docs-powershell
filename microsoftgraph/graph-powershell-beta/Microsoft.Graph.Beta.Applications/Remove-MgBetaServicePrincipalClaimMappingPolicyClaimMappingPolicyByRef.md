...
### Delete (Default)
```
Remove-MgBetaServicePrincipalClaimMappingPolicyClaimMappingPolicyByRef -ClaimsMappingPolicyId <String>
 -ServicePrincipalId <String> [-IfMatch <String>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaServicePrincipalClaimMappingPolicyClaimMappingPolicyByRef -InputObject <IApplicationsIdentity>
...
[https://learn.microsoft.com/graph/api/serviceprincipal-delete-claimsmappingpolicies?view=graph-rest-beta](https://learn.microsoft.com/graph/api/serviceprincipal-delete-claimsmappingpolicies?view=graph-rest-beta)
