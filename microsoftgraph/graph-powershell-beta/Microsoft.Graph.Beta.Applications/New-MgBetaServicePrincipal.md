...
### Create
```
New-MgBetaServicePrincipal -BodyParameter <IMicrosoftGraphServicePrincipal> [-ResponseHeadersVariable <String>]
...
[https://learn.microsoft.com/graph/api/serviceprincipal-post-serviceprincipals?view=graph-rest-beta](https://learn.microsoft.com/graph/api/serviceprincipal-post-serviceprincipals?view=graph-rest-beta)
