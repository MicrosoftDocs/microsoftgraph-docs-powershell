...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.applications/update-mgbetaserviceprincipalremotedesktopsecurityconfigurationtargetdevicegroup
Locale: en-US
Module Name: Microsoft.Graph.Beta.Applications
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaServicePrincipalRemoteDesktopSecurityConfigurationTargetDeviceGroup
---
...
```
Update-MgBetaServicePrincipalRemoteDesktopSecurityConfigurationTargetDeviceGroup
 -ServicePrincipalId <string> -TargetDeviceGroupId <string> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaServicePrincipalRemoteDesktopSecurityConfigurationTargetDeviceGroup
 -ServicePrincipalId <string> -TargetDeviceGroupId <string>
 -BodyParameter <IMicrosoftGraphTargetDeviceGroup> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
- [Update-MgBetaServicePrincipalRemoteDesktopSecurityConfigurationTargetDeviceGroup](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.applications/update-mgbetaserviceprincipalremotedesktopsecurityconfigurationtargetdevicegroup)
- [Graph API Reference](https://learn.microsoft.com/graph/api/targetdevicegroup-update?view=graph-rest-beta)
