...
### Delete (Default)
```
Remove-MgBetaServicePrincipalByAppId -AppId <String> [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaServicePrincipalByAppId -InputObject <IApplicationsIdentity> [-IfMatch <String>] [-PassThru]
