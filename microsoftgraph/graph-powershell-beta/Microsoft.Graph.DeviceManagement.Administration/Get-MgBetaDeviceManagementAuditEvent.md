...
### List (Default)
```
Get-MgBetaDeviceManagementAuditEvent [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaDeviceManagementAuditEvent -AuditEventId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
