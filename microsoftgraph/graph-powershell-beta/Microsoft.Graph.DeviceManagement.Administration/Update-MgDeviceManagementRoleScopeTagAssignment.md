...
```
Update-MgDeviceManagementRoleScopeTagAssignment -RoleScopeTagAutoAssignmentId <String> -RoleScopeTagId <String>
...
```
Update-MgDeviceManagementRoleScopeTagAssignment -RoleScopeTagAutoAssignmentId <String> -RoleScopeTagId <String>
 -BodyParameter <IMicrosoftGraphRoleScopeTagAutoAssignment> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
