...
### Get (Default)
```
Get-MgBetaReportTeamUserActivityUserDetail -Date <DateTime> -OutFile <String> [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Get1
```
Get-MgBetaReportTeamUserActivityUserDetail -Period <String> -OutFile <String> [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgBetaReportTeamUserActivityUserDetail -InputObject <IReportsIdentity> -OutFile <String>
