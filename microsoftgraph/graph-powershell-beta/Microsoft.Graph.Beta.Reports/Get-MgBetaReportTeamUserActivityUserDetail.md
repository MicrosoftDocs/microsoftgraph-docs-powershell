...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportteamuseractivityuserdetail
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaReportTeamUserActivityUserDetail -Date <DateTime> -OutFile <String> [-PassThru] [<CommonParameters>]
```

### Get1
```
Get-MgBetaReportTeamUserActivityUserDetail -Period <String> -OutFile <String> [-PassThru] [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgBetaReportTeamUserActivityUserDetail -InputObject <IReportsIdentity> -OutFile <String> [-PassThru]
 [<CommonParameters>]
```
...
## RELATED LINKS
[Get-MgReportTeamUserActivityUserDetail](/powershell/module/Microsoft.Graph.Reports/Get-MgReportTeamUserActivityUserDetail?view=graph-powershell-1.0)

[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportteamuseractivityuserdetail](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportteamuseractivityuserdetail)
