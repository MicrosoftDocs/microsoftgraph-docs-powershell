...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportmonthlyprintusagesummarybyuser
Locale: en-US
Module Name: Microsoft.Graph.Beta.Reports
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaReportMonthlyPrintUsageSummaryByUser
---
...
```
Get-MgBetaReportMonthlyPrintUsageSummaryByUser -PrintUsageByUserId <string>
...
```
Get-MgBetaReportMonthlyPrintUsageSummaryByUser -InputObject <IReportsIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
...
- [Get-MgBetaReportMonthlyPrintUsageSummaryByUser](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportmonthlyprintusagesummarybyuser)
