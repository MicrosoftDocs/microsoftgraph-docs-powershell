...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportserviceactivityactiveusermetricforonenoteweb
schema: 2.0.0
...
### Get (Default)
```
Get-MgBetaReportServiceActivityActiveUserMetricForOneNoteWeb -ExclusiveIntervalEndDateTime <DateTime>
...
### GetViaIdentity
```
Get-MgBetaReportServiceActivityActiveUserMetricForOneNoteWeb -InputObject <IReportsIdentity>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportserviceactivityactiveusermetricforonenoteweb](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportserviceactivityactiveusermetricforonenoteweb)

[https://learn.microsoft.com/graph/api/serviceactivity-getactiveusermetricsforonenoteweb?view=graph-rest-beta](https://learn.microsoft.com/graph/api/serviceactivity-getactiveusermetricsforonenoteweb?view=graph-rest-beta)
