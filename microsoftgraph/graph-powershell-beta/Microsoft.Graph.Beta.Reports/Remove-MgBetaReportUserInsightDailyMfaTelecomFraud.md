...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/remove-mgbetareportuserinsightdailymfatelecomfraud
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaReportUserInsightDailyMfaTelecomFraud -MfaTelecomFraudMetricId <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgBetaReportUserInsightDailyMfaTelecomFraud -InputObject <IReportsIdentity> [-IfMatch <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
