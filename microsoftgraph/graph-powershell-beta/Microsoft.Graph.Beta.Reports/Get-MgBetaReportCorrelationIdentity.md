...
# Get-MgBetaReportCorrelationIdentity
...
```
Get-MgBetaReportCorrelationIdentity -IdentityCorrelationId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaReportCorrelationIdentity -CorrelatedIdentityId <string> -IdentityCorrelationId <string>
...
```
Get-MgBetaReportCorrelationIdentity -InputObject <IReportsIdentity> [-ExpandProperty <string[]>]
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphCorrelatedIdentity
