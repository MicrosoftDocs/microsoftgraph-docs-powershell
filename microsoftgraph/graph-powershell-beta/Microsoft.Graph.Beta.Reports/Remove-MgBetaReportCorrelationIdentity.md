...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/remove-mgbetareportcorrelationidentity
Locale: en-US
Module Name: Microsoft.Graph.Beta.Reports
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Remove-MgBetaReportCorrelationIdentity
---

# Remove-MgBetaReportCorrelationIdentity
...
```
Remove-MgBetaReportCorrelationIdentity -CorrelatedIdentityId <string>
 -IdentityCorrelationId <string> [-IfMatch <string>] [-ResponseHeadersVariable <string>] [-Break]
...
```
Remove-MgBetaReportCorrelationIdentity -InputObject <IReportsIdentity> [-IfMatch <string>]
...
The unique identifier of correlatedIdentity
...
The unique identifier of identityCorrelation
...
- [Remove-MgBetaReportCorrelationIdentity](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/remove-mgbetareportcorrelationidentity)
