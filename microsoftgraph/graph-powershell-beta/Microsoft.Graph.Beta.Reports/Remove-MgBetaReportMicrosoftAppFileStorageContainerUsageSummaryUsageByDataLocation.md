...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/remove-mgbetareportmicrosoftappfilestoragecontainerusagesummaryusagebydatalocation
Locale: en-US
Module Name: Microsoft.Graph.Beta.Reports
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Remove-MgBetaReportMicrosoftAppFileStorageContainerUsageSummaryUsageByDataLocation
---

# Remove-MgBetaReportMicrosoftAppFileStorageContainerUsageSummaryUsageByDataLocation
...
```
Remove-MgBetaReportMicrosoftAppFileStorageContainerUsageSummaryUsageByDataLocation
 -MicrosoftAppsFileStorageContainerGeoUsageDataLocationCode <string> [-IfMatch <string>]
...
```
Remove-MgBetaReportMicrosoftAppFileStorageContainerUsageSummaryUsageByDataLocation
 -InputObject <IReportsIdentity> [-IfMatch <string>] [-ResponseHeadersVariable <string>] [-Break]
...
- [Remove-MgBetaReportMicrosoftAppFileStorageContainerUsageSummaryUsageByDataLocation](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/remove-mgbetareportmicrosoftappfilestoragecontainerusagesummaryusagebydatalocation)
