...
### Get (Default)
```
Get-MgBetaReportM365AppUserDetail -Date <DateTime> -OutFile <String> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Get1
```
Get-MgBetaReportM365AppUserDetail -Period <String> -OutFile <String> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgBetaReportM365AppUserDetail -InputObject <IReportsIdentity> -OutFile <String> [-Headers <IDictionary>]
...
## RELATED LINKS
[Get-MgReportM365AppUserDetail](/powershell/module/Microsoft.Graph.Reports/Get-MgReportM365AppUserDetail?view=graph-powershell-1.0)
