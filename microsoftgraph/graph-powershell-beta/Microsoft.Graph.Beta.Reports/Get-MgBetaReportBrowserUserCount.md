...
### Get (Default)
```
Get-MgBetaReportBrowserUserCount -Period <String> -OutFile <String> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportBrowserUserCount -InputObject <IReportsIdentity> -OutFile <String> [-Headers <IDictionary>]
