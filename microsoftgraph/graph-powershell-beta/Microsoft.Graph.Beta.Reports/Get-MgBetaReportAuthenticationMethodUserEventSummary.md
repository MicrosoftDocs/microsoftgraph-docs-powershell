...
```
Get-MgBetaReportAuthenticationMethodUserEventSummary [-ExpandProperty <string[]>]
...
```
Get-MgBetaReportAuthenticationMethodUserEventSummary -UserEventsSummaryId <string>
...
```
Get-MgBetaReportAuthenticationMethodUserEventSummary -InputObject <IReportsIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [<CommonParameters>]
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphUserEventsSummary
