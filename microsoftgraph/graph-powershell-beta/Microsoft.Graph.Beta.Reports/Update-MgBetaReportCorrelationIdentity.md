...
# Update-MgBetaReportCorrelationIdentity
...
```
Update-MgBetaReportCorrelationIdentity -CorrelatedIdentityId <string>
 -IdentityCorrelationId <string> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-CorrelatedDateTime <datetime>]
 [-Error <IMicrosoftGraphCorrelationError>] [-Id <string>]
 [-SourceIdentity <IMicrosoftGraphIdentityInfo>] [-Status <string>]
 [-TargetIdentity <IMicrosoftGraphIdentityInfo>] [-Break] [-Headers <IDictionary>]
...
```
Update-MgBetaReportCorrelationIdentity -CorrelatedIdentityId <string>
 -IdentityCorrelationId <string> -BodyParameter <IMicrosoftGraphCorrelatedIdentity>
...
```
Update-MgBetaReportCorrelationIdentity -InputObject <IReportsIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-CorrelatedDateTime <datetime>] [-Error <IMicrosoftGraphCorrelationError>] [-Id <string>]
 [-SourceIdentity <IMicrosoftGraphIdentityInfo>] [-Status <string>]
 [-TargetIdentity <IMicrosoftGraphIdentityInfo>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```
Update-MgBetaReportCorrelationIdentity -InputObject <IReportsIdentity>
 -BodyParameter <IMicrosoftGraphCorrelatedIdentity> [-ResponseHeadersVariable <string>] [-Break]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphCorrelatedIdentity
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
The date and time when the identity was correlated.
Supports $orderby.
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphCorrelationError
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphIdentityInfo
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
The correlation and assignment status.
Possible values include: uncorrelated, correlatedNotAssigned, correlatedAssigned and failToCorrelate.
...
identityInfo
To construct, see NOTES section for TARGETIDENTITY properties and create a hash table.
...
Read-only.
  [CorrelatedDateTime <DateTime?>]: The date and time when the identity was correlated.
 Supports $orderby.
  ...
  [Status <String>]: The correlation and assignment status.
Possible values include: uncorrelated, correlatedNotAssigned, correlatedAssigned and failToCorrelate.
 Supports $filter (eq), $count.
