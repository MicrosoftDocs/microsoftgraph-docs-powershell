...
### List (Default)
```
Get-MgBetaReportUserInsightMonthlyInactiveUserByApplication [-ExpandProperty <String[]>] [-Property <String[]>]
...
### Get
```
Get-MgBetaReportUserInsightMonthlyInactiveUserByApplication -MonthlyInactiveUsersByApplicationMetricId <String>
