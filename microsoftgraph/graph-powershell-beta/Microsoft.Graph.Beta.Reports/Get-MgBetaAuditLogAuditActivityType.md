...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetaauditlogauditactivitytype
Locale: en-US
Module Name: Microsoft.Graph.Beta.Reports
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaAuditLogAuditActivityType
---

# Get-MgBetaAuditLogAuditActivityType
...
```
Get-MgBetaAuditLogAuditActivityType [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaAuditLogAuditActivityType -AuditActivityTypeId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaAuditLogAuditActivityType -InputObject <IReportsIdentity> [-ExpandProperty <string[]>]
 [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
```
...
The unique identifier of auditActivityType
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphAuditActivityType
...
- [Get-MgBetaAuditLogAuditActivityType](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetaauditlogauditactivitytype)
- [Graph API Reference](https://learn.microsoft.com/graph/api/auditlogroot-list-auditactivitytypes?view=graph-rest-beta)
