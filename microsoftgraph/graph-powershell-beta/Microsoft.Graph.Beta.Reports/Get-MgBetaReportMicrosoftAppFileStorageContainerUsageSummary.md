...
Get storage usage data for SharePoint Embedded file storage containers in a tenant.
...
```
Get-MgBetaReportMicrosoftAppFileStorageContainerUsageSummary [-ExpandProperty <string[]>]
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphMicrosoftAppsFileStorageContainerUsage
