...
# Invoke-MgBetaUserReportAuthenticationMethodRegistrationActivity
...
```
Invoke-MgBetaUserReportAuthenticationMethodRegistrationActivity -Period <string> [-Count]
...
```
Invoke-MgBetaUserReportAuthenticationMethodRegistrationActivity -InputObject <IReportsIdentity>
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphUserRegistrationActivitySummary
