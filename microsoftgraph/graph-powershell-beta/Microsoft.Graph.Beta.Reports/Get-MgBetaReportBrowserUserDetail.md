...
### Get (Default)
```
Get-MgBetaReportBrowserUserDetail -Period <String> -OutFile <String> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportBrowserUserDetail -InputObject <IReportsIdentity> -OutFile <String> [-Headers <IDictionary>]
