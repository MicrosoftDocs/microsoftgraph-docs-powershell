...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportserviceactivityaudiostreamoverudpmetricforteam
schema: 2.0.0
...
### Get (Default)
```
Get-MgBetaReportServiceActivityAudioStreamOverUdpMetricForTeam -ExclusiveIntervalEndDateTime <DateTime>
...
### GetViaIdentity
```
Get-MgBetaReportServiceActivityAudioStreamOverUdpMetricForTeam -InputObject <IReportsIdentity>
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphServiceActivityPerformanceMetric
## NOTES
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportserviceactivityaudiostreamoverudpmetricforteam](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportserviceactivityaudiostreamoverudpmetricforteam)

[https://learn.microsoft.com/graph/api/serviceactivity-getaudiostreamsoverudpmetricsforteams?view=graph-rest-beta](https://learn.microsoft.com/graph/api/serviceactivity-getaudiostreamsoverudpmetricsforteams?view=graph-rest-beta)
