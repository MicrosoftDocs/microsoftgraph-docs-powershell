...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetaauditlogsummarizedmsisignin
Locale: en-US
Module Name: Microsoft.Graph.Beta.Reports
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaAuditLogSummarizedMsiSignIn
---

# Get-MgBetaAuditLogSummarizedMsiSignIn
...
```
Get-MgBetaAuditLogSummarizedMsiSignIn -AggregationWindow <string> [-Count]
...
```
Get-MgBetaAuditLogSummarizedMsiSignIn -InputObject <IReportsIdentity> [-Count]
 [-ExpandProperty <string[]>] [-Filter <string>] [-Property <string[]>] [-Search <string>]
 [-Skip <int>] [-Sort <string[]>] [-Top <int>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
...
- [Get-MgBetaAuditLogSummarizedMsiSignIn](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetaauditlogsummarizedmsisignin)
- [Graph API Reference](https://learn.microsoft.com/graph/api/auditlogroot-getsummarizedmsisignins?view=graph-rest-beta)
