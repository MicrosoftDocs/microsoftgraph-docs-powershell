...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/update-mgbetaadminreportsettingsharepointapiusagereportmetric
Locale: en-US
Module Name: Microsoft.Graph.Beta.Reports
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaAdminReportSettingSharePointApiUsageReportMetric
---

# Update-MgBetaAdminReportSettingSharePointApiUsageReportMetric
...
```
Update-MgBetaAdminReportSettingSharePointApiUsageReportMetric
 -ApiUsageReportEnablementStatusMetric <string> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaAdminReportSettingSharePointApiUsageReportMetric
 -ApiUsageReportEnablementStatusMetric <string>
...
```
Update-MgBetaAdminReportSettingSharePointApiUsageReportMetric -InputObject <IReportsIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-Metric <string>]
 [-OnboardingStatus <string>] [-Break] [-Headers <IDictionary>]
...
### -ApiUsageReportEnablementStatusMetric

The unique identifier of apiUsageReportEnablementStatus
