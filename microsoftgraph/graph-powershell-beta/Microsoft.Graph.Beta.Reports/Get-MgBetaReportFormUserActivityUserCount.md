...
### Get (Default)
```
Get-MgBetaReportFormUserActivityUserCount -Period <String> -OutFile <String> [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportFormUserActivityUserCount -InputObject <IReportsIdentity> -OutFile <String>
