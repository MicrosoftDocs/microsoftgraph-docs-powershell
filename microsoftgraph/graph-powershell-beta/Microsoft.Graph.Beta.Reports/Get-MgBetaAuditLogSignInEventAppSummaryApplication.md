...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetaauditlogsignineventappsummaryapplication
Locale: en-US
Module Name: Microsoft.Graph.Beta.Reports
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaAuditLogSignInEventAppSummaryApplication
---

# Get-MgBetaAuditLogSignInEventAppSummaryApplication
...
```
Get-MgBetaAuditLogSignInEventAppSummaryApplication -SignInEventsAppActivityAppId <string>
...
```
Get-MgBetaAuditLogSignInEventAppSummaryApplication -InputObject <IReportsIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
...
- [Get-MgBetaAuditLogSignInEventAppSummaryApplication](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetaauditlogsignineventappsummaryapplication)
