...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/update-mgbetareportpartnerbillingreconciliation
Locale: en-US
Module Name: Microsoft.Graph.Beta.Reports
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaReportPartnerBillingReconciliation
---
...
Update-MgBetaReportPartnerBillingReconciliation [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Billed <hashtable>] [-Id <string>] [-Unbilled <hashtable>]
...
```
Update-MgBetaReportPartnerBillingReconciliation
 -BodyParameter <IMicrosoftGraphPartnersBillingReconciliation> [-ResponseHeadersVariable <string>]
 [-Break] [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
- [Update-MgBetaReportPartnerBillingReconciliation](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/update-mgbetareportpartnerbillingreconciliation)
