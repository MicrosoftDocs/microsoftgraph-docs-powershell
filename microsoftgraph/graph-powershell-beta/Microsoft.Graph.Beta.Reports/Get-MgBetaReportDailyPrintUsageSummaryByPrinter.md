...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportdailyprintusagesummarybyprinter
Locale: en-US
Module Name: Microsoft.Graph.Beta.Reports
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaReportDailyPrintUsageSummaryByPrinter
---
...
```
Get-MgBetaReportDailyPrintUsageSummaryByPrinter [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaReportDailyPrintUsageSummaryByPrinter -PrintUsageByPrinterId <string>
...
```
Get-MgBetaReportDailyPrintUsageSummaryByPrinter -InputObject <IReportsIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
...
- [Get-MgBetaReportDailyPrintUsageSummaryByPrinter](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportdailyprintusagesummarybyprinter)
