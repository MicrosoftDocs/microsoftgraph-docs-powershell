...
```
Get-MgBetaReportPartner [-ExpandProperty <String[]>] [-Property <String[]>] [-ResponseHeadersVariable <String>]
...
## RELATED LINKS
[Get-MgReportPartner](/powershell/module/Microsoft.Graph.Reports/Get-MgReportPartner?view=graph-powershell-1.0)
