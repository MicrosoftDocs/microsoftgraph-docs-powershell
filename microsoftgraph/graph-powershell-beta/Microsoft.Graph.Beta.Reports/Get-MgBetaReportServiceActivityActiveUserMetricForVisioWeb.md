...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportserviceactivityactiveusermetricforvisioweb
schema: 2.0.0
...
### Get (Default)
```
Get-MgBetaReportServiceActivityActiveUserMetricForVisioWeb -ExclusiveIntervalEndDateTime <DateTime>
...
### GetViaIdentity
```
Get-MgBetaReportServiceActivityActiveUserMetricForVisioWeb -InputObject <IReportsIdentity>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportserviceactivityactiveusermetricforvisioweb](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportserviceactivityactiveusermetricforvisioweb)

[https://learn.microsoft.com/graph/api/serviceactivity-getactiveusermetricsforvisioweb?view=graph-rest-beta](https://learn.microsoft.com/graph/api/serviceactivity-getactiveusermetricsforvisioweb?view=graph-rest-beta)
