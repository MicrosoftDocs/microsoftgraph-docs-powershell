...
### Get (Default)
```
Get-MgBetaReportYammerActivityCount -Period <String> -OutFile <String> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportYammerActivityCount -InputObject <IReportsIdentity> -OutFile <String> [-Headers <IDictionary>]
...
## RELATED LINKS
[Get-MgReportYammerActivityCount](/powershell/module/Microsoft.Graph.Reports/Get-MgReportYammerActivityCount?view=graph-powershell-1.0)

[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportyammeractivitycount](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportyammeractivitycount)
