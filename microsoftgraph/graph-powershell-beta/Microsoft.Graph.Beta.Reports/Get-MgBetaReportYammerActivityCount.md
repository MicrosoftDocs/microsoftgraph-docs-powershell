...
### Get (Default)
```
Get-MgBetaReportYammerActivityCount -Period <String> -OutFile <String> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportYammerActivityCount -InputObject <IReportsIdentity> -OutFile <String>
