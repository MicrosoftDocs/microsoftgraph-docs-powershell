...
```
Get-MgBetaReportIdentityAnalyticGroup [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaReportIdentityAnalyticGroup -GroupAnalyticsId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaReportIdentityAnalyticGroup -InputObject <IReportsIdentity> [-ExpandProperty <string[]>]
 [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
```
