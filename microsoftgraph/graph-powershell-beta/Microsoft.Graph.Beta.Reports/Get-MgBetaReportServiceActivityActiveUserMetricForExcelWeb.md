...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportserviceactivityactiveusermetricforexcelweb
schema: 2.0.0
...
### Get (Default)
```
Get-MgBetaReportServiceActivityActiveUserMetricForExcelWeb -ExclusiveIntervalEndDateTime <DateTime>
...
### GetViaIdentity
```
Get-MgBetaReportServiceActivityActiveUserMetricForExcelWeb -InputObject <IReportsIdentity>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportserviceactivityactiveusermetricforexcelweb](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportserviceactivityactiveusermetricforexcelweb)

[https://learn.microsoft.com/graph/api/serviceactivity-getactiveusermetricsforexcelweb?view=graph-rest-beta](https://learn.microsoft.com/graph/api/serviceactivity-getactiveusermetricsforexcelweb?view=graph-rest-beta)
