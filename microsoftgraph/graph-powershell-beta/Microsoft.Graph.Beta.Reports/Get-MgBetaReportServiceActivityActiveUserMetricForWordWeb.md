...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportserviceactivityactiveusermetricforwordweb
schema: 2.0.0
...
### Get (Default)
```
Get-MgBetaReportServiceActivityActiveUserMetricForWordWeb -ExclusiveIntervalEndDateTime <DateTime>
...
### GetViaIdentity
```
Get-MgBetaReportServiceActivityActiveUserMetricForWordWeb -InputObject <IReportsIdentity>
...
```
This example shows how to use the Get-MgBetaReportServiceActivityActiveUserMetricForWordWeb Cmdlet.
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportserviceactivityactiveusermetricforwordweb](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportserviceactivityactiveusermetricforwordweb)

[https://learn.microsoft.com/graph/api/serviceactivity-getactiveusermetricsforwordweb?view=graph-rest-beta](https://learn.microsoft.com/graph/api/serviceactivity-getactiveusermetricsforwordweb?view=graph-rest-beta)
