...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportdailyprintusagebyprinter
Locale: en-US
Module Name: Microsoft.Graph.Beta.Reports
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Get-MgBetaReportDailyPrintUsageByPrinter
---
...
```
Get-MgBetaReportDailyPrintUsageByPrinter [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaReportDailyPrintUsageByPrinter -PrintUsageByPrinterId <string>
...
```
Get-MgBetaReportDailyPrintUsageByPrinter -InputObject <IReportsIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [<CommonParameters>]
