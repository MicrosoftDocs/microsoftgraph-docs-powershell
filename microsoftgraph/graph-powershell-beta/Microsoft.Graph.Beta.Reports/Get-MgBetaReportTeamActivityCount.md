...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportteamactivitycount
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgReportTeamActivityCount](/powershell/module/Microsoft.Graph.Reports/Get-MgReportTeamActivityCount?view=graph-powershell-1.0)

## SYNTAX

### Get (Default)
```
Get-MgBetaReportTeamActivityCount -Period <String> -OutFile <String> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportTeamActivityCount -InputObject <IReportsIdentity> -OutFile <String> [-Headers <IDictionary>]
...
## RELATED LINKS
[Get-MgReportTeamActivityCount](/powershell/module/Microsoft.Graph.Reports/Get-MgReportTeamActivityCount?view=graph-powershell-1.0)
