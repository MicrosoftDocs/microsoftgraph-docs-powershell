...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetaauditlogsignineventappsummary
Locale: en-US
Module Name: Microsoft.Graph.Beta.Reports
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaAuditLogSignInEventAppSummary
---

# Get-MgBetaAuditLogSignInEventAppSummary
...
```
Get-MgBetaAuditLogSignInEventAppSummary [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaAuditLogSignInEventAppSummary -SignInEventsAppActivityAppId <string>
...
```
Get-MgBetaAuditLogSignInEventAppSummary -InputObject <IReportsIdentity> [-ExpandProperty <string[]>]
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphSignInEventsAppActivity
...
- [Get-MgBetaAuditLogSignInEventAppSummary](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetaauditlogsignineventappsummary)
- [Graph API Reference](https://learn.microsoft.com/graph/api/auditlogroot-list-signineventsappsummary?view=graph-rest-beta)
