...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportuserinsightdailyauthentication
Locale: en-US
Module Name: Microsoft.Graph.Beta.Reports
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaReportUserInsightDailyAuthentication
---
...
```
Get-MgBetaReportUserInsightDailyAuthentication [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaReportUserInsightDailyAuthentication -AuthenticationsMetricId <string>
...
```
Get-MgBetaReportUserInsightDailyAuthentication -InputObject <IReportsIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
...
- [Get-MgBetaReportUserInsightDailyAuthentication](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportuserinsightdailyauthentication)
- [Graph API Reference](https://learn.microsoft.com/graph/api/dailyuserinsightmetricsroot-list-authentications?view=graph-rest-beta)
