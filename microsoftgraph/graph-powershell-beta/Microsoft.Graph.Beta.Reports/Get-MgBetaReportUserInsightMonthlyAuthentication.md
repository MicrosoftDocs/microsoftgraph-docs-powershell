...
### Get
```
Get-MgBetaReportUserInsightMonthlyAuthentication -AuthenticationsMetricId <String> [-ExpandProperty <String[]>]
...
[https://learn.microsoft.com/graph/api/monthlyuserinsightmetricsroot-list-authentications?view=graph-rest-beta](https://learn.microsoft.com/graph/api/monthlyuserinsightmetricsroot-list-authentications?view=graph-rest-beta)
