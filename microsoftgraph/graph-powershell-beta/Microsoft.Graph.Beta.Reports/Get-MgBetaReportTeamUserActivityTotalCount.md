...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportteamuseractivitytotalcount
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaReportTeamUserActivityTotalCount -Period <String> -OutFile <String> [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportTeamUserActivityTotalCount -InputObject <IReportsIdentity> -OutFile <String>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportteamuseractivitytotalcount](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportteamuseractivitytotalcount)
