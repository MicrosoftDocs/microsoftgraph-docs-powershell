...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportmicrosoft365copilotusercounttrend
schema: 2.0.0
...
### Get (Default)
```
Get-MgBetaReportMicrosoft365CopilotUserCountTrend -Period <String> -OutFile <String>
...
### GetViaIdentity
```
Get-MgBetaReportMicrosoft365CopilotUserCountTrend -InputObject <IReportsIdentity> -OutFile <String>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
