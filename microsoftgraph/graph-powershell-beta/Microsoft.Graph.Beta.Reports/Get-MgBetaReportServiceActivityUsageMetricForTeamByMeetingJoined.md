...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportserviceactivityusagemetricforteambymeetingjoined
schema: 2.0.0
...
### Get (Default)
```
Get-MgBetaReportServiceActivityUsageMetricForTeamByMeetingJoined -ExclusiveIntervalEndDateTime <DateTime>
...
### GetViaIdentity
```
Get-MgBetaReportServiceActivityUsageMetricForTeamByMeetingJoined -InputObject <IReportsIdentity>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportserviceactivityusagemetricforteambymeetingjoined](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportserviceactivityusagemetricforteambymeetingjoined)

[https://learn.microsoft.com/graph/api/serviceactivity-getusagemetricsforteamsbymeetingsjoined?view=graph-rest-beta](https://learn.microsoft.com/graph/api/serviceactivity-getusagemetricsforteamsbymeetingsjoined?view=graph-rest-beta)
