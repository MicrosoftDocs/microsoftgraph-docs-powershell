...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetaauditlogsignineventappsummaryapplicationlogo
Locale: en-US
Module Name: Microsoft.Graph.Beta.Reports
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaAuditLogSignInEventAppSummaryApplicationLogo
---

# Get-MgBetaAuditLogSignInEventAppSummaryApplicationLogo
...
```
Get-MgBetaAuditLogSignInEventAppSummaryApplicationLogo -SignInEventsAppActivityAppId <string>
...
```
Get-MgBetaAuditLogSignInEventAppSummaryApplicationLogo -InputObject <IReportsIdentity>
 -OutFile <string> [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru]
 [-Proxy <uri>] [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
```
...
- [Get-MgBetaAuditLogSignInEventAppSummaryApplicationLogo](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetaauditlogsignineventappsummaryapplicationlogo)
