...
### Get (Default)
```
Get-MgBetaReportTeamCount -Period <String> -OutFile <String> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportTeamCount -InputObject <IReportsIdentity> -OutFile <String> [-Headers <IDictionary>]
