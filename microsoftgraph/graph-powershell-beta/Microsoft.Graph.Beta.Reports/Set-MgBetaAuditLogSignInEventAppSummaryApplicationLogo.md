...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/set-mgbetaauditlogsignineventappsummaryapplicationlogo
Locale: en-US
Module Name: Microsoft.Graph.Beta.Reports
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Set-MgBetaAuditLogSignInEventAppSummaryApplicationLogo
---

# Set-MgBetaAuditLogSignInEventAppSummaryApplicationLogo
...
```
Set-MgBetaAuditLogSignInEventAppSummaryApplicationLogo -SignInEventsAppActivityAppId <string>
...
```
Set-MgBetaAuditLogSignInEventAppSummaryApplicationLogo -InputObject <IReportsIdentity>
 -InFile <string> [-Data <Stream>] [-ResponseHeadersVariable <string>] [-Break]
 [-ContentType <string>] [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
