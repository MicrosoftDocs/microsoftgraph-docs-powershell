...
### Get (Default)
```
Get-MgBetaReportOneDriveUsageStorage -Period <String> -OutFile <String> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportOneDriveUsageStorage -InputObject <IReportsIdentity> -OutFile <String> [-Headers <IDictionary>]
