...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportskypeforbusinessparticipantactivityusercount
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgReportSkypeForBusinessParticipantActivityUserCount](/powershell/module/Microsoft.Graph.Reports/Get-MgReportSkypeForBusinessParticipantActivityUserCount?view=graph-powershell-1.0)

## SYNTAX

### Get (Default)
```
Get-MgBetaReportSkypeForBusinessParticipantActivityUserCount -Period <String> -OutFile <String> [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportSkypeForBusinessParticipantActivityUserCount -InputObject <IReportsIdentity> -OutFile <String>
...
## RELATED LINKS
[Get-MgReportSkypeForBusinessParticipantActivityUserCount](/powershell/module/Microsoft.Graph.Reports/Get-MgReportSkypeForBusinessParticipantActivityUserCount?view=graph-powershell-1.0)

[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportskypeforbusinessparticipantactivityusercount](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportskypeforbusinessparticipantactivityusercount)
