...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetaauditlogsignineventsummary
Locale: en-US
Module Name: Microsoft.Graph.Beta.Reports
ms.date: 09/22/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaAuditLogSignInEventSummary
---

# Get-MgBetaAuditLogSignInEventSummary
...
```
Get-MgBetaAuditLogSignInEventSummary [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaAuditLogSignInEventSummary -SignInEventsActivityId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaAuditLogSignInEventSummary -InputObject <IReportsIdentity> [-ExpandProperty <string[]>]
 [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
```
...
### -SignInEventsActivityId

The unique identifier of signInEventsActivity
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphSignInEventsActivity
...
- [Get-MgBetaAuditLogSignInEventSummary](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetaauditlogsignineventsummary)
- [Graph API Reference](https://learn.microsoft.com/graph/api/auditlogroot-list-signineventssummary?view=graph-rest-beta)
