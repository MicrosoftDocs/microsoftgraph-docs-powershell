...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgReportEmailAppUsageUserDetail](/powershell/module/Microsoft.Graph.Reports/Get-MgReportEmailAppUsageUserDetail?view=graph-powershell-1.0)

## SYNTAX

### Get (Default)
```
Get-MgBetaReportEmailAppUsageUserDetail -Date <DateTime> -OutFile <String> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Get1
```
Get-MgBetaReportEmailAppUsageUserDetail -Period <String> -OutFile <String> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgBetaReportEmailAppUsageUserDetail -InputObject <IReportsIdentity> -OutFile <String>
...
## RELATED LINKS
[Get-MgReportEmailAppUsageUserDetail](/powershell/module/Microsoft.Graph.Reports/Get-MgReportEmailAppUsageUserDetail?view=graph-powershell-1.0)

[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportemailappusageuserdetail](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportemailappusageuserdetail)
