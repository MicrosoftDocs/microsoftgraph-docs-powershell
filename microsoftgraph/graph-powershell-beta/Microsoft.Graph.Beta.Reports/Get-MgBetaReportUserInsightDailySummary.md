...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportuserinsightdailysummary
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaReportUserInsightDailySummary [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
### Get
```
Get-MgBetaReportUserInsightDailySummary -InsightSummaryId <String> [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgBetaReportUserInsightDailySummary -InputObject <IReportsIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
### -InsightSummaryId
The unique identifier of insightSummary
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportuserinsightdailysummary](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportuserinsightdailysummary)
