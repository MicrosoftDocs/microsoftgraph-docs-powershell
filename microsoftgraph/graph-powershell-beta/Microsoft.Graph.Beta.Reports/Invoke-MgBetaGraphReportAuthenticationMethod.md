...
### Graph (Default)
```
Invoke-MgBetaGraphReportAuthenticationMethod [-Headers <IDictionary>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
### GraphViaIdentity1
```
Invoke-MgBetaGraphReportAuthenticationMethod -InputObject <IReportsIdentity> [-Headers <IDictionary>]
