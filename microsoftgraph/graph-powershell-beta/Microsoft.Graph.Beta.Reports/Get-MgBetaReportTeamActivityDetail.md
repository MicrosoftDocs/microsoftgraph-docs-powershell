...
### Get (Default)
```
Get-MgBetaReportTeamActivityDetail -Date <DateTime> -OutFile <String> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Get1
```
Get-MgBetaReportTeamActivityDetail -Period <String> -OutFile <String> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgBetaReportTeamActivityDetail -InputObject <IReportsIdentity> -OutFile <String> [-Headers <IDictionary>]
