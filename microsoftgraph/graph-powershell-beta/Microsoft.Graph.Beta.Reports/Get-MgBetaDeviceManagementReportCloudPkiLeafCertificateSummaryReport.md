...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths6Kr53MDevicemanagementReportsMicrosoftGraphRetrievecloudpkileafcertificatesummaryreportPostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
