...
### Get (Default)
```
Get-MgBetaReportMailboxUsageDetail -Period <String> -OutFile <String> [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaReportMailboxUsageDetail -InputObject <IReportsIdentity> -OutFile <String> [-Headers <IDictionary>]
...
## RELATED LINKS
[Get-MgReportMailboxUsageDetail](/powershell/module/Microsoft.Graph.Reports/Get-MgReportMailboxUsageDetail?view=graph-powershell-1.0)
