...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/remove-mgbetareportpartnerbillingmanifest
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Remove-MgReportPartnerBillingManifest](/powershell/module/Microsoft.Graph.Reports/Remove-MgReportPartnerBillingManifest?view=graph-powershell-1.0)

## SYNTAX

### Delete (Default)
```
Remove-MgBetaReportPartnerBillingManifest -ManifestId <String> [-IfMatch <String>] [-Headers <IDictionary>]
 [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaReportPartnerBillingManifest -InputObject <IReportsIdentity> [-IfMatch <String>]
...
## RELATED LINKS
[Remove-MgReportPartnerBillingManifest](/powershell/module/Microsoft.Graph.Reports/Remove-MgReportPartnerBillingManifest?view=graph-powershell-1.0)

[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/remove-mgbetareportpartnerbillingmanifest](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/remove-mgbetareportpartnerbillingmanifest)
