...
# Invoke-MgBetaSignReportAuthenticationMethod
...
```
Invoke-MgBetaSignReportAuthenticationMethod -Period <string> [-Count] [-ExpandProperty <string[]>]
...
```
Invoke-MgBetaSignReportAuthenticationMethod -InputObject <IReportsIdentity> [-Count]
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphUserSignInUsageByAuthMethodActivity
