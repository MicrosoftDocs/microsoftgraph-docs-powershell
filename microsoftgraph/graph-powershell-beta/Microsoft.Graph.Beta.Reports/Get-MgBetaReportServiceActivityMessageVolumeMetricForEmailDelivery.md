...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportserviceactivitymessagevolumemetricforemaildelivery
schema: 2.0.0
...
## SYNOPSIS
Get the number of messages successfully delivered by Exchange.
...
### Get (Default)
```
Get-MgBetaReportServiceActivityMessageVolumeMetricForEmailDelivery -ExclusiveIntervalEndDateTime <DateTime>
...
### GetViaIdentity
```
Get-MgBetaReportServiceActivityMessageVolumeMetricForEmailDelivery -InputObject <IReportsIdentity>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportserviceactivitymessagevolumemetricforemaildelivery](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportserviceactivitymessagevolumemetricforemaildelivery)

[https://learn.microsoft.com/graph/api/serviceactivity-getmessagevolumemetricsforemaildelivery?view=graph-rest-beta](https://learn.microsoft.com/graph/api/serviceactivity-getmessagevolumemetricsforemaildelivery?view=graph-rest-beta)
