...
### List (Default)
```
Get-MgBetaReportUserInsightDailyActiveUser [-ExpandProperty <String[]>] [-Property <String[]>]
...
### Get
```
Get-MgBetaReportUserInsightDailyActiveUser -ActiveUsersMetricId <String> [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgBetaReportUserInsightDailyActiveUser -InputObject <IReportsIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportuserinsightdailyactiveuser](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportuserinsightdailyactiveuser)

[https://learn.microsoft.com/graph/api/dailyuserinsightmetricsroot-list-activeusers?view=graph-rest-beta](https://learn.microsoft.com/graph/api/dailyuserinsightmetricsroot-list-activeusers?view=graph-rest-beta)
