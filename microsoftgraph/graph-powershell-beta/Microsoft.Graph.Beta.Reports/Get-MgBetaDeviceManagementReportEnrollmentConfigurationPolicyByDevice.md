...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetadevicemanagementreportenrollmentconfigurationpolicybydevice
schema: 2.0.0
---
...
Get-MgBetaDeviceManagementReportEnrollmentConfigurationPolicyByDevice -OutFile <String>
 ...
 [-GroupBy <String[]>] [-Name <String>] [-Property <String[]>] [-Search <String>] [-Skip <Int32>]
...
```yaml
Type: IPathsD7TdnyDevicemanagementReportsMicrosoftGraphGetenrollmentconfigurationpoliciesbydevicePostRequestbodyContentApplicationJsonSchema
Parameter Sets: Get
Aliases:
