...
### List (Default)
```
Get-MgDeviceManagementReportCachedReportConfiguration [-ExpandProperty <String[]>] [-Property <String[]>]
...
The unique identifier of deviceManagementCachedReportConfiguration
