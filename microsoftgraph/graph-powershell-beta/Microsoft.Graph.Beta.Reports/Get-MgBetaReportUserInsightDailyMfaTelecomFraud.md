...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportuserinsightdailymfatelecomfraud
schema: 2.0.0
---
...
### Get
```
Get-MgBetaReportUserInsightDailyMfaTelecomFraud -MfaTelecomFraudMetricId <String> [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgBetaReportUserInsightDailyMfaTelecomFraud -InputObject <IReportsIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
