...
### List (Default)
```
Get-MgBetaReportUserCredentialUsageDetail [-ExpandProperty <String[]>] [-Property <String[]>]
...
### Get
```
Get-MgBetaReportUserCredentialUsageDetail -UserCredentialUsageDetailsId <String> [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgBetaReportUserCredentialUsageDetail -InputObject <IReportsIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
The unique identifier of userCredentialUsageDetails
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphUserCredentialUsageDetails
## NOTES
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportusercredentialusagedetail](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportusercredentialusagedetail)

[https://learn.microsoft.com/graph/api/reportroot-list-usercredentialusagedetails?view=graph-rest-beta](https://learn.microsoft.com/graph/api/reportroot-list-usercredentialusagedetails?view=graph-rest-beta)
