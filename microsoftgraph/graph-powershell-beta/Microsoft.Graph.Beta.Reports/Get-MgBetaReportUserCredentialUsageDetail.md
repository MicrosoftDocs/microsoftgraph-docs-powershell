...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportusercredentialusagedetail
Locale: en-US
Module Name: Microsoft.Graph.Beta.Reports
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaReportUserCredentialUsageDetail
---
...
```
Get-MgBetaReportUserCredentialUsageDetail -UserCredentialUsageDetailsId <string>
...
```
Get-MgBetaReportUserCredentialUsageDetail -InputObject <IReportsIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
...
- [Get-MgBetaReportUserCredentialUsageDetail](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.reports/get-mgbetareportusercredentialusagedetail)
- [Graph API Reference](https://learn.microsoft.com/graph/api/reportroot-list-usercredentialusagedetails?view=graph-rest-beta)
