...
### Get (Default)
```
Get-MgBetaOrganizationSettingPronoun -OrganizationId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaOrganizationSettingPronoun -InputObject <IIdentityDirectoryManagementIdentity>
