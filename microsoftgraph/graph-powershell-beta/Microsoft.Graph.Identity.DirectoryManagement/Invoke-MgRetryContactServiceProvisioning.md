...
### Retry (Default)
```
Invoke-MgBetaRetryContactServiceProvisioning -OrgContactId <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### RetryViaIdentity
```
Invoke-MgBetaRetryContactServiceProvisioning -InputObject <IIdentityDirectoryManagementIdentity> [-PassThru]
