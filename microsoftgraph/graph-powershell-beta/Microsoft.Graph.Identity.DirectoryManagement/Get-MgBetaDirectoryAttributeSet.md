...
### List (Default)
```
Get-MgBetaDirectoryAttributeSet [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgBetaDirectoryAttributeSet -InputObject <IIdentityDirectoryManagementIdentity>
