...
### List (Default)
```
Get-MgDirectorySettingTemplate [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgDirectorySettingTemplate -InputObject <IIdentityDirectoryManagementIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
