...
### List (Default)
```
Get-MgBetaContract [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>] [-Search <String>]
...
### Get
```
Get-MgBetaContract -ContractId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
