...
### List (Default)
```
Get-MgBetaDeviceTransitiveMemberOfAsGroup -DeviceId <String> [-ExpandProperty <String[]>]
...
### Get
```
Get-MgBetaDeviceTransitiveMemberOfAsGroup -DeviceId <String> -DirectoryObjectId <String>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-ConsistencyLevel <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaDeviceTransitiveMemberOfAsGroup -InputObject <IIdentityDirectoryManagementIdentity>
 [-ExpandProperty <String[]>] [-Property <String[]>] [-ConsistencyLevel <String>] [<CommonParameters>]
```
