...
### Get1 (Default)
```
Get-MgContactManagerByRef -OrgContactId <String> [<CommonParameters>]
```

### GetViaIdentity1
```
Get-MgContactManagerByRef -InputObject <IIdentityDirectoryManagementIdentity> [<CommonParameters>]
```
