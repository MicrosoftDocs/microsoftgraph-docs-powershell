...
### Set (Default)
```
Set-MgBetaOrganizationBrandingLocalizationCustomCss -OrganizationId <String>
...
### SetViaIdentity
```
Set-MgBetaOrganizationBrandingLocalizationCustomCss -InputObject <IIdentityDirectoryManagementIdentity>
