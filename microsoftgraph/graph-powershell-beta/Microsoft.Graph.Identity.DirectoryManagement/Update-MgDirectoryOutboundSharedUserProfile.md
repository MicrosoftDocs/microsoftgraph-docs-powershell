...
Update-MgDirectoryOutboundSharedUserProfile -OutboundSharedUserProfileUserId <String>
 ...
 [-Tenants <IMicrosoftGraphTenantReference[]>] [-UserId <String>] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```
Update-MgDirectoryOutboundSharedUserProfile -OutboundSharedUserProfileUserId <String>
 -BodyParameter <IMicrosoftGraphOutboundSharedUserProfile> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.directorymanagement/update-mgdirectoryoutboundshareduserprofile](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.identity.directorymanagement/update-mgdirectoryoutboundshareduserprofile)
