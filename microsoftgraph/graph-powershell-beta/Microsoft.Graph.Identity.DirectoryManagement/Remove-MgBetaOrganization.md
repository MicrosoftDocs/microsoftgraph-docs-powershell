...
### Delete (Default)
```
Remove-MgBetaOrganization -OrganizationId <String> [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaOrganization -InputObject <IIdentityDirectoryManagementIdentity> [-IfMatch <String>] [-PassThru]
