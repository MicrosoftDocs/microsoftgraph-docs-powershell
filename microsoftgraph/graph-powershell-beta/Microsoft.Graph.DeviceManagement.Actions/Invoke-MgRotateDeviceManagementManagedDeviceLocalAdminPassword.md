...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.actions/invoke-mgrotatedevicemanagementmanageddevicelocaladminpassword
schema: 2.0.0
---
...
### Rotate (Default)
```
Invoke-MgRotateDeviceManagementManagedDeviceLocalAdminPassword -ManagedDeviceId <String> [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### RotateViaIdentity
```
Invoke-MgRotateDeviceManagementManagedDeviceLocalAdminPassword -InputObject <IDeviceManagementActionsIdentity>
