...
```yaml
Type: IPaths5Yguq9DevicemanagementDevicemanagementscriptsDevicemanagementscriptIdDevicerunstatesDevicemanagementscriptdevicestateIdManageddeviceMicrosoftGraphCleanwindowsdevicePostRequestbodyContentApplicationJsonSchema
