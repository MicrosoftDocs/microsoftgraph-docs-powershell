...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/invoke-mgbetadowndevicemanagementcomanageddeviceshut
schema: 2.0.0
---
...
### Down (Default)
```
Invoke-MgBetaDownDeviceManagementComanagedDeviceShut -ManagedDeviceId <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### DownViaIdentity
```
Invoke-MgBetaDownDeviceManagementComanagedDeviceShut -InputObject <IDeviceManagementActionsIdentity>
