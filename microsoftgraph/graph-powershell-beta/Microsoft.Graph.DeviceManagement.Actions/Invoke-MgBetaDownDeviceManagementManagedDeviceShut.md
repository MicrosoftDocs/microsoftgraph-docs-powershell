...
### Down (Default)
```
Invoke-MgBetaDownDeviceManagementManagedDeviceShut -ManagedDeviceId <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### DownViaIdentity
```
Invoke-MgBetaDownDeviceManagementManagedDeviceShut -InputObject <IDeviceManagementActionsIdentity> [-PassThru]
