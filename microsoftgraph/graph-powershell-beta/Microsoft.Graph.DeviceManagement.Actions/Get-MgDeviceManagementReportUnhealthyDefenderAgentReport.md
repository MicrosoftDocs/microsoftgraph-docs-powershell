...
### Get
```
Get-MgDeviceManagementReportUnhealthyDefenderAgentReport -OutFile <String>
...
```yaml
Type: IPathsIdq7HwDevicemanagementReportsMicrosoftGraphGetunhealthydefenderagentsreportPostRequestbodyContentApplicationJsonSchema
Parameter Sets: Get
Aliases:
