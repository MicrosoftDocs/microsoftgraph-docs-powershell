...
```yaml
Type: IPaths1Wwpo8IDevicemanagementDeviceshellscriptsDeviceshellscriptIdDevicerunstatesDevicemanagementscriptdevicestateIdManageddeviceMicrosoftGraphRestorecloudpcPostRequestbodyContentApplicationJsonSchema
