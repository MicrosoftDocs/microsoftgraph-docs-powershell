...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/get-mgbetadevicemanagementreportzebrafotadeploymentreport
schema: 2.0.0
---
...
### GetExpanded (Default)
```
Get-MgBetaDeviceManagementReportZebraFotaDeploymentReport -OutFile <String> [-AdditionalProperties <Hashtable>]
