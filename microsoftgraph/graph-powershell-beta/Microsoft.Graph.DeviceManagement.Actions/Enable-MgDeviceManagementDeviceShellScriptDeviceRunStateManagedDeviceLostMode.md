...
```yaml
Type: IPaths6Aetd5DevicemanagementDeviceshellscriptsDeviceshellscriptIdDevicerunstatesDevicemanagementscriptdevicestateIdManageddeviceMicrosoftGraphEnablelostmodePostRequestbodyContentApplicationJsonSchema
