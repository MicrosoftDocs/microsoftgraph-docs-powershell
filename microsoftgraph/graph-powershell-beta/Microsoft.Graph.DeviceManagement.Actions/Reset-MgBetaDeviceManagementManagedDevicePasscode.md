...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.devicemanagement.actions/reset-mgbetadevicemanagementmanageddevicepasscode
schema: 2.0.0
---
...
### Reset (Default)
```
Reset-MgBetaDeviceManagementManagedDevicePasscode -ManagedDeviceId <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### ResetViaIdentity
```
Reset-MgBetaDeviceManagementManagedDevicePasscode -InputObject <IDeviceManagementActionsIdentity> [-PassThru]
