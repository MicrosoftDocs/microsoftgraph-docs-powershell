...
### Locate (Default)
```
Find-MgDeviceManagementComanagedDevice -ManagedDeviceId <String> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### LocateViaIdentity
```
Find-MgDeviceManagementComanagedDevice -InputObject <IDeviceManagementActionsIdentity> [-PassThru] [-WhatIf]
