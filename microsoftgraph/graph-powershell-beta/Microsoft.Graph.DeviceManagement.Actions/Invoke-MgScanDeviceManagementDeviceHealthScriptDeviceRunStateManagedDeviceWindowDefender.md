...
Invoke-MgScanDeviceManagementDeviceHealthScriptDeviceRunStateManagedDeviceWindowDefender
 ...
 [-QuickScan] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```yaml
Type: IPaths1KdwzpoDevicemanagementDevicehealthscriptsDevicehealthscriptIdDevicerunstatesDevicehealthscriptdevicestateIdManageddeviceMicrosoftGraphWindowsdefenderscanPostRequestbodyContentApplicationJsonSchema
