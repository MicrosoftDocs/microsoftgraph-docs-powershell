...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.actions/get-mgdevicemanagementreportdeviceinstallstatusreport
schema: 2.0.0
---
...
### GetExpanded (Default)
```
Get-MgDeviceManagementReportDeviceInstallStatusReport -OutFile <String> [-AdditionalProperties <Hashtable>]
...
### Get
```
Get-MgDeviceManagementReportDeviceInstallStatusReport -OutFile <String>
