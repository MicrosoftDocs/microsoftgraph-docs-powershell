...
### Get
```
Get-MgDeviceManagementReportFailedMobileAppSummaryReport -OutFile <String>
...
```yaml
Type: IPathsLsdaarDevicemanagementReportsMicrosoftGraphGetfailedmobileappssummaryreportPostRequestbodyContentApplicationJsonSchema
Parameter Sets: Get
Aliases:
