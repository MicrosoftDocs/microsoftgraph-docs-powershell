...
### Get
```
Get-MgDeviceManagementReportUnhealthyFirewallReport -OutFile <String>
...
```yaml
Type: IPaths4Dr5S6DevicemanagementReportsMicrosoftGraphGetunhealthyfirewallreportPostRequestbodyContentApplicationJsonSchema
Parameter Sets: Get
Aliases:
