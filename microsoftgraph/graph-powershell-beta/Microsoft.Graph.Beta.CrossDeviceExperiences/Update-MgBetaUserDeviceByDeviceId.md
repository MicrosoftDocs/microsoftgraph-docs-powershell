...
```
Update-MgBetaUserDeviceByDeviceId -DeviceId <String> -UserId <String> [-ResponseHeadersVariable <String>]
...
```
Update-MgBetaUserDeviceByDeviceId [-DeviceId <String>] -InputObject <ICrossDeviceExperiencesIdentity>
