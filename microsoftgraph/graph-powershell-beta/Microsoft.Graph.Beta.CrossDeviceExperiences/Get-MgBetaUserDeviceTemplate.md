...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.crossdeviceexperiences/get-mgbetauserdevicetemplate
Locale: en-US
Module Name: Microsoft.Graph.Beta.CrossDeviceExperiences
ms.date: 08/12/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaUserDeviceTemplate
---
...
```
Get-MgBetaUserDeviceTemplate -InputObject <ICrossDeviceExperiencesIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
...
- [Get-MgBetaUserDeviceTemplate](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.crossdeviceexperiences/get-mgbetauserdevicetemplate)
