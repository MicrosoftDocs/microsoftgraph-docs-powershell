...
### Delete (Default)
```
Remove-MgBetaUserDeviceRegisteredOwnerByRef -DeviceId <String> -DirectoryObjectId <String>
...
### DeleteViaIdentity
```
Remove-MgBetaUserDeviceRegisteredOwnerByRef -InputObject <ICrossDeviceExperiencesIdentity>
