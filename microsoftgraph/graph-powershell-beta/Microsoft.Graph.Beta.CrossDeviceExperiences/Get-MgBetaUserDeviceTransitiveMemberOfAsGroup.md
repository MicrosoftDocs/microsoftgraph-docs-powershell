...
```
Get-MgBetaUserDeviceTransitiveMemberOfAsGroup -DeviceId <string> -UserId <string>
...
```
Get-MgBetaUserDeviceTransitiveMemberOfAsGroup -DeviceId <string> -DirectoryObjectId <string>
