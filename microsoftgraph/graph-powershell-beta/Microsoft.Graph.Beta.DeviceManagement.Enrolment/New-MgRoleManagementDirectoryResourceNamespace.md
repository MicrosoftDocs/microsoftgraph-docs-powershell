...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/new-mgrolemanagementdirectoryresourcenamespace
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgRoleManagementDirectoryResourceNamespace](/powershell/module/Microsoft.Graph.DeviceManagement.Enrolment/New-MgRoleManagementDirectoryResourceNamespace?view=graph-powershell-v1.0)

## SYNTAX

### CreateExpanded (Default)
```
New-MgRoleManagementDirectoryResourceNamespace [-AdditionalProperties <Hashtable>] [-Id <String>]
...
### Create
```
New-MgRoleManagementDirectoryResourceNamespace -BodyParameter <IMicrosoftGraphUnifiedRbacResourceNamespace1>
...
## RELATED LINKS
[New-MgRoleManagementDirectoryResourceNamespace](/powershell/module/Microsoft.Graph.DeviceManagement.Enrolment/New-MgRoleManagementDirectoryResourceNamespace?view=graph-powershell-v1.0)
