...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgRoleManagementEntitlementManagementRoleAssignmentScheduleInstance](/powershell/module/Microsoft.Graph.DeviceManagement.Enrolment/New-MgRoleManagementEntitlementManagementRoleAssignmentScheduleInstance?view=graph-powershell-v1.0)
...
```
New-MgRoleManagementEntitlementManagementRoleAssignmentScheduleInstance
 -BodyParameter <IMicrosoftGraphUnifiedRoleAssignmentScheduleInstance1> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
