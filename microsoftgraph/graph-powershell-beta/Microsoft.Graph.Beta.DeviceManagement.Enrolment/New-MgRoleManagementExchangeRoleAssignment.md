...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/new-mgrolemanagementexchangeroleassignment
schema: 2.0.0
---

# New-MgRoleManagementExchangeRoleAssignment
...
```
New-MgRoleManagementExchangeRoleAssignment [-AdditionalProperties <Hashtable>]
...
### Create
```
New-MgRoleManagementExchangeRoleAssignment -BodyParameter <IMicrosoftGraphUnifiedRoleAssignment1> [-WhatIf]
