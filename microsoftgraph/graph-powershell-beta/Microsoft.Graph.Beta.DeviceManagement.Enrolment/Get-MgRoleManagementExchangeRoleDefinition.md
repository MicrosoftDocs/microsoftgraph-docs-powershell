...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.devicemanagement.enrolment/get-mgrolemanagementexchangeroledefinition
schema: 2.0.0
---
...
### List (Default)
```
Get-MgRoleManagementExchangeRoleDefinition [-ExpandProperty <String[]>] [-Property <String[]>]
...
### Get
```
Get-MgRoleManagementExchangeRoleDefinition -UnifiedRoleDefinitionId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgRoleManagementExchangeRoleDefinition -InputObject <IDeviceManagementEnrolmentIdentity>
