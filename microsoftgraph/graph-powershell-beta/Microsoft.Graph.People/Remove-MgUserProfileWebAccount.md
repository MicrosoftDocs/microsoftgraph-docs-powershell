...
### Delete (Default)
```
Remove-MgBetaUserProfileWebAccount -UserId <String> -WebAccountId <String> [-IfMatch <String>] [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaUserProfileWebAccount -InputObject <IPeopleIdentity> [-IfMatch <String>] [-PassThru] [-WhatIf]
