...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/add-mgbetagroupsitecontenttypecopy
schema: 2.0.0
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Add-MgGroupSiteContentTypeCopy](/powershell/module/Microsoft.Graph.Sites/Add-MgGroupSiteContentTypeCopy?view=graph-powershell-1.0)
...
```
Add-MgBetaGroupSiteContentTypeCopy -InputObject <ISitesIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-ContentType <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### AddViaIdentity
```
Add-MgBetaGroupSiteContentTypeCopy -InputObject <ISitesIdentity>
 -BodyParameter <IPathsVrsotcGroupsGroupIdSitesSiteIdContenttypesMicrosoftGraphAddcopyPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/add-mgbetagroupsitecontenttypecopy](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/add-mgbetagroupsitecontenttypecopy)
