...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/get-mgbetasitepageassitepage
Locale: en-US
Module Name: Microsoft.Graph.Beta.Sites
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaSitePageAsSitePage
---
...
```
Get-MgBetaSitePageAsSitePage -SiteId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaSitePageAsSitePage -InputObject <ISitesIdentity> [-ExpandProperty <string[]>]
 [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
```
...
- [Get-MgBetaSitePageAsSitePage](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/get-mgbetasitepageassitepage)
- [Graph API Reference](https://learn.microsoft.com/graph/api/sitepage-get?view=graph-rest-beta)
