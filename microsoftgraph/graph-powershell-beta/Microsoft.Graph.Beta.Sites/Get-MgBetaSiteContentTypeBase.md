...
### Get (Default)
```
Get-MgBetaSiteContentTypeBase -ContentTypeId <String> [-SiteId <String>] [-ExpandProperty <String[]>]
...
### Get1
```
Get-MgBetaSiteContentTypeBase -ContentTypeId <String> [-SiteId <String>] -ListId <String>
