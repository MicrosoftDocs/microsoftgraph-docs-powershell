...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetasitetermstoresetterm
Locale: en-US
Module Name: Microsoft.Graph.Beta.Sites
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaSiteTermStoreSetTerm
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgSiteTermStoreSetTerm](/powershell/module/Microsoft.Graph.Sites/New-MgSiteTermStoreSetTerm?view=graph-powershell-1.0)
...
```
New-MgBetaSiteTermStoreSetTerm -SetId <string> -SiteId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaSiteTermStoreSetTerm -SetId <string> -SiteId <string>
...
```
New-MgBetaSiteTermStoreSetTerm -InputObject <ISitesIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Children <IMicrosoftGraphTermStoreTerm[]>]
 [-CreatedDateTime <datetime>] [-Descriptions <IMicrosoftGraphTermStoreLocalizedDescription[]>]
 [-Id <string>] [-Labels <IMicrosoftGraphTermStoreLocalizedLabel[]>]
 [-LastModifiedDateTime <datetime>] [-Properties <IMicrosoftGraphKeyValue[]>]
...
```
New-MgBetaSiteTermStoreSetTerm -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphTermStoreTerm> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgBetaSiteTermStoreSetTerm](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetasitetermstoresetterm)
