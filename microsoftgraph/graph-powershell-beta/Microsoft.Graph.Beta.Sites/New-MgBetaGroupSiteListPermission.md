...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetagroupsitelistpermission
schema: 2.0.0
---

# New-MgBetaGroupSiteListPermission
...
```
New-MgBetaGroupSiteListPermission -GroupId <String> -ListId <String> -SiteId <String>
...
```
New-MgBetaGroupSiteListPermission -InputObject <ISitesIdentity> [-ResponseHeadersVariable <String>]
...
### CreateViaIdentity
```
New-MgBetaGroupSiteListPermission -InputObject <ISitesIdentity> -BodyParameter <IMicrosoftGraphPermission>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetagroupsitelistpermission](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetagroupsitelistpermission)
