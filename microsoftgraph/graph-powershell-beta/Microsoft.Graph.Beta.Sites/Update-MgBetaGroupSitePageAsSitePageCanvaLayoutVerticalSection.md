...
Update-MgBetaGroupSitePageAsSitePageCanvaLayoutVerticalSection -BaseSitePageId <String> -GroupId <String>
 ...
 [-Webparts <IMicrosoftGraphWebPart[]>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Update
```
Update-MgBetaGroupSitePageAsSitePageCanvaLayoutVerticalSection -BaseSitePageId <String> -GroupId <String>
 -SiteId <String> -BodyParameter <IMicrosoftGraphVerticalSection> [-WhatIf] [-Confirm] [<CommonParameters>]
```
