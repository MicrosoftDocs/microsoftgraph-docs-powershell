...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/get-mgbetasitelistpermission
Locale: en-US
Module Name: Microsoft.Graph.Beta.Sites
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaSiteListPermission
---

# Get-MgBetaSiteListPermission
...
```
Get-MgBetaSiteListPermission -ListId <string> -SiteId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaSiteListPermission -ListId <string> -PermissionId <string> -SiteId <string>
...
```
Get-MgBetaSiteListPermission -InputObject <ISitesIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgBetaSiteListPermission](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/get-mgbetasitelistpermission)
