...
### Is (Default)
```
Test-MgBetaSiteContentTypePublished -ContentTypeId <String> -SiteId <String> [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### IsViaIdentity
```
Test-MgBetaSiteContentTypePublished -InputObject <ISitesIdentity> [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
