...
Get-MgBetaGroupSiteListItemDriveItemContent -GroupId <String> -ListId <String> -ListItemId <String>
 -SiteId <String> [-Format <String>] -OutFile <String> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaGroupSiteListItemDriveItemContent -InputObject <ISitesIdentity> [-Format <String>] -OutFile <String>
...
## RELATED LINKS
[Get-MgGroupSiteListItemDriveItemContent](/powershell/module/Microsoft.Graph.Sites/Get-MgGroupSiteListItemDriveItemContent?view=graph-powershell-1.0)
