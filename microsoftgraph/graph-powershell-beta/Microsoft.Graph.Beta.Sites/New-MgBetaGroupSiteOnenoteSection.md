...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetagroupsiteonenotesection
Locale: en-US
Module Name: Microsoft.Graph.Beta.Sites
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaGroupSiteOnenoteSection
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgGroupSiteOnenoteSection](/powershell/module/Microsoft.Graph.Sites/New-MgGroupSiteOnenoteSection?view=graph-powershell-1.0)
...
```
New-MgBetaGroupSiteOnenoteSection -InputObject <ISitesIdentity> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaGroupSiteOnenoteSection -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphOnenoteSection> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgBetaGroupSiteOnenoteSection](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetagroupsiteonenotesection)
