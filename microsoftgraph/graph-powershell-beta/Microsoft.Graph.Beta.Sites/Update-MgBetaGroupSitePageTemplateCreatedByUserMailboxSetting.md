...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsitepagetemplatecreatedbyusermailboxsetting
schema: 2.0.0
---

# Update-MgBetaGroupSitePageTemplateCreatedByUserMailboxSetting
...
```
Update-MgBetaGroupSitePageTemplateCreatedByUserMailboxSetting -GroupId <String> -PageTemplateId <String>
...
```
Update-MgBetaGroupSitePageTemplateCreatedByUserMailboxSetting -GroupId <String> -PageTemplateId <String>
 -SiteId <String> -BodyParameter <IMicrosoftGraphMailboxSettings> [-ResponseHeadersVariable <String>]
 [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgBetaGroupSitePageTemplateCreatedByUserMailboxSetting -InputObject <ISitesIdentity>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsitepagetemplatecreatedbyusermailboxsetting](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsitepagetemplatecreatedbyusermailboxsetting)
