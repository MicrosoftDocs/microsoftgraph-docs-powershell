...
```
Get-MgBetaSiteOperation -SiteId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaSiteOperation -RichLongRunningOperationId <string> -SiteId <string>
...
```
Get-MgBetaSiteOperation -InputObject <ISitesIdentity> [-ExpandProperty <string[]>]
...
| --------------- | ------------------------------------------  |
| Delegated (work or school account) | Sites.FullControl.All, Sites.Manage.All, Sites.Read.All, Sites.ReadWrite.All,  |
