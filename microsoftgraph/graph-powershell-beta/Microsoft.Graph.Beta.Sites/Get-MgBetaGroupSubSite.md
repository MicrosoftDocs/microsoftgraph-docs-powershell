...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/get-mgbetagroupsubsite
Locale: en-US
Module Name: Microsoft.Graph.Beta.Sites
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaGroupSubSite
---
...
```
Get-MgBetaGroupSubSite -GroupId <string> [-SiteId <string>] [-ExpandProperty <string[]>]
...
```
Get-MgBetaGroupSubSite -GroupId <string> -SiteId1 <string> [-SiteId <string>]
...
```
Get-MgBetaGroupSubSite -InputObject <ISitesIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgBetaGroupSubSite](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/get-mgbetagroupsubsite)
