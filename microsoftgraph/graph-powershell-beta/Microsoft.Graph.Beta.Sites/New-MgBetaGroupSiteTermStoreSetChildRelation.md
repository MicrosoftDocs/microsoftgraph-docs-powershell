...
```
New-MgBetaGroupSiteTermStoreSetChildRelation -InputObject <ISitesIdentity> [-ResponseHeadersVariable <String>]
...
## RELATED LINKS
[New-MgGroupSiteTermStoreSetChildRelation](/powershell/module/Microsoft.Graph.Sites/New-MgGroupSiteTermStoreSetChildRelation?view=graph-powershell-1.0)
