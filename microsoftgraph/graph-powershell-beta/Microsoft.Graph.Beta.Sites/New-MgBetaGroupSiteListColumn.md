...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetagroupsitelistcolumn
Locale: en-US
Module Name: Microsoft.Graph.Beta.Sites
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaGroupSiteListColumn
---
...
```
New-MgBetaGroupSiteListColumn -InputObject <ISitesIdentity> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaGroupSiteListColumn -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphColumnDefinition> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgBetaGroupSiteListColumn](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetagroupsitelistcolumn)
