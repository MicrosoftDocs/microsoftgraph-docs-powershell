...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetagroupsitelistcolumn
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgGroupSiteListColumn](/powershell/module/Microsoft.Graph.Sites/New-MgGroupSiteListColumn?view=graph-powershell-v1.0)

## SYNTAX

### CreateExpanded (Default)
```
New-MgBetaGroupSiteListColumn -GroupId <String> -ListId <String> -SiteId <String>
...
```
New-MgBetaGroupSiteListColumn -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]
...
### CreateViaIdentity
```
New-MgBetaGroupSiteListColumn -InputObject <ISitesIdentity> -BodyParameter <IMicrosoftGraphColumnDefinition>
...
## RELATED LINKS
[New-MgGroupSiteListColumn](/powershell/module/Microsoft.Graph.Sites/New-MgGroupSiteListColumn?view=graph-powershell-v1.0)
