...
```
Add-MgBetaSiteContentModelGetByNameToDrive -InputObject <ISitesIdentity> [-ResponseHeadersVariable <String>]
...
```yaml
Type: IPaths2IadlhSitesSiteIdContentmodelsMicrosoftGraphGetbynameModelnameMicrosoftGraphAddtodrivePostRequestbodyContentApplicationJsonSchema
