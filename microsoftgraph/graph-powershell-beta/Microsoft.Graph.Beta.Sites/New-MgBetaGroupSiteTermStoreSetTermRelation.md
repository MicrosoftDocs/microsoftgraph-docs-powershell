...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetagroupsitetermstoresettermrelation
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgGroupSiteTermStoreSetTermRelation](/powershell/module/Microsoft.Graph.Sites/New-MgGroupSiteTermStoreSetTermRelation?view=graph-powershell-v1.0)

## SYNTAX

### CreateExpanded (Default)
```
New-MgBetaGroupSiteTermStoreSetTermRelation -GroupId <String> -SetId <String> -SiteId <String> -TermId <String>
...
```
New-MgBetaGroupSiteTermStoreSetTermRelation -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]
...
### CreateViaIdentity
```
New-MgBetaGroupSiteTermStoreSetTermRelation -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphTermStoreRelation> [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
## RELATED LINKS
[New-MgGroupSiteTermStoreSetTermRelation](/powershell/module/Microsoft.Graph.Sites/New-MgGroupSiteTermStoreSetTermRelation?view=graph-powershell-v1.0)
