...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetasitegetbypathcontenttype
Locale: en-US
Module Name: Microsoft.Graph.Beta.Sites
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaSiteGetByPathContentType
---
...
```
New-MgBetaSiteGetByPathContentType -Path <string> -SiteId <string>
...
```
New-MgBetaSiteGetByPathContentType -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphContentType> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgBetaSiteGetByPathContentType](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetasitegetbypathcontenttype)
