...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgSiteGetByPathContentType](/powershell/module/Microsoft.Graph.Sites/New-MgSiteGetByPathContentType?view=graph-powershell-1.0)

## SYNTAX

### CreateExpanded (Default)
```
New-MgBetaSiteGetByPathContentType -Path <String> -SiteId <String> [-ResponseHeadersVariable <String>]
...
### CreateExpanded1
```
New-MgBetaSiteGetByPathContentType -Path <String> -SiteId <String> -Path1 <String>
...
```
New-MgBetaSiteGetByPathContentType -InputObject <ISitesIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-AssociatedHubsUrls <String[]>] [-Base <IMicrosoftGraphContentType>]
 [-BaseTypes <IMicrosoftGraphContentType[]>] [-ColumnLinks <IMicrosoftGraphColumnLink[]>]
 [-ColumnPositions <IMicrosoftGraphColumnDefinition[]>] [-Columns <IMicrosoftGraphColumnDefinition[]>]
 [-Description <String>] [-DocumentSet <IMicrosoftGraphDocumentSet>]
...
## RELATED LINKS
[New-MgSiteGetByPathContentType](/powershell/module/Microsoft.Graph.Sites/New-MgSiteGetByPathContentType?view=graph-powershell-1.0)

[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetasitegetbypathcontenttype](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetasitegetbypathcontenttype)
