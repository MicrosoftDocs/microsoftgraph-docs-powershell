...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/invoke-mgbetaarchivesitegetbypath
schema: 2.0.0
...
### Archive (Default)
```
Invoke-MgBetaArchiveSiteGetByPath -Path <String> -SiteId <String> [-ResponseHeadersVariable <String>]
