...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgSiteOperation](/powershell/module/Microsoft.Graph.Sites/New-MgSiteOperation?view=graph-powershell-v1.0)
...
### Create
```
New-MgBetaSiteOperation -SiteId <String> -BodyParameter <IMicrosoftGraphRichLongRunningOperation> [-WhatIf]
...
## RELATED LINKS
[New-MgSiteOperation](/powershell/module/Microsoft.Graph.Sites/New-MgSiteOperation?view=graph-powershell-v1.0)
