...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgGroupSiteOnenoteSectionGroupSection](/powershell/module/Microsoft.Graph.Sites/New-MgGroupSiteOnenoteSectionGroupSection?view=graph-powershell-v1.0)
...
```
New-MgBetaGroupSiteOnenoteSectionGroupSection -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]
