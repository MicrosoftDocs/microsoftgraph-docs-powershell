...
### Set (Default)
```
Set-MgBetaGroupSiteListItemActivityDriveItemContentStream -GroupId <String> -ItemActivityOldId <String>
...
### SetViaIdentity
```
Set-MgBetaGroupSiteListItemActivityDriveItemContentStream -InputObject <ISitesIdentity> [-Data <Stream>]
