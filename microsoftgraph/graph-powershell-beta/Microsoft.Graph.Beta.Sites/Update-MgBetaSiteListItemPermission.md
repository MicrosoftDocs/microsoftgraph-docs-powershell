...
```
Update-MgBetaSiteListItemPermission -InputObject <ISitesIdentity> [-ResponseHeadersVariable <String>]
...
### UpdateViaIdentity
```
Update-MgBetaSiteListItemPermission -InputObject <ISitesIdentity> -BodyParameter <IMicrosoftGraphPermission>
