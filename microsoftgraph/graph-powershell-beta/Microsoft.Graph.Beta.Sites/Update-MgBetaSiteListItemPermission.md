...
# Update-MgBetaSiteListItemPermission
...
```
Update-MgBetaSiteListItemPermission -ListId <string> -ListItemId <string> -PermissionId <string>
...
```
Update-MgBetaSiteListItemPermission -InputObject <ISitesIdentity>
...
- [Update-MgBetaSiteListItemPermission](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetasitelistitempermission)
