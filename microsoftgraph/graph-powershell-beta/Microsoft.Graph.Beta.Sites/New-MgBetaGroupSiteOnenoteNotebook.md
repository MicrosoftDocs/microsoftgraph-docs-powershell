...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetagroupsiteonenotenotebook
Locale: en-US
Module Name: Microsoft.Graph.Beta.Sites
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaGroupSiteOnenoteNotebook
---
...
```
New-MgBetaGroupSiteOnenoteNotebook -GroupId <string> -SiteId <string>
...
```
New-MgBetaGroupSiteOnenoteNotebook -InputObject <ISitesIdentity> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaGroupSiteOnenoteNotebook -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphNotebook> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgBetaGroupSiteOnenoteNotebook](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetagroupsiteonenotenotebook)
