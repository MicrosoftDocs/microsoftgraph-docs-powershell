...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/get-mgbetasitelistcolumn
Locale: en-US
Module Name: Microsoft.Graph.Beta.Sites
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaSiteListColumn
---
...
```
Get-MgBetaSiteListColumn -ListId <string> -SiteId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaSiteListColumn -InputObject <ISitesIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgBetaSiteListColumn](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/get-mgbetasitelistcolumn)
- [Graph API Reference](https://learn.microsoft.com/graph/api/list-list-columns?view=graph-rest-beta)
