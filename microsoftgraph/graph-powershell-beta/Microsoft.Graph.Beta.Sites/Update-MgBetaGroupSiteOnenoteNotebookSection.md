...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgGroupSiteOnenoteNotebookSection](/powershell/module/Microsoft.Graph.Sites/Update-MgGroupSiteOnenoteNotebookSection?view=graph-powershell-v1.0)
...
```
Update-MgBetaGroupSiteOnenoteNotebookSection -GroupId <String> -NotebookId <String> -OnenoteSectionId <String>
 -SiteId <String> -BodyParameter <IMicrosoftGraphOnenoteSection> [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgGroupSiteOnenoteNotebookSection](/powershell/module/Microsoft.Graph.Sites/Update-MgGroupSiteOnenoteNotebookSection?view=graph-powershell-v1.0)
