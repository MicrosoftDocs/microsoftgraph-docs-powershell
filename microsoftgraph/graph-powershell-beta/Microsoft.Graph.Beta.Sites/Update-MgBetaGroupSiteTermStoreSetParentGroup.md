...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgGroupSiteTermStoreSetParentGroup](/powershell/module/Microsoft.Graph.Sites/Update-MgGroupSiteTermStoreSetParentGroup?view=graph-powershell-v1.0)
...
```
Update-MgBetaGroupSiteTermStoreSetParentGroup -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]
...
## RELATED LINKS
[Update-MgGroupSiteTermStoreSetParentGroup](/powershell/module/Microsoft.Graph.Sites/Update-MgGroupSiteTermStoreSetParentGroup?view=graph-powershell-v1.0)
