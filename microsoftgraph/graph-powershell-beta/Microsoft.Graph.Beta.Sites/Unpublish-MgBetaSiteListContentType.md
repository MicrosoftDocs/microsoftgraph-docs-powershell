...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Unpublish-MgSiteListContentType](/powershell/module/Microsoft.Graph.Sites/Unpublish-MgSiteListContentType?view=graph-powershell-v1.0)
...
```
Unpublish-MgBetaSiteListContentType -InputObject <ISitesIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
## RELATED LINKS
[Unpublish-MgSiteListContentType](/powershell/module/Microsoft.Graph.Sites/Unpublish-MgSiteListContentType?view=graph-powershell-v1.0)
