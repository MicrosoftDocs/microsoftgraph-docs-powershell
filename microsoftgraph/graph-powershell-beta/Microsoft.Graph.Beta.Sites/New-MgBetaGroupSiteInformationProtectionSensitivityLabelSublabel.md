...
New-MgBetaGroupSiteInformationProtectionSensitivityLabelSublabel -GroupId <String> -SensitivityLabelId <String>
 ...
 [-IsDefault] [-IsEnabled] [-IsEndpointProtectionEnabled] [-IsScopedToUser] [-Locale <String>] [-Name <String>]
 [-Priority <Int32>] [-Rights <IMicrosoftGraphUsageRightsIncluded>]
...
New-MgBetaGroupSiteInformationProtectionSensitivityLabelSublabel -InputObject <ISitesIdentity>
 ...
 [-IsEndpointProtectionEnabled] [-IsScopedToUser] [-Locale <String>] [-Name <String>] [-Priority <Int32>]
