...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgGroupSiteOnenoteResource](/powershell/module/Microsoft.Graph.Sites/Update-MgGroupSiteOnenoteResource?view=graph-powershell-v1.0)
...
```
Update-MgBetaGroupSiteOnenoteResource -GroupId <String> -OnenoteResourceId <String> -SiteId <String>
 -BodyParameter <IMicrosoftGraphOnenoteResource> [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgBetaGroupSiteOnenoteResource -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]
 [-ContentInputFile <String>] [-ContentUrl <String>] [-Id <String>] [-Self <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgGroupSiteOnenoteResource](/powershell/module/Microsoft.Graph.Sites/Update-MgGroupSiteOnenoteResource?view=graph-powershell-v1.0)
