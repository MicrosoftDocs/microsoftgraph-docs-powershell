...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/remove-mgbetagroupsiterecyclebinitem
Locale: en-US
Module Name: Microsoft.Graph.Beta.Sites
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: Remove-MgBetaGroupSiteRecycleBinItem
---
...
```
Remove-MgBetaGroupSiteRecycleBinItem -GroupId <string> -SiteId <string>
...
```
Remove-MgBetaGroupSiteRecycleBinItem -InputObject <ISitesIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-Ids <string[]>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPathsMjdiljGroupsGroupIdSitesSiteIdRecyclebinItemsMicrosoftGraphDeletePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
- [Remove-MgBetaGroupSiteRecycleBinItem](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/remove-mgbetagroupsiterecyclebinitem)
