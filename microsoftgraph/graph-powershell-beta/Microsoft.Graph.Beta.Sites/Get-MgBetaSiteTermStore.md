...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/get-mgbetasitetermstore
Locale: en-US
Module Name: Microsoft.Graph.Beta.Sites
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaSiteTermStore
---
...
```
Get-MgBetaSiteTermStore -InputObject <ISitesIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgBetaSiteTermStore](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/get-mgbetasitetermstore)
- [Graph API Reference](https://learn.microsoft.com/graph/api/termstore-store-get?view=graph-rest-beta)
