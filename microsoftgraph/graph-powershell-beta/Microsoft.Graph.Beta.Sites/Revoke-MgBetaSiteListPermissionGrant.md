...
```
Revoke-MgBetaSiteListPermissionGrant -ListId <String> -PermissionId <String> -SiteId <String>
...
```
Revoke-MgBetaSiteListPermissionGrant -InputObject <ISitesIdentity> [-ResponseHeadersVariable <String>]
...
### RevokeViaIdentity
```
Revoke-MgBetaSiteListPermissionGrant -InputObject <ISitesIdentity>
 -BodyParameter <IPaths1Wubu4BSitesSiteIdListsListIdPermissionsPermissionIdMicrosoftGraphRevokegrantsPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
```yaml
Type: IPaths1Wubu4BSitesSiteIdListsListIdPermissionsPermissionIdMicrosoftGraphRevokegrantsPostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths1Wubu4BSitesSiteIdListsListIdPermissionsPermissionIdMicrosoftGraphRevokegrantsPostRequestbodyContentApplicationJsonSchema
