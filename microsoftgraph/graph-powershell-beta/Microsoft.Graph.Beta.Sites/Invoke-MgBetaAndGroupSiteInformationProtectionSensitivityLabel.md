...
# Invoke-MgBetaAndGroupSiteInformationProtectionSensitivityLabel
...
```
Invoke-MgBetaAndGroupSiteInformationProtectionSensitivityLabel -GroupId <string> -SiteId <string>
...
```
Invoke-MgBetaAndGroupSiteInformationProtectionSensitivityLabel -InputObject <ISitesIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-DelegatedUserEmail <string>] [-Locale <string>]
 [-ProtectedContents <IMicrosoftGraphProtectedContent[]>] [-SupportedContentFormats <string[]>]
 [-Break] [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths16Kg95IGroupsGroupIdSitesSiteIdInformationprotectionSensitivitylabelsMicrosoftGraphComputerightsandinheritancePostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths16Kg95IGroupsGroupIdSitesSiteIdInformationprotectionSensitivitylabelsMicrosoftGraphComputerightsandinheritancePostRequestbodyContentApplicationJsonSchema
