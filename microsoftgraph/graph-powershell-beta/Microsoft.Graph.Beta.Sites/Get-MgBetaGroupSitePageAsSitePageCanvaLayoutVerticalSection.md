...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/get-mgbetagroupsitepageassitepagecanvalayoutverticalsection
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaGroupSitePageAsSitePageCanvaLayoutVerticalSection -BaseSitePageId <String> -GroupId <String>
