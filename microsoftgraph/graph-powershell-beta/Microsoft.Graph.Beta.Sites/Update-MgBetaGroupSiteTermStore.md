...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsitetermstore
Locale: en-US
Module Name: Microsoft.Graph.Beta.Sites
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaGroupSiteTermStore
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgGroupSiteTermStore](/powershell/module/Microsoft.Graph.Sites/Update-MgGroupSiteTermStore?view=graph-powershell-1.0)
...
```
Update-MgBetaGroupSiteTermStore -GroupId <string> -SiteId <string>
...
```
Update-MgBetaGroupSiteTermStore -InputObject <ISitesIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaGroupSiteTermStore -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphTermStore> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [Update-MgBetaGroupSiteTermStore](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsitetermstore)
