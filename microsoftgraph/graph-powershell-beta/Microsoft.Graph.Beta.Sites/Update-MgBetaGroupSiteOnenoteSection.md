...
```
Update-MgBetaGroupSiteOnenoteSection -InputObject <ISitesIdentity> [-ResponseHeadersVariable <String>]
...
## RELATED LINKS
[Update-MgGroupSiteOnenoteSection](/powershell/module/Microsoft.Graph.Sites/Update-MgGroupSiteOnenoteSection?view=graph-powershell-1.0)
