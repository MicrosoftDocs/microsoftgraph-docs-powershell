...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/get-mgbetasitelistitem
Locale: en-US
Module Name: Microsoft.Graph.Beta.Sites
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaSiteListItem
---
...
```
Get-MgBetaSiteListItem -ListId <string> -SiteId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaSiteListItem -ListId <string> -ListItemId <string> -SiteId <string>
...
```
Get-MgBetaSiteListItem -InputObject <ISitesIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgBetaSiteListItem](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/get-mgbetasitelistitem)
- [Graph API Reference](https://learn.microsoft.com/graph/api/listitem-get?view=graph-rest-beta)
- [Graph API Reference](https://learn.microsoft.com/graph/api/listitem-list?view=graph-rest-beta)
