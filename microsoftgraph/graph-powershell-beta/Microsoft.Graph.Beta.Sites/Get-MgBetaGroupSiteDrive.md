...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/get-mgbetagroupsitedrive
Locale: en-US
Module Name: Microsoft.Graph.Beta.Sites
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaGroupSiteDrive
---
...
```
Get-MgBetaGroupSiteDrive -GroupId <string> -SiteId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaGroupSiteDrive -DriveId <string> -GroupId <string> -SiteId <string>
...
```
Get-MgBetaGroupSiteDrive -InputObject <ISitesIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgBetaGroupSiteDrive](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/get-mgbetagroupsitedrive)
