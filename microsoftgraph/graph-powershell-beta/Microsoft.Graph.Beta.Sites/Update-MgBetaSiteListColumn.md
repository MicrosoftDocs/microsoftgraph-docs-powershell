...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetasitelistcolumn
Locale: en-US
Module Name: Microsoft.Graph.Beta.Sites
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaSiteListColumn
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgSiteListColumn](/powershell/module/Microsoft.Graph.Sites/Update-MgSiteListColumn?view=graph-powershell-1.0)
...
```
Update-MgBetaSiteListColumn -InputObject <ISitesIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaSiteListColumn -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphColumnDefinition> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [Update-MgBetaSiteListColumn](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetasitelistcolumn)
