...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetagroupsitelistitempermission
schema: 2.0.0
---

# New-MgBetaGroupSiteListItemPermission
...
```
New-MgBetaGroupSiteListItemPermission -GroupId <String> -ListId <String> -ListItemId <String> -SiteId <String>
...
```
New-MgBetaGroupSiteListItemPermission -InputObject <ISitesIdentity> [-ResponseHeadersVariable <String>]
...
### CreateViaIdentity
```
New-MgBetaGroupSiteListItemPermission -InputObject <ISitesIdentity> -BodyParameter <IMicrosoftGraphPermission>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetagroupsitelistitempermission](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetagroupsitelistitempermission)
