...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetasitelistpermission
Locale: en-US
Module Name: Microsoft.Graph.Beta.Sites
ms.date: 09/25/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaSiteListPermission
---

# Update-MgBetaSiteListPermission
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgSiteListPermission](/powershell/module/Microsoft.Graph.Sites/Update-MgSiteListPermission?view=graph-powershell-1.0)
...
```
Update-MgBetaSiteListPermission -ListId <string> -PermissionId <string> -SiteId <string>
...
```
Update-MgBetaSiteListPermission -InputObject <ISitesIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaSiteListPermission -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphPermission> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [Update-MgBetaSiteListPermission](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetasitelistpermission)
