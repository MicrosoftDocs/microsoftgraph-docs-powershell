...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetasitelistpermission
schema: 2.0.0
---
...
### UpdateViaIdentity
```
Update-MgBetaSiteListPermission -InputObject <ISitesIdentity> -BodyParameter <IMicrosoftGraphPermission>
