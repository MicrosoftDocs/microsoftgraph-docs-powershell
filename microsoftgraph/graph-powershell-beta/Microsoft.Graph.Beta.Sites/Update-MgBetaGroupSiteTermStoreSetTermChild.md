...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgGroupSiteTermStoreSetTermChild](/powershell/module/Microsoft.Graph.Sites/Update-MgGroupSiteTermStoreSetTermChild?view=graph-powershell-1.0)

## SYNTAX

### UpdateExpanded (Default)
```
Update-MgBetaGroupSiteTermStoreSetTermChild -GroupId <String> -SetId <String> -SiteId <String> -TermId <String>
...
```
Update-MgBetaGroupSiteTermStoreSetTermChild -InputObject <ISitesIdentity> [-ResponseHeadersVariable <String>]
...
## RELATED LINKS
[Update-MgGroupSiteTermStoreSetTermChild](/powershell/module/Microsoft.Graph.Sites/Update-MgGroupSiteTermStoreSetTermChild?view=graph-powershell-1.0)

[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsitetermstoresettermchild](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsitetermstoresettermchild)
