...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/get-mgbetasiteanalytic
Locale: en-US
Module Name: Microsoft.Graph.Beta.Sites
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaSiteAnalytic
---
...
```
Get-MgBetaSiteAnalytic [-SiteId <string>] [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaSiteAnalytic -InputObject <ISitesIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgBetaSiteAnalytic](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/get-mgbetasiteanalytic)
