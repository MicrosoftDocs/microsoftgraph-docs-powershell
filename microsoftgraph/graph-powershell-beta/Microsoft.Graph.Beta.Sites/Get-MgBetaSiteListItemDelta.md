...
```
Get-MgBetaSiteListItemDelta -ListId <string> -SiteId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaSiteListItemDelta -ListId <string> -SiteId <string> -Token <string>
...
```
Get-MgBetaSiteListItemDelta -InputObject <ISitesIdentity> [-ExpandProperty <string[]>]
 [-Filter <string>] [-Property <string[]>] [-Search <string>] [-Skip <int>] [-Sort <string[]>]
...
- [Get-MgBetaSiteListItemDelta](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/get-mgbetasitelistitemdelta)
