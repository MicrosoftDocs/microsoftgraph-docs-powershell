...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsitegetbypathtermstore
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgGroupSiteGetByPathTermStore](/powershell/module/Microsoft.Graph.Sites/Update-MgGroupSiteGetByPathTermStore?view=graph-powershell-1.0)

## SYNTAX

### UpdateExpanded1 (Default)
```
Update-MgBetaGroupSiteGetByPathTermStore -GroupId <String> -Path <String> -SiteId <String>
...
### UpdateExpanded
```
Update-MgBetaGroupSiteGetByPathTermStore -GroupId <String> -Path <String> -Path1 <String> -SiteId <String>
 [-AdditionalProperties <Hashtable>] [-DefaultLanguageTag <String>] [-Groups <IMicrosoftGraphTermStoreGroup[]>]
 [-Id <String>] [-LanguageTags <String[]>] [-Sets <IMicrosoftGraphTermStoreSet[]>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```
Update-MgBetaGroupSiteGetByPathTermStore -GroupId <String> -Path <String> -SiteId <String>
 -BodyParameter <IMicrosoftGraphTermStore> [-Headers <IDictionary>] [-ProgressAction <ActionPreference>]
...
```
Update-MgBetaGroupSiteGetByPathTermStore -InputObject <ISitesIdentity> [-AdditionalProperties <Hashtable>]
...
### UpdateViaIdentity1
```
Update-MgBetaGroupSiteGetByPathTermStore -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphTermStore> [-Headers <IDictionary>] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
## RELATED LINKS
[Update-MgGroupSiteGetByPathTermStore](/powershell/module/Microsoft.Graph.Sites/Update-MgGroupSiteGetByPathTermStore?view=graph-powershell-1.0)

[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsitegetbypathtermstore](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsitegetbypathtermstore)
