...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Restore-MgSiteListItemVersion](/powershell/module/Microsoft.Graph.Sites/Restore-MgSiteListItemVersion?view=graph-powershell-v1.0)
...
### RestoreViaIdentity
```
Restore-MgBetaSiteListItemVersion -InputObject <ISitesIdentity> [-PassThru] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
