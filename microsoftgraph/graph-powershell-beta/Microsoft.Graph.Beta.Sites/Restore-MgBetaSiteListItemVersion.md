...
Restore-MgBetaSiteListItemVersion -ListId <String> -ListItemId <String> -ListItemVersionId <String>
 -SiteId <String> [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### RestoreViaIdentity
```
Restore-MgBetaSiteListItemVersion -InputObject <ISitesIdentity> [-Headers <IDictionary>] [-PassThru]
