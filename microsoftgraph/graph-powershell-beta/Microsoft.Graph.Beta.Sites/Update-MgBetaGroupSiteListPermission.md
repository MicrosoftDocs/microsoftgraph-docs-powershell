...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsitelistpermission
schema: 2.0.0
---

# Update-MgBetaGroupSiteListPermission
...
```
Update-MgBetaGroupSiteListPermission -GroupId <String> -ListId <String> -PermissionId <String> -SiteId <String>
...
```
Update-MgBetaGroupSiteListPermission -InputObject <ISitesIdentity> [-ResponseHeadersVariable <String>]
...
### UpdateViaIdentity
```
Update-MgBetaGroupSiteListPermission -InputObject <ISitesIdentity> -BodyParameter <IMicrosoftGraphPermission>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsitelistpermission](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetagroupsitelistpermission)
