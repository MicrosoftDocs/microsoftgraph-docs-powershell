...
New-MgBetaGroupSiteListItemDocumentSetVersion -GroupId <String> -ListId <String> -ListItemId <String>
 -SiteId <String> [-ResponseHeadersVariable <String>] [-AdditionalProperties <Hashtable>] [-Comment <String>]
...
```
New-MgBetaGroupSiteListItemDocumentSetVersion -InputObject <ISitesIdentity> [-ResponseHeadersVariable <String>]
