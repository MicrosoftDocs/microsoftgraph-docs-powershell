...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/remove-mgbetasitecontentmodelfromdrive
schema: 2.0.0
...
```
Remove-MgBetaSiteContentModelFromDrive -ContentModelId <String> -SiteId <String>
...
```
Remove-MgBetaSiteContentModelFromDrive -ContentModelId <String> -SiteId <String>
 -BodyParameter <IPaths17OjgbmSitesSiteIdContentmodelsContentmodelIdMicrosoftGraphRemovefromdrivePostRequestbodyContentApplicationJsonSchema>
...
```
Remove-MgBetaSiteContentModelFromDrive -InputObject <ISitesIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-DriveId <String>] [-Headers <IDictionary>] [-PassThru]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### RemoveViaIdentity
```
Remove-MgBetaSiteContentModelFromDrive -InputObject <ISitesIdentity>
 -BodyParameter <IPaths17OjgbmSitesSiteIdContentmodelsContentmodelIdMicrosoftGraphRemovefromdrivePostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```yaml
Type: IPaths17OjgbmSitesSiteIdContentmodelsContentmodelIdMicrosoftGraphRemovefromdrivePostRequestbodyContentApplicationJsonSchema
...
### Microsoft.Graph.Beta.PowerShell.Models.IPaths17OjgbmSitesSiteIdContentmodelsContentmodelIdMicrosoftGraphRemovefromdrivePostRequestbodyContentApplicationJsonSchema
