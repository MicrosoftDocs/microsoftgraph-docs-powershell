...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/get-mgbetasitetermstoreset
Locale: en-US
Module Name: Microsoft.Graph.Beta.Sites
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaSiteTermStoreSet
---
...
```
Get-MgBetaSiteTermStoreSet -InputObject <ISitesIdentity> [-ExpandProperty <string[]>]
 [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
```
...
- [Get-MgBetaSiteTermStoreSet](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/get-mgbetasitetermstoreset)
- [Graph API Reference](https://learn.microsoft.com/graph/api/termstore-set-get?view=graph-rest-beta)
