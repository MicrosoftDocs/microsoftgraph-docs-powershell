...
```
Update-MgBetaSiteColumn -ColumnDefinitionId <String> -SiteId <String> [-ResponseHeadersVariable <String>]
...
## RELATED LINKS
[Update-MgSiteColumn](/powershell/module/Microsoft.Graph.Sites/Update-MgSiteColumn?view=graph-powershell-1.0)
