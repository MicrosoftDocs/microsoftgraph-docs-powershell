...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetasitecolumn
Locale: en-US
Module Name: Microsoft.Graph.Beta.Sites
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaSiteColumn
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgSiteColumn](/powershell/module/Microsoft.Graph.Sites/Update-MgSiteColumn?view=graph-powershell-1.0)
...
```
Update-MgBetaSiteColumn -InputObject <ISitesIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaSiteColumn -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphColumnDefinition> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [Update-MgBetaSiteColumn](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetasitecolumn)
