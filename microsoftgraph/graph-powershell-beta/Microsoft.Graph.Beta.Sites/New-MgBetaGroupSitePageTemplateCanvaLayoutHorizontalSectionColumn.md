...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetagroupsitepagetemplatecanvalayouthorizontalsectioncolumn
schema: 2.0.0
---

# New-MgBetaGroupSitePageTemplateCanvaLayoutHorizontalSectionColumn
...
```
New-MgBetaGroupSitePageTemplateCanvaLayoutHorizontalSectionColumn -GroupId <String>
 -HorizontalSectionId <String> -PageTemplateId <String> -SiteId <String> [-ResponseHeadersVariable <String>]
...
```
New-MgBetaGroupSitePageTemplateCanvaLayoutHorizontalSectionColumn -InputObject <ISitesIdentity>
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetagroupsitepagetemplatecanvalayouthorizontalsectioncolumn](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetagroupsitepagetemplatecanvalayouthorizontalsectioncolumn)
