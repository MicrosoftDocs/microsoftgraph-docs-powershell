...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/update-mgbetasitegetbypathtermstore
Locale: en-US
Module Name: Microsoft.Graph.Beta.Sites
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Update-MgBetaSiteGetByPathTermStore
---
...
```
Update-MgBetaSiteGetByPathTermStore -Path <string> -SiteId <string>
...
```
Update-MgBetaSiteGetByPathTermStore -InputObject <ISitesIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>]
 [-DefaultLanguageTag <string>] [-Groups <IMicrosoftGraphTermStoreGroup[]>] [-Id <string>]
 [-LanguageTags <string[]>] [-Sets <IMicrosoftGraphTermStoreSet[]>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
