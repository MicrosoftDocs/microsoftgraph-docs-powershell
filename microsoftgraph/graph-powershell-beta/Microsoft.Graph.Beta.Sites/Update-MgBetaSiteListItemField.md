...
```
Update-MgBetaSiteListItemField -InputObject <ISitesIdentity> [-ResponseHeadersVariable <String>]
...
[https://learn.microsoft.com/graph/api/listitem-update?view=graph-rest-beta](https://learn.microsoft.com/graph/api/listitem-update?view=graph-rest-beta)
