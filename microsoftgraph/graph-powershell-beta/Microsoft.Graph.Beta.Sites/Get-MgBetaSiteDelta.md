...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgSiteDelta](/powershell/module/Microsoft.Graph.Sites/Get-MgSiteDelta?view=graph-powershell-v1.0)

## SYNTAX

```
Get-MgBetaSiteDelta [-Filter <String>] [-Property <String[]>] [-Search <String>] [-Skip <Int32>]
