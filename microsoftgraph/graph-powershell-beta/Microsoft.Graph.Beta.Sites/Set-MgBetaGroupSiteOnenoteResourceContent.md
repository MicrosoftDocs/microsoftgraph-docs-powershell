...
```
Set-MgBetaGroupSiteOnenoteResourceContent -GroupId <string> -OnenoteResourceId <string>
...
```
Set-MgBetaGroupSiteOnenoteResourceContent -InputObject <ISitesIdentity> -InFile <string>
