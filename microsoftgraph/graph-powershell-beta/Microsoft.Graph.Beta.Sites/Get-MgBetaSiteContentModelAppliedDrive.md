...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/get-mgbetasitecontentmodelapplieddrive
schema: 2.0.0
...
### Get (Default)
```
Get-MgBetaSiteContentModelAppliedDrive -ContentModelId <String> -SiteId <String> [-Count] [-Filter <String>]
...
### GetViaIdentity
```
Get-MgBetaSiteContentModelAppliedDrive -InputObject <ISitesIdentity> [-Count] [-Filter <String>]
 [-Search <String>] [-Skip <Int32>] [-Top <Int32>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
