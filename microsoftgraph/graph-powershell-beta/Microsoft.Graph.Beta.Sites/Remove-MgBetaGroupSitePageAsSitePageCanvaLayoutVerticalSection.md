...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/remove-mgbetagroupsitepageassitepagecanvalayoutverticalsection
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-MgBetaGroupSitePageAsSitePageCanvaLayoutVerticalSection -BaseSitePageId <String> -GroupId <String>
