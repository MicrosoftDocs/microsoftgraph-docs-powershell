...
```
New-MgBetaGroupSiteContentType -GroupId <string> -SiteId <string>
...
```
New-MgBetaGroupSiteContentType -InputObject <ISitesIdentity> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaGroupSiteContentType -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphContentType> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgBetaGroupSiteContentType](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetagroupsitecontenttype)
