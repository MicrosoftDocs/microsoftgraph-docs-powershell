...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetasitegetbypathpermission
Locale: en-US
Module Name: Microsoft.Graph.Beta.Sites
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaSiteGetByPathPermission
---
...
```
New-MgBetaSiteGetByPathPermission -Path <string> -SiteId <string>
...
```
New-MgBetaSiteGetByPathPermission -InputObject <ISitesIdentity>
 -BodyParameter <IMicrosoftGraphPermission> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgBetaSiteGetByPathPermission](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetasitegetbypathpermission)
