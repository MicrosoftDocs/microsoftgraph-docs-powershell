...
### DeleteViaIdentity
```
Remove-MgBetaSiteListItem -InputObject <ISitesIdentity> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
...
## RELATED LINKS
[Remove-MgSiteListItem](/powershell/module/Microsoft.Graph.Sites/Remove-MgSiteListItem?view=graph-powershell-1.0)
