...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/get-mgbetagroupsitelist
Locale: en-US
Module Name: Microsoft.Graph.Beta.Sites
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaGroupSiteList
---
...
```
Get-MgBetaGroupSiteList -GroupId <string> -SiteId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaGroupSiteList -GroupId <string> -ListId <string> -SiteId <string>
...
```
Get-MgBetaGroupSiteList -InputObject <ISitesIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgBetaGroupSiteList](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/get-mgbetagroupsitelist)
