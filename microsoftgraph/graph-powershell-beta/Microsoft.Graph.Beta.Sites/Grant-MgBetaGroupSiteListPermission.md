...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Grant-MgGroupSiteListPermission](/powershell/module/Microsoft.Graph.Sites/Grant-MgGroupSiteListPermission?view=graph-powershell-1.0)
...
```
Grant-MgBetaGroupSiteListPermission -GroupId <string> -ListId <string> -PermissionId <string>
...
```
Grant-MgBetaGroupSiteListPermission -InputObject <ISitesIdentity>
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPaths1Ky60AsGroupsGroupIdSitesSiteIdListsListIdPermissionsPermissionIdMicrosoftGraphGrantPostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
