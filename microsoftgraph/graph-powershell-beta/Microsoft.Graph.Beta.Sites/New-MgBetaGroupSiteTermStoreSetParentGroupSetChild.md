...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetagroupsitetermstoresetparentgroupsetchild
Locale: en-US
Module Name: Microsoft.Graph.Beta.Sites
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaGroupSiteTermStoreSetParentGroupSetChild
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [New-MgGroupSiteTermStoreSetParentGroupSetChild](/powershell/module/Microsoft.Graph.Sites/New-MgGroupSiteTermStoreSetParentGroupSetChild?view=graph-powershell-1.0)
...
```
New-MgBetaGroupSiteTermStoreSetParentGroupSetChild -GroupId <string> -SetId <string>
...
```
New-MgBetaGroupSiteTermStoreSetParentGroupSetChild -GroupId <string> -SetId <string>
 -SetId1 <string> -SiteId <string> -BodyParameter <IMicrosoftGraphTermStoreTerm>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
- [New-MgBetaGroupSiteTermStoreSetParentGroupSetChild](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.sites/new-mgbetagroupsitetermstoresetparentgroupsetchild)
