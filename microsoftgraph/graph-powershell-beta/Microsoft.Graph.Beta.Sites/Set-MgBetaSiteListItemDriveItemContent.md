...
```
Set-MgBetaSiteListItemDriveItemContent -ListId <string> -ListItemId <string> -SiteId <string>
...
```
Set-MgBetaSiteListItemDriveItemContent -InputObject <ISitesIdentity> -InFile <string>
