...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Set-MgSiteListItemActivityDriveItemContent](/powershell/module/Microsoft.Graph.Sites/Set-MgSiteListItemActivityDriveItemContent?view=graph-powershell-v1.0)
...
Set-MgBetaSiteListItemActivityDriveItemContent -ItemActivityOldId <String> -ListId <String>
 -ListItemId <String> -SiteId <String> [-Data <Stream>] -InFile <String> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### SetViaIdentity
```
Set-MgBetaSiteListItemActivityDriveItemContent -InputObject <ISitesIdentity> [-Data <Stream>] -InFile <String>
