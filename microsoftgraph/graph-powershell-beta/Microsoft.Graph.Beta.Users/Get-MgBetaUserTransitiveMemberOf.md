...
```
Get-MgBetaUserTransitiveMemberOf -UserId <string> [-ExpandProperty <string[]>]
...
```
Get-MgBetaUserTransitiveMemberOf -DirectoryObjectId <string> -UserId <string>
...
- [Graph API Reference](https://learn.microsoft.com/graph/api/user-list-transitivememberof?view=graph-rest-beta)
