...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgUserTransitiveMemberOf](/powershell/module/Microsoft.Graph.Users/Get-MgUserTransitiveMemberOf?view=graph-powershell-v1.0)

## SYNTAX

### List (Default)
```
Get-MgBetaUserTransitiveMemberOf -UserId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
### GetViaIdentity
```
Get-MgBetaUserTransitiveMemberOf -InputObject <IUsersIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-ConsistencyLevel <String>] [<CommonParameters>]
```
