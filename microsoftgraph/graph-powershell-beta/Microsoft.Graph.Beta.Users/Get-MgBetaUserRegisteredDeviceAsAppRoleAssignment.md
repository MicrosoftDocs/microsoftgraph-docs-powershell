...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/get-mgbetauserregistereddeviceasapproleassignment
Locale: en-US
Module Name: Microsoft.Graph.Beta.Users
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaUserRegisteredDeviceAsAppRoleAssignment
---
...
```
Get-MgBetaUserRegisteredDeviceAsAppRoleAssignment -InputObject <IUsersIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ConsistencyLevel <string>]
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
...
- [Get-MgBetaUserRegisteredDeviceAsAppRoleAssignment](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/get-mgbetauserregistereddeviceasapproleassignment)
