...
```
Update-MgBetaUserOnPremiseSyncBehavior -UserId <string> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaUserOnPremiseSyncBehavior -UserId <string>
...
```
Update-MgBetaUserOnPremiseSyncBehavior -InputObject <IUsersIdentity>
...
Indicates the state of synchronization for an object between the cloud and on-premises Active Directory.
