...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/remove-mgbetauserbyuserprincipalname
schema: 2.0.0
...
### Delete (Default)
```
Remove-MgBetaUserByUserPrincipalName -UserPrincipalName <String> [-IfMatch <String>]
...
### DeleteViaIdentity
```
Remove-MgBetaUserByUserPrincipalName -InputObject <IUsersIdentity> [-IfMatch <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/remove-mgbetauserbyuserprincipalname](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/remove-mgbetauserbyuserprincipalname)
