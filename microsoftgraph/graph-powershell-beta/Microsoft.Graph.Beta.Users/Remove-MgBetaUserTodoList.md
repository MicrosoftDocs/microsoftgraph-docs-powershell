...
### DeleteViaIdentity
```
Remove-MgBetaUserTodoList -InputObject <IUsersIdentity> [-IfMatch <String>] [-ResponseHeadersVariable <String>]
...
## RELATED LINKS
[Remove-MgUserTodoList](/powershell/module/Microsoft.Graph.Users/Remove-MgUserTodoList?view=graph-powershell-1.0)
