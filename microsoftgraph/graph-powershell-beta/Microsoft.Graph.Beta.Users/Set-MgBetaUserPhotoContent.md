...
### Set (Default)
```
Set-MgBetaUserPhotoContent -UserId <String> [-Data <Stream>] -InFile <String> [-ContentType <String>]
...
### SetViaIdentity1
```
Set-MgBetaUserPhotoContent -InputObject <IUsersIdentity> [-Data <Stream>] -InFile <String>
 [-ContentType <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
