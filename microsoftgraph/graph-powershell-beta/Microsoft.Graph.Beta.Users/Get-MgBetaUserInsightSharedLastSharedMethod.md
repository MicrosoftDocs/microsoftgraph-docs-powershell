...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/get-mgbetauserinsightsharedlastsharedmethod
Locale: en-US
Module Name: Microsoft.Graph.Beta.Users
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Get-MgBetaUserInsightSharedLastSharedMethod
---
...
```
Get-MgBetaUserInsightSharedLastSharedMethod -InputObject <IUsersIdentity>
 [-ExpandProperty <string[]>] [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [<CommonParameters>]
