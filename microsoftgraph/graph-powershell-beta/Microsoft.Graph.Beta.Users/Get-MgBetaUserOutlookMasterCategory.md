...
### List (Default)
```
Get-MgBetaUserOutlookMasterCategory -UserId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
### Get
```
Get-MgBetaUserOutlookMasterCategory -OutlookCategoryId <String> -UserId <String> [-ExpandProperty <String[]>]
