...
```
New-MgBetaUserSponsorByRef -UserId <string> -OdataId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaUserSponsorByRef -UserId <string> -BodyParameter <IReferenceCreate>
...
```
New-MgBetaUserSponsorByRef -InputObject <IUsersIdentity> -OdataId <string>
...
```
New-MgBetaUserSponsorByRef -InputObject <IUsersIdentity> -BodyParameter <IReferenceCreate>
 [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-PassThru]
 [-Proxy <uri>] [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
