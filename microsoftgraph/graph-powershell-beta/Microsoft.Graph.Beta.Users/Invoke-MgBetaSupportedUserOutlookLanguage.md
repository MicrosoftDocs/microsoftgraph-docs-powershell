...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/invoke-mgbetasupporteduseroutlooklanguage
schema: 2.0.0
...
```
Invoke-MgBetaSupportedUserOutlookLanguage -InputObject <IUsersIdentity> [-Count] [-Filter <String>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/invoke-mgbetasupporteduseroutlooklanguage](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/invoke-mgbetasupporteduseroutlooklanguage)
