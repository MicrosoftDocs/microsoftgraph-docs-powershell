...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/update-mgbetausersettingworkhourandlocation
Locale: en-US
Module Name: Microsoft.Graph.Beta.Users
ms.date: 08/14/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaUserSettingWorkHourAndLocation
---

# Update-MgBetaUserSettingWorkHourAndLocation
...
```
Update-MgBetaUserSettingWorkHourAndLocation -UserId <string> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Id <string>] [-MaxSharedWorkLocationDetails <string>]
 [-Occurrences <IMicrosoftGraphWorkPlanOccurrence[]>]
...
```
Update-MgBetaUserSettingWorkHourAndLocation -UserId <string>
...
```
Update-MgBetaUserSettingWorkHourAndLocation -InputObject <IUsersIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-Id <string>]
 [-MaxSharedWorkLocationDetails <string>] [-Occurrences <IMicrosoftGraphWorkPlanOccurrence[]>]
 [-Recurrences <IMicrosoftGraphWorkPlanRecurrence[]>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
```
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphWorkHoursAndLocationsSetting
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
To construct, see NOTES section for OCCURRENCES properties and create a hash table.
...
To construct, see NOTES section for RECURRENCES properties and create a hash table.
...
### Microsoft.Graph.Beta.PowerShell.Models.IMicrosoftGraphWorkHoursAndLocationsSetting
