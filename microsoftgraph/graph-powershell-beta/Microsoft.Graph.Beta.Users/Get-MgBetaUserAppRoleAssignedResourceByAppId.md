...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/get-mgbetauserapproleassignedresourcebyappid
schema: 2.0.0
---
...
### Get (Default)
```
Get-MgBetaUserAppRoleAssignedResourceByAppId -AppId <String> -UserId <String> [-ExpandProperty <String[]>]
...
### GetViaIdentity
```
Get-MgBetaUserAppRoleAssignedResourceByAppId -InputObject <IUsersIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [-ResponseHeadersVariable <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
