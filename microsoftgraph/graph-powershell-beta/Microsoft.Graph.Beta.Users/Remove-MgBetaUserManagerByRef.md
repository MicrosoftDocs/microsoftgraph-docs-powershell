...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/remove-mgbetausermanagerbyref
Locale: en-US
Module Name: Microsoft.Graph.Beta.Users
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Remove-MgBetaUserManagerByRef
---
...
```
Remove-MgBetaUserManagerByRef -UserId <string> [-IfMatch <string>]
...
- [Remove-MgBetaUserManagerByRef](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/remove-mgbetausermanagerbyref)
- [Graph API Reference](https://learn.microsoft.com/graph/api/agentuser-delete-manager?view=graph-rest-beta)
