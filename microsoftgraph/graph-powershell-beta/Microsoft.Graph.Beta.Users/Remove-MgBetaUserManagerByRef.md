...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/remove-mgbetausermanagerbyref)
- [](https://learn.microsoft.com/graph/api/agentuser-delete-manager?view=graph-rest-beta)
