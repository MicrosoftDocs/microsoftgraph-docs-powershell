...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/get-mgbetauseroutlooktasksinglevalueextendedproperty
schema: 2.0.0
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgUserOutlookTaskSingleValueExtendedProperty](/powershell/module/Microsoft.Graph.Users/Get-MgUserOutlookTaskSingleValueExtendedProperty?view=graph-powershell-v1.0)
...
### GetViaIdentity
```
Get-MgBetaUserOutlookTaskSingleValueExtendedProperty -InputObject <IUsersIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
