...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/new-mgbetausernotification
Locale: en-US
Module Name: Microsoft.Graph.Beta.Users
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaUserNotification
---
...
```
New-MgBetaUserNotification -UserId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaUserNotification -InputObject <IUsersIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-DisplayTimeToLive <int>] [-ExpirationDateTime <datetime>]
 [-GroupName <string>] [-Id <string>] [-Payload <IMicrosoftGraphPayloadTypes>] [-Priority <string>]
 [-TargetHostName <string>] [-TargetPolicy <IMicrosoftGraphTargetPolicyEndpoints>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
...
```
New-MgBetaUserNotification -InputObject <IUsersIdentity>
...
- [New-MgBetaUserNotification](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/new-mgbetausernotification)
