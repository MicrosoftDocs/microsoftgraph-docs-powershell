...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/new-mgbetauseroutlooktask
Locale: en-US
Module Name: Microsoft.Graph.Beta.Users
ms.date: 08/07/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaUserOutlookTask
---
...
```
New-MgBetaUserOutlookTask -UserId <string> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaUserOutlookTask -InputObject <IUsersIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-AssignedTo <string>]
 [-Attachments <IMicrosoftGraphAttachment[]>] [-Body <IMicrosoftGraphItemBody>]
 [-Categories <string[]>] [-ChangeKey <string>] [-CompletedDateTime <IMicrosoftGraphDateTimeZone>]
 [-CreatedDateTime <datetime>] [-DueDateTime <IMicrosoftGraphDateTimeZone>] [-HasAttachments]
...
- [New-MgBetaUserOutlookTask](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/new-mgbetauseroutlooktask)
