...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/get-mgbetauseroutlooktaskgroup
Locale: en-US
Module Name: Microsoft.Graph.Beta.Users
ms.date: 08/13/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaUserOutlookTaskGroup
---
...
The user's Outlook task groups.
Read-only.
Nullable.
...
```
Get-MgBetaUserOutlookTaskGroup -UserId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaUserOutlookTaskGroup -OutlookTaskGroupId <string> -UserId <string>
...
```
Get-MgBetaUserOutlookTaskGroup -InputObject <IUsersIdentity> [-ExpandProperty <string[]>]
...
- [Get-MgBetaUserOutlookTaskGroup](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/get-mgbetauseroutlooktaskgroup)
