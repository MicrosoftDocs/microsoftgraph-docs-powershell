...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/get-mgbetausermemberofasdirectoryrole
schema: 2.0.0
---
...
### List (Default)
```
Get-MgBetaUserMemberOfAsDirectoryRole -UserId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
### Get
```
Get-MgBetaUserMemberOfAsDirectoryRole -DirectoryObjectId <String> -UserId <String> [-ExpandProperty <String[]>]
