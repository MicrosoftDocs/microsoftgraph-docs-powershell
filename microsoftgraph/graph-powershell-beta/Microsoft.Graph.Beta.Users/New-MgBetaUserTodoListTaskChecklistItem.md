...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/new-mgbetausertodolisttaskchecklistitem
Locale: en-US
Module Name: Microsoft.Graph.Beta.Users
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaUserTodoListTaskChecklistItem
---
...
```
New-MgBetaUserTodoListTaskChecklistItem -TodoTaskId <string> -TodoTaskListId <string>
 ...
 [-IsChecked] [-Break] [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
...
```
New-MgBetaUserTodoListTaskChecklistItem -InputObject <IUsersIdentity>
 -BodyParameter <IMicrosoftGraphChecklistItem> [-ResponseHeadersVariable <string>] [-Break]
...
- [New-MgBetaUserTodoListTaskChecklistItem](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/new-mgbetausertodolisttaskchecklistitem)
