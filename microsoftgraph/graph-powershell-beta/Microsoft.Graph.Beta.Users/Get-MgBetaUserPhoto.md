...
### Get (Default)
```
Get-MgBetaUserPhoto -UserId <String> [-ExpandProperty <String[]>] [-Property <String[]>]
...
### List
```
Get-MgBetaUserPhoto -UserId <String> [-ExpandProperty <String[]>] [-Property <String[]>] [-Filter <String>]
...
### Get1
```
Get-MgBetaUserPhoto -UserId <String> -ProfilePhotoId <String> [-ExpandProperty <String[]>]
...
### GetViaIdentity1
```
Get-MgBetaUserPhoto -InputObject <IUsersIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
