...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/remove-mgbetauseroutlooktaskgrouptaskfolderpermanent
schema: 2.0.0
...
### Delete (Default)
```
Remove-MgBetaUserOutlookTaskGroupTaskFolderPermanent -OutlookTaskFolderId <String> -OutlookTaskGroupId <String>
