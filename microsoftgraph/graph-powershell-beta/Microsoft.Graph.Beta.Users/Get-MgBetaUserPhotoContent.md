...
```powershell
Get-MgBetaUserPhotoContent -UserId '3bb40cd7-03fe-40b7-8a1c-a14fdf0ab5fe' -OutFile $outFileId
```
...
```powershell
Get-MgBetaUserPhotoContent -UserId '3bb40cd7-03fe-40b7-8a1c-a14fdf0ab5fe' -ProfilePhotoId 360x360 -OutFile $outFileId
```
