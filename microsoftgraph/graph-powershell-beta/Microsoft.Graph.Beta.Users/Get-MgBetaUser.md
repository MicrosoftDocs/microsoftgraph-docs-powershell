...
Get-MgBetaUser -All ### Example 1: Get the list of all the users### Example 2: Get a user by Id

```powershell
Connect-MgGraph -Scopes 'User.Read.All'
Get-MgBetaUser -UserId 'e4e2b110-8d4f-434f-a990-7cd63e23aed6' ### Example 2: Get a user by Id### Example 3: Get a count of all users
