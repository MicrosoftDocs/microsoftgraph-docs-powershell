...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/get-mgbetauserdirectreport
Locale: en-US
Module Name: Microsoft.Graph.Beta.Users
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaUserDirectReport
---
...
```
Get-MgBetaUserDirectReport -InputObject <IUsersIdentity> [-ExpandProperty <string[]>]
 [-Property <string[]>] [-ConsistencyLevel <string>] [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials]
...
- [Get-MgBetaUserDirectReport](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/get-mgbetauserdirectreport)
- [Graph API Reference](https://learn.microsoft.com/graph/api/agentuser-list-directreports?view=graph-rest-beta)
