...
- [](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/get-mgbetauserdirectreport)
- [](https://learn.microsoft.com/graph/api/agentuser-list-directreports?view=graph-rest-beta)
