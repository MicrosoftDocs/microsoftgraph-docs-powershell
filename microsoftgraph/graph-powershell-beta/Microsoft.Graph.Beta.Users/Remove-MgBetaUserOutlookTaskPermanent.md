...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/remove-mgbetauseroutlooktaskpermanent
schema: 2.0.0
...
### DeleteViaIdentity
```
Remove-MgBetaUserOutlookTaskPermanent -InputObject <IUsersIdentity> [-ResponseHeadersVariable <String>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/remove-mgbetauseroutlooktaskpermanent](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/remove-mgbetauseroutlooktaskpermanent)
