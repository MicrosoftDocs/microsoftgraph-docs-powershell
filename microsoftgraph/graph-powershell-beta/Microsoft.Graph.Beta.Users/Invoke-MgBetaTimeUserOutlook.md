...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/invoke-mgbetatimeuseroutlook
schema: 2.0.0
---
...
### TimeViaIdentity1
```
Invoke-MgBetaTimeUserOutlook -InputObject <IUsersIdentity> [-Count] [-Filter <String>] [-Search <String>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/invoke-mgbetatimeuseroutlook](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/invoke-mgbetatimeuseroutlook)
