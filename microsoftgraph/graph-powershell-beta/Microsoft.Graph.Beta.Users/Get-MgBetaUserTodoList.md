...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/get-mgbetausertodolist
Locale: en-US
Module Name: Microsoft.Graph.Beta.Users
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaUserTodoList
---
...
```
Get-MgBetaUserTodoList -UserId <string> [-ExpandProperty <string[]>] [-Property <string[]>]
...
```
Get-MgBetaUserTodoList -InputObject <IUsersIdentity> [-ExpandProperty <string[]>]
 [-Property <string[]>] [-ResponseHeadersVariable <string>] [-Break] [-Headers <IDictionary>]
 [-HttpPipelineAppend <SendAsyncStep[]>] [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>]
 [-ProxyCredential <pscredential>] [-ProxyUseDefaultCredentials]
```
...
- [Get-MgBetaUserTodoList](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/get-mgbetausertodolist)
