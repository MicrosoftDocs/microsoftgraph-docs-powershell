...
### Get
```
Get-MgBetaUserOutlookTask -OutlookTaskId <String> -UserId <String> [-Property <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaUserOutlookTask -InputObject <IUsersIdentity> [-Property <String[]>] [<CommonParameters>]
```
