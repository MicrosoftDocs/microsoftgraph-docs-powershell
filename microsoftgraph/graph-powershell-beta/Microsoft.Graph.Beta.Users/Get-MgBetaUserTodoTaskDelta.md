...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/get-mgbetausertodotaskdelta
Locale: en-US
Module Name: Microsoft.Graph.Beta.Users
ms.date: 08/01/2026
PlatyPS schema version: 2024-05-01
title: Get-MgBetaUserTodoTaskDelta
---
...
```
Get-MgBetaUserTodoTaskDelta -InputObject <IUsersIdentity> [-ExpandProperty <string[]>]
 [-Filter <string>] [-Property <string[]>] [-Search <string>] [-Skip <int>] [-Sort <string[]>]
...
- [Get-MgBetaUserTodoTaskDelta](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/get-mgbetausertodotaskdelta)
