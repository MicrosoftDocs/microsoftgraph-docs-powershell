...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.users/new-mgbetausersettingstoragequotaservice
schema: 2.0.0
---
...
```
New-MgBetaUserSettingStorageQuotaService -UserId <String> [-ResponseHeadersVariable <String>]
...
### Create
```
New-MgBetaUserSettingStorageQuotaService -UserId <String> -BodyParameter <Hashtable>
...
```
New-MgBetaUserSettingStorageQuotaService -InputObject <IUsersIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-DisplayName <String>] [-Id <String>] [-ManageWebUrl <String>]
 [-Used <Int64>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### CreateViaIdentity
```
New-MgBetaUserSettingStorageQuotaService -InputObject <IUsersIdentity> -BodyParameter <Hashtable>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
