...
### Delete (Default)
```
Remove-MgBetaGroupEventInstanceAttachment -AttachmentId <String> -EventId <String> -EventId1 <String>
 -GroupId <String> [-IfMatch <String>] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaGroupEventInstanceAttachment -InputObject <ICalendarIdentity> [-IfMatch <String>] [-PassThru]
