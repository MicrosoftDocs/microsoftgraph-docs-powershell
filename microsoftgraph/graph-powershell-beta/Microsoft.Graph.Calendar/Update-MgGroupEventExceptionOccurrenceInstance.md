...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/update-mggroupeventexceptionoccurrenceinstance
schema: 2.0.0
---
...
```
Update-MgGroupEventExceptionOccurrenceInstance -EventId <String> -EventId1 <String> -EventId2 <String>
...
```
Update-MgGroupEventExceptionOccurrenceInstance -EventId <String> -EventId1 <String> -EventId2 <String>
 -GroupId <String> -BodyParameter <IMicrosoftGraphEvent> [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-MgGroupEventExceptionOccurrenceInstance -InputObject <ICalendarIdentity>
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/update-mggroupeventexceptionoccurrenceinstance](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/update-mggroupeventexceptionoccurrenceinstance)
