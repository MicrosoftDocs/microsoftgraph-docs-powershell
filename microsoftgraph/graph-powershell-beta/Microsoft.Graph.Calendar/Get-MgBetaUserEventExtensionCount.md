...
### Get (Default)
```
Get-MgBetaUserEventExtensionCount -EventId <String> -UserId <String> [-Filter <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaUserEventExtensionCount -InputObject <ICalendarIdentity> [-Filter <String>] [<CommonParameters>]
```
