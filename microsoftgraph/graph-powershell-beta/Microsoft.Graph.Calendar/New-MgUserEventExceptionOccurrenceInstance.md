...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/new-mgusereventexceptionoccurrenceinstance
schema: 2.0.0
---
...
```
New-MgUserEventExceptionOccurrenceInstance -EventId <String> -EventId1 <String> -UserId <String>
...
```
New-MgUserEventExceptionOccurrenceInstance -InputObject <ICalendarIdentity> [-AdditionalProperties <Hashtable>]
...
### CreateViaIdentity
```
New-MgUserEventExceptionOccurrenceInstance -InputObject <ICalendarIdentity>
 -BodyParameter <IMicrosoftGraphEvent> [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/new-mgusereventexceptionoccurrenceinstance](https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.calendar/new-mgusereventexceptionoccurrenceinstance)
