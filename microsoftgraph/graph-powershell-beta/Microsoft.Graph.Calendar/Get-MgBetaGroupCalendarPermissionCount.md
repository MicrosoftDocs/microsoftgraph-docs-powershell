...
### Get (Default)
```
Get-MgBetaGroupCalendarPermissionCount -GroupId <String> [-Filter <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaGroupCalendarPermissionCount -InputObject <ICalendarIdentity> [-Filter <String>] [<CommonParameters>]
```
