...
### Create
```
New-MgBetaGroupCalendarEvent -GroupId <String> -BodyParameter <IMicrosoftGraphEvent> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### CreateViaIdentity
```
New-MgBetaGroupCalendarEvent -InputObject <ICalendarIdentity> -BodyParameter <IMicrosoftGraphEvent> [-WhatIf]
