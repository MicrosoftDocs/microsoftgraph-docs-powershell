...
### List (Default)
```
Get-MgBetaExternalIndustryDataInboundFlow [-ExpandProperty <String[]>] [-Property <String[]>]
...
### Get
```
Get-MgBetaExternalIndustryDataInboundFlow -InboundFlowId <String> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-MgBetaExternalIndustryDataInboundFlow -InputObject <ISearchIdentity> [-ExpandProperty <String[]>]
 [-Property <String[]>] [<CommonParameters>]
```
