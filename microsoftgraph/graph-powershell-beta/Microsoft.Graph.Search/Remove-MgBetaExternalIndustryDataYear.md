...
### Delete (Default)
```
Remove-MgBetaExternalIndustryDataYear -YearTimePeriodDefinitionId <String> [-IfMatch <String>] [-PassThru]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaExternalIndustryDataYear -InputObject <ISearchIdentity> [-IfMatch <String>] [-PassThru] [-WhatIf]
