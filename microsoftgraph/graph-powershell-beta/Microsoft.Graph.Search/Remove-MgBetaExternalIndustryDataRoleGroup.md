...
### Delete (Default)
```
Remove-MgBetaExternalIndustryDataRoleGroup -RoleGroupId <String> [-IfMatch <String>] [-PassThru] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-MgBetaExternalIndustryDataRoleGroup -InputObject <ISearchIdentity> [-IfMatch <String>] [-PassThru]
