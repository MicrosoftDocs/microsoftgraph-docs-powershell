...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.mail/update-mgbetausermailfoldermessage
Locale: en-US
Module Name: Microsoft.Graph.Beta.Mail
ms.date: 09/04/2026
PlatyPS schema version: 2024-05-01
title: Update-MgBetaUserMailFolderMessage
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Update-MgUserMailFolderMessage](/powershell/module/Microsoft.Graph.Mail/Update-MgUserMailFolderMessage?view=graph-powershell-1.0)
...
```
Update-MgBetaUserMailFolderMessage -InputObject <IMailIdentity> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaUserMailFolderMessage -InputObject <IMailIdentity>
 -BodyParameter <IMicrosoftGraphMessage> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [Update-MgBetaUserMailFolderMessage](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.mail/update-mgbetausermailfoldermessage)
