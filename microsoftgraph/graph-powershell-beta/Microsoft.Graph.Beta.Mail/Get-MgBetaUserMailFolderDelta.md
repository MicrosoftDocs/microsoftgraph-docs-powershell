...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.mail/get-mgbetausermailfolderdelta
schema: 2.0.0
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Get-MgUserMailFolderDelta](/powershell/module/Microsoft.Graph.Mail/Get-MgUserMailFolderDelta?view=graph-powershell-1.0)

## SYNTAX

### Delta (Default)
```
Get-MgBetaUserMailFolderDelta -UserId <String> [-ExpandProperty <String[]>] [-Filter <String>]
...
### DeltaViaIdentity
```
Get-MgBetaUserMailFolderDelta -InputObject <IMailIdentity> [-ExpandProperty <String[]>] [-Filter <String>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.mail/get-mgbetausermailfolderdelta](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.mail/get-mgbetausermailfolderdelta)
