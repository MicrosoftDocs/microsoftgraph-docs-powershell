...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.mail/new-mgbetausermessagemention
Locale: en-US
Module Name: Microsoft.Graph.Beta.Mail
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: New-MgBetaUserMessageMention
---
...
```
New-MgBetaUserMessageMention -MessageId <string> -UserId <string>
...
```
New-MgBetaUserMessageMention -InputObject <IMailIdentity> [-ResponseHeadersVariable <string>]
