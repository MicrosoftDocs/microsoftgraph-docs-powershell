...
```
New-MgBetaUserMessageExtension -MessageId <String> -UserId <String> [-ResponseHeadersVariable <String>]
...
### Create
```
New-MgBetaUserMessageExtension -MessageId <String> -UserId <String> -BodyParameter <Hashtable>
...
```
New-MgBetaUserMessageExtension -InputObject <IMailIdentity> [-ResponseHeadersVariable <String>]
 [-AdditionalProperties <Hashtable>] [-Id <String>] [-Headers <IDictionary>]
 [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### CreateViaIdentity
```
New-MgBetaUserMessageExtension -InputObject <IMailIdentity> -BodyParameter <Hashtable>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
