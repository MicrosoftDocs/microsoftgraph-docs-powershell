...
Get-MgBetaUserMailFolderChildFolderMessageRuleCount -MailFolderId <String> -MailFolderId1 <String>
 -UserId <String> [-Filter <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
## RELATED LINKS
[Get-MgUserMailFolderChildFolderMessageRuleCount](/powershell/module/Microsoft.Graph.Mail/Get-MgUserMailFolderChildFolderMessageRuleCount?view=graph-powershell-1.0)
