...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.mail/invoke-mgbetareplyusermailfolderchildfoldermessage
Locale: en-US
Module Name: Microsoft.Graph.Beta.Mail
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: Invoke-MgBetaReplyUserMailFolderChildFolderMessage
---
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Invoke-MgReplyUserMailFolderChildFolderMessage](/powershell/module/Microsoft.Graph.Mail/Invoke-MgReplyUserMailFolderChildFolderMessage?view=graph-powershell-1.0)
...
```
Invoke-MgBetaReplyUserMailFolderChildFolderMessage -MailFolderId <string> -MailFolderId1 <string>
...
```
Invoke-MgBetaReplyUserMailFolderChildFolderMessage -InputObject <IMailIdentity>
...
```yaml
Type: Microsoft.Graph.Beta.PowerShell.Models.IPathsSp3FzmUsersUserIdMailfoldersMailfolderIdChildfoldersMailfolderId1MessagesMessageIdMicrosoftGraphReplyPostRequestbodyContentApplicationJsonSchema
DefaultValue: ''
SupportsWildcards: false
Aliases: []
ParameterSets:
...
### Microsoft.Graph.Beta.PowerShell.Models.IPathsSp3FzmUsersUserIdMailfoldersMailfolderIdChildfoldersMailfolderId1MessagesMessageIdMicrosoftGraphReplyPostRequestbodyContentApplicationJsonSchema
...
- [Invoke-MgBetaReplyUserMailFolderChildFolderMessage](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.mail/invoke-mgbetareplyusermailfolderchildfoldermessage)
