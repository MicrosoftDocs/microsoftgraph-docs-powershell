...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.mail/get-mgbetausermailfolderchildfolderdelta
schema: 2.0.0
...
### Delta (Default)
```
Get-MgBetaUserMailFolderChildFolderDelta -MailFolderId <String> -UserId <String> [-ExpandProperty <String[]>]
...
### DeltaViaIdentity
```
Get-MgBetaUserMailFolderChildFolderDelta -InputObject <IMailIdentity> [-ExpandProperty <String[]>]
 [-Filter <String>] [-Property <String[]>] [-Search <String>] [-Skip <Int32>] [-Sort <String[]>] [-Top <Int32>]
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.mail/get-mgbetausermailfolderchildfolderdelta](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.mail/get-mgbetausermailfolderchildfolderdelta)

[https://learn.microsoft.com/graph/api/mailfolder-delta?view=graph-rest-beta](https://learn.microsoft.com/graph/api/mailfolder-delta?view=graph-rest-beta)
