...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.mail/new-mgbetausermailfolderchildfolder
Locale: en-US
Module Name: Microsoft.Graph.Beta.Mail
ms.date: 08/21/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaUserMailFolderChildFolder
---
...
```
New-MgBetaUserMailFolderChildFolder -InputObject <IMailIdentity> [-ResponseHeadersVariable <string>]
...
```
New-MgBetaUserMailFolderChildFolder -InputObject <IMailIdentity>
 -BodyParameter <IMicrosoftGraphMailFolder> [-ResponseHeadersVariable <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgBetaUserMailFolderChildFolder](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.mail/new-mgbetausermailfolderchildfolder)
