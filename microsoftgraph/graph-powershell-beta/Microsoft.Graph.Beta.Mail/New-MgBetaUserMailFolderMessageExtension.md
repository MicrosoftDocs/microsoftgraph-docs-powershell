...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.mail/new-mgbetausermailfoldermessageextension
Locale: en-US
Module Name: Microsoft.Graph.Beta.Mail
ms.date: 08/28/2026
PlatyPS schema version: 2024-05-01
title: New-MgBetaUserMailFolderMessageExtension
---
...
```
New-MgBetaUserMailFolderMessageExtension -InputObject <IMailIdentity>
 [-ResponseHeadersVariable <string>] [-AdditionalProperties <hashtable>] [-Id <string>] [-Break]
 [-Headers <IDictionary>] [-HttpPipelineAppend <SendAsyncStep[]>]
 [-HttpPipelinePrepend <SendAsyncStep[]>] [-Proxy <uri>] [-ProxyCredential <pscredential>]
 [-ProxyUseDefaultCredentials] [-WhatIf] [-Confirm]
...
- [New-MgBetaUserMailFolderMessageExtension](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.mail/new-mgbetausermailfoldermessageextension)
