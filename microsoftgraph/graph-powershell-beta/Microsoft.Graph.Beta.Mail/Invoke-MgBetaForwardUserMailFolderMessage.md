...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.mail/invoke-mgbetaforwardusermailfoldermessage
schema: 2.0.0
...
> [!NOTE]
> To view the v1.0 release of this cmdlet, view [Invoke-MgForwardUserMailFolderMessage](/powershell/module/Microsoft.Graph.Mail/Invoke-MgForwardUserMailFolderMessage?view=graph-powershell-1.0)
...
```
Invoke-MgBetaForwardUserMailFolderMessage -InputObject <IMailIdentity> [-ResponseHeadersVariable <String>]
...
### ForwardViaIdentity
```
Invoke-MgBetaForwardUserMailFolderMessage -InputObject <IMailIdentity>
 -BodyParameter <IPaths1X7Dum0UsersUserIdMailfoldersMailfolderIdMessagesMessageIdMicrosoftGraphForwardPostRequestbodyContentApplicationJsonSchema>
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-PassThru] [-ProgressAction <ActionPreference>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
[https://learn.microsoft.com/powershell/module/microsoft.graph.beta.mail/invoke-mgbetaforwardusermailfoldermessage](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.mail/invoke-mgbetaforwardusermailfoldermessage)
