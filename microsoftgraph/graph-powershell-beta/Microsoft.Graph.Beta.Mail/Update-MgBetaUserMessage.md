...
HelpUri: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.mail/update-mgbetausermessage
Locale: en-US
Module Name: Microsoft.Graph.Beta.Mail
ms.date: 09/12/2025
PlatyPS schema version: 2024-05-01
title: Update-MgBetaUserMessage
---
...
```
Update-MgBetaUserMessage -MessageId <string> -UserId <string> [-ResponseHeadersVariable <string>]
...
```
Update-MgBetaUserMessage -MessageId <string> -UserId <string>
...
```
Update-MgBetaUserMessage -InputObject <IMailIdentity> [-ResponseHeadersVariable <string>]
 [-AdditionalProperties <hashtable>] [-Attachments <IMicrosoftGraphAttachment[]>]
 [-BccRecipients <IMicrosoftGraphRecipient[]>] [-Body <IMicrosoftGraphItemBody>]
 [-BodyPreview <string>] [-Categories <string[]>] [-CcRecipients <IMicrosoftGraphRecipient[]>]
 [-ChangeKey <string>] [-ConversationId <string>] [-ConversationIndexInputFile <string>]
