...
```
Get-MgBetaUserMailFolder -UserId <string> [-ExpandProperty <string[]>]
...
- [Get-MgBetaUserMailFolder](https://learn.microsoft.com/powershell/module/microsoft.graph.beta.mail/get-mgbetausermailfolder)
