...
### Set (Default)
```
Set-MgBetaUserMessageContent -MessageId <String> -UserId <String> [-Data <Stream>]
...
### SetViaIdentity
```
Set-MgBetaUserMessageContent -InputObject <IMailIdentity> [-Data <Stream>] [-ResponseHeadersVariable <String>]
