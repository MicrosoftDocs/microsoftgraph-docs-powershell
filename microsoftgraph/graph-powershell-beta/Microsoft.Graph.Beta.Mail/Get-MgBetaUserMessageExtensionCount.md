...
### Get (Default)
```
Get-MgBetaUserMessageExtensionCount -MessageId <String> -UserId <String> [-Filter <String>] [-Search <String>]
...
### GetViaIdentity
```
Get-MgBetaUserMessageExtensionCount -InputObject <IMailIdentity> [-Filter <String>] [-Search <String>]
 [-ResponseHeadersVariable <String>] [-Headers <IDictionary>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
