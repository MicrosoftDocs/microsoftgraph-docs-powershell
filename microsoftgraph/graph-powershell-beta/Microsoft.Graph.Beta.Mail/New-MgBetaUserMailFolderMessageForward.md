...
online version: https://learn.microsoft.com/powershell/module/microsoft.graph.beta.mail/new-mgbetausermailfoldermessageforward
schema: 2.0.0
...
```
New-MgBetaUserMailFolderMessageForward -InputObject <IMailIdentity> [-ResponseHeadersVariable <String>]
