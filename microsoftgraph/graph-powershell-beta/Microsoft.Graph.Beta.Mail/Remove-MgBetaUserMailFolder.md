...
### DeleteViaIdentity
```
Remove-MgBetaUserMailFolder -InputObject <IMailIdentity> [-IfMatch <String>] [-Headers <IDictionary>]
...
## RELATED LINKS
[Remove-MgUserMailFolder](/powershell/module/Microsoft.Graph.Mail/Remove-MgUserMailFolder?view=graph-powershell-1.0)
