...
The PowerShell SDK supports two types of authentication: [delegated access](/graph/auth-v2-user.md), and [app-only access](/graph/auth-v2-service.md). This guide will focus on the configuration needed to enable app-only access.
